...
namespace GalaxySMS.Data.Contracts
{
    ...
    {
        gcsUser GetByUserName(string userName, IApplicationUserSessionDataHeader sessionData);
        gcsUser GetByEmail(string email, IApplicationUserSessionDataHeader sessionData);
        ...
        PasswordValidationInfo IsPasswordValid(gcsUser user);
        ...
        IEnumerable<gcsUserOldPassword> GetOldPasswordsForUser(gcsUser user, int howMany, IApplicationUserSessionDataHeader sessionData);
        UserSignInResult SignInRequest(UserSignInRequest requestData, IApplicationUserSessionDataHeader sessionData, TwoFactorAuthParameters twoFactorAuthParameters);
        bool VerifyTwoFactorAuthenticationToken(TwoFactorAuthenticationData requestData, IApplicationUserSessionDataHeader sessionData, int tokenLifespan);
...
//        bool DoesUserHavePermission(Guid userId, Guid entityId, Guid applicationId, Guid permissionId);
        ...
        IEnumerable<gcsUserBasic> GetUserList(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters);
        ...
        ArrayResponse<gcsUser> GetByPrimaryEntityId(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters);
        ...
        UserSessionToken GetUserSessionTokenForApplications(Guid userId, Guid applicationId, UserSignInRequest requestData);
        UserSessionToken GetUserSessionTokenForSignInRequest(Guid userId, Guid applicationId, IEnumerable<Guid> applicationIds, bool bIncludeEntityPhotos, int entityPhotosPixelWidth, bool bIncludeUserImages, int userImagesPixelWidth, IEnumerable<Guid> permissionsForEntityIds, IApplicationUserSessionDataHeader sessionData);
        ArrayResponse<gcsUserBasic> GetUserListPaged(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters);
        ...
        IEnumerable<Guid> GetPermissionIdsForUserEntityPermissionCategory(Guid userId, Guid entityId, Guid permissionCategoryId);
        ICurrentEntityInfo SetCurrentEntityId(Guid userId, Guid entityId, IApplicationUserSessionDataHeader sessionData);
