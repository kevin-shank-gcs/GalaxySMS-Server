...
namespace GalaxySMS.Data.Contracts
{
    public interface IGcsResourceStringLanguageRepository : IDataRepository<gcsResourceStringLanguage>
    {
        ...
        gcsResourceStringLanguage SaveResourceStringLanguage(gcsResourceStringLanguage resource, IApplicationUserSessionDataHeader sessionData, PDSATransaction transaction, ISaveParameters saveParams);
