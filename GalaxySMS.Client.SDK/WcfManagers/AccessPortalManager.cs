...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class AccessPortalManager : ManagerBase
    {
        ...
        public CommandResponse<AccessPortalCommandAction>  ExecuteCommand(CommandParameters<AccessPortalCommandAction> parameters)
        {
            InitializeErrorsCollection();
        ...
        public async Task<CommandResponse<AccessPortalCommandAction>> ExecuteCommandAsync(CommandParameters<AccessPortalCommandAction> parameters)
        {
            InitializeErrorsCollection();
        ...
        public async Task<ArrayResponse<ActivityHistoryEvent>> GetAccessPortalActivityHistoryEventsAsync(ActivityHistoryEventSearchParameters parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<ActivityHistoryEvent> data = null;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Validates the AccessPortal described by data. </summary>
        ///
            ...
            WithClient<ISystemManagementService>(
                _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                    GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            savedItem = proxy.ValidateAccessPortal(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Validates the access portal asynchronous described by data. </summary>
        ///
        /// <remarks>   Kevin, 10/3/2022. </remarks>
        ///
        /// <param name="parameters"> The data. </param>
        ...
        public async Task<ValidationProblemDetails> ValidateAccessPortalAsync(SaveParameters<AccessPortal> parameters)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                        GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), async proxy =>
                        {
                            var savedItem = await proxy.ValidateAccessPortalAsync(parameters);
                            return savedItem;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
