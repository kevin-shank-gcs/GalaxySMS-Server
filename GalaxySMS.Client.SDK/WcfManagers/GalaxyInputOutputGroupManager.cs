...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class GalaxyInputOutputGroupManager : ManagerBase
    {
        ...
        private List<InputOutputGroupAssignmentSource> _InputOutputGroupAssignmentSources;
        ...
        public ReadOnlyCollection<InputOutputGroupAssignmentSource> InputOutputGroupAssignmentSources { get; internal set; }
        #endregion
        ...
        #region Get InputOutputGroupAssignmentSource
        ...
        public ReadOnlyCollection<InputOutputGroupAssignmentSource> GetInputOutputGroupAssignmentSourcesForInputOutputGroup(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            _InputOutputGroupAssignmentSources = new List<InputOutputGroupAssignmentSource>();
            ...
            WithClient<ISystemManagementService>(
                _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                    GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            var data = proxy.GetInputOutputGroupAssignmentSourcesForInputOutputGroup(parameters);
                            if (data != null)
                            {
                                foreach (var o in data)
                                    _InputOutputGroupAssignmentSources.Add(o);
                            }
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
            ...
            InputOutputGroupAssignmentSources = new ReadOnlyCollection<InputOutputGroupAssignmentSource>(_InputOutputGroupAssignmentSources);
            return InputOutputGroupAssignmentSources;
        }
        ...
        public async Task<ReadOnlyCollection<InputOutputGroupAssignmentSource>> GetInputOutputGroupAssignmentSourcesForInputOutputGroupAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            _InputOutputGroupAssignmentSources = new List<InputOutputGroupAssignmentSource>();
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                        GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), async proxy =>
                        {
                            var data = await proxy.GetInputOutputGroupAssignmentSourcesForInputOutputGroupAsync(parameters);
                            if (data != null)
                            {
                                foreach (var o in data)
                                    _InputOutputGroupAssignmentSources.Add(o);
