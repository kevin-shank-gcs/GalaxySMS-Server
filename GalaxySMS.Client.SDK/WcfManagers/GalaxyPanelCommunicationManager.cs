...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class GalaxyPanelCommunicationManager : ManagerBase, IGalaxyPanelCommunicationEventServiceCallback
    {
        ...
        {
            get { return new ReadOnlyCollection<CpuConnectionInfo>(_Connections); }
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Delegate for handling GetIsCommunicationServerRunningStatusAsyncCompleted events.
        /// </summary>
        ///
        /// <remarks>   Kevin, 12/26/2018. </remarks>
        ///
        /// <param name="sender">   Source of the event. </param>
        /// <param name="e">        Communication server running status event information. </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public delegate void GetIsCommunicationServerRunningStatusAsyncCompletedEventHandler(object sender, CommunicationServerRunningStatusEventArgs e);

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Event queue for all listeners interested in
        /// getIsCommunicationServerRunningStatusAsyncCompleted events.
        /// </summary>
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public event GetIsCommunicationServerRunningStatusAsyncCompletedEventHandler GetIsCommunicationServerRunningStatusAsyncCompletedEvent;

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Delegate for handling RefreshGalaxyCpuConnectionsAsyncCompleted events.
        /// </summary>
        ///
        /// <remarks>   Kevin, 12/26/2018. </remarks>
        ///
        /// <param name="sender">   Source of the event. </param>
        /// <param name="e">        Galaxy CPU connections event information. </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public delegate void RefreshGalaxyCpuConnectionsAsyncCompletedEventHandler(object sender, GalaxyCpuConnectionsEventArgs e);

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Event queue for all listeners interested in refreshGalaxyCpuConnectionsAsyncCompleted events.
        /// </summary>
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public event RefreshGalaxyCpuConnectionsAsyncCompletedEventHandler RefreshGalaxyCpuConnectionsAsyncCompletedEvent;
        ...
        public void SendDataPacketToServerAsync(RawDataToSend data)
        {
            InitializeErrorsCollection();
        ...
        public void GetIsCommunicationServerRunningStatusAsync()
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            ...
            WithClientAsync<IGalaxyPanelCommunicationManagerService>(
                    ...
                    ClientUserSessionData), async proxy =>
                    {
                        if (proxy != null)
                        {
                            Func<Task> task = async () =>
                            {
                                Task<bool> t = proxy.GetRunningStatusAsync();
                                CommunicationServerRunningStatus = await t;
                            };
                            try
                            {
                                task().Wait();
                                DateTimeOffset endedAt = DateTimeOffset.Now;
                                var handler = GetIsCommunicationServerRunningStatusAsyncCompletedEvent;
                                if (handler != null)
                                {
                                    handler(this,
                                        new CommunicationServerRunningStatusEventArgs(
                                            CommunicationServerRunningStatus, startedAt, endedAt));
                                }
                            }
                            catch (AggregateException ae)
                            {
        ...
        public ReadOnlyCollection<CpuConnectionInfo> RefreshGalaxyCpuConnections(GetCpuConnectionsParameters parameters)
        {
            ...
            WithClient<IGalaxyPanelCommunicationManagerService>(
                    ...
                    ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            _Connections = new List<CpuConnectionInfo>(proxy.GetConnections(parameters));
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        public void RefreshGalaxyCpuConnectionsAsync(GetCpuConnectionsParameters parameters)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            ...
            WithClientAsync<IGalaxyPanelCommunicationManagerService>(
                ...
                ClientUserSessionData), proxy =>
                {
                    if (proxy != null)
                    {
                        Func<Task> task = async () =>
                        {
                            Task<CpuConnectionInfo[]> t = proxy.GetConnectionsAsync(parameters);
                            _Connections = new List<CpuConnectionInfo>(await t);
                            DateTimeOffset endedAt = DateTimeOffset.Now;
                            var handler = RefreshGalaxyCpuConnectionsAsyncCompletedEvent;
                            if (handler != null)
                                handler(this, new GalaxyCpuConnectionsEventArgs(_Connections, startedAt, endedAt));
                        };
                        try
                        {
                            task().Wait();
        ...
        private void RegisterWithGalaxyPanelCommunicationEventService(bool bUnRegister)
        {
            try
            {
                if (bUnRegister == false)
                {
                    ...
                    Assembly myAssembly = GCS.Framework.Utilities.SystemUtilities.ExecutingAssembly;
