...
namespace GalaxySMS.Client.Entities
{
	...
	[DataContract]
	public partial class AccessPortalLockPushButtonBehavior : DbObjectBase, ITableEntityBase
    {
    ...
    namespace GalaxySMS.Client.Entities
    {
        ...
        {
        	public AccessPortalLockPushButtonBehavior() : base()
        	{
        		Initialize();
        	}
        
        	public AccessPortalLockPushButtonBehavior(AccessPortalLockPushButtonBehavior e) : base(e)
        	{
        		Initialize(e);
        	}
