...
{
    public class PanelMessageReceivedPublisherWorkflow : IPanelMessageWorkflow
    {
        ...
        private void SendNotificationEvent()
        {
            ...
            var queue = MessageQueueFactory.CreateOutbound(QueueNames.PanelMessagePublisher, MessagePattern.PublishSubscribe);
