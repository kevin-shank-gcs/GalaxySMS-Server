...
{
    public class MercPanelMessageRecorderWorkflow : IPanelMessageWorkflow
    {
        ...
        public void Run()
        {
            ...
            //}
#if NETFRAMEWORK
            this.Log().InfoFormat($"{DateTimeOffset.Now.TimeOfDay} MercPanelMessageRecorderWorkflow processing message: {msg}");
#elif NETCOREAPP
            //            this.Log().InfoFormat($"{DateTimeOffset.Now.TimeOfDay} MercPanelMessageRecorderWorkflow processing message: {msg}");
#endif
        }
