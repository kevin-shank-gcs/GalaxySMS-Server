...
namespace GCS.Core.Common.ServiceModel.Extensions
{
    ...
    //public class ApplicationUserSessionHeaderInspectorBehavior : Attribute, IDispatchMessageInspector, IClientMessageInspector, IEndpointBehavior, IServiceBehavior
    public class ApplicationUserSessionHeaderInspectorBehavior : Attribute, IClientMessageInspector, IEndpointBehavior, IServiceBehavior, IDispatchMessageInspector
    {
