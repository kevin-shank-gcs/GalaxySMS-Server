...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the gcs_GetRowCountFromTableByGuidColumnValuePDSA stored procedure.
  ...
  public partial class gcs_GetRowCountFromTableByGuidColumnValuePDSA : PDSAEntityBase
  {
    ...
    { 
      ...
      set 
      { 
        if(HasValueChanged(_GuidValue, value, "@GuidValue"))
        {
          _GuidValue = value; 
          RaisePropertyChanged("GuidValue");
        }
      } 
    }
