...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the ActivityEventPDSA_InsertPDSA stored procedure.
  ...
  public partial class ActivityEventPDSA_InsertPDSA : PDSAEntityBase
  {
    ...
    private DateTimeOffset _ActivityDateTime = DateTime.Now;
