...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalTypeAccessPortalCommandPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalTypeAccessPortalCommandPDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalTypeAccessPortalCommandUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Type Access Portal Command UidOld value
    /// </summary>
    
    public Guid AccessPortalTypeAccessPortalCommandUidOld
    { 
      get { return _AccessPortalTypeAccessPortalCommandUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalTypeAccessPortalCommandUidOld, value, "AccessPortalTypeAccessPortalCommandUid"))
        {
          _AccessPortalTypeAccessPortalCommandUidOld = value; 
          RaisePropertyChanged("AccessPortalTypeAccessPortalCommandUidOld");
        }
      } 
    }
    #endregion
