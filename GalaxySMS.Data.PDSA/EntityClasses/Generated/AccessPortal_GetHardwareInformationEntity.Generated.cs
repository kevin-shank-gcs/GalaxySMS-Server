...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the AccessPortal_GetHardwareInformationPDSA stored procedure.
  ...
  public partial class AccessPortal_GetHardwareInformationPDSA : PDSAEntityBase
  {
    ...
    private int _PanelConnectedCount = 0;
    ...
    /// <summary>
    /// Get/Set the Panel Connected Count value
    /// </summary>
    
    [DataMember]
    
    public int PanelConnectedCount 
    { 
      get { return _PanelConnectedCount; }
      set 
      { 
        if(HasValueChanged(_PanelConnectedCount, value, "PanelConnectedCount"))
        {
          _PanelConnectedCount = value; 
          RaisePropertyChanged("PanelConnectedCount");
        }
      } 
    }
