...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a ClusterCommandPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class ClusterCommandPDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _ClusterCommandUid = Guid.Empty;
    ...
    private Guid _ClusterCommandUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Cluster Command UidOld value
    /// </summary>
    
    public Guid ClusterCommandUidOld
    { 
      get { return _ClusterCommandUidOld; }
      set 
      { 
        if(HasValueChanged(_ClusterCommandUidOld, value, "ClusterCommandUid"))
        {
          _ClusterCommandUidOld = value; 
          RaisePropertyChanged("ClusterCommandUidOld");
        }
      } 
    }
    #endregion
