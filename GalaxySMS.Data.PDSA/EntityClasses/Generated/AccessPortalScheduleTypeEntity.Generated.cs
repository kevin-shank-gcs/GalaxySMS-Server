...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalScheduleTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalScheduleTypePDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalScheduleTypeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Schedule Type UidOld value
    /// </summary>
    
    public Guid AccessPortalScheduleTypeUidOld
    { 
      get { return _AccessPortalScheduleTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalScheduleTypeUidOld, value, "AccessPortalScheduleTypeUid"))
        {
          _AccessPortalScheduleTypeUidOld = value; 
          RaisePropertyChanged("AccessPortalScheduleTypeUidOld");
        }
      } 
    }
    #endregion
