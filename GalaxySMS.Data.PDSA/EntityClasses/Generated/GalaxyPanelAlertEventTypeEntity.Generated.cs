...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a GalaxyPanelAlertEventTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class GalaxyPanelAlertEventTypePDSA : PDSAEntityBase
  {
    ...
    private Guid _GalaxyPanelAlertEventTypeUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Galaxy Panel Alert Event Type UidOld value
    /// </summary>
    
    public Guid GalaxyPanelAlertEventTypeUidOld
    { 
      get { return _GalaxyPanelAlertEventTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_GalaxyPanelAlertEventTypeUidOld, value, "GalaxyPanelAlertEventTypeUid"))
        {
          _GalaxyPanelAlertEventTypeUidOld = value; 
          RaisePropertyChanged("GalaxyPanelAlertEventTypeUidOld");
        }
      } 
    }
    #endregion
