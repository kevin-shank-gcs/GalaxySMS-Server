...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalElevatorControlTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalElevatorControlTypePDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPointUid = Guid.NewGuid();
    private Guid _AccessPortalUid = Guid.NewGuid();
    private Guid _GalaxyPanelModelUid = Guid.NewGuid();
    private Guid _AccessPortalElevatorControlTypeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Elevator Control Type UidOld value
    /// </summary>
    
    public Guid AccessPortalElevatorControlTypeUidOld
    { 
      get { return _AccessPortalElevatorControlTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalElevatorControlTypeUidOld, value, "AccessPortalElevatorControlTypeUid"))
        {
          _AccessPortalElevatorControlTypeUidOld = value; 
          RaisePropertyChanged("AccessPortalElevatorControlTypeUidOld");
        }
      } 
    }
    #endregion
