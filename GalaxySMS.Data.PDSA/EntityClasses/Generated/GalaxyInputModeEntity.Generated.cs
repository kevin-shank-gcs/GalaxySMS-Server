...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a GalaxyInputModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class GalaxyInputModePDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _GalaxyInputModeUid = Guid.NewGuid();
    ...
    private Guid _GalaxyInputModeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Galaxy Input Mode UidOld value
    /// </summary>
    
    public Guid GalaxyInputModeUidOld
    { 
      get { return _GalaxyInputModeUidOld; }
      set 
      { 
        if(HasValueChanged(_GalaxyInputModeUidOld, value, "GalaxyInputModeUid"))
        {
          _GalaxyInputModeUidOld = value; 
          RaisePropertyChanged("GalaxyInputModeUidOld");
        }
      } 
    }
    #endregion
