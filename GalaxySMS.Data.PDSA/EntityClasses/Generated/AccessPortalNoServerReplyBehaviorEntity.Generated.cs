...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalNoServerReplyBehaviorPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalNoServerReplyBehaviorPDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalNoServerReplyBehaviorUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal No Server Reply Behavior UidOld value
    /// </summary>
    
    public Guid AccessPortalNoServerReplyBehaviorUidOld
    { 
      get { return _AccessPortalNoServerReplyBehaviorUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalNoServerReplyBehaviorUidOld, value, "AccessPortalNoServerReplyBehaviorUid"))
        {
          _AccessPortalNoServerReplyBehaviorUidOld = value; 
          RaisePropertyChanged("AccessPortalNoServerReplyBehaviorUidOld");
        }
      } 
    }
    #endregion
