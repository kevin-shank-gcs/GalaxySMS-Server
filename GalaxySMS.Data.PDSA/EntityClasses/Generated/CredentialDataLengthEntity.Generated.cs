...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a CredentialDataLengthPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class CredentialDataLengthPDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _CredentialDataLengthUid = Guid.NewGuid();
    ...
    private Guid _CredentialDataLengthUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Credential Data Length UidOld value
    /// </summary>
    
    public Guid CredentialDataLengthUidOld
    { 
      get { return _CredentialDataLengthUidOld; }
      set 
      { 
        if(HasValueChanged(_CredentialDataLengthUidOld, value, "CredentialDataLengthUid"))
        {
          _CredentialDataLengthUidOld = value; 
          RaisePropertyChanged("CredentialDataLengthUidOld");
        }
      } 
    }
    #endregion
