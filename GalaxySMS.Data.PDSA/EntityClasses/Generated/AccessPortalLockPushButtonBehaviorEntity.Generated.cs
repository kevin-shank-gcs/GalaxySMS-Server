...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalLockPushButtonBehaviorPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalLockPushButtonBehaviorPDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalLockPushButtonBehaviorUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Lock Push Button Behavior UidOld value
    /// </summary>
    
    public Guid AccessPortalLockPushButtonBehaviorUidOld
    { 
      get { return _AccessPortalLockPushButtonBehaviorUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalLockPushButtonBehaviorUidOld, value, "AccessPortalLockPushButtonBehaviorUid"))
        {
          _AccessPortalLockPushButtonBehaviorUidOld = value; 
          RaisePropertyChanged("AccessPortalLockPushButtonBehaviorUidOld");
        }
      } 
    }
    #endregion
