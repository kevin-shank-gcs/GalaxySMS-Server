...
namespace GalaxySMS.EntityLayer
{
  ...
  public partial class InputDevice_GetPanelLoadDataByClusterUidPDSA : PDSAEntityBase
  {
    ...
    private Guid _ServerAddress = Guid.Empty;
    private int _IsConnected = 0;
    private bool _MainIOGroupIsActive = false;
    ...
    /// <summary>
    /// Get/Set the Main IO Group Is Active value
    /// </summary>
    
    [DataMember]
    
    public bool MainIOGroupIsActive 
    { 
      get { return _MainIOGroupIsActive; }
      set 
      { 
        if(HasValueChanged(_MainIOGroupIsActive, value, "MainIOGroupIsActive"))
        {
          _MainIOGroupIsActive = value; 
          RaisePropertyChanged("MainIOGroupIsActive");
        }
      } 
    }
