...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a MercSioTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class MercSioTypePDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _MercSioTypeUid = Guid.Empty;
    ...
    private Guid _MercSioTypeUidOld = Guid.Empty;
    #endregion
    
    #region Public Properties
    /// <summary>
    /// Get/Set the Merc Sio Type Uid value
    /// </summary>
    
    [DataMember]
    
    public Guid MercSioTypeUid 
    { 
      get { return _MercSioTypeUid; }
      set 
      { 
        if(HasValueChanged(_MercSioTypeUid, value, "MercSioTypeUid"))
        {
          _MercSioTypeUid = value; 
          RaisePropertyChanged("MercSioTypeUid");
        }
      } 
    }
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Merc Sio Type UidOld value
    /// </summary>
    
    public Guid MercSioTypeUidOld
    { 
      get { return _MercSioTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_MercSioTypeUidOld, value, "MercSioTypeUid"))
        {
          _MercSioTypeUidOld = value; 
          RaisePropertyChanged("MercSioTypeUidOld");
        }
      } 
    }
    #endregion
