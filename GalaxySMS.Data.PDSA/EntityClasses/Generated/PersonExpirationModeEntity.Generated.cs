...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PersonExpirationModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PersonExpirationModePDSA : PDSAEntityBase
  {
    ...
    private Guid _PersonExpirationModeUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Person Expiration Mode UidOld value
    /// </summary>
    
    public Guid PersonExpirationModeUidOld
    { 
      get { return _PersonExpirationModeUidOld; }
      set 
      { 
        if(HasValueChanged(_PersonExpirationModeUidOld, value, "PersonExpirationModeUid"))
        {
          _PersonExpirationModeUidOld = value; 
          RaisePropertyChanged("PersonExpirationModeUidOld");
        }
      } 
    }
    #endregion
