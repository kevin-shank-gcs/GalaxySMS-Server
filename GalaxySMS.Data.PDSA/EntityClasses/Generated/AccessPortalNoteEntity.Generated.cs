...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalNotePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalNotePDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalNoteUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Note UidOld value
    /// </summary>
    
    public Guid AccessPortalNoteUidOld
    { 
      get { return _AccessPortalNoteUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalNoteUidOld, value, "AccessPortalNoteUid"))
        {
          _AccessPortalNoteUidOld = value; 
          RaisePropertyChanged("AccessPortalNoteUidOld");
        }
      } 
    }
    #endregion
