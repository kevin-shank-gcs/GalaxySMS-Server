...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a InputCommandPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class InputCommandPDSA : PDSAEntityBase
  {
    ...
    private Guid _InputCommandUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Input Command UidOld value
    /// </summary>
    
    public Guid InputCommandUidOld
    { 
      get { return _InputCommandUidOld; }
      set 
      { 
        if(HasValueChanged(_InputCommandUidOld, value, "InputCommandUid"))
        {
          _InputCommandUidOld = value; 
          RaisePropertyChanged("InputCommandUidOld");
        }
      } 
    }
    #endregion
