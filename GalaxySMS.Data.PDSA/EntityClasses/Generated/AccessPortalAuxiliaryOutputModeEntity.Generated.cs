...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalAuxiliaryOutputModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalAuxiliaryOutputModePDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalAuxiliaryOutputModeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Auxiliary Output Mode UidOld value
    /// </summary>
    
    public Guid AccessPortalAuxiliaryOutputModeUidOld
    { 
      get { return _AccessPortalAuxiliaryOutputModeUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalAuxiliaryOutputModeUidOld, value, "AccessPortalAuxiliaryOutputModeUid"))
        {
          _AccessPortalAuxiliaryOutputModeUidOld = value; 
          RaisePropertyChanged("AccessPortalAuxiliaryOutputModeUidOld");
        }
      } 
    }
    #endregion
