...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalAlertEventTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalAlertEventTypePDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalAlertEventTypeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Alert Event Type UidOld value
    /// </summary>
    
    public Guid AccessPortalAlertEventTypeUidOld
    { 
      get { return _AccessPortalAlertEventTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalAlertEventTypeUidOld, value, "AccessPortalAlertEventTypeUid"))
        {
          _AccessPortalAlertEventTypeUidOld = value; 
          RaisePropertyChanged("AccessPortalAlertEventTypeUidOld");
        }
      } 
    }
    #endregion
