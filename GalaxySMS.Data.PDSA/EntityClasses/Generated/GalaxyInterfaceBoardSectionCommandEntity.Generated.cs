...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a GalaxyInterfaceBoardSectionCommandPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class GalaxyInterfaceBoardSectionCommandPDSA : PDSAEntityBase
  {
    ...
    private Guid _GalaxyInterfaceBoardSectionCommandUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Galaxy Interface Board Section Command UidOld value
    /// </summary>
    
    public Guid GalaxyInterfaceBoardSectionCommandUidOld
    { 
      get { return _GalaxyInterfaceBoardSectionCommandUidOld; }
      set 
      { 
        if(HasValueChanged(_GalaxyInterfaceBoardSectionCommandUidOld, value, "GalaxyInterfaceBoardSectionCommandUid"))
        {
          _GalaxyInterfaceBoardSectionCommandUidOld = value; 
          RaisePropertyChanged("GalaxyInterfaceBoardSectionCommandUidOld");
        }
      } 
    }
    #endregion
