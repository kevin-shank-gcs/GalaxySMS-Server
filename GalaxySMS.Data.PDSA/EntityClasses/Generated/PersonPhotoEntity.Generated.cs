...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PersonPhotoPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PersonPhotoPDSA : PDSAEntityBase
  {
    ...
    private Guid _PersonPhotoUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Person Photo UidOld value
    /// </summary>
    
    public Guid PersonPhotoUidOld
    { 
      get { return _PersonPhotoUidOld; }
      set 
      { 
        if(HasValueChanged(_PersonPhotoUidOld, value, "PersonPhotoUid"))
        {
          _PersonPhotoUidOld = value; 
          RaisePropertyChanged("PersonPhotoUidOld");
        }
      } 
    }
    #endregion
