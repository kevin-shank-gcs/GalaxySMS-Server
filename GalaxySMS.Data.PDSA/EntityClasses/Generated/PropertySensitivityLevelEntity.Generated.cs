...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PropertySensitivityLevelPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PropertySensitivityLevelPDSA : PDSAEntityBase
  {
    ...
    private short _SensitivityLevel = 0;
    ...
    private Guid _PropertySensitivityLevelUidOld = Guid.Empty;
    #endregion
    ...
    /// <summary>
    /// Get/Set the Sensitivity Level value
    /// </summary>
    ...
    { 
      ...
      set 
      { 
        if(HasValueChanged(_SensitivityLevel, value, "SensitivityLevel"))
        {
          _SensitivityLevel = value; 
          RaisePropertyChanged("SensitivityLevel");
        }
      } 
    }
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Property Sensitivity Level UidOld value
    /// </summary>
    
    public Guid PropertySensitivityLevelUidOld
    { 
      get { return _PropertySensitivityLevelUidOld; }
      set 
      { 
        if(HasValueChanged(_PropertySensitivityLevelUidOld, value, "PropertySensitivityLevelUid"))
        {
          _PropertySensitivityLevelUidOld = value; 
          RaisePropertyChanged("PropertySensitivityLevelUidOld");
        }
      } 
    }
    #endregion
