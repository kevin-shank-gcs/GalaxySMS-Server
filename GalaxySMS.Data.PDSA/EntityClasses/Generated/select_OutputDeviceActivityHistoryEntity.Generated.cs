...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the select_OutputDeviceActivityHistoryPDSA stored procedure.
  ...
  public partial class select_OutputDeviceActivityHistoryPDSA : PDSAEntityBase
  {
    ...
    private int _CredentialDescription = 0;
    private int _PersonUid = 0;
    private int _CredentialUid = 0;
    ...
    private int _InputOutputGroupName = 0;
    ...
    public int CredentialDescription 
    { 
    ...
    public int InputOutputGroupName 
    { 
