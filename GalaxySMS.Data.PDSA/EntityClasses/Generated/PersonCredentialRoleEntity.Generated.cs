...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PersonCredentialRolePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PersonCredentialRolePDSA : PDSAEntityBase
  {
    ...
    private Guid _PersonCredentialRoleUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Person Credential Role UidOld value
    /// </summary>
    
    public Guid PersonCredentialRoleUidOld
    { 
      get { return _PersonCredentialRoleUidOld; }
      set 
      { 
        if(HasValueChanged(_PersonCredentialRoleUidOld, value, "PersonCredentialRoleUid"))
        {
          _PersonCredentialRoleUidOld = value; 
          RaisePropertyChanged("PersonCredentialRoleUidOld");
        }
      } 
    }
    #endregion
