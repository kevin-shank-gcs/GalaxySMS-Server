...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the select_ActivityHistoryPDSA stored procedure.
  ...
  public partial class select_ActivityHistoryPDSA : PDSAEntityBase
  {
    ...
    private DateTimeOffset _StartDateTime = DateTime.Now;
    private DateTimeOffset _EndDateTime = DateTime.Now;
