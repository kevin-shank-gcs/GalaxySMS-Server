...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PanelDataPacketLogPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PanelDataPacketLogPDSA : PDSAEntityBase
  {
    ...
    private Guid _IdOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      set 
      { 
        if(HasValueChanged(_IdOld, value, "Id"))
        {
          _IdOld = value; 
          RaisePropertyChanged("IdOld");
        }
      } 
    }
    #endregion
