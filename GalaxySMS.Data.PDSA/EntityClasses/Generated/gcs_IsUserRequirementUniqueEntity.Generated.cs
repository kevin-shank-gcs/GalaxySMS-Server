...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the gcs_IsUserRequirementUniquePDSA stored procedure.
  ...
  public partial class gcs_IsUserRequirementUniquePDSA : PDSAEntityBase
  {
    ...
    private Guid _UserRequirementsId = Guid.NewGuid();
