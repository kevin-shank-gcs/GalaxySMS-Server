...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a UserDefinedListPropertyRulesPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class UserDefinedListPropertyRulesPDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _UserDefinedPropertyUid = Guid.Empty;
    private bool? _AllowMultipleSelections = false;
    ...
    /// <summary>
    /// Get/Set the Allow Multiple Selections value
    /// </summary>
    ...
    { 
      ...
      set 
      { 
        if(HasValueChanged(_AllowMultipleSelections, value, "AllowMultipleSelections"))
        {
          _AllowMultipleSelections = value; 
          RaisePropertyChanged("AllowMultipleSelections");
        }
      } 
    }
