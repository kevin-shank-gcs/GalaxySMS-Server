  ...
  public class InputDevice_GetAlertEventAcknowledgeDataPDSAData : PDSAStoredProcReadOnly
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitDataColumns()
    {
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive, GetResourceMessage("GCS_InputDevice_GetAlertEventAcknowledgeDataPDSA_IsActive_Header", "Is Active"), false, typeof(bool), DbType.Boolean);
      AllColumns.Add(dc);
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired, GetResourceMessage("GCS_InputDevice_GetAlertEventAcknowledgeDataPDSA_ResponseRequired_Header", "Response Required"), false, typeof(bool), DbType.Boolean);
      AllColumns.Add(dc);
    }
    #endregion
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      if (AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive).SetAsNull == false)
        AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive).Value = Entity.IsActive;
      else
        AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive).Value = false;
      ...
      if (AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired).SetAsNull == false)
        AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired).Value = Entity.ResponseRequired;
      else
        AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired).Value = false;
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive).IsNull == false)
        Entity.IsActive = AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive).GetAsBool();
      else
      ...
      if (AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired).IsNull == false)
        Entity.ResponseRequired = AllColumns.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired).GetAsBool();
      else
    ...
    public InputDevice_GetAlertEventAcknowledgeDataPDSA CreateEntityFromDataRow(DataRow dr)
    {
      ...
      if (dr.Table.Columns.Contains(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive))
      {
        if (dr[InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive] != DBNull.Value)
          entity.IsActive = Convert.ToBoolean(dr[InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.IsActive]);
      }
      ...
      if (dr.Table.Columns.Contains(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired))
      {
        if (dr[InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired] != DBNull.Value)
          entity.ResponseRequired = Convert.ToBoolean(dr[InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ResponseRequired]);
      }
