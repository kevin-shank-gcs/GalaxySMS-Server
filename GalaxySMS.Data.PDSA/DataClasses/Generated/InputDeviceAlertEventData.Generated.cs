...
namespace GalaxySMS.DataLayer
{
  ...
  public partial class InputDeviceAlertEventPDSAData : PDSADataClassTable
  {
    ...
    protected override void InitDataColumns()
    {
      ...
      prop = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive);
      prop.IsInsertable = true;
      prop.IsUpdatable = true;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
      ...
      prop = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority);
      prop.IsInsertable = true;
      prop.IsUpdatable = true;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
      ...
      prop = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired);
      prop.IsInsertable = true;
      prop.IsUpdatable = true;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive).Value = Entity.IsActive;
      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive).SetAsNull == true)
        Entity.IsActive = false;
      ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority).Value = Entity.AcknowledgePriority;
      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority).SetAsNull == true)
        Entity.AcknowledgePriority = 0;
      ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired).Value = Entity.ResponseRequired;
      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired).SetAsNull == true)
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.InsertDate).IsNull == false)
        Entity.InsertDate = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.InsertDate).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.UpdateDate).IsNull == false)
        Entity.UpdateDate = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.UpdateDate).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive).IsNull == false)
        Entity.IsActive = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive).GetAsBool();
      else
        Entity.IsActive = false;
      Entity.SetOriginalValueForProperty(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive, ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive).Value);

      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority).IsNull == false)
        Entity.AcknowledgePriority = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority).GetAsInteger();
      else
        Entity.AcknowledgePriority = 0;
      Entity.SetOriginalValueForProperty(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority, ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority).Value);

      if (ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired).IsNull == false)
        Entity.ResponseRequired = ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired).GetAsBool();
      else
        Entity.ResponseRequired = false;
      Entity.SetOriginalValueForProperty(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired, ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired).Value);
          ...
          switch (InsertFilter)
          {
            case InsertFilters.All:
             CommandObject.Parameters.Clear();
              ...
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@AcknowledgePriority", DbType.Int32, ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.AcknowledgePriority).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@ResponseRequired", DbType.Boolean, ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ResponseRequired).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@IsActive", DbType.Boolean, ValidatorObject.Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.IsActive).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
