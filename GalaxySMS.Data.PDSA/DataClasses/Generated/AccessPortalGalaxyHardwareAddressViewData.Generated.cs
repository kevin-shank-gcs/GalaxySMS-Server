...
namespace GalaxySMS.DataLayer
{
  ...
  public partial class AccessPortalGalaxyHardwareAddressViewPDSAData : PDSADataClassReadOnly
  {
    ...
    protected override void InitDataColumns()
    {
      ...
      prop = ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
      ...
      prop = ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive).Value = Entity.IsNodeActive;
      if (ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive).SetAsNull == true)
        Entity.IsNodeActive = false;
      ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled).Value = Entity.IsEnabled;
      if (ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled).SetAsNull == true)
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive).IsNull == false)
        Entity.IsNodeActive = ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive).GetAsBool();
      else
        Entity.IsNodeActive = false;
      Entity.SetOriginalValueForProperty(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive, ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive).Value);

      if (ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled).IsNull == false)
        Entity.IsEnabled = ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled).GetAsBool();
      else
        Entity.IsEnabled = false;
      Entity.SetOriginalValueForProperty(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled, ValidatorObject.Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled).Value);
