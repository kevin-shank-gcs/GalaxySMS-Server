  ...
  public class Cluster_SelectionListForSitePDSAData : PDSAStoredProcReadOnly
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitParameters()
    {
      ...
      param = new PDSADataParameter();
      param.ParameterName = Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageNumber;
      ...
      param = new PDSADataParameter();
      param.ParameterName = Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageSize;
      param.DBType = DbType.Int32;
      param.ParamDirection = ParameterDirection.Input;
      param.IsRefCursor = false;
      AllParameters.Add(param);
      ...
      param = new PDSADataParameter();
      param.ParameterName = Cluster_SelectionListForSitePDSAValidator.ParameterNames.SortColumn;
      ...
      param = new PDSADataParameter();
      param.ParameterName = Cluster_SelectionListForSitePDSAValidator.ParameterNames.DescendingOrder;
    ...
    protected override void InitDataColumns()
    {
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(Cluster_SelectionListForSitePDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_Cluster_SelectionListForSitePDSA_ClusterGroupId_Header", "Cluster Group Id"), false, typeof(int), DbType.Int32);
      AllColumns.Add(dc);
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount, GetResourceMessage("GCS_Cluster_SelectionListForSitePDSA_TotalRowCount_Header", "Total Row Count"), false, typeof(int), DbType.Int32);
      AllColumns.Add(dc);
    }
    #endregion
    ...
    protected override void EntityDataToParameterCollection()
    {
      ...
      if (AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageNumber).SetAsNull == false)
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageNumber).Value = Entity.PageNumber;
      else
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageNumber).Value = System.Data.SqlTypes.SqlInt32.Null;
      if (AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageSize).SetAsNull == false)
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageSize).Value = Entity.PageSize;
      else
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.PageSize).Value = System.Data.SqlTypes.SqlInt32.Null;
      if (AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.SortColumn).SetAsNull == false)
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.SortColumn).Value = Entity.SortColumn;
      else
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.SortColumn).Value = System.Data.SqlTypes.SqlChars.Null;
      if (AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.DescendingOrder).SetAsNull == false)
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.DescendingOrder).Value = Entity.DescendingOrder;
      else
        AllParameters.GetByName(Cluster_SelectionListForSitePDSAValidator.ParameterNames.DescendingOrder).Value = System.Data.SqlTypes.SqlBoolean.Null;
    }
    #endregion
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      if (AllColumns.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.ClusterGroupId).SetAsNull == false)
        ...
        AllColumns.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.ClusterGroupId).Value = 0;
      ...
      if (AllColumns.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount).SetAsNull == false)
        AllColumns.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount).Value = Entity.TotalRowCount;
      else
        AllColumns.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount).Value = 0;
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (AllColumns.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount).IsNull == false)
        Entity.TotalRowCount = AllColumns.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount).GetAsInteger();
      else
    ...
    public Cluster_SelectionListForSitePDSA CreateEntityFromDataRow(DataRow dr)
    {
      ...
      if (dr.Table.Columns.Contains(Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount))
      {
        if (dr[Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount] != DBNull.Value)
          entity.TotalRowCount = Convert.ToInt32(dr[Cluster_SelectionListForSitePDSAValidator.ColumnNames.TotalRowCount]);
      }
