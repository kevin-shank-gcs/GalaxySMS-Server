...
namespace GalaxySMS.DataLayer
{
    ...
    public partial class GalaxyInterfaceBoardSectionNodePDSAData : PDSADataClassTable
    {
        ...
        protected override void InitDataColumns()
        {
            ...
            prop = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.AccessPortalUid);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
            ...
            prop = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.PortalName);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
            ...
            prop = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputDeviceUid);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
            ...
            prop = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputName);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
            ...
            prop = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputDeviceUid);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
            ...
            prop = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputName);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
        ...
        protected override void EntityDataToColumnCollection()
        {
            ...
            ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.AccessPortalUid).Value = Entity.AccessPortalUid;
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.AccessPortalUid).SetAsNull == true)
                Entity.AccessPortalUid = Guid.Empty;
            ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.PortalName).Value = Entity.PortalName;
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.PortalName).SetAsNull == true)
                Entity.PortalName = string.Empty;
            ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputDeviceUid).Value = Entity.InputDeviceUid;
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputDeviceUid).SetAsNull == true)
                Entity.InputDeviceUid = Guid.Empty;
            ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputName).Value = Entity.InputName;
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputName).SetAsNull == true)
                Entity.InputName = string.Empty;
            ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputDeviceUid).Value = Entity.OutputDeviceUid;
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputDeviceUid).SetAsNull == true)
                Entity.OutputDeviceUid = Guid.Empty;
            ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputName).Value = Entity.OutputName;
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputName).SetAsNull == true)
        ...
        protected override void ColumnCollectionToEntityData()
        {
            ...
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InsertDate).IsNull == false)
                Entity.InsertDate = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InsertDate).GetAsDateTimeOffset();
            else
            ...
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.UpdateDate).IsNull == false)
                Entity.UpdateDate = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.UpdateDate).GetAsDateTimeOffset();
            else
            ...
            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.AccessPortalUid).IsNull == false)
                Entity.AccessPortalUid = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.AccessPortalUid).GetAsGuid();
            else
                Entity.AccessPortalUid = Guid.Empty;
            Entity.SetOriginalValueForProperty(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.AccessPortalUid, ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.AccessPortalUid).Value);

            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.PortalName).IsNull == false)
                Entity.PortalName = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.PortalName).GetAsString();
            else
                Entity.PortalName = string.Empty;
            Entity.SetOriginalValueForProperty(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.PortalName, ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.PortalName).Value);

            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputDeviceUid).IsNull == false)
                Entity.InputDeviceUid = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputDeviceUid).GetAsGuid();
            else
                Entity.InputDeviceUid = Guid.Empty;
            Entity.SetOriginalValueForProperty(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputDeviceUid, ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputDeviceUid).Value);

            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputName).IsNull == false)
                Entity.InputName = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputName).GetAsString();
            else
                Entity.InputName = string.Empty;
            Entity.SetOriginalValueForProperty(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputName, ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.InputName).Value);

            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputDeviceUid).IsNull == false)
                Entity.OutputDeviceUid = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputDeviceUid).GetAsGuid();
            else
                Entity.OutputDeviceUid = Guid.Empty;
            Entity.SetOriginalValueForProperty(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputDeviceUid, ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputDeviceUid).Value);

            if (ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputName).IsNull == false)
                Entity.OutputName = ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputName).GetAsString();
            else
                Entity.OutputName = string.Empty;
            Entity.SetOriginalValueForProperty(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputName, ValidatorObject.Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.OutputName).Value);
