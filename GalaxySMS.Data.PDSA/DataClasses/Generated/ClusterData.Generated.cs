...
namespace GalaxySMS.DataLayer
{
  ...
  public partial class ClusterPDSAData : PDSADataClassTable
  {
    ...
    public enum SelectFilters
    {
      ...
      ,
      /// <summary>
      /// 'InfoByTimeScheduleUid' SelectFilter
      /// </summary>
      InfoByTimeScheduleUid
      ,
      /// <summary>
    ...
    protected override void InitDataColumns()
    {
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description);
      prop.IsInsertable = true;
      prop.IsUpdatable = true;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = false;
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = false;
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = false;
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = false;
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = false;
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = false;
      ...
      prop = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = false;
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).Value = Entity.Description;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).SetAsNull == true)
        Entity.Description = string.Empty;
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).Value = Entity.PageNumber;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).SetAsNull == true)
        Entity.PageNumber = 0;
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).Value = Entity.PageSize;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).SetAsNull == true)
        Entity.PageSize = 0;
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).Value = Entity.TotalRowCount;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).SetAsNull == true)
        Entity.TotalRowCount = 0;
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).Value = Entity.SortColumn;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).SetAsNull == true)
        Entity.SortColumn = string.Empty;
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).Value = Entity.DescendingOrder;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).SetAsNull == true)
        Entity.DescendingOrder = false;
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).Value = Entity.PanelScheduleNumber;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).SetAsNull == true)
        Entity.PanelScheduleNumber = 0;
      ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).Value = Entity.TimeScheduleUid;
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).SetAsNull == true)
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.InsertDate).IsNull == false)
        Entity.InsertDate = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.InsertDate).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.UpdateDate).IsNull == false)
        Entity.UpdateDate = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.UpdateDate).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.AccessRuleOverrideTimeout).IsNull == false)
        Entity.AccessRuleOverrideTimeout = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.AccessRuleOverrideTimeout).GetAsInteger();
      else
        Entity.AccessRuleOverrideTimeout = 0;
      ...
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.UnlimitedCredentialTimeout).IsNull == false)
        Entity.UnlimitedCredentialTimeout = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.UnlimitedCredentialTimeout).GetAsInteger();
      else
        Entity.UnlimitedCredentialTimeout = 0;
      ...
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.CurrentTimeForCluster).IsNull == false)
        Entity.CurrentTimeForCluster = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.CurrentTimeForCluster).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).IsNull == false)
        Entity.Description = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).GetAsString();
      else
        Entity.Description = string.Empty;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.Description, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).Value);

      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).IsNull == false)
        Entity.PageNumber = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).GetAsInteger();
      else
        Entity.PageNumber = 0;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.PageNumber, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).Value);

      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).IsNull == false)
        Entity.PageSize = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).GetAsInteger();
      else
        Entity.PageSize = 0;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.PageSize, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).Value);

      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).IsNull == false)
        Entity.TotalRowCount = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).GetAsInteger();
      else
        Entity.TotalRowCount = 0;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.TotalRowCount, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).Value);

      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).IsNull == false)
        Entity.SortColumn = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).GetAsString();
      else
        Entity.SortColumn = string.Empty;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.SortColumn, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).Value);

      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).IsNull == false)
        Entity.DescendingOrder = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).GetAsBool();
      else
        Entity.DescendingOrder = false;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.DescendingOrder, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).Value);

      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).IsNull == false)
        Entity.PanelScheduleNumber = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).GetAsInteger();
      else
        Entity.PanelScheduleNumber = 0;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).Value);

      if (ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).IsNull == false)
        Entity.TimeScheduleUid = ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).GetAsGuid();
      else
        Entity.TimeScheduleUid = Guid.Empty;
      Entity.SetOriginalValueForProperty(ClusterPDSAValidator.ColumnNames.TimeScheduleUid, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).Value);
    ...
    public override string SelectSQL()
    {
      ...
      switch (SelectFilter)
      {
        ...
        case SelectFilters.BySiteUid:
          ...
          break;
        case SelectFilters.InfoByTimeScheduleUid:
          if (UseStoredProcs)
          {
            sb.Append("GCS.ClusterPDSA_InfoByTimeScheduleUid");
          }
          else
          {
          ...
          switch (InsertFilter)
          {
            case InsertFilters.All:
             CommandObject.Parameters.Clear();
              ...
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@ClusterNumber", DbType.Int32, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.ClusterNumber).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@ClusterName", DbType.String, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.ClusterName).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@Description", DbType.String, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
              ...
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@AccessRuleOverrideTimeout", DbType.Int32, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.AccessRuleOverrideTimeout).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
                  "@UnlimitedCredentialTimeout", DbType.Int32, ValidatorObject.Properties.GetByName(ClusterPDSAValidator.ColumnNames.UnlimitedCredentialTimeout).Value));
              CommandObject.Parameters.Add(DataProvider.CreateParameter( 
