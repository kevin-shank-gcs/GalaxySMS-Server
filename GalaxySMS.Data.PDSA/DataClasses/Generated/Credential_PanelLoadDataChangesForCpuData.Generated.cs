...
namespace GalaxySMS.DataLayer
{
  ...
  public partial class Credential_PanelLoadDataChangesForCpuPDSAData : PDSADataClassReadOnly
  {
    ...
    protected override void InitDataColumns()
    {
      ...
      prop = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate).Value = Entity.PersonEmploymentDate;
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate).SetAsNull == true)
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialChangeDate).IsNull == false)
        Entity.LastCredentialChangeDate = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialChangeDate).GetAsDateTimeOffset();
      else
        Entity.LastCredentialChangeDate = DateTimeOffset.MinValue;
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialLoadedDate).IsNull == false)
        Entity.LastCredentialLoadedDate = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialLoadedDate).GetAsDateTimeOffset();
      else
        Entity.LastCredentialLoadedDate = DateTimeOffset.MinValue;
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonActivationDateTime).IsNull == false)
        Entity.PersonActivationDateTime = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonActivationDateTime).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonExpirationDateTime).IsNull == false)
        Entity.PersonExpirationDateTime = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonExpirationDateTime).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate).IsNull == false)
        Entity.PersonEmploymentDate = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate).GetAsDate();
      else
        Entity.PersonEmploymentDate = null;
      Entity.SetOriginalValueForProperty(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate, ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate).Value);
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialActivationDateTime).IsNull == false)
        Entity.CredentialActivationDateTime = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialActivationDateTime).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialExpirationDateTime).IsNull == false)
        Entity.CredentialExpirationDateTime = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialExpirationDateTime).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastPanelImpactingChangeDate).IsNull == false)
        Entity.LastPanelImpactingChangeDate = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastPanelImpactingChangeDate).GetAsDateTimeOffset();
      else
        Entity.LastPanelImpactingChangeDate = DateTimeOffset.MinValue;
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdStartingDate).IsNull == false)
        Entity.LcdStartingDate = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdStartingDate).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdEndingDate).IsNull == false)
        Entity.LcdEndingDate = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdEndingDate).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster).IsNull == false)
        Entity.CurrentTimeForCluster = ValidatorObject.Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster).GetAsDateTimeOffset();
      else
