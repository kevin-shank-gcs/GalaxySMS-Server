...
namespace GalaxySMS.DataLayer
{
  ...
  public partial class UnacknowledgedAlarmsPDSAData : PDSADataClassReadOnly
  {
    ...
    protected override void InitDataColumns()
    {
      ...
      prop = ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
      ...
      prop = ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).Value = Entity.ResponseRequired;
      if (ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).SetAsNull == true)
      ...
      ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).Value = Entity.ColorHex;
      if (ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).SetAsNull == true)
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.DateTime_x).IsNull == false)
        Entity.DateTime_x = ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.DateTime_x).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).IsNull == false)
        Entity.ResponseRequired = ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).GetAsBool();
      else
        Entity.ResponseRequired = false;
      Entity.SetOriginalValueForProperty(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired, ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).Value);
      ...
      if (ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).IsNull == false)
        Entity.ColorHex = ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).GetAsString();
      else
        Entity.ColorHex = string.Empty;
      Entity.SetOriginalValueForProperty(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex, ValidatorObject.Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).Value);
