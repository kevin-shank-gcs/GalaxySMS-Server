...
namespace GalaxySMS.DataLayer
{
    ...
    public partial class PersonPDSAData : PDSADataClassTable
    {
        ...
        protected override void InitDataColumns()
        {
            ...
            prop = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivityEventText);
            ...
            prop = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActiveStatusCode);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
            ...
            prop = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.DepartmentName);
            prop.IsInsertable = false;
            prop.IsUpdatable = false;
            prop.IsPrimaryKey = false;
            prop.IncludeInAuditTracking = false;
        ...
        protected override void EntityDataToColumnCollection()
        {
            ...
            ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivityEventText).Value = Entity.ActivityEventText;
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivityEventText).SetAsNull == true)
                Entity.ActivityEventText = string.Empty;
            ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActiveStatusCode).Value = Entity.ActiveStatusCode;
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActiveStatusCode).SetAsNull == true)
                Entity.ActiveStatusCode = 0;
            ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.DepartmentName).Value = Entity.DepartmentName;
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.DepartmentName).SetAsNull == true)
        ...
        protected override void ColumnCollectionToEntityData()
        {
            ...
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivationDateTime).IsNull == false)
                Entity.ActivationDateTime = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivationDateTime).GetAsDateTimeOffset();
            else
                Entity.ActivationDateTime = null;
            ...
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ExpirationDateTime).IsNull == false)
                Entity.ExpirationDateTime = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ExpirationDateTime).GetAsDateTimeOffset();
            else
                Entity.ExpirationDateTime = null;
            ...
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.InsertDate).IsNull == false)
                Entity.InsertDate = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.InsertDate).GetAsDateTimeOffset();
            else
            ...
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.UpdateDate).IsNull == false)
                Entity.UpdateDate = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.UpdateDate).GetAsDateTimeOffset();
            else
            ...
            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivityEventText).IsNull == false)
                Entity.ActivityEventText = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivityEventText).GetAsString();
            else
                Entity.ActivityEventText = string.Empty;
            Entity.SetOriginalValueForProperty(PersonPDSAValidator.ColumnNames.ActivityEventText, ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActivityEventText).Value);

            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActiveStatusCode).IsNull == false)
                Entity.ActiveStatusCode = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActiveStatusCode).GetAsShort();
            else
                Entity.ActiveStatusCode = 0;
            Entity.SetOriginalValueForProperty(PersonPDSAValidator.ColumnNames.ActiveStatusCode, ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.ActiveStatusCode).Value);

            if (ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.DepartmentName).IsNull == false)
                Entity.DepartmentName = ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.DepartmentName).GetAsString();
            else
                Entity.DepartmentName = string.Empty;
            Entity.SetOriginalValueForProperty(PersonPDSAValidator.ColumnNames.DepartmentName, ValidatorObject.Properties.GetByName(PersonPDSAValidator.ColumnNames.DepartmentName).Value);
