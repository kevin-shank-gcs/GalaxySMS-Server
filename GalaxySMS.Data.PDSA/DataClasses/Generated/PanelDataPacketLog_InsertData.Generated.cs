  ...
  public class PanelDataPacketLog_InsertPDSAData : PDSAStoredProcExecute
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitParameters()
    {
      ...
      param = new PDSADataParameter();
      param.ParameterName = PanelDataPacketLog_InsertPDSAData.ParameterNames.ClusterGroupId;
    ...
    protected override void EntityDataToParameterCollection()
    {
      ...
      if (AllParameters.GetByName(PanelDataPacketLog_InsertPDSAValidator.ParameterNames.ClusterGroupId).SetAsNull == false)
        AllParameters.GetByName(PanelDataPacketLog_InsertPDSAValidator.ParameterNames.ClusterGroupId).Value = Entity.ClusterGroupId;
      else
        AllParameters.GetByName(PanelDataPacketLog_InsertPDSAValidator.ParameterNames.ClusterGroupId).Value = System.Data.SqlTypes.SqlInt32.Null;
