  ...
  public class insert_AccessPortalActivityEventPDSAData : PDSAStoredProcExecute
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitParameters()
    {
      ...
      param = new PDSADataParameter();
      param.ParameterName = insert_AccessPortalActivityEventPDSAData.ParameterNames.ResponseRequired;
      param.DBType = DbType.Boolean;
      param.IsRefCursor = false;
      param.ParamDirection = ParameterDirection.Input;
      AllParameters.Add(param);
      ...
      param = new PDSADataParameter();
      param.ParameterName = insert_AccessPortalActivityEventPDSAData.ParameterNames.IsAccessGrantedEvent;
      param.DBType = DbType.Boolean;
      param.IsRefCursor = false;
      param.ParamDirection = ParameterDirection.Input;
      AllParameters.Add(param);
    ...
    protected override void EntityDataToParameterCollection()
    {
      ...
      if (AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.eventType).SetAsNull == false)
        ...
        AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.eventType).Value = System.Data.SqlTypes.SqlChars.Null;
      ...
      if (AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.ResponseRequired).SetAsNull == false)
        AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.ResponseRequired).Value = Entity.ResponseRequired;
      else
        AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.ResponseRequired).Value = System.Data.SqlTypes.SqlBoolean.Null;
      ...
      if (AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.IsAccessGrantedEvent).SetAsNull == false)
        AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.IsAccessGrantedEvent).Value = Entity.IsAccessGrantedEvent;
      else
        AllParameters.GetByName(insert_AccessPortalActivityEventPDSAValidator.ParameterNames.IsAccessGrantedEvent).Value = System.Data.SqlTypes.SqlBoolean.Null;
    }
    #endregion
