...
namespace GalaxySMS.DataLayer
{
  ...
  public partial class AcknowledgedAlarmBasicDataPDSAData : PDSADataClassReadOnly
  {
    ...
    public enum WhereFilters
    {
      ...
      ,
      /// <summary>
      /// 'Response' WhereFilter
      /// </summary>
      Response
      ,
      /// <summary>
      /// 'LikeResponse' WhereFilter
      /// </summary>
      LikeResponse
    }
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(AcknowledgedAlarmBasicDataPDSAValidator.ColumnNames.AckedDateTime).IsNull == false)
        Entity.AckedDateTime = ValidatorObject.Properties.GetByName(AcknowledgedAlarmBasicDataPDSAValidator.ColumnNames.AckedDateTime).GetAsDateTimeOffset();
      else
      ...
      if (ValidatorObject.Properties.GetByName(AcknowledgedAlarmBasicDataPDSAValidator.ColumnNames.AckedUpdatedDateTime).IsNull == false)
        Entity.AckedUpdatedDateTime = ValidatorObject.Properties.GetByName(AcknowledgedAlarmBasicDataPDSAValidator.ColumnNames.AckedUpdatedDateTime).GetAsDateTimeOffset();
      else
    ...
    public override string SelectSQL()
    {
      ...
      switch (SelectFilter)
      {
        case SelectFilters.All:
          sb.Append(" SELECT ActivityEventUid, DeviceEntityId, DeviceUid, AccessPortalAlarmEventAcknowledgmentUid, GalaxyPanelAlarmEventAcknowledgmentUid, InputDeviceAlarmEventAcknowledgmentUid, Response, AckedByUserId, AckedByUserDisplayName, AckedDateTime, AckedUpdatedDateTime FROM GCS.AcknowledgedAlarmBasicData");

          
          break;
        case SelectFilters.Search:
          sb.Append(" SELECT ActivityEventUid, DeviceEntityId, DeviceUid, AccessPortalAlarmEventAcknowledgmentUid, GalaxyPanelAlarmEventAcknowledgmentUid, InputDeviceAlarmEventAcknowledgmentUid, Response, AckedByUserId, AckedByUserDisplayName, AckedDateTime, AckedUpdatedDateTime FROM GCS.AcknowledgedAlarmBasicData WHERE (@Response IS NULL OR Response LIKE @Response + '%')");
    ...
    public override string RowCountSQL()
    {
      ...
      switch (RowCountFilter)
      {
        case RowCountFilters.All:
          sb.Append(" SELECT Count(*) As NumRecs FROM GCS.AcknowledgedAlarmBasicData");
    ...
    public override string WhereClauseSQL()
    {
      ...
      switch (WhereFilter)
      {
        ...
        case WhereFilters.Response:
          sb.Append(" WHERE Response = @Response");

          
          break;
        case WhereFilters.LikeResponse:
          sb.Append(" WHERE Response LIKE @Response + '%'");
    ...
    public override string OrderByClauseSQL()
    {
      ...
      switch (OrderByFilter)
      {
        ...
        case OrderByFilters.Response:
          sb.Append(" ORDER BY Response");
