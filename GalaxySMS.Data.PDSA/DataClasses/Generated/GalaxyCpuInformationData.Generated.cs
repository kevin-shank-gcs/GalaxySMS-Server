...
namespace GalaxySMS.DataLayer
{
  ...
  public partial class GalaxyCpuInformationPDSAData : PDSADataClassReadOnly
  {
    ...
    protected override void InitDataColumns()
    {
      ...
      prop = ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.EntityType);
      prop.IsInsertable = false;
      prop.IsUpdatable = false;
      prop.IsPrimaryKey = false;
      prop.IncludeInAuditTracking = true;
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.EntityType).Value = Entity.EntityType;
      if (ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.EntityType).SetAsNull == true)
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.ClusterNumber).IsNull == false)
        Entity.ClusterNumber = ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.ClusterNumber).GetAsInteger();
      else
        Entity.ClusterNumber = 0;
      ...
      if (ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.PanelNumber).IsNull == false)
        Entity.PanelNumber = ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.PanelNumber).GetAsInteger();
      else
        Entity.PanelNumber = 0;
      ...
      if (ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.EntityType).IsNull == false)
        Entity.EntityType = ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.EntityType).GetAsString();
      else
        Entity.EntityType = string.Empty;
      Entity.SetOriginalValueForProperty(GalaxyCpuInformationPDSAValidator.ColumnNames.EntityType, ValidatorObject.Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.EntityType).Value);
