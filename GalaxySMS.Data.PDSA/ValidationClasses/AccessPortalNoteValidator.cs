...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalNotePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalNotePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalNotePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalNotePDSA</param>
    public AccessPortalNotePDSAValidator(AccessPortalNotePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalNotePDSAValidator";

      // Create Properties for each field in the AccessPortalNotePDSA entity class
      InitProperties();
    ...
    public AccessPortalNotePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalNotePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalNotePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalNotePDSAValidator.ColumnNames.DateColumnNameHere);
