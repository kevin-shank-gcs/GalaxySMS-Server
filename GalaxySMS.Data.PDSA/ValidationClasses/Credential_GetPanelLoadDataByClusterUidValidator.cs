...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Credential_GetPanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_GetPanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_GetPanelLoadDataByClusterUidPDSA</param>
    public Credential_GetPanelLoadDataByClusterUidPDSAValidator(Credential_GetPanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_GetPanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the Credential_GetPanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
