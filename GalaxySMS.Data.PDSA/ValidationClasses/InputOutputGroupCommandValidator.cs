...
{
  /// <summary>
  /// Used to validate business rules on the InputOutputGroupCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputOutputGroupCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupCommandPDSA</param>
    public InputOutputGroupCommandPDSAValidator(InputOutputGroupCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupCommandPDSAValidator";

      // Create Properties for each field in the InputOutputGroupCommandPDSA entity class
      InitProperties();
    ...
    public InputOutputGroupCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputOutputGroupCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupCommandPDSAValidator.ColumnNames.DateColumnNameHere);
