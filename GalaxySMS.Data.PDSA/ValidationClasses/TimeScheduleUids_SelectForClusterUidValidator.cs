...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeScheduleUids_SelectForClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeScheduleUids_SelectForClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeScheduleUids_SelectForClusterUidPDSA</param>
    public TimeScheduleUids_SelectForClusterUidPDSAValidator(TimeScheduleUids_SelectForClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeScheduleUids_SelectForClusterUidPDSAValidator";

      // Create Properties for each field in the TimeScheduleUids_SelectForClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeScheduleUids_SelectForClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeScheduleUids_SelectForClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
