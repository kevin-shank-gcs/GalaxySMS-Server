...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class SelectParentAndChildEntitiesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the SelectParentAndChildEntitiesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a SelectParentAndChildEntitiesPDSA</param>
    public SelectParentAndChildEntitiesPDSAValidator(SelectParentAndChildEntitiesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "SelectParentAndChildEntitiesPDSAValidator";

      // Create Properties for each field in the SelectParentAndChildEntitiesPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(SelectParentAndChildEntitiesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(SelectParentAndChildEntitiesPDSAValidator.ColumnNames.DateColumnNameHere);
