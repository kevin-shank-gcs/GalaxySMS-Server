...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterEntityMapUniquePDSA</param>
    public IsClusterEntityMapUniquePDSAValidator(IsClusterEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsClusterEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
