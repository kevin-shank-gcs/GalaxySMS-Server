...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSA</param>
    public CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator";

      // Create Properties for each field in the CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DateColumnNameHere);
