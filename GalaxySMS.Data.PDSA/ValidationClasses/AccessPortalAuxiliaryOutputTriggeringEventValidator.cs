...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAuxiliaryOutputTriggeringEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAuxiliaryOutputTriggeringEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAuxiliaryOutputTriggeringEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAuxiliaryOutputTriggeringEventPDSA</param>
    public AccessPortalAuxiliaryOutputTriggeringEventPDSAValidator(AccessPortalAuxiliaryOutputTriggeringEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAuxiliaryOutputTriggeringEventPDSAValidator";

      // Create Properties for each field in the AccessPortalAuxiliaryOutputTriggeringEventPDSA entity class
      InitProperties();
    ...
    public AccessPortalAuxiliaryOutputTriggeringEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAuxiliaryOutputTriggeringEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAuxiliaryOutputTriggeringEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAuxiliaryOutputTriggeringEventPDSAValidator.ColumnNames.DateColumnNameHere);
