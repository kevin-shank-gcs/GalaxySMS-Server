...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalTimeSchedulePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalTimeSchedulePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalTimeSchedulePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalTimeSchedulePDSA</param>
    public AccessPortalTimeSchedulePDSAValidator(AccessPortalTimeSchedulePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalTimeSchedulePDSAValidator";

      // Create Properties for each field in the AccessPortalTimeSchedulePDSA entity class
      InitProperties();
    ...
    public AccessPortalTimeSchedulePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalTimeSchedulePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalTimeSchedulePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalTimeSchedulePDSAValidator.ColumnNames.DateColumnNameHere);
