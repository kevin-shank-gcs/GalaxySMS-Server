...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessGroupAccessPortalUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessGroupAccessPortalUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessGroupAccessPortalUniquePDSA</param>
    public IsAccessGroupAccessPortalUniquePDSAValidator(IsAccessGroupAccessPortalUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessGroupAccessPortalUniquePDSAValidator";

      // Create Properties for each field in the IsAccessGroupAccessPortalUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessGroupAccessPortalUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessGroupAccessPortalUniquePDSAValidator.ColumnNames.DateColumnNameHere);
