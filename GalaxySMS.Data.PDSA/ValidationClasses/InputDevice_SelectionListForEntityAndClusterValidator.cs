...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_SelectionListForEntityAndClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_SelectionListForEntityAndClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_SelectionListForEntityAndClusterPDSA</param>
    public InputDevice_SelectionListForEntityAndClusterPDSAValidator(InputDevice_SelectionListForEntityAndClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_SelectionListForEntityAndClusterPDSAValidator";

      // Create Properties for each field in the InputDevice_SelectionListForEntityAndClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.DateColumnNameHere);
