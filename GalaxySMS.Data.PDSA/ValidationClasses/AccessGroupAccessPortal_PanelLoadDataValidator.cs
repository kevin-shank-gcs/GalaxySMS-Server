...
{
  /// <summary>
  /// Used to validate business rules on the AccessGroupAccessPortal_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class AccessGroupAccessPortal_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortal_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortal_PanelLoadDataPDSA</param>
    public AccessGroupAccessPortal_PanelLoadDataPDSAValidator(AccessGroupAccessPortal_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortal_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortal_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AccessGroupAccessPortal_PanelLoadDataPDSA object</returns>
    public AccessGroupAccessPortal_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessGroupAccessPortal_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
