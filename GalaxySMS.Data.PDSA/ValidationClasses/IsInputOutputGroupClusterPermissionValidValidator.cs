...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupClusterPermissionValidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupClusterPermissionValidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupClusterPermissionValidPDSA</param>
    public IsInputOutputGroupClusterPermissionValidPDSAValidator(IsInputOutputGroupClusterPermissionValidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupClusterPermissionValidPDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupClusterPermissionValidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupClusterPermissionValidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupClusterPermissionValidPDSAValidator.ColumnNames.DateColumnNameHere);
