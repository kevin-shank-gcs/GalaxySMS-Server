...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserInRoleNamePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserInRoleNamePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserInRoleNamePDSA</param>
    public gcs_IsUserInRoleNamePDSAValidator(gcs_IsUserInRoleNamePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserInRoleNamePDSAValidator";

      // Create Properties for each field in the gcs_IsUserInRoleNamePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserInRoleNamePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserInRoleNamePDSAValidator.ColumnNames.DateColumnNameHere);
