...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyAreaPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyAreaPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyAreaPDSA</param>
    public GetEntityIdForGalaxyAreaPDSAValidator(GetEntityIdForGalaxyAreaPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyAreaPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyAreaPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyAreaPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyAreaPDSAValidator.ColumnNames.DateColumnNameHere);
