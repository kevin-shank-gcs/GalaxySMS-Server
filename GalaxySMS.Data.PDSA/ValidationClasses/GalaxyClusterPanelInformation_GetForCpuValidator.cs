...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyClusterPanelInformation_GetForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyClusterPanelInformation_GetForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyClusterPanelInformation_GetForCpuPDSA</param>
    public GalaxyClusterPanelInformation_GetForCpuPDSAValidator(GalaxyClusterPanelInformation_GetForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyClusterPanelInformation_GetForCpuPDSAValidator";

      // Create Properties for each field in the GalaxyClusterPanelInformation_GetForCpuPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyClusterPanelInformation_GetForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyClusterPanelInformation_GetForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
