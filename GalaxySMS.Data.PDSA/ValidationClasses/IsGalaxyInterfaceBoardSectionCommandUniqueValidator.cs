...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInterfaceBoardSectionCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInterfaceBoardSectionCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInterfaceBoardSectionCommandUniquePDSA</param>
    public IsGalaxyInterfaceBoardSectionCommandUniquePDSAValidator(IsGalaxyInterfaceBoardSectionCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInterfaceBoardSectionCommandUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInterfaceBoardSectionCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
