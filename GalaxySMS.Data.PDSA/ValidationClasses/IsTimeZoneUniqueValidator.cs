...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimeZoneUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimeZoneUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimeZoneUniquePDSA</param>
    public IsTimeZoneUniquePDSAValidator(IsTimeZoneUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimeZoneUniquePDSAValidator";

      // Create Properties for each field in the IsTimeZoneUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimeZoneUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimeZoneUniquePDSAValidator.ColumnNames.DateColumnNameHere);
