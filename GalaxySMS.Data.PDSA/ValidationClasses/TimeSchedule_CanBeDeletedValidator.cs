...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeSchedule_CanBeDeletedPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedule_CanBeDeletedPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedule_CanBeDeletedPDSA</param>
    public TimeSchedule_CanBeDeletedPDSAValidator(TimeSchedule_CanBeDeletedPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedule_CanBeDeletedPDSAValidator";

      // Create Properties for each field in the TimeSchedule_CanBeDeletedPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedule_CanBeDeletedPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedule_CanBeDeletedPDSAValidator.ColumnNames.DateColumnNameHere);
