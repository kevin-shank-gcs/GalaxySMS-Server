...
{
  /// <summary>
  /// Used to validate business rules on the AssaAccessPointPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaAccessPointPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaAccessPointPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaAccessPointPDSA</param>
    public AssaAccessPointPDSAValidator(AssaAccessPointPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaAccessPointPDSAValidator";

      // Create Properties for each field in the AssaAccessPointPDSA entity class
      InitProperties();
    ...
    public AssaAccessPointPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaAccessPointPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaAccessPointPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaAccessPointPDSAValidator.ColumnNames.DateColumnNameHere);
