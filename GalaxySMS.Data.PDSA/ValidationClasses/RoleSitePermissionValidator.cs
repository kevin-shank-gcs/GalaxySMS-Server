...
{
  /// <summary>
  /// Used to validate business rules on the RoleSitePermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleSitePermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleSitePermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleSitePermissionPDSA</param>
    public RoleSitePermissionPDSAValidator(RoleSitePermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleSitePermissionPDSAValidator";

      // Create Properties for each field in the RoleSitePermissionPDSA entity class
      InitProperties();
    ...
    public RoleSitePermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleSitePermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleSitePermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleSitePermissionPDSAValidator.ColumnNames.DateColumnNameHere);
