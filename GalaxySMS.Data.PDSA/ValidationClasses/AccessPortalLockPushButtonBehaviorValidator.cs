...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalLockPushButtonBehaviorPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalLockPushButtonBehaviorPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalLockPushButtonBehaviorPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalLockPushButtonBehaviorPDSA</param>
    public AccessPortalLockPushButtonBehaviorPDSAValidator(AccessPortalLockPushButtonBehaviorPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalLockPushButtonBehaviorPDSAValidator";

      // Create Properties for each field in the AccessPortalLockPushButtonBehaviorPDSA entity class
      InitProperties();
    ...
    public AccessPortalLockPushButtonBehaviorPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalLockPushButtonBehaviorPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalLockPushButtonBehaviorPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalLockPushButtonBehaviorPDSAValidator.ColumnNames.DateColumnNameHere);
