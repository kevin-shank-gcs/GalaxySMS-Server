...
{
  /// <summary>
  /// Used to validate business rules on the PersonInputOutputGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonInputOutputGroupPDSA</param>
    public PersonInputOutputGroupPDSAValidator(PersonInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonInputOutputGroupPDSAValidator";

      // Create Properties for each field in the PersonInputOutputGroupPDSA entity class
      InitProperties();
    ...
    public PersonInputOutputGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonInputOutputGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
