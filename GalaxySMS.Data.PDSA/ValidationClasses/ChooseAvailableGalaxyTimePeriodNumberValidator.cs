...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailableGalaxyTimePeriodNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailableGalaxyTimePeriodNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailableGalaxyTimePeriodNumberPDSA</param>
    public ChooseAvailableGalaxyTimePeriodNumberPDSAValidator(ChooseAvailableGalaxyTimePeriodNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailableGalaxyTimePeriodNumberPDSAValidator";

      // Create Properties for each field in the ChooseAvailableGalaxyTimePeriodNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailableGalaxyTimePeriodNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailableGalaxyTimePeriodNumberPDSAValidator.ColumnNames.DateColumnNameHere);
