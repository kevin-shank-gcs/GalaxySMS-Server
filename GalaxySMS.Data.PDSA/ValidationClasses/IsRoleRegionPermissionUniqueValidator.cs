...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleRegionPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleRegionPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleRegionPermissionUniquePDSA</param>
    public IsRoleRegionPermissionUniquePDSAValidator(IsRoleRegionPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleRegionPermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleRegionPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleRegionPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleRegionPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
