...
{
  /// <summary>
  /// Used to validate business rules on the ClusterTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterTypePDSA</param>
    public ClusterTypePDSAValidator(ClusterTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterTypePDSAValidator";

      // Create Properties for each field in the ClusterTypePDSA entity class
      InitProperties();
    ...
    public ClusterTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterTypePDSAValidator.ColumnNames.DateColumnNameHere);
