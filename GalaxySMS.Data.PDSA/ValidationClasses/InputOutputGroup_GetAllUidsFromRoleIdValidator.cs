...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroup_GetAllUidsFromRoleIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroup_GetAllUidsFromRoleIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroup_GetAllUidsFromRoleIdPDSA</param>
    public InputOutputGroup_GetAllUidsFromRoleIdPDSAValidator(InputOutputGroup_GetAllUidsFromRoleIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroup_GetAllUidsFromRoleIdPDSAValidator";

      // Create Properties for each field in the InputOutputGroup_GetAllUidsFromRoleIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroup_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroup_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.DateColumnNameHere);
