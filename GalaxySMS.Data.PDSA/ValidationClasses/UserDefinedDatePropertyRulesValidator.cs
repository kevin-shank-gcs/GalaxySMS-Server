...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedDatePropertyRulesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedDatePropertyRulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedDatePropertyRulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedDatePropertyRulesPDSA</param>
    public UserDefinedDatePropertyRulesPDSAValidator(UserDefinedDatePropertyRulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedDatePropertyRulesPDSAValidator";

      // Create Properties for each field in the UserDefinedDatePropertyRulesPDSA entity class
      InitProperties();
    ...
    public UserDefinedDatePropertyRulesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedDatePropertyRulesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedDatePropertyRulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedDatePropertyRulesPDSAValidator.ColumnNames.DateColumnNameHere);
