...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonExpirationModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonExpirationModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonExpirationModeUniquePDSA</param>
    public IsPersonExpirationModeUniquePDSAValidator(IsPersonExpirationModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonExpirationModeUniquePDSAValidator";

      // Create Properties for each field in the IsPersonExpirationModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonExpirationModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonExpirationModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
