...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedListPropertyRulesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedListPropertyRulesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedListPropertyRulesUniquePDSA</param>
    public IsUserDefinedListPropertyRulesUniquePDSAValidator(IsUserDefinedListPropertyRulesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedListPropertyRulesUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedListPropertyRulesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedListPropertyRulesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedListPropertyRulesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
