...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsOutputCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsOutputCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsOutputCommandUniquePDSA</param>
    public IsOutputCommandUniquePDSAValidator(IsOutputCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsOutputCommandUniquePDSAValidator";

      // Create Properties for each field in the IsOutputCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsOutputCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsOutputCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
