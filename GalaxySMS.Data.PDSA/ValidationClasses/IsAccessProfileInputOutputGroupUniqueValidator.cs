...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessProfileInputOutputGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessProfileInputOutputGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessProfileInputOutputGroupUniquePDSA</param>
    public IsAccessProfileInputOutputGroupUniquePDSAValidator(IsAccessProfileInputOutputGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessProfileInputOutputGroupUniquePDSAValidator";

      // Create Properties for each field in the IsAccessProfileInputOutputGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessProfileInputOutputGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessProfileInputOutputGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
