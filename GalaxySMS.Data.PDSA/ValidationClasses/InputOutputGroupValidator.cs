...
{
  /// <summary>
  /// Used to validate business rules on the InputOutputGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupPDSA</param>
    public InputOutputGroupPDSAValidator(InputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupPDSAValidator";

      // Create Properties for each field in the InputOutputGroupPDSA entity class
      InitProperties();
    ...
    public InputOutputGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputOutputGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
