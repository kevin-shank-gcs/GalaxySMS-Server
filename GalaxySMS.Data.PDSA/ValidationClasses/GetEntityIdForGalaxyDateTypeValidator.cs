...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyDateTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyDateTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyDateTypePDSA</param>
    public GetEntityIdForGalaxyDateTypePDSAValidator(GetEntityIdForGalaxyDateTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyDateTypePDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyDateTypePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyDateTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyDateTypePDSAValidator.ColumnNames.DateColumnNameHere);
