...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessGroupClusterPermissionValidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessGroupClusterPermissionValidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessGroupClusterPermissionValidPDSA</param>
    public IsAccessGroupClusterPermissionValidPDSAValidator(IsAccessGroupClusterPermissionValidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessGroupClusterPermissionValidPDSAValidator";

      // Create Properties for each field in the IsAccessGroupClusterPermissionValidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessGroupClusterPermissionValidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessGroupClusterPermissionValidPDSAValidator.ColumnNames.DateColumnNameHere);
