...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyCpuLoggingControl_SavePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuLoggingControl_SavePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuLoggingControl_SavePDSA</param>
    public GalaxyCpuLoggingControl_SavePDSAValidator(GalaxyCpuLoggingControl_SavePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuLoggingControl_SavePDSAValidator";

      // Create Properties for each field in the GalaxyCpuLoggingControl_SavePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuLoggingControl_SavePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuLoggingControl_SavePDSAValidator.ColumnNames.DateColumnNameHere);
