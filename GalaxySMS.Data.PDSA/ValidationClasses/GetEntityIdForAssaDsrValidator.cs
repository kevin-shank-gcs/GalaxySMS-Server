...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForAssaDsrPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForAssaDsrPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForAssaDsrPDSA</param>
    public GetEntityIdForAssaDsrPDSAValidator(GetEntityIdForAssaDsrPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForAssaDsrPDSAValidator";

      // Create Properties for each field in the GetEntityIdForAssaDsrPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForAssaDsrPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForAssaDsrPDSAValidator.ColumnNames.DateColumnNameHere);
