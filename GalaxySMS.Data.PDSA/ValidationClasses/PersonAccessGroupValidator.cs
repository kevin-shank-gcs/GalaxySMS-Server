...
{
  /// <summary>
  /// Used to validate business rules on the PersonAccessGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonAccessGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonAccessGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonAccessGroupPDSA</param>
    public PersonAccessGroupPDSAValidator(PersonAccessGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonAccessGroupPDSAValidator";

      // Create Properties for each field in the PersonAccessGroupPDSA entity class
      InitProperties();
    ...
    public PersonAccessGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonAccessGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonAccessGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonAccessGroupPDSAValidator.ColumnNames.DateColumnNameHere);
