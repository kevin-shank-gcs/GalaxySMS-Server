...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleRegionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleRegionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleRegionUniquePDSA</param>
    public IsRoleRegionUniquePDSAValidator(IsRoleRegionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleRegionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleRegionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleRegionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleRegionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
