...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalLockPushButtonBehaviorUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalLockPushButtonBehaviorUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalLockPushButtonBehaviorUniquePDSA</param>
    public IsAccessPortalLockPushButtonBehaviorUniquePDSAValidator(IsAccessPortalLockPushButtonBehaviorUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalLockPushButtonBehaviorUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalLockPushButtonBehaviorUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalLockPushButtonBehaviorUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalLockPushButtonBehaviorUniquePDSAValidator.ColumnNames.DateColumnNameHere);
