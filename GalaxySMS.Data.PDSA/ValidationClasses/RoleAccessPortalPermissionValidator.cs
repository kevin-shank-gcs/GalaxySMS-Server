...
{
  /// <summary>
  /// Used to validate business rules on the RoleAccessPortalPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleAccessPortalPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleAccessPortalPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleAccessPortalPermissionPDSA</param>
    public RoleAccessPortalPermissionPDSAValidator(RoleAccessPortalPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleAccessPortalPermissionPDSAValidator";

      // Create Properties for each field in the RoleAccessPortalPermissionPDSA entity class
      InitProperties();
    ...
    public RoleAccessPortalPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleAccessPortalPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleAccessPortalPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleAccessPortalPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
