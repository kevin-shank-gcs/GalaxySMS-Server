...
{
  /// <summary>
  /// Used to validate business rules on the CredentialReaderTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialReaderTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialReaderTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialReaderTypePDSA</param>
    public CredentialReaderTypePDSAValidator(CredentialReaderTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialReaderTypePDSAValidator";

      // Create Properties for each field in the CredentialReaderTypePDSA entity class
      InitProperties();
    ...
    public CredentialReaderTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialReaderTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialReaderTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialReaderTypePDSAValidator.ColumnNames.DateColumnNameHere);
