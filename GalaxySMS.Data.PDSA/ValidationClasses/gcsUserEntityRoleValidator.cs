...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserEntityRolePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserEntityRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserEntityRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserEntityRolePDSA</param>
    public gcsUserEntityRolePDSAValidator(gcsUserEntityRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserEntityRolePDSAValidator";

      // Create Properties for each field in the gcsUserEntityRolePDSA entity class
      InitProperties();
    ...
    public gcsUserEntityRolePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserEntityRolePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserEntityRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserEntityRolePDSAValidator.ColumnNames.DateColumnNameHere);
