...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevicePDSA_GetNamesForSiteUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevicePDSA_GetNamesForSiteUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevicePDSA_GetNamesForSiteUidPDSA</param>
    public OutputDevicePDSA_GetNamesForSiteUidPDSAValidator(OutputDevicePDSA_GetNamesForSiteUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevicePDSA_GetNamesForSiteUidPDSAValidator";

      // Create Properties for each field in the OutputDevicePDSA_GetNamesForSiteUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevicePDSA_GetNamesForSiteUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevicePDSA_GetNamesForSiteUidPDSAValidator.ColumnNames.DateColumnNameHere);
