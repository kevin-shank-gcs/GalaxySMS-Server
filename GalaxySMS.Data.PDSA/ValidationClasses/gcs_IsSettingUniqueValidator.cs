...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsSettingUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsSettingUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsSettingUniquePDSA</param>
    public gcs_IsSettingUniquePDSAValidator(gcs_IsSettingUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsSettingUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsSettingUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsSettingUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsSettingUniquePDSAValidator.ColumnNames.DateColumnNameHere);
