...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercScpUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercScpUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercScpUniquePDSA</param>
    public IsMercScpUniquePDSAValidator(IsMercScpUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercScpUniquePDSAValidator";

      // Create Properties for each field in the IsMercScpUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercScpUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercScpUniquePDSAValidator.ColumnNames.DateColumnNameHere);
