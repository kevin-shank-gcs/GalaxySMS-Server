...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupCount_GetLatestCountsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupCount_GetLatestCountsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupCount_GetLatestCountsPDSA</param>
    public AccessGroupCount_GetLatestCountsPDSAValidator(AccessGroupCount_GetLatestCountsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupCount_GetLatestCountsPDSAValidator";

      // Create Properties for each field in the AccessGroupCount_GetLatestCountsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupCount_GetLatestCountsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupCount_GetLatestCountsPDSAValidator.ColumnNames.DateColumnNameHere);
