...
{
  /// <summary>
  /// Used to validate business rules on the OutputDeviceGalaxyHardwareAddressPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class OutputDeviceGalaxyHardwareAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDeviceGalaxyHardwareAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDeviceGalaxyHardwareAddressPDSA</param>
    public OutputDeviceGalaxyHardwareAddressPDSAValidator(OutputDeviceGalaxyHardwareAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDeviceGalaxyHardwareAddressPDSAValidator";

      // Create Properties for each field in the OutputDeviceGalaxyHardwareAddressPDSA entity class
      InitProperties();
    ...
    public OutputDeviceGalaxyHardwareAddressPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputDeviceGalaxyHardwareAddressPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDeviceGalaxyHardwareAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDeviceGalaxyHardwareAddressPDSAValidator.ColumnNames.DateColumnNameHere);
