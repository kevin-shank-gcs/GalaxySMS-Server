...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupLoadToCpu_SaveLastLoadedDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupLoadToCpu_SaveLastLoadedDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupLoadToCpu_SaveLastLoadedDatePDSA</param>
    public AccessGroupLoadToCpu_SaveLastLoadedDatePDSAValidator(AccessGroupLoadToCpu_SaveLastLoadedDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupLoadToCpu_SaveLastLoadedDatePDSAValidator";

      // Create Properties for each field in the AccessGroupLoadToCpu_SaveLastLoadedDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.DateColumnNameHere);
