...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_GetAllUidsFromRoleIdAndSiteUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_GetAllUidsFromRoleIdAndSiteUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_GetAllUidsFromRoleIdAndSiteUidPDSA</param>
    public Cluster_GetAllUidsFromRoleIdAndSiteUidPDSAValidator(Cluster_GetAllUidsFromRoleIdAndSiteUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_GetAllUidsFromRoleIdAndSiteUidPDSAValidator";

      // Create Properties for each field in the Cluster_GetAllUidsFromRoleIdAndSiteUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_GetAllUidsFromRoleIdAndSiteUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_GetAllUidsFromRoleIdAndSiteUidPDSAValidator.ColumnNames.DateColumnNameHere);
