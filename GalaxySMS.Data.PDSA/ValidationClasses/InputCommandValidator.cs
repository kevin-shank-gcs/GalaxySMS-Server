...
{
  /// <summary>
  /// Used to validate business rules on the InputCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputCommandPDSA</param>
    public InputCommandPDSAValidator(InputCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputCommandPDSAValidator";

      // Create Properties for each field in the InputCommandPDSA entity class
      InitProperties();
    ...
    public InputCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputCommandPDSAValidator.ColumnNames.DateColumnNameHere);
