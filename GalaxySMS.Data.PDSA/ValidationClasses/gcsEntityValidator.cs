...
{
  /// <summary>
  /// Used to validate business rules on the gcsEntityPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsEntityPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityPDSA</param>
    public gcsEntityPDSAValidator(gcsEntityPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityPDSAValidator";

      // Create Properties for each field in the gcsEntityPDSA entity class
      InitProperties();
    ...
    public gcsEntityPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsEntityPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.DateColumnNameHere);
