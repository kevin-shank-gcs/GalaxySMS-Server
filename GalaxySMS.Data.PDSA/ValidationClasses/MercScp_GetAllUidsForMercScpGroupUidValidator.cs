...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class MercScp_GetAllUidsForMercScpGroupUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScp_GetAllUidsForMercScpGroupUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScp_GetAllUidsForMercScpGroupUidPDSA</param>
    public MercScp_GetAllUidsForMercScpGroupUidPDSAValidator(MercScp_GetAllUidsForMercScpGroupUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScp_GetAllUidsForMercScpGroupUidPDSAValidator";

      // Create Properties for each field in the MercScp_GetAllUidsForMercScpGroupUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScp_GetAllUidsForMercScpGroupUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScp_GetAllUidsForMercScpGroupUidPDSAValidator.ColumnNames.DateColumnNameHere);
