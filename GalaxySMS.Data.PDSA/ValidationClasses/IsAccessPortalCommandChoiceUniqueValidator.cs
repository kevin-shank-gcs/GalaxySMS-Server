...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalCommandChoiceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalCommandChoiceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalCommandChoiceUniquePDSA</param>
    public IsAccessPortalCommandChoiceUniquePDSAValidator(IsAccessPortalCommandChoiceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalCommandChoiceUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalCommandChoiceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalCommandChoiceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalCommandChoiceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
