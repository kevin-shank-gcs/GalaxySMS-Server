...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertPrimaryUserCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertPrimaryUserCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertPrimaryUserCountPDSA</param>
    public gcsEntityCountPDSA_InsertPrimaryUserCountPDSAValidator(gcsEntityCountPDSA_InsertPrimaryUserCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertPrimaryUserCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertPrimaryUserCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertPrimaryUserCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertPrimaryUserCountPDSAValidator.ColumnNames.DateColumnNameHere);
