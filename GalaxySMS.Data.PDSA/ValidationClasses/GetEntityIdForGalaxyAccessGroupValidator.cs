...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyAccessGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyAccessGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyAccessGroupPDSA</param>
    public GetEntityIdForGalaxyAccessGroupPDSAValidator(GetEntityIdForGalaxyAccessGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyAccessGroupPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyAccessGroupPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyAccessGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyAccessGroupPDSAValidator.ColumnNames.DateColumnNameHere);
