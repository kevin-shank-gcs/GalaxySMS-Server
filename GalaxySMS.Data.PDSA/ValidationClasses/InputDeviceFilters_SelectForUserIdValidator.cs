...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDeviceFilters_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceFilters_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceFilters_SelectForUserIdPDSA</param>
    public InputDeviceFilters_SelectForUserIdPDSAValidator(InputDeviceFilters_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceFilters_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the InputDeviceFilters_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceFilters_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceFilters_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
