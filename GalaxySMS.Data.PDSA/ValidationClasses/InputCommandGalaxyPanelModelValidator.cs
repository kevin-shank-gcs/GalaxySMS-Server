...
{
  /// <summary>
  /// Used to validate business rules on the InputCommandGalaxyPanelModelPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputCommandGalaxyPanelModelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputCommandGalaxyPanelModelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputCommandGalaxyPanelModelPDSA</param>
    public InputCommandGalaxyPanelModelPDSAValidator(InputCommandGalaxyPanelModelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputCommandGalaxyPanelModelPDSAValidator";

      // Create Properties for each field in the InputCommandGalaxyPanelModelPDSA entity class
      InitProperties();
    ...
    public InputCommandGalaxyPanelModelPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputCommandGalaxyPanelModelPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputCommandGalaxyPanelModelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputCommandGalaxyPanelModelPDSAValidator.ColumnNames.DateColumnNameHere);
