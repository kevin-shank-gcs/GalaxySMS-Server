...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupAssignment_GetAvailableOffsetIndexPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupAssignment_GetAvailableOffsetIndexPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupAssignment_GetAvailableOffsetIndexPDSA</param>
    public InputOutputGroupAssignment_GetAvailableOffsetIndexPDSAValidator(InputOutputGroupAssignment_GetAvailableOffsetIndexPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupAssignment_GetAvailableOffsetIndexPDSAValidator";

      // Create Properties for each field in the InputOutputGroupAssignment_GetAvailableOffsetIndexPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupAssignment_GetAvailableOffsetIndexPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupAssignment_GetAvailableOffsetIndexPDSAValidator.ColumnNames.DateColumnNameHere);
