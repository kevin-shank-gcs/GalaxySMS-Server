...
{
  /// <summary>
  /// Used to validate business rules on the OutputCommandGalaxyOutputModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class OutputCommandGalaxyOutputModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputCommandGalaxyOutputModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputCommandGalaxyOutputModePDSA</param>
    public OutputCommandGalaxyOutputModePDSAValidator(OutputCommandGalaxyOutputModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputCommandGalaxyOutputModePDSAValidator";

      // Create Properties for each field in the OutputCommandGalaxyOutputModePDSA entity class
      InitProperties();
    ...
    public OutputCommandGalaxyOutputModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputCommandGalaxyOutputModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputCommandGalaxyOutputModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputCommandGalaxyOutputModePDSAValidator.ColumnNames.DateColumnNameHere);
