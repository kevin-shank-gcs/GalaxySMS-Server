...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalAuxiliaryOutputModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalAuxiliaryOutputModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalAuxiliaryOutputModeUniquePDSA</param>
    public IsAccessPortalAuxiliaryOutputModeUniquePDSAValidator(IsAccessPortalAuxiliaryOutputModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalAuxiliaryOutputModeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalAuxiliaryOutputModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalAuxiliaryOutputModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalAuxiliaryOutputModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
