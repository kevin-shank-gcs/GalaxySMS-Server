...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSA</param>
    public IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSAValidator(IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelModelInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
