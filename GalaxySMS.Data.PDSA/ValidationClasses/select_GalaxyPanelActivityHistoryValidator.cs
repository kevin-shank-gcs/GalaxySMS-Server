...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class select_GalaxyPanelActivityHistoryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the select_GalaxyPanelActivityHistoryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a select_GalaxyPanelActivityHistoryPDSA</param>
    public select_GalaxyPanelActivityHistoryPDSAValidator(select_GalaxyPanelActivityHistoryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "select_GalaxyPanelActivityHistoryPDSAValidator";

      // Create Properties for each field in the select_GalaxyPanelActivityHistoryPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(select_GalaxyPanelActivityHistoryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(select_GalaxyPanelActivityHistoryPDSAValidator.ColumnNames.DateColumnNameHere);
