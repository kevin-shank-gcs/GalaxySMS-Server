...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimeScheduleTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimeScheduleTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimeScheduleTypeUniquePDSA</param>
    public IsTimeScheduleTypeUniquePDSAValidator(IsTimeScheduleTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimeScheduleTypeUniquePDSAValidator";

      // Create Properties for each field in the IsTimeScheduleTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimeScheduleTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimeScheduleTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
