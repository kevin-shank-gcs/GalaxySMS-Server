...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyHardwareModulePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyHardwareModulePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyHardwareModulePDSA</param>
    public GetEntityIdForGalaxyHardwareModulePDSAValidator(GetEntityIdForGalaxyHardwareModulePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyHardwareModulePDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyHardwareModulePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyHardwareModulePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyHardwareModulePDSAValidator.ColumnNames.DateColumnNameHere);
