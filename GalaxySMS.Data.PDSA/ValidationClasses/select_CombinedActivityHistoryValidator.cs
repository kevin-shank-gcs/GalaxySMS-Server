...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class select_CombinedActivityHistoryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the select_CombinedActivityHistoryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a select_CombinedActivityHistoryPDSA</param>
    public select_CombinedActivityHistoryPDSAValidator(select_CombinedActivityHistoryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "select_CombinedActivityHistoryPDSAValidator";

      // Create Properties for each field in the select_CombinedActivityHistoryPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(select_CombinedActivityHistoryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(select_CombinedActivityHistoryPDSAValidator.ColumnNames.DateColumnNameHere);
