...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_GetPanelLoadDataChangesForCpuPDSA</param>
    public AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator(AccessGroup_GetPanelLoadDataChangesForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator";

      // Create Properties for each field in the AccessGroup_GetPanelLoadDataChangesForCpuPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
