...
{
  /// <summary>
  /// Used to validate business rules on the CredentialH1030237BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialH1030237BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialH1030237BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialH1030237BitPDSA</param>
    public CredentialH1030237BitPDSAValidator(CredentialH1030237BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialH1030237BitPDSAValidator";

      // Create Properties for each field in the CredentialH1030237BitPDSA entity class
      InitProperties();
    ...
    public CredentialH1030237BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialH1030237BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialH1030237BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialH1030237BitPDSAValidator.ColumnNames.DateColumnNameHere);
