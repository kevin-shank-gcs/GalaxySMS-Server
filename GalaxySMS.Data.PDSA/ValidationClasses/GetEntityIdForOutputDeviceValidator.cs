...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForOutputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForOutputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForOutputDevicePDSA</param>
    public GetEntityIdForOutputDevicePDSAValidator(GetEntityIdForOutputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForOutputDevicePDSAValidator";

      // Create Properties for each field in the GetEntityIdForOutputDevicePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForOutputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForOutputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
