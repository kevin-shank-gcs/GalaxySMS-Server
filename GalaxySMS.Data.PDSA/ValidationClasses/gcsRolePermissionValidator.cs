...
{
  /// <summary>
  /// Used to validate business rules on the gcsRolePermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsRolePermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsRolePermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsRolePermissionPDSA</param>
    public gcsRolePermissionPDSAValidator(gcsRolePermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsRolePermissionPDSAValidator";

      // Create Properties for each field in the gcsRolePermissionPDSA entity class
      InitProperties();
    ...
    public gcsRolePermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsRolePermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsRolePermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsRolePermissionPDSAValidator.ColumnNames.DateColumnNameHere);
