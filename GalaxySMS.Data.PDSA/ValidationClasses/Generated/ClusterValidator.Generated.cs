...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class ClusterPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_ClusterPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_ClusterPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_ClusterPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_ClusterPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.AccessRuleOverrideTimeout, GetResourceMessage("GCS_ClusterPDSA_AccessRuleOverrideTimeout_Header", "Access Rule Override Timeout"), false, typeof(int), 10, GetResourceMessage("GCS_ClusterPDSA_AccessRuleOverrideTimeout_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("65535"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.UnlimitedCredentialTimeout, GetResourceMessage("GCS_ClusterPDSA_UnlimitedCredentialTimeout_Header", "Unlimited Credential Timeout"), true, typeof(int), 10, GetResourceMessage("GCS_ClusterPDSA_UnlimitedCredentialTimeout_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("65535"), 0, 0, @"", ""));
      ...
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.Description, GetResourceMessage("GCS_ClusterPDSA_Description_Header", "Description"), false, typeof(string), 1000, GetResourceMessage("GCS_ClusterPDSA_Description_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.PageNumber, GetResourceMessage("GCS_ClusterPDSA_PageNumber_Header", "Page Number"), false, typeof(int), 2147483647, GetResourceMessage("GCS_ClusterPDSA_PageNumber_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.PageSize, GetResourceMessage("GCS_ClusterPDSA_PageSize_Header", "Page Size"), false, typeof(int), 2147483647, GetResourceMessage("GCS_ClusterPDSA_PageSize_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.TotalRowCount, GetResourceMessage("GCS_ClusterPDSA_TotalRowCount_Header", "Total Row Count"), false, typeof(int), 2147483647, GetResourceMessage("GCS_ClusterPDSA_TotalRowCount_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.SortColumn, GetResourceMessage("GCS_ClusterPDSA_SortColumn_Header", "Sort Column"), false, typeof(string), 2147483647, GetResourceMessage("GCS_ClusterPDSA_SortColumn_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.DescendingOrder, GetResourceMessage("GCS_ClusterPDSA_DescendingOrder_Header", "Descending Order"), false, typeof(bool), 2147483647, GetResourceMessage("GCS_ClusterPDSA_DescendingOrder_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber, GetResourceMessage("GCS_ClusterPDSA_PanelScheduleNumber_Header", "Panel Schedule Number"), false, typeof(int), 2147483647, GetResourceMessage("GCS_ClusterPDSA_PanelScheduleNumber_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(ClusterPDSAValidator.ColumnNames.TimeScheduleUid, GetResourceMessage("GCS_ClusterPDSA_TimeScheduleUid_Header", "Time Schedule Uid"), false, typeof(Guid), 2147483647, GetResourceMessage("GCS_ClusterPDSA_TimeScheduleUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).Value = Entity.Description;
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).Value = Entity.PageNumber;
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).Value = Entity.PageSize;
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).Value = Entity.TotalRowCount;
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).Value = Entity.SortColumn;
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).Value = Entity.DescendingOrder;
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).Value = Entity.PanelScheduleNumber;
      if(!Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).SetAsNull)
        Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).Value = Entity.TimeScheduleUid;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.AccessRuleOverrideTimeout).IsNull == false)
        Entity.AccessRuleOverrideTimeout = Properties.GetByName(ClusterPDSAValidator.ColumnNames.AccessRuleOverrideTimeout).GetAsInteger();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.UnlimitedCredentialTimeout).IsNull == false)
        Entity.UnlimitedCredentialTimeout = Properties.GetByName(ClusterPDSAValidator.ColumnNames.UnlimitedCredentialTimeout).GetAsInteger();
      ...
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).IsNull == false)
        Entity.Description = Properties.GetByName(ClusterPDSAValidator.ColumnNames.Description).GetAsString();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).IsNull == false)
        Entity.PageNumber = Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageNumber).GetAsInteger();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).IsNull == false)
        Entity.PageSize = Properties.GetByName(ClusterPDSAValidator.ColumnNames.PageSize).GetAsInteger();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).IsNull == false)
        Entity.TotalRowCount = Properties.GetByName(ClusterPDSAValidator.ColumnNames.TotalRowCount).GetAsInteger();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).IsNull == false)
        Entity.SortColumn = Properties.GetByName(ClusterPDSAValidator.ColumnNames.SortColumn).GetAsString();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).IsNull == false)
        Entity.DescendingOrder = Properties.GetByName(ClusterPDSAValidator.ColumnNames.DescendingOrder).GetAsBool();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).IsNull == false)
        Entity.PanelScheduleNumber = Properties.GetByName(ClusterPDSAValidator.ColumnNames.PanelScheduleNumber).GetAsInteger();
      if(Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).IsNull == false)
        Entity.TimeScheduleUid = Properties.GetByName(ClusterPDSAValidator.ColumnNames.TimeScheduleUid).GetAsGuid();
    }
    #endregion
