...
{
  /// <summary>
  /// Used to validate all parameters of the InputDevice_GetPanelLoadDataByInputDeviceUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private InputDevice_GetPanelLoadDataByInputDeviceUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new InputDevice_GetPanelLoadDataByInputDeviceUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current InputDevice_GetPanelLoadDataByInputDeviceUidPDSA
    /// </summary>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByInputDeviceUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByInputDeviceUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in InputDevice_GetPanelLoadDataByInputDeviceUidPDSA
    /// </summary>
    /// <param name="entityToClone">The InputDevice_GetPanelLoadDataByInputDeviceUidPDSA entity to clone</param>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByInputDeviceUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByInputDeviceUidPDSA CloneEntity(InputDevice_GetPanelLoadDataByInputDeviceUidPDSA entityToClone)
    {
      InputDevice_GetPanelLoadDataByInputDeviceUidPDSA newEntity = new InputDevice_GetPanelLoadDataByInputDeviceUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.InputDeviceUid, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByInputDeviceUidPDSA_InputDeviceUid_Header", "Input Device Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByInputDeviceUidPDSA_InputDeviceUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByInputDeviceUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByInputDeviceUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.InputDeviceUid).Value = Entity.InputDeviceUid;
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.InputDeviceUid).IsNull == false)
        Entity.InputDeviceUid = this.Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.InputDeviceUid).GetAsGuid();
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
