...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class SiteEntityMapPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(SiteEntityMapPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_SiteEntityMapPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_SiteEntityMapPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(SiteEntityMapPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_SiteEntityMapPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_SiteEntityMapPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
