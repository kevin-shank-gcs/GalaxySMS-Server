...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class OutputCommandPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(OutputCommandPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_OutputCommandPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_OutputCommandPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(OutputCommandPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_OutputCommandPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_OutputCommandPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
