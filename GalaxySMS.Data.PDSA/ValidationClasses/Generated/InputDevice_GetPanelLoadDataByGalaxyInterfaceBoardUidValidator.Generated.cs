...
{
  /// <summary>
  /// Used to validate all parameters of the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA
    /// </summary>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA
    /// </summary>
    /// <param name="entityToClone">The InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity to clone</param>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA CloneEntity(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entityToClone)
    {
      InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA newEntity = new InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardUid, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA_GalaxyInterfaceBoardUid_Header", "Galaxy Interface Board Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA_GalaxyInterfaceBoardUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardUid).Value = Entity.GalaxyInterfaceBoardUid;
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardUid).IsNull == false)
        Entity.GalaxyInterfaceBoardUid = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardUid).GetAsGuid();
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
