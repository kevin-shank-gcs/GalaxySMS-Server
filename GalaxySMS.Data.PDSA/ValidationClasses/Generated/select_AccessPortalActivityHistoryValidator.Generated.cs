...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class select_AccessPortalActivityHistoryPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(select_AccessPortalActivityHistoryPDSAValidator.ParameterNames.DescendingOrder, GetResourceMessage("GCS_select_AccessPortalActivityHistoryPDSA_DescendingOrder_Header", "Descending Order"), false, typeof(bool), 0, GetResourceMessage("GCS_select_AccessPortalActivityHistoryPDSA_DescendingOrder_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(select_AccessPortalActivityHistoryPDSAValidator.ParameterNames.DescendingOrder).Value = Entity.DescendingOrder;
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(select_AccessPortalActivityHistoryPDSAValidator.ParameterNames.DescendingOrder).IsNull == false)
        Entity.DescendingOrder = this.Properties.GetByName(select_AccessPortalActivityHistoryPDSAValidator.ParameterNames.DescendingOrder).GetAsBool();
