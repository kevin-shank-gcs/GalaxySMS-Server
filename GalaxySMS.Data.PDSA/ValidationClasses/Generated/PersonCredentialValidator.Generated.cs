...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class PersonCredentialPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(PersonCredentialPDSAValidator.ColumnNames.BadgeLastPrinted, GetResourceMessage("GCS_PersonCredentialPDSA_BadgeLastPrinted_Header", "Badge Last Printed"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_PersonCredentialPDSA_BadgeLastPrinted_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, null, @"", ""));
      ...
      props.Add(PDSAProperty.Create(PersonCredentialPDSAValidator.ColumnNames.DossierLastPrinted, GetResourceMessage("GCS_PersonCredentialPDSA_DossierLastPrinted_Header", "Dossier Last Printed"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_PersonCredentialPDSA_DossierLastPrinted_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, null, @"", ""));
      props.Add(PDSAProperty.Create(PersonCredentialPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_PersonCredentialPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_PersonCredentialPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(PersonCredentialPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_PersonCredentialPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_PersonCredentialPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
