...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsSystemPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsSystemPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsSystemPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsSystemPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsSystemPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_gcsSystemPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsSystemPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
