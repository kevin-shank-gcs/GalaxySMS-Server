...
{
  /// <summary>
  /// Used to validate all parameters of the Credential_GetPanelLoadDataChangesByCpuUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private Credential_GetPanelLoadDataChangesByCpuUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new Credential_GetPanelLoadDataChangesByCpuUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current Credential_GetPanelLoadDataChangesByCpuUidPDSA
    /// </summary>
    /// <returns>A cloned Credential_GetPanelLoadDataChangesByCpuUidPDSA object</returns>
    public Credential_GetPanelLoadDataChangesByCpuUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in Credential_GetPanelLoadDataChangesByCpuUidPDSA
    /// </summary>
    /// <param name="entityToClone">The Credential_GetPanelLoadDataChangesByCpuUidPDSA entity to clone</param>
    /// <returns>A cloned Credential_GetPanelLoadDataChangesByCpuUidPDSA object</returns>
    public Credential_GetPanelLoadDataChangesByCpuUidPDSA CloneEntity(Credential_GetPanelLoadDataChangesByCpuUidPDSA entityToClone)
    {
      Credential_GetPanelLoadDataChangesByCpuUidPDSA newEntity = new Credential_GetPanelLoadDataChangesByCpuUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_CpuUid_Header", "Cpu Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_CpuUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_ServerAddress_Header", "Server Address"), false, typeof(string), 8000, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_ServerAddress_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_IsConnected_Header", "Is Connected"), false, typeof(bool), 0, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_IsConnected_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_Credential_GetPanelLoadDataChangesByCpuUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).Value = Entity.CpuUid;
      this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).Value = Entity.ServerAddress;
      this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).Value = Entity.IsConnected;
      this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).IsNull == false)
        Entity.CpuUid = this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).GetAsGuid();
      if(this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).IsNull == false)
        Entity.ServerAddress = this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).GetAsString();
      if(this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).IsNull == false)
        Entity.IsConnected = this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).GetAsBool();
      if(this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
