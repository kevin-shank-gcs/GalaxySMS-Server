...
{
  /// <summary>
  /// Used to validate all parameters of the OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA
    /// </summary>
    /// <returns>A cloned OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA object</returns>
    public OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA
    /// </summary>
    /// <param name="entityToClone">The OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA entity to clone</param>
    /// <returns>A cloned OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA object</returns>
    public OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA CloneEntity(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA entityToClone)
    {
      OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA newEntity = new OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_CpuUid_Header", "Cpu Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_CpuUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_ServerAddress_Header", "Server Address"), false, typeof(string), 8000, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_ServerAddress_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_IsConnected_Header", "Is Connected"), false, typeof(bool), 0, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_IsConnected_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).Value = Entity.CpuUid;
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).Value = Entity.ServerAddress;
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).Value = Entity.IsConnected;
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).IsNull == false)
        Entity.CpuUid = this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).GetAsGuid();
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).IsNull == false)
        Entity.ServerAddress = this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).GetAsString();
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).IsNull == false)
        Entity.IsConnected = this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).GetAsBool();
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
