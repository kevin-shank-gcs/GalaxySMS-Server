...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class GalaxyCpu_UpdateInformationPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(GalaxyCpu_UpdateInformationPDSAValidator.ParameterNames.Version, GetResourceMessage("GCS_GalaxyCpu_UpdateInformationPDSA_Version_Header", "Version"), false, typeof(string), 8000, GetResourceMessage("GCS_GalaxyCpu_UpdateInformationPDSA_Version_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      Properties.GetByName(GalaxyCpu_UpdateInformationPDSAValidator.ParameterNames.Version).Value = Entity.Version;
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(GalaxyCpu_UpdateInformationPDSAValidator.ParameterNames.Version).IsNull == false)
        Entity.Version = Properties.GetByName(GalaxyCpu_UpdateInformationPDSAValidator.ParameterNames.Version).GetAsString();
