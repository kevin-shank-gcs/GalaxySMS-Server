...
{
  /// <summary>
  /// Used to validate all parameters of the InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA
    /// </summary>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA
    /// </summary>
    /// <param name="entityToClone">The InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity to clone</param>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA CloneEntity(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entityToClone)
    {
      InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA newEntity = new InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_GalaxyHardwareModuleUid_Header", "Galaxy Hardware Module Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_GalaxyHardwareModuleUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid).Value = Entity.GalaxyHardwareModuleUid;
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid).IsNull == false)
        Entity.GalaxyHardwareModuleUid = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid).GetAsGuid();
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
