...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class UnacknowledgedAlarmsPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ClusterGroupId_Header", "Cluster Group Id"), false, typeof(int), 10, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ClusterGroupId_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ClusterNumber, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ClusterNumber_Header", "Cluster Number"), false, typeof(int), 10, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ClusterNumber_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("65565"), 0, 0, @"", ""));
      ...
      props.Add(PDSAProperty.Create(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ResponseRequired_Header", "Response Required"), false, typeof(bool), -1, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ResponseRequired_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      ...
      props.Add(PDSAProperty.Create(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ColorHex_Header", "Color Hex"), false, typeof(string), 20, GetResourceMessage("GCS_UnacknowledgedAlarmsPDSA_ColorHex_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).SetAsNull)
        Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).Value = Entity.ResponseRequired;
      ...
      if(!Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).SetAsNull)
        Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).Value = Entity.ColorHex;
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).IsNull == false)
        Entity.ResponseRequired = Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ResponseRequired).GetAsBool();
      ...
      if(Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).IsNull == false)
        Entity.ColorHex = Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColorHex).GetAsString();
