...
{
  /// <summary>
  /// Used to validate all parameters of the OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator : PDSAValidatorBase
  {
    ...
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA
    /// </summary>
    /// <returns>A cloned OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA object</returns>
    public OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA
    /// </summary>
    /// <param name="entityToClone">The OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity to clone</param>
    /// <returns>A cloned OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA object</returns>
    public OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA CloneEntity(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entityToClone)
    {
      OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA newEntity = new OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_GalaxyHardwareModuleUid_Header", "Galaxy Hardware Module Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_GalaxyHardwareModuleUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid).Value = Entity.GalaxyHardwareModuleUid;
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid).IsNull == false)
        Entity.GalaxyHardwareModuleUid = this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.GalaxyHardwareModuleUid).GetAsGuid();
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
