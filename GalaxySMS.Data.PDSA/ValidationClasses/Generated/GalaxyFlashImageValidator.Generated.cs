...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class GalaxyFlashImagePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(GalaxyFlashImagePDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_GalaxyFlashImagePDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_GalaxyFlashImagePDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(GalaxyFlashImagePDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_GalaxyFlashImagePDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_GalaxyFlashImagePDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
