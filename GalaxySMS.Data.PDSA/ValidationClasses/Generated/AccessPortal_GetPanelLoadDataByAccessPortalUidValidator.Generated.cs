...
{
  /// <summary>
  /// Used to validate all parameters of the AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator : PDSAValidatorBase
  {
    ...
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA
    /// </summary>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA
    /// </summary>
    /// <param name="entityToClone">The AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA entity to clone</param>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA CloneEntity(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA entityToClone)
    {
      AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA newEntity = new AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.AccessPortalUid, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA_AccessPortalUid_Header", "Access Portal Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA_AccessPortalUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.AccessPortalUid).Value = Entity.AccessPortalUid;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.AccessPortalUid).IsNull == false)
        Entity.AccessPortalUid = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.AccessPortalUid).GetAsGuid();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
