...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsUserSettingPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsUserSettingPDSAValidator.ColumnNames.UserId, GetResourceMessage("GCS_gcsUserSettingPDSA_UserId_Header", "User Id"), true, typeof(Guid), -1, GetResourceMessage("GCS_gcsUserSettingPDSA_UserId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcsUserSettingPDSAValidator.ColumnNames.ApplicationId, GetResourceMessage("GCS_gcsUserSettingPDSA_ApplicationId_Header", "Application Id"), false, typeof(Guid), -1, GetResourceMessage("GCS_gcsUserSettingPDSA_ApplicationId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserSettingPDSAValidator.ColumnNames.SettingDescription, GetResourceMessage("GCS_gcsUserSettingPDSA_SettingDescription_Header", "Setting Description"), false, typeof(string), 255, GetResourceMessage("GCS_gcsUserSettingPDSA_SettingDescription_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcsUserSettingPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsUserSettingPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsUserSettingPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserSettingPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_gcsUserSettingPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsUserSettingPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
