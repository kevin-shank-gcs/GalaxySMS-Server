...
{
  /// <summary>
  /// Used to validate all parameters of the Credential_GetPanelLoadDataByCredentialUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class Credential_GetPanelLoadDataByCredentialUidPDSAValidator : PDSAValidatorBase
  {
    ...
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new Credential_GetPanelLoadDataByCredentialUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current Credential_GetPanelLoadDataByCredentialUidPDSA
    /// </summary>
    /// <returns>A cloned Credential_GetPanelLoadDataByCredentialUidPDSA object</returns>
    public Credential_GetPanelLoadDataByCredentialUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in Credential_GetPanelLoadDataByCredentialUidPDSA
    /// </summary>
    /// <param name="entityToClone">The Credential_GetPanelLoadDataByCredentialUidPDSA entity to clone</param>
    /// <returns>A cloned Credential_GetPanelLoadDataByCredentialUidPDSA object</returns>
    public Credential_GetPanelLoadDataByCredentialUidPDSA CloneEntity(Credential_GetPanelLoadDataByCredentialUidPDSA entityToClone)
    {
      Credential_GetPanelLoadDataByCredentialUidPDSA newEntity = new Credential_GetPanelLoadDataByCredentialUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.CredentialUid, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCredentialUidPDSA_CredentialUid_Header", "Credential Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCredentialUidPDSA_CredentialUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCredentialUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCredentialUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.CredentialUid).Value = Entity.CredentialUid;
      this.Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.CredentialUid).IsNull == false)
        Entity.CredentialUid = this.Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.CredentialUid).GetAsGuid();
      if(this.Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
