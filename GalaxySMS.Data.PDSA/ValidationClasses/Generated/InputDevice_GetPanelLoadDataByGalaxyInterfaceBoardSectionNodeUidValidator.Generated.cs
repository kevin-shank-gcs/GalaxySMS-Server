...
{
  /// <summary>
  /// Used to validate all parameters of the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA
    /// </summary>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA
    /// </summary>
    /// <param name="entityToClone">The InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity to clone</param>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA CloneEntity(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entityToClone)
    {
      InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA newEntity = new InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA();
      ...
      newEntity.MainIOGroupIsActive = entityToClone.MainIOGroupIsActive;
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_GalaxyInterfaceBoardSectionNodeUid_Header", "Galaxy Interface Board Section Node Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_GalaxyInterfaceBoardSectionNodeUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid).Value = Entity.GalaxyInterfaceBoardSectionNodeUid;
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid).IsNull == false)
        Entity.GalaxyInterfaceBoardSectionNodeUid = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid).GetAsGuid();
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
    ...
    /// <summary>
    /// Returns 'MainIOGroupIsActive'
    /// </summary>
    public static string MainIOGroupIsActive = "MainIOGroupIsActive";
    /// <summary>
