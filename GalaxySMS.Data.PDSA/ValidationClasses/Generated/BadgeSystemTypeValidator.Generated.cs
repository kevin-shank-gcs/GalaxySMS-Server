...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class BadgeSystemTypePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(BadgeSystemTypePDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_BadgeSystemTypePDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_BadgeSystemTypePDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(BadgeSystemTypePDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_BadgeSystemTypePDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_BadgeSystemTypePDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
