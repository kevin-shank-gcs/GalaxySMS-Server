...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DataLength, GetResourceMessage("GCS_CredentialToDelete_PanelLoadDataChangesForCpuPDSA_DataLength_Header", "Data Length"), false, typeof(short), 5, GetResourceMessage("GCS_CredentialToDelete_PanelLoadDataChangesForCpuPDSA_DataLength_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt16("-32768"), Convert.ToInt16("32767"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsExtended, GetResourceMessage("GCS_CredentialToDelete_PanelLoadDataChangesForCpuPDSA_IsExtended_Header", "Is Extended"), false, typeof(bool), -1, GetResourceMessage("GCS_CredentialToDelete_PanelLoadDataChangesForCpuPDSA_IsExtended_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DataLength).SetAsNull)
        Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DataLength).Value = Entity.DataLength;
      if(!Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsExtended).SetAsNull)
        Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsExtended).Value = Entity.IsExtended;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DeletedFromDatabaseDate).IsNull == false)
        Entity.DeletedFromDatabaseDate = Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DeletedFromDatabaseDate).GetAsDate();
      if(Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DeletedFromCpuDate).IsNull == false)
        Entity.DeletedFromCpuDate = Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DeletedFromCpuDate).GetAsDate();
      ...
      if(Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DataLength).IsNull == false)
        Entity.DataLength = Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DataLength).GetAsShort();
      if(Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsExtended).IsNull == false)
        Entity.IsExtended = Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsExtended).GetAsBool();
    }
    #endregion
