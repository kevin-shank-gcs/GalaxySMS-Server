...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class AccessPortal_GetUserPermissionPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortal_GetUserPermissionPDSAValidator.ParameterNames.EntityId, GetResourceMessage("GCS_AccessPortal_GetUserPermissionPDSA_EntityId_Header", "Entity Id"), false, typeof(Guid), 0, GetResourceMessage("GCS_AccessPortal_GetUserPermissionPDSA_EntityId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(AccessPortal_GetUserPermissionPDSAValidator.ParameterNames.EntityId).Value = Entity.EntityId;
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(AccessPortal_GetUserPermissionPDSAValidator.ParameterNames.EntityId).IsNull == false)
        Entity.EntityId = this.Properties.GetByName(AccessPortal_GetUserPermissionPDSAValidator.ParameterNames.EntityId).GetAsGuid();
