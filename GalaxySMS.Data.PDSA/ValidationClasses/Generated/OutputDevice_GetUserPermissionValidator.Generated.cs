...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class OutputDevice_GetUserPermissionPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(OutputDevice_GetUserPermissionPDSAValidator.ParameterNames.EntityId, GetResourceMessage("GCS_OutputDevice_GetUserPermissionPDSA_EntityId_Header", "Entity Id"), false, typeof(Guid), 0, GetResourceMessage("GCS_OutputDevice_GetUserPermissionPDSA_EntityId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(OutputDevice_GetUserPermissionPDSAValidator.ParameterNames.EntityId).Value = Entity.EntityId;
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(OutputDevice_GetUserPermissionPDSAValidator.ParameterNames.EntityId).IsNull == false)
        Entity.EntityId = this.Properties.GetByName(OutputDevice_GetUserPermissionPDSAValidator.ParameterNames.EntityId).GetAsGuid();
