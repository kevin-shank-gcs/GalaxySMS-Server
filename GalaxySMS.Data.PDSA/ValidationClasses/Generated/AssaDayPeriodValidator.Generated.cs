...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class AssaDayPeriodPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AssaDayPeriodPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_AssaDayPeriodPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_AssaDayPeriodPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(AssaDayPeriodPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_AssaDayPeriodPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_AssaDayPeriodPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
