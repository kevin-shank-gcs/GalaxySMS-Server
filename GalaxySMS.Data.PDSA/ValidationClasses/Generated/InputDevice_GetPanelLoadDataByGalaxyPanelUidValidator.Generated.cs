...
{
  /// <summary>
  /// Used to validate all parameters of the InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA
    /// </summary>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA
    /// </summary>
    /// <param name="entityToClone">The InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA entity to clone</param>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA CloneEntity(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA entityToClone)
    {
      InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA newEntity = new InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA_GalaxyPanelUid_Header", "Galaxy Panel Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA_GalaxyPanelUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid).Value = Entity.GalaxyPanelUid;
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid).IsNull == false)
        Entity.GalaxyPanelUid = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid).GetAsGuid();
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
