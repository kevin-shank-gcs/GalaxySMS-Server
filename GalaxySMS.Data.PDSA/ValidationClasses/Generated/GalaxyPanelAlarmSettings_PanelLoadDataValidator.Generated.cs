...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_GalaxyPanelAlarmSettings_PanelLoadDataPDSA_ClusterGroupId_Header", "Cluster Group Id"), false, typeof(int), 10, GetResourceMessage("GCS_GalaxyPanelAlarmSettings_PanelLoadDataPDSA_ClusterGroupId_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      ...
      props.Add(PDSAProperty.Create(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.IsActive, GetResourceMessage("GCS_GalaxyPanelAlarmSettings_PanelLoadDataPDSA_IsActive_Header", "Is Active"), false, typeof(bool), -1, GetResourceMessage("GCS_GalaxyPanelAlarmSettings_PanelLoadDataPDSA_IsActive_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.IsActive).SetAsNull)
        Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.IsActive).Value = Entity.IsActive;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.IsActive).IsNull == false)
        Entity.IsActive = Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.IsActive).GetAsBool();
    }
    #endregion
