...
{
  /// <summary>
  /// Used to validate all parameters of the InputDevice_GetPanelLoadDataByClusterUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByClusterUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private InputDevice_GetPanelLoadDataByClusterUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new InputDevice_GetPanelLoadDataByClusterUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current InputDevice_GetPanelLoadDataByClusterUidPDSA
    /// </summary>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByClusterUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByClusterUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in InputDevice_GetPanelLoadDataByClusterUidPDSA
    /// </summary>
    /// <param name="entityToClone">The InputDevice_GetPanelLoadDataByClusterUidPDSA entity to clone</param>
    /// <returns>A cloned InputDevice_GetPanelLoadDataByClusterUidPDSA object</returns>
    public InputDevice_GetPanelLoadDataByClusterUidPDSA CloneEntity(InputDevice_GetPanelLoadDataByClusterUidPDSA entityToClone)
    {
      InputDevice_GetPanelLoadDataByClusterUidPDSA newEntity = new InputDevice_GetPanelLoadDataByClusterUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByClusterUidPDSA_ClusterUid_Header", "Cluster Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByClusterUidPDSA_ClusterUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByClusterUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_InputDevice_GetPanelLoadDataByClusterUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid).Value = Entity.ClusterUid;
      this.Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid).IsNull == false)
        Entity.ClusterUid = this.Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid).GetAsGuid();
      if(this.Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
