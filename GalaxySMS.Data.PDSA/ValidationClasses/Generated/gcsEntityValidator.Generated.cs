...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsEntityPDSAValidator : PDSAValidatorBase
  {
    ...
    public gcsEntityPDSA CloneEntity(gcsEntityPDSA entityToClone)
    {
      ...
      newEntity.ActiveOnly = entityToClone.ActiveOnly;
      newEntity.IgnoreEntityId = entityToClone.IgnoreEntityId;
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.EntityDescription, GetResourceMessage("GCS_gcsEntityPDSA_EntityDescription_Header", "Entity Description"), false, typeof(string), 255, GetResourceMessage("GCS_gcsEntityPDSA_EntityDescription_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsEntityPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsEntityPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_gcsEntityPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsEntityPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.EntityType, GetResourceMessage("GCS_gcsEntityPDSA_EntityType_Header", "Entity Type"), false, typeof(string), 65, GetResourceMessage("GCS_gcsEntityPDSA_EntityType_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.AutoMapTimeSchedules, GetResourceMessage("GCS_gcsEntityPDSA_AutoMapTimeSchedules_Header", "Auto Map Time Schedules"), true, typeof(bool), -1, GetResourceMessage("GCS_gcsEntityPDSA_AutoMapTimeSchedules_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_gcsEntityPDSA_ClusterGroupId_Header", "Cluster Group Id"), true, typeof(int), 10, GetResourceMessage("GCS_gcsEntityPDSA_ClusterGroupId_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.TimeZoneId, GetResourceMessage("GCS_gcsEntityPDSA_TimeZoneId_Header", "Time Zone Id"), true, typeof(string), 65, GetResourceMessage("GCS_gcsEntityPDSA_TimeZoneId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.PageNumber, GetResourceMessage("GCS_gcsEntityPDSA_PageNumber_Header", "Page Number"), false, typeof(int), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_PageNumber_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.PageSize, GetResourceMessage("GCS_gcsEntityPDSA_PageSize_Header", "Page Size"), false, typeof(int), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_PageSize_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.TotalRowCount, GetResourceMessage("GCS_gcsEntityPDSA_TotalRowCount_Header", "Total Row Count"), false, typeof(int), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_TotalRowCount_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.UserId, GetResourceMessage("GCS_gcsEntityPDSA_UserId_Header", "User Id"), false, typeof(Guid), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_UserId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.SortColumn, GetResourceMessage("GCS_gcsEntityPDSA_SortColumn_Header", "Sort Column"), false, typeof(string), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_SortColumn_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.DescendingOrder, GetResourceMessage("GCS_gcsEntityPDSA_DescendingOrder_Header", "Descending Order"), false, typeof(bool), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_DescendingOrder_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.ActiveOnly, GetResourceMessage("GCS_gcsEntityPDSA_ActiveOnly_Header", "Active Only"), false, typeof(bool), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_ActiveOnly_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      props.Add(PDSAProperty.Create(gcsEntityPDSAValidator.ColumnNames.IgnoreEntityId, GetResourceMessage("GCS_gcsEntityPDSA_IgnoreEntityId_Header", "Ignore Entity Id"), false, typeof(Guid), 2147483647, GetResourceMessage("GCS_gcsEntityPDSA_IgnoreEntityId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.EntityType).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.EntityType).Value = Entity.EntityType;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.AutoMapTimeSchedules).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.AutoMapTimeSchedules).Value = Entity.AutoMapTimeSchedules;
      ...
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ClusterGroupId).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ClusterGroupId).Value = Entity.ClusterGroupId;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TimeZoneId).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TimeZoneId).Value = Entity.TimeZoneId;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageNumber).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageNumber).Value = Entity.PageNumber;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageSize).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageSize).Value = Entity.PageSize;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TotalRowCount).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TotalRowCount).Value = Entity.TotalRowCount;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.UserId).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.UserId).Value = Entity.UserId;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.SortColumn).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.SortColumn).Value = Entity.SortColumn;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.DescendingOrder).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.DescendingOrder).Value = Entity.DescendingOrder;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ActiveOnly).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ActiveOnly).Value = Entity.ActiveOnly;
      if(!Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.IgnoreEntityId).SetAsNull)
        Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.IgnoreEntityId).Value = Entity.IgnoreEntityId;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.EntityType).IsNull == false)
        Entity.EntityType = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.EntityType).GetAsString();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.AutoMapTimeSchedules).IsNull == false)
        Entity.AutoMapTimeSchedules = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.AutoMapTimeSchedules).GetAsBool();
      ...
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ClusterGroupId).IsNull == false)
        Entity.ClusterGroupId = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ClusterGroupId).GetAsInteger();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TimeZoneId).IsNull == false)
        Entity.TimeZoneId = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TimeZoneId).GetAsString();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageNumber).IsNull == false)
        Entity.PageNumber = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageNumber).GetAsInteger();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageSize).IsNull == false)
        Entity.PageSize = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.PageSize).GetAsInteger();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TotalRowCount).IsNull == false)
        Entity.TotalRowCount = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.TotalRowCount).GetAsInteger();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.UserId).IsNull == false)
        Entity.UserId = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.UserId).GetAsGuid();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.SortColumn).IsNull == false)
        Entity.SortColumn = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.SortColumn).GetAsString();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.DescendingOrder).IsNull == false)
        Entity.DescendingOrder = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.DescendingOrder).GetAsBool();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ActiveOnly).IsNull == false)
        Entity.ActiveOnly = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.ActiveOnly).GetAsBool();
      if(Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.IgnoreEntityId).IsNull == false)
        Entity.IgnoreEntityId = Properties.GetByName(gcsEntityPDSAValidator.ColumnNames.IgnoreEntityId).GetAsGuid();
    }
    #endregion
    ...
    /// Returns 'ActiveOnly'
    /// </summary>
    public static string ActiveOnly = "ActiveOnly";
    /// <summary>
    /// Returns 'IgnoreEntityId'
    /// </summary>
    public static string IgnoreEntityId = "IgnoreEntityId";
    }
    #endregion
  }
}
