...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class TimeSchedulePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_TimeSchedulePDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_TimeSchedulePDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_TimeSchedulePDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_TimeSchedulePDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.PageNumber, GetResourceMessage("GCS_TimeSchedulePDSA_PageNumber_Header", "Page Number"), false, typeof(int), 2147483647, GetResourceMessage("GCS_TimeSchedulePDSA_PageNumber_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.PageSize, GetResourceMessage("GCS_TimeSchedulePDSA_PageSize_Header", "Page Size"), false, typeof(int), 2147483647, GetResourceMessage("GCS_TimeSchedulePDSA_PageSize_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.TotalRowCount, GetResourceMessage("GCS_TimeSchedulePDSA_TotalRowCount_Header", "Total Row Count"), false, typeof(int), 2147483647, GetResourceMessage("GCS_TimeSchedulePDSA_TotalRowCount_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.DescendingOrder, GetResourceMessage("GCS_TimeSchedulePDSA_DescendingOrder_Header", "Descending Order"), false, typeof(bool), 2147483647, GetResourceMessage("GCS_TimeSchedulePDSA_DescendingOrder_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.SortColumn, GetResourceMessage("GCS_TimeSchedulePDSA_SortColumn_Header", "Sort Column"), false, typeof(string), 2147483647, GetResourceMessage("GCS_TimeSchedulePDSA_SortColumn_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(TimeSchedulePDSAValidator.ColumnNames.PanelScheduleNumber, GetResourceMessage("GCS_TimeSchedulePDSA_PanelScheduleNumber_Header", "Panel Schedule Number"), false, typeof(int), 2147483647, GetResourceMessage("GCS_TimeSchedulePDSA_PanelScheduleNumber_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("0"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageNumber).SetAsNull)
        Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageNumber).Value = Entity.PageNumber;
      if(!Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageSize).SetAsNull)
        Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageSize).Value = Entity.PageSize;
      if(!Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.TotalRowCount).SetAsNull)
        Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.TotalRowCount).Value = Entity.TotalRowCount;
      if(!Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.DescendingOrder).SetAsNull)
        Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.DescendingOrder).Value = Entity.DescendingOrder;
      if(!Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.SortColumn).SetAsNull)
        Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.SortColumn).Value = Entity.SortColumn;
      if(!Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PanelScheduleNumber).SetAsNull)
        Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PanelScheduleNumber).Value = Entity.PanelScheduleNumber;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageNumber).IsNull == false)
        Entity.PageNumber = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageNumber).GetAsInteger();
      if(Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageSize).IsNull == false)
        Entity.PageSize = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PageSize).GetAsInteger();
      if(Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.TotalRowCount).IsNull == false)
        Entity.TotalRowCount = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.TotalRowCount).GetAsInteger();
      if(Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.DescendingOrder).IsNull == false)
        Entity.DescendingOrder = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.DescendingOrder).GetAsBool();
      if(Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.SortColumn).IsNull == false)
        Entity.SortColumn = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.SortColumn).GetAsString();
      if(Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PanelScheduleNumber).IsNull == false)
        Entity.PanelScheduleNumber = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.PanelScheduleNumber).GetAsInteger();
    }
    #endregion
