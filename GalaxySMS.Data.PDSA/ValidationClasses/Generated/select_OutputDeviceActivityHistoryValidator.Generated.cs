...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class select_OutputDeviceActivityHistoryPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(select_OutputDeviceActivityHistoryPDSAValidator.ParameterNames.DescendingOrder, GetResourceMessage("GCS_select_OutputDeviceActivityHistoryPDSA_DescendingOrder_Header", "Descending Order"), false, typeof(bool), 0, GetResourceMessage("GCS_select_OutputDeviceActivityHistoryPDSA_DescendingOrder_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(select_OutputDeviceActivityHistoryPDSAValidator.ParameterNames.DescendingOrder).Value = Entity.DescendingOrder;
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(select_OutputDeviceActivityHistoryPDSAValidator.ParameterNames.DescendingOrder).IsNull == false)
        Entity.DescendingOrder = this.Properties.GetByName(select_OutputDeviceActivityHistoryPDSAValidator.ParameterNames.DescendingOrder).GetAsBool();
