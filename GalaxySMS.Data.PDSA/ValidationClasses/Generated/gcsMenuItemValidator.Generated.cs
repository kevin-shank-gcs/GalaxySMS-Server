...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsMenuItemPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsMenuItemPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsMenuItemPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsMenuItemPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsMenuItemPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_gcsMenuItemPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 100, GetResourceMessage("GCS_gcsMenuItemPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
