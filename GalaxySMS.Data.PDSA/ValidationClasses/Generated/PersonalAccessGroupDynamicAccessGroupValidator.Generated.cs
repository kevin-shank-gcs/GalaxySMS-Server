...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class PersonalAccessGroupDynamicAccessGroupPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(PersonalAccessGroupDynamicAccessGroupPDSAValidator.ColumnNames.AccessGroupName, GetResourceMessage("GCS_PersonalAccessGroupDynamicAccessGroupPDSA_AccessGroupName_Header", "Access Group Name"), false, typeof(string), 2147483647, GetResourceMessage("GCS_PersonalAccessGroupDynamicAccessGroupPDSA_AccessGroupName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(PersonalAccessGroupDynamicAccessGroupPDSAValidator.ColumnNames.AccessGroupName).SetAsNull)
        Properties.GetByName(PersonalAccessGroupDynamicAccessGroupPDSAValidator.ColumnNames.AccessGroupName).Value = Entity.AccessGroupName;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(PersonalAccessGroupDynamicAccessGroupPDSAValidator.ColumnNames.AccessGroupName).IsNull == false)
        Entity.AccessGroupName = Properties.GetByName(PersonalAccessGroupDynamicAccessGroupPDSAValidator.ColumnNames.AccessGroupName).GetAsString();
    }
    #endregion
