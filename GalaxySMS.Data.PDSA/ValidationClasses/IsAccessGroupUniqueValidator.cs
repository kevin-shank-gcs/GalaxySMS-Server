...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessGroupUniquePDSA</param>
    public IsAccessGroupUniquePDSAValidator(IsAccessGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessGroupUniquePDSAValidator";

      // Create Properties for each field in the IsAccessGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
