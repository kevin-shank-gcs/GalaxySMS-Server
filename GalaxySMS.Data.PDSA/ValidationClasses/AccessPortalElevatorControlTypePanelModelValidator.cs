...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalElevatorControlTypePanelModelPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalElevatorControlTypePanelModelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalElevatorControlTypePanelModelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalElevatorControlTypePanelModelPDSA</param>
    public AccessPortalElevatorControlTypePanelModelPDSAValidator(AccessPortalElevatorControlTypePanelModelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalElevatorControlTypePanelModelPDSAValidator";

      // Create Properties for each field in the AccessPortalElevatorControlTypePanelModelPDSA entity class
      InitProperties();
    ...
    public AccessPortalElevatorControlTypePanelModelPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalElevatorControlTypePanelModelPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalElevatorControlTypePanelModelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalElevatorControlTypePanelModelPDSAValidator.ColumnNames.DateColumnNameHere);
