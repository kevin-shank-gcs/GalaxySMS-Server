...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetUserPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetUserPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetUserPermissionPDSA</param>
    public AccessPortal_GetUserPermissionPDSAValidator(AccessPortal_GetUserPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetUserPermissionPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetUserPermissionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetUserPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetUserPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
