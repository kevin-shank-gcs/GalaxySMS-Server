...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonActiveStatusTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonActiveStatusTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonActiveStatusTypeUniquePDSA</param>
    public IsPersonActiveStatusTypeUniquePDSAValidator(IsPersonActiveStatusTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonActiveStatusTypeUniquePDSAValidator";

      // Create Properties for each field in the IsPersonActiveStatusTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonActiveStatusTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonActiveStatusTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
