...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_GenerateAllCountsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_GenerateAllCountsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_GenerateAllCountsPDSA</param>
    public gcsEntityCountPDSA_GenerateAllCountsPDSAValidator(gcsEntityCountPDSA_GenerateAllCountsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_GenerateAllCountsPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_GenerateAllCountsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_GenerateAllCountsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_GenerateAllCountsPDSAValidator.ColumnNames.DateColumnNameHere);
