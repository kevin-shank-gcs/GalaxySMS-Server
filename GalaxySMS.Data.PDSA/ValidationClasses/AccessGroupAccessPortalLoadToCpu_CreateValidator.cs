...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupAccessPortalLoadToCpu_CreatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortalLoadToCpu_CreatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortalLoadToCpu_CreatePDSA</param>
    public AccessGroupAccessPortalLoadToCpu_CreatePDSAValidator(AccessGroupAccessPortalLoadToCpu_CreatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortalLoadToCpu_CreatePDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortalLoadToCpu_CreatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortalLoadToCpu_CreatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortalLoadToCpu_CreatePDSAValidator.ColumnNames.DateColumnNameHere);
