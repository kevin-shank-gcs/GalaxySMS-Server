...
{
  /// <summary>
  /// Used to validate business rules on the ClusterCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterCommandPDSA</param>
    public ClusterCommandPDSAValidator(ClusterCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterCommandPDSAValidator";

      // Create Properties for each field in the ClusterCommandPDSA entity class
      InitProperties();
    ...
    public ClusterCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterCommandPDSAValidator.ColumnNames.DateColumnNameHere);
