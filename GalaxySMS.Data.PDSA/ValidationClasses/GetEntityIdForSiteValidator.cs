...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForSitePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForSitePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForSitePDSA</param>
    public GetEntityIdForSitePDSAValidator(GetEntityIdForSitePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForSitePDSAValidator";

      // Create Properties for each field in the GetEntityIdForSitePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForSitePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForSitePDSAValidator.ColumnNames.DateColumnNameHere);
