...
{
  /// <summary>
  /// Used to validate business rules on the gcsEntityCountPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsEntityCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA</param>
    public gcsEntityCountPDSAValidator(gcsEntityCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA entity class
      InitProperties();
    ...
    public gcsEntityCountPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsEntityCountPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSAValidator.ColumnNames.DateColumnNameHere);
