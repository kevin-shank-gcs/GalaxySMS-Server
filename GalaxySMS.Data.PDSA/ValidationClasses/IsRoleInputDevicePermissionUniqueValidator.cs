...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleInputDevicePermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleInputDevicePermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleInputDevicePermissionUniquePDSA</param>
    public IsRoleInputDevicePermissionUniquePDSAValidator(IsRoleInputDevicePermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleInputDevicePermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleInputDevicePermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleInputDevicePermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleInputDevicePermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
