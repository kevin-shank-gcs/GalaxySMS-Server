...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalTypeFeatureMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalTypeFeatureMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalTypeFeatureMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalTypeFeatureMapPDSA</param>
    public AccessPortalTypeFeatureMapPDSAValidator(AccessPortalTypeFeatureMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalTypeFeatureMapPDSAValidator";

      // Create Properties for each field in the AccessPortalTypeFeatureMapPDSA entity class
      InitProperties();
    ...
    public AccessPortalTypeFeatureMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalTypeFeatureMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalTypeFeatureMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalTypeFeatureMapPDSAValidator.ColumnNames.DateColumnNameHere);
