...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupValidForGalaxyPanelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupValidForGalaxyPanelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupValidForGalaxyPanelPDSA</param>
    public IsInputOutputGroupValidForGalaxyPanelPDSAValidator(IsInputOutputGroupValidForGalaxyPanelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupValidForGalaxyPanelPDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupValidForGalaxyPanelPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupValidForGalaxyPanelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupValidForGalaxyPanelPDSAValidator.ColumnNames.DateColumnNameHere);
