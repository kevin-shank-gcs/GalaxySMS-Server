...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Region_SelectionListForEntityPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Region_SelectionListForEntityPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Region_SelectionListForEntityPDSA</param>
    public Region_SelectionListForEntityPDSAValidator(Region_SelectionListForEntityPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Region_SelectionListForEntityPDSAValidator";

      // Create Properties for each field in the Region_SelectionListForEntityPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Region_SelectionListForEntityPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Region_SelectionListForEntityPDSAValidator.ColumnNames.DateColumnNameHere);
