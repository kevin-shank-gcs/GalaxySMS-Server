...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertPersonCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertPersonCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertPersonCountPDSA</param>
    public gcsEntityCountPDSA_InsertPersonCountPDSAValidator(gcsEntityCountPDSA_InsertPersonCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertPersonCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertPersonCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertPersonCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertPersonCountPDSAValidator.ColumnNames.DateColumnNameHere);
