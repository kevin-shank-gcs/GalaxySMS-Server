...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedListPropertyItemPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedListPropertyItemPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedListPropertyItemPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedListPropertyItemPDSA</param>
    public UserDefinedListPropertyItemPDSAValidator(UserDefinedListPropertyItemPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedListPropertyItemPDSAValidator";

      // Create Properties for each field in the UserDefinedListPropertyItemPDSA entity class
      InitProperties();
    ...
    public UserDefinedListPropertyItemPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedListPropertyItemPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedListPropertyItemPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedListPropertyItemPDSAValidator.ColumnNames.DateColumnNameHere);
