...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeSchedule_IsScheduleActivePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedule_IsScheduleActivePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedule_IsScheduleActivePDSA</param>
    public TimeSchedule_IsScheduleActivePDSAValidator(TimeSchedule_IsScheduleActivePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedule_IsScheduleActivePDSAValidator";

      // Create Properties for each field in the TimeSchedule_IsScheduleActivePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedule_IsScheduleActivePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedule_IsScheduleActivePDSAValidator.ColumnNames.DateColumnNameHere);
