...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_DoesRowExistPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_DoesRowExistPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_DoesRowExistPDSA</param>
    public gcs_DoesRowExistPDSAValidator(gcs_DoesRowExistPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_DoesRowExistPDSAValidator";

      // Create Properties for each field in the gcs_DoesRowExistPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_DoesRowExistPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_DoesRowExistPDSAValidator.ColumnNames.DateColumnNameHere);
