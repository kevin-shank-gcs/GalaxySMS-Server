...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGenderUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGenderUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGenderUniquePDSA</param>
    public IsGenderUniquePDSAValidator(IsGenderUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGenderUniquePDSAValidator";

      // Create Properties for each field in the IsGenderUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGenderUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGenderUniquePDSAValidator.ColumnNames.DateColumnNameHere);
