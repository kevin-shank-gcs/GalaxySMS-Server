...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanel_GetAllUidsForEntityIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanel_GetAllUidsForEntityIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanel_GetAllUidsForEntityIdPDSA</param>
    public GalaxyPanel_GetAllUidsForEntityIdPDSAValidator(GalaxyPanel_GetAllUidsForEntityIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanel_GetAllUidsForEntityIdPDSAValidator";

      // Create Properties for each field in the GalaxyPanel_GetAllUidsForEntityIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanel_GetAllUidsForEntityIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanel_GetAllUidsForEntityIdPDSAValidator.ColumnNames.DateColumnNameHere);
