...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Region_GetAllUidsFromRoleIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Region_GetAllUidsFromRoleIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Region_GetAllUidsFromRoleIdPDSA</param>
    public Region_GetAllUidsFromRoleIdPDSAValidator(Region_GetAllUidsFromRoleIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Region_GetAllUidsFromRoleIdPDSAValidator";

      // Create Properties for each field in the Region_GetAllUidsFromRoleIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Region_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Region_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.DateColumnNameHere);
