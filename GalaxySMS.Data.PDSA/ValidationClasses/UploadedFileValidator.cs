...
{
  /// <summary>
  /// Used to validate business rules on the UploadedFilePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UploadedFilePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UploadedFilePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UploadedFilePDSA</param>
    public UploadedFilePDSAValidator(UploadedFilePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UploadedFilePDSAValidator";

      // Create Properties for each field in the UploadedFilePDSA entity class
      InitProperties();
    ...
    public UploadedFilePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UploadedFilePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UploadedFilePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UploadedFilePDSAValidator.ColumnNames.DateColumnNameHere);
