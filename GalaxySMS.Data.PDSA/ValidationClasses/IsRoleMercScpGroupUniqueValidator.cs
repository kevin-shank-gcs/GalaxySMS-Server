...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleMercScpGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleMercScpGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleMercScpGroupUniquePDSA</param>
    public IsRoleMercScpGroupUniquePDSAValidator(IsRoleMercScpGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleMercScpGroupUniquePDSAValidator";

      // Create Properties for each field in the IsRoleMercScpGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleMercScpGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleMercScpGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
