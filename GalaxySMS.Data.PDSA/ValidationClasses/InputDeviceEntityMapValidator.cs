...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceEntityMapPDSA</param>
    public InputDeviceEntityMapPDSAValidator(InputDeviceEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceEntityMapPDSAValidator";

      // Create Properties for each field in the InputDeviceEntityMapPDSA entity class
      InitProperties();
    ...
    public InputDeviceEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
