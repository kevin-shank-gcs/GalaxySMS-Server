...
{
  /// <summary>
  /// Used to validate business rules on the CredentialFormatParityPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialFormatParityPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialFormatParityPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialFormatParityPDSA</param>
    public CredentialFormatParityPDSAValidator(CredentialFormatParityPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialFormatParityPDSAValidator";

      // Create Properties for each field in the CredentialFormatParityPDSA entity class
      InitProperties();
    ...
    public CredentialFormatParityPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialFormatParityPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialFormatParityPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialFormatParityPDSAValidator.ColumnNames.DateColumnNameHere);
