...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedBooleanPropertyRulesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedBooleanPropertyRulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedBooleanPropertyRulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedBooleanPropertyRulesPDSA</param>
    public UserDefinedBooleanPropertyRulesPDSAValidator(UserDefinedBooleanPropertyRulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedBooleanPropertyRulesPDSAValidator";

      // Create Properties for each field in the UserDefinedBooleanPropertyRulesPDSA entity class
      InitProperties();
    ...
    public UserDefinedBooleanPropertyRulesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedBooleanPropertyRulesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedBooleanPropertyRulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedBooleanPropertyRulesPDSAValidator.ColumnNames.DateColumnNameHere);
