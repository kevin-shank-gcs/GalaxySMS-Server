...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupUids_SelectForClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupUids_SelectForClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupUids_SelectForClusterUidPDSA</param>
    public AccessGroupUids_SelectForClusterUidPDSAValidator(AccessGroupUids_SelectForClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupUids_SelectForClusterUidPDSAValidator";

      // Create Properties for each field in the AccessGroupUids_SelectForClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupUids_SelectForClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupUids_SelectForClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
