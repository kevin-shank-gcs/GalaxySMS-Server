...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA</param>
    public GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator(GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.DateColumnNameHere);
