...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalAlertEventTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalAlertEventTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalAlertEventTypeUniquePDSA</param>
    public IsAccessPortalAlertEventTypeUniquePDSAValidator(IsAccessPortalAlertEventTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalAlertEventTypeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalAlertEventTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalAlertEventTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalAlertEventTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
