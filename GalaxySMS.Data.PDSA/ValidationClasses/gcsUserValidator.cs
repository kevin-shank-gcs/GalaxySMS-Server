...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserPDSA</param>
    public gcsUserPDSAValidator(gcsUserPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserPDSAValidator";

      // Create Properties for each field in the gcsUserPDSA entity class
      InitProperties();
    ...
    public gcsUserPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.DateColumnNameHere);
