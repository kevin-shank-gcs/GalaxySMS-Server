...
{
  /// <summary>
  /// Used to validate business rules on the InputOutputGroup_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class InputOutputGroup_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroup_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroup_PanelLoadDataPDSA</param>
    public InputOutputGroup_PanelLoadDataPDSAValidator(InputOutputGroup_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroup_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the InputOutputGroup_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A InputOutputGroup_PanelLoadDataPDSA object</returns>
    public InputOutputGroup_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputOutputGroup_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroup_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroup_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
