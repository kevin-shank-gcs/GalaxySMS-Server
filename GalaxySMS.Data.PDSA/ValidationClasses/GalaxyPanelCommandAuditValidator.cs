...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelCommandAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelCommandAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelCommandAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelCommandAuditPDSA</param>
    public GalaxyPanelCommandAuditPDSAValidator(GalaxyPanelCommandAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelCommandAuditPDSAValidator";

      // Create Properties for each field in the GalaxyPanelCommandAuditPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelCommandAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelCommandAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelCommandAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelCommandAuditPDSAValidator.ColumnNames.DateColumnNameHere);
