...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedTextPropertyRulesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedTextPropertyRulesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedTextPropertyRulesUniquePDSA</param>
    public IsUserDefinedTextPropertyRulesUniquePDSAValidator(IsUserDefinedTextPropertyRulesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedTextPropertyRulesUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedTextPropertyRulesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedTextPropertyRulesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedTextPropertyRulesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
