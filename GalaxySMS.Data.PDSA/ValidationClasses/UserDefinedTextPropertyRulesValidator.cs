...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedTextPropertyRulesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedTextPropertyRulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedTextPropertyRulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedTextPropertyRulesPDSA</param>
    public UserDefinedTextPropertyRulesPDSAValidator(UserDefinedTextPropertyRulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedTextPropertyRulesPDSAValidator";

      // Create Properties for each field in the UserDefinedTextPropertyRulesPDSA entity class
      InitProperties();
    ...
    public UserDefinedTextPropertyRulesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedTextPropertyRulesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedTextPropertyRulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedTextPropertyRulesPDSAValidator.ColumnNames.DateColumnNameHere);
