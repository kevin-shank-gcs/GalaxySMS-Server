...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInterfaceBoardSectionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInterfaceBoardSectionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSectionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSectionPDSA</param>
    public GalaxyInterfaceBoardSectionPDSAValidator(GalaxyInterfaceBoardSectionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSectionPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSectionPDSA entity class
      InitProperties();
    ...
    public GalaxyInterfaceBoardSectionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInterfaceBoardSectionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionPDSAValidator.ColumnNames.DateColumnNameHere);
