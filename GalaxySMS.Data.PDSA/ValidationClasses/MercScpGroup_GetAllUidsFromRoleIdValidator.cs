...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class MercScpGroup_GetAllUidsFromRoleIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpGroup_GetAllUidsFromRoleIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpGroup_GetAllUidsFromRoleIdPDSA</param>
    public MercScpGroup_GetAllUidsFromRoleIdPDSAValidator(MercScpGroup_GetAllUidsFromRoleIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpGroup_GetAllUidsFromRoleIdPDSAValidator";

      // Create Properties for each field in the MercScpGroup_GetAllUidsFromRoleIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpGroup_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpGroup_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.DateColumnNameHere);
