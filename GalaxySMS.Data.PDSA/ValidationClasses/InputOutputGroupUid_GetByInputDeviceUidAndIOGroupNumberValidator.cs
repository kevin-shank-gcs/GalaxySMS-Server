...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSA</param>
    public InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSAValidator(InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSAValidator";

      // Create Properties for each field in the InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupUid_GetByInputDeviceUidAndIOGroupNumberPDSAValidator.ColumnNames.DateColumnNameHere);
