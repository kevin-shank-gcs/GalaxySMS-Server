...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupCommandUniquePDSA</param>
    public IsInputOutputGroupCommandUniquePDSAValidator(IsInputOutputGroupCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupCommandUniquePDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
