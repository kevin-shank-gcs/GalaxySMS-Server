...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInterfaceBoardSectionNodePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInterfaceBoardSectionNodePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSectionNodePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSectionNodePDSA</param>
    public GalaxyInterfaceBoardSectionNodePDSAValidator(GalaxyInterfaceBoardSectionNodePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSectionNodePDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSectionNodePDSA entity class
      InitProperties();
    ...
    public GalaxyInterfaceBoardSectionNodePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInterfaceBoardSectionNodePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.DateColumnNameHere);
