...
{
  /// <summary>
  /// Used to validate business rules on the RoleOutputDevicePermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleOutputDevicePermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleOutputDevicePermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleOutputDevicePermissionPDSA</param>
    public RoleOutputDevicePermissionPDSAValidator(RoleOutputDevicePermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleOutputDevicePermissionPDSAValidator";

      // Create Properties for each field in the RoleOutputDevicePermissionPDSA entity class
      InitProperties();
    ...
    public RoleOutputDevicePermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleOutputDevicePermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleOutputDevicePermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleOutputDevicePermissionPDSAValidator.ColumnNames.DateColumnNameHere);
