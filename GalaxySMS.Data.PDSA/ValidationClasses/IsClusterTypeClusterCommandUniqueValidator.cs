...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterTypeClusterCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterTypeClusterCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterTypeClusterCommandUniquePDSA</param>
    public IsClusterTypeClusterCommandUniquePDSAValidator(IsClusterTypeClusterCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterTypeClusterCommandUniquePDSAValidator";

      // Create Properties for each field in the IsClusterTypeClusterCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterTypeClusterCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterTypeClusterCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
