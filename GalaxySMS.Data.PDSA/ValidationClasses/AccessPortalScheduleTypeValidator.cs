...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalScheduleTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalScheduleTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalScheduleTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalScheduleTypePDSA</param>
    public AccessPortalScheduleTypePDSAValidator(AccessPortalScheduleTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalScheduleTypePDSAValidator";

      // Create Properties for each field in the AccessPortalScheduleTypePDSA entity class
      InitProperties();
    ...
    public AccessPortalScheduleTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalScheduleTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalScheduleTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalScheduleTypePDSAValidator.ColumnNames.DateColumnNameHere);
