...
{
  /// <summary>
  /// Used to validate business rules on the PersonCredentialRolePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonCredentialRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonCredentialRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonCredentialRolePDSA</param>
    public PersonCredentialRolePDSAValidator(PersonCredentialRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonCredentialRolePDSAValidator";

      // Create Properties for each field in the PersonCredentialRolePDSA entity class
      InitProperties();
    ...
    public PersonCredentialRolePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonCredentialRolePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonCredentialRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonCredentialRolePDSAValidator.ColumnNames.DateColumnNameHere);
