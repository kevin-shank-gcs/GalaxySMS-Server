...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_GetRowCountFromTableByBigIntColumnValuePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_GetRowCountFromTableByBigIntColumnValuePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_GetRowCountFromTableByBigIntColumnValuePDSA</param>
    public gcs_GetRowCountFromTableByBigIntColumnValuePDSAValidator(gcs_GetRowCountFromTableByBigIntColumnValuePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_GetRowCountFromTableByBigIntColumnValuePDSAValidator";

      // Create Properties for each field in the gcs_GetRowCountFromTableByBigIntColumnValuePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_GetRowCountFromTableByBigIntColumnValuePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_GetRowCountFromTableByBigIntColumnValuePDSAValidator.ColumnNames.DateColumnNameHere);
