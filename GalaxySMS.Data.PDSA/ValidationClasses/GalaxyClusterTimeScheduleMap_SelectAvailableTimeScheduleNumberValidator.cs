...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSA</param>
    public GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSAValidator(GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSAValidator";

      // Create Properties for each field in the GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyClusterTimeScheduleMap_SelectAvailableTimeScheduleNumberPDSAValidator.ColumnNames.DateColumnNameHere);
