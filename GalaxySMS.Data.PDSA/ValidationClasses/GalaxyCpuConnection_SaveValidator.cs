...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyCpuConnection_SavePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuConnection_SavePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuConnection_SavePDSA</param>
    public GalaxyCpuConnection_SavePDSAValidator(GalaxyCpuConnection_SavePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuConnection_SavePDSAValidator";

      // Create Properties for each field in the GalaxyCpuConnection_SavePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuConnection_SavePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuConnection_SavePDSAValidator.ColumnNames.DateColumnNameHere);
