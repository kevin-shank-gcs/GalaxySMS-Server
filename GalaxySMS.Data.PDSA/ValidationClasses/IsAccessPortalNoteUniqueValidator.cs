...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalNoteUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalNoteUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalNoteUniquePDSA</param>
    public IsAccessPortalNoteUniquePDSAValidator(IsAccessPortalNoteUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalNoteUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalNoteUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalNoteUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalNoteUniquePDSAValidator.ColumnNames.DateColumnNameHere);
