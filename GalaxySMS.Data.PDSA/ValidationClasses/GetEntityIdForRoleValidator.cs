...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForRolePDSA</param>
    public GetEntityIdForRolePDSAValidator(GetEntityIdForRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForRolePDSAValidator";

      // Create Properties for each field in the GetEntityIdForRolePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForRolePDSAValidator.ColumnNames.DateColumnNameHere);
