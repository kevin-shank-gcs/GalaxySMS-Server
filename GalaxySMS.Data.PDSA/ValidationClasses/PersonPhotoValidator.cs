...
{
  /// <summary>
  /// Used to validate business rules on the PersonPhotoPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonPhotoPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPhotoPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPhotoPDSA</param>
    public PersonPhotoPDSAValidator(PersonPhotoPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPhotoPDSAValidator";

      // Create Properties for each field in the PersonPhotoPDSA entity class
      InitProperties();
    ...
    public PersonPhotoPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonPhotoPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPhotoPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPhotoPDSAValidator.ColumnNames.DateColumnNameHere);
