...
{
  /// <summary>
  /// Used to validate business rules on the BadgeTemplateEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BadgeTemplateEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BadgeTemplateEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BadgeTemplateEntityMapPDSA</param>
    public BadgeTemplateEntityMapPDSAValidator(BadgeTemplateEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BadgeTemplateEntityMapPDSAValidator";

      // Create Properties for each field in the BadgeTemplateEntityMapPDSA entity class
      InitProperties();
    ...
    public BadgeTemplateEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BadgeTemplateEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BadgeTemplateEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BadgeTemplateEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
