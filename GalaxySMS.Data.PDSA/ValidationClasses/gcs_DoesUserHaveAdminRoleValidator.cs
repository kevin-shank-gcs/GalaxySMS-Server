...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_DoesUserHaveAdminRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_DoesUserHaveAdminRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_DoesUserHaveAdminRolePDSA</param>
    public gcs_DoesUserHaveAdminRolePDSAValidator(gcs_DoesUserHaveAdminRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_DoesUserHaveAdminRolePDSAValidator";

      // Create Properties for each field in the gcs_DoesUserHaveAdminRolePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_DoesUserHaveAdminRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_DoesUserHaveAdminRolePDSAValidator.ColumnNames.DateColumnNameHere);
