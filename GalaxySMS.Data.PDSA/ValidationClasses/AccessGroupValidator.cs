...
{
  /// <summary>
  /// Used to validate business rules on the AccessGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupPDSA</param>
    public AccessGroupPDSAValidator(AccessGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupPDSAValidator";

      // Create Properties for each field in the AccessGroupPDSA entity class
      InitProperties();
    ...
    public AccessGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupPDSAValidator.ColumnNames.DateColumnNameHere);
