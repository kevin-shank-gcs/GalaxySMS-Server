...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntity_GetTimeScheduleCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntity_GetTimeScheduleCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntity_GetTimeScheduleCountPDSA</param>
    public gcsEntity_GetTimeScheduleCountPDSAValidator(gcsEntity_GetTimeScheduleCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntity_GetTimeScheduleCountPDSAValidator";

      // Create Properties for each field in the gcsEntity_GetTimeScheduleCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntity_GetTimeScheduleCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntity_GetTimeScheduleCountPDSAValidator.ColumnNames.DateColumnNameHere);
