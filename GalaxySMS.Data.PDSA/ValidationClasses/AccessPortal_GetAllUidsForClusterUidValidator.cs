...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetAllUidsForClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetAllUidsForClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetAllUidsForClusterUidPDSA</param>
    public AccessPortal_GetAllUidsForClusterUidPDSAValidator(AccessPortal_GetAllUidsForClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetAllUidsForClusterUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetAllUidsForClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetAllUidsForClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetAllUidsForClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
