...
{
  /// <summary>
  /// Used to validate business rules on the LiquidCrystalDisplayEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class LiquidCrystalDisplayEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the LiquidCrystalDisplayEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a LiquidCrystalDisplayEntityMapPDSA</param>
    public LiquidCrystalDisplayEntityMapPDSAValidator(LiquidCrystalDisplayEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "LiquidCrystalDisplayEntityMapPDSAValidator";

      // Create Properties for each field in the LiquidCrystalDisplayEntityMapPDSA entity class
      InitProperties();
    ...
    public LiquidCrystalDisplayEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your LiquidCrystalDisplayEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(LiquidCrystalDisplayEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(LiquidCrystalDisplayEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
