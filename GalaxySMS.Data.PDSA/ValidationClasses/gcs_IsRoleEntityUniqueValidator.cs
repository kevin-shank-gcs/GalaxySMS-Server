...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsRoleEntityUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsRoleEntityUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsRoleEntityUniquePDSA</param>
    public gcs_IsRoleEntityUniquePDSAValidator(gcs_IsRoleEntityUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsRoleEntityUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsRoleEntityUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsRoleEntityUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsRoleEntityUniquePDSAValidator.ColumnNames.DateColumnNameHere);
