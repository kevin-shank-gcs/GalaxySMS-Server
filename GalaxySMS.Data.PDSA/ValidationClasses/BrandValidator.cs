...
{
  /// <summary>
  /// Used to validate business rules on the BrandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BrandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BrandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BrandPDSA</param>
    public BrandPDSAValidator(BrandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BrandPDSAValidator";

      // Create Properties for each field in the BrandPDSA entity class
      InitProperties();
    ...
    public BrandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BrandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BrandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BrandPDSAValidator.ColumnNames.DateColumnNameHere);
