...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntity_SetAutoMapTimeSchedulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntity_SetAutoMapTimeSchedulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntity_SetAutoMapTimeSchedulesPDSA</param>
    public gcsEntity_SetAutoMapTimeSchedulesPDSAValidator(gcsEntity_SetAutoMapTimeSchedulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntity_SetAutoMapTimeSchedulesPDSAValidator";

      // Create Properties for each field in the gcsEntity_SetAutoMapTimeSchedulesPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntity_SetAutoMapTimeSchedulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntity_SetAutoMapTimeSchedulesPDSAValidator.ColumnNames.DateColumnNameHere);
