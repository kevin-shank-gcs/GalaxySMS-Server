...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSA</param>
    public CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSAValidator(CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSAValidator";

      // Create Properties for each field in the CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToLoadToCpu_SaveLastPersonalAccessGroupLoadedDatePDSAValidator.ColumnNames.DateColumnNameHere);
