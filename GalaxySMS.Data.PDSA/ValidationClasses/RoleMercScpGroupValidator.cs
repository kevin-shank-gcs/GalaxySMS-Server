...
{
  /// <summary>
  /// Used to validate business rules on the RoleMercScpGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleMercScpGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleMercScpGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleMercScpGroupPDSA</param>
    public RoleMercScpGroupPDSAValidator(RoleMercScpGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleMercScpGroupPDSAValidator";

      // Create Properties for each field in the RoleMercScpGroupPDSA entity class
      InitProperties();
    ...
    public RoleMercScpGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleMercScpGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleMercScpGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleMercScpGroupPDSAValidator.ColumnNames.DateColumnNameHere);
