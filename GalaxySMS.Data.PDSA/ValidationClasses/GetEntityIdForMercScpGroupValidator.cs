...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForMercScpGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForMercScpGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForMercScpGroupPDSA</param>
    public GetEntityIdForMercScpGroupPDSAValidator(GetEntityIdForMercScpGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForMercScpGroupPDSAValidator";

      // Create Properties for each field in the GetEntityIdForMercScpGroupPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForMercScpGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForMercScpGroupPDSAValidator.ColumnNames.DateColumnNameHere);
