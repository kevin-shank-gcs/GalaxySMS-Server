...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelSitePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelSitePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelSitePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelSitePDSA</param>
    public GalaxyPanelSitePDSAValidator(GalaxyPanelSitePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelSitePDSAValidator";

      // Create Properties for each field in the GalaxyPanelSitePDSA entity class
      InitProperties();
    ...
    public GalaxyPanelSitePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelSitePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelSitePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelSitePDSAValidator.ColumnNames.DateColumnNameHere);
