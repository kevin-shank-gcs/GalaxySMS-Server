...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonPhotoUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonPhotoUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonPhotoUniquePDSA</param>
    public IsPersonPhotoUniquePDSAValidator(IsPersonPhotoUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonPhotoUniquePDSAValidator";

      // Create Properties for each field in the IsPersonPhotoUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonPhotoUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonPhotoUniquePDSAValidator.ColumnNames.DateColumnNameHere);
