...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonCredentialRoleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonCredentialRoleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonCredentialRoleUniquePDSA</param>
    public IsPersonCredentialRoleUniquePDSAValidator(IsPersonCredentialRoleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonCredentialRoleUniquePDSAValidator";

      // Create Properties for each field in the IsPersonCredentialRoleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonCredentialRoleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonCredentialRoleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
