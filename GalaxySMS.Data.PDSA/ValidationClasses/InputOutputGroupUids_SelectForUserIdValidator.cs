...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupUids_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupUids_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupUids_SelectForUserIdPDSA</param>
    public InputOutputGroupUids_SelectForUserIdPDSAValidator(InputOutputGroupUids_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupUids_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the InputOutputGroupUids_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupUids_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupUids_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
