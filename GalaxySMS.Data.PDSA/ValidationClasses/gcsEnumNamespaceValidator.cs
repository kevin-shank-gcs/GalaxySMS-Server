...
{
  /// <summary>
  /// Used to validate business rules on the gcsEnumNamespacePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsEnumNamespacePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEnumNamespacePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEnumNamespacePDSA</param>
    public gcsEnumNamespacePDSAValidator(gcsEnumNamespacePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEnumNamespacePDSAValidator";

      // Create Properties for each field in the gcsEnumNamespacePDSA entity class
      InitProperties();
    ...
    public gcsEnumNamespacePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsEnumNamespacePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEnumNamespacePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEnumNamespacePDSAValidator.ColumnNames.DateColumnNameHere);
