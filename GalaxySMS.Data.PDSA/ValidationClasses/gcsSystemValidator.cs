...
{
  /// <summary>
  /// Used to validate business rules on the gcsSystemPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsSystemPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsSystemPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsSystemPDSA</param>
    public gcsSystemPDSAValidator(gcsSystemPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsSystemPDSAValidator";

      // Create Properties for each field in the gcsSystemPDSA entity class
      InitProperties();
    ...
    public gcsSystemPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsSystemPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsSystemPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsSystemPDSAValidator.ColumnNames.DateColumnNameHere);
