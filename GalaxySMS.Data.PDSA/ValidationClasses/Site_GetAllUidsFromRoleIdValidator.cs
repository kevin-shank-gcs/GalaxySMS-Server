...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Site_GetAllUidsFromRoleIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Site_GetAllUidsFromRoleIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Site_GetAllUidsFromRoleIdPDSA</param>
    public Site_GetAllUidsFromRoleIdPDSAValidator(Site_GetAllUidsFromRoleIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Site_GetAllUidsFromRoleIdPDSAValidator";

      // Create Properties for each field in the Site_GetAllUidsFromRoleIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Site_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Site_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.DateColumnNameHere);
