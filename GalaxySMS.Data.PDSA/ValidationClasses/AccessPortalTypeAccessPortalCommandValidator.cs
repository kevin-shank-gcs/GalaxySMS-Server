...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalTypeAccessPortalCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalTypeAccessPortalCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalTypeAccessPortalCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalTypeAccessPortalCommandPDSA</param>
    public AccessPortalTypeAccessPortalCommandPDSAValidator(AccessPortalTypeAccessPortalCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalTypeAccessPortalCommandPDSAValidator";

      // Create Properties for each field in the AccessPortalTypeAccessPortalCommandPDSA entity class
      InitProperties();
    ...
    public AccessPortalTypeAccessPortalCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalTypeAccessPortalCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalTypeAccessPortalCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalTypeAccessPortalCommandPDSAValidator.ColumnNames.DateColumnNameHere);
