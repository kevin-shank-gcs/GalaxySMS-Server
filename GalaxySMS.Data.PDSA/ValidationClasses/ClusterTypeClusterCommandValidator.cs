...
{
  /// <summary>
  /// Used to validate business rules on the ClusterTypeClusterCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterTypeClusterCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterTypeClusterCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterTypeClusterCommandPDSA</param>
    public ClusterTypeClusterCommandPDSAValidator(ClusterTypeClusterCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterTypeClusterCommandPDSAValidator";

      // Create Properties for each field in the ClusterTypeClusterCommandPDSA entity class
      InitProperties();
    ...
    public ClusterTypeClusterCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterTypeClusterCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterTypeClusterCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterTypeClusterCommandPDSAValidator.ColumnNames.DateColumnNameHere);
