...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSA</param>
    public AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSAValidator(AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByInputDeviceAlarmEventAcknowledgmentUidPDSAValidator.ColumnNames.DateColumnNameHere);
