...
{
  /// <summary>
  /// Used to validate business rules on the UserEntityRoleViewPDSA class.
  ...
  /// </summary>
  public partial class UserEntityRoleViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserEntityRoleViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserEntityRoleViewPDSA</param>
    public UserEntityRoleViewPDSAValidator(UserEntityRoleViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserEntityRoleViewPDSAValidator";

      // Create Properties for each field in the UserEntityRoleViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A UserEntityRoleViewPDSA object</returns>
    public UserEntityRoleViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserEntityRoleViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserEntityRoleViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserEntityRoleViewPDSAValidator.ColumnNames.DateColumnNameHere);
