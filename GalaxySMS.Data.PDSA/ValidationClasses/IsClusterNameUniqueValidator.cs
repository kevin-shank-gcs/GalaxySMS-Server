...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterNameUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterNameUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterNameUniquePDSA</param>
    public IsClusterNameUniquePDSAValidator(IsClusterNameUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterNameUniquePDSAValidator";

      // Create Properties for each field in the IsClusterNameUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterNameUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterNameUniquePDSAValidator.ColumnNames.DateColumnNameHere);
