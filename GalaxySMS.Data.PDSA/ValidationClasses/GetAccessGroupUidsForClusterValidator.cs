...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetAccessGroupUidsForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetAccessGroupUidsForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetAccessGroupUidsForClusterPDSA</param>
    public GetAccessGroupUidsForClusterPDSAValidator(GetAccessGroupUidsForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetAccessGroupUidsForClusterPDSAValidator";

      // Create Properties for each field in the GetAccessGroupUidsForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetAccessGroupUidsForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetAccessGroupUidsForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
