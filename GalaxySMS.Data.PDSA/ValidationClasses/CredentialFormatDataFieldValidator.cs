...
{
  /// <summary>
  /// Used to validate business rules on the CredentialFormatDataFieldPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialFormatDataFieldPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialFormatDataFieldPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialFormatDataFieldPDSA</param>
    public CredentialFormatDataFieldPDSAValidator(CredentialFormatDataFieldPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialFormatDataFieldPDSAValidator";

      // Create Properties for each field in the CredentialFormatDataFieldPDSA entity class
      InitProperties();
    ...
    public CredentialFormatDataFieldPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialFormatDataFieldPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialFormatDataFieldPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialFormatDataFieldPDSAValidator.ColumnNames.DateColumnNameHere);
