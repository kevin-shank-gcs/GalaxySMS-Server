...
{
  /// <summary>
  /// Used to validate business rules on the CredentialDataPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialDataPDSA</param>
    public CredentialDataPDSAValidator(CredentialDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialDataPDSAValidator";

      // Create Properties for each field in the CredentialDataPDSA entity class
      InitProperties();
    ...
    public CredentialDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialDataPDSAValidator.ColumnNames.DateColumnNameHere);
