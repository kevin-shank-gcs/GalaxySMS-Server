...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AcknowledgedAlarms_ByDeviceUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarms_ByDeviceUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarms_ByDeviceUidPDSA</param>
    public AcknowledgedAlarms_ByDeviceUidPDSAValidator(AcknowledgedAlarms_ByDeviceUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarms_ByDeviceUidPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarms_ByDeviceUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarms_ByDeviceUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarms_ByDeviceUidPDSAValidator.ColumnNames.DateColumnNameHere);
