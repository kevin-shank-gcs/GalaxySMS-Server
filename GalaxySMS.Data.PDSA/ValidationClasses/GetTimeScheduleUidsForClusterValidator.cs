...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetTimeScheduleUidsForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetTimeScheduleUidsForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetTimeScheduleUidsForClusterPDSA</param>
    public GetTimeScheduleUidsForClusterPDSAValidator(GetTimeScheduleUidsForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetTimeScheduleUidsForClusterPDSAValidator";

      // Create Properties for each field in the GetTimeScheduleUidsForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetTimeScheduleUidsForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetTimeScheduleUidsForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
