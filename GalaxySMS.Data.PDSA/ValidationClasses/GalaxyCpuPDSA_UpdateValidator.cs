...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyCpuPDSA_UpdatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuPDSA_UpdatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuPDSA_UpdatePDSA</param>
    public GalaxyCpuPDSA_UpdatePDSAValidator(GalaxyCpuPDSA_UpdatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuPDSA_UpdatePDSAValidator";

      // Create Properties for each field in the GalaxyCpuPDSA_UpdatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuPDSA_UpdatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuPDSA_UpdatePDSAValidator.ColumnNames.DateColumnNameHere);
