...
{
  /// <summary>
  /// Used to validate business rules on the CredentialFormatEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialFormatEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialFormatEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialFormatEntityMapPDSA</param>
    public CredentialFormatEntityMapPDSAValidator(CredentialFormatEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialFormatEntityMapPDSAValidator";

      // Create Properties for each field in the CredentialFormatEntityMapPDSA entity class
      InitProperties();
    ...
    public CredentialFormatEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialFormatEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialFormatEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialFormatEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
