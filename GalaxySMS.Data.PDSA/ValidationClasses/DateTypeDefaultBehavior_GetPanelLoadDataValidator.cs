...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateTypeDefaultBehavior_GetPanelLoadDataPDSA</param>
    public DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator(DateTypeDefaultBehavior_GetPanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator";

      // Create Properties for each field in the DateTypeDefaultBehavior_GetPanelLoadDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
