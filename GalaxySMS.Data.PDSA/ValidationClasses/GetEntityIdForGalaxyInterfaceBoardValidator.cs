...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyInterfaceBoardPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyInterfaceBoardPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyInterfaceBoardPDSA</param>
    public GetEntityIdForGalaxyInterfaceBoardPDSAValidator(GetEntityIdForGalaxyInterfaceBoardPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyInterfaceBoardPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyInterfaceBoardPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyInterfaceBoardPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyInterfaceBoardPDSAValidator.ColumnNames.DateColumnNameHere);
