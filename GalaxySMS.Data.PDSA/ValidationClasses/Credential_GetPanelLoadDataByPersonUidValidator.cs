...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Credential_GetPanelLoadDataByPersonUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_GetPanelLoadDataByPersonUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_GetPanelLoadDataByPersonUidPDSA</param>
    public Credential_GetPanelLoadDataByPersonUidPDSAValidator(Credential_GetPanelLoadDataByPersonUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_GetPanelLoadDataByPersonUidPDSAValidator";

      // Create Properties for each field in the Credential_GetPanelLoadDataByPersonUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_GetPanelLoadDataByPersonUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_GetPanelLoadDataByPersonUidPDSAValidator.ColumnNames.DateColumnNameHere);
