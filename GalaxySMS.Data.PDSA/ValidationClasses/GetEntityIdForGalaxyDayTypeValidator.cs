...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyDayTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyDayTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyDayTypePDSA</param>
    public GetEntityIdForGalaxyDayTypePDSAValidator(GetEntityIdForGalaxyDayTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyDayTypePDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyDayTypePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyDayTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyDayTypePDSAValidator.ColumnNames.DateColumnNameHere);
