...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaDayPeriodUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaDayPeriodUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaDayPeriodUniquePDSA</param>
    public IsAssaDayPeriodUniquePDSAValidator(IsAssaDayPeriodUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaDayPeriodUniquePDSAValidator";

      // Create Properties for each field in the IsAssaDayPeriodUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaDayPeriodUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaDayPeriodUniquePDSAValidator.ColumnNames.DateColumnNameHere);
