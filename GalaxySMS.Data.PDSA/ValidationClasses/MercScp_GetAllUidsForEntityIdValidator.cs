...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class MercScp_GetAllUidsForEntityIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScp_GetAllUidsForEntityIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScp_GetAllUidsForEntityIdPDSA</param>
    public MercScp_GetAllUidsForEntityIdPDSAValidator(MercScp_GetAllUidsForEntityIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScp_GetAllUidsForEntityIdPDSAValidator";

      // Create Properties for each field in the MercScp_GetAllUidsForEntityIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScp_GetAllUidsForEntityIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScp_GetAllUidsForEntityIdPDSAValidator.ColumnNames.DateColumnNameHere);
