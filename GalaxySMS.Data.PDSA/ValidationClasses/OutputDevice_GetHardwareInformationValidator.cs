...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetHardwareInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetHardwareInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetHardwareInformationPDSA</param>
    public OutputDevice_GetHardwareInformationPDSAValidator(OutputDevice_GetHardwareInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetHardwareInformationPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetHardwareInformationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ColumnNames.DateColumnNameHere);
