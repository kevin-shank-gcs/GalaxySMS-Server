...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_CanRowBeDeletedPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_CanRowBeDeletedPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_CanRowBeDeletedPDSA</param>
    public gcs_CanRowBeDeletedPDSAValidator(gcs_CanRowBeDeletedPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_CanRowBeDeletedPDSAValidator";

      // Create Properties for each field in the gcs_CanRowBeDeletedPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_CanRowBeDeletedPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_CanRowBeDeletedPDSAValidator.ColumnNames.DateColumnNameHere);
