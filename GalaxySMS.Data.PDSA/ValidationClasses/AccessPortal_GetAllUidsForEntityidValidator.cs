...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetAllUidsForEntityidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetAllUidsForEntityidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetAllUidsForEntityidPDSA</param>
    public AccessPortal_GetAllUidsForEntityidPDSAValidator(AccessPortal_GetAllUidsForEntityidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetAllUidsForEntityidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetAllUidsForEntityidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetAllUidsForEntityidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetAllUidsForEntityidPDSAValidator.ColumnNames.DateColumnNameHere);
