...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInputModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInputModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInputModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInputModePDSA</param>
    public GalaxyInputModePDSAValidator(GalaxyInputModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInputModePDSAValidator";

      // Create Properties for each field in the GalaxyInputModePDSA entity class
      InitProperties();
    ...
    public GalaxyInputModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInputModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInputModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInputModePDSAValidator.ColumnNames.DateColumnNameHere);
