...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetInputOutputGroupUidsForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetInputOutputGroupUidsForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetInputOutputGroupUidsForClusterPDSA</param>
    public GetInputOutputGroupUidsForClusterPDSAValidator(GetInputOutputGroupUidsForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetInputOutputGroupUidsForClusterPDSAValidator";

      // Create Properties for each field in the GetInputOutputGroupUidsForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetInputOutputGroupUidsForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetInputOutputGroupUidsForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
