...
{
  /// <summary>
  /// Used to validate business rules on the gcsSerializedObjectPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsSerializedObjectPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsSerializedObjectPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsSerializedObjectPDSA</param>
    public gcsSerializedObjectPDSAValidator(gcsSerializedObjectPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsSerializedObjectPDSAValidator";

      // Create Properties for each field in the gcsSerializedObjectPDSA entity class
      InitProperties();
    ...
    public gcsSerializedObjectPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsSerializedObjectPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsSerializedObjectPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsSerializedObjectPDSAValidator.ColumnNames.DateColumnNameHere);
