...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntity_GetAutoMapTimeSchedulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntity_GetAutoMapTimeSchedulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntity_GetAutoMapTimeSchedulesPDSA</param>
    public gcsEntity_GetAutoMapTimeSchedulesPDSAValidator(gcsEntity_GetAutoMapTimeSchedulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntity_GetAutoMapTimeSchedulesPDSAValidator";

      // Create Properties for each field in the gcsEntity_GetAutoMapTimeSchedulesPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntity_GetAutoMapTimeSchedulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntity_GetAutoMapTimeSchedulesPDSAValidator.ColumnNames.DateColumnNameHere);
