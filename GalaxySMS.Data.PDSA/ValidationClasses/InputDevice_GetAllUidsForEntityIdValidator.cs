...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetAllUidsForEntityIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetAllUidsForEntityIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetAllUidsForEntityIdPDSA</param>
    public InputDevice_GetAllUidsForEntityIdPDSAValidator(InputDevice_GetAllUidsForEntityIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetAllUidsForEntityIdPDSAValidator";

      // Create Properties for each field in the InputDevice_GetAllUidsForEntityIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetAllUidsForEntityIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetAllUidsForEntityIdPDSAValidator.ColumnNames.DateColumnNameHere);
