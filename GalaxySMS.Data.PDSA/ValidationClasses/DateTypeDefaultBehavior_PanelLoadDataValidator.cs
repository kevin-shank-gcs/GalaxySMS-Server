...
{
  /// <summary>
  /// Used to validate business rules on the DateTypeDefaultBehavior_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class DateTypeDefaultBehavior_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateTypeDefaultBehavior_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateTypeDefaultBehavior_PanelLoadDataPDSA</param>
    public DateTypeDefaultBehavior_PanelLoadDataPDSAValidator(DateTypeDefaultBehavior_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateTypeDefaultBehavior_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the DateTypeDefaultBehavior_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A DateTypeDefaultBehavior_PanelLoadDataPDSA object</returns>
    public DateTypeDefaultBehavior_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DateTypeDefaultBehavior_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateTypeDefaultBehavior_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateTypeDefaultBehavior_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
