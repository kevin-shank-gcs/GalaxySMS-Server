...
{
  /// <summary>
  /// Used to validate business rules on the SiteEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class SiteEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the SiteEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a SiteEntityMapPDSA</param>
    public SiteEntityMapPDSAValidator(SiteEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "SiteEntityMapPDSAValidator";

      // Create Properties for each field in the SiteEntityMapPDSA entity class
      InitProperties();
    ...
    public SiteEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your SiteEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(SiteEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(SiteEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
