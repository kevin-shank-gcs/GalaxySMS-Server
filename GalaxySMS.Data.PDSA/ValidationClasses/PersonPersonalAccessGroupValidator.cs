...
{
  /// <summary>
  /// Used to validate business rules on the PersonPersonalAccessGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonPersonalAccessGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPersonalAccessGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPersonalAccessGroupPDSA</param>
    public PersonPersonalAccessGroupPDSAValidator(PersonPersonalAccessGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPersonalAccessGroupPDSAValidator";

      // Create Properties for each field in the PersonPersonalAccessGroupPDSA entity class
      InitProperties();
    ...
    public PersonPersonalAccessGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonPersonalAccessGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPersonalAccessGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPersonalAccessGroupPDSAValidator.ColumnNames.DateColumnNameHere);
