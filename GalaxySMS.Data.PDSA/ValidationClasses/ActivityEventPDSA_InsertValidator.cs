...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ActivityEventPDSA_InsertPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ActivityEventPDSA_InsertPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ActivityEventPDSA_InsertPDSA</param>
    public ActivityEventPDSA_InsertPDSAValidator(ActivityEventPDSA_InsertPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ActivityEventPDSA_InsertPDSAValidator";

      // Create Properties for each field in the ActivityEventPDSA_InsertPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ActivityEventPDSA_InsertPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ActivityEventPDSA_InsertPDSAValidator.ColumnNames.DateColumnNameHere);
