...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserRequirementsPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserRequirementsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserRequirementsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserRequirementsPDSA</param>
    public gcsUserRequirementsPDSAValidator(gcsUserRequirementsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserRequirementsPDSAValidator";

      // Create Properties for each field in the gcsUserRequirementsPDSA entity class
      InitProperties();
    ...
    public gcsUserRequirementsPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserRequirementsPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserRequirementsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserRequirementsPDSAValidator.ColumnNames.DateColumnNameHere);
