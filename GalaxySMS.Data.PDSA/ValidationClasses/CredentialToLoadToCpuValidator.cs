...
{
  /// <summary>
  /// Used to validate business rules on the CredentialToLoadToCpuPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialToLoadToCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToLoadToCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToLoadToCpuPDSA</param>
    public CredentialToLoadToCpuPDSAValidator(CredentialToLoadToCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToLoadToCpuPDSAValidator";

      // Create Properties for each field in the CredentialToLoadToCpuPDSA entity class
      InitProperties();
    ...
    public CredentialToLoadToCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialToLoadToCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.DateColumnNameHere);
