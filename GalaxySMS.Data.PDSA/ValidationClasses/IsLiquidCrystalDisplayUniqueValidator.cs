...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsLiquidCrystalDisplayUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsLiquidCrystalDisplayUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsLiquidCrystalDisplayUniquePDSA</param>
    public IsLiquidCrystalDisplayUniquePDSAValidator(IsLiquidCrystalDisplayUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsLiquidCrystalDisplayUniquePDSAValidator";

      // Create Properties for each field in the IsLiquidCrystalDisplayUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsLiquidCrystalDisplayUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsLiquidCrystalDisplayUniquePDSAValidator.ColumnNames.DateColumnNameHere);
