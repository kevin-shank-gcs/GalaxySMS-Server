...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsStateProvinceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsStateProvinceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsStateProvinceUniquePDSA</param>
    public IsStateProvinceUniquePDSAValidator(IsStateProvinceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsStateProvinceUniquePDSAValidator";

      // Create Properties for each field in the IsStateProvinceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsStateProvinceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsStateProvinceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
