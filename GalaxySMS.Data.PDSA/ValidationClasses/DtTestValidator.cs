...
{
  /// <summary>
  /// Used to validate business rules on the DtTestPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class DtTestPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DtTestPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DtTestPDSA</param>
    public DtTestPDSAValidator(DtTestPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DtTestPDSAValidator";

      // Create Properties for each field in the DtTestPDSA entity class
      InitProperties();
    ...
    public DtTestPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DtTestPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DtTestPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DtTestPDSAValidator.ColumnNames.DateColumnNameHere);
