...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForPersonPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForPersonPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForPersonPDSA</param>
    public GetEntityIdForPersonPDSAValidator(GetEntityIdForPersonPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForPersonPDSAValidator";

      // Create Properties for each field in the GetEntityIdForPersonPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForPersonPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForPersonPDSAValidator.ColumnNames.DateColumnNameHere);
