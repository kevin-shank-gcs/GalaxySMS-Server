...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetAllUidsFromRoleIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetAllUidsFromRoleIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetAllUidsFromRoleIdPDSA</param>
    public AccessPortal_GetAllUidsFromRoleIdPDSAValidator(AccessPortal_GetAllUidsFromRoleIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetAllUidsFromRoleIdPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetAllUidsFromRoleIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.DateColumnNameHere);
