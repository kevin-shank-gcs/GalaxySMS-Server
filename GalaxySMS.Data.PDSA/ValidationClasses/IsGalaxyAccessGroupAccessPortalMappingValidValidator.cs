...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyAccessGroupAccessPortalMappingValidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyAccessGroupAccessPortalMappingValidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyAccessGroupAccessPortalMappingValidPDSA</param>
    public IsGalaxyAccessGroupAccessPortalMappingValidPDSAValidator(IsGalaxyAccessGroupAccessPortalMappingValidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyAccessGroupAccessPortalMappingValidPDSAValidator";

      // Create Properties for each field in the IsGalaxyAccessGroupAccessPortalMappingValidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyAccessGroupAccessPortalMappingValidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyAccessGroupAccessPortalMappingValidPDSAValidator.ColumnNames.DateColumnNameHere);
