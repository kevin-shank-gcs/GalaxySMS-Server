...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroup_GetPersonInfoPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_GetPersonInfoPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_GetPersonInfoPDSA</param>
    public AccessGroup_GetPersonInfoPDSAValidator(AccessGroup_GetPersonInfoPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_GetPersonInfoPDSAValidator";

      // Create Properties for each field in the AccessGroup_GetPersonInfoPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_GetPersonInfoPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_GetPersonInfoPDSAValidator.ColumnNames.DateColumnNameHere);
