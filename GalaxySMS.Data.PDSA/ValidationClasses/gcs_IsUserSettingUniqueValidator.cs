...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserSettingUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserSettingUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserSettingUniquePDSA</param>
    public gcs_IsUserSettingUniquePDSAValidator(gcs_IsUserSettingUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserSettingUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsUserSettingUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserSettingUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserSettingUniquePDSAValidator.ColumnNames.DateColumnNameHere);
