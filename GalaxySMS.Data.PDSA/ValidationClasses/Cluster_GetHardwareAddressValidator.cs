...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_GetHardwareAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_GetHardwareAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_GetHardwareAddressPDSA</param>
    public Cluster_GetHardwareAddressPDSAValidator(Cluster_GetHardwareAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_GetHardwareAddressPDSAValidator";

      // Create Properties for each field in the Cluster_GetHardwareAddressPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_GetHardwareAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_GetHardwareAddressPDSAValidator.ColumnNames.DateColumnNameHere);
