...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeSchedule_CanBeUnmappedFromClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedule_CanBeUnmappedFromClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedule_CanBeUnmappedFromClusterPDSA</param>
    public TimeSchedule_CanBeUnmappedFromClusterPDSAValidator(TimeSchedule_CanBeUnmappedFromClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedule_CanBeUnmappedFromClusterPDSAValidator";

      // Create Properties for each field in the TimeSchedule_CanBeUnmappedFromClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedule_CanBeUnmappedFromClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedule_CanBeUnmappedFromClusterPDSAValidator.ColumnNames.DateColumnNameHere);
