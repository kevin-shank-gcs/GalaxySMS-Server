...
{
  /// <summary>
  /// Used to validate business rules on the PersonAccessControlPropertiesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonAccessControlPropertiesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonAccessControlPropertiesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonAccessControlPropertiesPDSA</param>
    public PersonAccessControlPropertiesPDSAValidator(PersonAccessControlPropertiesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonAccessControlPropertiesPDSAValidator";

      // Create Properties for each field in the PersonAccessControlPropertiesPDSA entity class
      InitProperties();
    ...
    public PersonAccessControlPropertiesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonAccessControlPropertiesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonAccessControlPropertiesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonAccessControlPropertiesPDSAValidator.ColumnNames.DateColumnNameHere);
