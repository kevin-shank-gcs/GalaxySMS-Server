...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA</param>
    public AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetPanelLoadDataByAccessPortalUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ColumnNames.DateColumnNameHere);
