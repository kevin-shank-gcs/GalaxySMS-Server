...
{
  /// <summary>
  /// Used to validate business rules on the DateType_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class DateType_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateType_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateType_PanelLoadDataPDSA</param>
    public DateType_PanelLoadDataPDSAValidator(DateType_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateType_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the DateType_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A DateType_PanelLoadDataPDSA object</returns>
    public DateType_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DateType_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateType_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateType_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
