...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercScpGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercScpGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercScpGroupUniquePDSA</param>
    public IsMercScpGroupUniquePDSAValidator(IsMercScpGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercScpGroupUniquePDSAValidator";

      // Create Properties for each field in the IsMercScpGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercScpGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercScpGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
