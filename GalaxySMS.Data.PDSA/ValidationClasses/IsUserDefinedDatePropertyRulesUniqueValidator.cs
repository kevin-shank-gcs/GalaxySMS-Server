...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedDatePropertyRulesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedDatePropertyRulesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedDatePropertyRulesUniquePDSA</param>
    public IsUserDefinedDatePropertyRulesUniquePDSAValidator(IsUserDefinedDatePropertyRulesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedDatePropertyRulesUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedDatePropertyRulesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedDatePropertyRulesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedDatePropertyRulesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
