...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_SetIsEnabledPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_SetIsEnabledPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_SetIsEnabledPDSA</param>
    public AccessPortal_SetIsEnabledPDSAValidator(AccessPortal_SetIsEnabledPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_SetIsEnabledPDSAValidator";

      // Create Properties for each field in the AccessPortal_SetIsEnabledPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_SetIsEnabledPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_SetIsEnabledPDSAValidator.ColumnNames.DateColumnNameHere);
