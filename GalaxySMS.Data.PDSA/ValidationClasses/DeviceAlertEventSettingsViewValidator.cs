...
{
  /// <summary>
  /// Used to validate business rules on the DeviceAlertEventSettingsViewPDSA class.
  ...
  /// </summary>
  public partial class DeviceAlertEventSettingsViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DeviceAlertEventSettingsViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DeviceAlertEventSettingsViewPDSA</param>
    public DeviceAlertEventSettingsViewPDSAValidator(DeviceAlertEventSettingsViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DeviceAlertEventSettingsViewPDSAValidator";

      // Create Properties for each field in the DeviceAlertEventSettingsViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A DeviceAlertEventSettingsViewPDSA object</returns>
    public DeviceAlertEventSettingsViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DeviceAlertEventSettingsViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DeviceAlertEventSettingsViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DeviceAlertEventSettingsViewPDSAValidator.ColumnNames.DateColumnNameHere);
