...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAlarmEventAcknowledgmentPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAlarmEventAcknowledgmentPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAlarmEventAcknowledgmentPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAlarmEventAcknowledgmentPDSA</param>
    public AccessPortalAlarmEventAcknowledgmentPDSAValidator(AccessPortalAlarmEventAcknowledgmentPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAlarmEventAcknowledgmentPDSAValidator";

      // Create Properties for each field in the AccessPortalAlarmEventAcknowledgmentPDSA entity class
      InitProperties();
    ...
    public AccessPortalAlarmEventAcknowledgmentPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAlarmEventAcknowledgmentPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAlarmEventAcknowledgmentPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAlarmEventAcknowledgmentPDSAValidator.ColumnNames.DateColumnNameHere);
