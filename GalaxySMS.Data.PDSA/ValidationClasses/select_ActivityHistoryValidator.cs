...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class select_ActivityHistoryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the select_ActivityHistoryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a select_ActivityHistoryPDSA</param>
    public select_ActivityHistoryPDSAValidator(select_ActivityHistoryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "select_ActivityHistoryPDSAValidator";

      // Create Properties for each field in the select_ActivityHistoryPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(select_ActivityHistoryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(select_ActivityHistoryPDSAValidator.ColumnNames.DateColumnNameHere);
