...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetHardwareInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetHardwareInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetHardwareInformationPDSA</param>
    public InputDevice_GetHardwareInformationPDSAValidator(InputDevice_GetHardwareInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetHardwareInformationPDSAValidator";

      // Create Properties for each field in the InputDevice_GetHardwareInformationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetHardwareInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetHardwareInformationPDSAValidator.ColumnNames.DateColumnNameHere);
