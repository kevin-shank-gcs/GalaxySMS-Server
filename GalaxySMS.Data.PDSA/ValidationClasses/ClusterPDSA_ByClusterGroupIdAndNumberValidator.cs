...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterPDSA_ByClusterGroupIdAndNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterPDSA_ByClusterGroupIdAndNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterPDSA_ByClusterGroupIdAndNumberPDSA</param>
    public ClusterPDSA_ByClusterGroupIdAndNumberPDSAValidator(ClusterPDSA_ByClusterGroupIdAndNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterPDSA_ByClusterGroupIdAndNumberPDSAValidator";

      // Create Properties for each field in the ClusterPDSA_ByClusterGroupIdAndNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterPDSA_ByClusterGroupIdAndNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterPDSA_ByClusterGroupIdAndNumberPDSAValidator.ColumnNames.DateColumnNameHere);
