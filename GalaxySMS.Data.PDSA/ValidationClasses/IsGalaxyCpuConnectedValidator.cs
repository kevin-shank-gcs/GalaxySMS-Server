...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyCpuConnectedPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyCpuConnectedPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyCpuConnectedPDSA</param>
    public IsGalaxyCpuConnectedPDSAValidator(IsGalaxyCpuConnectedPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyCpuConnectedPDSAValidator";

      // Create Properties for each field in the IsGalaxyCpuConnectedPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyCpuConnectedPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyCpuConnectedPDSAValidator.ColumnNames.DateColumnNameHere);
