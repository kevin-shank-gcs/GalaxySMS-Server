...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntity_CanBeDeletedPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntity_CanBeDeletedPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntity_CanBeDeletedPDSA</param>
    public gcsEntity_CanBeDeletedPDSAValidator(gcsEntity_CanBeDeletedPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntity_CanBeDeletedPDSAValidator";

      // Create Properties for each field in the gcsEntity_CanBeDeletedPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntity_CanBeDeletedPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntity_CanBeDeletedPDSAValidator.ColumnNames.DateColumnNameHere);
