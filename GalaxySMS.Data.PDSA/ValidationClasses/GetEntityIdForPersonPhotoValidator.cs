...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForPersonPhotoPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForPersonPhotoPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForPersonPhotoPDSA</param>
    public GetEntityIdForPersonPhotoPDSAValidator(GetEntityIdForPersonPhotoPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForPersonPhotoPDSAValidator";

      // Create Properties for each field in the GetEntityIdForPersonPhotoPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForPersonPhotoPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForPersonPhotoPDSAValidator.ColumnNames.DateColumnNameHere);
