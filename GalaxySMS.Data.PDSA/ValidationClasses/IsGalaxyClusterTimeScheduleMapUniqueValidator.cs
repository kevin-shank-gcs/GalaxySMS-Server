...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyClusterTimeScheduleMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyClusterTimeScheduleMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyClusterTimeScheduleMapUniquePDSA</param>
    public IsGalaxyClusterTimeScheduleMapUniquePDSAValidator(IsGalaxyClusterTimeScheduleMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyClusterTimeScheduleMapUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyClusterTimeScheduleMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyClusterTimeScheduleMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyClusterTimeScheduleMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
