...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyHardwareModuleTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyHardwareModuleTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyHardwareModuleTypeUniquePDSA</param>
    public IsGalaxyHardwareModuleTypeUniquePDSAValidator(IsGalaxyHardwareModuleTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyHardwareModuleTypeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyHardwareModuleTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyHardwareModuleTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyHardwareModuleTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
