...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsUser_UpdatePasswordChangeTokenPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUser_UpdatePasswordChangeTokenPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUser_UpdatePasswordChangeTokenPDSA</param>
    public gcsUser_UpdatePasswordChangeTokenPDSAValidator(gcsUser_UpdatePasswordChangeTokenPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUser_UpdatePasswordChangeTokenPDSAValidator";

      // Create Properties for each field in the gcsUser_UpdatePasswordChangeTokenPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUser_UpdatePasswordChangeTokenPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUser_UpdatePasswordChangeTokenPDSAValidator.ColumnNames.DateColumnNameHere);
