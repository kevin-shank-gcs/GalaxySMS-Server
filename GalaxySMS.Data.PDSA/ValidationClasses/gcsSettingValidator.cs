...
{
  /// <summary>
  /// Used to validate business rules on the gcsSettingPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsSettingPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsSettingPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsSettingPDSA</param>
    public gcsSettingPDSAValidator(gcsSettingPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsSettingPDSAValidator";

      // Create Properties for each field in the gcsSettingPDSA entity class
      InitProperties();
    ...
    public gcsSettingPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsSettingPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsSettingPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsSettingPDSAValidator.ColumnNames.DateColumnNameHere);
