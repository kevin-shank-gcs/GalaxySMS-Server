...
{
  /// <summary>
  /// Used to validate business rules on the RoleOutputDevicePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleOutputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleOutputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleOutputDevicePDSA</param>
    public RoleOutputDevicePDSAValidator(RoleOutputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleOutputDevicePDSAValidator";

      // Create Properties for each field in the RoleOutputDevicePDSA entity class
      InitProperties();
    ...
    public RoleOutputDevicePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleOutputDevicePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleOutputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleOutputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
