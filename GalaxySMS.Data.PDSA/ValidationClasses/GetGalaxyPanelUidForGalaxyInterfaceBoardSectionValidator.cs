...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSA</param>
    public GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSAValidator(GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSAValidator";

      // Create Properties for each field in the GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetGalaxyPanelUidForGalaxyInterfaceBoardSectionPDSAValidator.ColumnNames.DateColumnNameHere);
