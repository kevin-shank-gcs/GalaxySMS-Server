...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserRequirementUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserRequirementUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserRequirementUniquePDSA</param>
    public gcs_IsUserRequirementUniquePDSAValidator(gcs_IsUserRequirementUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserRequirementUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsUserRequirementUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserRequirementUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserRequirementUniquePDSAValidator.ColumnNames.DateColumnNameHere);
