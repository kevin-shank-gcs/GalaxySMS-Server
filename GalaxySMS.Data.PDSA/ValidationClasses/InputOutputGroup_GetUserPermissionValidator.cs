...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroup_GetUserPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroup_GetUserPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroup_GetUserPermissionPDSA</param>
    public InputOutputGroup_GetUserPermissionPDSAValidator(InputOutputGroup_GetUserPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroup_GetUserPermissionPDSAValidator";

      // Create Properties for each field in the InputOutputGroup_GetUserPermissionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroup_GetUserPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroup_GetUserPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
