...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaAccessPointTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaAccessPointTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaAccessPointTypeUniquePDSA</param>
    public IsAssaAccessPointTypeUniquePDSAValidator(IsAssaAccessPointTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaAccessPointTypeUniquePDSAValidator";

      // Create Properties for each field in the IsAssaAccessPointTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaAccessPointTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaAccessPointTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
