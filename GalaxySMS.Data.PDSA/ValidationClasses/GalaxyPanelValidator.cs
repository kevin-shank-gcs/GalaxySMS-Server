...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelPDSA</param>
    public GalaxyPanelPDSAValidator(GalaxyPanelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelPDSAValidator";

      // Create Properties for each field in the GalaxyPanelPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelPDSAValidator.ColumnNames.DateColumnNameHere);
