...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForAssaDayPeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForAssaDayPeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForAssaDayPeriodPDSA</param>
    public GetEntityIdForAssaDayPeriodPDSAValidator(GetEntityIdForAssaDayPeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForAssaDayPeriodPDSAValidator";

      // Create Properties for each field in the GetEntityIdForAssaDayPeriodPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForAssaDayPeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForAssaDayPeriodPDSAValidator.ColumnNames.DateColumnNameHere);
