...
{
  /// <summary>
  /// Used to validate business rules on the TimeScheduleDayTypeTimePeriodPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class TimeScheduleDayTypeTimePeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeScheduleDayTypeTimePeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeScheduleDayTypeTimePeriodPDSA</param>
    public TimeScheduleDayTypeTimePeriodPDSAValidator(TimeScheduleDayTypeTimePeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeScheduleDayTypeTimePeriodPDSAValidator";

      // Create Properties for each field in the TimeScheduleDayTypeTimePeriodPDSA entity class
      InitProperties();
    ...
    public TimeScheduleDayTypeTimePeriodPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TimeScheduleDayTypeTimePeriodPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeScheduleDayTypeTimePeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeScheduleDayTypeTimePeriodPDSAValidator.ColumnNames.DateColumnNameHere);
