...
{
  /// <summary>
  /// Used to validate business rules on the AssaDayPeriodTimePeriodPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaDayPeriodTimePeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaDayPeriodTimePeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaDayPeriodTimePeriodPDSA</param>
    public AssaDayPeriodTimePeriodPDSAValidator(AssaDayPeriodTimePeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaDayPeriodTimePeriodPDSAValidator";

      // Create Properties for each field in the AssaDayPeriodTimePeriodPDSA entity class
      InitProperties();
    ...
    public AssaDayPeriodTimePeriodPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaDayPeriodTimePeriodPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaDayPeriodTimePeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaDayPeriodTimePeriodPDSAValidator.ColumnNames.DateColumnNameHere);
