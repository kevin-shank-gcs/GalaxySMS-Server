...
{
  /// <summary>
  /// Used to validate business rules on the AccessProfileEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessProfileEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessProfileEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessProfileEntityMapPDSA</param>
    public AccessProfileEntityMapPDSAValidator(AccessProfileEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessProfileEntityMapPDSAValidator";

      // Create Properties for each field in the AccessProfileEntityMapPDSA entity class
      InitProperties();
    ...
    public AccessProfileEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessProfileEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessProfileEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessProfileEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
