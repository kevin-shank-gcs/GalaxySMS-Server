...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialFormatDataFieldUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialFormatDataFieldUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialFormatDataFieldUniquePDSA</param>
    public IsCredentialFormatDataFieldUniquePDSAValidator(IsCredentialFormatDataFieldUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialFormatDataFieldUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialFormatDataFieldUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialFormatDataFieldUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialFormatDataFieldUniquePDSAValidator.ColumnNames.DateColumnNameHere);
