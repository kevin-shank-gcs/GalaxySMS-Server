...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalContactSupervisionTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalContactSupervisionTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalContactSupervisionTypeUniquePDSA</param>
    public IsAccessPortalContactSupervisionTypeUniquePDSAValidator(IsAccessPortalContactSupervisionTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalContactSupervisionTypeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalContactSupervisionTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalContactSupervisionTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalContactSupervisionTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
