...
{
  /// <summary>
  /// Used to validate business rules on the CredentialPIV75BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialPIV75BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialPIV75BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialPIV75BitPDSA</param>
    public CredentialPIV75BitPDSAValidator(CredentialPIV75BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialPIV75BitPDSAValidator";

      // Create Properties for each field in the CredentialPIV75BitPDSA entity class
      InitProperties();
    ...
    public CredentialPIV75BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialPIV75BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialPIV75BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialPIV75BitPDSAValidator.ColumnNames.DateColumnNameHere);
