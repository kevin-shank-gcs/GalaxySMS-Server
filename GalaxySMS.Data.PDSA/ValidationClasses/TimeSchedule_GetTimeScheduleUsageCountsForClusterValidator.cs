...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSA</param>
    public TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSAValidator(TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSAValidator";

      // Create Properties for each field in the TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedule_GetTimeScheduleUsageCountsForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
