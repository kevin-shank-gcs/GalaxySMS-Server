...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DateType_PanelLoadData_GetForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateType_PanelLoadData_GetForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateType_PanelLoadData_GetForClusterPDSA</param>
    public DateType_PanelLoadData_GetForClusterPDSAValidator(DateType_PanelLoadData_GetForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateType_PanelLoadData_GetForClusterPDSAValidator";

      // Create Properties for each field in the DateType_PanelLoadData_GetForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateType_PanelLoadData_GetForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateType_PanelLoadData_GetForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
