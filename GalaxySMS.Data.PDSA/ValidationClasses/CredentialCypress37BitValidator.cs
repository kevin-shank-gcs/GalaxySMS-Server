...
{
  /// <summary>
  /// Used to validate business rules on the CredentialCypress37BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialCypress37BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialCypress37BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialCypress37BitPDSA</param>
    public CredentialCypress37BitPDSAValidator(CredentialCypress37BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialCypress37BitPDSAValidator";

      // Create Properties for each field in the CredentialCypress37BitPDSA entity class
      InitProperties();
    ...
    public CredentialCypress37BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialCypress37BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialCypress37BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialCypress37BitPDSAValidator.ColumnNames.DateColumnNameHere);
