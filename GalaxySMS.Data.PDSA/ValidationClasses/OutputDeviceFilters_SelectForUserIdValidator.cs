...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDeviceFilters_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDeviceFilters_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDeviceFilters_SelectForUserIdPDSA</param>
    public OutputDeviceFilters_SelectForUserIdPDSAValidator(OutputDeviceFilters_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDeviceFilters_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the OutputDeviceFilters_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDeviceFilters_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDeviceFilters_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
