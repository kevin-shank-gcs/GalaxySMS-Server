...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyPanelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyPanelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyPanelPDSA</param>
    public GetEntityIdForGalaxyPanelPDSAValidator(GetEntityIdForGalaxyPanelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyPanelPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyPanelPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyPanelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyPanelPDSAValidator.ColumnNames.DateColumnNameHere);
