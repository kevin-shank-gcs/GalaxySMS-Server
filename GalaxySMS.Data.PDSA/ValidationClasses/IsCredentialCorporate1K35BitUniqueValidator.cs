...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialCorporate1K35BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialCorporate1K35BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialCorporate1K35BitUniquePDSA</param>
    public IsCredentialCorporate1K35BitUniquePDSAValidator(IsCredentialCorporate1K35BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialCorporate1K35BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialCorporate1K35BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialCorporate1K35BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialCorporate1K35BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
