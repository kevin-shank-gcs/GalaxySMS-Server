...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAreaEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAreaEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAreaEntityMapUniquePDSA</param>
    public IsAreaEntityMapUniquePDSAValidator(IsAreaEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAreaEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsAreaEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAreaEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAreaEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
