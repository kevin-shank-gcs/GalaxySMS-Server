...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortal_PanelLoadDataChangesForCpuPDSA class.
  ...
  /// </summary>
  public partial class AccessPortal_PanelLoadDataChangesForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_PanelLoadDataChangesForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_PanelLoadDataChangesForCpuPDSA</param>
    public AccessPortal_PanelLoadDataChangesForCpuPDSAValidator(AccessPortal_PanelLoadDataChangesForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_PanelLoadDataChangesForCpuPDSAValidator";

      // Create Properties for each field in the AccessPortal_PanelLoadDataChangesForCpuPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AccessPortal_PanelLoadDataChangesForCpuPDSA object</returns>
    public AccessPortal_PanelLoadDataChangesForCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortal_PanelLoadDataChangesForCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
