...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialDataLengthUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialDataLengthUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialDataLengthUniquePDSA</param>
    public IsCredentialDataLengthUniquePDSAValidator(IsCredentialDataLengthUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialDataLengthUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialDataLengthUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialDataLengthUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialDataLengthUniquePDSAValidator.ColumnNames.DateColumnNameHere);
