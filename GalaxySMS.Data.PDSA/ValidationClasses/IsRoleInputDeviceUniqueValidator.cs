...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleInputDeviceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleInputDeviceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleInputDeviceUniquePDSA</param>
    public IsRoleInputDeviceUniquePDSAValidator(IsRoleInputDeviceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleInputDeviceUniquePDSAValidator";

      // Create Properties for each field in the IsRoleInputDeviceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleInputDeviceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleInputDeviceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
