...
{
  /// <summary>
  /// Used to validate business rules on the RoleFiltersPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleFiltersPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleFiltersPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleFiltersPDSA</param>
    public RoleFiltersPDSAValidator(RoleFiltersPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleFiltersPDSAValidator";

      // Create Properties for each field in the RoleFiltersPDSA entity class
      InitProperties();
    ...
    public RoleFiltersPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleFiltersPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleFiltersPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleFiltersPDSAValidator.ColumnNames.DateColumnNameHere);
