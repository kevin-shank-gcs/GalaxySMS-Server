...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInterfaceBoardSection_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class GalaxyInterfaceBoardSection_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSection_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSection_PanelLoadDataPDSA</param>
    public GalaxyInterfaceBoardSection_PanelLoadDataPDSAValidator(GalaxyInterfaceBoardSection_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSection_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSection_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A GalaxyInterfaceBoardSection_PanelLoadDataPDSA object</returns>
    public GalaxyInterfaceBoardSection_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInterfaceBoardSection_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
