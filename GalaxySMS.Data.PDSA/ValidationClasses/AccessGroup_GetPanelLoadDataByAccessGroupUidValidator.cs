...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroup_GetPanelLoadDataByAccessGroupUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_GetPanelLoadDataByAccessGroupUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_GetPanelLoadDataByAccessGroupUidPDSA</param>
    public AccessGroup_GetPanelLoadDataByAccessGroupUidPDSAValidator(AccessGroup_GetPanelLoadDataByAccessGroupUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_GetPanelLoadDataByAccessGroupUidPDSAValidator";

      // Create Properties for each field in the AccessGroup_GetPanelLoadDataByAccessGroupUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataByAccessGroupUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataByAccessGroupUidPDSAValidator.ColumnNames.DateColumnNameHere);
