...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalGalaxyHardwareAddressUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalGalaxyHardwareAddressUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalGalaxyHardwareAddressUniquePDSA</param>
    public IsAccessPortalGalaxyHardwareAddressUniquePDSAValidator(IsAccessPortalGalaxyHardwareAddressUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalGalaxyHardwareAddressUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalGalaxyHardwareAddressUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.DateColumnNameHere);
