...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSA</param>
    public AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSAValidator(AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByGalaxyPanelAlarmEventAcknowledgmentUidPDSAValidator.ColumnNames.DateColumnNameHere);
