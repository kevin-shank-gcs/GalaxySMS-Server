...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInterfaceBoardSectionCommandAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInterfaceBoardSectionCommandAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSectionCommandAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSectionCommandAuditPDSA</param>
    public GalaxyInterfaceBoardSectionCommandAuditPDSAValidator(GalaxyInterfaceBoardSectionCommandAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSectionCommandAuditPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSectionCommandAuditPDSA entity class
      InitProperties();
    ...
    public GalaxyInterfaceBoardSectionCommandAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInterfaceBoardSectionCommandAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionCommandAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionCommandAuditPDSAValidator.ColumnNames.DateColumnNameHere);
