...
{
  /// <summary>
  /// Used to validate business rules on the PersonalAccessGroupAccessPortalPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonalAccessGroupAccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroupAccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroupAccessPortalPDSA</param>
    public PersonalAccessGroupAccessPortalPDSAValidator(PersonalAccessGroupAccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroupAccessPortalPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroupAccessPortalPDSA entity class
      InitProperties();
    ...
    public PersonalAccessGroupAccessPortalPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonalAccessGroupAccessPortalPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroupAccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroupAccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
