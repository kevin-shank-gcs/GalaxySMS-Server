...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_GetUserPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_GetUserPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_GetUserPermissionPDSA</param>
    public Cluster_GetUserPermissionPDSAValidator(Cluster_GetUserPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_GetUserPermissionPDSAValidator";

      // Create Properties for each field in the Cluster_GetUserPermissionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_GetUserPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_GetUserPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
