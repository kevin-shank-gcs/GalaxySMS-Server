...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class MercScpStatus_SavePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpStatus_SavePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpStatus_SavePDSA</param>
    public MercScpStatus_SavePDSAValidator(MercScpStatus_SavePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpStatus_SavePDSAValidator";

      // Create Properties for each field in the MercScpStatus_SavePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpStatus_SavePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpStatus_SavePDSAValidator.ColumnNames.DateColumnNameHere);
