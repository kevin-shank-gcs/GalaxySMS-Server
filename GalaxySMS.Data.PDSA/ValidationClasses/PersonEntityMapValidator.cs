...
{
  /// <summary>
  /// Used to validate business rules on the PersonEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonEntityMapPDSA</param>
    public PersonEntityMapPDSAValidator(PersonEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonEntityMapPDSAValidator";

      // Create Properties for each field in the PersonEntityMapPDSA entity class
      InitProperties();
    ...
    public PersonEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
