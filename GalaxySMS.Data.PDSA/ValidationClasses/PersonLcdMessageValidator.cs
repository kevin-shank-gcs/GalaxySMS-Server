...
{
  /// <summary>
  /// Used to validate business rules on the PersonLcdMessagePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonLcdMessagePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonLcdMessagePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonLcdMessagePDSA</param>
    public PersonLcdMessagePDSAValidator(PersonLcdMessagePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonLcdMessagePDSAValidator";

      // Create Properties for each field in the PersonLcdMessagePDSA entity class
      InitProperties();
    ...
    public PersonLcdMessagePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonLcdMessagePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonLcdMessagePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonLcdMessagePDSAValidator.ColumnNames.DateColumnNameHere);
