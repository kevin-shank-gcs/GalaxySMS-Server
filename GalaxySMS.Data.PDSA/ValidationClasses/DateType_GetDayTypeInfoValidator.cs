...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DateType_GetDayTypeInfoPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateType_GetDayTypeInfoPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateType_GetDayTypeInfoPDSA</param>
    public DateType_GetDayTypeInfoPDSAValidator(DateType_GetDayTypeInfoPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateType_GetDayTypeInfoPDSAValidator";

      // Create Properties for each field in the DateType_GetDayTypeInfoPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateType_GetDayTypeInfoPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateType_GetDayTypeInfoPDSAValidator.ColumnNames.DateColumnNameHere);
