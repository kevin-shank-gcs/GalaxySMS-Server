...
{
  /// <summary>
  /// Used to validate business rules on the gcsApplicationAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsApplicationAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsApplicationAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsApplicationAuditPDSA</param>
    public gcsApplicationAuditPDSAValidator(gcsApplicationAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsApplicationAuditPDSAValidator";

      // Create Properties for each field in the gcsApplicationAuditPDSA entity class
      InitProperties();
    ...
    public gcsApplicationAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsApplicationAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsApplicationAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsApplicationAuditPDSAValidator.ColumnNames.DateColumnNameHere);
