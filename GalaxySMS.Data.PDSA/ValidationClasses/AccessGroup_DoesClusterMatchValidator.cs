...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroup_DoesClusterMatchPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_DoesClusterMatchPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_DoesClusterMatchPDSA</param>
    public AccessGroup_DoesClusterMatchPDSAValidator(AccessGroup_DoesClusterMatchPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_DoesClusterMatchPDSAValidator";

      // Create Properties for each field in the AccessGroup_DoesClusterMatchPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_DoesClusterMatchPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_DoesClusterMatchPDSAValidator.ColumnNames.DateColumnNameHere);
