...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetCurrentEntityInfoPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetCurrentEntityInfoPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetCurrentEntityInfoPDSA</param>
    public GetCurrentEntityInfoPDSAValidator(GetCurrentEntityInfoPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetCurrentEntityInfoPDSAValidator";

      // Create Properties for each field in the GetCurrentEntityInfoPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetCurrentEntityInfoPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetCurrentEntityInfoPDSAValidator.ColumnNames.DateColumnNameHere);
