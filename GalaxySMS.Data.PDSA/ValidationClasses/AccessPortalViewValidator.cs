...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalViewPDSA class.
  ...
  /// </summary>
  public partial class AccessPortalViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalViewPDSA</param>
    public AccessPortalViewPDSAValidator(AccessPortalViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalViewPDSAValidator";

      // Create Properties for each field in the AccessPortalViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AccessPortalViewPDSA object</returns>
    public AccessPortalViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalViewPDSAValidator.ColumnNames.DateColumnNameHere);
