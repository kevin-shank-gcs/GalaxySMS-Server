...
{
  /// <summary>
  /// Used to validate business rules on the BiometricSystemTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BiometricSystemTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BiometricSystemTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BiometricSystemTypePDSA</param>
    public BiometricSystemTypePDSAValidator(BiometricSystemTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BiometricSystemTypePDSAValidator";

      // Create Properties for each field in the BiometricSystemTypePDSA entity class
      InitProperties();
    ...
    public BiometricSystemTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BiometricSystemTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BiometricSystemTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BiometricSystemTypePDSAValidator.ColumnNames.DateColumnNameHere);
