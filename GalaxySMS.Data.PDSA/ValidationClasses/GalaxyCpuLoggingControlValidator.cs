...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyCpuLoggingControlPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyCpuLoggingControlPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuLoggingControlPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuLoggingControlPDSA</param>
    public GalaxyCpuLoggingControlPDSAValidator(GalaxyCpuLoggingControlPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuLoggingControlPDSAValidator";

      // Create Properties for each field in the GalaxyCpuLoggingControlPDSA entity class
      InitProperties();
    ...
    public GalaxyCpuLoggingControlPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyCpuLoggingControlPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuLoggingControlPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuLoggingControlPDSAValidator.ColumnNames.DateColumnNameHere);
