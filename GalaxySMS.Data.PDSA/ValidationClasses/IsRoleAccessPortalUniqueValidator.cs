...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleAccessPortalUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleAccessPortalUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleAccessPortalUniquePDSA</param>
    public IsRoleAccessPortalUniquePDSAValidator(IsRoleAccessPortalUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleAccessPortalUniquePDSAValidator";

      // Create Properties for each field in the IsRoleAccessPortalUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleAccessPortalUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleAccessPortalUniquePDSAValidator.ColumnNames.DateColumnNameHere);
