...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInputDelayTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInputDelayTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInputDelayTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInputDelayTypePDSA</param>
    public GalaxyInputDelayTypePDSAValidator(GalaxyInputDelayTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInputDelayTypePDSAValidator";

      // Create Properties for each field in the GalaxyInputDelayTypePDSA entity class
      InitProperties();
    ...
    public GalaxyInputDelayTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInputDelayTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInputDelayTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInputDelayTypePDSAValidator.ColumnNames.DateColumnNameHere);
