...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimeScheduleEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimeScheduleEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimeScheduleEntityMapUniquePDSA</param>
    public IsTimeScheduleEntityMapUniquePDSAValidator(IsTimeScheduleEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimeScheduleEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsTimeScheduleEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimeScheduleEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimeScheduleEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
