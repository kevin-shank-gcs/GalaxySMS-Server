...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_GetAllColumnGuidValuesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_GetAllColumnGuidValuesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_GetAllColumnGuidValuesPDSA</param>
    public gcs_GetAllColumnGuidValuesPDSAValidator(gcs_GetAllColumnGuidValuesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_GetAllColumnGuidValuesPDSAValidator";

      // Create Properties for each field in the gcs_GetAllColumnGuidValuesPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_GetAllColumnGuidValuesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_GetAllColumnGuidValuesPDSAValidator.ColumnNames.DateColumnNameHere);
