...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_GetCountsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_GetCountsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_GetCountsPDSA</param>
    public Cluster_GetCountsPDSAValidator(Cluster_GetCountsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_GetCountsPDSAValidator";

      // Create Properties for each field in the Cluster_GetCountsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_GetCountsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_GetCountsPDSAValidator.ColumnNames.DateColumnNameHere);
