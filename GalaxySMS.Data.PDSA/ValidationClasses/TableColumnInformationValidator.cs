...
{
  /// <summary>
  /// Used to validate business rules on the TableColumnInformationPDSA class.
  ...
  /// </summary>
  public partial class TableColumnInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TableColumnInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TableColumnInformationPDSA</param>
    public TableColumnInformationPDSAValidator(TableColumnInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TableColumnInformationPDSAValidator";

      // Create Properties for each field in the TableColumnInformationPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A TableColumnInformationPDSA object</returns>
    public TableColumnInformationPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TableColumnInformationPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TableColumnInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TableColumnInformationPDSAValidator.ColumnNames.DateColumnNameHere);
