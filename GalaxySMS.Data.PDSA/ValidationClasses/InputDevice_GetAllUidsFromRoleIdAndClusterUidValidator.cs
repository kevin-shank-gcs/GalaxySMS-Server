...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSA</param>
    public InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator(InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
