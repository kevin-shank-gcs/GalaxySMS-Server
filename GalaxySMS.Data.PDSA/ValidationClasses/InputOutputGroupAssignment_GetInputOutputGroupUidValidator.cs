...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupAssignment_GetInputOutputGroupUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupAssignment_GetInputOutputGroupUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupAssignment_GetInputOutputGroupUidPDSA</param>
    public InputOutputGroupAssignment_GetInputOutputGroupUidPDSAValidator(InputOutputGroupAssignment_GetInputOutputGroupUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupAssignment_GetInputOutputGroupUidPDSAValidator";

      // Create Properties for each field in the InputOutputGroupAssignment_GetInputOutputGroupUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupAssignment_GetInputOutputGroupUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupAssignment_GetInputOutputGroupUidPDSAValidator.ColumnNames.DateColumnNameHere);
