...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputDevicePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDevicePDSA</param>
    public GalaxyOutputDevicePDSAValidator(GalaxyOutputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDevicePDSAValidator";

      // Create Properties for each field in the GalaxyOutputDevicePDSA entity class
      InitProperties();
    ...
    public GalaxyOutputDevicePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputDevicePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
