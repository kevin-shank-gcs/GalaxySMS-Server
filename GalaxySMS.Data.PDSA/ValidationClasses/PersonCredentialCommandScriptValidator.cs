...
{
  /// <summary>
  /// Used to validate business rules on the PersonCredentialCommandScriptPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonCredentialCommandScriptPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonCredentialCommandScriptPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonCredentialCommandScriptPDSA</param>
    public PersonCredentialCommandScriptPDSAValidator(PersonCredentialCommandScriptPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonCredentialCommandScriptPDSAValidator";

      // Create Properties for each field in the PersonCredentialCommandScriptPDSA entity class
      InitProperties();
    ...
    public PersonCredentialCommandScriptPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonCredentialCommandScriptPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonCredentialCommandScriptPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonCredentialCommandScriptPDSAValidator.ColumnNames.DateColumnNameHere);
