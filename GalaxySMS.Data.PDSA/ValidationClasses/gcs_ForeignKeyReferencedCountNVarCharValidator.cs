...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_ForeignKeyReferencedCountNVarCharPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_ForeignKeyReferencedCountNVarCharPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_ForeignKeyReferencedCountNVarCharPDSA</param>
    public gcs_ForeignKeyReferencedCountNVarCharPDSAValidator(gcs_ForeignKeyReferencedCountNVarCharPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_ForeignKeyReferencedCountNVarCharPDSAValidator";

      // Create Properties for each field in the gcs_ForeignKeyReferencedCountNVarCharPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_ForeignKeyReferencedCountNVarCharPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_ForeignKeyReferencedCountNVarCharPDSAValidator.ColumnNames.DateColumnNameHere);
