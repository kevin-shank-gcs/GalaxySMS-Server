...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRegionEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRegionEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRegionEntityMapUniquePDSA</param>
    public IsRegionEntityMapUniquePDSAValidator(IsRegionEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRegionEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsRegionEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRegionEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRegionEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
