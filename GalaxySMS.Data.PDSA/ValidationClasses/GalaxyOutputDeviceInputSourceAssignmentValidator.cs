...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputDeviceInputSourceAssignmentPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputDeviceInputSourceAssignmentPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDeviceInputSourceAssignmentPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDeviceInputSourceAssignmentPDSA</param>
    public GalaxyOutputDeviceInputSourceAssignmentPDSAValidator(GalaxyOutputDeviceInputSourceAssignmentPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDeviceInputSourceAssignmentPDSAValidator";

      // Create Properties for each field in the GalaxyOutputDeviceInputSourceAssignmentPDSA entity class
      InitProperties();
    ...
    public GalaxyOutputDeviceInputSourceAssignmentPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputDeviceInputSourceAssignmentPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDeviceInputSourceAssignmentPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDeviceInputSourceAssignmentPDSAValidator.ColumnNames.DateColumnNameHere);
