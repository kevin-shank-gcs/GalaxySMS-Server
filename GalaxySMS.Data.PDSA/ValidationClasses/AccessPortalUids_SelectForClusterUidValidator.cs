...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortalUids_SelectForClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalUids_SelectForClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalUids_SelectForClusterUidPDSA</param>
    public AccessPortalUids_SelectForClusterUidPDSAValidator(AccessPortalUids_SelectForClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalUids_SelectForClusterUidPDSAValidator";

      // Create Properties for each field in the AccessPortalUids_SelectForClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalUids_SelectForClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalUids_SelectForClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
