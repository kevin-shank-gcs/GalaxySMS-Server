...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyInterfaceBoardSectionNodePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyInterfaceBoardSectionNodePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyInterfaceBoardSectionNodePDSA</param>
    public GetEntityIdForGalaxyInterfaceBoardSectionNodePDSAValidator(GetEntityIdForGalaxyInterfaceBoardSectionNodePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyInterfaceBoardSectionNodePDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyInterfaceBoardSectionNodePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyInterfaceBoardSectionNodePDSAValidator.ColumnNames.DateColumnNameHere);
