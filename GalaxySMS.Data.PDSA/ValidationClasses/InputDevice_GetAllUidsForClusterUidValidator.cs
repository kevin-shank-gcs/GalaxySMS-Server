...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetAllUidsForClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetAllUidsForClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetAllUidsForClusterUidPDSA</param>
    public InputDevice_GetAllUidsForClusterUidPDSAValidator(InputDevice_GetAllUidsForClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetAllUidsForClusterUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetAllUidsForClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetAllUidsForClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetAllUidsForClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
