...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsSiteUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsSiteUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsSiteUniquePDSA</param>
    public IsSiteUniquePDSAValidator(IsSiteUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsSiteUniquePDSAValidator";

      // Create Properties for each field in the IsSiteUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsSiteUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsSiteUniquePDSAValidator.ColumnNames.DateColumnNameHere);
