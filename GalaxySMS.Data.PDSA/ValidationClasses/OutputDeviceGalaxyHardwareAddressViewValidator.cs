...
{
  /// <summary>
  /// Used to validate business rules on the OutputDeviceGalaxyHardwareAddressViewPDSA class.
  ...
  /// </summary>
  public partial class OutputDeviceGalaxyHardwareAddressViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDeviceGalaxyHardwareAddressViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDeviceGalaxyHardwareAddressViewPDSA</param>
    public OutputDeviceGalaxyHardwareAddressViewPDSAValidator(OutputDeviceGalaxyHardwareAddressViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDeviceGalaxyHardwareAddressViewPDSAValidator";

      // Create Properties for each field in the OutputDeviceGalaxyHardwareAddressViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A OutputDeviceGalaxyHardwareAddressViewPDSA object</returns>
    public OutputDeviceGalaxyHardwareAddressViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputDeviceGalaxyHardwareAddressViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDeviceGalaxyHardwareAddressViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDeviceGalaxyHardwareAddressViewPDSAValidator.ColumnNames.DateColumnNameHere);
