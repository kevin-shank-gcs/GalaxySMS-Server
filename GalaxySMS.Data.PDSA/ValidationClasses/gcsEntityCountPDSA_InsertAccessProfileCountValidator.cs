...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertAccessProfileCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertAccessProfileCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertAccessProfileCountPDSA</param>
    public gcsEntityCountPDSA_InsertAccessProfileCountPDSAValidator(gcsEntityCountPDSA_InsertAccessProfileCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertAccessProfileCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertAccessProfileCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessProfileCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessProfileCountPDSAValidator.ColumnNames.DateColumnNameHere);
