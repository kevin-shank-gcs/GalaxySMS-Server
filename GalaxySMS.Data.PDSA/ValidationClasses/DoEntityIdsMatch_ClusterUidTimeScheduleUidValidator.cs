...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSA</param>
    public DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSAValidator(DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSAValidator";

      // Create Properties for each field in the DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DoEntityIdsMatch_ClusterUidTimeScheduleUidPDSAValidator.ColumnNames.DateColumnNameHere);
