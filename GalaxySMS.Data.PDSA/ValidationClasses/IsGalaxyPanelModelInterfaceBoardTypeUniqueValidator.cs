...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelModelInterfaceBoardTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelModelInterfaceBoardTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelModelInterfaceBoardTypeUniquePDSA</param>
    public IsGalaxyPanelModelInterfaceBoardTypeUniquePDSAValidator(IsGalaxyPanelModelInterfaceBoardTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelModelInterfaceBoardTypeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelModelInterfaceBoardTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelModelInterfaceBoardTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelModelInterfaceBoardTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
