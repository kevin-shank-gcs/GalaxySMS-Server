...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_SelectionListForEntityAndClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_SelectionListForEntityAndClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_SelectionListForEntityAndClusterPDSA</param>
    public OutputDevice_SelectionListForEntityAndClusterPDSAValidator(OutputDevice_SelectionListForEntityAndClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_SelectionListForEntityAndClusterPDSAValidator";

      // Create Properties for each field in the OutputDevice_SelectionListForEntityAndClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.DateColumnNameHere);
