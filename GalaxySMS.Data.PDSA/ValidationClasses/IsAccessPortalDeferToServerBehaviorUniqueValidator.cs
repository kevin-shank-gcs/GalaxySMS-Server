...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalDeferToServerBehaviorUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalDeferToServerBehaviorUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalDeferToServerBehaviorUniquePDSA</param>
    public IsAccessPortalDeferToServerBehaviorUniquePDSAValidator(IsAccessPortalDeferToServerBehaviorUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalDeferToServerBehaviorUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalDeferToServerBehaviorUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalDeferToServerBehaviorUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalDeferToServerBehaviorUniquePDSAValidator.ColumnNames.DateColumnNameHere);
