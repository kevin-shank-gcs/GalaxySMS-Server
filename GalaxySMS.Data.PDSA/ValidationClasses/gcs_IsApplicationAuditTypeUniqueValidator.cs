...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsApplicationAuditTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsApplicationAuditTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsApplicationAuditTypeUniquePDSA</param>
    public gcs_IsApplicationAuditTypeUniquePDSAValidator(gcs_IsApplicationAuditTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsApplicationAuditTypeUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsApplicationAuditTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsApplicationAuditTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsApplicationAuditTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
