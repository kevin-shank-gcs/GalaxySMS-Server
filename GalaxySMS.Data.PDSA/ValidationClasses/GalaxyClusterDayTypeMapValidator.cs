...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyClusterDayTypeMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyClusterDayTypeMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyClusterDayTypeMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyClusterDayTypeMapPDSA</param>
    public GalaxyClusterDayTypeMapPDSAValidator(GalaxyClusterDayTypeMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyClusterDayTypeMapPDSAValidator";

      // Create Properties for each field in the GalaxyClusterDayTypeMapPDSA entity class
      InitProperties();
    ...
    public GalaxyClusterDayTypeMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyClusterDayTypeMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyClusterDayTypeMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyClusterDayTypeMapPDSAValidator.ColumnNames.DateColumnNameHere);
