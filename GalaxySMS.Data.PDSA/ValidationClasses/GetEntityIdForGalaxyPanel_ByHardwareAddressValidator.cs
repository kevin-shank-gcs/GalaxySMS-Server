...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyPanel_ByHardwareAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyPanel_ByHardwareAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyPanel_ByHardwareAddressPDSA</param>
    public GetEntityIdForGalaxyPanel_ByHardwareAddressPDSAValidator(GetEntityIdForGalaxyPanel_ByHardwareAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyPanel_ByHardwareAddressPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyPanel_ByHardwareAddressPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyPanel_ByHardwareAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyPanel_ByHardwareAddressPDSAValidator.ColumnNames.DateColumnNameHere);
