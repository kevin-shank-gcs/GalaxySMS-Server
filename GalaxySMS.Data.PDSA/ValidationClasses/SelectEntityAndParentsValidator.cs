...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class SelectEntityAndParentsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the SelectEntityAndParentsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a SelectEntityAndParentsPDSA</param>
    public SelectEntityAndParentsPDSAValidator(SelectEntityAndParentsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "SelectEntityAndParentsPDSAValidator";

      // Create Properties for each field in the SelectEntityAndParentsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(SelectEntityAndParentsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(SelectEntityAndParentsPDSAValidator.ColumnNames.DateColumnNameHere);
