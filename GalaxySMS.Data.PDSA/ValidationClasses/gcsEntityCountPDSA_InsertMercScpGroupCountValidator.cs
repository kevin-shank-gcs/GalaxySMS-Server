...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertMercScpGroupCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertMercScpGroupCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertMercScpGroupCountPDSA</param>
    public gcsEntityCountPDSA_InsertMercScpGroupCountPDSAValidator(gcsEntityCountPDSA_InsertMercScpGroupCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertMercScpGroupCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertMercScpGroupCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertMercScpGroupCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertMercScpGroupCountPDSAValidator.ColumnNames.DateColumnNameHere);
