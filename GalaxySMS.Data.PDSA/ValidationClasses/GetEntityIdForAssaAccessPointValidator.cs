...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForAssaAccessPointPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForAssaAccessPointPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForAssaAccessPointPDSA</param>
    public GetEntityIdForAssaAccessPointPDSAValidator(GetEntityIdForAssaAccessPointPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForAssaAccessPointPDSAValidator";

      // Create Properties for each field in the GetEntityIdForAssaAccessPointPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForAssaAccessPointPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForAssaAccessPointPDSAValidator.ColumnNames.DateColumnNameHere);
