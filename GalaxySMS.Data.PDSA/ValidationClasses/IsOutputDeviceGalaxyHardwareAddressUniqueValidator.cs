...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsOutputDeviceGalaxyHardwareAddressUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsOutputDeviceGalaxyHardwareAddressUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsOutputDeviceGalaxyHardwareAddressUniquePDSA</param>
    public IsOutputDeviceGalaxyHardwareAddressUniquePDSAValidator(IsOutputDeviceGalaxyHardwareAddressUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsOutputDeviceGalaxyHardwareAddressUniquePDSAValidator";

      // Create Properties for each field in the IsOutputDeviceGalaxyHardwareAddressUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsOutputDeviceGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsOutputDeviceGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.DateColumnNameHere);
