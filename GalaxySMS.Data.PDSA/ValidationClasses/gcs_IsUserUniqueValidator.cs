...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserUniquePDSA</param>
    public gcs_IsUserUniquePDSAValidator(gcs_IsUserUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsUserUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserUniquePDSAValidator.ColumnNames.DateColumnNameHere);
