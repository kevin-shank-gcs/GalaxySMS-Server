...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForDepartmentPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForDepartmentPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForDepartmentPDSA</param>
    public GetEntityIdForDepartmentPDSAValidator(GetEntityIdForDepartmentPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForDepartmentPDSAValidator";

      // Create Properties for each field in the GetEntityIdForDepartmentPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForDepartmentPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForDepartmentPDSAValidator.ColumnNames.DateColumnNameHere);
