...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalActivityAlarmEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalActivityAlarmEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalActivityAlarmEventUniquePDSA</param>
    public IsAccessPortalActivityAlarmEventUniquePDSAValidator(IsAccessPortalActivityAlarmEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalActivityAlarmEventUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalActivityAlarmEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalActivityAlarmEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalActivityAlarmEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
