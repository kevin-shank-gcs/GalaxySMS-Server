...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalAlarmEventAcknowledgmentUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalAlarmEventAcknowledgmentUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalAlarmEventAcknowledgmentUniquePDSA</param>
    public IsAccessPortalAlarmEventAcknowledgmentUniquePDSAValidator(IsAccessPortalAlarmEventAcknowledgmentUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalAlarmEventAcknowledgmentUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalAlarmEventAcknowledgmentUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalAlarmEventAcknowledgmentUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalAlarmEventAcknowledgmentUniquePDSAValidator.ColumnNames.DateColumnNameHere);
