...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaDayPeriodEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaDayPeriodEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaDayPeriodEntityMapUniquePDSA</param>
    public IsAssaDayPeriodEntityMapUniquePDSAValidator(IsAssaDayPeriodEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaDayPeriodEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsAssaDayPeriodEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaDayPeriodEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaDayPeriodEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
