...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalEntityMapUniquePDSA</param>
    public IsAccessPortalEntityMapUniquePDSAValidator(IsAccessPortalEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
