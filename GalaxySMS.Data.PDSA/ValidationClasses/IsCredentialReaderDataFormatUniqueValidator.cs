...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialReaderDataFormatUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialReaderDataFormatUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialReaderDataFormatUniquePDSA</param>
    public IsCredentialReaderDataFormatUniquePDSAValidator(IsCredentialReaderDataFormatUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialReaderDataFormatUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialReaderDataFormatUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialReaderDataFormatUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialReaderDataFormatUniquePDSAValidator.ColumnNames.DateColumnNameHere);
