...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRegionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRegionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRegionUniquePDSA</param>
    public IsRegionUniquePDSAValidator(IsRegionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRegionUniquePDSAValidator";

      // Create Properties for each field in the IsRegionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRegionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRegionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
