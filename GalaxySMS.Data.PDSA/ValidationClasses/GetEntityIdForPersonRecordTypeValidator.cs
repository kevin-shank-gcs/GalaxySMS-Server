...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForPersonRecordTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForPersonRecordTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForPersonRecordTypePDSA</param>
    public GetEntityIdForPersonRecordTypePDSAValidator(GetEntityIdForPersonRecordTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForPersonRecordTypePDSAValidator";

      // Create Properties for each field in the GetEntityIdForPersonRecordTypePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForPersonRecordTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForPersonRecordTypePDSAValidator.ColumnNames.DateColumnNameHere);
