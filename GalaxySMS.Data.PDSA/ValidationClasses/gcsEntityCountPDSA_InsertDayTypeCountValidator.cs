...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertDayTypeCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertDayTypeCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertDayTypeCountPDSA</param>
    public gcsEntityCountPDSA_InsertDayTypeCountPDSAValidator(gcsEntityCountPDSA_InsertDayTypeCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertDayTypeCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertDayTypeCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertDayTypeCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertDayTypeCountPDSAValidator.ColumnNames.DateColumnNameHere);
