...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyTimePeriodEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyTimePeriodEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyTimePeriodEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyTimePeriodEntityMapPDSA</param>
    public GalaxyTimePeriodEntityMapPDSAValidator(GalaxyTimePeriodEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyTimePeriodEntityMapPDSAValidator";

      // Create Properties for each field in the GalaxyTimePeriodEntityMapPDSA entity class
      InitProperties();
    ...
    public GalaxyTimePeriodEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyTimePeriodEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyTimePeriodEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyTimePeriodEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
