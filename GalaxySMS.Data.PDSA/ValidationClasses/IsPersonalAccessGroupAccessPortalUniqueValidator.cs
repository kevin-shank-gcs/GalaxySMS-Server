...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonalAccessGroupAccessPortalUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonalAccessGroupAccessPortalUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonalAccessGroupAccessPortalUniquePDSA</param>
    public IsPersonalAccessGroupAccessPortalUniquePDSAValidator(IsPersonalAccessGroupAccessPortalUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonalAccessGroupAccessPortalUniquePDSAValidator";

      // Create Properties for each field in the IsPersonalAccessGroupAccessPortalUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonalAccessGroupAccessPortalUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonalAccessGroupAccessPortalUniquePDSAValidator.ColumnNames.DateColumnNameHere);
