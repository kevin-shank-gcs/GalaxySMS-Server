...
{
  /// <summary>
  /// Used to validate business rules on the BadgeSystemTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BadgeSystemTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BadgeSystemTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BadgeSystemTypePDSA</param>
    public BadgeSystemTypePDSAValidator(BadgeSystemTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BadgeSystemTypePDSAValidator";

      // Create Properties for each field in the BadgeSystemTypePDSA entity class
      InitProperties();
    ...
    public BadgeSystemTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BadgeSystemTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BadgeSystemTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BadgeSystemTypePDSAValidator.ColumnNames.DateColumnNameHere);
