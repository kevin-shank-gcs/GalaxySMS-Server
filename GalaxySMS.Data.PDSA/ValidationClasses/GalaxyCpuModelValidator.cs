...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyCpuModelPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyCpuModelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuModelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuModelPDSA</param>
    public GalaxyCpuModelPDSAValidator(GalaxyCpuModelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuModelPDSAValidator";

      // Create Properties for each field in the GalaxyCpuModelPDSA entity class
      InitProperties();
    ...
    public GalaxyCpuModelPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyCpuModelPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuModelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuModelPDSAValidator.ColumnNames.DateColumnNameHere);
