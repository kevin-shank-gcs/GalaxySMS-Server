...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonPhotoScaledUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonPhotoScaledUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonPhotoScaledUniquePDSA</param>
    public IsPersonPhotoScaledUniquePDSAValidator(IsPersonPhotoScaledUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonPhotoScaledUniquePDSAValidator";

      // Create Properties for each field in the IsPersonPhotoScaledUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonPhotoScaledUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonPhotoScaledUniquePDSAValidator.ColumnNames.DateColumnNameHere);
