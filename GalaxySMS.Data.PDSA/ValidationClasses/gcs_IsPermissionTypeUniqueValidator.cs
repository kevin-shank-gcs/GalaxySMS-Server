...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsPermissionTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsPermissionTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsPermissionTypeUniquePDSA</param>
    public gcs_IsPermissionTypeUniquePDSAValidator(gcs_IsPermissionTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsPermissionTypeUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsPermissionTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsPermissionTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsPermissionTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
