...
{
  /// <summary>
  /// Used to validate business rules on the PersonPhotoScaledPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonPhotoScaledPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPhotoScaledPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPhotoScaledPDSA</param>
    public PersonPhotoScaledPDSAValidator(PersonPhotoScaledPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPhotoScaledPDSAValidator";

      // Create Properties for each field in the PersonPhotoScaledPDSA entity class
      InitProperties();
    ...
    public PersonPhotoScaledPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonPhotoScaledPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPhotoScaledPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPhotoScaledPDSAValidator.ColumnNames.DateColumnNameHere);
