...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessProfileAccessGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessProfileAccessGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessProfileAccessGroupUniquePDSA</param>
    public IsAccessProfileAccessGroupUniquePDSAValidator(IsAccessProfileAccessGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessProfileAccessGroupUniquePDSAValidator";

      // Create Properties for each field in the IsAccessProfileAccessGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessProfileAccessGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessProfileAccessGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
