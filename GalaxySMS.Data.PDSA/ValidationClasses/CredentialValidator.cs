...
{
  /// <summary>
  /// Used to validate business rules on the CredentialPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialPDSA</param>
    public CredentialPDSAValidator(CredentialPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialPDSAValidator";

      // Create Properties for each field in the CredentialPDSA entity class
      InitProperties();
    ...
    public CredentialPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialPDSAValidator.ColumnNames.DateColumnNameHere);
