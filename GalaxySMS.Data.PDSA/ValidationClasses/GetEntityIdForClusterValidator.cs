...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForClusterPDSA</param>
    public GetEntityIdForClusterPDSAValidator(GetEntityIdForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForClusterPDSAValidator";

      // Create Properties for each field in the GetEntityIdForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
