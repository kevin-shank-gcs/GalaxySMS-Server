...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class insert_GalaxyPanelActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the insert_GalaxyPanelActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a insert_GalaxyPanelActivityEventPDSA</param>
    public insert_GalaxyPanelActivityEventPDSAValidator(insert_GalaxyPanelActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "insert_GalaxyPanelActivityEventPDSAValidator";

      // Create Properties for each field in the insert_GalaxyPanelActivityEventPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(insert_GalaxyPanelActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(insert_GalaxyPanelActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
