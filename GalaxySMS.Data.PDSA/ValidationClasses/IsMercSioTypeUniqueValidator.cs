...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercSioTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercSioTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercSioTypeUniquePDSA</param>
    public IsMercSioTypeUniquePDSAValidator(IsMercSioTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercSioTypeUniquePDSAValidator";

      // Create Properties for each field in the IsMercSioTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercSioTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercSioTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
