...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleClusterUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleClusterUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleClusterUniquePDSA</param>
    public IsRoleClusterUniquePDSAValidator(IsRoleClusterUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleClusterUniquePDSAValidator";

      // Create Properties for each field in the IsRoleClusterUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleClusterUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleClusterUniquePDSAValidator.ColumnNames.DateColumnNameHere);
