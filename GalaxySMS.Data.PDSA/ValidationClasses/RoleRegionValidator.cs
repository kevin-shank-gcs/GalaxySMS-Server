...
{
  /// <summary>
  /// Used to validate business rules on the RoleRegionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleRegionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleRegionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleRegionPDSA</param>
    public RoleRegionPDSAValidator(RoleRegionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleRegionPDSAValidator";

      // Create Properties for each field in the RoleRegionPDSA entity class
      InitProperties();
    ...
    public RoleRegionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleRegionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleRegionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleRegionPDSAValidator.ColumnNames.DateColumnNameHere);
