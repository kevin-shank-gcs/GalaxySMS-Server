...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSA</param>
    public AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSAValidator(AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByAccessPortalAlarmEventAcknowledgmentUidPDSAValidator.ColumnNames.DateColumnNameHere);
