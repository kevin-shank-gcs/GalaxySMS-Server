...
{
  /// <summary>
  /// Used to validate business rules on the TimeScheduleDayTypeGalaxyTimePeriodPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class TimeScheduleDayTypeGalaxyTimePeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeScheduleDayTypeGalaxyTimePeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeScheduleDayTypeGalaxyTimePeriodPDSA</param>
    public TimeScheduleDayTypeGalaxyTimePeriodPDSAValidator(TimeScheduleDayTypeGalaxyTimePeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeScheduleDayTypeGalaxyTimePeriodPDSAValidator";

      // Create Properties for each field in the TimeScheduleDayTypeGalaxyTimePeriodPDSA entity class
      InitProperties();
    ...
    public TimeScheduleDayTypeGalaxyTimePeriodPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TimeScheduleDayTypeGalaxyTimePeriodPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeScheduleDayTypeGalaxyTimePeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeScheduleDayTypeGalaxyTimePeriodPDSAValidator.ColumnNames.DateColumnNameHere);
