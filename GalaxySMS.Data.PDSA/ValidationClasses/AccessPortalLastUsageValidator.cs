...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalLastUsagePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalLastUsagePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalLastUsagePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalLastUsagePDSA</param>
    public AccessPortalLastUsagePDSAValidator(AccessPortalLastUsagePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalLastUsagePDSAValidator";

      // Create Properties for each field in the AccessPortalLastUsagePDSA entity class
      InitProperties();
    ...
    public AccessPortalLastUsagePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalLastUsagePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalLastUsagePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalLastUsagePDSAValidator.ColumnNames.DateColumnNameHere);
