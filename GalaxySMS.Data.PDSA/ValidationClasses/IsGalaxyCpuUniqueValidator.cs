...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyCpuUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyCpuUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyCpuUniquePDSA</param>
    public IsGalaxyCpuUniquePDSAValidator(IsGalaxyCpuUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyCpuUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyCpuUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyCpuUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyCpuUniquePDSAValidator.ColumnNames.DateColumnNameHere);
