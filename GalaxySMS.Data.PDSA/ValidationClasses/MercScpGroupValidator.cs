...
{
  /// <summary>
  /// Used to validate business rules on the MercScpGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class MercScpGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpGroupPDSA</param>
    public MercScpGroupPDSAValidator(MercScpGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpGroupPDSAValidator";

      // Create Properties for each field in the MercScpGroupPDSA entity class
      InitProperties();
    ...
    public MercScpGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your MercScpGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpGroupPDSAValidator.ColumnNames.DateColumnNameHere);
