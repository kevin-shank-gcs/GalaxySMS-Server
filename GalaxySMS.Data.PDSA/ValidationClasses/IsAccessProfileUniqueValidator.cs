...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessProfileUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessProfileUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessProfileUniquePDSA</param>
    public IsAccessProfileUniquePDSAValidator(IsAccessProfileUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessProfileUniquePDSAValidator";

      // Create Properties for each field in the IsAccessProfileUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessProfileUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessProfileUniquePDSAValidator.ColumnNames.DateColumnNameHere);
