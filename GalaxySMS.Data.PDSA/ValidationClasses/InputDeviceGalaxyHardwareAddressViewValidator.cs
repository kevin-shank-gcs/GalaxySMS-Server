...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceGalaxyHardwareAddressViewPDSA class.
  ...
  /// </summary>
  public partial class InputDeviceGalaxyHardwareAddressViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceGalaxyHardwareAddressViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceGalaxyHardwareAddressViewPDSA</param>
    public InputDeviceGalaxyHardwareAddressViewPDSAValidator(InputDeviceGalaxyHardwareAddressViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceGalaxyHardwareAddressViewPDSAValidator";

      // Create Properties for each field in the InputDeviceGalaxyHardwareAddressViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A InputDeviceGalaxyHardwareAddressViewPDSA object</returns>
    public InputDeviceGalaxyHardwareAddressViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceGalaxyHardwareAddressViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceGalaxyHardwareAddressViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceGalaxyHardwareAddressViewPDSAValidator.ColumnNames.DateColumnNameHere);
