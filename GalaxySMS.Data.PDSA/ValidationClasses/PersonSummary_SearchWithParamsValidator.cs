...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonSummary_SearchWithParamsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonSummary_SearchWithParamsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonSummary_SearchWithParamsPDSA</param>
    public PersonSummary_SearchWithParamsPDSAValidator(PersonSummary_SearchWithParamsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonSummary_SearchWithParamsPDSAValidator";

      // Create Properties for each field in the PersonSummary_SearchWithParamsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonSummary_SearchWithParamsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonSummary_SearchWithParamsPDSAValidator.ColumnNames.DateColumnNameHere);
