...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleSitePermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleSitePermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleSitePermissionUniquePDSA</param>
    public IsRoleSitePermissionUniquePDSAValidator(IsRoleSitePermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleSitePermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleSitePermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleSitePermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleSitePermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
