...
{
  /// <summary>
  /// Used to validate business rules on the AccessGroupEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessGroupEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupEntityMapPDSA</param>
    public AccessGroupEntityMapPDSAValidator(AccessGroupEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupEntityMapPDSAValidator";

      // Create Properties for each field in the AccessGroupEntityMapPDSA entity class
      InitProperties();
    ...
    public AccessGroupEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessGroupEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
