...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_SelectionListForSitePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_SelectionListForSitePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_SelectionListForSitePDSA</param>
    public Cluster_SelectionListForSitePDSAValidator(Cluster_SelectionListForSitePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_SelectionListForSitePDSAValidator";

      // Create Properties for each field in the Cluster_SelectionListForSitePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_SelectionListForSitePDSAValidator.ColumnNames.DateColumnNameHere);
