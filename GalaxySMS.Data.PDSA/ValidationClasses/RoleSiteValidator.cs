...
{
  /// <summary>
  /// Used to validate business rules on the RoleSitePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleSitePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleSitePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleSitePDSA</param>
    public RoleSitePDSAValidator(RoleSitePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleSitePDSAValidator";

      // Create Properties for each field in the RoleSitePDSA entity class
      InitProperties();
    ...
    public RoleSitePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleSitePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleSitePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleSitePDSAValidator.ColumnNames.DateColumnNameHere);
