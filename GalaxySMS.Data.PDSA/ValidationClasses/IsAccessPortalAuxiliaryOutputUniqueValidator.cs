...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalAuxiliaryOutputUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalAuxiliaryOutputUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalAuxiliaryOutputUniquePDSA</param>
    public IsAccessPortalAuxiliaryOutputUniquePDSAValidator(IsAccessPortalAuxiliaryOutputUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalAuxiliaryOutputUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalAuxiliaryOutputUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalAuxiliaryOutputUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalAuxiliaryOutputUniquePDSAValidator.ColumnNames.DateColumnNameHere);
