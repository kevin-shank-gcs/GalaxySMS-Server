...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroup_GetPanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_GetPanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_GetPanelLoadDataByClusterUidPDSA</param>
    public AccessGroup_GetPanelLoadDataByClusterUidPDSAValidator(AccessGroup_GetPanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_GetPanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the AccessGroup_GetPanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
