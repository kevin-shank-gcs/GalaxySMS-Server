...
{
  /// <summary>
  /// Used to validate business rules on the gcsResourceStringLanguagePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsResourceStringLanguagePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsResourceStringLanguagePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsResourceStringLanguagePDSA</param>
    public gcsResourceStringLanguagePDSAValidator(gcsResourceStringLanguagePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsResourceStringLanguagePDSAValidator";

      // Create Properties for each field in the gcsResourceStringLanguagePDSA entity class
      InitProperties();
    ...
    public gcsResourceStringLanguagePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsResourceStringLanguagePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsResourceStringLanguagePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsResourceStringLanguagePDSAValidator.ColumnNames.DateColumnNameHere);
