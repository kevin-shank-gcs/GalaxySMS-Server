...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetPrimaryEntityIdForUserPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetPrimaryEntityIdForUserPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetPrimaryEntityIdForUserPDSA</param>
    public GetPrimaryEntityIdForUserPDSAValidator(GetPrimaryEntityIdForUserPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetPrimaryEntityIdForUserPDSAValidator";

      // Create Properties for each field in the GetPrimaryEntityIdForUserPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetPrimaryEntityIdForUserPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetPrimaryEntityIdForUserPDSAValidator.ColumnNames.DateColumnNameHere);
