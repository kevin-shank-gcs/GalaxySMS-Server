...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA</param>
    public AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.DateColumnNameHere);
