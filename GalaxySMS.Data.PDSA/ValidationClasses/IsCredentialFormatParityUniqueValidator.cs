...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialFormatParityUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialFormatParityUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialFormatParityUniquePDSA</param>
    public IsCredentialFormatParityUniquePDSAValidator(IsCredentialFormatParityUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialFormatParityUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialFormatParityUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialFormatParityUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialFormatParityUniquePDSAValidator.ColumnNames.DateColumnNameHere);
