...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterInputOutputGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterInputOutputGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterInputOutputGroupUniquePDSA</param>
    public IsClusterInputOutputGroupUniquePDSAValidator(IsClusterInputOutputGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterInputOutputGroupUniquePDSAValidator";

      // Create Properties for each field in the IsClusterInputOutputGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterInputOutputGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterInputOutputGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
