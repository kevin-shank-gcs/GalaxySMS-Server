...
{
  /// <summary>
  /// Used to validate business rules on the OutputCommandAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class OutputCommandAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputCommandAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputCommandAuditPDSA</param>
    public OutputCommandAuditPDSAValidator(OutputCommandAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputCommandAuditPDSAValidator";

      // Create Properties for each field in the OutputCommandAuditPDSA entity class
      InitProperties();
    ...
    public OutputCommandAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputCommandAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputCommandAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputCommandAuditPDSAValidator.ColumnNames.DateColumnNameHere);
