...
{
  /// <summary>
  /// Used to validate business rules on the RegionEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RegionEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RegionEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RegionEntityMapPDSA</param>
    public RegionEntityMapPDSAValidator(RegionEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RegionEntityMapPDSAValidator";

      // Create Properties for each field in the RegionEntityMapPDSA entity class
      InitProperties();
    ...
    public RegionEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RegionEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RegionEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RegionEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
