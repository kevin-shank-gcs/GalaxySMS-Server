...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class select_ActivityEventsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the select_ActivityEventsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a select_ActivityEventsPDSA</param>
    public select_ActivityEventsPDSAValidator(select_ActivityEventsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "select_ActivityEventsPDSAValidator";

      // Create Properties for each field in the select_ActivityEventsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(select_ActivityEventsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(select_ActivityEventsPDSAValidator.ColumnNames.DateColumnNameHere);
