...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialReaderTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialReaderTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialReaderTypeUniquePDSA</param>
    public IsCredentialReaderTypeUniquePDSAValidator(IsCredentialReaderTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialReaderTypeUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialReaderTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialReaderTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialReaderTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
