...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetPermissionsForUserEntityApplicationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetPermissionsForUserEntityApplicationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetPermissionsForUserEntityApplicationPDSA</param>
    public GetPermissionsForUserEntityApplicationPDSAValidator(GetPermissionsForUserEntityApplicationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetPermissionsForUserEntityApplicationPDSAValidator";

      // Create Properties for each field in the GetPermissionsForUserEntityApplicationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetPermissionsForUserEntityApplicationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetPermissionsForUserEntityApplicationPDSAValidator.ColumnNames.DateColumnNameHere);
