...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSA</param>
    public GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSAValidator(GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSAValidator";

      // Create Properties for each field in the GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.DateColumnNameHere);
