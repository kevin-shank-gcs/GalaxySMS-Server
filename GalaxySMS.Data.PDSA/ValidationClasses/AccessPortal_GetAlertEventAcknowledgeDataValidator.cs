...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetAlertEventAcknowledgeDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetAlertEventAcknowledgeDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetAlertEventAcknowledgeDataPDSA</param>
    public AccessPortal_GetAlertEventAcknowledgeDataPDSAValidator(AccessPortal_GetAlertEventAcknowledgeDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetAlertEventAcknowledgeDataPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetAlertEventAcknowledgeDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.DateColumnNameHere);
