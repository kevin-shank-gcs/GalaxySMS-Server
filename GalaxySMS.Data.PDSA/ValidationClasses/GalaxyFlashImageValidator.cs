...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyFlashImagePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyFlashImagePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyFlashImagePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyFlashImagePDSA</param>
    public GalaxyFlashImagePDSAValidator(GalaxyFlashImagePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyFlashImagePDSAValidator";

      // Create Properties for each field in the GalaxyFlashImagePDSA entity class
      InitProperties();
    ...
    public GalaxyFlashImagePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyFlashImagePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyFlashImagePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyFlashImagePDSAValidator.ColumnNames.DateColumnNameHere);
