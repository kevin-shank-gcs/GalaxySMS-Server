...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupValidForInputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupValidForInputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupValidForInputDevicePDSA</param>
    public IsInputOutputGroupValidForInputDevicePDSAValidator(IsInputOutputGroupValidForInputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupValidForInputDevicePDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupValidForInputDevicePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupValidForInputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupValidForInputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
