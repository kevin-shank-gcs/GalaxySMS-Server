...
{
  /// <summary>
  /// Used to validate business rules on the ClusterEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterEntityMapPDSA</param>
    public ClusterEntityMapPDSAValidator(ClusterEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterEntityMapPDSAValidator";

      // Create Properties for each field in the ClusterEntityMapPDSA entity class
      InitProperties();
    ...
    public ClusterEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
