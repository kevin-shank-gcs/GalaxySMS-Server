...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSA</param>
    public PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSAValidator(PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSAValidator";

      // Create Properties for each field in the PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPhotoScaledPDSA_UpdatePublicUrlByPkPDSAValidator.ColumnNames.DateColumnNameHere);
