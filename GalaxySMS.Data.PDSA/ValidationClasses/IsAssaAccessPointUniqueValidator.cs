...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaAccessPointUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaAccessPointUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaAccessPointUniquePDSA</param>
    public IsAssaAccessPointUniquePDSAValidator(IsAssaAccessPointUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaAccessPointUniquePDSAValidator";

      // Create Properties for each field in the IsAssaAccessPointUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaAccessPointUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaAccessPointUniquePDSAValidator.ColumnNames.DateColumnNameHere);
