...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailablePersonalAccessGroupNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailablePersonalAccessGroupNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailablePersonalAccessGroupNumberPDSA</param>
    public ChooseAvailablePersonalAccessGroupNumberPDSAValidator(ChooseAvailablePersonalAccessGroupNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailablePersonalAccessGroupNumberPDSAValidator";

      // Create Properties for each field in the ChooseAvailablePersonalAccessGroupNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailablePersonalAccessGroupNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailablePersonalAccessGroupNumberPDSAValidator.ColumnNames.DateColumnNameHere);
