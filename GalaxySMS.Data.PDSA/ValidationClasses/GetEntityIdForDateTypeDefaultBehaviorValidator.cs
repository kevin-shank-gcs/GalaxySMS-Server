...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForDateTypeDefaultBehaviorPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForDateTypeDefaultBehaviorPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForDateTypeDefaultBehaviorPDSA</param>
    public GetEntityIdForDateTypeDefaultBehaviorPDSAValidator(GetEntityIdForDateTypeDefaultBehaviorPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForDateTypeDefaultBehaviorPDSAValidator";

      // Create Properties for each field in the GetEntityIdForDateTypeDefaultBehaviorPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForDateTypeDefaultBehaviorPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForDateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateColumnNameHere);
