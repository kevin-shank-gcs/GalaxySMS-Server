...
{
  /// <summary>
  /// Used to validate business rules on the ActivityEventAcknowledgementPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ActivityEventAcknowledgementPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ActivityEventAcknowledgementPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ActivityEventAcknowledgementPDSA</param>
    public ActivityEventAcknowledgementPDSAValidator(ActivityEventAcknowledgementPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ActivityEventAcknowledgementPDSAValidator";

      // Create Properties for each field in the ActivityEventAcknowledgementPDSA entity class
      InitProperties();
    ...
    public ActivityEventAcknowledgementPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ActivityEventAcknowledgementPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ActivityEventAcknowledgementPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ActivityEventAcknowledgementPDSAValidator.ColumnNames.DateColumnNameHere);
