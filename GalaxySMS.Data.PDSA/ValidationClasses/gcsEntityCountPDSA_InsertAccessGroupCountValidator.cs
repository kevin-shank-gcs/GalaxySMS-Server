...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertAccessGroupCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertAccessGroupCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertAccessGroupCountPDSA</param>
    public gcsEntityCountPDSA_InsertAccessGroupCountPDSAValidator(gcsEntityCountPDSA_InsertAccessGroupCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertAccessGroupCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertAccessGroupCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessGroupCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessGroupCountPDSAValidator.ColumnNames.DateColumnNameHere);
