...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserEntityApplicationRoleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserEntityApplicationRoleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserEntityApplicationRoleUniquePDSA</param>
    public gcs_IsUserEntityApplicationRoleUniquePDSAValidator(gcs_IsUserEntityApplicationRoleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserEntityApplicationRoleUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsUserEntityApplicationRoleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserEntityApplicationRoleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserEntityApplicationRoleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
