...
{
  /// <summary>
  /// Used to validate business rules on the CredentialSoftwareHouse37BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialSoftwareHouse37BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialSoftwareHouse37BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialSoftwareHouse37BitPDSA</param>
    public CredentialSoftwareHouse37BitPDSAValidator(CredentialSoftwareHouse37BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialSoftwareHouse37BitPDSAValidator";

      // Create Properties for each field in the CredentialSoftwareHouse37BitPDSA entity class
      InitProperties();
    ...
    public CredentialSoftwareHouse37BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialSoftwareHouse37BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialSoftwareHouse37BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialSoftwareHouse37BitPDSAValidator.ColumnNames.DateColumnNameHere);
