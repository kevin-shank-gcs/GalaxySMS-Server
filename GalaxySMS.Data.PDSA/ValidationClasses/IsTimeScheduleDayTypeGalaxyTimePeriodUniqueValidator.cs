...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSA</param>
    public IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSAValidator(IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSAValidator";

      // Create Properties for each field in the IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimeScheduleDayTypeGalaxyTimePeriodUniquePDSAValidator.ColumnNames.DateColumnNameHere);
