...
{
  /// <summary>
  /// Used to validate business rules on the PersonalAccessGroupDynamicAccessGroupTempPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonalAccessGroupDynamicAccessGroupTempPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroupDynamicAccessGroupTempPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroupDynamicAccessGroupTempPDSA</param>
    public PersonalAccessGroupDynamicAccessGroupTempPDSAValidator(PersonalAccessGroupDynamicAccessGroupTempPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroupDynamicAccessGroupTempPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroupDynamicAccessGroupTempPDSA entity class
      InitProperties();
    ...
    public PersonalAccessGroupDynamicAccessGroupTempPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonalAccessGroupDynamicAccessGroupTempPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroupDynamicAccessGroupTempPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroupDynamicAccessGroupTempPDSAValidator.ColumnNames.DateColumnNameHere);
