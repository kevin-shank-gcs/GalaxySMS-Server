...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelAlertEventTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelAlertEventTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelAlertEventTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelAlertEventTypePDSA</param>
    public GalaxyPanelAlertEventTypePDSAValidator(GalaxyPanelAlertEventTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelAlertEventTypePDSAValidator";

      // Create Properties for each field in the GalaxyPanelAlertEventTypePDSA entity class
      InitProperties();
    ...
    public GalaxyPanelAlertEventTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelAlertEventTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelAlertEventTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelAlertEventTypePDSAValidator.ColumnNames.DateColumnNameHere);
