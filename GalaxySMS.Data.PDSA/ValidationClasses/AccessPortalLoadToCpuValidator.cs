...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalLoadToCpuPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalLoadToCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalLoadToCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalLoadToCpuPDSA</param>
    public AccessPortalLoadToCpuPDSAValidator(AccessPortalLoadToCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalLoadToCpuPDSAValidator";

      // Create Properties for each field in the AccessPortalLoadToCpuPDSA entity class
      InitProperties();
    ...
    public AccessPortalLoadToCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalLoadToCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalLoadToCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalLoadToCpuPDSAValidator.ColumnNames.DateColumnNameHere);
