...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyCpu_GetCpuPanelClusterInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpu_GetCpuPanelClusterInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpu_GetCpuPanelClusterInformationPDSA</param>
    public GalaxyCpu_GetCpuPanelClusterInformationPDSAValidator(GalaxyCpu_GetCpuPanelClusterInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpu_GetCpuPanelClusterInformationPDSAValidator";

      // Create Properties for each field in the GalaxyCpu_GetCpuPanelClusterInformationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpu_GetCpuPanelClusterInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpu_GetCpuPanelClusterInformationPDSAValidator.ColumnNames.DateColumnNameHere);
