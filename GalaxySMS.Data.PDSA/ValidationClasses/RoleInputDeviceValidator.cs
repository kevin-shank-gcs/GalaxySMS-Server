...
{
  /// <summary>
  /// Used to validate business rules on the RoleInputDevicePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleInputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleInputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleInputDevicePDSA</param>
    public RoleInputDevicePDSAValidator(RoleInputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleInputDevicePDSAValidator";

      // Create Properties for each field in the RoleInputDevicePDSA entity class
      InitProperties();
    ...
    public RoleInputDevicePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleInputDevicePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleInputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleInputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
