...
{
  /// <summary>
  /// Used to validate business rules on the ClusterLedBehaviorModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterLedBehaviorModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterLedBehaviorModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterLedBehaviorModePDSA</param>
    public ClusterLedBehaviorModePDSAValidator(ClusterLedBehaviorModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterLedBehaviorModePDSAValidator";

      // Create Properties for each field in the ClusterLedBehaviorModePDSA entity class
      InitProperties();
    ...
    public ClusterLedBehaviorModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterLedBehaviorModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterLedBehaviorModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterLedBehaviorModePDSAValidator.ColumnNames.DateColumnNameHere);
