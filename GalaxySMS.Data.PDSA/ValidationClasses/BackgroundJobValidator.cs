...
{
  /// <summary>
  /// Used to validate business rules on the BackgroundJobPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BackgroundJobPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BackgroundJobPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BackgroundJobPDSA</param>
    public BackgroundJobPDSAValidator(BackgroundJobPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BackgroundJobPDSAValidator";

      // Create Properties for each field in the BackgroundJobPDSA entity class
      InitProperties();
    ...
    public BackgroundJobPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BackgroundJobPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BackgroundJobPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BackgroundJobPDSAValidator.ColumnNames.DateColumnNameHere);
