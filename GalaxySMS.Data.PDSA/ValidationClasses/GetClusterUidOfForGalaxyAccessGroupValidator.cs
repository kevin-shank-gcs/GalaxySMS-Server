...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetClusterUidOfForGalaxyAccessGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetClusterUidOfForGalaxyAccessGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetClusterUidOfForGalaxyAccessGroupPDSA</param>
    public GetClusterUidOfForGalaxyAccessGroupPDSAValidator(GetClusterUidOfForGalaxyAccessGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetClusterUidOfForGalaxyAccessGroupPDSAValidator";

      // Create Properties for each field in the GetClusterUidOfForGalaxyAccessGroupPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetClusterUidOfForGalaxyAccessGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetClusterUidOfForGalaxyAccessGroupPDSAValidator.ColumnNames.DateColumnNameHere);
