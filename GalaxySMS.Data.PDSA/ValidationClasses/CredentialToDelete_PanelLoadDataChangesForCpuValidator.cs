...
{
  /// <summary>
  /// Used to validate business rules on the CredentialToDelete_PanelLoadDataChangesForCpuPDSA class.
  ...
  /// </summary>
  public partial class CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToDelete_PanelLoadDataChangesForCpuPDSA</param>
    public CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator(CredentialToDelete_PanelLoadDataChangesForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator";

      // Create Properties for each field in the CredentialToDelete_PanelLoadDataChangesForCpuPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A CredentialToDelete_PanelLoadDataChangesForCpuPDSA object</returns>
    public CredentialToDelete_PanelLoadDataChangesForCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialToDelete_PanelLoadDataChangesForCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
