...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsUser_UpdatePasswordPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUser_UpdatePasswordPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUser_UpdatePasswordPDSA</param>
    public gcsUser_UpdatePasswordPDSAValidator(gcsUser_UpdatePasswordPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUser_UpdatePasswordPDSAValidator";

      // Create Properties for each field in the gcsUser_UpdatePasswordPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUser_UpdatePasswordPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUser_UpdatePasswordPDSAValidator.ColumnNames.DateColumnNameHere);
