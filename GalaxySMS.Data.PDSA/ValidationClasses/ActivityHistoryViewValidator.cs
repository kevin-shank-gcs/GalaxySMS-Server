...
{
  /// <summary>
  /// Used to validate business rules on the ActivityHistoryViewPDSA class.
  ...
  /// </summary>
  public partial class ActivityHistoryViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ActivityHistoryViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ActivityHistoryViewPDSA</param>
    public ActivityHistoryViewPDSAValidator(ActivityHistoryViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ActivityHistoryViewPDSAValidator";

      // Create Properties for each field in the ActivityHistoryViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A ActivityHistoryViewPDSA object</returns>
    public ActivityHistoryViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ActivityHistoryViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ActivityHistoryViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ActivityHistoryViewPDSAValidator.ColumnNames.DateColumnNameHere);
