...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityPDSA_SelectNameByPKPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityPDSA_SelectNameByPKPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityPDSA_SelectNameByPKPDSA</param>
    public gcsEntityPDSA_SelectNameByPKPDSAValidator(gcsEntityPDSA_SelectNameByPKPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityPDSA_SelectNameByPKPDSAValidator";

      // Create Properties for each field in the gcsEntityPDSA_SelectNameByPKPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityPDSA_SelectNameByPKPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityPDSA_SelectNameByPKPDSAValidator.ColumnNames.DateColumnNameHere);
