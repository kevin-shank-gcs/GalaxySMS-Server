...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputInputSourceTriggerConditionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputInputSourceTriggerConditionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputInputSourceTriggerConditionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputInputSourceTriggerConditionPDSA</param>
    public GalaxyOutputInputSourceTriggerConditionPDSAValidator(GalaxyOutputInputSourceTriggerConditionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputInputSourceTriggerConditionPDSAValidator";

      // Create Properties for each field in the GalaxyOutputInputSourceTriggerConditionPDSA entity class
      InitProperties();
    ...
    public GalaxyOutputInputSourceTriggerConditionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputInputSourceTriggerConditionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputInputSourceTriggerConditionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputInputSourceTriggerConditionPDSAValidator.ColumnNames.DateColumnNameHere);
