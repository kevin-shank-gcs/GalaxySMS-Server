...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelAlertEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelAlertEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelAlertEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelAlertEventPDSA</param>
    public GalaxyPanelAlertEventPDSAValidator(GalaxyPanelAlertEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelAlertEventPDSAValidator";

      // Create Properties for each field in the GalaxyPanelAlertEventPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelAlertEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelAlertEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelAlertEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelAlertEventPDSAValidator.ColumnNames.DateColumnNameHere);
