...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsApplicationUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsApplicationUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsApplicationUniquePDSA</param>
    public gcs_IsApplicationUniquePDSAValidator(gcs_IsApplicationUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsApplicationUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsApplicationUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsApplicationUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsApplicationUniquePDSAValidator.ColumnNames.DateColumnNameHere);
