...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSA</param>
    public IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSAValidator(IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyOutputDeviceInputSourceAssignmentUniquePDSAValidator.ColumnNames.DateColumnNameHere);
