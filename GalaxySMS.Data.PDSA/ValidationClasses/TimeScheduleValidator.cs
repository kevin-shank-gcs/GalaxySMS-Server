...
{
  /// <summary>
  /// Used to validate business rules on the TimeSchedulePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class TimeSchedulePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedulePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedulePDSA</param>
    public TimeSchedulePDSAValidator(TimeSchedulePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedulePDSAValidator";

      // Create Properties for each field in the TimeSchedulePDSA entity class
      InitProperties();
    ...
    public TimeSchedulePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TimeSchedulePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedulePDSAValidator.ColumnNames.DateColumnNameHere);
