...
{
  /// <summary>
  /// Used to validate business rules on the CredentialBqt36BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialBqt36BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialBqt36BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialBqt36BitPDSA</param>
    public CredentialBqt36BitPDSAValidator(CredentialBqt36BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialBqt36BitPDSAValidator";

      // Create Properties for each field in the CredentialBqt36BitPDSA entity class
      InitProperties();
    ...
    public CredentialBqt36BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialBqt36BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialBqt36BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialBqt36BitPDSAValidator.ColumnNames.DateColumnNameHere);
