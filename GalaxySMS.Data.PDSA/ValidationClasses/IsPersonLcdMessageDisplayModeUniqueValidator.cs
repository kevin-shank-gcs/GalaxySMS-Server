...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonLcdMessageDisplayModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonLcdMessageDisplayModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonLcdMessageDisplayModeUniquePDSA</param>
    public IsPersonLcdMessageDisplayModeUniquePDSAValidator(IsPersonLcdMessageDisplayModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonLcdMessageDisplayModeUniquePDSAValidator";

      // Create Properties for each field in the IsPersonLcdMessageDisplayModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonLcdMessageDisplayModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonLcdMessageDisplayModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
