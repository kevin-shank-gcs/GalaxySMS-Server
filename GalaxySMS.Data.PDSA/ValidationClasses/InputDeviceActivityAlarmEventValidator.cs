...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceActivityAlarmEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceActivityAlarmEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceActivityAlarmEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceActivityAlarmEventPDSA</param>
    public InputDeviceActivityAlarmEventPDSAValidator(InputDeviceActivityAlarmEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceActivityAlarmEventPDSAValidator";

      // Create Properties for each field in the InputDeviceActivityAlarmEventPDSA entity class
      InitProperties();
    ...
    public InputDeviceActivityAlarmEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceActivityAlarmEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceActivityAlarmEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceActivityAlarmEventPDSAValidator.ColumnNames.DateColumnNameHere);
