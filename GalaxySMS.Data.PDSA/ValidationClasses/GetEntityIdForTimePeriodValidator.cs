...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForTimePeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForTimePeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForTimePeriodPDSA</param>
    public GetEntityIdForTimePeriodPDSAValidator(GetEntityIdForTimePeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForTimePeriodPDSAValidator";

      // Create Properties for each field in the GetEntityIdForTimePeriodPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForTimePeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForTimePeriodPDSAValidator.ColumnNames.DateColumnNameHere);
