...
{
  /// <summary>
  /// Used to validate business rules on the RoleRegionPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleRegionPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleRegionPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleRegionPermissionPDSA</param>
    public RoleRegionPermissionPDSAValidator(RoleRegionPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleRegionPermissionPDSAValidator";

      // Create Properties for each field in the RoleRegionPermissionPDSA entity class
      InitProperties();
    ...
    public RoleRegionPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleRegionPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleRegionPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleRegionPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
