...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceNotePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceNotePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceNotePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceNotePDSA</param>
    public InputDeviceNotePDSAValidator(InputDeviceNotePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceNotePDSAValidator";

      // Create Properties for each field in the InputDeviceNotePDSA entity class
      InitProperties();
    ...
    public InputDeviceNotePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceNotePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceNotePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceNotePDSAValidator.ColumnNames.DateColumnNameHere);
