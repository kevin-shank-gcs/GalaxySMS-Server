...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceNoteUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceNoteUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceNoteUniquePDSA</param>
    public IsInputDeviceNoteUniquePDSAValidator(IsInputDeviceNoteUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceNoteUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceNoteUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceNoteUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceNoteUniquePDSAValidator.ColumnNames.DateColumnNameHere);
