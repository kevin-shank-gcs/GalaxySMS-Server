...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertTimePeriodCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertTimePeriodCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertTimePeriodCountPDSA</param>
    public gcsEntityCountPDSA_InsertTimePeriodCountPDSAValidator(gcsEntityCountPDSA_InsertTimePeriodCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertTimePeriodCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertTimePeriodCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertTimePeriodCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertTimePeriodCountPDSAValidator.ColumnNames.DateColumnNameHere);
