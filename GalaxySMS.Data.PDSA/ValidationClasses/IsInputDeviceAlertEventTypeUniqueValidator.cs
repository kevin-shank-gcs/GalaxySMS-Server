...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceAlertEventTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceAlertEventTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceAlertEventTypeUniquePDSA</param>
    public IsInputDeviceAlertEventTypeUniquePDSAValidator(IsInputDeviceAlertEventTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceAlertEventTypeUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceAlertEventTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceAlertEventTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceAlertEventTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
