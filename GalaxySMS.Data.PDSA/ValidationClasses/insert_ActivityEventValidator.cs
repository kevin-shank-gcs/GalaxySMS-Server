...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class insert_ActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the insert_ActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a insert_ActivityEventPDSA</param>
    public insert_ActivityEventPDSAValidator(insert_ActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "insert_ActivityEventPDSAValidator";

      // Create Properties for each field in the insert_ActivityEventPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(insert_ActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(insert_ActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
