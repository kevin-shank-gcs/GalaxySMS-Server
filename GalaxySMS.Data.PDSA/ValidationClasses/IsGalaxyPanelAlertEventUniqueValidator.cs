...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelAlertEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelAlertEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelAlertEventUniquePDSA</param>
    public IsGalaxyPanelAlertEventUniquePDSAValidator(IsGalaxyPanelAlertEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelAlertEventUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelAlertEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelAlertEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelAlertEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
