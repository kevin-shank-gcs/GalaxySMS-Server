...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimeScheduleMappedToClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimeScheduleMappedToClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimeScheduleMappedToClusterPDSA</param>
    public IsTimeScheduleMappedToClusterPDSAValidator(IsTimeScheduleMappedToClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimeScheduleMappedToClusterPDSAValidator";

      // Create Properties for each field in the IsTimeScheduleMappedToClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimeScheduleMappedToClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimeScheduleMappedToClusterPDSAValidator.ColumnNames.DateColumnNameHere);
