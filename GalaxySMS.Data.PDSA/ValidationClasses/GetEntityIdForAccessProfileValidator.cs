...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForAccessProfilePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForAccessProfilePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForAccessProfilePDSA</param>
    public GetEntityIdForAccessProfilePDSAValidator(GetEntityIdForAccessProfilePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForAccessProfilePDSAValidator";

      // Create Properties for each field in the GetEntityIdForAccessProfilePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForAccessProfilePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForAccessProfilePDSAValidator.ColumnNames.DateColumnNameHere);
