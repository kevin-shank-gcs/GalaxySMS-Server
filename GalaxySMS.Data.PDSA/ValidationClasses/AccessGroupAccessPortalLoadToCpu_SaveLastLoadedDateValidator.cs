...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSA</param>
    public AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator(AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.DateColumnNameHere);
