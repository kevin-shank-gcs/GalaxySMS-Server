...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceEventPropertiesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceEventPropertiesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceEventPropertiesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceEventPropertiesPDSA</param>
    public InputDeviceEventPropertiesPDSAValidator(InputDeviceEventPropertiesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceEventPropertiesPDSAValidator";

      // Create Properties for each field in the InputDeviceEventPropertiesPDSA entity class
      InitProperties();
    ...
    public InputDeviceEventPropertiesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceEventPropertiesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceEventPropertiesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceEventPropertiesPDSAValidator.ColumnNames.DateColumnNameHere);
