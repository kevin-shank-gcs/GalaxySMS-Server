...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalTypePDSA</param>
    public AccessPortalTypePDSAValidator(AccessPortalTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalTypePDSAValidator";

      // Create Properties for each field in the AccessPortalTypePDSA entity class
      InitProperties();
    ...
    public AccessPortalTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalTypePDSAValidator.ColumnNames.DateColumnNameHere);
