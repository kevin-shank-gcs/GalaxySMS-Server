...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyCpuPDSA</param>
    public GetEntityIdForGalaxyCpuPDSAValidator(GetEntityIdForGalaxyCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyCpuPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyCpuPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyCpuPDSAValidator.ColumnNames.DateColumnNameHere);
