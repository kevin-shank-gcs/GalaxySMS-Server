...
{
  /// <summary>
  /// Used to validate business rules on the gcsPermissionTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsPermissionTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsPermissionTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsPermissionTypePDSA</param>
    public gcsPermissionTypePDSAValidator(gcsPermissionTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsPermissionTypePDSAValidator";

      // Create Properties for each field in the gcsPermissionTypePDSA entity class
      InitProperties();
    ...
    public gcsPermissionTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsPermissionTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsPermissionTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsPermissionTypePDSAValidator.ColumnNames.DateColumnNameHere);
