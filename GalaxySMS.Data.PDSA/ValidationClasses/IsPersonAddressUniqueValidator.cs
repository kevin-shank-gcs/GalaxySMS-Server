...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonAddressUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonAddressUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonAddressUniquePDSA</param>
    public IsPersonAddressUniquePDSAValidator(IsPersonAddressUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonAddressUniquePDSAValidator";

      // Create Properties for each field in the IsPersonAddressUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonAddressUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonAddressUniquePDSAValidator.ColumnNames.DateColumnNameHere);
