...
{
  /// <summary>
  /// Used to validate business rules on the DepartmentPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class DepartmentPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DepartmentPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DepartmentPDSA</param>
    public DepartmentPDSAValidator(DepartmentPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DepartmentPDSAValidator";

      // Create Properties for each field in the DepartmentPDSA entity class
      InitProperties();
    ...
    public DepartmentPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DepartmentPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DepartmentPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DepartmentPDSAValidator.ColumnNames.DateColumnNameHere);
