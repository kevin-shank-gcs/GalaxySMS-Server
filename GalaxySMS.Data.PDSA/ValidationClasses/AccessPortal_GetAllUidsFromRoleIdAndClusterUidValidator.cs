...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSA</param>
    public AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSAValidator(AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
