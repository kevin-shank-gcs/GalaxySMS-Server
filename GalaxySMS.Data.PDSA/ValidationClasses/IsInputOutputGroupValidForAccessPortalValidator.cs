...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupValidForAccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupValidForAccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupValidForAccessPortalPDSA</param>
    public IsInputOutputGroupValidForAccessPortalPDSAValidator(IsInputOutputGroupValidForAccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupValidForAccessPortalPDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupValidForAccessPortalPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupValidForAccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupValidForAccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
