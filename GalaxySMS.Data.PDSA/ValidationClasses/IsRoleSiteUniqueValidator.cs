...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleSiteUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleSiteUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleSiteUniquePDSA</param>
    public IsRoleSiteUniquePDSAValidator(IsRoleSiteUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleSiteUniquePDSAValidator";

      // Create Properties for each field in the IsRoleSiteUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleSiteUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleSiteUniquePDSAValidator.ColumnNames.DateColumnNameHere);
