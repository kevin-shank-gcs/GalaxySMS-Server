...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelNameUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelNameUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelNameUniquePDSA</param>
    public IsGalaxyPanelNameUniquePDSAValidator(IsGalaxyPanelNameUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelNameUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelNameUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelNameUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelNameUniquePDSAValidator.ColumnNames.DateColumnNameHere);
