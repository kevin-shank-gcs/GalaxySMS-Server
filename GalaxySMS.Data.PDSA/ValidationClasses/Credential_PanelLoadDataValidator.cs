...
{
  /// <summary>
  /// Used to validate business rules on the Credential_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class Credential_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_PanelLoadDataPDSA</param>
    public Credential_PanelLoadDataPDSAValidator(Credential_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the Credential_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A Credential_PanelLoadDataPDSA object</returns>
    public Credential_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your Credential_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
