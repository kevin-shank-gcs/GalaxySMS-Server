...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyInterfaceBoardSectionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyInterfaceBoardSectionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyInterfaceBoardSectionPDSA</param>
    public GetEntityIdForGalaxyInterfaceBoardSectionPDSAValidator(GetEntityIdForGalaxyInterfaceBoardSectionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyInterfaceBoardSectionPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyInterfaceBoardSectionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyInterfaceBoardSectionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyInterfaceBoardSectionPDSAValidator.ColumnNames.DateColumnNameHere);
