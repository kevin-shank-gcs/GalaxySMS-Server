...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserSessionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserSessionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserSessionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserSessionPDSA</param>
    public gcsUserSessionPDSAValidator(gcsUserSessionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserSessionPDSAValidator";

      // Create Properties for each field in the gcsUserSessionPDSA entity class
      InitProperties();
    ...
    public gcsUserSessionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserSessionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserSessionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserSessionPDSAValidator.ColumnNames.DateColumnNameHere);
