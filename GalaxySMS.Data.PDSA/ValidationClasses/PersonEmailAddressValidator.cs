...
{
  /// <summary>
  /// Used to validate business rules on the PersonEmailAddressPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonEmailAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonEmailAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonEmailAddressPDSA</param>
    public PersonEmailAddressPDSAValidator(PersonEmailAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonEmailAddressPDSAValidator";

      // Create Properties for each field in the PersonEmailAddressPDSA entity class
      InitProperties();
    ...
    public PersonEmailAddressPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonEmailAddressPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonEmailAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonEmailAddressPDSAValidator.ColumnNames.DateColumnNameHere);
