...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonPhotoPDSA_UpdateIsDefaultByPkPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPhotoPDSA_UpdateIsDefaultByPkPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPhotoPDSA_UpdateIsDefaultByPkPDSA</param>
    public PersonPhotoPDSA_UpdateIsDefaultByPkPDSAValidator(PersonPhotoPDSA_UpdateIsDefaultByPkPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPhotoPDSA_UpdateIsDefaultByPkPDSAValidator";

      // Create Properties for each field in the PersonPhotoPDSA_UpdateIsDefaultByPkPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPhotoPDSA_UpdateIsDefaultByPkPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPhotoPDSA_UpdateIsDefaultByPkPDSAValidator.ColumnNames.DateColumnNameHere);
