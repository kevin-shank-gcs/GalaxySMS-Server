...
{
  /// <summary>
  /// Used to validate business rules on the RoleClusterPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleClusterPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleClusterPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleClusterPermissionPDSA</param>
    public RoleClusterPermissionPDSAValidator(RoleClusterPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleClusterPermissionPDSAValidator";

      // Create Properties for each field in the RoleClusterPermissionPDSA entity class
      InitProperties();
    ...
    public RoleClusterPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleClusterPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleClusterPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleClusterPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
