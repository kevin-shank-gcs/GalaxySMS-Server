...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonPhotoPDSA_UpdatePublicUrlByPkPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPhotoPDSA_UpdatePublicUrlByPkPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPhotoPDSA_UpdatePublicUrlByPkPDSA</param>
    public PersonPhotoPDSA_UpdatePublicUrlByPkPDSAValidator(PersonPhotoPDSA_UpdatePublicUrlByPkPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPhotoPDSA_UpdatePublicUrlByPkPDSAValidator";

      // Create Properties for each field in the PersonPhotoPDSA_UpdatePublicUrlByPkPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPhotoPDSA_UpdatePublicUrlByPkPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPhotoPDSA_UpdatePublicUrlByPkPDSAValidator.ColumnNames.DateColumnNameHere);
