...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAutomaticForgivePassbackFrequencyUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAutomaticForgivePassbackFrequencyUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAutomaticForgivePassbackFrequencyUniquePDSA</param>
    public IsAutomaticForgivePassbackFrequencyUniquePDSAValidator(IsAutomaticForgivePassbackFrequencyUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAutomaticForgivePassbackFrequencyUniquePDSAValidator";

      // Create Properties for each field in the IsAutomaticForgivePassbackFrequencyUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAutomaticForgivePassbackFrequencyUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAutomaticForgivePassbackFrequencyUniquePDSAValidator.ColumnNames.DateColumnNameHere);
