...
{
  /// <summary>
  /// Used to validate business rules on the PropertySensitivityLevelPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PropertySensitivityLevelPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PropertySensitivityLevelPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PropertySensitivityLevelPermissionPDSA</param>
    public PropertySensitivityLevelPermissionPDSAValidator(PropertySensitivityLevelPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PropertySensitivityLevelPermissionPDSAValidator";

      // Create Properties for each field in the PropertySensitivityLevelPermissionPDSA entity class
      InitProperties();
    ...
    public PropertySensitivityLevelPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PropertySensitivityLevelPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PropertySensitivityLevelPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PropertySensitivityLevelPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
