...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroup_SelectionListForEntityAndClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_SelectionListForEntityAndClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_SelectionListForEntityAndClusterPDSA</param>
    public AccessGroup_SelectionListForEntityAndClusterPDSAValidator(AccessGroup_SelectionListForEntityAndClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_SelectionListForEntityAndClusterPDSAValidator";

      // Create Properties for each field in the AccessGroup_SelectionListForEntityAndClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.DateColumnNameHere);
