...
{
  /// <summary>
  /// Used to validate business rules on the OutputDeviceActivityEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class OutputDeviceActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDeviceActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDeviceActivityEventPDSA</param>
    public OutputDeviceActivityEventPDSAValidator(OutputDeviceActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDeviceActivityEventPDSAValidator";

      // Create Properties for each field in the OutputDeviceActivityEventPDSA entity class
      InitProperties();
    ...
    public OutputDeviceActivityEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputDeviceActivityEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDeviceActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDeviceActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
