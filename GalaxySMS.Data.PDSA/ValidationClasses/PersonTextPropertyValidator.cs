...
{
  /// <summary>
  /// Used to validate business rules on the PersonTextPropertyPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonTextPropertyPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonTextPropertyPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonTextPropertyPDSA</param>
    public PersonTextPropertyPDSAValidator(PersonTextPropertyPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonTextPropertyPDSAValidator";

      // Create Properties for each field in the PersonTextPropertyPDSA entity class
      InitProperties();
    ...
    public PersonTextPropertyPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonTextPropertyPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonTextPropertyPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonTextPropertyPDSAValidator.ColumnNames.DateColumnNameHere);
