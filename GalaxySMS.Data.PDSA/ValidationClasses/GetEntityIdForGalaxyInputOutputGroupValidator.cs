...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyInputOutputGroupPDSA</param>
    public GetEntityIdForGalaxyInputOutputGroupPDSAValidator(GetEntityIdForGalaxyInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyInputOutputGroupPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyInputOutputGroupPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
