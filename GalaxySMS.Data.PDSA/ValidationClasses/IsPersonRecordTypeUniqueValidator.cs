...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonRecordTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonRecordTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonRecordTypeUniquePDSA</param>
    public IsPersonRecordTypeUniquePDSAValidator(IsPersonRecordTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonRecordTypeUniquePDSAValidator";

      // Create Properties for each field in the IsPersonRecordTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonRecordTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonRecordTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
