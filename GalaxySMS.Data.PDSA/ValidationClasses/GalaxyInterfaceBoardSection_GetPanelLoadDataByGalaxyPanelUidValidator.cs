...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSA</param>
    public GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSAValidator(GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.DateColumnNameHere);
