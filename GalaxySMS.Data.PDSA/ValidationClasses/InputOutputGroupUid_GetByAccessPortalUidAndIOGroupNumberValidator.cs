...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSA</param>
    public InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSAValidator(InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSAValidator";

      // Create Properties for each field in the InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupUid_GetByAccessPortalUidAndIOGroupNumberPDSAValidator.ColumnNames.DateColumnNameHere);
