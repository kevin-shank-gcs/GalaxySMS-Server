...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyClusterPanelCpuInformationPDSA class.
  ...
  /// </summary>
  public partial class GalaxyClusterPanelCpuInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyClusterPanelCpuInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyClusterPanelCpuInformationPDSA</param>
    public GalaxyClusterPanelCpuInformationPDSAValidator(GalaxyClusterPanelCpuInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyClusterPanelCpuInformationPDSAValidator";

      // Create Properties for each field in the GalaxyClusterPanelCpuInformationPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A GalaxyClusterPanelCpuInformationPDSA object</returns>
    public GalaxyClusterPanelCpuInformationPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyClusterPanelCpuInformationPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyClusterPanelCpuInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyClusterPanelCpuInformationPDSAValidator.ColumnNames.DateColumnNameHere);
