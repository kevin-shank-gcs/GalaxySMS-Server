...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_GetRowCountFromTableByNVarCharColumnValuePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_GetRowCountFromTableByNVarCharColumnValuePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_GetRowCountFromTableByNVarCharColumnValuePDSA</param>
    public gcs_GetRowCountFromTableByNVarCharColumnValuePDSAValidator(gcs_GetRowCountFromTableByNVarCharColumnValuePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_GetRowCountFromTableByNVarCharColumnValuePDSAValidator";

      // Create Properties for each field in the gcs_GetRowCountFromTableByNVarCharColumnValuePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_GetRowCountFromTableByNVarCharColumnValuePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_GetRowCountFromTableByNVarCharColumnValuePDSAValidator.ColumnNames.DateColumnNameHere);
