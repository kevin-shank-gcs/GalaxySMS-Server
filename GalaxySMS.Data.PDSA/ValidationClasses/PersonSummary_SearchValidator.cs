...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonSummary_SearchPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonSummary_SearchPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonSummary_SearchPDSA</param>
    public PersonSummary_SearchPDSAValidator(PersonSummary_SearchPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonSummary_SearchPDSAValidator";

      // Create Properties for each field in the PersonSummary_SearchPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonSummary_SearchPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonSummary_SearchPDSAValidator.ColumnNames.DateColumnNameHere);
