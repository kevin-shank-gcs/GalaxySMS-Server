...
{
  /// <summary>
  /// Used to validate business rules on the InterfaceBoardSectionModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InterfaceBoardSectionModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InterfaceBoardSectionModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InterfaceBoardSectionModePDSA</param>
    public InterfaceBoardSectionModePDSAValidator(InterfaceBoardSectionModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InterfaceBoardSectionModePDSAValidator";

      // Create Properties for each field in the InterfaceBoardSectionModePDSA entity class
      InitProperties();
    ...
    public InterfaceBoardSectionModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InterfaceBoardSectionModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InterfaceBoardSectionModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InterfaceBoardSectionModePDSAValidator.ColumnNames.DateColumnNameHere);
