...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetGalaxyPanelUidForAccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetGalaxyPanelUidForAccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetGalaxyPanelUidForAccessPortalPDSA</param>
    public GetGalaxyPanelUidForAccessPortalPDSAValidator(GetGalaxyPanelUidForAccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetGalaxyPanelUidForAccessPortalPDSAValidator";

      // Create Properties for each field in the GetGalaxyPanelUidForAccessPortalPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetGalaxyPanelUidForAccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetGalaxyPanelUidForAccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
