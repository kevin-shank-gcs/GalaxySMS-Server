...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterUid_GetByInputDeviceUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterUid_GetByInputDeviceUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterUid_GetByInputDeviceUidPDSA</param>
    public ClusterUid_GetByInputDeviceUidPDSAValidator(ClusterUid_GetByInputDeviceUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterUid_GetByInputDeviceUidPDSAValidator";

      // Create Properties for each field in the ClusterUid_GetByInputDeviceUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterUid_GetByInputDeviceUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterUid_GetByInputDeviceUidPDSAValidator.ColumnNames.DateColumnNameHere);
