...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonEntityMapUniquePDSA</param>
    public IsPersonEntityMapUniquePDSAValidator(IsPersonEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsPersonEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
