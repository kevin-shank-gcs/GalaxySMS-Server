...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAreaTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAreaTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAreaTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAreaTypePDSA</param>
    public AccessPortalAreaTypePDSAValidator(AccessPortalAreaTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAreaTypePDSAValidator";

      // Create Properties for each field in the AccessPortalAreaTypePDSA entity class
      InitProperties();
    ...
    public AccessPortalAreaTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAreaTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAreaTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAreaTypePDSAValidator.ColumnNames.DateColumnNameHere);
