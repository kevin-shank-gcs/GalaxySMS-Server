...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyCpuModelUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyCpuModelUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyCpuModelUniquePDSA</param>
    public IsGalaxyCpuModelUniquePDSAValidator(IsGalaxyCpuModelUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyCpuModelUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyCpuModelUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyCpuModelUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyCpuModelUniquePDSAValidator.ColumnNames.DateColumnNameHere);
