...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ResetConcurrencyValuePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ResetConcurrencyValuePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ResetConcurrencyValuePDSA</param>
    public ResetConcurrencyValuePDSAValidator(ResetConcurrencyValuePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ResetConcurrencyValuePDSAValidator";

      // Create Properties for each field in the ResetConcurrencyValuePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ResetConcurrencyValuePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ResetConcurrencyValuePDSAValidator.ColumnNames.DateColumnNameHere);
