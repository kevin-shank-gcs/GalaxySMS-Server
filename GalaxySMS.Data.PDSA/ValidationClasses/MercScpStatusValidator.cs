...
{
  /// <summary>
  /// Used to validate business rules on the MercScpStatusPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class MercScpStatusPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpStatusPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpStatusPDSA</param>
    public MercScpStatusPDSAValidator(MercScpStatusPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpStatusPDSAValidator";

      // Create Properties for each field in the MercScpStatusPDSA entity class
      InitProperties();
    ...
    public MercScpStatusPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your MercScpStatusPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpStatusPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpStatusPDSAValidator.ColumnNames.DateColumnNameHere);
