...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercScpNameUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercScpNameUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercScpNameUniquePDSA</param>
    public IsMercScpNameUniquePDSAValidator(IsMercScpNameUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercScpNameUniquePDSAValidator";

      // Create Properties for each field in the IsMercScpNameUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercScpNameUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercScpNameUniquePDSAValidator.ColumnNames.DateColumnNameHere);
