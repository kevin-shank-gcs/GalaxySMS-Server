...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetPersonIdForPersonPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetPersonIdForPersonPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetPersonIdForPersonPDSA</param>
    public GetPersonIdForPersonPDSAValidator(GetPersonIdForPersonPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetPersonIdForPersonPDSAValidator";

      // Create Properties for each field in the GetPersonIdForPersonPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetPersonIdForPersonPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetPersonIdForPersonPDSAValidator.ColumnNames.DateColumnNameHere);
