...
{
  /// <summary>
  /// Used to validate business rules on the AccessGroupLoadToCpuPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessGroupLoadToCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupLoadToCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupLoadToCpuPDSA</param>
    public AccessGroupLoadToCpuPDSAValidator(AccessGroupLoadToCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupLoadToCpuPDSAValidator";

      // Create Properties for each field in the AccessGroupLoadToCpuPDSA entity class
      InitProperties();
    ...
    public AccessGroupLoadToCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessGroupLoadToCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupLoadToCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupLoadToCpuPDSAValidator.ColumnNames.DateColumnNameHere);
