...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedNumberPropertyRulesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedNumberPropertyRulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedNumberPropertyRulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedNumberPropertyRulesPDSA</param>
    public UserDefinedNumberPropertyRulesPDSAValidator(UserDefinedNumberPropertyRulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedNumberPropertyRulesPDSAValidator";

      // Create Properties for each field in the UserDefinedNumberPropertyRulesPDSA entity class
      InitProperties();
    ...
    public UserDefinedNumberPropertyRulesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedNumberPropertyRulesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedNumberPropertyRulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedNumberPropertyRulesPDSAValidator.ColumnNames.DateColumnNameHere);
