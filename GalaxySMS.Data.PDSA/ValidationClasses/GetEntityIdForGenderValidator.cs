...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGenderPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGenderPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGenderPDSA</param>
    public GetEntityIdForGenderPDSAValidator(GetEntityIdForGenderPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGenderPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGenderPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGenderPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGenderPDSAValidator.ColumnNames.DateColumnNameHere);
