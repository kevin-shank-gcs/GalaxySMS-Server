...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelAlarmEventAcknowledgmentPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelAlarmEventAcknowledgmentPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelAlarmEventAcknowledgmentPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelAlarmEventAcknowledgmentPDSA</param>
    public GalaxyPanelAlarmEventAcknowledgmentPDSAValidator(GalaxyPanelAlarmEventAcknowledgmentPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelAlarmEventAcknowledgmentPDSAValidator";

      // Create Properties for each field in the GalaxyPanelAlarmEventAcknowledgmentPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelAlarmEventAcknowledgmentPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelAlarmEventAcknowledgmentPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelAlarmEventAcknowledgmentPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelAlarmEventAcknowledgmentPDSAValidator.ColumnNames.DateColumnNameHere);
