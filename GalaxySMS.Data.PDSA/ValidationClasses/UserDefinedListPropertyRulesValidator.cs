...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedListPropertyRulesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedListPropertyRulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedListPropertyRulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedListPropertyRulesPDSA</param>
    public UserDefinedListPropertyRulesPDSAValidator(UserDefinedListPropertyRulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedListPropertyRulesPDSAValidator";

      // Create Properties for each field in the UserDefinedListPropertyRulesPDSA entity class
      InitProperties();
    ...
    public UserDefinedListPropertyRulesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedListPropertyRulesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedListPropertyRulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedListPropertyRulesPDSAValidator.ColumnNames.DateColumnNameHere);
