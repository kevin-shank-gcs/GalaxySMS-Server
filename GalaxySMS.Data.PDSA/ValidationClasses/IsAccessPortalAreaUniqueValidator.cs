...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalAreaUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalAreaUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalAreaUniquePDSA</param>
    public IsAccessPortalAreaUniquePDSAValidator(IsAccessPortalAreaUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalAreaUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalAreaUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalAreaUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalAreaUniquePDSAValidator.ColumnNames.DateColumnNameHere);
