...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetLoadDataCountsForGalaxyPanelUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetLoadDataCountsForGalaxyPanelUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetLoadDataCountsForGalaxyPanelUidPDSA</param>
    public GetLoadDataCountsForGalaxyPanelUidPDSAValidator(GetLoadDataCountsForGalaxyPanelUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetLoadDataCountsForGalaxyPanelUidPDSAValidator";

      // Create Properties for each field in the GetLoadDataCountsForGalaxyPanelUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetLoadDataCountsForGalaxyPanelUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetLoadDataCountsForGalaxyPanelUidPDSAValidator.ColumnNames.DateColumnNameHere);
