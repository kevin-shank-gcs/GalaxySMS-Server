...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class usp_SaveApplicationAuditTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the usp_SaveApplicationAuditTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a usp_SaveApplicationAuditTypePDSA</param>
    public usp_SaveApplicationAuditTypePDSAValidator(usp_SaveApplicationAuditTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "usp_SaveApplicationAuditTypePDSAValidator";

      // Create Properties for each field in the usp_SaveApplicationAuditTypePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(usp_SaveApplicationAuditTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(usp_SaveApplicationAuditTypePDSAValidator.ColumnNames.DateColumnNameHere);
