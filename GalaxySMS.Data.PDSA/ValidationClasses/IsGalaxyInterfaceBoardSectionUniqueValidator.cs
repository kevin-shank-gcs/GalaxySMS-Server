...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInterfaceBoardSectionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInterfaceBoardSectionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInterfaceBoardSectionUniquePDSA</param>
    public IsGalaxyInterfaceBoardSectionUniquePDSAValidator(IsGalaxyInterfaceBoardSectionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInterfaceBoardSectionUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInterfaceBoardSectionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
