...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsEntityApplicationRoleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsEntityApplicationRoleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsEntityApplicationRoleUniquePDSA</param>
    public gcs_IsEntityApplicationRoleUniquePDSAValidator(gcs_IsEntityApplicationRoleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsEntityApplicationRoleUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsEntityApplicationRoleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsEntityApplicationRoleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsEntityApplicationRoleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
