...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetPermissionsForUserEntityPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetPermissionsForUserEntityPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetPermissionsForUserEntityPDSA</param>
    public GetPermissionsForUserEntityPDSAValidator(GetPermissionsForUserEntityPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetPermissionsForUserEntityPDSAValidator";

      // Create Properties for each field in the GetPermissionsForUserEntityPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetPermissionsForUserEntityPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetPermissionsForUserEntityPDSAValidator.ColumnNames.DateColumnNameHere);
