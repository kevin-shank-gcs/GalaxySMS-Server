...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA</param>
    public InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.DateColumnNameHere);
