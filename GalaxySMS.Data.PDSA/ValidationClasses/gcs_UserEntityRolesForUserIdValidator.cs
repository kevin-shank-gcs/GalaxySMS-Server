...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_UserEntityRolesForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_UserEntityRolesForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_UserEntityRolesForUserIdPDSA</param>
    public gcs_UserEntityRolesForUserIdPDSAValidator(gcs_UserEntityRolesForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_UserEntityRolesForUserIdPDSAValidator";

      // Create Properties for each field in the gcs_UserEntityRolesForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_UserEntityRolesForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_UserEntityRolesForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
