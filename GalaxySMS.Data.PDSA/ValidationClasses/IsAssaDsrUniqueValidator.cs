...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaDsrUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaDsrUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaDsrUniquePDSA</param>
    public IsAssaDsrUniquePDSAValidator(IsAssaDsrUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaDsrUniquePDSAValidator";

      // Create Properties for each field in the IsAssaDsrUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaDsrUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaDsrUniquePDSAValidator.ColumnNames.DateColumnNameHere);
