...
{
  /// <summary>
  /// Used to validate business rules on the AreaEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AreaEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AreaEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AreaEntityMapPDSA</param>
    public AreaEntityMapPDSAValidator(AreaEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AreaEntityMapPDSAValidator";

      // Create Properties for each field in the AreaEntityMapPDSA entity class
      InitProperties();
    ...
    public AreaEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AreaEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AreaEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AreaEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
