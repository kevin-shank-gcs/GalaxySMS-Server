...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSA</param>
    public DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSAValidator(DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSAValidator";

      // Create Properties for each field in the DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DoEntityIdsMatch_ClusterUidInputOutputGroupUidPDSAValidator.ColumnNames.DateColumnNameHere);
