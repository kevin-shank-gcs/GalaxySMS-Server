...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalCommandChoicePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalCommandChoicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalCommandChoicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalCommandChoicePDSA</param>
    public AccessPortalCommandChoicePDSAValidator(AccessPortalCommandChoicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalCommandChoicePDSAValidator";

      // Create Properties for each field in the AccessPortalCommandChoicePDSA entity class
      InitProperties();
    ...
    public AccessPortalCommandChoicePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalCommandChoicePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalCommandChoicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalCommandChoicePDSAValidator.ColumnNames.DateColumnNameHere);
