...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroup_GetPanelLoadDataChangesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_GetPanelLoadDataChangesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_GetPanelLoadDataChangesPDSA</param>
    public AccessGroup_GetPanelLoadDataChangesPDSAValidator(AccessGroup_GetPanelLoadDataChangesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_GetPanelLoadDataChangesPDSAValidator";

      // Create Properties for each field in the AccessGroup_GetPanelLoadDataChangesPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataChangesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_GetPanelLoadDataChangesPDSAValidator.ColumnNames.DateColumnNameHere);
