...
{
  /// <summary>
  /// Used to validate business rules on the AssaDayPeriodPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaDayPeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaDayPeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaDayPeriodPDSA</param>
    public AssaDayPeriodPDSAValidator(AssaDayPeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaDayPeriodPDSAValidator";

      // Create Properties for each field in the AssaDayPeriodPDSA entity class
      InitProperties();
    ...
    public AssaDayPeriodPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaDayPeriodPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaDayPeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaDayPeriodPDSAValidator.ColumnNames.DateColumnNameHere);
