...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceActivityEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceActivityEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceActivityEventUniquePDSA</param>
    public IsInputDeviceActivityEventUniquePDSAValidator(IsInputDeviceActivityEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceActivityEventUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceActivityEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceActivityEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceActivityEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
