...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialSoftwareHouse37BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialSoftwareHouse37BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialSoftwareHouse37BitUniquePDSA</param>
    public IsCredentialSoftwareHouse37BitUniquePDSAValidator(IsCredentialSoftwareHouse37BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialSoftwareHouse37BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialSoftwareHouse37BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialSoftwareHouse37BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialSoftwareHouse37BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
