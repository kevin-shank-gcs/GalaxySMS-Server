...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsOutputDeviceEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsOutputDeviceEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsOutputDeviceEntityMapUniquePDSA</param>
    public IsOutputDeviceEntityMapUniquePDSAValidator(IsOutputDeviceEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsOutputDeviceEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsOutputDeviceEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsOutputDeviceEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsOutputDeviceEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
