...
{
  /// <summary>
  /// Used to validate business rules on the ClusterCommandAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterCommandAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterCommandAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterCommandAuditPDSA</param>
    public ClusterCommandAuditPDSAValidator(ClusterCommandAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterCommandAuditPDSAValidator";

      // Create Properties for each field in the ClusterCommandAuditPDSA entity class
      InitProperties();
    ...
    public ClusterCommandAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterCommandAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterCommandAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterCommandAuditPDSAValidator.ColumnNames.DateColumnNameHere);
