...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyOutputInputSourceTriggerConditionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyOutputInputSourceTriggerConditionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyOutputInputSourceTriggerConditionUniquePDSA</param>
    public IsGalaxyOutputInputSourceTriggerConditionUniquePDSAValidator(IsGalaxyOutputInputSourceTriggerConditionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyOutputInputSourceTriggerConditionUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyOutputInputSourceTriggerConditionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyOutputInputSourceTriggerConditionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyOutputInputSourceTriggerConditionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
