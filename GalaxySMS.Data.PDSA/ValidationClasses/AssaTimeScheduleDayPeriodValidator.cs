...
{
  /// <summary>
  /// Used to validate business rules on the AssaTimeScheduleDayPeriodPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaTimeScheduleDayPeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaTimeScheduleDayPeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaTimeScheduleDayPeriodPDSA</param>
    public AssaTimeScheduleDayPeriodPDSAValidator(AssaTimeScheduleDayPeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaTimeScheduleDayPeriodPDSAValidator";

      // Create Properties for each field in the AssaTimeScheduleDayPeriodPDSA entity class
      InitProperties();
    ...
    public AssaTimeScheduleDayPeriodPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaTimeScheduleDayPeriodPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaTimeScheduleDayPeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaTimeScheduleDayPeriodPDSAValidator.ColumnNames.DateColumnNameHere);
