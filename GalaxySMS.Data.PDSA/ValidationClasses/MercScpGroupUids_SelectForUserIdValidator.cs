...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class MercScpGroupUids_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpGroupUids_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpGroupUids_SelectForUserIdPDSA</param>
    public MercScpGroupUids_SelectForUserIdPDSAValidator(MercScpGroupUids_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpGroupUids_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the MercScpGroupUids_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpGroupUids_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpGroupUids_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
