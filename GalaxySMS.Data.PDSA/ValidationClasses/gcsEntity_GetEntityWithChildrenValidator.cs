...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntity_GetEntityWithChildrenPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntity_GetEntityWithChildrenPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntity_GetEntityWithChildrenPDSA</param>
    public gcsEntity_GetEntityWithChildrenPDSAValidator(gcsEntity_GetEntityWithChildrenPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntity_GetEntityWithChildrenPDSAValidator";

      // Create Properties for each field in the gcsEntity_GetEntityWithChildrenPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntity_GetEntityWithChildrenPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntity_GetEntityWithChildrenPDSAValidator.ColumnNames.DateColumnNameHere);
