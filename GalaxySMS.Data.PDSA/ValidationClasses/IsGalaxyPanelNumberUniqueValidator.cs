...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelNumberUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelNumberUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelNumberUniquePDSA</param>
    public IsGalaxyPanelNumberUniquePDSAValidator(IsGalaxyPanelNumberUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelNumberUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelNumberUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelNumberUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelNumberUniquePDSAValidator.ColumnNames.DateColumnNameHere);
