...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForBadgeTemplatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForBadgeTemplatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForBadgeTemplatePDSA</param>
    public GetEntityIdForBadgeTemplatePDSAValidator(GetEntityIdForBadgeTemplatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForBadgeTemplatePDSAValidator";

      // Create Properties for each field in the GetEntityIdForBadgeTemplatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForBadgeTemplatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForBadgeTemplatePDSAValidator.ColumnNames.DateColumnNameHere);
