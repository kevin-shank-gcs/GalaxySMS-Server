...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DeviceAlertEventSettings_ByEntityIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DeviceAlertEventSettings_ByEntityIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DeviceAlertEventSettings_ByEntityIdPDSA</param>
    public DeviceAlertEventSettings_ByEntityIdPDSAValidator(DeviceAlertEventSettings_ByEntityIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DeviceAlertEventSettings_ByEntityIdPDSAValidator";

      // Create Properties for each field in the DeviceAlertEventSettings_ByEntityIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DeviceAlertEventSettings_ByEntityIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DeviceAlertEventSettings_ByEntityIdPDSAValidator.ColumnNames.DateColumnNameHere);
