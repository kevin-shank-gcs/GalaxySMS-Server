...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSA</param>
    public MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSAValidator(MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSAValidator";

      // Create Properties for each field in the MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpGroup_GetAllUidsFromRoleIdAndSiteUidPDSAValidator.ColumnNames.DateColumnNameHere);
