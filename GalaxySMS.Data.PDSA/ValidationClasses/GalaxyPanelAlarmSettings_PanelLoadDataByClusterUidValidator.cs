...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSA</param>
    public GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSAValidator(GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
