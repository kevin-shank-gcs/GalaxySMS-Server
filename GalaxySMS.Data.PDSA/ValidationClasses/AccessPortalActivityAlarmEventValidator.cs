...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalActivityAlarmEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalActivityAlarmEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalActivityAlarmEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalActivityAlarmEventPDSA</param>
    public AccessPortalActivityAlarmEventPDSAValidator(AccessPortalActivityAlarmEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalActivityAlarmEventPDSAValidator";

      // Create Properties for each field in the AccessPortalActivityAlarmEventPDSA entity class
      InitProperties();
    ...
    public AccessPortalActivityAlarmEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalActivityAlarmEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalActivityAlarmEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalActivityAlarmEventPDSAValidator.ColumnNames.DateColumnNameHere);
