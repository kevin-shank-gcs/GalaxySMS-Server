...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelConnectedPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelConnectedPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelConnectedPDSA</param>
    public IsGalaxyPanelConnectedPDSAValidator(IsGalaxyPanelConnectedPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelConnectedPDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelConnectedPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelConnectedPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelConnectedPDSAValidator.ColumnNames.DateColumnNameHere);
