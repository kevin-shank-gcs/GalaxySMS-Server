...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA</param>
    public AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ColumnNames.DateColumnNameHere);
