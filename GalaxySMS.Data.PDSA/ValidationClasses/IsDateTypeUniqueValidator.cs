...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsDateTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsDateTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsDateTypeUniquePDSA</param>
    public IsDateTypeUniquePDSAValidator(IsDateTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsDateTypeUniquePDSAValidator";

      // Create Properties for each field in the IsDateTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsDateTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsDateTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
