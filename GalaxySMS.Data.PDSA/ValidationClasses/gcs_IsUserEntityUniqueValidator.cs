...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserEntityUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserEntityUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserEntityUniquePDSA</param>
    public gcs_IsUserEntityUniquePDSAValidator(gcs_IsUserEntityUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserEntityUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsUserEntityUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserEntityUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserEntityUniquePDSAValidator.ColumnNames.DateColumnNameHere);
