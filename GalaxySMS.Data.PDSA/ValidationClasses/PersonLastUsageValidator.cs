...
{
  /// <summary>
  /// Used to validate business rules on the PersonLastUsagePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonLastUsagePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonLastUsagePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonLastUsagePDSA</param>
    public PersonLastUsagePDSAValidator(PersonLastUsagePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonLastUsagePDSAValidator";

      // Create Properties for each field in the PersonLastUsagePDSA entity class
      InitProperties();
    ...
    public PersonLastUsagePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonLastUsagePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonLastUsagePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonLastUsagePDSAValidator.ColumnNames.DateColumnNameHere);
