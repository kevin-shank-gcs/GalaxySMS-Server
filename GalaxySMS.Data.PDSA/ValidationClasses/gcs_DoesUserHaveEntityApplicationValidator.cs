...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_DoesUserHaveEntityApplicationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_DoesUserHaveEntityApplicationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_DoesUserHaveEntityApplicationPDSA</param>
    public gcs_DoesUserHaveEntityApplicationPDSAValidator(gcs_DoesUserHaveEntityApplicationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_DoesUserHaveEntityApplicationPDSAValidator";

      // Create Properties for each field in the gcs_DoesUserHaveEntityApplicationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_DoesUserHaveEntityApplicationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_DoesUserHaveEntityApplicationPDSAValidator.ColumnNames.DateColumnNameHere);
