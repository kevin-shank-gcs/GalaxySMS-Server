...
{
  /// <summary>
  /// Used to validate business rules on the RegionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RegionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RegionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RegionPDSA</param>
    public RegionPDSAValidator(RegionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RegionPDSAValidator";

      // Create Properties for each field in the RegionPDSA entity class
      InitProperties();
    ...
    public RegionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RegionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RegionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RegionPDSAValidator.ColumnNames.DateColumnNameHere);
