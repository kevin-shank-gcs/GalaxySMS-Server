...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class CredentialToDeleteFromCpu_CreatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToDeleteFromCpu_CreatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToDeleteFromCpu_CreatePDSA</param>
    public CredentialToDeleteFromCpu_CreatePDSAValidator(CredentialToDeleteFromCpu_CreatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToDeleteFromCpu_CreatePDSAValidator";

      // Create Properties for each field in the CredentialToDeleteFromCpu_CreatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToDeleteFromCpu_CreatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToDeleteFromCpu_CreatePDSAValidator.ColumnNames.DateColumnNameHere);
