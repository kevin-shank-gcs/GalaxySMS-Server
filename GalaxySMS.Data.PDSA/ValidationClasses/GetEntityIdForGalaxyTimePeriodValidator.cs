...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForGalaxyTimePeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForGalaxyTimePeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForGalaxyTimePeriodPDSA</param>
    public GetEntityIdForGalaxyTimePeriodPDSAValidator(GetEntityIdForGalaxyTimePeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForGalaxyTimePeriodPDSAValidator";

      // Create Properties for each field in the GetEntityIdForGalaxyTimePeriodPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForGalaxyTimePeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForGalaxyTimePeriodPDSAValidator.ColumnNames.DateColumnNameHere);
