...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class insert_GalaxyRawActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the insert_GalaxyRawActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a insert_GalaxyRawActivityEventPDSA</param>
    public insert_GalaxyRawActivityEventPDSAValidator(insert_GalaxyRawActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "insert_GalaxyRawActivityEventPDSAValidator";

      // Create Properties for each field in the insert_GalaxyRawActivityEventPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(insert_GalaxyRawActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(insert_GalaxyRawActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
