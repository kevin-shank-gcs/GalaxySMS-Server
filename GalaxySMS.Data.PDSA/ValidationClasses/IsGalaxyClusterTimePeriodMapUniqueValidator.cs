...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyClusterTimePeriodMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyClusterTimePeriodMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyClusterTimePeriodMapUniquePDSA</param>
    public IsGalaxyClusterTimePeriodMapUniquePDSAValidator(IsGalaxyClusterTimePeriodMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyClusterTimePeriodMapUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyClusterTimePeriodMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyClusterTimePeriodMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyClusterTimePeriodMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
