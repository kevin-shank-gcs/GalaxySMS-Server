...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetHardwareInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetHardwareInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetHardwareInformationPDSA</param>
    public AccessPortal_GetHardwareInformationPDSAValidator(AccessPortal_GetHardwareInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetHardwareInformationPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetHardwareInformationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetHardwareInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetHardwareInformationPDSAValidator.ColumnNames.DateColumnNameHere);
