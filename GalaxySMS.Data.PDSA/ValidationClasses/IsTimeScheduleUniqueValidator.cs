...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimeScheduleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimeScheduleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimeScheduleUniquePDSA</param>
    public IsTimeScheduleUniquePDSAValidator(IsTimeScheduleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimeScheduleUniquePDSAValidator";

      // Create Properties for each field in the IsTimeScheduleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimeScheduleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimeScheduleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
