...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterPDSA_ByClusterNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterPDSA_ByClusterNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterPDSA_ByClusterNumberPDSA</param>
    public ClusterPDSA_ByClusterNumberPDSAValidator(ClusterPDSA_ByClusterNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterPDSA_ByClusterNumberPDSAValidator";

      // Create Properties for each field in the ClusterPDSA_ByClusterNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterPDSA_ByClusterNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterPDSA_ByClusterNumberPDSAValidator.ColumnNames.DateColumnNameHere);
