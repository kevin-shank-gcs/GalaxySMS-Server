...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetAreaUidsForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetAreaUidsForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetAreaUidsForClusterPDSA</param>
    public GetAreaUidsForClusterPDSAValidator(GetAreaUidsForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetAreaUidsForClusterPDSAValidator";

      // Create Properties for each field in the GetAreaUidsForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetAreaUidsForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetAreaUidsForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
