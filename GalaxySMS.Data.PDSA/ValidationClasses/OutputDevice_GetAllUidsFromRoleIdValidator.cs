...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetAllUidsFromRoleIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetAllUidsFromRoleIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetAllUidsFromRoleIdPDSA</param>
    public OutputDevice_GetAllUidsFromRoleIdPDSAValidator(OutputDevice_GetAllUidsFromRoleIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetAllUidsFromRoleIdPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetAllUidsFromRoleIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.DateColumnNameHere);
