...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsDepartmentUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsDepartmentUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsDepartmentUniquePDSA</param>
    public IsDepartmentUniquePDSAValidator(IsDepartmentUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsDepartmentUniquePDSAValidator";

      // Create Properties for each field in the IsDepartmentUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsDepartmentUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsDepartmentUniquePDSAValidator.ColumnNames.DateColumnNameHere);
