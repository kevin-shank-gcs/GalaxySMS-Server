...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInputArmingInputOutputGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInputArmingInputOutputGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInputArmingInputOutputGroupUniquePDSA</param>
    public IsGalaxyInputArmingInputOutputGroupUniquePDSAValidator(IsGalaxyInputArmingInputOutputGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInputArmingInputOutputGroupUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInputArmingInputOutputGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInputArmingInputOutputGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInputArmingInputOutputGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
