...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonPropertyBagUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonPropertyBagUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonPropertyBagUniquePDSA</param>
    public IsPersonPropertyBagUniquePDSAValidator(IsPersonPropertyBagUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonPropertyBagUniquePDSAValidator";

      // Create Properties for each field in the IsPersonPropertyBagUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonPropertyBagUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonPropertyBagUniquePDSAValidator.ColumnNames.DateColumnNameHere);
