...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class MercScpGroup_GetUserPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpGroup_GetUserPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpGroup_GetUserPermissionPDSA</param>
    public MercScpGroup_GetUserPermissionPDSAValidator(MercScpGroup_GetUserPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpGroup_GetUserPermissionPDSAValidator";

      // Create Properties for each field in the MercScpGroup_GetUserPermissionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpGroup_GetUserPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpGroup_GetUserPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
