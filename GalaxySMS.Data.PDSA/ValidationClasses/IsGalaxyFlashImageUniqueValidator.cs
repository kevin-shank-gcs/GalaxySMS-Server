...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyFlashImageUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyFlashImageUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyFlashImageUniquePDSA</param>
    public IsGalaxyFlashImageUniquePDSAValidator(IsGalaxyFlashImageUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyFlashImageUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyFlashImageUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyFlashImageUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyFlashImageUniquePDSAValidator.ColumnNames.DateColumnNameHere);
