...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalTimeScheduleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalTimeScheduleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalTimeScheduleUniquePDSA</param>
    public IsAccessPortalTimeScheduleUniquePDSAValidator(IsAccessPortalTimeScheduleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalTimeScheduleUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalTimeScheduleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalTimeScheduleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalTimeScheduleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
