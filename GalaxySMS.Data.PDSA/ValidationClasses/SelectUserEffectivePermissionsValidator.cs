...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class SelectUserEffectivePermissionsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the SelectUserEffectivePermissionsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a SelectUserEffectivePermissionsPDSA</param>
    public SelectUserEffectivePermissionsPDSAValidator(SelectUserEffectivePermissionsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "SelectUserEffectivePermissionsPDSAValidator";

      // Create Properties for each field in the SelectUserEffectivePermissionsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(SelectUserEffectivePermissionsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(SelectUserEffectivePermissionsPDSAValidator.ColumnNames.DateColumnNameHere);
