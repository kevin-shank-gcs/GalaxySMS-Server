...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA</param>
    public AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator(AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.DateColumnNameHere);
