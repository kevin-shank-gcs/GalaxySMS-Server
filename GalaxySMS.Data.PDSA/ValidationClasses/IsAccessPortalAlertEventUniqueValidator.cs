...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalAlertEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalAlertEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalAlertEventUniquePDSA</param>
    public IsAccessPortalAlertEventUniquePDSAValidator(IsAccessPortalAlertEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalAlertEventUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalAlertEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalAlertEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalAlertEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
