...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyCpuPDSA_InsertPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuPDSA_InsertPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuPDSA_InsertPDSA</param>
    public GalaxyCpuPDSA_InsertPDSAValidator(GalaxyCpuPDSA_InsertPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuPDSA_InsertPDSAValidator";

      // Create Properties for each field in the GalaxyCpuPDSA_InsertPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuPDSA_InsertPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuPDSA_InsertPDSAValidator.ColumnNames.DateColumnNameHere);
