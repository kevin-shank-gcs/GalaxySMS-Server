...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DoesMercScpMacAddressExistPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DoesMercScpMacAddressExistPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DoesMercScpMacAddressExistPDSA</param>
    public DoesMercScpMacAddressExistPDSAValidator(DoesMercScpMacAddressExistPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DoesMercScpMacAddressExistPDSAValidator";

      // Create Properties for each field in the DoesMercScpMacAddressExistPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DoesMercScpMacAddressExistPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DoesMercScpMacAddressExistPDSAValidator.ColumnNames.DateColumnNameHere);
