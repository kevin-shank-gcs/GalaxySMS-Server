...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_ForeignKeyReferencedCountGuidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_ForeignKeyReferencedCountGuidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_ForeignKeyReferencedCountGuidPDSA</param>
    public gcs_ForeignKeyReferencedCountGuidPDSAValidator(gcs_ForeignKeyReferencedCountGuidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_ForeignKeyReferencedCountGuidPDSAValidator";

      // Create Properties for each field in the gcs_ForeignKeyReferencedCountGuidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_ForeignKeyReferencedCountGuidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_ForeignKeyReferencedCountGuidPDSAValidator.ColumnNames.DateColumnNameHere);
