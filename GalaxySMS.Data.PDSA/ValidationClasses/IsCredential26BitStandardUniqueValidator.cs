...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredential26BitStandardUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredential26BitStandardUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredential26BitStandardUniquePDSA</param>
    public IsCredential26BitStandardUniquePDSAValidator(IsCredential26BitStandardUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredential26BitStandardUniquePDSAValidator";

      // Create Properties for each field in the IsCredential26BitStandardUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredential26BitStandardUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredential26BitStandardUniquePDSAValidator.ColumnNames.DateColumnNameHere);
