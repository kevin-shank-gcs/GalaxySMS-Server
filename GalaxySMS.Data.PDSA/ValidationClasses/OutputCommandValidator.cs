...
{
  /// <summary>
  /// Used to validate business rules on the OutputCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class OutputCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputCommandPDSA</param>
    public OutputCommandPDSAValidator(OutputCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputCommandPDSAValidator";

      // Create Properties for each field in the OutputCommandPDSA entity class
      InitProperties();
    ...
    public OutputCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputCommandPDSAValidator.ColumnNames.DateColumnNameHere);
