...
{
  /// <summary>
  /// Used to validate business rules on the PersonExpirationModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonExpirationModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonExpirationModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonExpirationModePDSA</param>
    public PersonExpirationModePDSAValidator(PersonExpirationModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonExpirationModePDSAValidator";

      // Create Properties for each field in the PersonExpirationModePDSA entity class
      InitProperties();
    ...
    public PersonExpirationModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonExpirationModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonExpirationModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonExpirationModePDSAValidator.ColumnNames.DateColumnNameHere);
