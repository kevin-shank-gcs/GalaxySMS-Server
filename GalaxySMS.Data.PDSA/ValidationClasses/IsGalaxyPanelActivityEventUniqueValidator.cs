...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelActivityEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelActivityEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelActivityEventUniquePDSA</param>
    public IsGalaxyPanelActivityEventUniquePDSAValidator(IsGalaxyPanelActivityEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelActivityEventUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelActivityEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelActivityEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelActivityEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
