...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSA</param>
    public InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSAValidator(InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSAValidator";

      // Create Properties for each field in the InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroup_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
