...
{
  /// <summary>
  /// Used to validate business rules on the gcsEntityIdProducerPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsEntityIdProducerPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityIdProducerPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityIdProducerPDSA</param>
    public gcsEntityIdProducerPDSAValidator(gcsEntityIdProducerPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityIdProducerPDSAValidator";

      // Create Properties for each field in the gcsEntityIdProducerPDSA entity class
      InitProperties();
    ...
    public gcsEntityIdProducerPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsEntityIdProducerPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityIdProducerPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityIdProducerPDSAValidator.ColumnNames.DateColumnNameHere);
