...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA</param>
    public InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.DateColumnNameHere);
