...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSA</param>
    public OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator(OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetAllUidsFromRoleIdAndClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
