...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalElevatorControlTypePanelModelUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalElevatorControlTypePanelModelUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalElevatorControlTypePanelModelUniquePDSA</param>
    public IsAccessPortalElevatorControlTypePanelModelUniquePDSAValidator(IsAccessPortalElevatorControlTypePanelModelUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalElevatorControlTypePanelModelUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalElevatorControlTypePanelModelUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalElevatorControlTypePanelModelUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalElevatorControlTypePanelModelUniquePDSAValidator.ColumnNames.DateColumnNameHere);
