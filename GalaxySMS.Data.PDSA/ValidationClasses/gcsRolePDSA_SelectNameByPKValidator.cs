...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsRolePDSA_SelectNameByPKPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsRolePDSA_SelectNameByPKPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsRolePDSA_SelectNameByPKPDSA</param>
    public gcsRolePDSA_SelectNameByPKPDSAValidator(gcsRolePDSA_SelectNameByPKPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsRolePDSA_SelectNameByPKPDSAValidator";

      // Create Properties for each field in the gcsRolePDSA_SelectNameByPKPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsRolePDSA_SelectNameByPKPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsRolePDSA_SelectNameByPKPDSAValidator.ColumnNames.DateColumnNameHere);
