...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonSummary_SearchWithParamsExPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonSummary_SearchWithParamsExPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonSummary_SearchWithParamsExPDSA</param>
    public PersonSummary_SearchWithParamsExPDSAValidator(PersonSummary_SearchWithParamsExPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonSummary_SearchWithParamsExPDSAValidator";

      // Create Properties for each field in the PersonSummary_SearchWithParamsExPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonSummary_SearchWithParamsExPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonSummary_SearchWithParamsExPDSAValidator.ColumnNames.DateColumnNameHere);
