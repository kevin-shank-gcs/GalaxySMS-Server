...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonUniquePDSA</param>
    public IsPersonUniquePDSAValidator(IsPersonUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonUniquePDSAValidator";

      // Create Properties for each field in the IsPersonUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonUniquePDSAValidator.ColumnNames.DateColumnNameHere);
