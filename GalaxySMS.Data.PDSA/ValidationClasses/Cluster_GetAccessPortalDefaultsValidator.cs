...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_GetAccessPortalDefaultsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_GetAccessPortalDefaultsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_GetAccessPortalDefaultsPDSA</param>
    public Cluster_GetAccessPortalDefaultsPDSAValidator(Cluster_GetAccessPortalDefaultsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_GetAccessPortalDefaultsPDSAValidator";

      // Create Properties for each field in the Cluster_GetAccessPortalDefaultsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_GetAccessPortalDefaultsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_GetAccessPortalDefaultsPDSAValidator.ColumnNames.DateColumnNameHere);
