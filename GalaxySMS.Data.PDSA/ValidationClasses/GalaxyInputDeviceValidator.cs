...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInputDevicePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInputDevicePDSA</param>
    public GalaxyInputDevicePDSAValidator(GalaxyInputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInputDevicePDSAValidator";

      // Create Properties for each field in the GalaxyInputDevicePDSA entity class
      InitProperties();
    ...
    public GalaxyInputDevicePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInputDevicePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
