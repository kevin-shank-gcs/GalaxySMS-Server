...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedGuidPropertyRulesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedGuidPropertyRulesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedGuidPropertyRulesUniquePDSA</param>
    public IsUserDefinedGuidPropertyRulesUniquePDSAValidator(IsUserDefinedGuidPropertyRulesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedGuidPropertyRulesUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedGuidPropertyRulesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedGuidPropertyRulesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedGuidPropertyRulesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
