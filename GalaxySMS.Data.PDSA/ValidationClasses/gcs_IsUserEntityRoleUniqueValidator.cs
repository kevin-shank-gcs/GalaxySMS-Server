...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserEntityRoleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserEntityRoleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserEntityRoleUniquePDSA</param>
    public gcs_IsUserEntityRoleUniquePDSAValidator(gcs_IsUserEntityRoleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserEntityRoleUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsUserEntityRoleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserEntityRoleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserEntityRoleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
