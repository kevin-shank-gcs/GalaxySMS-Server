...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class UploadedFile_DeleteStaleItemsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UploadedFile_DeleteStaleItemsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UploadedFile_DeleteStaleItemsPDSA</param>
    public UploadedFile_DeleteStaleItemsPDSAValidator(UploadedFile_DeleteStaleItemsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UploadedFile_DeleteStaleItemsPDSAValidator";

      // Create Properties for each field in the UploadedFile_DeleteStaleItemsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UploadedFile_DeleteStaleItemsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UploadedFile_DeleteStaleItemsPDSAValidator.ColumnNames.DateColumnNameHere);
