...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceEventPropertiesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceEventPropertiesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceEventPropertiesUniquePDSA</param>
    public IsInputDeviceEventPropertiesUniquePDSAValidator(IsInputDeviceEventPropertiesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceEventPropertiesUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceEventPropertiesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceEventPropertiesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceEventPropertiesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
