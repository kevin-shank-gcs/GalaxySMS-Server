...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Site_SelectionListForEntityAndRegionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Site_SelectionListForEntityAndRegionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Site_SelectionListForEntityAndRegionPDSA</param>
    public Site_SelectionListForEntityAndRegionPDSAValidator(Site_SelectionListForEntityAndRegionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Site_SelectionListForEntityAndRegionPDSAValidator";

      // Create Properties for each field in the Site_SelectionListForEntityAndRegionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Site_SelectionListForEntityAndRegionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Site_SelectionListForEntityAndRegionPDSAValidator.ColumnNames.DateColumnNameHere);
