...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelAlarmSettings_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelAlarmSettings_PanelLoadDataPDSA</param>
    public GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator(GalaxyPanelAlarmSettings_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the GalaxyPanelAlarmSettings_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A GalaxyPanelAlarmSettings_PanelLoadDataPDSA object</returns>
    public GalaxyPanelAlarmSettings_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelAlarmSettings_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
