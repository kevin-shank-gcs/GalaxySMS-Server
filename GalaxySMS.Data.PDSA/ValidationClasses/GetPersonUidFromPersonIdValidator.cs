...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetPersonUidFromPersonIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetPersonUidFromPersonIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetPersonUidFromPersonIdPDSA</param>
    public GetPersonUidFromPersonIdPDSAValidator(GetPersonUidFromPersonIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetPersonUidFromPersonIdPDSAValidator";

      // Create Properties for each field in the GetPersonUidFromPersonIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetPersonUidFromPersonIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetPersonUidFromPersonIdPDSAValidator.ColumnNames.DateColumnNameHere);
