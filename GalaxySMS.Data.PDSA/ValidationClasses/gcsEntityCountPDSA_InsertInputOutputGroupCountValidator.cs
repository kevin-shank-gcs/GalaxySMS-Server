...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertInputOutputGroupCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertInputOutputGroupCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertInputOutputGroupCountPDSA</param>
    public gcsEntityCountPDSA_InsertInputOutputGroupCountPDSAValidator(gcsEntityCountPDSA_InsertInputOutputGroupCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertInputOutputGroupCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertInputOutputGroupCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInputOutputGroupCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInputOutputGroupCountPDSAValidator.ColumnNames.DateColumnNameHere);
