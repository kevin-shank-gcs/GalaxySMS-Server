...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyCpuInformationPDSA class.
  ...
  /// </summary>
  public partial class GalaxyCpuInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuInformationPDSA</param>
    public GalaxyCpuInformationPDSAValidator(GalaxyCpuInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuInformationPDSAValidator";

      // Create Properties for each field in the GalaxyCpuInformationPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A GalaxyCpuInformationPDSA object</returns>
    public GalaxyCpuInformationPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyCpuInformationPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuInformationPDSAValidator.ColumnNames.DateColumnNameHere);
