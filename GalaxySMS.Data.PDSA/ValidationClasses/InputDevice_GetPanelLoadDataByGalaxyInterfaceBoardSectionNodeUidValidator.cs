...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA</param>
    public InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ColumnNames.DateColumnNameHere);
