...
{
  /// <summary>
  /// Used to validate business rules on the gcsPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsPermissionPDSA</param>
    public gcsPermissionPDSAValidator(gcsPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsPermissionPDSAValidator";

      // Create Properties for each field in the gcsPermissionPDSA entity class
      InitProperties();
    ...
    public gcsPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
