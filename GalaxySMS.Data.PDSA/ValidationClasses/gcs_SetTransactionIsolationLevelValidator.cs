...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_SetTransactionIsolationLevelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_SetTransactionIsolationLevelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_SetTransactionIsolationLevelPDSA</param>
    public gcs_SetTransactionIsolationLevelPDSAValidator(gcs_SetTransactionIsolationLevelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_SetTransactionIsolationLevelPDSAValidator";

      // Create Properties for each field in the gcs_SetTransactionIsolationLevelPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_SetTransactionIsolationLevelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_SetTransactionIsolationLevelPDSAValidator.ColumnNames.DateColumnNameHere);
