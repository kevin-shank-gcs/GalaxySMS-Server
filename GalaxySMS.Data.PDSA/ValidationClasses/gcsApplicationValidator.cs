...
{
  /// <summary>
  /// Used to validate business rules on the gcsApplicationPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsApplicationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsApplicationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsApplicationPDSA</param>
    public gcsApplicationPDSAValidator(gcsApplicationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsApplicationPDSAValidator";

      // Create Properties for each field in the gcsApplicationPDSA entity class
      InitProperties();
    ...
    public gcsApplicationPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsApplicationPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsApplicationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsApplicationPDSAValidator.ColumnNames.DateColumnNameHere);
