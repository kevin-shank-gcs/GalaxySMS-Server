...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInputDelayTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInputDelayTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInputDelayTypeUniquePDSA</param>
    public IsGalaxyInputDelayTypeUniquePDSAValidator(IsGalaxyInputDelayTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInputDelayTypeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInputDelayTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInputDelayTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInputDelayTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
