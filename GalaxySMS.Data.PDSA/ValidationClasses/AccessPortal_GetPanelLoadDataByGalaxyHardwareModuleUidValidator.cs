...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA</param>
    public AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator(AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.DateColumnNameHere);
