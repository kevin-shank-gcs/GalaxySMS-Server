...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AcknowledgedAlarmBasicData_ByActivityEventUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarmBasicData_ByActivityEventUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarmBasicData_ByActivityEventUidPDSA</param>
    public AcknowledgedAlarmBasicData_ByActivityEventUidPDSAValidator(AcknowledgedAlarmBasicData_ByActivityEventUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarmBasicData_ByActivityEventUidPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarmBasicData_ByActivityEventUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByActivityEventUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarmBasicData_ByActivityEventUidPDSAValidator.ColumnNames.DateColumnNameHere);
