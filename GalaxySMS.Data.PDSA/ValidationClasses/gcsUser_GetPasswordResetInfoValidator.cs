...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsUser_GetPasswordResetInfoPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUser_GetPasswordResetInfoPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUser_GetPasswordResetInfoPDSA</param>
    public gcsUser_GetPasswordResetInfoPDSAValidator(gcsUser_GetPasswordResetInfoPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUser_GetPasswordResetInfoPDSAValidator";

      // Create Properties for each field in the gcsUser_GetPasswordResetInfoPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUser_GetPasswordResetInfoPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUser_GetPasswordResetInfoPDSAValidator.ColumnNames.DateColumnNameHere);
