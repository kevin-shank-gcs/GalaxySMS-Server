...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercScpMacAddressUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercScpMacAddressUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercScpMacAddressUniquePDSA</param>
    public IsMercScpMacAddressUniquePDSAValidator(IsMercScpMacAddressUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercScpMacAddressUniquePDSAValidator";

      // Create Properties for each field in the IsMercScpMacAddressUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercScpMacAddressUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercScpMacAddressUniquePDSAValidator.ColumnNames.DateColumnNameHere);
