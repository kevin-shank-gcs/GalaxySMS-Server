...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelCommandPDSA</param>
    public GalaxyPanelCommandPDSAValidator(GalaxyPanelCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelCommandPDSAValidator";

      // Create Properties for each field in the GalaxyPanelCommandPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelCommandPDSAValidator.ColumnNames.DateColumnNameHere);
