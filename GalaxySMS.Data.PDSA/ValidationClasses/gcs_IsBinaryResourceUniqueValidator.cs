...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsBinaryResourceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsBinaryResourceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsBinaryResourceUniquePDSA</param>
    public gcs_IsBinaryResourceUniquePDSAValidator(gcs_IsBinaryResourceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsBinaryResourceUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsBinaryResourceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsBinaryResourceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsBinaryResourceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
