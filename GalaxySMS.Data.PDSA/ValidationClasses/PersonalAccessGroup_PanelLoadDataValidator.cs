...
{
  /// <summary>
  /// Used to validate business rules on the PersonalAccessGroup_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class PersonalAccessGroup_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroup_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroup_PanelLoadDataPDSA</param>
    public PersonalAccessGroup_PanelLoadDataPDSAValidator(PersonalAccessGroup_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroup_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroup_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A PersonalAccessGroup_PanelLoadDataPDSA object</returns>
    public PersonalAccessGroup_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonalAccessGroup_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
