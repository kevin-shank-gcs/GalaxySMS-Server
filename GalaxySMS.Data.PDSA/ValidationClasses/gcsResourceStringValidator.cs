...
{
  /// <summary>
  /// Used to validate business rules on the gcsResourceStringPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsResourceStringPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsResourceStringPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsResourceStringPDSA</param>
    public gcsResourceStringPDSAValidator(gcsResourceStringPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsResourceStringPDSAValidator";

      // Create Properties for each field in the gcsResourceStringPDSA entity class
      InitProperties();
    ...
    public gcsResourceStringPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsResourceStringPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsResourceStringPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsResourceStringPDSAValidator.ColumnNames.DateColumnNameHere);
