...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonListPropertyItemUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonListPropertyItemUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonListPropertyItemUniquePDSA</param>
    public IsPersonListPropertyItemUniquePDSAValidator(IsPersonListPropertyItemUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonListPropertyItemUniquePDSAValidator";

      // Create Properties for each field in the IsPersonListPropertyItemUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonListPropertyItemUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonListPropertyItemUniquePDSAValidator.ColumnNames.DateColumnNameHere);
