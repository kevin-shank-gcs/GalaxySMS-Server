...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSA</param>
    public gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSAValidator(gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertOutputDeviceActivityEventCountPDSAValidator.ColumnNames.DateColumnNameHere);
