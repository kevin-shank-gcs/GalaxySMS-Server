...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForPersonActiveStatusTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForPersonActiveStatusTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForPersonActiveStatusTypePDSA</param>
    public GetEntityIdForPersonActiveStatusTypePDSAValidator(GetEntityIdForPersonActiveStatusTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForPersonActiveStatusTypePDSAValidator";

      // Create Properties for each field in the GetEntityIdForPersonActiveStatusTypePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForPersonActiveStatusTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForPersonActiveStatusTypePDSAValidator.ColumnNames.DateColumnNameHere);
