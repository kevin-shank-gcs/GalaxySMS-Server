...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsFeatureUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsFeatureUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsFeatureUniquePDSA</param>
    public IsFeatureUniquePDSAValidator(IsFeatureUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsFeatureUniquePDSAValidator";

      // Create Properties for each field in the IsFeatureUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsFeatureUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsFeatureUniquePDSAValidator.ColumnNames.DateColumnNameHere);
