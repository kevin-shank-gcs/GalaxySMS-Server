...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsBiometricSystemTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsBiometricSystemTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsBiometricSystemTypeUniquePDSA</param>
    public IsBiometricSystemTypeUniquePDSAValidator(IsBiometricSystemTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsBiometricSystemTypeUniquePDSAValidator";

      // Create Properties for each field in the IsBiometricSystemTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsBiometricSystemTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsBiometricSystemTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
