...
{
  /// <summary>
  /// Used to validate business rules on the InputDevicePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevicePDSA</param>
    public InputDevicePDSAValidator(InputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevicePDSAValidator";

      // Create Properties for each field in the InputDevicePDSA entity class
      InitProperties();
    ...
    public InputDevicePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDevicePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
