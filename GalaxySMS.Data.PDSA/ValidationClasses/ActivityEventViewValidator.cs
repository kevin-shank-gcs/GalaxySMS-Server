...
{
  /// <summary>
  /// Used to validate business rules on the ActivityEventViewPDSA class.
  ...
  /// </summary>
  public partial class ActivityEventViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ActivityEventViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ActivityEventViewPDSA</param>
    public ActivityEventViewPDSAValidator(ActivityEventViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ActivityEventViewPDSAValidator";

      // Create Properties for each field in the ActivityEventViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A ActivityEventViewPDSA object</returns>
    public ActivityEventViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ActivityEventViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ActivityEventViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ActivityEventViewPDSAValidator.ColumnNames.DateColumnNameHere);
