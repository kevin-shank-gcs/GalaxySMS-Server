...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialClusterTourUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialClusterTourUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialClusterTourUniquePDSA</param>
    public IsCredentialClusterTourUniquePDSAValidator(IsCredentialClusterTourUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialClusterTourUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialClusterTourUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialClusterTourUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialClusterTourUniquePDSAValidator.ColumnNames.DateColumnNameHere);
