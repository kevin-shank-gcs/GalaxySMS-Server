...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForCluster_ByHardwareAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForCluster_ByHardwareAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForCluster_ByHardwareAddressPDSA</param>
    public GetEntityIdForCluster_ByHardwareAddressPDSAValidator(GetEntityIdForCluster_ByHardwareAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForCluster_ByHardwareAddressPDSAValidator";

      // Create Properties for each field in the GetEntityIdForCluster_ByHardwareAddressPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForCluster_ByHardwareAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForCluster_ByHardwareAddressPDSAValidator.ColumnNames.DateColumnNameHere);
