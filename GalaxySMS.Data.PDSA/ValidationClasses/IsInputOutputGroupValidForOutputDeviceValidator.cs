...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupValidForOutputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupValidForOutputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupValidForOutputDevicePDSA</param>
    public IsInputOutputGroupValidForOutputDevicePDSAValidator(IsInputOutputGroupValidForOutputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupValidForOutputDevicePDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupValidForOutputDevicePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupValidForOutputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupValidForOutputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
