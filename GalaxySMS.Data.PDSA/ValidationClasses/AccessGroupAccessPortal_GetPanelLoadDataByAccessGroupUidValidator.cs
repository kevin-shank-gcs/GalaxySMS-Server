...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSA</param>
    public AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSAValidator(AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidPDSAValidator.ColumnNames.DateColumnNameHere);
