...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertTimeScheduleCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertTimeScheduleCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertTimeScheduleCountPDSA</param>
    public gcsEntityCountPDSA_InsertTimeScheduleCountPDSAValidator(gcsEntityCountPDSA_InsertTimeScheduleCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertTimeScheduleCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertTimeScheduleCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertTimeScheduleCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertTimeScheduleCountPDSAValidator.ColumnNames.DateColumnNameHere);
