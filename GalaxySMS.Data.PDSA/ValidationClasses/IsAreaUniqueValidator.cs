...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAreaUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAreaUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAreaUniquePDSA</param>
    public IsAreaUniquePDSAValidator(IsAreaUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAreaUniquePDSAValidator";

      // Create Properties for each field in the IsAreaUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAreaUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAreaUniquePDSAValidator.ColumnNames.DateColumnNameHere);
