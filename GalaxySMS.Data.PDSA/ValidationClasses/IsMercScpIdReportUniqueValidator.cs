...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercScpIdReportUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercScpIdReportUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercScpIdReportUniquePDSA</param>
    public IsMercScpIdReportUniquePDSAValidator(IsMercScpIdReportUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercScpIdReportUniquePDSAValidator";

      // Create Properties for each field in the IsMercScpIdReportUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercScpIdReportUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercScpIdReportUniquePDSAValidator.ColumnNames.DateColumnNameHere);
