...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterUid_GetByGalaxyHardwareModuleUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterUid_GetByGalaxyHardwareModuleUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterUid_GetByGalaxyHardwareModuleUidPDSA</param>
    public ClusterUid_GetByGalaxyHardwareModuleUidPDSAValidator(ClusterUid_GetByGalaxyHardwareModuleUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterUid_GetByGalaxyHardwareModuleUidPDSAValidator";

      // Create Properties for each field in the ClusterUid_GetByGalaxyHardwareModuleUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterUid_GetByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterUid_GetByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.DateColumnNameHere);
