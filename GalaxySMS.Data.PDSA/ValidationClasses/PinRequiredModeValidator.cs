...
{
  /// <summary>
  /// Used to validate business rules on the PinRequiredModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PinRequiredModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PinRequiredModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PinRequiredModePDSA</param>
    public PinRequiredModePDSAValidator(PinRequiredModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PinRequiredModePDSAValidator";

      // Create Properties for each field in the PinRequiredModePDSA entity class
      InitProperties();
    ...
    public PinRequiredModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PinRequiredModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PinRequiredModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PinRequiredModePDSAValidator.ColumnNames.DateColumnNameHere);
