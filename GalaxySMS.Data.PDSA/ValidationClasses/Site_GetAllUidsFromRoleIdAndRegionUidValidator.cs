...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Site_GetAllUidsFromRoleIdAndRegionUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Site_GetAllUidsFromRoleIdAndRegionUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Site_GetAllUidsFromRoleIdAndRegionUidPDSA</param>
    public Site_GetAllUidsFromRoleIdAndRegionUidPDSAValidator(Site_GetAllUidsFromRoleIdAndRegionUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Site_GetAllUidsFromRoleIdAndRegionUidPDSAValidator";

      // Create Properties for each field in the Site_GetAllUidsFromRoleIdAndRegionUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Site_GetAllUidsFromRoleIdAndRegionUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Site_GetAllUidsFromRoleIdAndRegionUidPDSAValidator.ColumnNames.DateColumnNameHere);
