...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForRegionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForRegionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForRegionPDSA</param>
    public GetEntityIdForRegionPDSAValidator(GetEntityIdForRegionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForRegionPDSAValidator";

      // Create Properties for each field in the GetEntityIdForRegionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForRegionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForRegionPDSAValidator.ColumnNames.DateColumnNameHere);
