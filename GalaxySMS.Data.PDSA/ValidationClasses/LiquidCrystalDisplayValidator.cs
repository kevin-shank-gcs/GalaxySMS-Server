...
{
  /// <summary>
  /// Used to validate business rules on the LiquidCrystalDisplayPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class LiquidCrystalDisplayPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the LiquidCrystalDisplayPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a LiquidCrystalDisplayPDSA</param>
    public LiquidCrystalDisplayPDSAValidator(LiquidCrystalDisplayPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "LiquidCrystalDisplayPDSAValidator";

      // Create Properties for each field in the LiquidCrystalDisplayPDSA entity class
      InitProperties();
    ...
    public LiquidCrystalDisplayPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your LiquidCrystalDisplayPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(LiquidCrystalDisplayPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(LiquidCrystalDisplayPDSAValidator.ColumnNames.DateColumnNameHere);
