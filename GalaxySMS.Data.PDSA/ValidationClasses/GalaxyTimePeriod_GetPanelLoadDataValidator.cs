...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyTimePeriod_GetPanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyTimePeriod_GetPanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyTimePeriod_GetPanelLoadDataPDSA</param>
    public GalaxyTimePeriod_GetPanelLoadDataPDSAValidator(GalaxyTimePeriod_GetPanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyTimePeriod_GetPanelLoadDataPDSAValidator";

      // Create Properties for each field in the GalaxyTimePeriod_GetPanelLoadDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyTimePeriod_GetPanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyTimePeriod_GetPanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
