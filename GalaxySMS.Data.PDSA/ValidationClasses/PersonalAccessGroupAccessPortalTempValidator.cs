...
{
  /// <summary>
  /// Used to validate business rules on the PersonalAccessGroupAccessPortalTempPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonalAccessGroupAccessPortalTempPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroupAccessPortalTempPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroupAccessPortalTempPDSA</param>
    public PersonalAccessGroupAccessPortalTempPDSAValidator(PersonalAccessGroupAccessPortalTempPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroupAccessPortalTempPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroupAccessPortalTempPDSA entity class
      InitProperties();
    ...
    public PersonalAccessGroupAccessPortalTempPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonalAccessGroupAccessPortalTempPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroupAccessPortalTempPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroupAccessPortalTempPDSAValidator.ColumnNames.DateColumnNameHere);
