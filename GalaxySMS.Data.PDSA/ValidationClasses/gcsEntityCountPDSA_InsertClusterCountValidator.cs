...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertClusterCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertClusterCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertClusterCountPDSA</param>
    public gcsEntityCountPDSA_InsertClusterCountPDSAValidator(gcsEntityCountPDSA_InsertClusterCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertClusterCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertClusterCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertClusterCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertClusterCountPDSAValidator.ColumnNames.DateColumnNameHere);
