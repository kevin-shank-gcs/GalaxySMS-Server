...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelCommandUniquePDSA</param>
    public IsGalaxyPanelCommandUniquePDSAValidator(IsGalaxyPanelCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelCommandUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
