...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSA</param>
    public gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSAValidator(gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessPortalGroupCountPDSAValidator.ColumnNames.DateColumnNameHere);
