...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForTimeSchedulePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForTimeSchedulePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForTimeSchedulePDSA</param>
    public GetEntityIdForTimeSchedulePDSAValidator(GetEntityIdForTimeSchedulePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForTimeSchedulePDSAValidator";

      // Create Properties for each field in the GetEntityIdForTimeSchedulePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForTimeSchedulePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForTimeSchedulePDSAValidator.ColumnNames.DateColumnNameHere);
