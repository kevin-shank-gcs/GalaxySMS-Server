...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeSchedule_GetTimeScheduleUsageDataForClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedule_GetTimeScheduleUsageDataForClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedule_GetTimeScheduleUsageDataForClusterPDSA</param>
    public TimeSchedule_GetTimeScheduleUsageDataForClusterPDSAValidator(TimeSchedule_GetTimeScheduleUsageDataForClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedule_GetTimeScheduleUsageDataForClusterPDSAValidator";

      // Create Properties for each field in the TimeSchedule_GetTimeScheduleUsageDataForClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedule_GetTimeScheduleUsageDataForClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedule_GetTimeScheduleUsageDataForClusterPDSAValidator.ColumnNames.DateColumnNameHere);
