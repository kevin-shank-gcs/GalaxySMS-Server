...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntity_DeleteSitesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntity_DeleteSitesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntity_DeleteSitesPDSA</param>
    public gcsEntity_DeleteSitesPDSAValidator(gcsEntity_DeleteSitesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntity_DeleteSitesPDSAValidator";

      // Create Properties for each field in the gcsEntity_DeleteSitesPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntity_DeleteSitesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntity_DeleteSitesPDSAValidator.ColumnNames.DateColumnNameHere);
