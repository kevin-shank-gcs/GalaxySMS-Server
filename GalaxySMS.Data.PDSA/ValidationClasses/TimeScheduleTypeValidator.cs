...
{
  /// <summary>
  /// Used to validate business rules on the TimeScheduleTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class TimeScheduleTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeScheduleTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeScheduleTypePDSA</param>
    public TimeScheduleTypePDSAValidator(TimeScheduleTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeScheduleTypePDSAValidator";

      // Create Properties for each field in the TimeScheduleTypePDSA entity class
      InitProperties();
    ...
    public TimeScheduleTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TimeScheduleTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeScheduleTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeScheduleTypePDSAValidator.ColumnNames.DateColumnNameHere);
