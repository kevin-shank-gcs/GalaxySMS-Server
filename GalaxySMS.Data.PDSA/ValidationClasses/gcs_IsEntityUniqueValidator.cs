...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsEntityUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsEntityUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsEntityUniquePDSA</param>
    public gcs_IsEntityUniquePDSAValidator(gcs_IsEntityUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsEntityUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsEntityUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsEntityUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsEntityUniquePDSAValidator.ColumnNames.DateColumnNameHere);
