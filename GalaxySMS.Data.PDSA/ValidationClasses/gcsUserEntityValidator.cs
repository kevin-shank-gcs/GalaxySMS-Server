...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserEntityPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserEntityPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserEntityPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserEntityPDSA</param>
    public gcsUserEntityPDSAValidator(gcsUserEntityPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserEntityPDSAValidator";

      // Create Properties for each field in the gcsUserEntityPDSA entity class
      InitProperties();
    ...
    public gcsUserEntityPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserEntityPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserEntityPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserEntityPDSAValidator.ColumnNames.DateColumnNameHere);
