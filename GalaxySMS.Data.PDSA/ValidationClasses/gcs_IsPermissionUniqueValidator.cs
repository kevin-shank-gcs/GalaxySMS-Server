...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsPermissionUniquePDSA</param>
    public gcs_IsPermissionUniquePDSAValidator(gcs_IsPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsPermissionUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
