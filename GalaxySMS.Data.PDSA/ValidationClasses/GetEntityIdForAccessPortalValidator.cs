...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForAccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForAccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForAccessPortalPDSA</param>
    public GetEntityIdForAccessPortalPDSAValidator(GetEntityIdForAccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForAccessPortalPDSAValidator";

      // Create Properties for each field in the GetEntityIdForAccessPortalPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForAccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForAccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
