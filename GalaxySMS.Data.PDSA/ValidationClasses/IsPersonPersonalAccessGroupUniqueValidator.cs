...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonPersonalAccessGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonPersonalAccessGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonPersonalAccessGroupUniquePDSA</param>
    public IsPersonPersonalAccessGroupUniquePDSAValidator(IsPersonPersonalAccessGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonPersonalAccessGroupUniquePDSAValidator";

      // Create Properties for each field in the IsPersonPersonalAccessGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonPersonalAccessGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonPersonalAccessGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
