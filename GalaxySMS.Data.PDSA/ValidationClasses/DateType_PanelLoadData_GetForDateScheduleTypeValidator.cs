...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DateType_PanelLoadData_GetForDateScheduleTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateType_PanelLoadData_GetForDateScheduleTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateType_PanelLoadData_GetForDateScheduleTypePDSA</param>
    public DateType_PanelLoadData_GetForDateScheduleTypePDSAValidator(DateType_PanelLoadData_GetForDateScheduleTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateType_PanelLoadData_GetForDateScheduleTypePDSAValidator";

      // Create Properties for each field in the DateType_PanelLoadData_GetForDateScheduleTypePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateType_PanelLoadData_GetForDateScheduleTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateType_PanelLoadData_GetForDateScheduleTypePDSAValidator.ColumnNames.DateColumnNameHere);
