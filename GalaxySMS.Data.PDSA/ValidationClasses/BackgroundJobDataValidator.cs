...
{
  /// <summary>
  /// Used to validate business rules on the BackgroundJobDataPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BackgroundJobDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BackgroundJobDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BackgroundJobDataPDSA</param>
    public BackgroundJobDataPDSAValidator(BackgroundJobDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BackgroundJobDataPDSAValidator";

      // Create Properties for each field in the BackgroundJobDataPDSA entity class
      InitProperties();
    ...
    public BackgroundJobDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BackgroundJobDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BackgroundJobDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BackgroundJobDataPDSAValidator.ColumnNames.DateColumnNameHere);
