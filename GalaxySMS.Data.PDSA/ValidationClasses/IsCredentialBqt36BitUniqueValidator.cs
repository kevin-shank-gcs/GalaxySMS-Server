...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialBqt36BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialBqt36BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialBqt36BitUniquePDSA</param>
    public IsCredentialBqt36BitUniquePDSAValidator(IsCredentialBqt36BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialBqt36BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialBqt36BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialBqt36BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialBqt36BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
