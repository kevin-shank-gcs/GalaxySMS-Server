...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_DoesUserHaveEntityPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_DoesUserHaveEntityPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_DoesUserHaveEntityPDSA</param>
    public gcs_DoesUserHaveEntityPDSAValidator(gcs_DoesUserHaveEntityPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_DoesUserHaveEntityPDSAValidator";

      // Create Properties for each field in the gcs_DoesUserHaveEntityPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_DoesUserHaveEntityPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_DoesUserHaveEntityPDSAValidator.ColumnNames.DateColumnNameHere);
