...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupLoadToCpu_CreatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupLoadToCpu_CreatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupLoadToCpu_CreatePDSA</param>
    public AccessGroupLoadToCpu_CreatePDSAValidator(AccessGroupLoadToCpu_CreatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupLoadToCpu_CreatePDSAValidator";

      // Create Properties for each field in the AccessGroupLoadToCpu_CreatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupLoadToCpu_CreatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupLoadToCpu_CreatePDSAValidator.ColumnNames.DateColumnNameHere);
