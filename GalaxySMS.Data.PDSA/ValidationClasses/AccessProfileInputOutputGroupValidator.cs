...
{
  /// <summary>
  /// Used to validate business rules on the AccessProfileInputOutputGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessProfileInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessProfileInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessProfileInputOutputGroupPDSA</param>
    public AccessProfileInputOutputGroupPDSAValidator(AccessProfileInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessProfileInputOutputGroupPDSAValidator";

      // Create Properties for each field in the AccessProfileInputOutputGroupPDSA entity class
      InitProperties();
    ...
    public AccessProfileInputOutputGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessProfileInputOutputGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessProfileInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessProfileInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
