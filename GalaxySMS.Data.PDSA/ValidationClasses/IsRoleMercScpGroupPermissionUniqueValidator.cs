...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleMercScpGroupPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleMercScpGroupPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleMercScpGroupPermissionUniquePDSA</param>
    public IsRoleMercScpGroupPermissionUniquePDSAValidator(IsRoleMercScpGroupPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleMercScpGroupPermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleMercScpGroupPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleMercScpGroupPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleMercScpGroupPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
