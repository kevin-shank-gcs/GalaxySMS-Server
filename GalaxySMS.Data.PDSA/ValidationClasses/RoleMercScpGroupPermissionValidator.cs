...
{
  /// <summary>
  /// Used to validate business rules on the RoleMercScpGroupPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleMercScpGroupPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleMercScpGroupPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleMercScpGroupPermissionPDSA</param>
    public RoleMercScpGroupPermissionPDSAValidator(RoleMercScpGroupPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleMercScpGroupPermissionPDSAValidator";

      // Create Properties for each field in the RoleMercScpGroupPermissionPDSA entity class
      InitProperties();
    ...
    public RoleMercScpGroupPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleMercScpGroupPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleMercScpGroupPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleMercScpGroupPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
