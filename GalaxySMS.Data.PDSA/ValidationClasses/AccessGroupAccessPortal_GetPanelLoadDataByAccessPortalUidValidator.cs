...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSA</param>
    public AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator(AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByAccessPortalUidPDSAValidator.ColumnNames.DateColumnNameHere);
