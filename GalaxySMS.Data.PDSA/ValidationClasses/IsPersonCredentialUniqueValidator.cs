...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonCredentialUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonCredentialUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonCredentialUniquePDSA</param>
    public IsPersonCredentialUniquePDSAValidator(IsPersonCredentialUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonCredentialUniquePDSAValidator";

      // Create Properties for each field in the IsPersonCredentialUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonCredentialUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonCredentialUniquePDSAValidator.ColumnNames.DateColumnNameHere);
