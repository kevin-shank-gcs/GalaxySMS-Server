...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsUserEntityRoles_GetMinimalInfoForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserEntityRoles_GetMinimalInfoForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserEntityRoles_GetMinimalInfoForUserIdPDSA</param>
    public gcsUserEntityRoles_GetMinimalInfoForUserIdPDSAValidator(gcsUserEntityRoles_GetMinimalInfoForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserEntityRoles_GetMinimalInfoForUserIdPDSAValidator";

      // Create Properties for each field in the gcsUserEntityRoles_GetMinimalInfoForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserEntityRoles_GetMinimalInfoForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserEntityRoles_GetMinimalInfoForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
