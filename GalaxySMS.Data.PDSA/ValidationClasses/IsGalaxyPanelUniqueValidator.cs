...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelUniquePDSA</param>
    public IsGalaxyPanelUniquePDSAValidator(IsGalaxyPanelUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelUniquePDSAValidator.ColumnNames.DateColumnNameHere);
