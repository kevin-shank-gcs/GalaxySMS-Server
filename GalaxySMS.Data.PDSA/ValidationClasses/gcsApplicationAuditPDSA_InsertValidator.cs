...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsApplicationAuditPDSA_InsertPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsApplicationAuditPDSA_InsertPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsApplicationAuditPDSA_InsertPDSA</param>
    public gcsApplicationAuditPDSA_InsertPDSAValidator(gcsApplicationAuditPDSA_InsertPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsApplicationAuditPDSA_InsertPDSAValidator";

      // Create Properties for each field in the gcsApplicationAuditPDSA_InsertPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsApplicationAuditPDSA_InsertPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsApplicationAuditPDSA_InsertPDSAValidator.ColumnNames.DateColumnNameHere);
