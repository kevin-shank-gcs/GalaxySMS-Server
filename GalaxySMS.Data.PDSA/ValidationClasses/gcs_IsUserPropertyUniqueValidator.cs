...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserPropertyUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserPropertyUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserPropertyUniquePDSA</param>
    public gcs_IsUserPropertyUniquePDSAValidator(gcs_IsUserPropertyUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserPropertyUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsUserPropertyUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserPropertyUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserPropertyUniquePDSAValidator.ColumnNames.DateColumnNameHere);
