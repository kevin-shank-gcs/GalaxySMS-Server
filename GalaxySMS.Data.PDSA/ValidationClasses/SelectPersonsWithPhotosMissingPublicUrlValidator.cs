...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class SelectPersonsWithPhotosMissingPublicUrlPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the SelectPersonsWithPhotosMissingPublicUrlPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a SelectPersonsWithPhotosMissingPublicUrlPDSA</param>
    public SelectPersonsWithPhotosMissingPublicUrlPDSAValidator(SelectPersonsWithPhotosMissingPublicUrlPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "SelectPersonsWithPhotosMissingPublicUrlPDSAValidator";

      // Create Properties for each field in the SelectPersonsWithPhotosMissingPublicUrlPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(SelectPersonsWithPhotosMissingPublicUrlPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(SelectPersonsWithPhotosMissingPublicUrlPDSAValidator.ColumnNames.DateColumnNameHere);
