...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_DoesRowExistNVarCharPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_DoesRowExistNVarCharPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_DoesRowExistNVarCharPDSA</param>
    public gcs_DoesRowExistNVarCharPDSAValidator(gcs_DoesRowExistNVarCharPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_DoesRowExistNVarCharPDSAValidator";

      // Create Properties for each field in the gcs_DoesRowExistNVarCharPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_DoesRowExistNVarCharPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_DoesRowExistNVarCharPDSAValidator.ColumnNames.DateColumnNameHere);
