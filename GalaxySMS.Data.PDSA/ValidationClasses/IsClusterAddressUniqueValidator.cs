...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterAddressUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterAddressUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterAddressUniquePDSA</param>
    public IsClusterAddressUniquePDSAValidator(IsClusterAddressUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterAddressUniquePDSAValidator";

      // Create Properties for each field in the IsClusterAddressUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterAddressUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterAddressUniquePDSAValidator.ColumnNames.DateColumnNameHere);
