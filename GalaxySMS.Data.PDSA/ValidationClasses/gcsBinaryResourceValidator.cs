...
{
  /// <summary>
  /// Used to validate business rules on the gcsBinaryResourcePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsBinaryResourcePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsBinaryResourcePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsBinaryResourcePDSA</param>
    public gcsBinaryResourcePDSAValidator(gcsBinaryResourcePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsBinaryResourcePDSAValidator";

      // Create Properties for each field in the gcsBinaryResourcePDSA entity class
      InitProperties();
    ...
    public gcsBinaryResourcePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsBinaryResourcePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsBinaryResourcePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsBinaryResourcePDSAValidator.ColumnNames.DateColumnNameHere);
