...
{
  /// <summary>
  /// Used to validate business rules on the gcsPermissionCategoryPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsPermissionCategoryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsPermissionCategoryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsPermissionCategoryPDSA</param>
    public gcsPermissionCategoryPDSAValidator(gcsPermissionCategoryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsPermissionCategoryPDSAValidator";

      // Create Properties for each field in the gcsPermissionCategoryPDSA entity class
      InitProperties();
    ...
    public gcsPermissionCategoryPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsPermissionCategoryPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.DateColumnNameHere);
