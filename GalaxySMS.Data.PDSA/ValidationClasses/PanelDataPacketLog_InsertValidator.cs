...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PanelDataPacketLog_InsertPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PanelDataPacketLog_InsertPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PanelDataPacketLog_InsertPDSA</param>
    public PanelDataPacketLog_InsertPDSAValidator(PanelDataPacketLog_InsertPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PanelDataPacketLog_InsertPDSAValidator";

      // Create Properties for each field in the PanelDataPacketLog_InsertPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PanelDataPacketLog_InsertPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PanelDataPacketLog_InsertPDSAValidator.ColumnNames.DateColumnNameHere);
