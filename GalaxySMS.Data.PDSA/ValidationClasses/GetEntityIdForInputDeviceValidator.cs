...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForInputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForInputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForInputDevicePDSA</param>
    public GetEntityIdForInputDevicePDSAValidator(GetEntityIdForInputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForInputDevicePDSAValidator";

      // Create Properties for each field in the GetEntityIdForInputDevicePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForInputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForInputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
