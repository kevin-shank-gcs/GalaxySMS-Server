...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalAreaTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalAreaTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalAreaTypeUniquePDSA</param>
    public IsAccessPortalAreaTypeUniquePDSAValidator(IsAccessPortalAreaTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalAreaTypeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalAreaTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalAreaTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalAreaTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
