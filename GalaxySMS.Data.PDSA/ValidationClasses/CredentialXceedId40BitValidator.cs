...
{
  /// <summary>
  /// Used to validate business rules on the CredentialXceedId40BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialXceedId40BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialXceedId40BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialXceedId40BitPDSA</param>
    public CredentialXceedId40BitPDSAValidator(CredentialXceedId40BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialXceedId40BitPDSAValidator";

      // Create Properties for each field in the CredentialXceedId40BitPDSA entity class
      InitProperties();
    ...
    public CredentialXceedId40BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialXceedId40BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialXceedId40BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialXceedId40BitPDSAValidator.ColumnNames.DateColumnNameHere);
