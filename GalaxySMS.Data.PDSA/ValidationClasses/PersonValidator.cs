...
{
  /// <summary>
  /// Used to validate business rules on the PersonPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPDSA</param>
    public PersonPDSAValidator(PersonPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPDSAValidator";

      // Create Properties for each field in the PersonPDSA entity class
      InitProperties();
    ...
    public PersonPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
            ...
            //prop = Properties.GetByName(PersonPDSAValidator.ColumnNames.ColumnNameHere);
            //prop.MinLength = 6;

            //prop = Properties.GetByName(PersonPDSAValidator.ColumnNames.DateColumnNameHere);
