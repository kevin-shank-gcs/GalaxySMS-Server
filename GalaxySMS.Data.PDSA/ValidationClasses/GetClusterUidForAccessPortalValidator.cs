...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetClusterUidForAccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetClusterUidForAccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetClusterUidForAccessPortalPDSA</param>
    public GetClusterUidForAccessPortalPDSAValidator(GetClusterUidForAccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetClusterUidForAccessPortalPDSAValidator";

      // Create Properties for each field in the GetClusterUidForAccessPortalPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetClusterUidForAccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetClusterUidForAccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
