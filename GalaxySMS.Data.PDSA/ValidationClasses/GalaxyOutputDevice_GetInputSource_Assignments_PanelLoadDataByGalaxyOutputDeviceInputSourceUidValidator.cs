...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSAValidator class
    /// </summary>
    ...
    public GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSAValidator(GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSAValidator";

      // Create Properties for each field in the GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDevice_GetInputSource_Assignments_PanelLoadDataByGalaxyOutputDeviceInputSourceUidPDSAValidator.ColumnNames.DateColumnNameHere);
