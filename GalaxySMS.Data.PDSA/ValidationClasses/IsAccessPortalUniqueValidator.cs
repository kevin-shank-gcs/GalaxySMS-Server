...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalUniquePDSA</param>
    public IsAccessPortalUniquePDSAValidator(IsAccessPortalUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalUniquePDSAValidator.ColumnNames.DateColumnNameHere);
