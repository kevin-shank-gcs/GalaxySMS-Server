...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSA</param>
    public GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSAValidator(GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSA object</returns>
    public GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDevice_InputSource_Main_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
