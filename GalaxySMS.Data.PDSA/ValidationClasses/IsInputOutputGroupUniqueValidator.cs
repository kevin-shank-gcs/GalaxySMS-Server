...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupUniquePDSA</param>
    public IsInputOutputGroupUniquePDSAValidator(IsInputOutputGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupUniquePDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
