...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetPanelLoadDataByClusterUidPDSA</param>
    public AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator(AccessPortal_GetPanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetPanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
