...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSA</param>
    public ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSAValidator(ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSAValidator";

      // Create Properties for each field in the ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ActivityEventAcknowledgementPDSA_ByActivityEventUidPDSAValidator.ColumnNames.DateColumnNameHere);
