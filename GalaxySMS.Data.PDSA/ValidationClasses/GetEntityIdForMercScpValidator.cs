...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetEntityIdForMercScpPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetEntityIdForMercScpPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetEntityIdForMercScpPDSA</param>
    public GetEntityIdForMercScpPDSAValidator(GetEntityIdForMercScpPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetEntityIdForMercScpPDSAValidator";

      // Create Properties for each field in the GetEntityIdForMercScpPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetEntityIdForMercScpPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetEntityIdForMercScpPDSAValidator.ColumnNames.DateColumnNameHere);
