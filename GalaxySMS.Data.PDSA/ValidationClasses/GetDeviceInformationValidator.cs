...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetDeviceInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetDeviceInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetDeviceInformationPDSA</param>
    public GetDeviceInformationPDSAValidator(GetDeviceInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetDeviceInformationPDSAValidator";

      // Create Properties for each field in the GetDeviceInformationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetDeviceInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetDeviceInformationPDSAValidator.ColumnNames.DateColumnNameHere);
