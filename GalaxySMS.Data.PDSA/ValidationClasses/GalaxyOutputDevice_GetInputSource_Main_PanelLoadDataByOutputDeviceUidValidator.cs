...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSA</param>
    public GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSAValidator(GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSAValidator";

      // Create Properties for each field in the GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDevice_GetInputSource_Main_PanelLoadDataByOutputDeviceUidPDSAValidator.ColumnNames.DateColumnNameHere);
