...
{
  /// <summary>
  /// Used to validate business rules on the TimeScheduleEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class TimeScheduleEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeScheduleEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeScheduleEntityMapPDSA</param>
    public TimeScheduleEntityMapPDSAValidator(TimeScheduleEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeScheduleEntityMapPDSAValidator";

      // Create Properties for each field in the TimeScheduleEntityMapPDSA entity class
      InitProperties();
    ...
    public TimeScheduleEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TimeScheduleEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeScheduleEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeScheduleEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
