...
{
  /// <summary>
  /// Used to validate business rules on the AcknowledgeAlarmPredefinedResponsePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AcknowledgeAlarmPredefinedResponsePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgeAlarmPredefinedResponsePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgeAlarmPredefinedResponsePDSA</param>
    public AcknowledgeAlarmPredefinedResponsePDSAValidator(AcknowledgeAlarmPredefinedResponsePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgeAlarmPredefinedResponsePDSAValidator";

      // Create Properties for each field in the AcknowledgeAlarmPredefinedResponsePDSA entity class
      InitProperties();
    ...
    public AcknowledgeAlarmPredefinedResponsePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AcknowledgeAlarmPredefinedResponsePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgeAlarmPredefinedResponsePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgeAlarmPredefinedResponsePDSAValidator.ColumnNames.DateColumnNameHere);
