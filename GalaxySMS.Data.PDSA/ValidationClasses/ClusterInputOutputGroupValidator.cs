...
{
  /// <summary>
  /// Used to validate business rules on the ClusterInputOutputGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterInputOutputGroupPDSA</param>
    public ClusterInputOutputGroupPDSAValidator(ClusterInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterInputOutputGroupPDSAValidator";

      // Create Properties for each field in the ClusterInputOutputGroupPDSA entity class
      InitProperties();
    ...
    public ClusterInputOutputGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterInputOutputGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
