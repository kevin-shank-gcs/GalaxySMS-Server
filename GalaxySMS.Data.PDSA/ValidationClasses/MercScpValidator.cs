...
{
  /// <summary>
  /// Used to validate business rules on the MercScpPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class MercScpPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpPDSA</param>
    public MercScpPDSAValidator(MercScpPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpPDSAValidator";

      // Create Properties for each field in the MercScpPDSA entity class
      InitProperties();
    ...
    public MercScpPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your MercScpPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpPDSAValidator.ColumnNames.DateColumnNameHere);
