...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedNumberPropertyRulesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedNumberPropertyRulesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedNumberPropertyRulesUniquePDSA</param>
    public IsUserDefinedNumberPropertyRulesUniquePDSAValidator(IsUserDefinedNumberPropertyRulesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedNumberPropertyRulesUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedNumberPropertyRulesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedNumberPropertyRulesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedNumberPropertyRulesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
