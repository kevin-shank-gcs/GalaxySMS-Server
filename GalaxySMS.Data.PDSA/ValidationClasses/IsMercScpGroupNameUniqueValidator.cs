...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercScpGroupNameUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercScpGroupNameUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercScpGroupNameUniquePDSA</param>
    public IsMercScpGroupNameUniquePDSAValidator(IsMercScpGroupNameUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercScpGroupNameUniquePDSAValidator";

      // Create Properties for each field in the IsMercScpGroupNameUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercScpGroupNameUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercScpGroupNameUniquePDSAValidator.ColumnNames.DateColumnNameHere);
