...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetTimeScheduleAndClusterNamesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetTimeScheduleAndClusterNamesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetTimeScheduleAndClusterNamesPDSA</param>
    public GetTimeScheduleAndClusterNamesPDSAValidator(GetTimeScheduleAndClusterNamesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetTimeScheduleAndClusterNamesPDSAValidator";

      // Create Properties for each field in the GetTimeScheduleAndClusterNamesPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetTimeScheduleAndClusterNamesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetTimeScheduleAndClusterNamesPDSAValidator.ColumnNames.DateColumnNameHere);
