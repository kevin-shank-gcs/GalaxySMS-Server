...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonClusterPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonClusterPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonClusterPermissionUniquePDSA</param>
    public IsPersonClusterPermissionUniquePDSAValidator(IsPersonClusterPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonClusterPermissionUniquePDSAValidator";

      // Create Properties for each field in the IsPersonClusterPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonClusterPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonClusterPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
