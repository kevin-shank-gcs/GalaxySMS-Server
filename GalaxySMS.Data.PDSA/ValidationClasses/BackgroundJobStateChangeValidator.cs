...
{
  /// <summary>
  /// Used to validate business rules on the BackgroundJobStateChangePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BackgroundJobStateChangePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BackgroundJobStateChangePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BackgroundJobStateChangePDSA</param>
    public BackgroundJobStateChangePDSAValidator(BackgroundJobStateChangePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BackgroundJobStateChangePDSAValidator";

      // Create Properties for each field in the BackgroundJobStateChangePDSA entity class
      InitProperties();
    ...
    public BackgroundJobStateChangePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BackgroundJobStateChangePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BackgroundJobStateChangePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BackgroundJobStateChangePDSAValidator.ColumnNames.DateColumnNameHere);
