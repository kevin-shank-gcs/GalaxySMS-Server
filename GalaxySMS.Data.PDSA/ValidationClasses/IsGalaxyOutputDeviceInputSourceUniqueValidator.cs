...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyOutputDeviceInputSourceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyOutputDeviceInputSourceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyOutputDeviceInputSourceUniquePDSA</param>
    public IsGalaxyOutputDeviceInputSourceUniquePDSAValidator(IsGalaxyOutputDeviceInputSourceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyOutputDeviceInputSourceUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyOutputDeviceInputSourceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyOutputDeviceInputSourceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyOutputDeviceInputSourceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
