...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntity_DeleteRegionsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntity_DeleteRegionsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntity_DeleteRegionsPDSA</param>
    public gcsEntity_DeleteRegionsPDSAValidator(gcsEntity_DeleteRegionsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntity_DeleteRegionsPDSAValidator";

      // Create Properties for each field in the gcsEntity_DeleteRegionsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntity_DeleteRegionsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntity_DeleteRegionsPDSAValidator.ColumnNames.DateColumnNameHere);
