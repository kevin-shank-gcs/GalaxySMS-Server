...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataByClusterUidPDSA</param>
    public InputDevice_GetPanelLoadDataByClusterUidPDSAValidator(InputDevice_GetPanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
