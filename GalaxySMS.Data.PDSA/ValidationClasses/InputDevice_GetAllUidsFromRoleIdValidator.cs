...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetAllUidsFromRoleIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetAllUidsFromRoleIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetAllUidsFromRoleIdPDSA</param>
    public InputDevice_GetAllUidsFromRoleIdPDSAValidator(InputDevice_GetAllUidsFromRoleIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetAllUidsFromRoleIdPDSAValidator";

      // Create Properties for each field in the InputDevice_GetAllUidsFromRoleIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetAllUidsFromRoleIdPDSAValidator.ColumnNames.DateColumnNameHere);
