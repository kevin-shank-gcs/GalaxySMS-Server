...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanel_GetAllUidsForClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanel_GetAllUidsForClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanel_GetAllUidsForClusterUidPDSA</param>
    public GalaxyPanel_GetAllUidsForClusterUidPDSAValidator(GalaxyPanel_GetAllUidsForClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanel_GetAllUidsForClusterUidPDSAValidator";

      // Create Properties for each field in the GalaxyPanel_GetAllUidsForClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanel_GetAllUidsForClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanel_GetAllUidsForClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
