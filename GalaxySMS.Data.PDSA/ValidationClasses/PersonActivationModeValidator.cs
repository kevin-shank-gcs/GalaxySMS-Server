...
{
  /// <summary>
  /// Used to validate business rules on the PersonActivationModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonActivationModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonActivationModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonActivationModePDSA</param>
    public PersonActivationModePDSAValidator(PersonActivationModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonActivationModePDSAValidator";

      // Create Properties for each field in the PersonActivationModePDSA entity class
      InitProperties();
    ...
    public PersonActivationModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonActivationModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonActivationModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonActivationModePDSAValidator.ColumnNames.DateColumnNameHere);
