...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAcknowledgeAlarmPredefinedResponseUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAcknowledgeAlarmPredefinedResponseUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAcknowledgeAlarmPredefinedResponseUniquePDSA</param>
    public IsAcknowledgeAlarmPredefinedResponseUniquePDSAValidator(IsAcknowledgeAlarmPredefinedResponseUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAcknowledgeAlarmPredefinedResponseUniquePDSAValidator";

      // Create Properties for each field in the IsAcknowledgeAlarmPredefinedResponseUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAcknowledgeAlarmPredefinedResponseUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAcknowledgeAlarmPredefinedResponseUniquePDSAValidator.ColumnNames.DateColumnNameHere);
