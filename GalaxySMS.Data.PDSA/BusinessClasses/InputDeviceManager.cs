...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputDevicePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputDevicePDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputDevicePDSA object</param>
    public void InitEntityObject(InputDevicePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputDevice entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InputDevice objects
    /// </summary>
    public IEnumerable<InputDevice> ConvertPDSACollection(InputDevicePDSACollection pdsaCollection)
    {	
	 var results = new List<InputDevice>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputDevice();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent InputDevice objects
    /// </summary>
    public IEnumerable<InputDevice> ConvertPDSACollection(IEnumerable<InputDevicePDSA> pdsaCollection)
    {	
	 var results = new List<InputDevice>();
      foreach (var pdsaEntity in pdsaCollection)
      {
