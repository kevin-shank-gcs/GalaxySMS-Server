...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InterfaceBoardTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InterfaceBoardTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An InterfaceBoardTypePDSA object</param>
    public void InitEntityObject(InterfaceBoardTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InterfaceBoardType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InterfaceBoardType objects
    /// </summary>
    public IEnumerable<InterfaceBoardType> ConvertPDSACollection(InterfaceBoardTypePDSACollection pdsaCollection)
    {	
	 var results = new List<InterfaceBoardType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InterfaceBoardType();
