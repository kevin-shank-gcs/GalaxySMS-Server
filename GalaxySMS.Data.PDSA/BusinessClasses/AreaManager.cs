...
namespace GalaxySMS.BusinessLayer
{
    ...
    /// </summary>
    public partial class AreaPDSAManager
    {
        ...
        /// <summary>
        /// Call this method to initialize an AreaPDSA object with any default values
        /// </summary>
        /// <param name="entity">An AreaPDSA object</param>
        public void InitEntityObject(AreaPDSA entity)
        {
        ...
        /// </summary>
        public void InitEntityObject(Area entity)
        {
        ...
        /// <summary>
        /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Area objects
        /// </summary>
        public IEnumerable<Area> ConvertPDSACollection(AreaPDSACollection pdsaCollection)
        {
            var results = new List<Area>();
            foreach (var pdsaEntity in pdsaCollection)
            {
                var convertedEntity = new Area();
        ...
        /// <summary>
        /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent Area objects
        /// </summary>
        public IEnumerable<Area> ConvertPDSACollection(IEnumerable<AreaPDSA> pdsaCollection)
        {
            var results = new List<Area>();
            foreach (var pdsaEntity in pdsaCollection)
            {
