...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyInterfaceBoardPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyInterfaceBoardPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyInterfaceBoardPDSA object</param>
    public void InitEntityObject(GalaxyInterfaceBoardPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyInterfaceBoard entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyInterfaceBoard objects
    /// </summary>
    public IEnumerable<GalaxyInterfaceBoard> ConvertPDSACollection(GalaxyInterfaceBoardPDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyInterfaceBoard>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyInterfaceBoard();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent GalaxyInterfaceBoard objects
    /// </summary>
    public IEnumerable<GalaxyInterfaceBoard> ConvertPDSACollection(IEnumerable<GalaxyInterfaceBoardPDSA> pdsaCollection)
    {	
	 var results = new List<GalaxyInterfaceBoard>();
      foreach (var pdsaEntity in pdsaCollection)
      {
