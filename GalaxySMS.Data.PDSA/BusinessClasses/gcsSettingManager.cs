...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsSettingPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsSettingPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsSettingPDSA object</param>
    public void InitEntityObject(gcsSettingPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsSetting entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsSetting objects
    /// </summary>
    public IEnumerable<gcsSetting> ConvertPDSACollection(gcsSettingPDSACollection pdsaCollection)
    {	
	 var results = new List<gcsSetting>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsSetting();
