...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonRecordTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonRecordTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonRecordTypePDSA object</param>
    public void InitEntityObject(PersonRecordTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonRecordType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonRecordType objects
    /// </summary>
    public IEnumerable<PersonRecordType> ConvertPDSACollection(PersonRecordTypePDSACollection pdsaCollection)
    {	
	 var results = new List<PersonRecordType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonRecordType();
