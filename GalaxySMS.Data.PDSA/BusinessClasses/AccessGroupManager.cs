...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessGroupPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessGroupPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessGroupPDSA object</param>
    public void InitEntityObject(AccessGroupPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessGroup entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessGroup objects
    /// </summary>
    public IEnumerable<AccessGroup> ConvertPDSACollection(AccessGroupPDSACollection pdsaCollection)
    {	
	 var results = new List<AccessGroup>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessGroup();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent AccessGroup objects
    /// </summary>
    public IEnumerable<AccessGroup> ConvertPDSACollection(IEnumerable<AccessGroupPDSA> pdsaCollection)
    {	
	 var results = new List<AccessGroup>();
      foreach (var pdsaEntity in pdsaCollection)
      {
