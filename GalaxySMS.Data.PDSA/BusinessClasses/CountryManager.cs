...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CountryPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CountryPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CountryPDSA object</param>
    public void InitEntityObject(CountryPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Country entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Country objects
    /// </summary>
    public IEnumerable<Country> ConvertPDSACollection(CountryPDSACollection pdsaCollection)
    {	
	 var results = new List<Country>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Country();
