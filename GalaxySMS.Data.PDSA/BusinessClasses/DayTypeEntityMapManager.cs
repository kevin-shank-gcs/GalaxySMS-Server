...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class DayTypeEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an DayTypeEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An DayTypeEntityMapPDSA object</param>
    public void InitEntityObject(DayTypeEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(DayTypeEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent DayTypeEntityMap objects 
    /// </summary>
    public IEnumerable<DayTypeEntityMap> ConvertPDSACollection(DayTypeEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<DayTypeEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new DayTypeEntityMap();
