...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AssaAccessPointPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AssaAccessPointPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AssaAccessPointPDSA object</param>
    public void InitEntityObject(AssaAccessPointPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AssaAccessPoint entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AssaAccessPoint objects 
    /// </summary>
    public IEnumerable<AssaAccessPoint> ConvertPDSACollection(AssaAccessPointPDSACollection pdsaCollection)
    {	
	 var results = new List<AssaAccessPoint>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AssaAccessPoint();
