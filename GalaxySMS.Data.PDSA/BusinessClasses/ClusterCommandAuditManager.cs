...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class ClusterCommandAuditPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an ClusterCommandAuditPDSA object with any default values
    /// </summary>
    /// <param name="entity">An ClusterCommandAuditPDSA object</param>
    public void InitEntityObject(ClusterCommandAuditPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(ClusterCommandAudit entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent ClusterCommandAudit objects
    /// </summary>
    public IEnumerable<ClusterCommandAudit> ConvertPDSACollection(ClusterCommandAuditPDSACollection pdsaCollection)
    {	
	 var results = new List<ClusterCommandAudit>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new ClusterCommandAudit();
