...
namespace GalaxySMS.BusinessLayer
{
  ...
  public partial class gcsRolePermissionPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsRolePermission objects
    /// </summary>
    public IEnumerable<gcsRolePermission> ConvertPDSACollection(gcsRolePermissionPDSACollection pdsaCollection)
    {	
	 var results = new List<gcsRolePermission>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsRolePermission();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent gcsRolePermission objects
    /// </summary>
    public IEnumerable<gcsRolePermission> ConvertPDSACollection(IEnumerable<gcsRolePermissionPDSA> pdsaCollection)
    {	
	 var results = new List<gcsRolePermission>();
      foreach (var pdsaEntity in pdsaCollection)
      {
