...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputCommandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputCommandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputCommandPDSA object</param>
    public void InitEntityObject(InputCommandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputCommand entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InputCommand objects
    /// </summary>
    public IEnumerable<InputCommand> ConvertPDSACollection(InputCommandPDSACollection pdsaCollection)
    {	
	 var results = new List<InputCommand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputCommand();
