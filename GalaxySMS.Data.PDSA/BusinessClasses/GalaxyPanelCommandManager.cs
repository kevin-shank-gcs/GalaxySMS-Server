...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelCommandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyPanelCommandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyPanelCommandPDSA object</param>
    public void InitEntityObject(GalaxyPanelCommandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyPanelCommand entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyPanelCommand objects
    /// </summary>
    public IEnumerable<GalaxyPanelCommand> ConvertPDSACollection(GalaxyPanelCommandPDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyPanelCommand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyPanelCommand();
