...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonDatePropertyPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonDatePropertyPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonDatePropertyPDSA object</param>
    public void InitEntityObject(PersonDatePropertyPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonDateProperty entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonDateProperty objects
    /// </summary>
    public IEnumerable<PersonDateProperty> ConvertPDSACollection(PersonDatePropertyPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonDateProperty>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonDateProperty();
