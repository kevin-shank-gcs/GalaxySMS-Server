...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AssaDayPeriodTimePeriodPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AssaDayPeriodTimePeriodPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AssaDayPeriodTimePeriodPDSA object</param>
    public void InitEntityObject(AssaDayPeriodTimePeriodPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AssaDayPeriodTimePeriod entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AssaDayPeriodTimePeriod objects 
    /// </summary>
    public IEnumerable<AssaDayPeriodTimePeriod> ConvertPDSACollection(AssaDayPeriodTimePeriodPDSACollection pdsaCollection)
    {	
	 var results = new List<AssaDayPeriodTimePeriod>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AssaDayPeriodTimePeriod();
