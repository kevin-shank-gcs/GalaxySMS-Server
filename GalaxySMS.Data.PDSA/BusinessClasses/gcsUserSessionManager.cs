...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsUserSessionPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsUserSessionPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsUserSessionPDSA object</param>
    public void InitEntityObject(gcsUserSessionPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsUserSession entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsUserSession objects
    /// </summary>
    public IEnumerable<gcsUserSession> ConvertPDSACollection(gcsUserSessionPDSACollection pdsaCollection)
    {	
	 var results = new List<gcsUserSession>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsUserSession();
