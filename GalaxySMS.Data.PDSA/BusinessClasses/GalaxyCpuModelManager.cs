...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyCpuModelPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyCpuModelPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyCpuModelPDSA object</param>
    public void InitEntityObject(GalaxyCpuModelPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyCpuModel entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyCpuModel objects
    /// </summary>
    public IEnumerable<GalaxyCpuModel> ConvertPDSACollection(GalaxyCpuModelPDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyCpuModel>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyCpuModel();
