...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AssaDsrPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AssaDsrPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AssaDsrPDSA object</param>
    public void InitEntityObject(AssaDsrPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AssaDsr entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AssaDsr objects 
    /// </summary>
    public IEnumerable<AssaDsr> ConvertPDSACollection(AssaDsrPDSACollection pdsaCollection)
    {	
	 var results = new List<AssaDsr>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AssaDsr();
