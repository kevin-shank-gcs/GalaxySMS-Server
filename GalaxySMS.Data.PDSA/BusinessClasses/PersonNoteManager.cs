...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonNotePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonNotePDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonNotePDSA object</param>
    public void InitEntityObject(PersonNotePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonNote entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonNote objects
    /// </summary>
    public IEnumerable<PersonNote> ConvertPDSACollection(PersonNotePDSACollection pdsaCollection)
    {	
	 var results = new List<PersonNote>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonNote();
