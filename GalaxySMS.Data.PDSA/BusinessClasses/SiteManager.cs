...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class SitePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an SitePDSA object with any default values
    /// </summary>
    /// <param name="entity">An SitePDSA object</param>
    public void InitEntityObject(SitePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Site entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Site objects 
    /// </summary>
    public IEnumerable<Site> ConvertPDSACollection(SitePDSACollection pdsaCollection)
    {	
	 var results = new List<Site>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Site();
