...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class MercScpPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an MercScpPDSA object with any default values
    /// </summary>
    /// <param name="entity">An MercScpPDSA object</param>
    public void InitEntityObject(MercScpPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(MercScp entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent MercScp objects
    /// </summary>
    public IEnumerable<MercScp> ConvertPDSACollection(MercScpPDSACollection pdsaCollection)
    {	
	 var results = new List<MercScp>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new MercScp();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent MercScp objects
    /// </summary>
    public IEnumerable<MercScp> ConvertPDSACollection(IEnumerable<MercScpPDSA> pdsaCollection)
    {	
	 var results = new List<MercScp>();
      foreach (var pdsaEntity in pdsaCollection)
      {
