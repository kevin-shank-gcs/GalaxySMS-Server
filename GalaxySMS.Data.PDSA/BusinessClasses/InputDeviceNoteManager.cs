...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputDeviceNotePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputDeviceNotePDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputDeviceNotePDSA object</param>
    public void InitEntityObject(InputDeviceNotePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputDeviceNote entity)
    {
    ...
    /// </summary>
    public IEnumerable<InputDeviceNote> ConvertPDSACollection(InputDeviceNotePDSACollection pdsaCollection)
    {	
	 var results = new List<InputDeviceNote>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputDeviceNote();
