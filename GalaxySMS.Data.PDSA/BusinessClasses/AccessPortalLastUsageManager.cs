...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalLastUsagePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalLastUsagePDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalLastUsagePDSA object</param>
    public void InitEntityObject(AccessPortalLastUsagePDSA entity)
    {
  ...
  //  /// <summary>
  //  /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent gcsClass objects
  //  /// </summary>
  //  public IEnumerable<gcsClass> ConvertPDSACollection(IEnumerable<gcsClassPDSA> pdsaCollection)
  //  {	
	 //var results = new List<gcsClass>();
  //    foreach (var pdsaEntity in pdsaCollection)
  //    {
