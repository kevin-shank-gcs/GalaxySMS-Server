...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyHardwareModulePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyHardwareModulePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyHardwareModulePDSA object</param>
    public void InitEntityObject(GalaxyHardwareModulePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyHardwareModule entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyHardwareModule objects
    /// </summary>
    public IEnumerable<GalaxyHardwareModule> ConvertPDSACollection(GalaxyHardwareModulePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyHardwareModule>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyHardwareModule();
