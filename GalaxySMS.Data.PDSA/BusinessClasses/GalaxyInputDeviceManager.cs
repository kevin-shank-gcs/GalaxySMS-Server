...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyInputDevicePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyInputDevicePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyInputDevicePDSA object</param>
    public void InitEntityObject(GalaxyInputDevicePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyInputDevice entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyInputDevice objects
    /// </summary>
    public IEnumerable<GalaxyInputDevice> ConvertPDSACollection(GalaxyInputDevicePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyInputDevice>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyInputDevice();
