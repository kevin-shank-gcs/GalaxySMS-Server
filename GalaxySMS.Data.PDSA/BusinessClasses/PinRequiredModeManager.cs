...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PinRequiredModePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PinRequiredModePDSA object with any default values
    /// </summary>
    /// <param name="entity">An PinRequiredModePDSA object</param>
    public void InitEntityObject(PinRequiredModePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PinRequiredMode entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PinRequiredMode objects
    /// </summary>
    public IEnumerable<PinRequiredMode> ConvertPDSACollection(PinRequiredModePDSACollection pdsaCollection)
    {	
	 var results = new List<PinRequiredMode>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PinRequiredMode();
