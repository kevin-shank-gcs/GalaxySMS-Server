...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialDataPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialDataPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialDataPDSA object</param>
    public void InitEntityObject(CredentialDataPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CredentialData entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialData objects
    /// </summary>
    public IEnumerable<CredentialData> ConvertPDSACollection(CredentialDataPDSACollection pdsaCollection)
    {	
	 var results = new List<CredentialData>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CredentialData();
