...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class DepartmentPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an DepartmentPDSA object with any default values
    /// </summary>
    /// <param name="entity">An DepartmentPDSA object</param>
    public void InitEntityObject(DepartmentPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Department entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Department objects
    /// </summary>
    public IEnumerable<Department> ConvertPDSACollection(DepartmentPDSACollection pdsaCollection)
    {	
	 var results = new List<Department>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Department();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent Department objects
    /// </summary>
    public IEnumerable<Department> ConvertPDSACollection(IEnumerable<DepartmentPDSA> pdsaCollection)
    {	
	 var results = new List<Department>();
      foreach (var pdsaEntity in pdsaCollection)
      {
