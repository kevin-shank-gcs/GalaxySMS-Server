...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class UserDefinedNumberPropertyRulesPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an UserDefinedNumberPropertyRulesPDSA object with any default values
    /// </summary>
    /// <param name="entity">An UserDefinedNumberPropertyRulesPDSA object</param>
    public void InitEntityObject(UserDefinedNumberPropertyRulesPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(UserDefinedNumberPropertyRule entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent UserDefinedNumberPropertyRule objects
    /// </summary>
    public IEnumerable<UserDefinedNumberPropertyRule> ConvertPDSACollection(UserDefinedNumberPropertyRulesPDSACollection pdsaCollection)
    {	
	 var results = new List<UserDefinedNumberPropertyRule>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new UserDefinedNumberPropertyRule();
