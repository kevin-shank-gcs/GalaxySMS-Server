...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class RegionEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an RegionEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An RegionEntityMapPDSA object</param>
    public void InitEntityObject(RegionEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(RegionEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent RegionEntityMap objects
    /// </summary>
    public IEnumerable<RegionEntityMap> ConvertPDSACollection(RegionEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<RegionEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new RegionEntityMap();
