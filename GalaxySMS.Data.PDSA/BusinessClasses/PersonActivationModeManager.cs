...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonActivationModePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonActivationModePDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonActivationModePDSA object</param>
    public void InitEntityObject(PersonActivationModePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonActivationMode entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonActivationMode objects
    /// </summary>
    public IEnumerable<PersonActivationMode> ConvertPDSACollection(PersonActivationModePDSACollection pdsaCollection)
    {	
	 var results = new List<PersonActivationMode>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonActivationMode();
