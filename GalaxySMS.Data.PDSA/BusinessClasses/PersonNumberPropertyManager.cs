...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonNumberPropertyPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonNumberPropertyPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonNumberPropertyPDSA object</param>
    public void InitEntityObject(PersonNumberPropertyPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonNumberProperty entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonNumberProperty objects
    /// </summary>
    public IEnumerable<PersonNumberProperty> ConvertPDSACollection(PersonNumberPropertyPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonNumberProperty>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonNumberProperty();
