...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyInterfaceBoardSectionCommandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyInterfaceBoardSectionCommandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyInterfaceBoardSectionCommandPDSA object</param>
    public void InitEntityObject(GalaxyInterfaceBoardSectionCommandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyInterfaceBoardSectionCommand entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyInterfaceBoardSectionCommand objects
    /// </summary>
    public IEnumerable<GalaxyInterfaceBoardSectionCommand> ConvertPDSACollection(GalaxyInterfaceBoardSectionCommandPDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyInterfaceBoardSectionCommand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyInterfaceBoardSectionCommand();
