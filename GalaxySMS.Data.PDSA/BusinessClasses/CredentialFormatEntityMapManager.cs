...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialFormatEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialFormatEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialFormatEntityMapPDSA object</param>
    public void InitEntityObject(CredentialFormatEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CredentialFormatEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialFormatEntityMap objects
    /// </summary>
    public IEnumerable<CredentialFormatEntityMap> ConvertPDSACollection(CredentialFormatEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<CredentialFormatEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CredentialFormatEntityMap();
