...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class UserDefinedPropertyPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an UserDefinedPropertyPDSA object with any default values
    /// </summary>
    /// <param name="entity">An UserDefinedPropertyPDSA object</param>
    public void InitEntityObject(UserDefinedPropertyPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(UserDefinedProperty entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent UserDefinedProperty objects
    /// </summary>
    public IEnumerable<UserDefinedProperty> ConvertPDSACollection(UserDefinedPropertyPDSACollection pdsaCollection)
    {	
	 var results = new List<UserDefinedProperty>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new UserDefinedProperty();
