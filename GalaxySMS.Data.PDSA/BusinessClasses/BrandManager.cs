...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class BrandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an BrandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An BrandPDSA object</param>
    public void InitEntityObject(BrandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Brand entity)
    {
    ...
    /// </summary>
    public IEnumerable<Brand> ConvertPDSACollection(BrandPDSACollection pdsaCollection)
    {	
	 var results = new List<Brand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Brand();
