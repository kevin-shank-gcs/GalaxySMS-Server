  ...
  public partial class AcknowledgedAlarmsWithResponsesPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public AcknowledgedAlarmsWithResponsesPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.DateTime_x))
        ret.DateTime_x = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.DateTime_x]);
      ...
      if (values.ContainsKey(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.ResponseRequired))
        ret.ResponseRequired = Convert.ToBoolean(values[AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.ResponseRequired]);
      ...
      if (values.ContainsKey(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.ColorHex))
        ret.ColorHex = PDSAString.ConvertToStringTrim(values[AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.ColorHex]);
      ...
      if (values.ContainsKey(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.AckedDateTime))
        ret.AckedDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.AckedDateTime]);

      if (values.ContainsKey(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.AckedUpdatedDateTime))
        ret.AckedUpdatedDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.AckedUpdatedDateTime]);
