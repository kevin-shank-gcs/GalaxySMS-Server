    ...
    public partial class PersonCredentialBadgeDataViewPDSAManager : PDSADataClassManagerReadOnlyBase
    {
        ...
        public PersonCredentialBadgeDataViewPDSA DictionaryToEntity(Dictionary<string, string> values)
        {
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ActivationDateTime))
                ret.ActivationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ActivationDateTime]);
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ExpirationDateTime))
                ret.ExpirationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ExpirationDateTime]);
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.InsertDate))
                ret.InsertDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.InsertDate]);
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.UpdateDate))
                ret.UpdateDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.UpdateDate]);
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialActivationDate))
                ret.CredentialActivationDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialActivationDate]);
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialExpirationDateTime))
                ret.CredentialExpirationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialExpirationDateTime]);
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date1))
                ret.Date1 = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date1]);

            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date2))
                ret.Date2 = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date2]);
            ...
            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDate))
                ret.CurrentDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDate]);

            if (values.ContainsKey(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDateTime))
                ret.CurrentDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDateTime]);
