    ...
    public partial class PersonLcdMessagePDSAManager : PDSADataClassManagerBase
    {
        ...
        public PersonLcdMessagePDSA DictionaryToEntity(Dictionary<string, string> values)
        {
            ...
            if (values.ContainsKey(PersonLcdMessagePDSAValidator.ColumnNames.StartingDate))
                ret.StartingDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonLcdMessagePDSAValidator.ColumnNames.StartingDate]);

            if (values.ContainsKey(PersonLcdMessagePDSAValidator.ColumnNames.EndingDate))
                ret.EndingDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonLcdMessagePDSAValidator.ColumnNames.EndingDate]);
            ...
            if (values.ContainsKey(PersonLcdMessagePDSAValidator.ColumnNames.InsertDate))
                ret.InsertDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonLcdMessagePDSAValidator.ColumnNames.InsertDate]);
            ...
            if (values.ContainsKey(PersonLcdMessagePDSAValidator.ColumnNames.UpdateDate))
                ret.UpdateDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonLcdMessagePDSAValidator.ColumnNames.UpdateDate]);
