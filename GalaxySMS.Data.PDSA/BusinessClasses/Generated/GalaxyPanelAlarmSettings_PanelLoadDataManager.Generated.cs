...
namespace GalaxySMS.BusinessLayer
{
  ...
  public partial class GalaxyPanelAlarmSettings_PanelLoadDataPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public GalaxyPanelAlarmSettings_PanelLoadDataPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.IsActive))
        ret.IsActive = Convert.ToBoolean(values[GalaxyPanelAlarmSettings_PanelLoadDataPDSAValidator.ColumnNames.IsActive]);
