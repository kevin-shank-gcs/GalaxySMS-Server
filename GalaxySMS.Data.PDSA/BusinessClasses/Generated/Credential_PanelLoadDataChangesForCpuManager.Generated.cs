  ...
  public partial class Credential_PanelLoadDataChangesForCpuPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public Credential_PanelLoadDataChangesForCpuPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialChangeDate))
        ret.LastCredentialChangeDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialChangeDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialLoadedDate))
        ret.LastCredentialLoadedDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastCredentialLoadedDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonActivationDateTime))
        ret.PersonActivationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonActivationDateTime]);

      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonExpirationDateTime))
        ret.PersonExpirationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonExpirationDateTime]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate))
        ret.PersonEmploymentDate = Convert.ToDateTime(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PersonEmploymentDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialActivationDateTime))
        ret.CredentialActivationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialActivationDateTime]);

      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialExpirationDateTime))
        ret.CredentialExpirationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CredentialExpirationDateTime]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastPanelImpactingChangeDate))
        ret.LastPanelImpactingChangeDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LastPanelImpactingChangeDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdStartingDate))
        ret.LcdStartingDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdStartingDate]);

      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdEndingDate))
        ret.LcdEndingDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LcdEndingDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster))
        ret.CurrentTimeForCluster = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster]);
