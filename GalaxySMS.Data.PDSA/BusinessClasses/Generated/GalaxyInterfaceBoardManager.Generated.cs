  ...
  public partial class GalaxyInterfaceBoardPDSAManager : PDSADataClassManagerBase
  {
    ...
    public GalaxyInterfaceBoardPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(GalaxyInterfaceBoardPDSAValidator.ColumnNames.InsertDate))
        ret.InsertDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[GalaxyInterfaceBoardPDSAValidator.ColumnNames.InsertDate]);
      ...
      if (values.ContainsKey(GalaxyInterfaceBoardPDSAValidator.ColumnNames.UpdateDate))
        ret.UpdateDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[GalaxyInterfaceBoardPDSAValidator.ColumnNames.UpdateDate]);
      ...
      if (values.ContainsKey(GalaxyInterfaceBoardPDSAValidator.ColumnNames.AccountCode))
        ret.AccountCode = PDSAString.ConvertToStringTrim(values[GalaxyInterfaceBoardPDSAValidator.ColumnNames.AccountCode]);

      if (values.ContainsKey(GalaxyInterfaceBoardPDSAValidator.ColumnNames.ClusterName))
        ret.ClusterName = PDSAString.ConvertToStringTrim(values[GalaxyInterfaceBoardPDSAValidator.ColumnNames.ClusterName]);

      if (values.ContainsKey(GalaxyInterfaceBoardPDSAValidator.ColumnNames.PanelName))
        ret.PanelName = PDSAString.ConvertToStringTrim(values[GalaxyInterfaceBoardPDSAValidator.ColumnNames.PanelName]);
