...
namespace GalaxySMS.BusinessLayer
{
  ...
  public partial class AccessPortalGalaxyHardwareAddressViewPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public AccessPortalGalaxyHardwareAddressViewPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive))
        ret.IsNodeActive = Convert.ToBoolean(values[AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsNodeActive]);

      if (values.ContainsKey(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled))
        ret.IsEnabled = Convert.ToBoolean(values[AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.IsEnabled]);
