  ...
  public partial class PersonPDSAManager : PDSADataClassManagerBase
  {
    ...
    public PersonPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(PersonPDSAValidator.ColumnNames.ActivationDateTime))
          ret.ActivationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonPDSAValidator.ColumnNames.ActivationDateTime]);

      if (values.ContainsKey(PersonPDSAValidator.ColumnNames.ExpirationDateTime))
          ret.ExpirationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonPDSAValidator.ColumnNames.ExpirationDateTime]);
      ...
      if (values.ContainsKey(PersonPDSAValidator.ColumnNames.InsertDate))
          ret.InsertDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonPDSAValidator.ColumnNames.InsertDate]);
      ...
      if (values.ContainsKey(PersonPDSAValidator.ColumnNames.UpdateDate))
          ret.UpdateDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[PersonPDSAValidator.ColumnNames.UpdateDate]);
      ...
      if (values.ContainsKey(PersonPDSAValidator.ColumnNames.ActivityEventText))
        ret.ActivityEventText = PDSAString.ConvertToStringTrim(values[PersonPDSAValidator.ColumnNames.ActivityEventText]);

      if (values.ContainsKey(PersonPDSAValidator.ColumnNames.ActiveStatusCode))
        ret.ActiveStatusCode = Convert.ToInt16(values[PersonPDSAValidator.ColumnNames.ActiveStatusCode]);

      if (values.ContainsKey(PersonPDSAValidator.ColumnNames.DepartmentName))
        ret.DepartmentName = PDSAString.ConvertToStringTrim(values[PersonPDSAValidator.ColumnNames.DepartmentName]);
