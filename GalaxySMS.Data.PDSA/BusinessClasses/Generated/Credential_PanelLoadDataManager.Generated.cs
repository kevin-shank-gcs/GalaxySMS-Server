  ...
  public partial class Credential_PanelLoadDataPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public Credential_PanelLoadDataPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.PersonActivationDateTime))
        ret.PersonActivationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.PersonActivationDateTime]);

      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.PersonExpirationDateTime))
        ret.PersonExpirationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.PersonExpirationDateTime]);

      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.PersonEmploymentDate))
        ret.PersonEmploymentDate = Convert.ToDateTime(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.PersonEmploymentDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.CredentialActivationDateTime))
        ret.CredentialActivationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.CredentialActivationDateTime]);

      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.CredentialExpirationDateTime))
        ret.CredentialExpirationDateTime = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.CredentialExpirationDateTime]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.LastPanelImpactingChangeDate))
        ret.LastPanelImpactingChangeDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.LastPanelImpactingChangeDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.LcdStartingDate))
        ret.LcdStartingDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.LcdStartingDate]);

      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.LcdEndingDate))
        ret.LcdEndingDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.LcdEndingDate]);
      ...
      if (values.ContainsKey(Credential_PanelLoadDataPDSAValidator.ColumnNames.ClusterNumber))
        ret.ClusterNumber = Convert.ToInt32(values[Credential_PanelLoadDataPDSAValidator.ColumnNames.ClusterNumber]);
