  ...
  public partial class ActivityHistoryViewPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public ActivityHistoryViewPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.ActivityDateTime))
        ret.ActivityDateTime = PDSAProperty.ConvertToDateTimeOffset(values[ActivityHistoryViewPDSAValidator.ColumnNames.ActivityDateTime]);

      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.ActivityDateTimeUTC))
        ret.ActivityDateTimeUTC = PDSAProperty.ConvertToDateTimeOffset(values[ActivityHistoryViewPDSAValidator.ColumnNames.ActivityDateTimeUTC]);
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.ForeColorHex))
        ret.ForeColorHex = PDSAString.ConvertToStringTrim(values[ActivityHistoryViewPDSAValidator.ColumnNames.ForeColorHex]);
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.IsTraced))
        ret.IsTraced = Convert.ToBoolean(values[ActivityHistoryViewPDSAValidator.ColumnNames.IsTraced]);
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.ClusterUid))
        ret.ClusterUid = PDSAProperty.ConvertToGuid(values[ActivityHistoryViewPDSAValidator.ColumnNames.ClusterUid]);
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.AlarmPriority))
        ret.AlarmPriority = Convert.ToInt32(values[ActivityHistoryViewPDSAValidator.ColumnNames.AlarmPriority]);

      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.ResponseRequired))
        ret.ResponseRequired = Convert.ToInt32(values[ActivityHistoryViewPDSAValidator.ColumnNames.ResponseRequired]);

      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.AcknowledgedTime))
        ret.AcknowledgedTime = PDSAProperty.ConvertToDateTimeOffset(values[ActivityHistoryViewPDSAValidator.ColumnNames.AcknowledgedTime]);

      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.AcknowledgeComment))
        ret.AcknowledgeComment = PDSAString.ConvertToStringTrim(values[ActivityHistoryViewPDSAValidator.ColumnNames.AcknowledgeComment]);

      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.IsAcknowledgeable))
        ret.IsAcknowledgeable = Convert.ToInt32(values[ActivityHistoryViewPDSAValidator.ColumnNames.IsAcknowledgeable]);

      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.IsAcknowledged))
        ret.IsAcknowledged = Convert.ToInt32(values[ActivityHistoryViewPDSAValidator.ColumnNames.IsAcknowledged]);

      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.AcknowledgedByUser))
        ret.AcknowledgedByUser = PDSAString.ConvertToStringTrim(values[ActivityHistoryViewPDSAValidator.ColumnNames.AcknowledgedByUser]);
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.EntityName))
        ret.EntityName = PDSAString.ConvertToStringTrim(values[ActivityHistoryViewPDSAValidator.ColumnNames.EntityName]);
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.EntityType))
        ret.EntityType = PDSAString.ConvertToStringTrim(values[ActivityHistoryViewPDSAValidator.ColumnNames.EntityType]);
      ...
      if (values.ContainsKey(ActivityHistoryViewPDSAValidator.ColumnNames.AckCount))
        ret.AckCount = Convert.ToInt32(values[ActivityHistoryViewPDSAValidator.ColumnNames.AckCount]);
