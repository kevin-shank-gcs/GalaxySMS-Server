...
namespace GalaxySMS.BusinessLayer
{
  ...
  public partial class PersonalAccessGroup_PanelLoadDataPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public PersonalAccessGroup_PanelLoadDataPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(PersonalAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.TimeScheduleUid))
        ret.TimeScheduleUid = PDSAProperty.ConvertToGuid(values[PersonalAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.TimeScheduleUid]);

      if (values.ContainsKey(PersonalAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.DefaultTimeScheduleUid))
        ret.DefaultTimeScheduleUid = PDSAProperty.ConvertToGuid(values[PersonalAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.DefaultTimeScheduleUid]);
