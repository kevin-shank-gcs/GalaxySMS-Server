...
namespace GalaxySMS.BusinessLayer
{
  ...
  public partial class CredentialToDelete_PanelLoadDataChangesForCpuPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public CredentialToDelete_PanelLoadDataChangesForCpuPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DataLength))
        ret.DataLength = Convert.ToInt16(values[CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DataLength]);

      if (values.ContainsKey(CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsExtended))
        ret.IsExtended = Convert.ToBoolean(values[CredentialToDelete_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsExtended]);
    ...
    public CredentialToDelete_PanelLoadDataChangesForCpuPDSA CloneEntity(CredentialToDelete_PanelLoadDataChangesForCpuPDSA entityToClone)
    {
      ...
      newEntity.IsExtended = entityToClone.IsExtended;
