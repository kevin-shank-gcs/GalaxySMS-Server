  ...
  public partial class AccessPortal_PanelLoadDataPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public AccessPortal_PanelLoadDataPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ClusterNumber))
        ret.ClusterNumber = Convert.ToInt32(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ClusterNumber]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PanelNumber))
        ret.PanelNumber = Convert.ToInt32(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PanelNumber]);
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.IsEnabled))
        ret.IsEnabled = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.IsEnabled]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PropertiesLastUpdated))
        ret.PropertiesLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PropertiesLastUpdated]);
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.HardwareAddressLastUpdated))
        ret.HardwareAddressLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.HardwareAddressLastUpdated]);
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackIntoAreaLastUpdated))
        ret.PassbackIntoAreaLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackIntoAreaLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AccessPortalLastUpdated))
        ret.AccessPortalLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AccessPortalLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackFromAreaLastUpdated))
        ret.PassbackFromAreaLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackFromAreaLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.FreeAccessSchLastUpdated))
        ret.FreeAccessSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.FreeAccessSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.CrisisFreeAccessSchLastUpdated))
        ret.CrisisFreeAccessSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.CrisisFreeAccessSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PinRequiredSchLastUpdated))
        ret.PinRequiredSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PinRequiredSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisableForcedOpenSchLastUpdated))
        ret.DisableForcedOpenSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisableForcedOpenSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisableOpenTooLongSchLastUpdated))
        ret.DisableOpenTooLongSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisableOpenTooLongSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AuxOutputSchLastUpdated))
        ret.AuxOutputSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AuxOutputSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AuxOutputLastUpdated))
        ret.AuxOutputLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AuxOutputLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Relay2SchLastUpdated))
        ret.Relay2SchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Relay2SchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ForcedOpenAlertLastUpdated))
        ret.ForcedOpenAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ForcedOpenAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.OpenTooLongAlertLastUpdated))
        ret.OpenTooLongAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.OpenTooLongAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.InvalidAccessAttemptAlertLastUpdated))
        ret.InvalidAccessAttemptAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.InvalidAccessAttemptAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackViolationAlertLastUpdated))
        ret.PassbackViolationAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackViolationAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DuressAlertLastUpdated))
        ret.DuressAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DuressAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.MissedHeartbeatAlertLastUpdated))
        ret.MissedHeartbeatAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.MissedHeartbeatAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AccessGrantedAlertLastUpdated))
        ret.AccessGrantedAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AccessGrantedAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DoorGroupAlertLastUpdated))
        ret.DoorGroupAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DoorGroupAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.UnlockedByIogLastUpdated))
        ret.UnlockedByIogLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.UnlockedByIogLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.LockedByIogLastUpdated))
        ret.LockedByIogLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.LockedByIogLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog1LastUpdated))
        ret.DisarmIog1LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog1LastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog2LastUpdated))
        ret.DisarmIog2LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog2LastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog3LastUpdated))
        ret.DisarmIog3LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog3LastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog4LastUpdated))
        ret.DisarmIog4LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DisarmIog4LastUpdated]);
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ForcedOpenAlertEventIsActive))
        ret.ForcedOpenAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ForcedOpenAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.OpenTooLongAlertEventIsActive))
        ret.OpenTooLongAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.OpenTooLongAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.InvalidAccessAttemptAlertEventIsActive))
        ret.InvalidAccessAttemptAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.InvalidAccessAttemptAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackViolationAlertEventIsActive))
        ret.PassbackViolationAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.PassbackViolationAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DuressAlertEventIsActive))
        ret.DuressAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DuressAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.MissedHeartbeatAlertEventIsActive))
        ret.MissedHeartbeatAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.MissedHeartbeatAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AccessGrantedAlertEventIsActive))
        ret.AccessGrantedAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.AccessGrantedAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DoorGroupAlertEventIsActive))
        ret.DoorGroupAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DoorGroupAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.UnlockedByAlertEventIsActive))
        ret.UnlockedByAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.UnlockedByAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.LockedByAlertEventIsActive))
        ret.LockedByAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.LockedByAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm1AlertEventIsActive))
        ret.Disarm1AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm1AlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm2AlertEventIsActive))
        ret.Disarm2AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm2AlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm3AlertEventIsActive))
        ret.Disarm3AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm3AlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm4AlertEventIsActive))
        ret.Disarm4AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.Disarm4AlertEventIsActive]);
