...
namespace GalaxySMS.BusinessLayer
{
  ...
  public partial class GalaxyClusterPanelCpuInformationPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public GalaxyClusterPanelCpuInformationPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(GalaxyClusterPanelCpuInformationPDSAValidator.ColumnNames.EntityType))
        ret.EntityType = PDSAString.ConvertToStringTrim(values[GalaxyClusterPanelCpuInformationPDSAValidator.ColumnNames.EntityType]);
      ...
      if (values.ContainsKey(GalaxyClusterPanelCpuInformationPDSAValidator.ColumnNames.IsConnected))
        ret.IsConnected = Convert.ToBoolean(values[GalaxyClusterPanelCpuInformationPDSAValidator.ColumnNames.IsConnected]);
