  ...
  public partial class InputDevicePDSAManager : PDSADataClassManagerBase
  {
    ...
    public InputDevicePDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.InsertDate))
        ret.InsertDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[InputDevicePDSAValidator.ColumnNames.InsertDate]);
      ...
      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.UpdateDate))
        ret.UpdateDate = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[InputDevicePDSAValidator.ColumnNames.UpdateDate]);
      ...
      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.IsBoundToHardware))
        ret.IsBoundToHardware = Convert.ToBoolean(values[InputDevicePDSAValidator.ColumnNames.IsBoundToHardware]);
      ...
      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.PageNumber))
        ret.PageNumber = Convert.ToInt32(values[InputDevicePDSAValidator.ColumnNames.PageNumber]);

      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.PageSize))
        ret.PageSize = Convert.ToInt32(values[InputDevicePDSAValidator.ColumnNames.PageSize]);

      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.TotalRowCount))
        ret.TotalRowCount = Convert.ToInt32(values[InputDevicePDSAValidator.ColumnNames.TotalRowCount]);

      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.SortColumn))
        ret.SortColumn = PDSAString.ConvertToStringTrim(values[InputDevicePDSAValidator.ColumnNames.SortColumn]);

      if (values.ContainsKey(InputDevicePDSAValidator.ColumnNames.DescendingOrder))
        ret.DescendingOrder = Convert.ToBoolean(values[InputDevicePDSAValidator.ColumnNames.DescendingOrder]);
