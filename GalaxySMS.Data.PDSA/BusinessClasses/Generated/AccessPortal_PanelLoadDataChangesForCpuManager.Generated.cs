...
namespace GalaxySMS.BusinessLayer
{
  ...
  public partial class AccessPortal_PanelLoadDataChangesForCpuPDSAManager : PDSADataClassManagerReadOnlyBase
  {
    ...
    public AccessPortal_PanelLoadDataChangesForCpuPDSA DictionaryToEntity(Dictionary<string, string> values)
    {
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsEnabled))
        ret.IsEnabled = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.IsEnabled]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PropertiesLastUpdated))
        ret.PropertiesLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PropertiesLastUpdated]);
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AccessPortalLastUpdated))
        ret.AccessPortalLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AccessPortalLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.HardwareAddressLastUpdated))
        ret.HardwareAddressLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.HardwareAddressLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackIntoAreaLastUpdated))
        ret.PassbackIntoAreaLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackIntoAreaLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackFromAreaLastUpdated))
        ret.PassbackFromAreaLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackFromAreaLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.FreeAccessSchLastUpdated))
        ret.FreeAccessSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.FreeAccessSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CrisisFreeAccessSchLastUpdated))
        ret.CrisisFreeAccessSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CrisisFreeAccessSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PinRequiredSchLastUpdated))
        ret.PinRequiredSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PinRequiredSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisableForcedOpenSchLastUpdated))
        ret.DisableForcedOpenSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisableForcedOpenSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisableOpenTooLongSchLastUpdated))
        ret.DisableOpenTooLongSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisableOpenTooLongSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AuxOutputSchLastUpdated))
        ret.AuxOutputSchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AuxOutputSchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AuxOutputLastUpdated))
        ret.AuxOutputLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AuxOutputLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Relay2SchLastUpdated))
        ret.Relay2SchLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Relay2SchLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ForcedOpenAlertLastUpdated))
        ret.ForcedOpenAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ForcedOpenAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.OpenTooLongAlertLastUpdated))
        ret.OpenTooLongAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.OpenTooLongAlertLastUpdated]);
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.InvalidAccessAttemptAlertLastUpdated))
        ret.InvalidAccessAttemptAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.InvalidAccessAttemptAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackViolationAlertLastUpdated))
        ret.PassbackViolationAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackViolationAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DuressAlertLastUpdated))
        ret.DuressAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DuressAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MissedHeartbeatAlertLastUpdated))
        ret.MissedHeartbeatAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MissedHeartbeatAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AccessGrantedAlertLastUpdated))
        ret.AccessGrantedAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AccessGrantedAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DoorGroupAlertLastUpdated))
        ret.DoorGroupAlertLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DoorGroupAlertLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.UnlockedByIogLastUpdated))
        ret.UnlockedByIogLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.UnlockedByIogLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LockedByIogLastUpdated))
        ret.LockedByIogLastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LockedByIogLastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog1LastUpdated))
        ret.DisarmIog1LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog1LastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog2LastUpdated))
        ret.DisarmIog2LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog2LastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog3LastUpdated))
        ret.DisarmIog3LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog3LastUpdated]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog4LastUpdated))
        ret.DisarmIog4LastUpdated = GCS.Core.Common.Extensions.DateTimeExtensions.ToDateTimeOffset(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DisarmIog4LastUpdated]);
      ...
      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ForcedOpenAlertEventIsActive))
        ret.ForcedOpenAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ForcedOpenAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.OpenTooLongAlertEventIsActive))
        ret.OpenTooLongAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.OpenTooLongAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.InvalidAccessAttemptAlertEventIsActive))
        ret.InvalidAccessAttemptAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.InvalidAccessAttemptAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackViolationAlertEventIsActive))
        ret.PassbackViolationAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.PassbackViolationAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DuressAlertEventIsActive))
        ret.DuressAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DuressAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MissedHeartbeatAlertEventIsActive))
        ret.MissedHeartbeatAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MissedHeartbeatAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AccessGrantedAlertEventIsActive))
        ret.AccessGrantedAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.AccessGrantedAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DoorGroupAlertEventIsActive))
        ret.DoorGroupAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DoorGroupAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.UnlockedByAlertEventIsActive))
        ret.UnlockedByAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.UnlockedByAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LockedByAlertEventIsActive))
        ret.LockedByAlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.LockedByAlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm1AlertEventIsActive))
        ret.Disarm1AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm1AlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm2AlertEventIsActive))
        ret.Disarm2AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm2AlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm3AlertEventIsActive))
        ret.Disarm3AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm3AlertEventIsActive]);

      if (values.ContainsKey(AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm4AlertEventIsActive))
        ret.Disarm4AlertEventIsActive = Convert.ToBoolean(values[AccessPortal_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.Disarm4AlertEventIsActive]);
