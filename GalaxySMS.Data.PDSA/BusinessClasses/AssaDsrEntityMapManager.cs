...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AssaDsrEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AssaDsrEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AssaDsrEntityMapPDSA object</param>
    public void InitEntityObject(AssaDsrEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AssaDsrEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AssaDsrEntityMap objects 
    /// </summary>
    public IEnumerable<AssaDsrEntityMap> ConvertPDSACollection(AssaDsrEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<AssaDsrEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AssaDsrEntityMap();
