...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class TimePeriodEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an TimePeriodEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An TimePeriodEntityMapPDSA object</param>
    public void InitEntityObject(TimePeriodEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(TimePeriodEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent TimePeriodEntityMap objects 
    /// </summary>
    public IEnumerable<TimePeriodEntityMap> ConvertPDSACollection(TimePeriodEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<TimePeriodEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new TimePeriodEntityMap();
