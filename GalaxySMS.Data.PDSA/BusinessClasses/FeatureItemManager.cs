...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class FeatureItemPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an FeatureItemPDSA object with any default values
    /// </summary>
    /// <param name="entity">An FeatureItemPDSA object</param>
    public void InitEntityObject(FeatureItemPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(FeatureItem entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent FeatureItem objects 
    /// </summary>
    public IEnumerable<FeatureItem> ConvertPDSACollection(FeatureItemPDSACollection pdsaCollection)
    {	
	 var results = new List<FeatureItem>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new FeatureItem();
