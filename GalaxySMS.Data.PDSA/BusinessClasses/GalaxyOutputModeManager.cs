...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyOutputModePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyOutputModePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyOutputModePDSA object</param>
    public void InitEntityObject(GalaxyOutputModePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyOutputMode entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyOutputMode objects
    /// </summary>
    public IEnumerable<GalaxyOutputMode> ConvertPDSACollection(GalaxyOutputModePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyOutputMode>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyOutputMode();
