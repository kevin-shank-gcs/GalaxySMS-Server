...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyHardwareModuleTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyHardwareModuleTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyHardwareModuleTypePDSA object</param>
    public void InitEntityObject(GalaxyHardwareModuleTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyHardwareModuleType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyHardwareModuleType objects
    /// </summary>
    public IEnumerable<GalaxyHardwareModuleType> ConvertPDSACollection(GalaxyHardwareModuleTypePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyHardwareModuleType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyHardwareModuleType();
