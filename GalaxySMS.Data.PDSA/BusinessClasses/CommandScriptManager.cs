...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CommandScriptPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CommandScriptPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CommandScriptPDSA object</param>
    public void InitEntityObject(CommandScriptPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CommandScript entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CommandScript objects
    /// </summary>
    public IEnumerable<CommandScript> ConvertPDSACollection(CommandScriptPDSACollection pdsaCollection)
    {	
	 var results = new List<CommandScript>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CommandScript();
