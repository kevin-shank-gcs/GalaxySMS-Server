...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class StateProvincePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an StateProvincePDSA object with any default values
    /// </summary>
    /// <param name="entity">An StateProvincePDSA object</param>
    public void InitEntityObject(StateProvincePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(StateProvince entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent StateProvince objects 
    /// </summary>
    public IEnumerable<StateProvince> ConvertPDSACollection(StateProvincePDSACollection pdsaCollection)
    {	
	 var results = new List<StateProvince>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new StateProvince();
