...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AssaDayPeriodPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AssaDayPeriodPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AssaDayPeriodPDSA object</param>
    public void InitEntityObject(AssaDayPeriodPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AssaDayPeriod entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AssaDayPeriod objects 
    /// </summary>
    public IEnumerable<AssaDayPeriod> ConvertPDSACollection(AssaDayPeriodPDSACollection pdsaCollection)
    {	
	 var results = new List<AssaDayPeriod>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AssaDayPeriod();
