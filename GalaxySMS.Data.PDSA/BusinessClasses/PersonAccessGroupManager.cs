...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonAccessGroupPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonAccessGroupPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonAccessGroupPDSA object</param>
    public void InitEntityObject(PersonAccessGroupPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonAccessGroup entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonAccessGroup objects
    /// </summary>
    public IEnumerable<PersonAccessGroup> ConvertPDSACollection(PersonAccessGroupPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonAccessGroup>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonAccessGroup();
