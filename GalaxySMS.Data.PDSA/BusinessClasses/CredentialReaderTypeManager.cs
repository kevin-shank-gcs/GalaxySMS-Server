...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialReaderTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialReaderTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialReaderTypePDSA object</param>
    public void InitEntityObject(CredentialReaderTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CredentialReaderType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialReaderType objects 
    /// </summary>
    public IEnumerable<CredentialReaderType> ConvertPDSACollection(CredentialReaderTypePDSACollection pdsaCollection)
    {	
	 var results = new List<CredentialReaderType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CredentialReaderType();
