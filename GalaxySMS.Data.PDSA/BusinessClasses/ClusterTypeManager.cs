...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class ClusterTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an ClusterTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An ClusterTypePDSA object</param>
    public void InitEntityObject(ClusterTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(ClusterType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent ClusterType objects
    /// </summary>
    public IEnumerable<ClusterType> ConvertPDSACollection(ClusterTypePDSACollection pdsaCollection)
    {	
	 var results = new List<ClusterType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new ClusterType();
