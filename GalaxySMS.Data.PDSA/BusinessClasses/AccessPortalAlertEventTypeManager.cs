...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalAlertEventTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalAlertEventTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalAlertEventTypePDSA object</param>
    public void InitEntityObject(AccessPortalAlertEventTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalAlertEventType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalAlertEventType objects
    /// </summary>
    public IEnumerable<AccessPortalAlertEventType> ConvertPDSACollection(AccessPortalAlertEventTypePDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalAlertEventType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalAlertEventType();
