...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonLcdMessagePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonLcdMessagePDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonLcdMessagePDSA object</param>
    public void InitEntityObject(PersonLcdMessagePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonLcdMessage entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonLcdMessage objects
    /// </summary>
    public IEnumerable<PersonLcdMessage> ConvertPDSACollection(PersonLcdMessagePDSACollection pdsaCollection)
    {	
	 var results = new List<PersonLcdMessage>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonLcdMessage();
