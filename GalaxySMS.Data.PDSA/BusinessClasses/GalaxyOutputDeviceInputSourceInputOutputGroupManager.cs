...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyOutputDeviceInputSourceInputOutputGroupPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyOutputDeviceInputSourceInputOutputGroupPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyOutputDeviceInputSourceInputOutputGroupPDSA object</param>
    public void InitEntityObject(GalaxyOutputDeviceInputSourceInputOutputGroupPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyOutputDeviceInputSourceInputOutputGroup entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyOutputDeviceInputSourceInputOutputGroup objects
    /// </summary>
    public IEnumerable<GalaxyOutputDeviceInputSourceInputOutputGroup> ConvertPDSACollection(GalaxyOutputDeviceInputSourceInputOutputGroupPDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyOutputDeviceInputSourceInputOutputGroup>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyOutputDeviceInputSourceInputOutputGroup();
