...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonEmailAddressPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonEmailAddressPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonEmailAddressPDSA object</param>
    public void InitEntityObject(PersonEmailAddressPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonEmailAddress entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonEmailAddress objects
    /// </summary>
    public IEnumerable<PersonEmailAddress> ConvertPDSACollection(PersonEmailAddressPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonEmailAddress>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonEmailAddress();
