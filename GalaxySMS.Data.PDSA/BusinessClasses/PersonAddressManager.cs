...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonAddressPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonAddressPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonAddressPDSA object</param>
    public void InitEntityObject(PersonAddressPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonAddress entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonAddress objects
    /// </summary>
    public IEnumerable<PersonAddress> ConvertPDSACollection(PersonAddressPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonAddress>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonAddress();
