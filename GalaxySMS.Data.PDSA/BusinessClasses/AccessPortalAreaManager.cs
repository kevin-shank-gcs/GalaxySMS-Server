...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalAreaPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalAreaPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalAreaPDSA object</param>
    public void InitEntityObject(AccessPortalAreaPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalArea entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalArea objects
    /// </summary>
    public IEnumerable<AccessPortalArea> ConvertPDSACollection(AccessPortalAreaPDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalArea>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalArea();
