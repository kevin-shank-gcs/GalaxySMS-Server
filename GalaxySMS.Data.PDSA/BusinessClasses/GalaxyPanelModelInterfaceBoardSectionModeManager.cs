...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelModelInterfaceBoardSectionModePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyPanelModelInterfaceBoardSectionModePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyPanelModelInterfaceBoardSectionModePDSA object</param>
    public void InitEntityObject(GalaxyPanelModelInterfaceBoardSectionModePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyPanelModelInterfaceBoardSectionMode entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyPanelModelInterfaceBoardSectionMode objects
    /// </summary>
    public IEnumerable<GalaxyPanelModelInterfaceBoardSectionMode> ConvertPDSACollection(GalaxyPanelModelInterfaceBoardSectionModePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyPanelModelInterfaceBoardSectionMode>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyPanelModelInterfaceBoardSectionMode();
