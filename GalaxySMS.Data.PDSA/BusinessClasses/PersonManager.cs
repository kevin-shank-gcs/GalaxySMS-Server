...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonPDSA object</param>
    public void InitEntityObject(PersonPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Person entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Person objects
    /// </summary>
    public IEnumerable<Person> ConvertPDSACollection(PersonPDSACollection pdsaCollection)
    {	
	 var results = new List<Person>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Person();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent Person objects
    /// </summary>
    public IEnumerable<Person> ConvertPDSACollection(IEnumerable<PersonPDSA> pdsaCollection)
    {	
	 var results = new List<Person>();
      foreach (var pdsaEntity in pdsaCollection)
      {
