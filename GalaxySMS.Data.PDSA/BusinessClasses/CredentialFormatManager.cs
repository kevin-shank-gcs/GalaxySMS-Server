...
namespace GalaxySMS.BusinessLayer
{
    ...
    /// </summary>
    public partial class CredentialFormatPDSAManager
    {
        ...
        /// <summary>
        /// Call this method to initialize an CredentialFormatPDSA object with any default values
        /// </summary>
        /// <param name="entity">An CredentialFormatPDSA object</param>
        public void InitEntityObject(CredentialFormatPDSA entity)
        {
        ...
        /// </summary>
        public void InitEntityObject(CredentialFormat entity)
        {
        ...
        /// <summary>
        /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialFormat objects
        /// </summary>
        public IEnumerable<CredentialFormat> ConvertPDSACollection(CredentialFormatPDSACollection pdsaCollection)
        {
            var results = new List<CredentialFormat>();
            foreach (var pdsaEntity in pdsaCollection)
            {
                var convertedEntity = new CredentialFormat();
        ...
        /// <summary>
        /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent CredentialFormat objects
        /// </summary>
        public IEnumerable<CredentialFormat> ConvertPDSACollection(IEnumerable<CredentialFormatPDSA> pdsaCollection)
        {
            var results = new List<CredentialFormat>();
            foreach (var pdsaEntity in pdsaCollection)
            {
