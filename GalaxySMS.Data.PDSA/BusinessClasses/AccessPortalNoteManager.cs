...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalNotePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalNotePDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalNotePDSA object</param>
    public void InitEntityObject(AccessPortalNotePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalNote entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalNote objects
    /// </summary>
    public IEnumerable<AccessPortalNote> ConvertPDSACollection(AccessPortalNotePDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalNote>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalNote();
