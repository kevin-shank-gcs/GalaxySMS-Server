...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyInputModePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyInputModePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyInputModePDSA object</param>
    public void InitEntityObject(GalaxyInputModePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyInputMode entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyInputMode objects
    /// </summary>
    public IEnumerable<GalaxyInputMode> ConvertPDSACollection(GalaxyInputModePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyInputMode>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyInputMode();
