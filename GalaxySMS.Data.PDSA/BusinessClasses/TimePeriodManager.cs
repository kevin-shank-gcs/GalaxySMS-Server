...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class TimePeriodPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an TimePeriodPDSA object with any default values
    /// </summary>
    /// <param name="entity">An TimePeriodPDSA object</param>
    public void InitEntityObject(TimePeriodPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(TimePeriod entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent TimePeriod objects
    /// </summary>
    public IEnumerable<TimePeriod> ConvertPDSACollection(TimePeriodPDSACollection pdsaCollection)
    {	
	 var results = new List<TimePeriod>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new TimePeriod();
