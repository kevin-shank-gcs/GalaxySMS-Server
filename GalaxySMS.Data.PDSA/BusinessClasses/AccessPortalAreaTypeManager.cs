...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalAreaTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalAreaTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalAreaTypePDSA object</param>
    public void InitEntityObject(AccessPortalAreaTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalAreaType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalAreaType objects
    /// </summary>
    public IEnumerable<AccessPortalAreaType> ConvertPDSACollection(AccessPortalAreaTypePDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalAreaType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalAreaType();
