...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsEntityPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsEntityPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsEntityPDSA object</param>
    public void InitEntityObject(gcsEntityPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsEntity entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsEntity objects
    /// </summary>
    public IEnumerable<gcsEntity> ConvertPDSACollection(gcsEntityPDSACollection pdsaCollection)
    {	
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent gcsEntity objects
    /// </summary>
    public IEnumerable<gcsEntity> ConvertPDSACollection(IEnumerable<gcsEntityPDSA> pdsaCollection)
    {	
	 var results = new List<gcsEntity>();
      foreach (var pdsaEntity in pdsaCollection)
      {
