...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class LiquidCrystalDisplayPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an LiquidCrystalDisplayPDSA object with any default values
    /// </summary>
    /// <param name="entity">An LiquidCrystalDisplayPDSA object</param>
    public void InitEntityObject(LiquidCrystalDisplayPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(LiquidCrystalDisplay entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent LiquidCrystalDisplay objects
    /// </summary>
    public IEnumerable<LiquidCrystalDisplay> ConvertPDSACollection(LiquidCrystalDisplayPDSACollection pdsaCollection)
    {	
	 var results = new List<LiquidCrystalDisplay>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new LiquidCrystalDisplay();
