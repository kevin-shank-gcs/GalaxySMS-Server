...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialBqt36BitPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialBqt36BitPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialBqt36BitPDSA object</param>
    public void InitEntityObject(CredentialBqt36BitPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CredentialBqt36Bit entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialBqt36Bit objects
    /// </summary>
    public IEnumerable<CredentialBqt36Bit> ConvertPDSACollection(CredentialBqt36BitPDSACollection pdsaCollection)
    {	
	 var results = new List<CredentialBqt36Bit>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CredentialBqt36Bit();
