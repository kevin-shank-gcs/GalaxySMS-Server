...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsUserOldPasswordPDSAManager
  {
    ...
    public void InitEntityObject(gcsUserOldPassword entity)
    {
        SimpleMapper.PropertyMap(entity, Entity);
    }

    public IEnumerable<gcsUserOldPassword> ConvertPDSACollection(gcsUserOldPasswordPDSACollection pdsaCollection)
    {
        List<gcsUserOldPassword> results = new List<gcsUserOldPassword>();
        foreach (var pdsaEntity in pdsaCollection)
        {
            gcsUserOldPassword convertedEntity = new gcsUserOldPassword();
    ...
    /// <summary>
    /// Call this method to initialize an gcsUserOldPasswordPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsUserOldPasswordPDSA object</param>
    public void InitEntityObject(gcsUserOldPasswordPDSA entity)
    {
