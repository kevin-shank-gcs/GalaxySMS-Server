...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsUserRequirementsPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsUserRequirementsPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsUserRequirementsPDSA object</param>
    public void InitEntityObject(gcsUserRequirementsPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsUserRequirement entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsUserRequirements objects
    /// </summary>
    public IEnumerable<gcsUserRequirement> ConvertPDSACollection(gcsUserRequirementsPDSACollection pdsaCollection)
    {	
	 var results = new List<gcsUserRequirement>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsUserRequirement();
