...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialFormatDataFieldPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialFormatDataFieldPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialFormatDataFieldPDSA object</param>
    public void InitEntityObject(CredentialFormatDataFieldPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CredentialFormatDataField entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialFormatDataField objects
    /// </summary>
    public IEnumerable<CredentialFormatDataField> ConvertPDSACollection(CredentialFormatDataFieldPDSACollection pdsaCollection)
    {	
	 var results = new List<CredentialFormatDataField>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CredentialFormatDataField();
