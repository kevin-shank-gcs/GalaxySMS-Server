...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GenderPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GenderPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GenderPDSA object</param>
    public void InitEntityObject(GenderPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Gender entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Gender objects
    /// </summary>
    public IEnumerable<Gender> ConvertPDSACollection(GenderPDSACollection pdsaCollection)
    {	
	 var results = new List<Gender>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Gender();
