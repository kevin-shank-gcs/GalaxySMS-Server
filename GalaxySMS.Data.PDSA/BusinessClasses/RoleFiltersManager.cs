...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class RoleFiltersPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an RoleFiltersPDSA object with any default values
    /// </summary>
    /// <param name="entity">An RoleFiltersPDSA object</param>
    public void InitEntityObject(RoleFiltersPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(RoleFilters entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent RoleFilters objects
    /// </summary>
    public IEnumerable<RoleFilters> ConvertPDSACollection(RoleFiltersPDSACollection pdsaCollection)
    {	
	 var results = new List<RoleFilters>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new RoleFilters();
    ...
    /// <summary>
    /// Call this method to convert a IEnumerable<T> to an IEnumerable collection of an equivalent RoleFilters objects
    /// </summary>
    public IEnumerable<RoleFilters> ConvertPDSACollection(IEnumerable<RoleFiltersPDSA> pdsaCollection)
    {	
	 var results = new List<RoleFilters>();
      foreach (var pdsaEntity in pdsaCollection)
      {
