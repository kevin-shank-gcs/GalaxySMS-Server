...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AssaDsrTimeScheduleMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AssaDsrTimeScheduleMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AssaDsrTimeScheduleMapPDSA object</param>
    public void InitEntityObject(AssaDsrTimeScheduleMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AssaDsrTimeScheduleMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AssaDsrTimeScheduleMap objects 
    /// </summary>
    public IEnumerable<AssaDsrTimeScheduleMap> ConvertPDSACollection(AssaDsrTimeScheduleMapPDSACollection pdsaCollection)
    {	
	 var results = new List<AssaDsrTimeScheduleMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AssaDsrTimeScheduleMap();
