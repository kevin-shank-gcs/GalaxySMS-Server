...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelModelPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyPanelModelPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyPanelModelPDSA object</param>
    public void InitEntityObject(GalaxyPanelModelPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyPanelModel entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyPanelModel objects
    /// </summary>
    public IEnumerable<GalaxyPanelModel> ConvertPDSACollection(GalaxyPanelModelPDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyPanelModel>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyPanelModel();
