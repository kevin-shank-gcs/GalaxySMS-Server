...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsEntityApplicationPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsEntityApplicationPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsEntityApplicationPDSA object</param>
    public void InitEntityObject(gcsEntityApplicationPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsEntityApplication entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsEntityApplication objects
    /// </summary>
    public IEnumerable<gcsEntityApplication> ConvertPDSACollection(gcsEntityApplicationPDSACollection pdsaCollection)
    {	
	 var results = new List<gcsEntityApplication>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsEntityApplication();
