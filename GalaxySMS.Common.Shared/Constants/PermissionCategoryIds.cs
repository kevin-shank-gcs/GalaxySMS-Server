...
namespace GalaxySMS.Common.Constants
{
    ...
    public class PermissionCategoryIds
    {
        ...
        public static readonly Guid BadgeTemplateDataAccessEditingCategoryId = new Guid("1FA691FC-2362-4EA2-8EBC-CBC961205909");
        /// <summary>   Identifier for the badge layout data access editing category. </summary>
        public static readonly Guid DepartmentDataAccessEditingCategoryId = new Guid("25721b4e-e34f-46d1-9c4e-6a58a1b536f5");

        /// <summary>   Identifier for the person selection item data access editing category. </summary>
        public static readonly Guid PersonSelectionItemDataAccessEditingCategoryId = new Guid("02764772-47E6-4D5E-992A-31E0BFEF1BC5");
        ...
        /// <summary>   Identifier for the access portal command category. </summary>
        public static readonly Guid AlarmAlertCommandCategoryId = new Guid("04D40DC7-F42E-448B-98EB-1EDF2C559DBA");
    }
}
