...
namespace GalaxySMS.Common.Constants
{
    ...
    public class AccessPortalTypeIds
    {
        ...
        /// <summary>   The access portal type standard entry point inverted data clock. </summary>
        public static readonly Guid AccessPortalType_StandardEntryPoint_InvertedDataClock = new Guid("71428011-94e5-4f1a-a6a5-d8b90217c205");

        /// <summary>   The access portal type standard entry point essex keypad. </summary>
        public static readonly Guid AccessPortalType_StandardEntryPoint_EssexKeypad = new Guid("93df4613-ac3c-471d-ba08-8120cfad99c7");
