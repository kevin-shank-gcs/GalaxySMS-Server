...
namespace GalaxySMS.Common.Constants
{
    ...
    public enum LicenseFeatureKey
    {
        ...
        /// <summary>   An enum constant representing the maximum badging printers option. </summary>
        MaximumBadgePrinters,
    ...
    public class DefaultTrialLicenseValues
    {
        ...
        /// <summary>   The maximum badge printers. </summary>
        public const int MaximumBadgePrinters = 10;
