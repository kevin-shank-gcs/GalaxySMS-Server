...
namespace GalaxySMS.Common.Constants
{
    ...
    public class GalaxyClusterCommandIds
    {
        ...
        /// <summary>   Information describing the galaxy cluster command request board. </summary>
        public static readonly Guid GalaxyClusterCommand_RequestBoardInformation = new Guid("00000000-0000-0000-0000-000000000067");
