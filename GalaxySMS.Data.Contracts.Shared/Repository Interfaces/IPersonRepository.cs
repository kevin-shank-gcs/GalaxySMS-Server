...
namespace GalaxySMS.Data.Contracts
{
    public interface IPersonRepository : IDataRepository<Person>, IHasGetEntityId
    {
        ...
        ArrayResponse<PersonSummary> AdvancedSearchForPersonSummaryPaged(IApplicationUserSessionDataHeader sessionData, PersonSummarySearchParameters getParameters);
