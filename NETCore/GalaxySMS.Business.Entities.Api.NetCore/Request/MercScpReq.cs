...
{
    public partial class MercScpReq
    {
        ...
        public MercuryPanelType MercScpType { get; set; }

        [Required]
        [RequiredGuidNotEmpty(nameof(MercScpGroupUid))]
        ...
        public int ConnectionType { get; set; } = (int)MercScpConnectionType.IPClient;

        [EnumDataType(typeof(GalaxySMS.Common.Enums.MercScpConnectionType))]
        public MercScpConnectionType ScpConnectionType { get; set; }
        ...
        [Range(2000, 60000)] 
        public int TcpConnectRetryInterval { get; set; } = 30000;

        public int RetryCountBeforeOffline { get; set; }

        [Range(2000, 65000)] 
        public int OfflineTime { get; set; } = 32000;
        ...
        public bool UseDaylightSavingsTime { get; set; } = true;

        [Range(10000, int.MaxValue)] 
        public int TransactionCount { get; set; } = 100000;

        [Range(10000, int.MaxValue)] 
        public int TransactionUnreportedLimit { get; set; } = 10000;

        public bool DualPortEnabled { get; set; } = false;

        public int ConnectionTypeAlt { get; set; } = (int) MercScpConnectionType.None;
        ...
        [Range(500, 5000)] 
        public int PollDelayAlt { get; set; } = 5000;
