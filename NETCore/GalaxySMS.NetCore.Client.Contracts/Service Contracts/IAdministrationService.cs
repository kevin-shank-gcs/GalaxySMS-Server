...
namespace GalaxySMS.Client.Contracts.NetCore
{
    ...
    public interface IAdministrationService : IServiceContract
    {
        ...
        [OperationContract]
        //        Task<gcsEntityBasic[]> GetEntityListForUserAsync(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        gcsApplicationBasic[] GetAllApplicationBasic();
        ...
        [OperationContract]
        void SaveApplicationAuditData(SaveParameters<gcsApplicationAudit> auditData);
        ...
        [OperationContract]
        Task<gcsApplicationBasic[]> GetAllApplicationBasicAsync();
        ...
        [OperationContract]
        Task SaveApplicationAuditDataAsync(SaveParameters<gcsApplicationAudit> auditData);
        ...
        [OperationContract]
        ArrayResponse<gcsRole> GetAllRolesForApplication(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        ApplicationRoleEditingData GetRoleEditingData(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        Task<ArrayResponse<gcsRole>> GetAllRolesForApplicationAsync(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        Task<ApplicationRoleEditingData> GetRoleEditingDataAsync(GetParametersWithPhoto parameters);
        #endregion
        #endregion
        ...
        [OperationContract]
        Task<gcsUser> SaveUserSaveAsync(SaveParameters<gcsUserSave> parameters);
        ...
        [OperationContract]
        Task<Country> GetCountryByIsoAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<Country> GetCountryByIso3Async(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<Country[]> GetCountriesByCountryNameAsync(GetParametersWithPhoto parameters);
