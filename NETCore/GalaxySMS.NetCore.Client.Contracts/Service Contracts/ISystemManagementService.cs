...
namespace GalaxySMS.Client.Contracts.NetCore
{
    ...
    public interface ISystemManagementService : IServiceContract
    {
        ...
        //[TransactionFlow(TransactionFlowOption.Allowed)]
        [FaultContract(typeof(ExceptionDetailEx))]
        bool ExecuteInputDeviceCommand(CommandParameters<InputDeviceCommandAction> parameters);
        ...
        [OperationContract]
        Task<bool> ExecuteInputDeviceCommandAsync(CommandParameters<InputDeviceCommandAction> parameters);
        ...
        //[TransactionFlow(TransactionFlowOption.Allowed)]
        [FaultContract(typeof(ExceptionDetailEx))]
        bool ExecuteOutputDeviceCommand(CommandParameters<OutputDeviceCommandAction> parameters);
        ...
        [OperationContract]
        Task<bool> ExecuteOutputDeviceCommandAsync(CommandParameters<OutputDeviceCommandAction> parameters);
        ...
        [OperationContract]
        ArrayResponse<ListItemBase> GetAllTimeSchedulesList(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<TimeSchedule> GetAllTimeSchedulesForEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<ListItemBase> GetAllTimeSchedulesForEntityList(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        Task<ArrayResponse<ListItemBase>> GetAllTimeSchedulesListAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<TimeSchedule>> GetAllTimeSchedulesForEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<ListItemBase>> GetAllTimeSchedulesForEntityListAsync(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        ArrayResponse<ListItemBase> GetAllGalaxyTimePeriodsList(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<GalaxyTimePeriod> GetAllGalaxyTimePeriodsForEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<ListItemBase> GetAllGalaxyTimePeriodsListForEntity(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        Task<ArrayResponse<ListItemBase> GetAllGalaxyTimePeriodsListAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<GalaxyTimePeriod>> GetAllGalaxyTimePeriodsForEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<ListItemBase>> GetAllGalaxyTimePeriodsListForEntityAsync(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        ListItemBase[] GetAllDayTypesList(GetParametersWithPhoto parameters);

        [OperationContract]
        DayType[] GetAllDayTypesForEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        ListItemBase[] GetAllDayTypesListForEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        DayType[] GetAllDayTypesForMappedEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        ListItemBase[] GetAllDayTypesListForMappedEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        DayType[] GetAllDayTypesForCluster(GetParametersWithPhoto parameters);

        [OperationContract]
        ListItemBase[] GetAllDayTypesListForCluster(GetParametersWithPhoto parameters);

        [OperationContract]
        DayType[] GetAllDayTypesForAssaAbloyDsr(GetParametersWithPhoto parameters);

        [OperationContract]
        ListItemBase[] GetAllDayTypesListForAssaAbloyDsr(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        Task<ListItemBase[]> GetAllDayTypesListAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<DayType[]> GetAllDayTypesForEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ListItemBase[]> GetAllDayTypesListForEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<DayType[]> GetAllDayTypesForMappedEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ListItemBase[]> GetAllDayTypesListForMappedEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<DayType[]> GetAllDayTypesForClusterAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ListItemBase[]> GetAllDayTypesListForClusterAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<DayType[]> GetAllDayTypesForAssaAbloyDsrAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ListItemBase[]> GetAllDayTypesListForAssaAbloyDsrAsync(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        bool SendClusterDataToPanels(CommandParameters<ClusterDataLoadParameters> parameters);
        ...
        [OperationContract]
        Task<bool> SendClusterDataToPanelsAsync(CommandParameters<ClusterDataLoadParameters> parameters);
        ...
        //[TransactionFlow(TransactionFlowOption.Allowed)]
        [FaultContract(typeof(ExceptionDetailEx))]
        bool ExecuteClusterCommand(CommandParameters<ClusterCommandAction> parameters);
        ...
        [OperationContract]
        Task<bool> ExecuteClusterCommandAsync(CommandParameters<ClusterCommandAction> parameters);
        ...
        #region Synchronous Operations
        [OperationContract]
        ArrayResponse<AccessGroup> GetAllAccessGroups(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<AccessGroup> GetAllAccessGroupsForEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<AccessGroup> GetAllAccessGroupsForCluster(GetParametersWithPhoto parameters);
        ...
        #region Async Operations
        [OperationContract]
        Task<ArrayResponse<AccessGroup>> GetAllAccessGroupsAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<AccessGroup>> GetAllAccessGroupsForEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<AccessGroup>> GetAllAccessGroupsForClusterAsync(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        ArrayResponse<ListItemBase> GetAllAccessProfilesList(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<AccessProfile> GetAllAccessProfilesForEntity(GetParametersWithPhoto parameters);

        [OperationContract]
        ArrayResponse<ListItemBase> GetAllAccessProfilesListForEntity(GetParametersWithPhoto parameters);
        ...
        [OperationContract]
        Task<ArrayResponse<ListItemBase>> GetAllAccessProfilesListAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<AccessProfile>> GetAllAccessProfilesForEntityAsync(GetParametersWithPhoto parameters);

        [OperationContract]
        Task<ArrayResponse<ListItemBase>> GetAllAccessProfilesListForEntityAsync(GetParametersWithPhoto parameters);
