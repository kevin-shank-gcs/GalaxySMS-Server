...
namespace GalaxySMS.Client.Contracts.NetCore
{
    ...
    public interface IUserSessionService : IServiceContract
    {
        ...
        [OperationContract]
        Task<bool> DoesUserHavePermissionAsync(Guid userId, Guid entityId, Guid permissionId);

        [OperationContract]
        Task<bool> IsUserInRoleAsync(Guid userId, Guid entityId, Guid roleId);

        [OperationContract]
        Task<bool> IsUserInRoleNameAsync(Guid userId, Guid entityId, string roleName);

        [OperationContract]
        Task<UserEntity> GetUserEntityAsync(Guid entityId);
