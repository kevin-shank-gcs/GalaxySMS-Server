...
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ReadOnlyCollection<CustomError> Errors { get; }
    ...
    public class ManagerBase : IManagerBase
    {
        ...
        public string GetErrorsString()
        {
            ...
            foreach (var error in Errors)
            {
                ...
                if (error.ErrorMessages.Any())
                {
                    foreach (var em in error.ErrorMessages)
                        sb.AppendFormat($", {em}");
                }
                sb.AppendLine();
            }
        ...
        public HttpStatusCode HttpStatusCode
        {
            get
            {
                ...
                foreach (var error in Errors)
                {
                    if (error.ExceptionDetailEx != null)
                        return error.ExceptionDetailEx.PreferredHttpStatusCode;
                }
