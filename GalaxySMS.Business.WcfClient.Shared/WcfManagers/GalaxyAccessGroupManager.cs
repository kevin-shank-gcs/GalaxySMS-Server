...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class GalaxyAccessGroupManager : ManagerBase
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Validates the access group described by data. </summary>
        ///
        /// <remarks>   Kevin, 10/18/2022. </remarks>
        ///
        ...
        public ValidationProblemDetails ValidateAccessGroup(SaveParameters<AccessGroup> data)
        {
            InitializeErrorsCollection();
            ...
            WithClient<ISystemManagementService>(
                _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                    GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            savedItem = proxy.ValidateAccessGroup(data);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Validates the access group asynchronous described by data. </summary>
        ///
        /// <remarks>   Kevin, 10/18/2022. </remarks>
        ///
        /// <param name="data"> The data. </param>
        ///
        /// <returns>   The validate access group. </returns>
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public async Task<ValidationProblemDetails> ValidateAccessGroupAsync(SaveParameters<AccessGroup> data)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                        GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), async proxy =>
                        {
                            var savedItem = await proxy.ValidateAccessGroupAsync(data);
                            return savedItem;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
