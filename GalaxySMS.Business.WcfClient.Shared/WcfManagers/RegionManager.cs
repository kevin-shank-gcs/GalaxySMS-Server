...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class RegionManager : ManagerBase
    {
        ...
        public ReadOnlyCollection<Region> GetRegionsForEntity(GetParametersWithPhoto parameters, bool rethrow)
        {
        ...
        public async Task<ReadOnlyCollection<Region>> GetRegionsForEntityAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            _Regions = new List<Region>();
        ...
        public ReadOnlyCollection<ListItemBase> GetRegionsListItemsForEntity(GetParametersWithPhoto parameters, bool rethrow)
        {
            InitializeErrorsCollection();
        ...
        public async Task<ReadOnlyCollection<ListItemBase>> GetRegionsListItemsForEntityAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            _RegionsList = new List<ListItemBase>();
