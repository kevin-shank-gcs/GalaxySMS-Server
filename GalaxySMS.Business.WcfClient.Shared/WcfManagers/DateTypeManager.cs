...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class DateTypeManager : ManagerBase
    {
        ...
        public ArrayResponse<DateType> DateTypes { get; internal set; }
        ...
        {
            DateTypes = new ArrayResponse<DateType>();
        }
            ...
            WithClient<ISystemManagementService>(
                _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                    GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            DateTypes = proxy.GetAllDateTypes(parameters);
                         }
        ...
        public async Task<ArrayResponse<DateType>> GetAllDateTypesAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                        ...
                        {
                            DateTypes = await proxy.GetAllDateTypesAsync(parameters);
                            return DateTypes;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
        ...
        public ArrayResponse<DateType> GetDateTypesForEntity(GetParametersWithPhoto parameters, bool rethrow)
        {
            InitializeErrorsCollection();
            ...
            WithClient<ISystemManagementService>(
                _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                    GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            DateTypes = proxy.GetAllDateTypesForEntity(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        public async Task<ArrayResponse<DateType>> GetDateTypesForEntityAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                        GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), async proxy =>
                        {
                            DateTypes = await proxy.GetAllDateTypesForEntityAsync(parameters);
                            return DateTypes;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
        ...
        public ArrayResponse<DateType> GetDateTypesForMappedEntity(GetParametersWithPhoto parameters, bool rethrow)
        {
            InitializeErrorsCollection();
            ...
            WithClient<ISystemManagementService>(
                _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                    GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            DateTypes = proxy.GetAllDateTypesForMappedEntity(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        public async Task<ArrayResponse<DateType>> GetDateTypesForMappedEntityAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                        GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), async proxy =>
                        {
                            DateTypes = await proxy.GetAllDateTypesForMappedEntityAsync(parameters);
                            return DateTypes;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
        ...
        public ArrayResponse<DateType> GetDateTypesForDayType(GetParametersWithPhoto parameters, bool rethrow)
        {
            InitializeErrorsCollection();
            ...
            WithClient<ISystemManagementService>(
                _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                    GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            DateTypes = proxy.GetAllDateTypesForDayType(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        public async Task<ArrayResponse<DateType>> GetAllDateTypesForDayTypeAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<ISystemManagementService>(Binding,
                        GetServiceAddress(ServiceNames.SystemManagementService), ClientUserSessionData), async proxy =>
                        {
                            DateTypes = await proxy.GetAllDateTypesForDayTypeAsync(parameters);
                            return DateTypes;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
