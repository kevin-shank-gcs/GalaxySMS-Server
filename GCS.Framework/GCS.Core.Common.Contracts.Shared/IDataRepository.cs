...
namespace GCS.Core.Common.Contracts
{
        ...
        where T : class, IIdentifiableEntity, new()
    {
        ...
        T Add(T entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams);
        ...
        T Update(T entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams);
        ...
        int Remove(T entity, IApplicationUserSessionDataHeader sessionData );
        ...
        int Remove(int id, IApplicationUserSessionDataHeader sessionData);
        ...
        int Remove(Guid id, IApplicationUserSessionDataHeader sessionData);
