...
namespace GCS.Framework.CredentialProcessor
{
    ...
    public class CredentialCypress37BitFormat : CredentialFormatBase
    {
        ...
        public const ushort FacilityCodeMinimumValue = 0;
        public const ushort FacilityCodeMaximumValue = 0xff;

        public const int IdCodeBitLength = 27;
        public const short IdCodeStartBitPosition = 10;
        public const int IdCodeMinimumValue = 0;
        public const uint IdCodeMaximumValue = 0x7ffffff;   // 0x7ffffff

        public CredentialCypress37BitFormat()
        {
        ...
        public CredentialCypress37BitFormat(ushort facilityCode, ushort idCode)
        {
            BitCount = TotalBitLength;//37;
        ...
        public static ICredentialFormatInstance GetCredentialFormatInstance()
        {
            ...
            formatDefinition = new CredentialFormatDefinition
            {
                ...
                CredentialFormatCode = CredentialFormatCodes.Cypress37Bit, 
                BiometricEnrollmentSupported = false,
                BiometricIdField = 2,
                IsEnabled = true,
                Display = "Cypress 37 Bit"
            };
        ...
        public override CredentialFormatCodes DataFormat
        {
            get
            {
                if (ContainsData == true)
                    return CredentialFormatCodes.Cypress37Bit;
                else
        ...
        {
            var formatInstance = CredentialCypress37BitFormat.GetCredentialFormatInstance();
        ...
        public static CredentialCypress37BitFormat IsBinaryDataValid(byte[] array)
        {
            var ret = new CredentialCypress37BitFormat();
