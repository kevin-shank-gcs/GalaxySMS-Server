...
{
    public class CredentialHIDCorporate1K48BitFormat : CredentialFormatBase
    {
        ...
        public const UInt64 OddParityMSBMask = 0x7FFFFFFFFFFF;
        public const UInt64 OddParityLSBMask = 0x36DB6DB6DB6C;
        public const UInt64 EvenParityMask = 0x1B6DB6DB6DB6;

        public const short OddParityMSBBitPosition = 1;
        public const short OddParityLSBBitPosition = 48;
        public const short EvenParityBitPosition = 2;
        ...
        public const int TotalBitLength = 48;
        public const int CompanyCodeBitLength = 22;
        public const short CompanyCodeStartBitPosition = 3;
        public const int CompanyCodeMinimumValue = 0;
        public const uint CompanyCodeMaximumValue = 4194303;

        public const int IdCodeBitLength = 23;
        public const short IdCodeStartBitPosition = 25;
        public const int IdCodeMinimumValue = 0;
        public const uint IdCodeMaximumValue = 8388607;


        public CredentialHIDCorporate1K48BitFormat()
        {
            CompanyCode = 0;
            IDCode = 0;
        ...
        public CredentialHIDCorporate1K48BitFormat(uint companyCode, uint idCode)
        {
        ...
        public override CredentialFormatCodes DataFormat
        {
            get
            {
                if (ContainsData == true)
                    return CredentialFormatCodes.Corporate1K48Bit;
                else
        ...
        {
            //UInt64 mask = OddParityMSBMask;//0x7FFFFFFFFFFF;
            bool bRet = false;
            int bits_on = 0;
        ...
        {
            //UInt64 mask = 0x36DB6DB6DB6C;
            bool bRet = false;
            int bits_on = 0;

            data &= OddParityLSBMask;// mask;
            while (data != 0)
            {
                if ((data & 1) != 0)
                    bits_on++;
        ...
        {
 //           UInt64 mask = 0x1B6DB6DB6DB6;
            int bits_on = 0;
            bool bRet = false;

            data &= EvenParityMask;//mask;
            while (data != 0)
            {
                if ((data & 1) != 0)
                    bits_on++;
        ...
        {
            ulong mask = (ulong)0x3FFFFF000000;
        ...
        ///
        /// <returns>   A Card35BitHIDCorporate1000Format. </returns>
        ////////////////////////////////////////////////////////////////////////////////////////////////////

        public static CredentialHIDCorporate1K48BitFormat IsBinaryDataValid(byte[] array)
        {
            var ret = new CredentialHIDCorporate1K48BitFormat();
            short hightest1Bit = HexEncoding.GetHighestNonZeroBit(array);
            if (hightest1Bit > 48)
                return ret;
            if (array.Length < 6)   // at least 6 bytes are required for 48 bits
                return ret;
