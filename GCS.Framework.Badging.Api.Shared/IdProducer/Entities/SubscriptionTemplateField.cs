...
namespace GCS.Framework.Badging.IdProducer.Entities
{
    ...
    public class SubscriptionTemplateField
    {
        ...
        public bool IsDisplayedKeyField { get; set; }
        public bool IsExcludedFromBatchUpdates { get; set; }
        public int DataSensitivityLevelID { get; set; }
        public string DataSensitivityLevelCode { get; set; }

        public bool IsInaccessibleToUser { get; set; }

        public bool IsLastModifiedDateField { get; set; }

        public bool IsCreatedDateField { get; set; }

        public bool IsMappedToRemoteField { get; set; }
        public object[] TemplateFieldValues { get; set; }
        public object[] TemplateFieldChoices { get; set; }
        public object[] SearchFieldValues { get; set; }
        public bool MarkedForDeletion { get; set; }
    }
