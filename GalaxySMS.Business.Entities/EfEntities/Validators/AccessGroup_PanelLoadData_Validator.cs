...
namespace GalaxySMS.Business.Entities
{
    ...
    {
        class AccessGroup_PanelLoadDataValidator : AbstractValidator<AccessGroup_PanelLoadData>
        {
            public AccessGroup_PanelLoadDataValidator()
            {
        ...
        {
            return new AccessGroup_PanelLoadDataValidator();
        }
    }
}
