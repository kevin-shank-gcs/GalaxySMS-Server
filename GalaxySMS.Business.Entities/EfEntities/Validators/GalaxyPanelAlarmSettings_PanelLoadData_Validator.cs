...
namespace GalaxySMS.Business.Entities
{
    ...
    {
        class GalaxyPanelAlarmSettings_PanelLoadDataValidator : AbstractValidator<GalaxyPanelAlarmSettings_PanelLoadData>
        {
            public GalaxyPanelAlarmSettings_PanelLoadDataValidator()
            {
                RuleFor(obj=>obj.IOGroupNumber <= GalaxySMS.Common.Constants.InputOutputGroupLimits.HighestNumber);
                RuleFor(obj=>obj.AlertEventType).IsInEnum();
        ...
        {
            return new GalaxyPanelAlarmSettings_PanelLoadDataValidator();
        }
    }
}
