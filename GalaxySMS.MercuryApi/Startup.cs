...
using GalaxySMS.MercuryApi.Middleware;
//using AutoMapper;
...
namespace GalaxySMS.MercuryApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "GalaxySMS Mercury API",
                    Description = "GalaxySMS Mercury Web API",
                    TermsOfService = null,
                ...
                c.IncludeXmlComments(GetMercDataClassesXmlCommentsPath());
            ...
            services.AddSwaggerExamplesFromAssemblyOf<SaveMercuryPanelExamples>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "GalaxySMS Mercury API V1");
...
//                app.UseMiddleware<ApiLoggingMiddleware>();
        ...
        private string GetLocalXmlCommentsPath()
        {
            ...
            return System.IO.Path.Combine(app, "GalaxySMS.MercuryApi.xml");
        }
        ...
        private string GetMercDataClassesXmlCommentsPath()
        {
            var app = System.AppContext.BaseDirectory;
            return System.IO.Path.Combine(app, "GalaxySMS.Business.Entities.MercApi.NetCore.xml");
        }
    }
}
