...
namespace GalaxySMS.Client.Proxies
{
    ...
    public class UserSessionClient : UserClientBase<IUserSessionService>, IUserSessionService
    {
        ...
        //{
        //    base.InsertUserDataToOutgoingHeader();
        //    return Channel.SetJwt(sessionid, jwt);
        //}
        ...
        {
            System.Diagnostics.Trace.WriteLine($"NetCore Proxies SignInRequestAsync");
            base.InsertUserDataToOutgoingHeader();
        ...
        //public Task<UserSessionToken> SetJwtAsync(Guid sessionid, string jwt)
        //{
        //    base.InsertUserDataToOutgoingHeader();
        //    return Channel.SetJwtAsync(sessionid, jwt);
        //}
