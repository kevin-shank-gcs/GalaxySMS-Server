...
#endif
{
    ...
    [DataContract]
#endif
    public partial class DayType : EntityBase, IIdentifiableEntity, IEquatable<DayType>, IHasEntityMappingList, ITableEntityBase, IHasEntityId
    {
        ...
        [DataMember]
#endif
        public ICollection<DateType> Dates { get; set; }
