...
#endif
{
    ...
    public partial class GalaxyInputDevice : EntityBase, IIdentifiableEntity, IEquatable<GalaxyInputDevice>, ITableEntityBase
    {
        ...
        [DataMember]
#endif
        public ICollection<InputDeviceAlertEvent> AlertEvents { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public GalaxyInputDeviceTimeSchedule TimeSchedule { get; set; }
        ...
        [DataMember]
#endif
        public ICollection<GalaxyInputArmingInputOutputGroup> ArmingInputOutputGroups { get; set; }
