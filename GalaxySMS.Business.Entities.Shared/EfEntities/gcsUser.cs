...
#endif
{
    ...
    public partial class gcsUser : EntityBase, IIdentifiableEntity, IEquatable<gcsUser>
    {
        ...
        [DataMember]
#endif
        public DateTimeOffset? IsLockedOutClearedDate { get; set; }
        ...
        [DataMember]
#endif
        public ICollection<gcsUserOldPassword> UserOldPasswords { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public ICollection<gcsUserEntity> UserEntities { get; set; }
