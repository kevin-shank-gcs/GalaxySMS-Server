...
#endif
{
    ...
    [DataContract]
#endif
    public partial class PropertySensitivityLevel : EntityBase, IIdentifiableEntity, IEquatable<PropertySensitivityLevel>, ITableEntityBase, IHasDisplayResourceKey, IHasDescriptionResourceKey
    {
