...
#endif
{
	public partial class AccessPortalProperties
    {
        ...
        {
            return this.AutomaticForgivePassbackFrequencyUid == Guid.Empty ||
                   this.PinRequiredModeUid == Guid.Empty ||
                   this.AccessPortalContactSupervisionTypeUid == Guid.Empty ||
                   this.AccessPortalDeferToServerBehaviorUid == Guid.Empty ||
                   this.AccessPortalNoServerReplyBehaviorUid == Guid.Empty ||
                   this.AccessPortalLockPushButtonBehaviorUid == Guid.Empty ||
                   this.LiquidCrystalDisplayUid == Guid.Empty ||
                   this.AccessPortalElevatorControlTypeUid == Guid.Empty ||
                   this.OtisElevatorDecUid == Guid.Empty ||
                   this.ElevatorRelayInterfaceBoardSectionUid == Guid.Empty ||
                   this.AccessPortalMultiFactorModeUid == Guid.Empty;
        }
    }
}