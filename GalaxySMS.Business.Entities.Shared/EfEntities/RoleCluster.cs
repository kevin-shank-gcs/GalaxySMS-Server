...
//        public gcsRole gcsRole { get; set; }
        ...
        [DataMember]
#endif
        public ICollection<RoleAccessPortal> AccessPortals { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public ICollection<RoleInputOutputGroup> InputOutputGroups { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public ICollection<RoleInputDevice> InputDevices { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public ICollection<RoleOutputDevice> OutputDevices { get; set; }
