...
#endif
{
    ...
    {
        class AccessGroup_PanelLoadDataChangesValidator : AbstractValidator<AccessGroup_PanelLoadDataChanges>
        {
            public AccessGroup_PanelLoadDataChangesValidator()
            {
        ...
        {
            return new AccessGroup_PanelLoadDataChangesValidator();
        }
    }
}
