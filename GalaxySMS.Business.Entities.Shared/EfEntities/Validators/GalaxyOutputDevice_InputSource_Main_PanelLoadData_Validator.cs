...
#endif
{
    ...
    {
        class GalaxyOutputDevice_InputSource_Main_PanelLoadDataValidator : AbstractValidator<GalaxyOutputDevice_InputSource_Main_PanelLoadData>
        {
            public GalaxyOutputDevice_InputSource_Main_PanelLoadDataValidator()
            {
                ...
                RuleFor(obj => (int)obj.SourceNumber).InclusiveBetween(1, 4);
                RuleFor(obj => (int)obj.IOGroupNumber).InclusiveBetween(0, GalaxySMS.Common.Constants.InputOutputGroupLimits.HighestNumber);
                //RuleFor(obj => (int)obj.).InclusiveBetween(0, ushort.MaxValue);
        ...
        {
            return new GalaxyOutputDevice_InputSource_Main_PanelLoadDataValidator();
        }
    }
}
