...
#endif
{
    ...
    {
        class AccessPortal_PanelLoadDataValidator : AbstractValidator<AccessPortal_PanelLoadData>
        {
            public AccessPortal_PanelLoadDataValidator()
            {
        ...
        {
            return new AccessPortal_PanelLoadDataValidator();
        }
    }
}
