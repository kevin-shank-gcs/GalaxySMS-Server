...
#endif
{
    ...
    {
        class Credential_PanelLoadDataValidator : AbstractValidator<Credential_PanelLoadData>
        {
            public Credential_PanelLoadDataValidator()
            {
        ...
        {
            return new Credential_PanelLoadDataValidator();
        }
    }
}
