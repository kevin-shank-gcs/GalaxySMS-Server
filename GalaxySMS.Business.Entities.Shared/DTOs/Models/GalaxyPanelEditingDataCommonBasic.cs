...
#endif
{
    ...
    [DataContract]
#endif
    public class GalaxyPanelEditingDataCommonBasic// : EntityBaseSimple
    {
        public GalaxyPanelEditingDataCommonBasic()
        {
...
//            CpuModels = new HashSet<GalaxyCpuModelBasic>();
            ...
            GalaxyPanelModel635Commands = new HashSet<GalaxyPanelCommandBasic>();
        }
...
//        public ICollection<InterfaceBoardSectionModeBasic> InterfaceBoardSectionModes { get; set; }
        ...
        [DataMember]
#endif
        public ICollection<GalaxyPanelCommandBasic> GalaxyPanelModel635Commands { get; set; }
