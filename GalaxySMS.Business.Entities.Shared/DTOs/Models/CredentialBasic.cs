...
#endif
{
    ...
    [DataContract]
#endif
    public partial class CredentialBasic : EntityBaseSimple
    {
        ...
        [DataMember]
#endif
        public Credential26BitStandardBasic Standard26Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialBqt36BitBasic Bqt36Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialCorporate1K35BitBasic Corporate1K35Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialCorporate1K48BitBasic Corporate1K48Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialFormatBasic CredentialFormat { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialCypress37BitBasic Cypress37Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialDataBasic CredentialData { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialH1030437BitBasic H1030437Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialH1030237BitBasic H1030237Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialPIV75BitBasic PIV75Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialXceedId40BitBasic XceedId40Bit { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialSoftwareHouse37BitBasic SoftwareHouse37Bit { get; set; }
        ...
        public string CredentialFormatDescription
        {
            get
            {
                ...
                if (this.SoftwareHouse37Bit != null)
                    return this.SoftwareHouse37Bit.CredentialFormatDescription;
        ...
        public string CredentialValueDescription
        {
            get
            {
                ...
                if (this.SoftwareHouse37Bit != null)
                    return this.SoftwareHouse37Bit.CredentialValueDescription;
        ...
        public string CredentialPartsString
        {
            get
            {
                ...
                if (this.SoftwareHouse37Bit != null)
                    return this.SoftwareHouse37Bit.CredentialPartsString;
