...
#endif
{
    ...
    [DataContract]
#endif
    public partial class CredentialCorporate1K48BitBasic : EntityBaseSimple
    {
        ...
        public string CredentialFormatCodeAndPartsString
        {
            get
            {
                return $"{GalaxySMS.Common.Enums.CredentialFormatCodes.Corporate1K48Bit}:{CredentialPartsString}";
            }
            set
            {
                ;
