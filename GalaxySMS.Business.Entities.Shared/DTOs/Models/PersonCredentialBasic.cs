...
#endif
{
    ...
    [DataContract]
#endif
    public partial class PersonCredentialBasic : EntityBaseSimple
    {
        ...
        [DataMember]
#endif
        public ICollection<PersonCredentialCommandScriptBasic> PersonCredentialCommandScripts { get; set; }

#if NetCoreApi
#else
        [DataMember]
#endif
        public CredentialBasic Credential { get; set; }
