...
namespace GalaxySMS.Common.Constants
{
    ...
    public class PermissionIds
    {
        ...
        public class GalaxySMSDataAccessPermission
        {
            ...
            public static readonly Guid MonitoredDeviceCanViewId = new Guid("CBFF7A23-C0A6-4613-AB73-C52AB709AE49");
            /// <summary>   Identifier for the monitored device can add. </summary>
            public static readonly Guid MonitoredDeviceCanAddId = new Guid("23BBAFFE-22A0-4D38-900E-A6403EB3A798");
            /// <summary>   Identifier for the monitored device can update. </summary>
            public static readonly Guid MonitoredDeviceCanUpdateId = new Guid("C6FA206E-A7DF-440B-96B3-BBC6E8696FB3");
            /// <summary>   Identifier for the monitored device can delete. </summary>
            public static readonly Guid MonitoredDeviceCanDeleteId = new Guid("FAAF3A0F-9021-439F-9C24-5E8876D25F0A");
