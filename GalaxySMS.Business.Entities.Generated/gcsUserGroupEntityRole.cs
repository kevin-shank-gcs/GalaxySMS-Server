...
#endif
{
    ...
    public partial class gcsUserGroupEntityRole : EntityBase, IIdentifiableEntity, IEquatable<gcsUserGroupEntityRole>, ITableEntityBase
    {
    ...
    */
    	...
    	[DataMember]
    #endif
    	public System.Guid UserGroupEntityRoleId { get; set; }
    
    #if NetCoreApi
    #else
    	[DataMember]
    #endif
    	public System.Guid UserGroupEntityId { get; set; }
