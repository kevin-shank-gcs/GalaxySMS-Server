...
#endif
{
    ...
    public partial class RegionEntityMap : EntityBase, IIdentifiableEntity, IEquatable<RegionEntityMap>, ITableEntityBase
    {
    ...
    */
    	...
    	[DataMember]
    #endif
    	public Nullable<System.Guid> EntityMapPermissionLevelUid { get; set; }
    	...
    	[DataMember]
    #endif
    	public EntityMapPermissionLevel EntityMapPermissionLevel { get; set; }
