...
namespace GalaxySMS.Business.Entities
{
    public class UserSessionToken : EntityBase
    {
        ...
        public bool IsInRole(Guid entityId, Guid applicationId, string roleName)
        {
            ...
            var role = (from r in application.UserRoles where r.RoleName == roleName select r).FirstOrDefault();
            if (role == null)
                return false;
        ...
        public bool IsInRole(Guid entityId, Guid applicationId, Guid roleId)
        {
            ...
            var role = (from r in application.UserRoles where r.RoleId == roleId select r).FirstOrDefault();
            if (role == null)
                return false;
