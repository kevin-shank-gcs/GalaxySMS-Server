...
#endif
{
    ...
    public partial class PersonAccessProfile : EntityBase, IIdentifiableEntity, IEquatable<PersonAccessProfile>, ITableEntityBase
    {
    ...
    */
    	...
    	[DataMember]
    #endif
    	public System.Guid PersonAccessProfileUid { get; set; }
    	...
    	[DataMember]
    #endif
    	public Nullable<System.Guid> AccessProfileUid { get; set; }
