...
#endif
{
    ...
    public partial class gcsEntityCount : EntityBase, IIdentifiableEntity, IEquatable<gcsEntityCount>, ITableEntityBase
    {
    ...
    #endif
    {
        ...
        {
        	public gcsEntityCount()
        	{
        		Initialize();
        	}
        
        	public gcsEntityCount(gcsEntityCount e)
        	{
        		Initialize(e);
        	}
    ...
    */
    	...
    	[DataMember]
    #endif
    	public System.Guid EntityCountUid { get; set; }
