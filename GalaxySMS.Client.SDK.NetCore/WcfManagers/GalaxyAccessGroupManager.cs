...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class GalaxyAccessGroupManager : ManagerBase
    {
        ...
        public ArrayResponse<AccessGroup> GetAccessGroupsForCluster(GetParametersWithPhoto parameters, bool rethrow)
        {
            InitializeErrorsCollection();
            ArrayResponse<AccessGroup> data = null;
        ...
        public async Task<ArrayResponse<AccessGroup>> GetAccessGroupsForClusterAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<AccessGroup> data = null;
        ...
        public ArrayResponse<AccessGroup> GetAllAccessGroupsForEntity(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<AccessGroup> data = null;
        ...
        public async Task<ArrayResponse<AccessGroup>> GetAllAccessGroupsForEntityAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<AccessGroup> data = null;
        ...
        public ArrayResponse<AccessGroup> GetAllAccessGroups(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<AccessGroup> data = null;
        ...
        public async Task<ArrayResponse<AccessGroup>> GetAllAccessGroupsAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<AccessGroup> data = null;
        ...
        public AccessGroup SaveAccessGroup(SaveParameters<AccessGroup> parameters)
        {
            InitializeErrorsCollection();
            AccessGroup savedItem = null;
        ...
        public async Task<AccessGroup> SaveAccessGroupAsync(SaveParameters<AccessGroup> parameters)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            AccessGroup savedItem = null;
        ...
        public AccessGroup GetAccessGroup(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
        ...
        public async Task<AccessGroup> GetAccessGroupAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            AccessGroup AccessGroup = null;
        ...
        public async Task<int> GetAvailableAccessGroupNumberAsync(Guid clusterUid, GalaxySMS.Common.Enums.ChooseAvailableAccessGroupNumberRange rangeOption)
        {
            InitializeErrorsCollection();
            int agNumber = GalaxySMS.Common.Constants.AccessGroupLimits.None;
