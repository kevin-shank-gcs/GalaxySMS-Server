...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class InputDeviceManager : ManagerBase
    {
        ...
        public bool ExecuteCommand(CommandParameters<InputDeviceCommandAction> parameters)
        {
            InitializeErrorsCollection();
        ...
        public async Task<bool> ExecuteCommandAsync(CommandParameters<InputDeviceCommandAction> parameters)
        {
            InitializeErrorsCollection();
