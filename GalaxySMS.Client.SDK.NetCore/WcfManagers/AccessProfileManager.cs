...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class AccessProfileManager : ManagerBase
    {
        ...
        public ArrayResponse<ListItemBase> GetAllAccessProfilesList(GetParametersWithPhoto parameters)
        {
        ...
        public async Task<ArrayResponse<ListItemBase>> GetAllAccessProfilesListAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<ListItemBase> data = null;
        ...
        public ArrayResponse<ListItemBase> GetAllAccessProfilesListForEntity(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<ListItemBase> data = null;
        ...
        public async Task<ArrayResponse<ListItemBase>> GetAllAccessProfilesListForEntityAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<ListItemBase> data = null;
