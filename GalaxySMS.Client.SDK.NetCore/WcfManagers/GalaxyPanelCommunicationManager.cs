...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class GalaxyPanelCommunicationManager : ManagerBase, IGalaxyPanelCommunicationEventServiceCallback
    {
        ...
        public bool SendClusterDataToPanels(CommandParameters<ClusterDataLoadParameters> parameters)
        {
            InitializeErrorsCollection();
            bool ret = false;
            WithClient<ISystemManagementService>(
        ...
        public async Task<bool> SendClusterDataToPanelsAsync(CommandParameters<ClusterDataLoadParameters> parameters)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            bool ret = false;
