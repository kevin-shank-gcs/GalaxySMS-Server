...
namespace GalaxySMS.Client.SDK.Managers
{
    ...
    public class GetAllEntitiesCompletedEventArgs : EventArgsBase
    {
        ...
        public GetAllEntitiesCompletedEventArgs(ArrayResponse<gcsEntity> entities, DateTimeOffset requestInvokedAt, DateTimeOffset requestCompletedAt)
        ...
        public ArrayResponse<gcsEntity> Entities { get; internal set; }
    }
    ...
    public class SaveEntityCompletedEventArgs : EventArgsBase
    {
        ...
        public SaveEntityCompletedEventArgs(gcsEntity entity, Boolean isNew, DateTimeOffset requestInvokedAt, DateTimeOffset requestCompletedAt)
            : base(requestInvokedAt, requestCompletedAt)
        {
            Entity = entity;
            IsNew = isNew;
    ...
    public class EntityManager : ManagerBase
    {
        ...
        public async Task<ArrayResponse<gcsEntityEx>> GetAllEntitiesForUserAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ...
            try
            {
                ...
                var entities = await client.GetAllEntitiesForUserAsync(parameters);
            ...
            WithClient<IAdministrationService>(
                _ServiceFactory.CreateClient<IAdministrationService>(Binding,
                    GetServiceAddress(ServiceNames.AdministrationService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            x = proxy.DeleteEntityByPk(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        public async Task<int> DeleteEntityByUniqueIdAsync(DeleteParameters parameters)
        {
            ...
            try
            {
                return await WithClientFuncAsync(_ServiceFactory.CreateClient<IAdministrationService>(Binding,
                    GetServiceAddress(ServiceNames.AdministrationService), ClientUserSessionData), async proxy =>
                    {
                        var x = await proxy.DeleteEntityByPkAsync(parameters);
                        return x;
                    });
            }
            catch (FaultException<ExceptionDetail> ex)
            ...
            WithClient<IAdministrationService>(
                _ServiceFactory.CreateClient<IAdministrationService>(Binding,
                    GetServiceAddress(ServiceNames.AdministrationService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            savedItem = proxy.SaveEntity(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        public async Task<gcsEntity> SaveEntityAsync(SaveParameters<gcsEntity> parameters)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
        ...
        {
            InitializeErrorsCollection();
            BackgroundJobInfo jobInfo = null;
            bool isNew = (parameters.Data.EntityId == Guid.Empty);
            WithClient<IAdministrationService>(
                _ServiceFactory.CreateClient<IAdministrationService>(Binding,
                    GetServiceAddress(ServiceNames.AdministrationService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            jobInfo = proxy.SaveEntityJob(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        public async Task<BackgroundJobInfo> SaveEntityJobAsync(SaveParameters<gcsEntity> parameters)
        {
            InitializeErrorsCollection();
            DateTimeOffset startedAt = DateTimeOffset.Now;
            BackgroundJobInfo jobInfo = null;
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<IAdministrationService>(Binding,
                        ...
                        {
                            isNew = (parameters.Data.EntityId == Guid.Empty);
                            jobInfo = await proxy.SaveEntityJobAsync(parameters);
                            return jobInfo;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
        ...
        #region Get gcsEntityBasic List By Name or Description

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Gets entity list by name or description. </summary>
        ///
        /// <param name="parameters">   Options for controlling the operation. </param>
        ///
        /// <returns>   The entity list by name or description. </returns>
        ///=================================================================================================
            ...
            WithClient<IAdministrationService>(
                _ServiceFactory.CreateClient<IAdministrationService>(Binding,
                    GetServiceAddress(ServiceNames.AdministrationService), ClientUserSessionData), proxy =>
                    {
                        try
                        {
                            returnList = proxy.GetEntityListByNameOrDescription(parameters);
                        }
                        catch (FaultException<ExceptionDetail> ex)
                        {
                            AddError(new CustomError(ex.Detail));
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Gets entity list by name or description asynchronous. </summary>
        ///
        /// <param name="parameters">   Options for controlling the operation. </param>
        ///
        /// <returns>   The entity list by name or description asynchronous. </returns>
        ///=================================================================================================

        public async Task<ArrayResponse<gcsEntityExBasic>> GetEntityListByNameOrDescriptionAsync(GetParametersWithPhoto parameters)
        {
            InitializeErrorsCollection();
            ArrayResponse<gcsEntityExBasic> returnList = null;
            DateTimeOffset startedAt = DateTimeOffset.Now;
            ...
            try
            {
                return await WithClientFuncAsync(
                    _ServiceFactory.CreateClient<IAdministrationService>(Binding,
                        GetServiceAddress(ServiceNames.AdministrationService), ClientUserSessionData), async proxy =>
                        {
                            returnList = await proxy.GetEntityListByNameOrDescriptionAsync(parameters);
                            return returnList;
                        });
            }
            catch (FaultException<ExceptionDetail> ex)
