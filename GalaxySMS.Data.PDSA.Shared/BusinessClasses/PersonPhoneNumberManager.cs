...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonPhoneNumberPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonPhoneNumberPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonPhoneNumberPDSA object</param>
    public void InitEntityObject(PersonPhoneNumberPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonPhoneNumber entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonPhoneNumber objects
    /// </summary>
    public IEnumerable<PersonPhoneNumber> ConvertPDSACollection(PersonPhoneNumberPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonPhoneNumber>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonPhoneNumber();
