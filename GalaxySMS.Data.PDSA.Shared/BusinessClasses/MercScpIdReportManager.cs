...
namespace GalaxySMS.BusinessLayer
{
    ...
    /// </summary>
    public partial class MercScpIdReportPDSAManager
    {
        ...
        /// <summary>
        /// Call this method to initialize an MercScpIdReportPDSA object with any default values
        /// </summary>
        /// <param name="entity">An MercScpIdReportPDSA object</param>
        public void InitEntityObject(MercScpIdReportPDSA entity)
        {
        ...
        /// </summary>
        public void InitEntityObject(MercScpIdReport entity)
        {
        ...
        /// <summary>
        /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent MercScpIdReport objects
        /// </summary>
        public IEnumerable<MercScpIdReport> ConvertPDSACollection(MercScpIdReportPDSACollection pdsaCollection)
        {
            var results = new List<MercScpIdReport>();
            foreach (var pdsaEntity in pdsaCollection)
            {
                var convertedEntity = new MercScpIdReport();
