...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class BadgeTemplatePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an BadgeTemplatePDSA object with any default values
    /// </summary>
    /// <param name="entity">An BadgeTemplatePDSA object</param>
    public void InitEntityObject(BadgeTemplatePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(BadgeTemplate entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent BadgeTemplate objects
    /// </summary>
    public IEnumerable<BadgeTemplate> ConvertPDSACollection(BadgeTemplatePDSACollection pdsaCollection)
    {	
	 var results = new List<BadgeTemplate>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new BadgeTemplate();
