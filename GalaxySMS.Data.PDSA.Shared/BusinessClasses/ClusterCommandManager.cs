...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class ClusterCommandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an ClusterCommandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An ClusterCommandPDSA object</param>
    public void InitEntityObject(ClusterCommandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(ClusterCommand entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent ClusterCommand objects
    /// </summary>
    public IEnumerable<ClusterCommand> ConvertPDSACollection(ClusterCommandPDSACollection pdsaCollection)
    {	
	 var results = new List<ClusterCommand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new ClusterCommand();
