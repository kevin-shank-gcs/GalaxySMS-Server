...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class SiteEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an SiteEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An SiteEntityMapPDSA object</param>
    public void InitEntityObject(SiteEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(SiteEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent SiteEntityMap objects 
    /// </summary>
    public IEnumerable<SiteEntityMap> ConvertPDSACollection(SiteEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<SiteEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new SiteEntityMap();
