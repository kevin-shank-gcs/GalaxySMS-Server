...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelModelInterfaceBoardTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyPanelModelInterfaceBoardTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyPanelModelInterfaceBoardTypePDSA object</param>
    public void InitEntityObject(GalaxyPanelModelInterfaceBoardTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyPanelModelInterfaceBoardType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyPanelModelInterfaceBoardType objects
    /// </summary>
    public IEnumerable<GalaxyPanelModelInterfaceBoardType> ConvertPDSACollection(GalaxyPanelModelInterfaceBoardTypePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyPanelModelInterfaceBoardType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyPanelModelInterfaceBoardType();
