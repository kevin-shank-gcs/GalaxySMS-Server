...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialDataLengthPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialDataLengthPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialDataLengthPDSA object</param>
    public void InitEntityObject(CredentialDataLengthPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CredentialDataLength entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialDataLength objects
    /// </summary>
    public IEnumerable<CredentialDataLength> ConvertPDSACollection(CredentialDataLengthPDSACollection pdsaCollection)
    {	
	 var results = new List<CredentialDataLength>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CredentialDataLength();
