...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalAuxiliaryOutputModePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalAuxiliaryOutputModePDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalAuxiliaryOutputModePDSA object</param>
    public void InitEntityObject(AccessPortalAuxiliaryOutputModePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalAuxiliaryOutputMode entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalAuxiliaryOutputMode objects
    /// </summary>
    public IEnumerable<AccessPortalAuxiliaryOutputMode> ConvertPDSACollection(AccessPortalAuxiliaryOutputModePDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalAuxiliaryOutputMode>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalAuxiliaryOutputMode();
