...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class OutputCommandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an OutputCommandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An OutputCommandPDSA object</param>
    public void InitEntityObject(OutputCommandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(OutputCommand entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent OutputCommand objects
    /// </summary>
    public IEnumerable<OutputCommand> ConvertPDSACollection(OutputCommandPDSACollection pdsaCollection)
    {	
	 var results = new List<OutputCommand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new OutputCommand();
