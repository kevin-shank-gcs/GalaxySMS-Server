...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class BiometricSystemTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an BiometricSystemTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An BiometricSystemTypePDSA object</param>
    public void InitEntityObject(BiometricSystemTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(BiometricSystemType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent BiometricSystemType objects
    /// </summary>
    public IEnumerable<BiometricSystemType> ConvertPDSACollection(BiometricSystemTypePDSACollection pdsaCollection)
    {	
	 var results = new List<BiometricSystemType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new BiometricSystemType();
