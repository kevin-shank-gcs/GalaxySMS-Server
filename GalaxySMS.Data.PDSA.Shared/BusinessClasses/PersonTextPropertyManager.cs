...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonTextPropertyPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonTextPropertyPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonTextPropertyPDSA object</param>
    public void InitEntityObject(PersonTextPropertyPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonTextProperty entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonTextProperty objects
    /// </summary>
    public IEnumerable<PersonTextProperty> ConvertPDSACollection(PersonTextPropertyPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonTextProperty>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonTextProperty();
