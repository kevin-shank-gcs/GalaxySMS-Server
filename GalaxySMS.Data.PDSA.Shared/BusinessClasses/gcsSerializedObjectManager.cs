...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsSerializedObjectPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsSerializedObjectPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsSerializedObjectPDSA object</param>
    public void InitEntityObject(gcsSerializedObjectPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsSerializedObject entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsSerializedObject objects
    /// </summary>
    public IEnumerable<gcsSerializedObject> ConvertPDSACollection(gcsSerializedObjectPDSACollection pdsaCollection)
    {	
	 var results = new List<gcsSerializedObject>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsSerializedObject();
