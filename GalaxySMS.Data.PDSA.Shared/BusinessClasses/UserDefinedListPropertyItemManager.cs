...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class UserDefinedListPropertyItemPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an UserDefinedListPropertyItemPDSA object with any default values
    /// </summary>
    /// <param name="entity">An UserDefinedListPropertyItemPDSA object</param>
    public void InitEntityObject(UserDefinedListPropertyItemPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(UserDefinedListPropertyItem entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent UserDefinedListPropertyItem objects
    /// </summary>
    public IEnumerable<UserDefinedListPropertyItem> ConvertPDSACollection(UserDefinedListPropertyItemPDSACollection pdsaCollection)
    {	
	 var results = new List<UserDefinedListPropertyItem>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new UserDefinedListPropertyItem();
