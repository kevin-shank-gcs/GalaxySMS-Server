...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyFlashImagePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyFlashImagePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyFlashImagePDSA object</param>
    public void InitEntityObject(GalaxyFlashImagePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyFlashImage entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyFlashImage objects
    /// </summary>
    public IEnumerable<GalaxyFlashImage> ConvertPDSACollection(GalaxyFlashImagePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyFlashImage>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyFlashImage();
