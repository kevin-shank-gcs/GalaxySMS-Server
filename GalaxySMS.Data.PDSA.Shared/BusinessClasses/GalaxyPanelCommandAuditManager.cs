...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelCommandAuditPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyPanelCommandAuditPDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyPanelCommandAuditPDSA object</param>
    public void InitEntityObject(GalaxyPanelCommandAuditPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyPanelCommandAudit entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyPanelCommandAudit objects
    /// </summary>
    public IEnumerable<GalaxyPanelCommandAudit> ConvertPDSACollection(GalaxyPanelCommandAuditPDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyPanelCommandAudit>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyPanelCommandAudit();
