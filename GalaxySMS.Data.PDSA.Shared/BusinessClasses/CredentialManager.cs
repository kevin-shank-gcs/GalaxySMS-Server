...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialPDSA object</param>
    public void InitEntityObject(CredentialPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Credential entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Credential objects
    /// </summary>
    public IEnumerable<Credential> ConvertPDSACollection(CredentialPDSACollection pdsaCollection)
    {	
	 var results = new List<Credential>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Credential();
