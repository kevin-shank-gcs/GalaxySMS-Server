...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsEnumNamespacePDSAManager
  {
    ...
    public void InitEntityObject(gcsEnumNamespace entity)
    {
        SimpleMapper.PropertyMap(entity, Entity);
    }

    public IEnumerable<gcsEnumNamespace> ConvertPDSACollection(gcsEnumNamespacePDSACollection pdsaCollection)
    {
        List<gcsEnumNamespace> results = new List<gcsEnumNamespace>();
        foreach (var pdsaEntity in pdsaCollection)
        {
            gcsEnumNamespace convertedEntity = new gcsEnumNamespace();
    ...
    /// <summary>
    /// Call this method to initialize an gcsEnumNamespacePDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsEnumNamespacePDSA object</param>
    public void InitEntityObject(gcsEnumNamespacePDSA entity)
    {
