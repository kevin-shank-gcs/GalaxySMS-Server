...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalTypePDSA object</param>
    public void InitEntityObject(AccessPortalTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalType objects 
    /// </summary>
    public IEnumerable<AccessPortalType> ConvertPDSACollection(AccessPortalTypePDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalType();
