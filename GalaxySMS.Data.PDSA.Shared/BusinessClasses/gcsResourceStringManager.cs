...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsResourceStringPDSAManager
  {
    ...
    public void InitEntityObject(gcsResourceString entity)
    {
        SimpleMapper.PropertyMap(entity, Entity);
    }

    public IEnumerable<gcsResourceString> ConvertPDSACollection(gcsResourceStringPDSACollection pdsaCollection)
    {
        List<gcsResourceString> results = new List<gcsResourceString>();
        foreach (var pdsaEntity in pdsaCollection)
        {
            gcsResourceString convertedEntity = new gcsResourceString();
    ...
    /// <summary>
    /// Call this method to initialize an gcsResourceStringPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsResourceStringPDSA object</param>
    public void InitEntityObject(gcsResourceStringPDSA entity)
    {
