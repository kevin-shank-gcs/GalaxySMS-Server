...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class ClusterEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an ClusterEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An ClusterEntityMapPDSA object</param>
    public void InitEntityObject(ClusterEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(ClusterEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent ClusterEntityMap objects 
    /// </summary>
    public IEnumerable<ClusterEntityMap> ConvertPDSACollection(ClusterEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<ClusterEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new ClusterEntityMap();
