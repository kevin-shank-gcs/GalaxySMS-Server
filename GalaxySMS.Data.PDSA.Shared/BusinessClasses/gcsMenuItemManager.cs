...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsMenuItemPDSAManager
  {
    ...
    public void InitEntityObject(gcsMenuItem entity)
    {
        SimpleMapper.PropertyMap(entity, Entity);
    }

    public IEnumerable<gcsMenuItem> ConvertPDSACollection(gcsMenuItemPDSACollection pdsaCollection)
    {
        List<gcsMenuItem> results = new List<gcsMenuItem>();
        foreach (var pdsaEntity in pdsaCollection)
        {
            gcsMenuItem convertedEntity = new gcsMenuItem();
    ...
    /// <summary>
    /// Call this method to initialize an gcsMenuItemPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsMenuItemPDSA object</param>
    public void InitEntityObject(gcsMenuItemPDSA entity)
    {
