...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessGroupEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessGroupEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessGroupEntityMapPDSA object</param>
    public void InitEntityObject(AccessGroupEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessGroupEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessGroupEntityMap objects 
    /// </summary>
    public IEnumerable<AccessGroupEntityMap> ConvertPDSACollection(AccessGroupEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<AccessGroupEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessGroupEntityMap();
