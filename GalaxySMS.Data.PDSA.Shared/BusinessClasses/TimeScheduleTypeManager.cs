...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class TimeScheduleTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an TimeScheduleTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An TimeScheduleTypePDSA object</param>
    public void InitEntityObject(TimeScheduleTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(TimeScheduleType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent TimeScheduleType objects
    /// </summary>
    public IEnumerable<TimeScheduleType> ConvertPDSACollection(TimeScheduleTypePDSACollection pdsaCollection)
    {	
	 var results = new List<TimeScheduleType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new TimeScheduleType();
