...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsResourceStringLanguagePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsResourceStringLanguagePDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsResourceStringLanguagePDSA object</param>
    public void InitEntityObject(gcsResourceStringLanguagePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsResourceStringLanguage entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivelant gcsResourceStringLanguage objects 
    /// </summary>
    public IEnumerable<gcsResourceStringLanguage> ConvertPDSACollection(gcsResourceStringLanguagePDSACollection pdsaCollection)
    {	
	 var results = new List<gcsResourceStringLanguage>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsResourceStringLanguage();
