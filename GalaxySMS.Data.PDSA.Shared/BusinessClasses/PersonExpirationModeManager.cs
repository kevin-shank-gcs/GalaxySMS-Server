...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonExpirationModePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonExpirationModePDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonExpirationModePDSA object</param>
    public void InitEntityObject(PersonExpirationModePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonExpirationMode entity)
    {
    ...
    /// </summary>
    public IEnumerable<PersonExpirationMode> ConvertPDSACollection(PersonExpirationModePDSACollection pdsaCollection)
    {	
	 var results = new List<PersonExpirationMode>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonExpirationMode();
