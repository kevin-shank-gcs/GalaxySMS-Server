...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CellCarrierPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CellCarrierPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CellCarrierPDSA object</param>
    public void InitEntityObject(CellCarrierPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CellCarrier entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CellCarrier objects
    /// </summary>
    public IEnumerable<CellCarrier> ConvertPDSACollection(CellCarrierPDSACollection pdsaCollection)
    {	
	 var results = new List<CellCarrier>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CellCarrier();
