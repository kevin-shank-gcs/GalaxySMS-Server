...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonPropertyBagPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonPropertyBagPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonPropertyBagPDSA object</param>
    public void InitEntityObject(PersonPropertyBagPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonPropertyBag entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonPropertyBag objects
    /// </summary>
    public IEnumerable<PersonPropertyBag> ConvertPDSACollection(PersonPropertyBagPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonPropertyBag>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonPropertyBag();
