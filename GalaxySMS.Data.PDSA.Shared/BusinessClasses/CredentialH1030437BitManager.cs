...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class CredentialH1030437BitPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an CredentialH1030437BitPDSA object with any default values
    /// </summary>
    /// <param name="entity">An CredentialH1030437BitPDSA object</param>
    public void InitEntityObject(CredentialH1030437BitPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(CredentialH1030437Bit entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent CredentialH1030437Bit objects
    /// </summary>
    public IEnumerable<CredentialH1030437Bit> ConvertPDSACollection(CredentialH1030437BitPDSACollection pdsaCollection)
    {	
	 var results = new List<CredentialH1030437Bit>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new CredentialH1030437Bit();
