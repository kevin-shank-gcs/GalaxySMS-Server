...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonOtisElevatorPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonOtisElevatorPDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonOtisElevatorPDSA object</param>
    public void InitEntityObject(PersonOtisElevatorPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonOtisElevator entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonOtisElevator objects
    /// </summary>
    public IEnumerable<PersonOtisElevator> ConvertPDSACollection(PersonOtisElevatorPDSACollection pdsaCollection)
    {	
	 var results = new List<PersonOtisElevator>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonOtisElevator();
