...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyOutputDevicePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyOutputDevicePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyOutputDevicePDSA object</param>
    public void InitEntityObject(GalaxyOutputDevicePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyOutputDevice entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyOutputDevice objects
    /// </summary>
    public IEnumerable<GalaxyOutputDevice> ConvertPDSACollection(GalaxyOutputDevicePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyOutputDevice>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyOutputDevice();
