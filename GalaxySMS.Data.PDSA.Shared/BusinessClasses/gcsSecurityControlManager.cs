...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsSecurityControlPDSAManager
  {
    ...
    public void InitEntityObject(gcsSecurityControl entity)
    {
        SimpleMapper.PropertyMap(entity, Entity);
    }

    public IEnumerable<gcsSecurityControl> ConvertPDSACollection(gcsSecurityControlPDSACollection pdsaCollection)
    {
        List<gcsSecurityControl> results = new List<gcsSecurityControl>();
        foreach (var pdsaEntity in pdsaCollection)
        {
            gcsSecurityControl convertedEntity = new gcsSecurityControl();
    ...
    /// <summary>
    /// Call this method to initialize an gcsSecurityControlPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsSecurityControlPDSA object</param>
    public void InitEntityObject(gcsSecurityControlPDSA entity)
    {
