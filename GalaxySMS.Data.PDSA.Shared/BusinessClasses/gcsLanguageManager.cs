...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsLanguagePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsLanguagePDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsLanguagePDSA object</param>
    public void InitEntityObject(gcsLanguagePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsLanguage entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsLanguage objects 
    /// </summary>
    public IEnumerable<gcsLanguage> ConvertPDSACollection(gcsLanguagePDSACollection pdsaCollection)
    {	
	 var results = new List<gcsLanguage>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsLanguage();
