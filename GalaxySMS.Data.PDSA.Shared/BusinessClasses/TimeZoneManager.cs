...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class TimeZonePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an TimeZonePDSA object with any default values
    /// </summary>
    /// <param name="entity">An TimeZonePDSA object</param>
    public void InitEntityObject(TimeZonePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxySMS.Business.Entities.TimeZone entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxySMS.Business.Entities.TimeZone objects
    /// </summary>
    public IEnumerable<GalaxySMS.Business.Entities.TimeZone> ConvertPDSACollection(TimeZonePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxySMS.Business.Entities.TimeZone>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxySMS.Business.Entities.TimeZone();
