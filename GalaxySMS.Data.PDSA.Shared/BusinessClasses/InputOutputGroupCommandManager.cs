...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupCommandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputOutputGroupCommandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputOutputGroupCommandPDSA object</param>
    public void InitEntityObject(InputOutputGroupCommandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputOutputGroupCommand entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InputOutputGroupCommand objects
    /// </summary>
    public IEnumerable<InputOutputGroupCommand> ConvertPDSACollection(InputOutputGroupCommandPDSACollection pdsaCollection)
    {	
	 var results = new List<InputOutputGroupCommand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputOutputGroupCommand();
