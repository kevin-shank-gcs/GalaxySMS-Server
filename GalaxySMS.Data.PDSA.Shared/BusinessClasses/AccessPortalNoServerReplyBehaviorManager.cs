...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalNoServerReplyBehaviorPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalNoServerReplyBehaviorPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalNoServerReplyBehaviorPDSA object</param>
    public void InitEntityObject(AccessPortalNoServerReplyBehaviorPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalNoServerReplyBehavior entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalNoServerReplyBehavior objects
    /// </summary>
    public IEnumerable<AccessPortalNoServerReplyBehavior> ConvertPDSACollection(AccessPortalNoServerReplyBehaviorPDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalNoServerReplyBehavior>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalNoServerReplyBehavior();
