...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputDeviceSupervisionTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputDeviceSupervisionTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputDeviceSupervisionTypePDSA object</param>
    public void InitEntityObject(InputDeviceSupervisionTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputDeviceSupervisionType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InputDeviceSupervisionType objects
    /// </summary>
    public IEnumerable<InputDeviceSupervisionType> ConvertPDSACollection(InputDeviceSupervisionTypePDSACollection pdsaCollection)
    {	
	 var results = new List<InputDeviceSupervisionType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputDeviceSupervisionType();
