...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputDeviceAlertEventTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputDeviceAlertEventTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputDeviceAlertEventTypePDSA object</param>
    public void InitEntityObject(InputDeviceAlertEventTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputDeviceAlertEventType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InputDeviceAlertEventType objects
    /// </summary>
    public IEnumerable<InputDeviceAlertEventType> ConvertPDSACollection(InputDeviceAlertEventTypePDSACollection pdsaCollection)
    {	
	 var results = new List<InputDeviceAlertEventType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputDeviceAlertEventType();
