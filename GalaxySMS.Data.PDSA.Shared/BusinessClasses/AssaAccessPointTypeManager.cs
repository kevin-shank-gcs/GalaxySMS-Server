...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AssaAccessPointTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AssaAccessPointTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An AssaAccessPointTypePDSA object</param>
    public void InitEntityObject(AssaAccessPointTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AssaAccessPointType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AssaAccessPointType objects 
    /// </summary>
    public IEnumerable<AssaAccessPointType> ConvertPDSACollection(AssaAccessPointTypePDSACollection pdsaCollection)
    {	
	 var results = new List<AssaAccessPointType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AssaAccessPointType();
