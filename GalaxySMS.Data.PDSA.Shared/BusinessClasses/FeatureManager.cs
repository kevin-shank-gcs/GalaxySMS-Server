...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class FeaturePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an FeaturePDSA object with any default values
    /// </summary>
    /// <param name="entity">An FeaturePDSA object</param>
    public void InitEntityObject(FeaturePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Feature entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Feature objects 
    /// </summary>
    public IEnumerable<Feature> ConvertPDSACollection(FeaturePDSACollection pdsaCollection)
    {	
	 var results = new List<Feature>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Feature();
