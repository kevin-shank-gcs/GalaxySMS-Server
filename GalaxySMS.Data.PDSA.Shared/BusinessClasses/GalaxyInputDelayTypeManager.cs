...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class GalaxyInputDelayTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an GalaxyInputDelayTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An GalaxyInputDelayTypePDSA object</param>
    public void InitEntityObject(GalaxyInputDelayTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(GalaxyInputDelayType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent GalaxyInputDelayType objects
    /// </summary>
    public IEnumerable<GalaxyInputDelayType> ConvertPDSACollection(GalaxyInputDelayTypePDSACollection pdsaCollection)
    {	
	 var results = new List<GalaxyInputDelayType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new GalaxyInputDelayType();
