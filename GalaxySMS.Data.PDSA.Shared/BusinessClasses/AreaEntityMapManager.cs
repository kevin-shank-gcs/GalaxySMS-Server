...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AreaEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AreaEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AreaEntityMapPDSA object</param>
    public void InitEntityObject(AreaEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AreaEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AreaEntityMap objects 
    /// </summary>
    public IEnumerable<AreaEntityMap> ConvertPDSACollection(AreaEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<AreaEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AreaEntityMap();
