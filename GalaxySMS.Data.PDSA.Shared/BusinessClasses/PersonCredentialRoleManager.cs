...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class PersonCredentialRolePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an PersonCredentialRolePDSA object with any default values
    /// </summary>
    /// <param name="entity">An PersonCredentialRolePDSA object</param>
    public void InitEntityObject(PersonCredentialRolePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(PersonCredentialRole entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent PersonCredentialRole objects
    /// </summary>
    public IEnumerable<PersonCredentialRole> ConvertPDSACollection(PersonCredentialRolePDSACollection pdsaCollection)
    {	
	 var results = new List<PersonCredentialRole>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new PersonCredentialRole();
