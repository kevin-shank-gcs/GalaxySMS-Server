...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class NotePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an NotePDSA object with any default values
    /// </summary>
    /// <param name="entity">An NotePDSA object</param>
    public void InitEntityObject(NotePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Note entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Note objects
    /// </summary>
    public IEnumerable<Note> ConvertPDSACollection(NotePDSACollection pdsaCollection)
    {	
	 var results = new List<Note>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Note();
