...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsApplicationPDSAManager
  {
    ...
    public void InitEntityObject(gcsApplication entity)
    {
        SimpleMapper.PropertyMap(entity, Entity);
    }

    public IEnumerable<gcsApplication> ConvertPDSACollection(gcsApplicationPDSACollection pdsaCollection)
    {
        var results = new List<gcsApplication>();
        foreach (var pdsaEntity in pdsaCollection)
        {
            var convertedEntity = new gcsApplication();
    ...
    /// <summary>
    /// Call this method to initialize an gcsApplicationPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsApplicationPDSA object</param>
    public void InitEntityObject(gcsApplicationPDSA entity)
    {
