...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class DateTypeEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an DateTypeEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An DateTypeEntityMapPDSA object</param>
    public void InitEntityObject(DateTypeEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(DateTypeEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent DateTypeEntityMap objects 
    /// </summary>
    public IEnumerable<DateTypeEntityMap> ConvertPDSACollection(DateTypeEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<DateTypeEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new DateTypeEntityMap();
