...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalLoadToCpuPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalLoadToCpuPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalLoadToCpuPDSA object</param>
    public void InitEntityObject(AccessPortalLoadToCpuPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalLoadToCpu entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalLoadToCpu objects
    /// </summary>
    public IEnumerable<AccessPortalLoadToCpu> ConvertPDSACollection(AccessPortalLoadToCpuPDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalLoadToCpu>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalLoadToCpu();
