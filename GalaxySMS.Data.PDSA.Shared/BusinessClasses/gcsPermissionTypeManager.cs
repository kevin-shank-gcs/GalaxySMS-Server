...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsPermissionTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an gcsPermissionTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsPermissionTypePDSA object</param>
    public void InitEntityObject(gcsPermissionTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(gcsPermissionType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent gcsPermissionType objects
    /// </summary>
    public IEnumerable<gcsPermissionType> ConvertPDSACollection(gcsPermissionTypePDSACollection pdsaCollection)
    {	
	 var results = new List<gcsPermissionType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new gcsPermissionType();
