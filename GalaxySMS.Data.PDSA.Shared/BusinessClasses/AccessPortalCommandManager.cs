...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AccessPortalCommandPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AccessPortalCommandPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AccessPortalCommandPDSA object</param>
    public void InitEntityObject(AccessPortalCommandPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(AccessPortalCommand entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent AccessPortalCommand objects
    /// </summary>
    public IEnumerable<AccessPortalCommand> ConvertPDSACollection(AccessPortalCommandPDSACollection pdsaCollection)
    {	
	 var results = new List<AccessPortalCommand>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new AccessPortalCommand();
