...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class AddressPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an AddressPDSA object with any default values
    /// </summary>
    /// <param name="entity">An AddressPDSA object</param>
    public void InitEntityObject(AddressPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(Address entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent Address objects 
    /// </summary>
    public IEnumerable<Address> ConvertPDSACollection(AddressPDSACollection pdsaCollection)
    {	
	 var results = new List<Address>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new Address();
