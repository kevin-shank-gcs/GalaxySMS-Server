    ...
    public partial class InputDevice_PanelLoadDataChangesForCpuPDSAManager : PDSADataClassManagerReadOnlyBase
    {
        ...
        public InputDevice_PanelLoadDataChangesForCpuPDSA DictionaryToEntity(Dictionary<string, string> values)
        {
            ...
            if (values.ContainsKey(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.GalaxyInputDevicePropertiesLastUpdated))
                ret.GalaxyInputDevicePropertiesLastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.GalaxyInputDevicePropertiesLastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MainIOGroupLastUpdated))
                ret.MainIOGroupLastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MainIOGroupLastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup1LastUpdated))
                ret.ArmingIOGroup1LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup1LastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup2LastUpdated))
                ret.ArmingIOGroup2LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup2LastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup3LastUpdated))
                ret.ArmingIOGroup3LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup3LastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup4LastUpdated))
                ret.ArmingIOGroup4LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ArmingIOGroup4LastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MainScheduleLastUpdated))
                ret.MainScheduleLastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.MainScheduleLastUpdated]);
