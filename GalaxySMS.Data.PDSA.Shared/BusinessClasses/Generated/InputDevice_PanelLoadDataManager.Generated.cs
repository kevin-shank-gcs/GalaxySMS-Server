    ...
    public partial class InputDevice_PanelLoadDataPDSAManager : PDSADataClassManagerReadOnlyBase
    {
        ...
        public InputDevice_PanelLoadDataPDSA DictionaryToEntity(Dictionary<string, string> values)
        {
            ...
            if (values.ContainsKey(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.GalaxyInputDevicePropertiesLastUpdated))
                ret.GalaxyInputDevicePropertiesLastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataPDSAValidator.ColumnNames.GalaxyInputDevicePropertiesLastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainIOGroupLastUpdated))
                ret.MainIOGroupLastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainIOGroupLastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup1LastUpdated))
                ret.ArmingIOGroup1LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup1LastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup2LastUpdated))
                ret.ArmingIOGroup2LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup2LastUpdated]);
            ...
            if (values.ContainsKey(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup3LastUpdated))
                ret.ArmingIOGroup3LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup3LastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup4LastUpdated))
                ret.ArmingIOGroup4LastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup4LastUpdated]);

            if (values.ContainsKey(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainScheduleLastUpdated))
                ret.MainScheduleLastUpdated = Convert.ToDateTime(values[InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainScheduleLastUpdated]);
