...
namespace GalaxySMS.BusinessLayer
{
    ...
    public partial class DateTypeDefaultBehavior_PanelLoadDataPDSAManager : PDSADataClassManagerReadOnlyBase
    {
        ...
        public DateTypeDefaultBehavior_PanelLoadDataPDSA DictionaryToEntity(Dictionary<string, string> values)
        {
            ...
            if (values.ContainsKey(DateTypeDefaultBehavior_PanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid))
                ret.DateTypeDefaultBehaviorUid = PDSAProperty.ConvertToGuid(values[DateTypeDefaultBehavior_PanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid]);
