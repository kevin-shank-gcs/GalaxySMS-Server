...
namespace GalaxySMS.BusinessLayer
{
    ...
    public partial class DateTypeDefaultBehaviorPDSAManager : PDSADataClassManagerBase
    {
        ...
        public DateTypeDefaultBehaviorPDSA DictionaryToEntity(Dictionary<string, string> values)
        {
            ...
            if (values.ContainsKey(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid))
                ret.DateTypeDefaultBehaviorUid = PDSAProperty.ConvertToGuid(values[DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid]);
            ...
            if (values.ContainsKey(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.InsertDate))
                ret.InsertDate = Convert.ToDateTime(values[DateTypeDefaultBehaviorPDSAValidator.ColumnNames.InsertDate]);
            ...
            if (values.ContainsKey(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.UpdateDate))
                ret.UpdateDate = Convert.ToDateTime(values[DateTypeDefaultBehaviorPDSAValidator.ColumnNames.UpdateDate]);
        ...
        public int Delete(DateTypeDefaultBehaviorPDSA entity)
        {
            ...
            Entity = entity;
            DataObject.Entity = entity;
            ret = DataObject.DeleteByPK(entity.DateTypeDefaultBehaviorUid);
            if (ret >= 1)
                TrackChanges("Delete");
        ...
        public DateTypeDefaultBehaviorPDSACollection GetDateTypeDefaultBehaviorPDSAsByFK_DateTypeDefaultBehaviorEntityEntity(gcsEntityPDSA entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    {
                        DataObject.SelectFilter = DateTypeDefaultBehaviorPDSAData.SelectFilters.ByEntityId;
                    }
                    else
                    {
                    }
