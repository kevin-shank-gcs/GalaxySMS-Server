...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class BadgeSystemTypePDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an BadgeSystemTypePDSA object with any default values
    /// </summary>
    /// <param name="entity">An BadgeSystemTypePDSA object</param>
    public void InitEntityObject(BadgeSystemTypePDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(BadgeSystemType entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent BadgeSystemType objects
    /// </summary>
    public IEnumerable<BadgeSystemType> ConvertPDSACollection(BadgeSystemTypePDSACollection pdsaCollection)
    {	
	 var results = new List<BadgeSystemType>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new BadgeSystemType();
