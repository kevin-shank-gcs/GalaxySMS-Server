...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputDeviceEntityMapPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputDeviceEntityMapPDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputDeviceEntityMapPDSA object</param>
    public void InitEntityObject(InputDeviceEntityMapPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputDeviceEntityMap entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InputDeviceEntityMap objects
    /// </summary>
    public IEnumerable<InputDeviceEntityMap> ConvertPDSACollection(InputDeviceEntityMapPDSACollection pdsaCollection)
    {	
	 var results = new List<InputDeviceEntityMap>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputDeviceEntityMap();
