...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class OutputCommandAuditPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an OutputCommandAuditPDSA object with any default values
    /// </summary>
    /// <param name="entity">An OutputCommandAuditPDSA object</param>
    public void InitEntityObject(OutputCommandAuditPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(OutputCommandAudit entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent OutputCommandAudit objects
    /// </summary>
    public IEnumerable<OutputCommandAudit> ConvertPDSACollection(OutputCommandAuditPDSACollection pdsaCollection)
    {	
	 var results = new List<OutputCommandAudit>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new OutputCommandAudit();
