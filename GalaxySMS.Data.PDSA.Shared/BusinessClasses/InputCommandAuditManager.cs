...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class InputCommandAuditPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an InputCommandAuditPDSA object with any default values
    /// </summary>
    /// <param name="entity">An InputCommandAuditPDSA object</param>
    public void InitEntityObject(InputCommandAuditPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(InputCommandAudit entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent InputCommandAudit objects
    /// </summary>
    public IEnumerable<InputCommandAudit> ConvertPDSACollection(InputCommandAuditPDSACollection pdsaCollection)
    {	
	 var results = new List<InputCommandAudit>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new InputCommandAudit();
