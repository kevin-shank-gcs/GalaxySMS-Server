...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class gcsAuditPDSAManager
  {
    ...
    public void InitEntityObject(gcsAudit entity)
    {
        SimpleMapper.PropertyMap(entity, Entity);
    }

    public IEnumerable<gcsAudit> ConvertPDSACollection(gcsAuditPDSACollection pdsaCollection)
    {
        var results = new List<gcsAudit>();
        foreach (var pdsaEntity in pdsaCollection)
        {
            var convertedEntity = new gcsAudit();
    ...
    /// <summary>
    /// Call this method to initialize an gcsAuditPDSA object with any default values
    /// </summary>
    /// <param name="entity">An gcsAuditPDSA object</param>
    public void InitEntityObject(gcsAuditPDSA entity)
    {
