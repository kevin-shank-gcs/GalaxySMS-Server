...
namespace GalaxySMS.BusinessLayer
{
  ...
  /// </summary>
  public partial class RoleInputOutputGroupPermissionPDSAManager
  {
    ...
    /// <summary>
    /// Call this method to initialize an RoleInputOutputGroupPermissionPDSA object with any default values
    /// </summary>
    /// <param name="entity">An RoleInputOutputGroupPermissionPDSA object</param>
    public void InitEntityObject(RoleInputOutputGroupPermissionPDSA entity)
    {
    ...
    /// </summary>
    public void InitEntityObject(RoleInputOutputGroupPermission entity)
    {
    ...
    /// <summary>
    /// Call this method to convert a PDSACollection to an IEnumerable collection of an equivalent RoleInputOutputGroupPermission objects
    /// </summary>
    public IEnumerable<RoleInputOutputGroupPermission> ConvertPDSACollection(RoleInputOutputGroupPermissionPDSACollection pdsaCollection)
    {	
	 var results = new List<RoleInputOutputGroupPermission>();
      foreach (var pdsaEntity in pdsaCollection)
      {
        var convertedEntity = new RoleInputOutputGroupPermission();
