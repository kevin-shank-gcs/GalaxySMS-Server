...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the IsAccessPortalPropertiesUniquePDSA stored procedure.
  ...
  public partial class IsAccessPortalPropertiesUniquePDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalPropertiesUid = Guid.NewGuid();
