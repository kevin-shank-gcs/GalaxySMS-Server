...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PersonActivationModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PersonActivationModePDSA : PDSAEntityBase
  {
    ...
    private Guid _PersonActivationModeUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Person Activation Mode UidOld value
    /// </summary>
    
    public Guid PersonActivationModeUidOld
    { 
      get { return _PersonActivationModeUidOld; }
      set 
      { 
        if(HasValueChanged(_PersonActivationModeUidOld, value, "PersonActivationModeUid"))
        {
          _PersonActivationModeUidOld = value; 
          RaisePropertyChanged("PersonActivationModeUidOld");
        }
      } 
    }
    #endregion
