...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalMultiFactorModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalMultiFactorModePDSA : PDSAEntityBase
  {
    ...
    private Guid _AccessPortalMultiFactorModeUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Multi Factor Mode UidOld value
    /// </summary>
    
    public Guid AccessPortalMultiFactorModeUidOld
    { 
      get { return _AccessPortalMultiFactorModeUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalMultiFactorModeUidOld, value, "AccessPortalMultiFactorModeUid"))
        {
          _AccessPortalMultiFactorModeUidOld = value; 
          RaisePropertyChanged("AccessPortalMultiFactorModeUidOld");
        }
      } 
    }
    #endregion
