...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a InterfaceBoardSectionModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class InterfaceBoardSectionModePDSA : PDSAEntityBase
  {
    ...
    private Guid _InterfaceBoardSectionModeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Interface Board Section Mode UidOld value
    /// </summary>
    
    public Guid InterfaceBoardSectionModeUidOld
    { 
      get { return _InterfaceBoardSectionModeUidOld; }
      set 
      { 
        if(HasValueChanged(_InterfaceBoardSectionModeUidOld, value, "InterfaceBoardSectionModeUid"))
        {
          _InterfaceBoardSectionModeUidOld = value; 
          RaisePropertyChanged("InterfaceBoardSectionModeUidOld");
        }
      } 
    }
    #endregion
