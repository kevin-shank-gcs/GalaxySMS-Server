...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a InterfaceBoardTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class InterfaceBoardTypePDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _InterfaceBoardTypeUid = Guid.NewGuid();
    private short _TypeCode = 0;
    private string _Display = string.Empty;
    private Guid _DisplayResourceKey = Guid.NewGuid();
    private string _Description = string.Empty;
    private Guid _DescriptionResourceKey = Guid.NewGuid();
    private string _Model = string.Empty;
    private short _NumberOfSections = 0;
    ...
    private Guid _InterfaceBoardTypeUidOld = Guid.NewGuid();
    #endregion
    ...
    /// <summary>
    /// Get/Set the Number Of Sections value
    /// </summary>
    ...
    { 
      ...
      set 
      { 
        if(HasValueChanged(_NumberOfSections, value, "NumberOfSections"))
        {
          _NumberOfSections = value; 
          RaisePropertyChanged("NumberOfSections");
        }
      } 
    }
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Interface Board Type UidOld value
    /// </summary>
    
    public Guid InterfaceBoardTypeUidOld
    { 
      get { return _InterfaceBoardTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_InterfaceBoardTypeUidOld, value, "InterfaceBoardTypeUid"))
        {
          _InterfaceBoardTypeUidOld = value; 
          RaisePropertyChanged("InterfaceBoardTypeUidOld");
        }
      } 
    }
    #endregion
