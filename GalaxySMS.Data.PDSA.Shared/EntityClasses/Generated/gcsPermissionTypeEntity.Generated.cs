...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a gcsPermissionTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class gcsPermissionTypePDSA : PDSAEntityBase
  {
    ...
    private Guid _PermissionTypeIdOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Permission Type IdOld value
    /// </summary>
    
    public Guid PermissionTypeIdOld
    { 
      get { return _PermissionTypeIdOld; }
      set 
      { 
        if(HasValueChanged(_PermissionTypeIdOld, value, "PermissionTypeId"))
        {
          _PermissionTypeIdOld = value; 
          RaisePropertyChanged("PermissionTypeIdOld");
        }
      } 
    }
    #endregion
