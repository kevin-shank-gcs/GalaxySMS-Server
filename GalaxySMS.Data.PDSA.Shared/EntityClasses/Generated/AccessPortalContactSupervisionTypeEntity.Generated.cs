...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AccessPortalContactSupervisionTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AccessPortalContactSupervisionTypePDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _AccessPortalContactSupervisionTypeUid = Guid.NewGuid();
    ...
    private Guid _AccessPortalContactSupervisionTypeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Access Portal Contact Supervision Type UidOld value
    /// </summary>
    
    public Guid AccessPortalContactSupervisionTypeUidOld
    { 
      get { return _AccessPortalContactSupervisionTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_AccessPortalContactSupervisionTypeUidOld, value, "AccessPortalContactSupervisionTypeUid"))
        {
          _AccessPortalContactSupervisionTypeUidOld = value; 
          RaisePropertyChanged("AccessPortalContactSupervisionTypeUidOld");
        }
      } 
    }
    #endregion
