...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a gcsApplicationAuditTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class gcsApplicationAuditTypePDSA : PDSAEntityBase
  {
    ...
    private Guid _ApplicationAuditTypeIdOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Application Audit Type IdOld value
    /// </summary>
    
    public Guid ApplicationAuditTypeIdOld
    { 
      get { return _ApplicationAuditTypeIdOld; }
      set 
      { 
        if(HasValueChanged(_ApplicationAuditTypeIdOld, value, "ApplicationAuditTypeId"))
        {
          _ApplicationAuditTypeIdOld = value; 
          RaisePropertyChanged("ApplicationAuditTypeIdOld");
        }
      } 
    }
    #endregion
