...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a AutomaticForgivePassbackFrequencyPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class AutomaticForgivePassbackFrequencyPDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _AutomaticForgivePassbackFrequencyUid = Guid.NewGuid();
    ...
    private Guid _AutomaticForgivePassbackFrequencyUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Automatic Forgive Passback Frequency UidOld value
    /// </summary>
    
    public Guid AutomaticForgivePassbackFrequencyUidOld
    { 
      get { return _AutomaticForgivePassbackFrequencyUidOld; }
      set 
      { 
        if(HasValueChanged(_AutomaticForgivePassbackFrequencyUidOld, value, "AutomaticForgivePassbackFrequencyUid"))
        {
          _AutomaticForgivePassbackFrequencyUidOld = value; 
          RaisePropertyChanged("AutomaticForgivePassbackFrequencyUidOld");
        }
      } 
    }
    #endregion
