...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a ClusterTypePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class ClusterTypePDSA : PDSAEntityBase
  {
    ...
    private Guid _ClusterTypeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Cluster Type UidOld value
    /// </summary>
    
    public Guid ClusterTypeUidOld
    { 
      get { return _ClusterTypeUidOld; }
      set 
      { 
        if(HasValueChanged(_ClusterTypeUidOld, value, "ClusterTypeUid"))
        {
          _ClusterTypeUidOld = value; 
          RaisePropertyChanged("ClusterTypeUidOld");
        }
      } 
    }
    #endregion
