...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a GenderPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class GenderPDSA : PDSAEntityBase
  {
    ...
    private Guid _GenderUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      set 
      { 
        if(HasValueChanged(_GenderCode, value, "GenderCode"))
        {
          _GenderCode = value; 
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Gender UidOld value
    /// </summary>
    
    public Guid GenderUidOld
    { 
      get { return _GenderUidOld; }
      set 
      { 
        if(HasValueChanged(_GenderUidOld, value, "GenderUid"))
        {
          _GenderUidOld = value; 
          RaisePropertyChanged("GenderUidOld");
        }
      } 
    }
    #endregion
