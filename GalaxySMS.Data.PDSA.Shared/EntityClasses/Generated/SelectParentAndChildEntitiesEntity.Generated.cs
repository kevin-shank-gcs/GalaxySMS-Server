...
{
  /// <summary>
  /// This class contains properties for each data value returned, or parameter to be input/output from the SelectParentAndChildEntitiesPDSA stored procedure.
  ...
  public partial class SelectParentAndChildEntitiesPDSA : PDSAEntityBase
  {
    ...
    private Guid _rootEntityId = Guid.Empty;
    ...
    /// <summary>
    /// Get/Set the root Entity Id value
    /// </summary>
    ...
    { 
      ...
      set 
      { 
        if(HasValueChanged(_rootEntityId, value, "@rootEntityId"))
        {
          _rootEntityId = value; 
          RaisePropertyChanged("rootEntityId");
        }
      } 
    }
