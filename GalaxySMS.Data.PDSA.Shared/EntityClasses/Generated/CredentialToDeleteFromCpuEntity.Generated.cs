...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a CredentialToDeleteFromCpuPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class CredentialToDeleteFromCpuPDSA : PDSAEntityBase
  {
    ...
    private Guid _CredentialToDeleteFromCpuUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Credential To Delete From Cpu UidOld value
    /// </summary>
    
    public Guid CredentialToDeleteFromCpuUidOld
    { 
      get { return _CredentialToDeleteFromCpuUidOld; }
      set 
      { 
        if(HasValueChanged(_CredentialToDeleteFromCpuUidOld, value, "CredentialToDeleteFromCpuUid"))
        {
          _CredentialToDeleteFromCpuUidOld = value; 
          RaisePropertyChanged("CredentialToDeleteFromCpuUidOld");
        }
      } 
    }
    #endregion
