...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a GalaxyOutputInputSourceModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class GalaxyOutputInputSourceModePDSA : PDSAEntityBase
  {
    ...
    private Guid _GalaxyOutputInputSourceModeUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Galaxy Output Input Source Mode UidOld value
    /// </summary>
    
    public Guid GalaxyOutputInputSourceModeUidOld
    { 
      get { return _GalaxyOutputInputSourceModeUidOld; }
      set 
      { 
        if(HasValueChanged(_GalaxyOutputInputSourceModeUidOld, value, "GalaxyOutputInputSourceModeUid"))
        {
          _GalaxyOutputInputSourceModeUidOld = value; 
          RaisePropertyChanged("GalaxyOutputInputSourceModeUidOld");
        }
      } 
    }
    #endregion
