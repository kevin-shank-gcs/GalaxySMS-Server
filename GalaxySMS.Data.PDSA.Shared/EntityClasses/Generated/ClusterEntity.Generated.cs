...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a ClusterPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class ClusterPDSA : PDSAEntityBase
  {
    ...
    private short _AccessRuleOverrideTimeout = 0;
    private short _UnlimitedCredentialTimeout = 0;
    ...
    private Guid _ClusterUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Cluster UidOld value
    /// </summary>
    
    public Guid ClusterUidOld
    { 
      get { return _ClusterUidOld; }
      set 
      { 
        if(HasValueChanged(_ClusterUidOld, value, "ClusterUid"))
        {
          _ClusterUidOld = value; 
          RaisePropertyChanged("ClusterUidOld");
        }
      } 
    }
    #endregion
