...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a OutputDeviceActivityEventPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class OutputDeviceActivityEventPDSA : PDSAEntityBase
  {
    ...
    private Guid _OutputDeviceActivityEventUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Output Device Activity Event UidOld value
    /// </summary>
    
    public Guid OutputDeviceActivityEventUidOld
    { 
      get { return _OutputDeviceActivityEventUidOld; }
      set 
      { 
        if(HasValueChanged(_OutputDeviceActivityEventUidOld, value, "OutputDeviceActivityEventUid"))
        {
          _OutputDeviceActivityEventUidOld = value; 
          RaisePropertyChanged("OutputDeviceActivityEventUidOld");
        }
      } 
    }
    #endregion
