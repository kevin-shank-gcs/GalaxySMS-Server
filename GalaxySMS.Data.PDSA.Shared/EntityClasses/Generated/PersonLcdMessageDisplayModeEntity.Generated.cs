...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PersonLcdMessageDisplayModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PersonLcdMessageDisplayModePDSA : PDSAEntityBase
  {
    ...
    private Guid _PersonLcdMessageDisplayModeUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Person Lcd Message Display Mode UidOld value
    /// </summary>
    
    public Guid PersonLcdMessageDisplayModeUidOld
    { 
      get { return _PersonLcdMessageDisplayModeUidOld; }
      set 
      { 
        if(HasValueChanged(_PersonLcdMessageDisplayModeUidOld, value, "PersonLcdMessageDisplayModeUid"))
        {
          _PersonLcdMessageDisplayModeUidOld = value; 
          RaisePropertyChanged("PersonLcdMessageDisplayModeUidOld");
        }
      } 
    }
    #endregion
