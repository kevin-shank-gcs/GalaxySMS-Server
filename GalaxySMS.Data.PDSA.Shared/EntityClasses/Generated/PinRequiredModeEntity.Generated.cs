...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a PinRequiredModePDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class PinRequiredModePDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _PinRequiredModeUid = Guid.NewGuid();
    ...
    private Guid _PinRequiredModeUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Pin Required Mode UidOld value
    /// </summary>
    
    public Guid PinRequiredModeUidOld
    { 
      get { return _PinRequiredModeUidOld; }
      set 
      { 
        if(HasValueChanged(_PinRequiredModeUidOld, value, "PinRequiredModeUid"))
        {
          _PinRequiredModeUidOld = value; 
          RaisePropertyChanged("PinRequiredModeUidOld");
        }
      } 
    }
    #endregion
