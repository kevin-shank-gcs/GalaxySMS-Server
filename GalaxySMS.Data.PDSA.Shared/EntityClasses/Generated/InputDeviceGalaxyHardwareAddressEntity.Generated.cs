...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a InputDeviceGalaxyHardwareAddressPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class InputDeviceGalaxyHardwareAddressPDSA : PDSAEntityBase
  {
    #region Private Variables
    private Guid _InputDeviceGalaxyHardwareAddressUid = Guid.Empty;
    ...
    private Guid _InputDeviceGalaxyHardwareAddressUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Input Device Galaxy Hardware Address UidOld value
    /// </summary>
    
    public Guid InputDeviceGalaxyHardwareAddressUidOld
    { 
      get { return _InputDeviceGalaxyHardwareAddressUidOld; }
      set 
      { 
        if(HasValueChanged(_InputDeviceGalaxyHardwareAddressUidOld, value, "InputDeviceGalaxyHardwareAddressUid"))
        {
          _InputDeviceGalaxyHardwareAddressUidOld = value; 
          RaisePropertyChanged("InputDeviceGalaxyHardwareAddressUidOld");
        }
      } 
    }
    #endregion
