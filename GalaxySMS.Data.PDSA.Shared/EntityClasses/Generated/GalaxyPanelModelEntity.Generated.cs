...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a GalaxyPanelModelPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class GalaxyPanelModelPDSA : PDSAEntityBase
  {
    ...
    private Guid _GalaxyPanelModelUidOld = Guid.NewGuid();
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Galaxy Panel Model UidOld value
    /// </summary>
    
    public Guid GalaxyPanelModelUidOld
    { 
      get { return _GalaxyPanelModelUidOld; }
      set 
      { 
        if(HasValueChanged(_GalaxyPanelModelUidOld, value, "GalaxyPanelModelUid"))
        {
          _GalaxyPanelModelUidOld = value; 
          RaisePropertyChanged("GalaxyPanelModelUidOld");
        }
      } 
    }
    #endregion
