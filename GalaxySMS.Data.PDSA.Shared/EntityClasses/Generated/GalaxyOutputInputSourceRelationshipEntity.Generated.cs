...
{
  /// <summary>
  /// This class contains properties for each data value that makes up a GalaxyOutputInputSourceRelationshipPDSA.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// Do not modify this class or add methods as it is intended to be able to be re-generated at any time.
  /// </summary>
  
  public partial class GalaxyOutputInputSourceRelationshipPDSA : PDSAEntityBase
  {
    ...
    private Guid _GalaxyOutputInputSourceRelationshipUidOld = Guid.Empty;
    #endregion
    ...
    { 
      ...
      { 
        ...
        /// <summary>
    /// Get/Set the Galaxy Output Input Source Relationship UidOld value
    /// </summary>
    
    public Guid GalaxyOutputInputSourceRelationshipUidOld
    { 
      get { return _GalaxyOutputInputSourceRelationshipUidOld; }
      set 
      { 
        if(HasValueChanged(_GalaxyOutputInputSourceRelationshipUidOld, value, "GalaxyOutputInputSourceRelationshipUid"))
        {
          _GalaxyOutputInputSourceRelationshipUidOld = value; 
          RaisePropertyChanged("GalaxyOutputInputSourceRelationshipUidOld");
        }
      } 
    }
    #endregion
