  ...
  public partial class gcsPermissionCategoryPDSAData : PDSADataClassTable
  {
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.IsSystemCategory).IsNull == false)
        Entity.IsSystemCategory = ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.IsSystemCategory).GetValueAsBoolean();
      else
        Entity.IsSystemCategory = null;
      ...
      if (ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.IsEntityCategory).IsNull == false)
        Entity.IsEntityCategory = ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.IsEntityCategory).GetValueAsBoolean();
      else
        Entity.IsEntityCategory = null;
      ...
      if (ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.InsertDate).IsNull == false)
        Entity.InsertDate = ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.InsertDate).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.UpdateDate).IsNull == false)
        Entity.UpdateDate = ValidatorObject.Properties.GetByName(gcsPermissionCategoryPDSAValidator.ColumnNames.UpdateDate).GetAsDate();
      else
    ...
    public override string SelectSQL()
    {
      ...
      switch (SelectFilter)
      {
        case SelectFilters.All:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_SelectAll");
          }
          else
          {
        ...
        case SelectFilters.ByApplicationId:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_ByApplicationId");
          }
          else
          {
        ...
        case SelectFilters.ListBox:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_SelectListBox");
          }
          else
          {
        ...
        case SelectFilters.PrimaryKey:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_SelectByPK");
          }
          else
          {
        ...
        case SelectFilters.Search:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_SelectSearch");
          }
          else
          {
    ...
    public override string InsertSQL()
    {
      ...
      switch (InsertFilter)
      {
        case InsertFilters.All:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_Insert");
          }
          else
          {
    ...
    public override string UpdateSQL()
    {
      ...
      switch (UpdateFilter)
      {
        case UpdateFilters.PrimaryKey:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_Update");
          }
          else
          {
        ...
        case UpdateFilters.UpdateConcurrency:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_UpdateConcurrency");
          }
          else
          {
    ...
    public override string DeleteSQL()
    {
      ...
      switch (DeleteFilter)
      {
        ...
        case DeleteFilters.DeleteByPK:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_DeleteByPK");
          }
          else
          {
    ...
    public override string RowCountSQL()
    {
      ...
      switch (RowCountFilter)
      {
        case RowCountFilters.All:
          if (UseStoredProcs)
          {
            sb.Append("GCS.gcsPermissionCategory_RowCount");
          }
          else
          {
