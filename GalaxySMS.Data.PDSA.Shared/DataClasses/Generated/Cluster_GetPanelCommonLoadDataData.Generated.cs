  ...
  public class Cluster_GetPanelCommonLoadDataPDSAData : PDSAStoredProcReadOnly
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitDataColumns()
    {
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_Cluster_GetPanelCommonLoadDataPDSA_AccountCode_Header", "Account Code"), false, typeof(string), DbType.String);
      AllColumns.Add(dc);
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AccessRuleOverrideTimeout, GetResourceMessage("GCS_Cluster_GetPanelCommonLoadDataPDSA_AccessRuleOverrideTimeout_Header", "Access Rule Override Timeout"), false, typeof(short), DbType.Int16);
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UnlimitedCredentialTimeout, GetResourceMessage("GCS_Cluster_GetPanelCommonLoadDataPDSA_UnlimitedCredentialTimeout_Header", "Unlimited Credential Timeout"), false, typeof(short), DbType.Int16);
      AllColumns.Add(dc);
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.ResetCrisisIOGroupNumber, GetResourceMessage("GCS_Cluster_GetPanelCommonLoadDataPDSA_ResetCrisisIOGroupNumber_Header", "Reset Crisis IO Group Numbe"), false, typeof(int), DbType.Int32);
      AllColumns.Add(dc);
    ...
    protected override void EntityDataToParameterCollection()
    {
      ...
      if (AllParameters.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ParameterNames.ClusterGroupId).SetAsNull == false)
        ...
        AllParameters.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ParameterNames.ClusterGroupId).Value = System.Data.SqlTypes.SqlChars.Null;
    ...
    protected override void EntityDataToColumnCollection()
    {
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.ClusterUid).SetAsNull == false)
        ...
        AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.ClusterUid).Value = Guid.NewGuid();
      ...
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.ClusterGroupId).SetAsNull == false)
        ...
        AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.ClusterGroupId).Value = string.Empty;
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.InsertDate).IsNull == false)
        Entity.InsertDate = AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.InsertDate).GetAsDate();
      else
        Entity.InsertDate = DateTimeOffset.Now;

      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UpdateDate).IsNull == false)
        Entity.UpdateDate = AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UpdateDate).GetAsDate();
      else
      ...
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.IsActive).IsNull == false)
        Entity.IsActive = AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.IsActive).GetValueAsBoolean();
      else
      ...
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AbaFoldOption).IsNull == false)
        Entity.AbaFoldOption = AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AbaFoldOption).GetValueAsBoolean();
      else
      ...
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AbaClipOption).IsNull == false)
        Entity.AbaClipOption = AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AbaClipOption).GetValueAsBoolean();
      else
      ...
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AccessRuleOverrideTimeout).IsNull == false)
        Entity.AccessRuleOverrideTimeout = AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AccessRuleOverrideTimeout).GetAsShort();
      else
      ...
      if (AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UnlimitedCredentialTimeout).IsNull == false)
        Entity.UnlimitedCredentialTimeout = AllColumns.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UnlimitedCredentialTimeout).GetAsShort();
      else
    ...
    public Cluster_GetPanelCommonLoadDataPDSA CreateEntityFromDataRow(DataRow dr)
    {
      ...
      if (dr.Table.Columns.Contains(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.InsertDate))
      {
        if (dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.InsertDate] != DBNull.Value)
          entity.InsertDate = Convert.ToDateTime(dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.InsertDate]);
      }
      if (dr.Table.Columns.Contains(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UpdateDate))
      {
        if (dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UpdateDate] != DBNull.Value)
          entity.UpdateDate = Convert.ToDateTime(dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UpdateDate]);
      }
      ...
      if (dr.Table.Columns.Contains(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AccessRuleOverrideTimeout))
      {
        if (dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AccessRuleOverrideTimeout] != DBNull.Value)
          entity.AccessRuleOverrideTimeout = Convert.ToInt16(dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.AccessRuleOverrideTimeout]);
      }
      if (dr.Table.Columns.Contains(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UnlimitedCredentialTimeout))
      {
        if (dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UnlimitedCredentialTimeout] != DBNull.Value)
          entity.UnlimitedCredentialTimeout = Convert.ToInt16(dr[Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.UnlimitedCredentialTimeout]);
      }
