    ...
    public override string SelectSQL()
    {
      ...
      switch (SelectFilter)
      {
        case SelectFilters.All:
          sb.Append(" SELECT CredentialToDeleteFromCpuUid, CpuUid, CardBinaryData, DeletedFromDatabaseDate, DeletedFromCpuDate, ClusterNumber, PanelNumber, CpuNumber, ClusterGroupId, ServerAddress, IsConnected FROM GCS.CredentialToDelete_PanelLoadDataChangesForCpu");

          
          break;
        case SelectFilters.Search:
          sb.Append(" SELECT CredentialToDeleteFromCpuUid, CpuUid, CardBinaryData, DeletedFromDatabaseDate, DeletedFromCpuDate, ClusterNumber, PanelNumber, CpuNumber, ClusterGroupId, ServerAddress, IsConnected FROM GCS.CredentialToDelete_PanelLoadDataChangesForCpu WHERE (@ServerAddress IS NULL OR ServerAddress LIKE @ServerAddress + '%')");
    ...
    public override string RowCountSQL()
    {
      ...
      switch (RowCountFilter)
      {
        case RowCountFilters.All:
          sb.Append(" SELECT Count(*) As NumRecs FROM GCS.CredentialToDelete_PanelLoadDataChangesForCpu");
    ...
    public override string WhereClauseSQL()
    {
      ...
      switch (WhereFilter)
      {
        ...
        case WhereFilters.ServerAddress:
          sb.Append(" WHERE ServerAddress = @ServerAddress");

          
          break;
        case WhereFilters.LikeServerAddress:
          sb.Append(" WHERE ServerAddress LIKE @ServerAddress + '%'");
    ...
    public override string OrderByClauseSQL()
    {
      ...
      switch (OrderByFilter)
      {
        ...
        case OrderByFilters.ServerAddress:
          sb.Append(" ORDER BY ServerAddress");
