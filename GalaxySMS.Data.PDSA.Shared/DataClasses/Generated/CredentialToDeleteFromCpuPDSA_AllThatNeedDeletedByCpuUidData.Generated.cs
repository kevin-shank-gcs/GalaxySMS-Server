   ...
   #region InitParameters Method
    ...
    protected override void EntityDataToParameterCollection()
    {
      ...
      if (AllParameters.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ParameterNames.ServerAddress).SetAsNull == false)
        ...
        AllParameters.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ParameterNames.ServerAddress).Value = System.Data.SqlTypes.SqlChars.Null;
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      if (AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromDatabaseDate).SetAsNull == false)
        ...
        AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromDatabaseDate).Value = DateTimeOffset.Now;
      ...
      if (AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromCpuDate).SetAsNull == false)
        ...
        AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromCpuDate).Value = DateTimeOffset.Now;
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromDatabaseDate).IsNull == false)
        Entity.DeletedFromDatabaseDate = AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromDatabaseDate).GetAsDate();
      else
        Entity.DeletedFromDatabaseDate = DateTimeOffset.Now;

      if (AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromCpuDate).IsNull == false)
        Entity.DeletedFromCpuDate = AllColumns.GetByName(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromCpuDate).GetAsDate();
      else
    ...
    public CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSA CreateEntityFromDataRow(DataRow dr)
    {
      ...
      if (dr.Table.Columns.Contains(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.CardBinaryData))
      {
        if (dr[CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.CardBinaryData] != DBNull.Value)
            entity.CardBinaryData = (byte[])dr[CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedPDSAData.ColumnNames.CardBinaryData];//entity.CardBinaryData = PDSAString.ConvertToStringTrim(dr[CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.CardBinaryData]);
      }
      if (dr.Table.Columns.Contains(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromDatabaseDate))
      {
        if (dr[CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromDatabaseDate] != DBNull.Value)
          entity.DeletedFromDatabaseDate = Convert.ToDateTime(dr[CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromDatabaseDate]);
      }
      if (dr.Table.Columns.Contains(CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromCpuDate))
      {
        if (dr[CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromCpuDate] != DBNull.Value)
          entity.DeletedFromCpuDate = Convert.ToDateTime(dr[CredentialToDeleteFromCpuPDSA_AllThatNeedDeletedByCpuUidPDSAValidator.ColumnNames.DeletedFromCpuDate]);
      }
