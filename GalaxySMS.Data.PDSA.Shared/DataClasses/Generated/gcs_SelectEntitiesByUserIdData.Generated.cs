   ...
   #region InitParameters Method
    ...
    protected override void EntityDataToColumnCollection()
    {
      if (AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.EntityId).SetAsNull == false)
        ...
        AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.EntityId).Value = Guid.NewGuid();
      ...
      if (AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.BinaryResourceUid).SetAsNull == false)
        ...
        AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.BinaryResourceUid).Value = Guid.NewGuid();
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.IsDefault).IsNull == false)
        Entity.IsDefault = AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.IsDefault).GetValueAsBoolean();
      else
        Entity.IsDefault = false;

      if (AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.IsActive).IsNull == false)
        Entity.IsActive = AllColumns.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.IsActive).GetValueAsBoolean();
      else
