  ...
  public partial class CredentialToLoadToCpuPDSAData : PDSADataClassTable
  {
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      if (ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastCredentialLoadedDate).SetAsNull == true)
        Entity.LastCredentialLoadedDate = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);//DateTimeOffset.Now;
      ...
      if (ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastPersonalAccessGroupLoadedDate).SetAsNull == true)
        Entity.LastPersonalAccessGroupLoadedDate = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);//DateTimeOffset.Now;
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastCredentialChangeDate).IsNull == false)
        Entity.LastCredentialChangeDate = ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastCredentialChangeDate).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastPersonalAccessGroupChangeDate).IsNull == false)
        Entity.LastPersonalAccessGroupChangeDate = ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastPersonalAccessGroupChangeDate).GetAsDate();
      else
        Entity.LastPersonalAccessGroupChangeDate = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);
      ...
      if (ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastCredentialLoadedDate).IsNull == false)
        Entity.LastCredentialLoadedDate = ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastCredentialLoadedDate).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastPersonalAccessGroupLoadedDate).IsNull == false)
        Entity.LastPersonalAccessGroupLoadedDate = ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastPersonalAccessGroupLoadedDate).GetAsDate();
      else
        Entity.LastPersonalAccessGroupLoadedDate = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);
      ...
      if (ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastForceLoadDate).IsNull == false)
        Entity.LastForceLoadDate = ValidatorObject.Properties.GetByName(CredentialToLoadToCpuPDSAValidator.ColumnNames.LastForceLoadDate).GetAsDate();
      else
