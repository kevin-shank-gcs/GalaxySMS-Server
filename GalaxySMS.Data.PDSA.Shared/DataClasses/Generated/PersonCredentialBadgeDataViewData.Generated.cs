  ...
  public partial class PersonCredentialBadgeDataViewPDSAData : PDSADataClassReadOnly
  {
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ActivationDateTime).IsNull == false)
        Entity.ActivationDateTime = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ActivationDateTime).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ExpirationDateTime).IsNull == false)
        Entity.ExpirationDateTime = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ExpirationDateTime).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.InsertDate).IsNull == false)
        Entity.InsertDate = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.InsertDate).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.UpdateDate).IsNull == false)
        Entity.UpdateDate = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.UpdateDate).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialActivationDate).IsNull == false)
        Entity.CredentialActivationDate = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialActivationDate).GetAsDate();
      else
        Entity.CredentialActivationDate = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialExpirationDateTime).IsNull == false)
        Entity.CredentialExpirationDateTime = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CredentialExpirationDateTime).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date1).IsNull == false)
        Entity.Date1 = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date1).GetAsDate();
      else
        Entity.Date1 = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date2).IsNull == false)
        Entity.Date2 = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.Date2).GetAsDate();
      else
        Entity.Date2 = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDate).IsNull == false)
        Entity.CurrentDate = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDate).GetAsDate();
      else
        Entity.CurrentDate = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);
      ...
      if (ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDateTime).IsNull == false)
        Entity.CurrentDateTime = ValidatorObject.Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.CurrentDateTime).GetAsDate();
      else
        Entity.CurrentDateTime = Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat);
