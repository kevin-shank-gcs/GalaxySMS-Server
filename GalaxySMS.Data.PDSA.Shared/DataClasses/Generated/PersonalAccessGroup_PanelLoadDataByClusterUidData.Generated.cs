  ...
  public class PersonalAccessGroup_PanelLoadDataByClusterUidPDSAData : PDSAStoredProcReadOnly
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitDataColumns()
    {
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_PersonalAccessGroup_PanelLoadDataByClusterUidPDSA_AccountCode_Header", "Account Code"), false, typeof(string), DbType.String);
      AllColumns.Add(dc);
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      if (AllColumns.GetByName(PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator.ColumnNames.ClusterGroupId).SetAsNull == false)
        ...
        AllColumns.GetByName(PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator.ColumnNames.ClusterGroupId).Value = string.Empty;
