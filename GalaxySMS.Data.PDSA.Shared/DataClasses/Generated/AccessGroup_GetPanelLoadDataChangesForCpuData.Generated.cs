  ...
  public class AccessGroup_GetPanelLoadDataChangesForCpuPDSAData : PDSAStoredProcReadOnly
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitDataColumns()
    {
      ...
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ActivationDate, GetResourceMessage("GCS_AccessGroup_GetPanelLoadDataChangesForCpuPDSA_ActivationDate_Header", "Activation Date"), false, typeof(DateTimeOffset), DbType.DateTimeOffset);
      AllColumns.Add(dc);
      dc = PDSADataColumn.CreateDataColumn(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ExpirationDate, GetResourceMessage("GCS_AccessGroup_GetPanelLoadDataChangesForCpuPDSA_ExpirationDate_Header", "Expiration Date"), false, typeof(DateTimeOffset), DbType.DateTimeOffset);
      AllColumns.Add(dc);
    ...
    protected override void EntityDataToColumnCollection()
    {
      ...
      if (AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ActivationDate).SetAsNull == false)
        AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ActivationDate).Value = Entity.ActivationDate;
      else
        AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ActivationDate).Value = DateTimeOffset.Now;
     
      if (AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ExpirationDate).SetAsNull == false)
        AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ExpirationDate).Value = Entity.ExpirationDate;
      else
        AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ExpirationDate).Value = DateTimeOffset.Now;
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster).IsNull == false)
        Entity.CurrentTimeForCluster = AllColumns.GetByName(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster).GetAsDate();
      else
    ...
    public AccessGroup_GetPanelLoadDataChangesForCpuPDSA CreateEntityFromDataRow(DataRow dr)
    {
      ...
      if (dr.Table.Columns.Contains(AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster))
      {
        if (dr[AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster] != DBNull.Value)
          entity.CurrentTimeForCluster = Convert.ToDateTime(dr[AccessGroup_GetPanelLoadDataChangesForCpuPDSAValidator.ColumnNames.CurrentTimeForCluster]);
      }
