  ...
  public class DateTypeDefaultBehavior_GetPanelLoadDataPDSAData : PDSAStoredProcReadOnly
  {
   ...
   #region InitParameters Method
    ...
    protected override void InitDataColumns()
    {
      ...
      dc = PDSADataColumn.CreateDataColumn(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid, GetResourceMessage("GCS_DateTypeDefaultBehavior_GetPanelLoadDataPDSA_DateTypeDefaultBehaviorUid_Header", "Date Type Default Behavior Uid"), false, typeof(Guid), DbType.Guid);
      AllColumns.Add(dc);
    ...
    {
      if (AllColumns.GetByName(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).SetAsNull == false)
        AllColumns.GetByName(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).Value = Entity.DateTypeDefaultBehaviorUid;
      else
        AllColumns.GetByName(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).Value = Guid.Empty;
    ...
    {
      if (AllColumns.GetByName(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).IsNull == false)
        Entity.DateTypeDefaultBehaviorUid = AllColumns.GetByName(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).GetAsGuid();
      else
    ...
    public DateTypeDefaultBehavior_GetPanelLoadDataPDSA CreateEntityFromDataRow(DataRow dr)
    {
      ...
      if (dr.Table.Columns.Contains(DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid))
      {
        if (dr[DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid] != DBNull.Value)
          entity.DateTypeDefaultBehaviorUid = PDSAProperty.ConvertToGuid(dr[DateTypeDefaultBehavior_GetPanelLoadDataPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid]);
      }
