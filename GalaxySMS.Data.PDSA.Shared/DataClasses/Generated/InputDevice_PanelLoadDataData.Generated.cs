  ...
  public partial class InputDevice_PanelLoadDataPDSAData : PDSADataClassReadOnly
  {
    ...
    protected override void ColumnCollectionToEntityData()
    {
      ...
      if (ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.GalaxyInputDevicePropertiesLastUpdated).IsNull == false)
        Entity.GalaxyInputDevicePropertiesLastUpdated = ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.GalaxyInputDevicePropertiesLastUpdated).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainIOGroupLastUpdated).IsNull == false)
        Entity.MainIOGroupLastUpdated = ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainIOGroupLastUpdated).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup1LastUpdated).IsNull == false)
        Entity.ArmingIOGroup1LastUpdated = ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup1LastUpdated).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup2LastUpdated).IsNull == false)
        Entity.ArmingIOGroup2LastUpdated = ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup2LastUpdated).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup3LastUpdated).IsNull == false)
        Entity.ArmingIOGroup3LastUpdated = ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup3LastUpdated).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup4LastUpdated).IsNull == false)
        Entity.ArmingIOGroup4LastUpdated = ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ArmingIOGroup4LastUpdated).GetAsDate();
      else
      ...
      if (ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainScheduleLastUpdated).IsNull == false)
        Entity.MainScheduleLastUpdated = ValidatorObject.Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.MainScheduleLastUpdated).GetAsDate();
      else
