    ...
    public override string SelectSQL()
    {
      ...
      switch (SelectFilter)
      {
        case SelectFilters.All:
          sb.Append(" SELECT PersonUid, ClusterUid, GalaxyPanelUid, PersonalAccessGroupNumber, ClusterNumber, ClusterGroupId, PanelScheduleNumber, DoorNumber, PanelNumber, AccessGroupDisplay FROM GCS.PersonalAccessGroup_PanelLoadData");

          
          break;
        case SelectFilters.Search:
          sb.Append(" SELECT PersonUid, ClusterUid, GalaxyPanelUid, PersonalAccessGroupNumber, ClusterNumber, ClusterGroupId, PanelScheduleNumber, DoorNumber, PanelNumber, AccessGroupDisplay FROM GCS.PersonalAccessGroup_PanelLoadData WHERE (@ClusterGroupId IS NULL OR ClusterGroupId LIKE @ClusterGroupId + '%')");
    ...
    public override string RowCountSQL()
    {
      ...
      switch (RowCountFilter)
      {
        case RowCountFilters.All:
          sb.Append(" SELECT Count(*) As NumRecs FROM GCS.PersonalAccessGroup_PanelLoadData");
