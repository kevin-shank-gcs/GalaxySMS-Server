...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalNoServerReplyBehaviorUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalNoServerReplyBehaviorUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalNoServerReplyBehaviorUniquePDSA</param>
    public IsAccessPortalNoServerReplyBehaviorUniquePDSAValidator(IsAccessPortalNoServerReplyBehaviorUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalNoServerReplyBehaviorUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalNoServerReplyBehaviorUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalNoServerReplyBehaviorUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalNoServerReplyBehaviorUniquePDSAValidator.ColumnNames.DateColumnNameHere);
