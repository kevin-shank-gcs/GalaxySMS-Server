...
{
  /// <summary>
  /// Used to validate business rules on the ClusterPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class ClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterPDSA</param>
    public ClusterPDSAValidator(ClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterPDSAValidator";

      // Create Properties for each field in the ClusterPDSA entity class
      InitProperties();
    ...
    public ClusterPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your ClusterPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterPDSAValidator.ColumnNames.DateColumnNameHere);
