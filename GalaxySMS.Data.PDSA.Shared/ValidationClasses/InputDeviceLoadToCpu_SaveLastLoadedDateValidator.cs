...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceLoadToCpu_SaveLastLoadedDatePDSA</param>
    public InputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator(InputDeviceLoadToCpu_SaveLastLoadedDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator";

      // Create Properties for each field in the InputDeviceLoadToCpu_SaveLastLoadedDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.DateColumnNameHere);
