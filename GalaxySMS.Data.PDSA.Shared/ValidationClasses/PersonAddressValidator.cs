...
{
  /// <summary>
  /// Used to validate business rules on the PersonAddressPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonAddressPDSA</param>
    public PersonAddressPDSAValidator(PersonAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonAddressPDSAValidator";

      // Create Properties for each field in the PersonAddressPDSA entity class
      InitProperties();
    ...
    public PersonAddressPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonAddressPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonAddressPDSAValidator.ColumnNames.DateColumnNameHere);
