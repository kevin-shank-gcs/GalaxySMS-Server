...
{
  /// <summary>
  /// Used to validate business rules on the AssaAccessPointTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaAccessPointTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaAccessPointTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaAccessPointTypePDSA</param>
    public AssaAccessPointTypePDSAValidator(AssaAccessPointTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaAccessPointTypePDSAValidator";

      // Create Properties for each field in the AssaAccessPointTypePDSA entity class
      InitProperties();
    ...
    public AssaAccessPointTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaAccessPointTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaAccessPointTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaAccessPointTypePDSAValidator.ColumnNames.DateColumnNameHere);
