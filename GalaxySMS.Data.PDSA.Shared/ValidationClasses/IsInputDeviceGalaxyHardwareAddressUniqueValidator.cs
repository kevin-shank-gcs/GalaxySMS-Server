...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceGalaxyHardwareAddressUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceGalaxyHardwareAddressUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceGalaxyHardwareAddressUniquePDSA</param>
    public IsInputDeviceGalaxyHardwareAddressUniquePDSAValidator(IsInputDeviceGalaxyHardwareAddressUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceGalaxyHardwareAddressUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceGalaxyHardwareAddressUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.DateColumnNameHere);
