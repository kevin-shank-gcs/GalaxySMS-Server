...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsSetting_GetValuePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsSetting_GetValuePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsSetting_GetValuePDSA</param>
    public gcsSetting_GetValuePDSAValidator(gcsSetting_GetValuePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsSetting_GetValuePDSAValidator";

      // Create Properties for each field in the gcsSetting_GetValuePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsSetting_GetValuePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsSetting_GetValuePDSAValidator.ColumnNames.DateColumnNameHere);
