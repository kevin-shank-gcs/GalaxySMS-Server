...
{
  /// <summary>
  /// Used to validate business rules on the PersonCredentialPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonCredentialPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonCredentialPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonCredentialPDSA</param>
    public PersonCredentialPDSAValidator(PersonCredentialPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonCredentialPDSAValidator";

      // Create Properties for each field in the PersonCredentialPDSA entity class
      InitProperties();
    ...
    public PersonCredentialPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonCredentialPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonCredentialPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonCredentialPDSAValidator.ColumnNames.DateColumnNameHere);
