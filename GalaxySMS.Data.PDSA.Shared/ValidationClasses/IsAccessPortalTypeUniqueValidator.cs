...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalTypeUniquePDSA</param>
    public IsAccessPortalTypeUniquePDSAValidator(IsAccessPortalTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalTypeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
