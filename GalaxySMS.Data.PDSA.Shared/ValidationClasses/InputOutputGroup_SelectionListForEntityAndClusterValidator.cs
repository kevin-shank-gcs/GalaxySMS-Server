...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroup_SelectionListForEntityAndClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroup_SelectionListForEntityAndClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroup_SelectionListForEntityAndClusterPDSA</param>
    public InputOutputGroup_SelectionListForEntityAndClusterPDSAValidator(InputOutputGroup_SelectionListForEntityAndClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroup_SelectionListForEntityAndClusterPDSAValidator";

      // Create Properties for each field in the InputOutputGroup_SelectionListForEntityAndClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroup_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroup_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.DateColumnNameHere);
