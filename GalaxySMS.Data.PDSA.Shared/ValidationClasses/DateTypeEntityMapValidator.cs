...
{
  /// <summary>
  /// Used to validate business rules on the DateTypeEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class DateTypeEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateTypeEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateTypeEntityMapPDSA</param>
    public DateTypeEntityMapPDSAValidator(DateTypeEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateTypeEntityMapPDSAValidator";

      // Create Properties for each field in the DateTypeEntityMapPDSA entity class
      InitProperties();
    ...
    public DateTypeEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DateTypeEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateTypeEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateTypeEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
