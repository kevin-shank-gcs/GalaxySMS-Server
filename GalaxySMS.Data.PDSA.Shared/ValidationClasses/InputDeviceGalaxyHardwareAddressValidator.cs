...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceGalaxyHardwareAddressPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceGalaxyHardwareAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceGalaxyHardwareAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceGalaxyHardwareAddressPDSA</param>
    public InputDeviceGalaxyHardwareAddressPDSAValidator(InputDeviceGalaxyHardwareAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceGalaxyHardwareAddressPDSAValidator";

      // Create Properties for each field in the InputDeviceGalaxyHardwareAddressPDSA entity class
      InitProperties();
    ...
    public InputDeviceGalaxyHardwareAddressPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceGalaxyHardwareAddressPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceGalaxyHardwareAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceGalaxyHardwareAddressPDSAValidator.ColumnNames.DateColumnNameHere);
