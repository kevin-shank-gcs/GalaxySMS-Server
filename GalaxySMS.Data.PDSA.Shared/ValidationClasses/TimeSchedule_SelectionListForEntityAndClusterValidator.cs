...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeSchedule_SelectionListForEntityAndClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedule_SelectionListForEntityAndClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedule_SelectionListForEntityAndClusterPDSA</param>
    public TimeSchedule_SelectionListForEntityAndClusterPDSAValidator(TimeSchedule_SelectionListForEntityAndClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedule_SelectionListForEntityAndClusterPDSAValidator";

      // Create Properties for each field in the TimeSchedule_SelectionListForEntityAndClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedule_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedule_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.DateColumnNameHere);
