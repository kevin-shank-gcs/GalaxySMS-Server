...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalTypeAccessPortalCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalTypeAccessPortalCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalTypeAccessPortalCommandUniquePDSA</param>
    public IsAccessPortalTypeAccessPortalCommandUniquePDSAValidator(IsAccessPortalTypeAccessPortalCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalTypeAccessPortalCommandUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalTypeAccessPortalCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalTypeAccessPortalCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalTypeAccessPortalCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
