...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSA class.
  /// For views, this can be used if you do searching on the view and users will be entering values to search on
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSA</param>
    public GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSAValidator(GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSA object</returns>
    public GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDevice_InputSource_InputOutputGroupMode_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
