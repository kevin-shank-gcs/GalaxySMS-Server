...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertInputDeviceCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertInputDeviceCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertInputDeviceCountPDSA</param>
    public gcsEntityCountPDSA_InsertInputDeviceCountPDSAValidator(gcsEntityCountPDSA_InsertInputDeviceCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertInputDeviceCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertInputDeviceCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInputDeviceCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInputDeviceCountPDSAValidator.ColumnNames.DateColumnNameHere);
