...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaDayPeriodTimePeriodUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaDayPeriodTimePeriodUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaDayPeriodTimePeriodUniquePDSA</param>
    public IsAssaDayPeriodTimePeriodUniquePDSAValidator(IsAssaDayPeriodTimePeriodUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaDayPeriodTimePeriodUniquePDSAValidator";

      // Create Properties for each field in the IsAssaDayPeriodTimePeriodUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaDayPeriodTimePeriodUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaDayPeriodTimePeriodUniquePDSAValidator.ColumnNames.DateColumnNameHere);
