...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupAssignmentUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupAssignmentUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupAssignmentUniquePDSA</param>
    public IsInputOutputGroupAssignmentUniquePDSAValidator(IsInputOutputGroupAssignmentUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupAssignmentUniquePDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupAssignmentUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupAssignmentUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupAssignmentUniquePDSAValidator.ColumnNames.DateColumnNameHere);
