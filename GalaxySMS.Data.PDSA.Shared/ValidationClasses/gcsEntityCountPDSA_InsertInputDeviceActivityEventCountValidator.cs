...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSA</param>
    public gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSAValidator(gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInputDeviceActivityEventCountPDSAValidator.ColumnNames.DateColumnNameHere);
