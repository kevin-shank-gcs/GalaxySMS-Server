...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class CredentialPDSA_SelectBinaryDataByPKPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialPDSA_SelectBinaryDataByPKPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialPDSA_SelectBinaryDataByPKPDSA</param>
    public CredentialPDSA_SelectBinaryDataByPKPDSAValidator(CredentialPDSA_SelectBinaryDataByPKPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialPDSA_SelectBinaryDataByPKPDSAValidator";

      // Create Properties for each field in the CredentialPDSA_SelectBinaryDataByPKPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialPDSA_SelectBinaryDataByPKPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialPDSA_SelectBinaryDataByPKPDSAValidator.ColumnNames.DateColumnNameHere);
