...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalDeferToServerBehaviorPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalDeferToServerBehaviorPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalDeferToServerBehaviorPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalDeferToServerBehaviorPDSA</param>
    public AccessPortalDeferToServerBehaviorPDSAValidator(AccessPortalDeferToServerBehaviorPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalDeferToServerBehaviorPDSAValidator";

      // Create Properties for each field in the AccessPortalDeferToServerBehaviorPDSA entity class
      InitProperties();
    ...
    public AccessPortalDeferToServerBehaviorPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalDeferToServerBehaviorPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalDeferToServerBehaviorPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalDeferToServerBehaviorPDSAValidator.ColumnNames.DateColumnNameHere);
