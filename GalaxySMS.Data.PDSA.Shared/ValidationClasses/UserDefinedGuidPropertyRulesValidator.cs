...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedGuidPropertyRulesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedGuidPropertyRulesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedGuidPropertyRulesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedGuidPropertyRulesPDSA</param>
    public UserDefinedGuidPropertyRulesPDSAValidator(UserDefinedGuidPropertyRulesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedGuidPropertyRulesPDSAValidator";

      // Create Properties for each field in the UserDefinedGuidPropertyRulesPDSA entity class
      InitProperties();
    ...
    public UserDefinedGuidPropertyRulesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedGuidPropertyRulesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedGuidPropertyRulesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedGuidPropertyRulesPDSAValidator.ColumnNames.DateColumnNameHere);
