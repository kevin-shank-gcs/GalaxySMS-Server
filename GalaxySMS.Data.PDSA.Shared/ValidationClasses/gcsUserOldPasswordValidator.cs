...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserOldPasswordPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserOldPasswordPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserOldPasswordPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserOldPasswordPDSA</param>
    public gcsUserOldPasswordPDSAValidator(gcsUserOldPasswordPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserOldPasswordPDSAValidator";

      // Create Properties for each field in the gcsUserOldPasswordPDSA entity class
      InitProperties();
    ...
    public gcsUserOldPasswordPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserOldPasswordPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserOldPasswordPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserOldPasswordPDSAValidator.ColumnNames.DateColumnNameHere);
