...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailableClusterNumberWithOutputPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailableClusterNumberWithOutputPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailableClusterNumberWithOutputPDSA</param>
    public ChooseAvailableClusterNumberWithOutputPDSAValidator(ChooseAvailableClusterNumberWithOutputPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailableClusterNumberWithOutputPDSAValidator";

      // Create Properties for each field in the ChooseAvailableClusterNumberWithOutputPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailableClusterNumberWithOutputPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailableClusterNumberWithOutputPDSAValidator.ColumnNames.DateColumnNameHere);
