...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSA</param>
    public gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSAValidator(gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessPortalActivityEventCountPDSAValidator.ColumnNames.DateColumnNameHere);
