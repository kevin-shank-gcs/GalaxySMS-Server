...
{
  /// <summary>
  /// Used to validate business rules on the AutomaticForgivePassbackFrequencyPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AutomaticForgivePassbackFrequencyPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AutomaticForgivePassbackFrequencyPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AutomaticForgivePassbackFrequencyPDSA</param>
    public AutomaticForgivePassbackFrequencyPDSAValidator(AutomaticForgivePassbackFrequencyPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AutomaticForgivePassbackFrequencyPDSAValidator";

      // Create Properties for each field in the AutomaticForgivePassbackFrequencyPDSA entity class
      InitProperties();
    ...
    public AutomaticForgivePassbackFrequencyPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AutomaticForgivePassbackFrequencyPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AutomaticForgivePassbackFrequencyPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AutomaticForgivePassbackFrequencyPDSAValidator.ColumnNames.DateColumnNameHere);
