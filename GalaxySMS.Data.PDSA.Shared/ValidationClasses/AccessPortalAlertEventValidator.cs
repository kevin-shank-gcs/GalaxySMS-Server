...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAlertEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAlertEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAlertEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAlertEventPDSA</param>
    public AccessPortalAlertEventPDSAValidator(AccessPortalAlertEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAlertEventPDSAValidator";

      // Create Properties for each field in the AccessPortalAlertEventPDSA entity class
      InitProperties();
    ...
    public AccessPortalAlertEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAlertEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAlertEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAlertEventPDSAValidator.ColumnNames.DateColumnNameHere);
