...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSA</param>
    public CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSAValidator(CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSAValidator";

      // Create Properties for each field in the CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToLoadToCpu_SaveLastCredentialLoadedDatePDSAValidator.ColumnNames.DateColumnNameHere);
