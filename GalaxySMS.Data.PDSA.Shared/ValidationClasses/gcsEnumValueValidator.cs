...
{
  /// <summary>
  /// Used to validate business rules on the gcsEnumValuePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsEnumValuePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEnumValuePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEnumValuePDSA</param>
    public gcsEnumValuePDSAValidator(gcsEnumValuePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEnumValuePDSAValidator";

      // Create Properties for each field in the gcsEnumValuePDSA entity class
      InitProperties();
    ...
    public gcsEnumValuePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsEnumValuePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEnumValuePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEnumValuePDSAValidator.ColumnNames.DateColumnNameHere);
