...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_SelectionListForEntityAndSitePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_SelectionListForEntityAndSitePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_SelectionListForEntityAndSitePDSA</param>
    public Cluster_SelectionListForEntityAndSitePDSAValidator(Cluster_SelectionListForEntityAndSitePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_SelectionListForEntityAndSitePDSAValidator";

      // Create Properties for each field in the Cluster_SelectionListForEntityAndSitePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_SelectionListForEntityAndSitePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_SelectionListForEntityAndSitePDSAValidator.ColumnNames.DateColumnNameHere);
