...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedBooleanPropertyRulesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedBooleanPropertyRulesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedBooleanPropertyRulesUniquePDSA</param>
    public IsUserDefinedBooleanPropertyRulesUniquePDSAValidator(IsUserDefinedBooleanPropertyRulesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedBooleanPropertyRulesUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedBooleanPropertyRulesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedBooleanPropertyRulesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedBooleanPropertyRulesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
