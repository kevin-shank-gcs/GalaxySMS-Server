...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceAlertEventTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceAlertEventTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceAlertEventTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceAlertEventTypePDSA</param>
    public InputDeviceAlertEventTypePDSAValidator(InputDeviceAlertEventTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceAlertEventTypePDSAValidator";

      // Create Properties for each field in the InputDeviceAlertEventTypePDSA entity class
      InitProperties();
    ...
    public InputDeviceAlertEventTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceAlertEventTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceAlertEventTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceAlertEventTypePDSAValidator.ColumnNames.DateColumnNameHere);
