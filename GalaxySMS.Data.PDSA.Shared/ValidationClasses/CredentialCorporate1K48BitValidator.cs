...
{
  /// <summary>
  /// Used to validate business rules on the CredentialCorporate1K48BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialCorporate1K48BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialCorporate1K48BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialCorporate1K48BitPDSA</param>
    public CredentialCorporate1K48BitPDSAValidator(CredentialCorporate1K48BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialCorporate1K48BitPDSAValidator";

      // Create Properties for each field in the CredentialCorporate1K48BitPDSA entity class
      InitProperties();
    ...
    public CredentialCorporate1K48BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialCorporate1K48BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialCorporate1K48BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialCorporate1K48BitPDSAValidator.ColumnNames.DateColumnNameHere);
