...
{
  /// <summary>
  /// Used to validate business rules on the PersonAccessProfilePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonAccessProfilePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonAccessProfilePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonAccessProfilePDSA</param>
    public PersonAccessProfilePDSAValidator(PersonAccessProfilePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonAccessProfilePDSAValidator";

      // Create Properties for each field in the PersonAccessProfilePDSA entity class
      InitProperties();
    ...
    public PersonAccessProfilePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonAccessProfilePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonAccessProfilePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonAccessProfilePDSAValidator.ColumnNames.DateColumnNameHere);
