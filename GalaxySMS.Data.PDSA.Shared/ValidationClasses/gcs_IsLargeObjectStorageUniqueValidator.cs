...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsLargeObjectStorageUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsLargeObjectStorageUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsLargeObjectStorageUniquePDSA</param>
    public gcs_IsLargeObjectStorageUniquePDSAValidator(gcs_IsLargeObjectStorageUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsLargeObjectStorageUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsLargeObjectStorageUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsLargeObjectStorageUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsLargeObjectStorageUniquePDSAValidator.ColumnNames.DateColumnNameHere);
