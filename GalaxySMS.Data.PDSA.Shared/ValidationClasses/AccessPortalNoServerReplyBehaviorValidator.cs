...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalNoServerReplyBehaviorPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalNoServerReplyBehaviorPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalNoServerReplyBehaviorPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalNoServerReplyBehaviorPDSA</param>
    public AccessPortalNoServerReplyBehaviorPDSAValidator(AccessPortalNoServerReplyBehaviorPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalNoServerReplyBehaviorPDSAValidator";

      // Create Properties for each field in the AccessPortalNoServerReplyBehaviorPDSA entity class
      InitProperties();
    ...
    public AccessPortalNoServerReplyBehaviorPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalNoServerReplyBehaviorPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalNoServerReplyBehaviorPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalNoServerReplyBehaviorPDSAValidator.ColumnNames.DateColumnNameHere);
