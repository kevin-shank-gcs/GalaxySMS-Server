...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialCorporate1K48BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialCorporate1K48BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialCorporate1K48BitUniquePDSA</param>
    public IsCredentialCorporate1K48BitUniquePDSAValidator(IsCredentialCorporate1K48BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialCorporate1K48BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialCorporate1K48BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialCorporate1K48BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialCorporate1K48BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
