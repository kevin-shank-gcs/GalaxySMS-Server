...
{
  /// <summary>
  /// Used to validate business rules on the gcsApplicationAuditTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsApplicationAuditTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsApplicationAuditTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsApplicationAuditTypePDSA</param>
    public gcsApplicationAuditTypePDSAValidator(gcsApplicationAuditTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsApplicationAuditTypePDSAValidator";

      // Create Properties for each field in the gcsApplicationAuditTypePDSA entity class
      InitProperties();
    ...
    public gcsApplicationAuditTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsApplicationAuditTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsApplicationAuditTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsApplicationAuditTypePDSAValidator.ColumnNames.DateColumnNameHere);
