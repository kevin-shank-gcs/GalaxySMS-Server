...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialUniquePDSA</param>
    public IsCredentialUniquePDSAValidator(IsCredentialUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialUniquePDSAValidator.ColumnNames.DateColumnNameHere);
