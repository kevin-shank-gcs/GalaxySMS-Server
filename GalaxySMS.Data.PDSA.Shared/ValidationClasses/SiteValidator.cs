...
{
  /// <summary>
  /// Used to validate business rules on the SitePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class SitePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the SitePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a SitePDSA</param>
    public SitePDSAValidator(SitePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "SitePDSAValidator";

      // Create Properties for each field in the SitePDSA entity class
      InitProperties();
    ...
    public SitePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your SitePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(SitePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(SitePDSAValidator.ColumnNames.DateColumnNameHere);
