...
{
  /// <summary>
  /// Used to validate business rules on the PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSA</param>
    public PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSAValidator(PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSA object</returns>
    public PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroupDynamicAccessGroup_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
