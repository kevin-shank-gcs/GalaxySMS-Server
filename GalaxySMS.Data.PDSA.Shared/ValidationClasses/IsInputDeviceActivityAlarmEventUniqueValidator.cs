...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceActivityAlarmEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceActivityAlarmEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceActivityAlarmEventUniquePDSA</param>
    public IsInputDeviceActivityAlarmEventUniquePDSAValidator(IsInputDeviceActivityAlarmEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceActivityAlarmEventUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceActivityAlarmEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceActivityAlarmEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceActivityAlarmEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
