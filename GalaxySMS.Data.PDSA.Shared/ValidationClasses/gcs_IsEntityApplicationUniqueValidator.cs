...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsEntityApplicationUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsEntityApplicationUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsEntityApplicationUniquePDSA</param>
    public gcs_IsEntityApplicationUniquePDSAValidator(gcs_IsEntityApplicationUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsEntityApplicationUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsEntityApplicationUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsEntityApplicationUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsEntityApplicationUniquePDSAValidator.ColumnNames.DateColumnNameHere);
