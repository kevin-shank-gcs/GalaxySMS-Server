...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_GetCurrentTimePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_GetCurrentTimePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_GetCurrentTimePDSA</param>
    public Cluster_GetCurrentTimePDSAValidator(Cluster_GetCurrentTimePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_GetCurrentTimePDSAValidator";

      // Create Properties for each field in the Cluster_GetCurrentTimePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_GetCurrentTimePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_GetCurrentTimePDSAValidator.ColumnNames.DateColumnNameHere);
