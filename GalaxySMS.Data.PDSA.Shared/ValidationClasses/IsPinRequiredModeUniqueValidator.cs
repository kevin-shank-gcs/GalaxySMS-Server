...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPinRequiredModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPinRequiredModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPinRequiredModeUniquePDSA</param>
    public IsPinRequiredModeUniquePDSAValidator(IsPinRequiredModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPinRequiredModeUniquePDSAValidator";

      // Create Properties for each field in the IsPinRequiredModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPinRequiredModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPinRequiredModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
