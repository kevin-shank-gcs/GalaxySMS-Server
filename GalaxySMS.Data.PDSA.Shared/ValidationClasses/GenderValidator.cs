...
{
  /// <summary>
  /// Used to validate business rules on the GenderPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GenderPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GenderPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GenderPDSA</param>
    public GenderPDSAValidator(GenderPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GenderPDSAValidator";

      // Create Properties for each field in the GenderPDSA entity class
      InitProperties();
    ...
    public GenderPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GenderPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GenderPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GenderPDSAValidator.ColumnNames.DateColumnNameHere);
