...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalElevatorControlTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalElevatorControlTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalElevatorControlTypeUniquePDSA</param>
    public IsAccessPortalElevatorControlTypeUniquePDSAValidator(IsAccessPortalElevatorControlTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalElevatorControlTypeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalElevatorControlTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalElevatorControlTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalElevatorControlTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
