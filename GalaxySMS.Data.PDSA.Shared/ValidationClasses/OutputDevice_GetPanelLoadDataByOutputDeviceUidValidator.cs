...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSA</param>
    public OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSAValidator(OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByOutputDeviceUidPDSAValidator.ColumnNames.DateColumnNameHere);
