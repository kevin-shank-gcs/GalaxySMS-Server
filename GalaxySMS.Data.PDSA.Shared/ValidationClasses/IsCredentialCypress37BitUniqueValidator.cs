...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialCypress37BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialCypress37BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialCypress37BitUniquePDSA</param>
    public IsCredentialCypress37BitUniquePDSAValidator(IsCredentialCypress37BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialCypress37BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialCypress37BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialCypress37BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialCypress37BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
