...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInputArmingInputOutputGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInputArmingInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInputArmingInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInputArmingInputOutputGroupPDSA</param>
    public GalaxyInputArmingInputOutputGroupPDSAValidator(GalaxyInputArmingInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInputArmingInputOutputGroupPDSAValidator";

      // Create Properties for each field in the GalaxyInputArmingInputOutputGroupPDSA entity class
      InitProperties();
    ...
    public GalaxyInputArmingInputOutputGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInputArmingInputOutputGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInputArmingInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInputArmingInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
