...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSA</param>
    public InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSAValidator(InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSAValidator";

      // Create Properties for each field in the InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupAssignment_IsAssociatedWithInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
