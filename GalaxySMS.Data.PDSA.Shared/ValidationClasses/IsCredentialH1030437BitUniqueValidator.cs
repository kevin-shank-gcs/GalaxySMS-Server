...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialH1030437BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialH1030437BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialH1030437BitUniquePDSA</param>
    public IsCredentialH1030437BitUniquePDSAValidator(IsCredentialH1030437BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialH1030437BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialH1030437BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialH1030437BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialH1030437BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
