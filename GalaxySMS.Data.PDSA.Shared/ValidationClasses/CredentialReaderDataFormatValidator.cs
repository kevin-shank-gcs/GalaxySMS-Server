...
{
  /// <summary>
  /// Used to validate business rules on the CredentialReaderDataFormatPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialReaderDataFormatPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialReaderDataFormatPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialReaderDataFormatPDSA</param>
    public CredentialReaderDataFormatPDSAValidator(CredentialReaderDataFormatPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialReaderDataFormatPDSAValidator";

      // Create Properties for each field in the CredentialReaderDataFormatPDSA entity class
      InitProperties();
    ...
    public CredentialReaderDataFormatPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialReaderDataFormatPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialReaderDataFormatPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialReaderDataFormatPDSAValidator.ColumnNames.DateColumnNameHere);
