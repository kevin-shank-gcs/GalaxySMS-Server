...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalGalaxyHardwareAddressViewPDSA class.
  ...
  /// </summary>
  public partial class AccessPortalGalaxyHardwareAddressViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalGalaxyHardwareAddressViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalGalaxyHardwareAddressViewPDSA</param>
    public AccessPortalGalaxyHardwareAddressViewPDSAValidator(AccessPortalGalaxyHardwareAddressViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalGalaxyHardwareAddressViewPDSAValidator";

      // Create Properties for each field in the AccessPortalGalaxyHardwareAddressViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AccessPortalGalaxyHardwareAddressViewPDSA object</returns>
    public AccessPortalGalaxyHardwareAddressViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalGalaxyHardwareAddressViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalGalaxyHardwareAddressViewPDSAValidator.ColumnNames.DateColumnNameHere);
