...
{
  /// <summary>
  /// Used to validate business rules on the AddressPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AddressPDSA</param>
    public AddressPDSAValidator(AddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AddressPDSAValidator";

      // Create Properties for each field in the AddressPDSA entity class
      InitProperties();
    ...
    public AddressPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AddressPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AddressPDSAValidator.ColumnNames.DateColumnNameHere);
