...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonAccessGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonAccessGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonAccessGroupUniquePDSA</param>
    public IsPersonAccessGroupUniquePDSAValidator(IsPersonAccessGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonAccessGroupUniquePDSAValidator";

      // Create Properties for each field in the IsPersonAccessGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonAccessGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonAccessGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
