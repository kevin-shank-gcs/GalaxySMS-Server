...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_GetPanelLoadDataChangesByCpuUidPDSA</param>
    public Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator(Credential_GetPanelLoadDataChangesByCpuUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator";

      // Create Properties for each field in the Credential_GetPanelLoadDataChangesByCpuUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.DateColumnNameHere);
