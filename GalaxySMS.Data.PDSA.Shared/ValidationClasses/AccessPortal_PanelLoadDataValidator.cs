...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortal_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class AccessPortal_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_PanelLoadDataPDSA</param>
    public AccessPortal_PanelLoadDataPDSAValidator(AccessPortal_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the AccessPortal_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AccessPortal_PanelLoadDataPDSA object</returns>
    public AccessPortal_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortal_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
