...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsUserInRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsUserInRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsUserInRolePDSA</param>
    public gcs_IsUserInRolePDSAValidator(gcs_IsUserInRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsUserInRolePDSAValidator";

      // Create Properties for each field in the gcs_IsUserInRolePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsUserInRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsUserInRolePDSAValidator.ColumnNames.DateColumnNameHere);
