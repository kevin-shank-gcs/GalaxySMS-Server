...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataByInputDeviceUidPDSA</param>
    public InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator(InputDevice_GetPanelLoadDataByInputDeviceUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataByInputDeviceUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByInputDeviceUidPDSAValidator.ColumnNames.DateColumnNameHere);
