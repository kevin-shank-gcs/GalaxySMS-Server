...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsOutputDeviceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsOutputDeviceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsOutputDeviceUniquePDSA</param>
    public IsOutputDeviceUniquePDSAValidator(IsOutputDeviceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsOutputDeviceUniquePDSAValidator";

      // Create Properties for each field in the IsOutputDeviceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsOutputDeviceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsOutputDeviceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
