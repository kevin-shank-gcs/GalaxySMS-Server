...
{
  /// <summary>
  /// Used to validate business rules on the CountryPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CountryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CountryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CountryPDSA</param>
    public CountryPDSAValidator(CountryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CountryPDSAValidator";

      // Create Properties for each field in the CountryPDSA entity class
      InitProperties();
    ...
    public CountryPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CountryPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CountryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CountryPDSAValidator.ColumnNames.DateColumnNameHere);
