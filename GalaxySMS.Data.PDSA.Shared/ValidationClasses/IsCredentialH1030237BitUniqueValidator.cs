...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialH1030237BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialH1030237BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialH1030237BitUniquePDSA</param>
    public IsCredentialH1030237BitUniquePDSAValidator(IsCredentialH1030237BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialH1030237BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialH1030237BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialH1030237BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialH1030237BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
