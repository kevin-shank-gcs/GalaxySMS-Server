...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceUniquePDSA</param>
    public IsInputDeviceUniquePDSAValidator(IsInputDeviceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
