...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_GetRowCountFromTableByGuidColumnValuePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_GetRowCountFromTableByGuidColumnValuePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_GetRowCountFromTableByGuidColumnValuePDSA</param>
    public gcs_GetRowCountFromTableByGuidColumnValuePDSAValidator(gcs_GetRowCountFromTableByGuidColumnValuePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_GetRowCountFromTableByGuidColumnValuePDSAValidator";

      // Create Properties for each field in the gcs_GetRowCountFromTableByGuidColumnValuePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_GetRowCountFromTableByGuidColumnValuePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_GetRowCountFromTableByGuidColumnValuePDSAValidator.ColumnNames.DateColumnNameHere);
