...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserSettingPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserSettingPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserSettingPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserSettingPDSA</param>
    public gcsUserSettingPDSAValidator(gcsUserSettingPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserSettingPDSAValidator";

      // Create Properties for each field in the gcsUserSettingPDSA entity class
      InitProperties();
    ...
    public gcsUserSettingPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserSettingPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserSettingPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserSettingPDSAValidator.ColumnNames.DateColumnNameHere);
