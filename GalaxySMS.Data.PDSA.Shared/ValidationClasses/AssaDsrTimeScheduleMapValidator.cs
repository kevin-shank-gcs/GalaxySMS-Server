...
{
  /// <summary>
  /// Used to validate business rules on the AssaDsrTimeScheduleMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaDsrTimeScheduleMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaDsrTimeScheduleMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaDsrTimeScheduleMapPDSA</param>
    public AssaDsrTimeScheduleMapPDSAValidator(AssaDsrTimeScheduleMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaDsrTimeScheduleMapPDSAValidator";

      // Create Properties for each field in the AssaDsrTimeScheduleMapPDSA entity class
      InitProperties();
    ...
    public AssaDsrTimeScheduleMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaDsrTimeScheduleMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaDsrTimeScheduleMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaDsrTimeScheduleMapPDSAValidator.ColumnNames.DateColumnNameHere);
