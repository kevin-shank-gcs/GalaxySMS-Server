...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA</param>
    public OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ColumnNames.DateColumnNameHere);
