...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceAlarmEventAcknowledgmentUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceAlarmEventAcknowledgmentUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceAlarmEventAcknowledgmentUniquePDSA</param>
    public IsInputDeviceAlarmEventAcknowledgmentUniquePDSAValidator(IsInputDeviceAlarmEventAcknowledgmentUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceAlarmEventAcknowledgmentUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceAlarmEventAcknowledgmentUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceAlarmEventAcknowledgmentUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceAlarmEventAcknowledgmentUniquePDSAValidator.ColumnNames.DateColumnNameHere);
