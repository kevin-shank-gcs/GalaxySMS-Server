...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaDsrTimeScheduleMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaDsrTimeScheduleMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaDsrTimeScheduleMapUniquePDSA</param>
    public IsAssaDsrTimeScheduleMapUniquePDSAValidator(IsAssaDsrTimeScheduleMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaDsrTimeScheduleMapUniquePDSAValidator";

      // Create Properties for each field in the IsAssaDsrTimeScheduleMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaDsrTimeScheduleMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaDsrTimeScheduleMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
