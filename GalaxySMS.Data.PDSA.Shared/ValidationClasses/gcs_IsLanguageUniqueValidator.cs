...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsLanguageUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsLanguageUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsLanguageUniquePDSA</param>
    public gcs_IsLanguageUniquePDSAValidator(gcs_IsLanguageUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsLanguageUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsLanguageUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsLanguageUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsLanguageUniquePDSAValidator.ColumnNames.DateColumnNameHere);
