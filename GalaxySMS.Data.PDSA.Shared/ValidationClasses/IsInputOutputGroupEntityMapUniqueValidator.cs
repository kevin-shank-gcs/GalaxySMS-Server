...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputOutputGroupEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputOutputGroupEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputOutputGroupEntityMapUniquePDSA</param>
    public IsInputOutputGroupEntityMapUniquePDSAValidator(IsInputOutputGroupEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputOutputGroupEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsInputOutputGroupEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputOutputGroupEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputOutputGroupEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
