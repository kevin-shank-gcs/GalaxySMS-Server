...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInputModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInputModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInputModeUniquePDSA</param>
    public IsGalaxyInputModeUniquePDSAValidator(IsGalaxyInputModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInputModeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInputModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInputModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInputModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
