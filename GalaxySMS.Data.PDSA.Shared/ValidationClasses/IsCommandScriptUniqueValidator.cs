...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCommandScriptUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCommandScriptUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCommandScriptUniquePDSA</param>
    public IsCommandScriptUniquePDSAValidator(IsCommandScriptUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCommandScriptUniquePDSAValidator";

      // Create Properties for each field in the IsCommandScriptUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCommandScriptUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCommandScriptUniquePDSAValidator.ColumnNames.DateColumnNameHere);
