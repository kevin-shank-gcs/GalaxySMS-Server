...
{
  /// <summary>
  /// Used to validate business rules on the NotePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class NotePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the NotePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a NotePDSA</param>
    public NotePDSAValidator(NotePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "NotePDSAValidator";

      // Create Properties for each field in the NotePDSA entity class
      InitProperties();
    ...
    public NotePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your NotePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(NotePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(NotePDSAValidator.ColumnNames.DateColumnNameHere);
