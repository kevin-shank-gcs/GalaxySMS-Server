...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalPropertiesUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalPropertiesUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalPropertiesUniquePDSA</param>
    public IsAccessPortalPropertiesUniquePDSAValidator(IsAccessPortalPropertiesUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalPropertiesUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalPropertiesUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalPropertiesUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalPropertiesUniquePDSAValidator.ColumnNames.DateColumnNameHere);
