...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalEntityMapPDSA</param>
    public AccessPortalEntityMapPDSAValidator(AccessPortalEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalEntityMapPDSAValidator";

      // Create Properties for each field in the AccessPortalEntityMapPDSA entity class
      InitProperties();
    ...
    public AccessPortalEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
