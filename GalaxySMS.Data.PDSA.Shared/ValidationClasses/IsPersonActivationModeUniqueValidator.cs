...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonActivationModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonActivationModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonActivationModeUniquePDSA</param>
    public IsPersonActivationModeUniquePDSAValidator(IsPersonActivationModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonActivationModeUniquePDSAValidator";

      // Create Properties for each field in the IsPersonActivationModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonActivationModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonActivationModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
