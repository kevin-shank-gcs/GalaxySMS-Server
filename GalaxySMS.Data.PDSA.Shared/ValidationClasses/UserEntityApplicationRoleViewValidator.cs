...
{
  /// <summary>
  /// Used to validate business rules on the UserEntityApplicationRoleViewPDSA class.
  ...
  /// </summary>
  public partial class UserEntityApplicationRoleViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserEntityApplicationRoleViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserEntityApplicationRoleViewPDSA</param>
    public UserEntityApplicationRoleViewPDSAValidator(UserEntityApplicationRoleViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserEntityApplicationRoleViewPDSAValidator";

      // Create Properties for each field in the UserEntityApplicationRoleViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A UserEntityApplicationRoleViewPDSA object</returns>
    public UserEntityApplicationRoleViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserEntityApplicationRoleViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserEntityApplicationRoleViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserEntityApplicationRoleViewPDSAValidator.ColumnNames.DateColumnNameHere);
