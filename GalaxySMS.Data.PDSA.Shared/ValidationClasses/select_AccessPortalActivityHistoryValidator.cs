...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class select_AccessPortalActivityHistoryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the select_AccessPortalActivityHistoryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a select_AccessPortalActivityHistoryPDSA</param>
    public select_AccessPortalActivityHistoryPDSAValidator(select_AccessPortalActivityHistoryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "select_AccessPortalActivityHistoryPDSAValidator";

      // Create Properties for each field in the select_AccessPortalActivityHistoryPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(select_AccessPortalActivityHistoryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(select_AccessPortalActivityHistoryPDSAValidator.ColumnNames.DateColumnNameHere);
