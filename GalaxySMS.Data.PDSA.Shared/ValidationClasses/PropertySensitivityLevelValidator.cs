...
{
  /// <summary>
  /// Used to validate business rules on the PropertySensitivityLevelPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PropertySensitivityLevelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PropertySensitivityLevelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PropertySensitivityLevelPDSA</param>
    public PropertySensitivityLevelPDSAValidator(PropertySensitivityLevelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PropertySensitivityLevelPDSAValidator";

      // Create Properties for each field in the PropertySensitivityLevelPDSA entity class
      InitProperties();
    ...
    public PropertySensitivityLevelPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PropertySensitivityLevelPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PropertySensitivityLevelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PropertySensitivityLevelPDSAValidator.ColumnNames.DateColumnNameHere);
