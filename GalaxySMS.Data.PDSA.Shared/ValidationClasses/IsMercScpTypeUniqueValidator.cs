...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsMercScpTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsMercScpTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsMercScpTypeUniquePDSA</param>
    public IsMercScpTypeUniquePDSAValidator(IsMercScpTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsMercScpTypeUniquePDSAValidator";

      // Create Properties for each field in the IsMercScpTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsMercScpTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsMercScpTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
