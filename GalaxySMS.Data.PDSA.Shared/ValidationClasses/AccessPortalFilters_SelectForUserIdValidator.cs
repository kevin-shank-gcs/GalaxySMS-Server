...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortalFilters_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalFilters_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalFilters_SelectForUserIdPDSA</param>
    public AccessPortalFilters_SelectForUserIdPDSAValidator(AccessPortalFilters_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalFilters_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the AccessPortalFilters_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalFilters_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalFilters_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
