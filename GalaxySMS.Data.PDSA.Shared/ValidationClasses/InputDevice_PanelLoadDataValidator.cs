...
{
  /// <summary>
  /// Used to validate business rules on the InputDevice_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class InputDevice_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_PanelLoadDataPDSA</param>
    public InputDevice_PanelLoadDataPDSAValidator(InputDevice_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the InputDevice_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A InputDevice_PanelLoadDataPDSA object</returns>
    public InputDevice_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDevice_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
