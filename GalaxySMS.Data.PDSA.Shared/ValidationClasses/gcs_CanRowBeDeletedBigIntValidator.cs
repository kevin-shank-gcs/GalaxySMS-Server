...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_CanRowBeDeletedBigIntPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_CanRowBeDeletedBigIntPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_CanRowBeDeletedBigIntPDSA</param>
    public gcs_CanRowBeDeletedBigIntPDSAValidator(gcs_CanRowBeDeletedBigIntPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_CanRowBeDeletedBigIntPDSAValidator";

      // Create Properties for each field in the gcs_CanRowBeDeletedBigIntPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_CanRowBeDeletedBigIntPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_CanRowBeDeletedBigIntPDSAValidator.ColumnNames.DateColumnNameHere);
