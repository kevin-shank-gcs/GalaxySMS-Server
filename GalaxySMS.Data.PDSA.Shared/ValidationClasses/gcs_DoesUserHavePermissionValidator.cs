...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_DoesUserHavePermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_DoesUserHavePermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_DoesUserHavePermissionPDSA</param>
    public gcs_DoesUserHavePermissionPDSAValidator(gcs_DoesUserHavePermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_DoesUserHavePermissionPDSAValidator";

      // Create Properties for each field in the gcs_DoesUserHavePermissionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_DoesUserHavePermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_DoesUserHavePermissionPDSAValidator.ColumnNames.DateColumnNameHere);
