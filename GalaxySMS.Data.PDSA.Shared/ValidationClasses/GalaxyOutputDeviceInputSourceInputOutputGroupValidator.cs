...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputDeviceInputSourceInputOutputGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputDeviceInputSourceInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDeviceInputSourceInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDeviceInputSourceInputOutputGroupPDSA</param>
    public GalaxyOutputDeviceInputSourceInputOutputGroupPDSAValidator(GalaxyOutputDeviceInputSourceInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDeviceInputSourceInputOutputGroupPDSAValidator";

      // Create Properties for each field in the GalaxyOutputDeviceInputSourceInputOutputGroupPDSA entity class
      InitProperties();
    ...
    public GalaxyOutputDeviceInputSourceInputOutputGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputDeviceInputSourceInputOutputGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDeviceInputSourceInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDeviceInputSourceInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
