...
{
  /// <summary>
  /// Used to validate business rules on the PersonPhoneNumberPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonPhoneNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPhoneNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPhoneNumberPDSA</param>
    public PersonPhoneNumberPDSAValidator(PersonPhoneNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPhoneNumberPDSAValidator";

      // Create Properties for each field in the PersonPhoneNumberPDSA entity class
      InitProperties();
    ...
    public PersonPhoneNumberPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonPhoneNumberPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPhoneNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPhoneNumberPDSAValidator.ColumnNames.DateColumnNameHere);
