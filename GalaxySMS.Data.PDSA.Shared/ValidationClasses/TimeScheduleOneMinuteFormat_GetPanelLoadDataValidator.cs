...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSA</param>
    public TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSAValidator(TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSAValidator";

      // Create Properties for each field in the TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeScheduleOneMinuteFormat_GetPanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
