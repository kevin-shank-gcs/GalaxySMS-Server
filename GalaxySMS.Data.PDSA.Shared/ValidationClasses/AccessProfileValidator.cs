...
{
  /// <summary>
  /// Used to validate business rules on the AccessProfilePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessProfilePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessProfilePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessProfilePDSA</param>
    public AccessProfilePDSAValidator(AccessProfilePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessProfilePDSAValidator";

      // Create Properties for each field in the AccessProfilePDSA entity class
      InitProperties();
    ...
    public AccessProfilePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessProfilePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessProfilePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessProfilePDSAValidator.ColumnNames.DateColumnNameHere);
