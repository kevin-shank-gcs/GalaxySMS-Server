...
{
  /// <summary>
  /// Used to validate business rules on the PersonBooleanPropertyPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonBooleanPropertyPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonBooleanPropertyPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonBooleanPropertyPDSA</param>
    public PersonBooleanPropertyPDSAValidator(PersonBooleanPropertyPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonBooleanPropertyPDSAValidator";

      // Create Properties for each field in the PersonBooleanPropertyPDSA entity class
      InitProperties();
    ...
    public PersonBooleanPropertyPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonBooleanPropertyPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonBooleanPropertyPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonBooleanPropertyPDSAValidator.ColumnNames.DateColumnNameHere);
