...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailableClusterNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailableClusterNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailableClusterNumberPDSA</param>
    public ChooseAvailableClusterNumberPDSAValidator(ChooseAvailableClusterNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailableClusterNumberPDSAValidator";

      // Create Properties for each field in the ChooseAvailableClusterNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailableClusterNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailableClusterNumberPDSAValidator.ColumnNames.DateColumnNameHere);
