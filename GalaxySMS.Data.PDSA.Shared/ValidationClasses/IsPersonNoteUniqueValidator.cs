...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonNoteUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonNoteUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonNoteUniquePDSA</param>
    public IsPersonNoteUniquePDSAValidator(IsPersonNoteUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonNoteUniquePDSAValidator";

      // Create Properties for each field in the IsPersonNoteUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonNoteUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonNoteUniquePDSAValidator.ColumnNames.DateColumnNameHere);
