...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSA</param>
    public CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSAValidator(CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSAValidator";

      // Create Properties for each field in the CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToDeleteFromCpu_SaveDeletedFromCpuDatePDSAValidator.ColumnNames.DateColumnNameHere);
