...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAlertEventTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAlertEventTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAlertEventTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAlertEventTypePDSA</param>
    public AccessPortalAlertEventTypePDSAValidator(AccessPortalAlertEventTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAlertEventTypePDSAValidator";

      // Create Properties for each field in the AccessPortalAlertEventTypePDSA entity class
      InitProperties();
    ...
    public AccessPortalAlertEventTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAlertEventTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAlertEventTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAlertEventTypePDSAValidator.ColumnNames.DateColumnNameHere);
