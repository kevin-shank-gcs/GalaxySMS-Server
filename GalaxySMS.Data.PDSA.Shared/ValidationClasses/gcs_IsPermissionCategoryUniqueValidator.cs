...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsPermissionCategoryUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsPermissionCategoryUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsPermissionCategoryUniquePDSA</param>
    public gcs_IsPermissionCategoryUniquePDSAValidator(gcs_IsPermissionCategoryUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsPermissionCategoryUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsPermissionCategoryUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsPermissionCategoryUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsPermissionCategoryUniquePDSAValidator.ColumnNames.DateColumnNameHere);
