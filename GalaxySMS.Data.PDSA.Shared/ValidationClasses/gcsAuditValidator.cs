...
{
  /// <summary>
  /// Used to validate business rules on the gcsAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsAuditPDSA</param>
    public gcsAuditPDSAValidator(gcsAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsAuditPDSAValidator";

      // Create Properties for each field in the gcsAuditPDSA entity class
      InitProperties();
    ...
    public gcsAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsAuditPDSAValidator.ColumnNames.DateColumnNameHere);
