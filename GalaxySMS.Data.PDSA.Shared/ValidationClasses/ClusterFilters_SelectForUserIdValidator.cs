...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterFilters_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterFilters_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterFilters_SelectForUserIdPDSA</param>
    public ClusterFilters_SelectForUserIdPDSAValidator(ClusterFilters_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterFilters_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the ClusterFilters_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterFilters_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterFilters_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
