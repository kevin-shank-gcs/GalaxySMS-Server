...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalLoadToCpu_SaveLastLoadedDatePDSA</param>
    public AccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator(AccessPortalLoadToCpu_SaveLastLoadedDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator";

      // Create Properties for each field in the AccessPortalLoadToCpu_SaveLastLoadedDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.DateColumnNameHere);
