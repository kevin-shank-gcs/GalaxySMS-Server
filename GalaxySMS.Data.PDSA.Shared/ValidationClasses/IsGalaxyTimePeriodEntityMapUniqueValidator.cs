...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyTimePeriodEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyTimePeriodEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyTimePeriodEntityMapUniquePDSA</param>
    public IsGalaxyTimePeriodEntityMapUniquePDSAValidator(IsGalaxyTimePeriodEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyTimePeriodEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyTimePeriodEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyTimePeriodEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyTimePeriodEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
