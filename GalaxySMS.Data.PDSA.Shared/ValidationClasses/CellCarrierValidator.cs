...
{
  /// <summary>
  /// Used to validate business rules on the CellCarrierPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CellCarrierPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CellCarrierPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CellCarrierPDSA</param>
    public CellCarrierPDSAValidator(CellCarrierPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CellCarrierPDSAValidator";

      // Create Properties for each field in the CellCarrierPDSA entity class
      InitProperties();
    ...
    public CellCarrierPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CellCarrierPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CellCarrierPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CellCarrierPDSAValidator.ColumnNames.DateColumnNameHere);
