...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputInputSourceModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputInputSourceModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputInputSourceModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputInputSourceModePDSA</param>
    public GalaxyOutputInputSourceModePDSAValidator(GalaxyOutputInputSourceModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputInputSourceModePDSAValidator";

      // Create Properties for each field in the GalaxyOutputInputSourceModePDSA entity class
      InitProperties();
    ...
    public GalaxyOutputInputSourceModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputInputSourceModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputInputSourceModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputInputSourceModePDSAValidator.ColumnNames.DateColumnNameHere);
