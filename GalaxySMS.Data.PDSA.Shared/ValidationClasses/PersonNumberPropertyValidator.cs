...
{
  /// <summary>
  /// Used to validate business rules on the PersonNumberPropertyPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonNumberPropertyPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonNumberPropertyPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonNumberPropertyPDSA</param>
    public PersonNumberPropertyPDSAValidator(PersonNumberPropertyPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonNumberPropertyPDSAValidator";

      // Create Properties for each field in the PersonNumberPropertyPDSA entity class
      InitProperties();
    ...
    public PersonNumberPropertyPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonNumberPropertyPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonNumberPropertyPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonNumberPropertyPDSAValidator.ColumnNames.DateColumnNameHere);
