...
{
  /// <summary>
  /// Used to validate business rules on the PersonNotePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonNotePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonNotePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonNotePDSA</param>
    public PersonNotePDSAValidator(PersonNotePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonNotePDSAValidator";

      // Create Properties for each field in the PersonNotePDSA entity class
      InitProperties();
    ...
    public PersonNotePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonNotePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonNotePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonNotePDSAValidator.ColumnNames.DateColumnNameHere);
