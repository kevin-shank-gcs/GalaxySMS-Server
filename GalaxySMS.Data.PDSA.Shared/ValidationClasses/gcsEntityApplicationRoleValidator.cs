...
{
  /// <summary>
  /// Used to validate business rules on the gcsEntityApplicationRolePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsEntityApplicationRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityApplicationRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityApplicationRolePDSA</param>
    public gcsEntityApplicationRolePDSAValidator(gcsEntityApplicationRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityApplicationRolePDSAValidator";

      // Create Properties for each field in the gcsEntityApplicationRolePDSA entity class
      InitProperties();
    ...
    public gcsEntityApplicationRolePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsEntityApplicationRolePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityApplicationRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityApplicationRolePDSAValidator.ColumnNames.DateColumnNameHere);
