...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterCommandUniquePDSA</param>
    public IsClusterCommandUniquePDSAValidator(IsClusterCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterCommandUniquePDSAValidator";

      // Create Properties for each field in the IsClusterCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
