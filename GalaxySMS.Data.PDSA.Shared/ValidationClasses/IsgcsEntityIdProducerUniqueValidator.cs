...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsgcsEntityIdProducerUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsgcsEntityIdProducerUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsgcsEntityIdProducerUniquePDSA</param>
    public IsgcsEntityIdProducerUniquePDSAValidator(IsgcsEntityIdProducerUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsgcsEntityIdProducerUniquePDSAValidator";

      // Create Properties for each field in the IsgcsEntityIdProducerUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsgcsEntityIdProducerUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsgcsEntityIdProducerUniquePDSAValidator.ColumnNames.DateColumnNameHere);
