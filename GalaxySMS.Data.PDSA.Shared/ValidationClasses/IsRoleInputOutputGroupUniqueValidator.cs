...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleInputOutputGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleInputOutputGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleInputOutputGroupUniquePDSA</param>
    public IsRoleInputOutputGroupUniquePDSAValidator(IsRoleInputOutputGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleInputOutputGroupUniquePDSAValidator";

      // Create Properties for each field in the IsRoleInputOutputGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleInputOutputGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleInputOutputGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
