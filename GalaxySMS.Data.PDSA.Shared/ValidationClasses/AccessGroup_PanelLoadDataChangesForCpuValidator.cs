...
{
  /// <summary>
  /// Used to validate business rules on the AccessGroup_PanelLoadDataChangesForCpuPDSA class.
  ...
  /// </summary>
  public partial class AccessGroup_PanelLoadDataChangesForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroup_PanelLoadDataChangesForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroup_PanelLoadDataChangesForCpuPDSA</param>
    public AccessGroup_PanelLoadDataChangesForCpuPDSAValidator(AccessGroup_PanelLoadDataChangesForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroup_PanelLoadDataChangesForCpuPDSAValidator";

      // Create Properties for each field in the AccessGroup_PanelLoadDataChangesForCpuPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AccessGroup_PanelLoadDataChangesForCpuPDSA object</returns>
    public AccessGroup_PanelLoadDataChangesForCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessGroup_PanelLoadDataChangesForCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
