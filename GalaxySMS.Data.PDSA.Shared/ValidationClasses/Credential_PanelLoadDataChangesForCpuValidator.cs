...
{
  /// <summary>
  /// Used to validate business rules on the Credential_PanelLoadDataChangesForCpuPDSA class.
  ...
  /// </summary>
  public partial class Credential_PanelLoadDataChangesForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_PanelLoadDataChangesForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_PanelLoadDataChangesForCpuPDSA</param>
    public Credential_PanelLoadDataChangesForCpuPDSAValidator(Credential_PanelLoadDataChangesForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_PanelLoadDataChangesForCpuPDSAValidator";

      // Create Properties for each field in the Credential_PanelLoadDataChangesForCpuPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A Credential_PanelLoadDataChangesForCpuPDSA object</returns>
    public Credential_PanelLoadDataChangesForCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your Credential_PanelLoadDataChangesForCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
