...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_SelectEntitiesByUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_SelectEntitiesByUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_SelectEntitiesByUserIdPDSA</param>
    public gcs_SelectEntitiesByUserIdPDSAValidator(gcs_SelectEntitiesByUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_SelectEntitiesByUserIdPDSAValidator";

      // Create Properties for each field in the gcs_SelectEntitiesByUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_SelectEntitiesByUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
