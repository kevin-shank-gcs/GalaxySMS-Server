...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessProfileClusterUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessProfileClusterUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessProfileClusterUniquePDSA</param>
    public IsAccessProfileClusterUniquePDSAValidator(IsAccessProfileClusterUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessProfileClusterUniquePDSAValidator";

      // Create Properties for each field in the IsAccessProfileClusterUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessProfileClusterUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessProfileClusterUniquePDSAValidator.ColumnNames.DateColumnNameHere);
