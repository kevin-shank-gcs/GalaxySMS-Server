...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA</param>
    public OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ColumnNames.DateColumnNameHere);
