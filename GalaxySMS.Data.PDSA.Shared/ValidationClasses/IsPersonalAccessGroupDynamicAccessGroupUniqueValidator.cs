...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonalAccessGroupDynamicAccessGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonalAccessGroupDynamicAccessGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonalAccessGroupDynamicAccessGroupUniquePDSA</param>
    public IsPersonalAccessGroupDynamicAccessGroupUniquePDSAValidator(IsPersonalAccessGroupDynamicAccessGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonalAccessGroupDynamicAccessGroupUniquePDSAValidator";

      // Create Properties for each field in the IsPersonalAccessGroupDynamicAccessGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonalAccessGroupDynamicAccessGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonalAccessGroupDynamicAccessGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
