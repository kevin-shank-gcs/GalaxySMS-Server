...
{
  /// <summary>
  /// Used to validate business rules on the gcsLargeObjectStoragePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsLargeObjectStoragePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsLargeObjectStoragePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsLargeObjectStoragePDSA</param>
    public gcsLargeObjectStoragePDSAValidator(gcsLargeObjectStoragePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsLargeObjectStoragePDSAValidator";

      // Create Properties for each field in the gcsLargeObjectStoragePDSA entity class
      InitProperties();
    ...
    public gcsLargeObjectStoragePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsLargeObjectStoragePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsLargeObjectStoragePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsLargeObjectStoragePDSAValidator.ColumnNames.DateColumnNameHere);
