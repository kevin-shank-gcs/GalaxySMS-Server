...
{
  /// <summary>
  /// Used to validate business rules on the gcsLanguagePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsLanguagePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsLanguagePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsLanguagePDSA</param>
    public gcsLanguagePDSAValidator(gcsLanguagePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsLanguagePDSAValidator";

      // Create Properties for each field in the gcsLanguagePDSA entity class
      InitProperties();
    ...
    public gcsLanguagePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsLanguagePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsLanguagePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsLanguagePDSAValidator.ColumnNames.DateColumnNameHere);
