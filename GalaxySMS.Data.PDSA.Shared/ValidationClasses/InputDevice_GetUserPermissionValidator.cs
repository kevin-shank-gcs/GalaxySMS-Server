...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetUserPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetUserPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetUserPermissionPDSA</param>
    public InputDevice_GetUserPermissionPDSAValidator(InputDevice_GetUserPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetUserPermissionPDSAValidator";

      // Create Properties for each field in the InputDevice_GetUserPermissionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetUserPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetUserPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
