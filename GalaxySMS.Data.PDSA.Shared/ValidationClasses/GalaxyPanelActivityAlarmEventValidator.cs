...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelActivityAlarmEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelActivityAlarmEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelActivityAlarmEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelActivityAlarmEventPDSA</param>
    public GalaxyPanelActivityAlarmEventPDSAValidator(GalaxyPanelActivityAlarmEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelActivityAlarmEventPDSAValidator";

      // Create Properties for each field in the GalaxyPanelActivityAlarmEventPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelActivityAlarmEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelActivityAlarmEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelActivityAlarmEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelActivityAlarmEventPDSAValidator.ColumnNames.DateColumnNameHere);
