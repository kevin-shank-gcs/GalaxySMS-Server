...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Cluster_GetPanelCommonLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Cluster_GetPanelCommonLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Cluster_GetPanelCommonLoadDataPDSA</param>
    public Cluster_GetPanelCommonLoadDataPDSAValidator(Cluster_GetPanelCommonLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Cluster_GetPanelCommonLoadDataPDSAValidator";

      // Create Properties for each field in the Cluster_GetPanelCommonLoadDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Cluster_GetPanelCommonLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
