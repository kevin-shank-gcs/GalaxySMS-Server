...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSA</param>
    public GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSAValidator(GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSA object</returns>
    public GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDevice_InputSource_Assignments_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
