...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalPDSA</param>
    public AccessPortalPDSAValidator(AccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalPDSAValidator";

      // Create Properties for each field in the AccessPortalPDSA entity class
      InitProperties();
    ...
    public AccessPortalPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
