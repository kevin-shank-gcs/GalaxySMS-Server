...
{
  /// <summary>
  /// Used to validate business rules on the InputOutputGroupEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputOutputGroupEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupEntityMapPDSA</param>
    public InputOutputGroupEntityMapPDSAValidator(InputOutputGroupEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupEntityMapPDSAValidator";

      // Create Properties for each field in the InputOutputGroupEntityMapPDSA entity class
      InitProperties();
    ...
    public InputOutputGroupEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputOutputGroupEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
