...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class insert_AccessPortalActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the insert_AccessPortalActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a insert_AccessPortalActivityEventPDSA</param>
    public insert_AccessPortalActivityEventPDSAValidator(insert_AccessPortalActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "insert_AccessPortalActivityEventPDSAValidator";

      // Create Properties for each field in the insert_AccessPortalActivityEventPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(insert_AccessPortalActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(insert_AccessPortalActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
