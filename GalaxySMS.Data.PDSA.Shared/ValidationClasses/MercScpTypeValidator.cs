...
{
  /// <summary>
  /// Used to validate business rules on the MercScpTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class MercScpTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpTypePDSA</param>
    public MercScpTypePDSAValidator(MercScpTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpTypePDSAValidator";

      // Create Properties for each field in the MercScpTypePDSA entity class
      InitProperties();
    ...
    public MercScpTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your MercScpTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpTypePDSAValidator.ColumnNames.DateColumnNameHere);
