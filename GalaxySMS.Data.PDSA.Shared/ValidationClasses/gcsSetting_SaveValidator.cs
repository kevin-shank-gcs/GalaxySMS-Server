...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsSetting_SavePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsSetting_SavePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsSetting_SavePDSA</param>
    public gcsSetting_SavePDSAValidator(gcsSetting_SavePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsSetting_SavePDSAValidator";

      // Create Properties for each field in the gcsSetting_SavePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsSetting_SavePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsSetting_SavePDSAValidator.ColumnNames.DateColumnNameHere);
