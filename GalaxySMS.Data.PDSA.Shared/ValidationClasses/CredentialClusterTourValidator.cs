...
{
  /// <summary>
  /// Used to validate business rules on the CredentialClusterTourPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialClusterTourPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialClusterTourPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialClusterTourPDSA</param>
    public CredentialClusterTourPDSAValidator(CredentialClusterTourPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialClusterTourPDSAValidator";

      // Create Properties for each field in the CredentialClusterTourPDSA entity class
      InitProperties();
    ...
    public CredentialClusterTourPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialClusterTourPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialClusterTourPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialClusterTourPDSAValidator.ColumnNames.DateColumnNameHere);
