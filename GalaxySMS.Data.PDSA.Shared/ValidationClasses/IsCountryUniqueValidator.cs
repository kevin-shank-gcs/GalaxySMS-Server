...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCountryUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCountryUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCountryUniquePDSA</param>
    public IsCountryUniquePDSAValidator(IsCountryUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCountryUniquePDSAValidator";

      // Create Properties for each field in the IsCountryUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCountryUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCountryUniquePDSAValidator.ColumnNames.DateColumnNameHere);
