...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInterfaceBoardSectionModeCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInterfaceBoardSectionModeCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInterfaceBoardSectionModeCommandUniquePDSA</param>
    public IsGalaxyInterfaceBoardSectionModeCommandUniquePDSAValidator(IsGalaxyInterfaceBoardSectionModeCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInterfaceBoardSectionModeCommandUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInterfaceBoardSectionModeCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionModeCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionModeCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
