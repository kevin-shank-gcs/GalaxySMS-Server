...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_ForeignKeyReferencedCountBigIntPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_ForeignKeyReferencedCountBigIntPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_ForeignKeyReferencedCountBigIntPDSA</param>
    public gcs_ForeignKeyReferencedCountBigIntPDSAValidator(gcs_ForeignKeyReferencedCountBigIntPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_ForeignKeyReferencedCountBigIntPDSAValidator";

      // Create Properties for each field in the gcs_ForeignKeyReferencedCountBigIntPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_ForeignKeyReferencedCountBigIntPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_ForeignKeyReferencedCountBigIntPDSAValidator.ColumnNames.DateColumnNameHere);
