...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsRolePermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsRolePermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsRolePermissionUniquePDSA</param>
    public gcs_IsRolePermissionUniquePDSAValidator(gcs_IsRolePermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsRolePermissionUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsRolePermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsRolePermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsRolePermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
