...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalCommandUniquePDSA</param>
    public IsAccessPortalCommandUniquePDSAValidator(IsAccessPortalCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalCommandUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
