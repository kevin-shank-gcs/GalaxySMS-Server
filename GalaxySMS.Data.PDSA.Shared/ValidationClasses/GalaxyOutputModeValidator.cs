...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputModePDSA</param>
    public GalaxyOutputModePDSAValidator(GalaxyOutputModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputModePDSAValidator";

      // Create Properties for each field in the GalaxyOutputModePDSA entity class
      InitProperties();
    ...
    public GalaxyOutputModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputModePDSAValidator.ColumnNames.DateColumnNameHere);
