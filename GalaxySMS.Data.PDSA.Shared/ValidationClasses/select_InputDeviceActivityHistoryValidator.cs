...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class select_InputDeviceActivityHistoryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the select_InputDeviceActivityHistoryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a select_InputDeviceActivityHistoryPDSA</param>
    public select_InputDeviceActivityHistoryPDSAValidator(select_InputDeviceActivityHistoryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "select_InputDeviceActivityHistoryPDSAValidator";

      // Create Properties for each field in the select_InputDeviceActivityHistoryPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(select_InputDeviceActivityHistoryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(select_InputDeviceActivityHistoryPDSAValidator.ColumnNames.DateColumnNameHere);
