...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleAccessPortalPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleAccessPortalPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleAccessPortalPermissionUniquePDSA</param>
    public IsRoleAccessPortalPermissionUniquePDSAValidator(IsRoleAccessPortalPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleAccessPortalPermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleAccessPortalPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleAccessPortalPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleAccessPortalPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
