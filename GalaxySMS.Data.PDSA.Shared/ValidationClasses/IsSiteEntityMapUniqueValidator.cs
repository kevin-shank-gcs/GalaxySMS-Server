...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsSiteEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsSiteEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsSiteEntityMapUniquePDSA</param>
    public IsSiteEntityMapUniquePDSAValidator(IsSiteEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsSiteEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsSiteEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsSiteEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsSiteEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
