...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA</param>
    public OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.DateColumnNameHere);
