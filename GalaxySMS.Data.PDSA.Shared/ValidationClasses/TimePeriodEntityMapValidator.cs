...
{
  /// <summary>
  /// Used to validate business rules on the TimePeriodEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class TimePeriodEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimePeriodEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimePeriodEntityMapPDSA</param>
    public TimePeriodEntityMapPDSAValidator(TimePeriodEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimePeriodEntityMapPDSAValidator";

      // Create Properties for each field in the TimePeriodEntityMapPDSA entity class
      InitProperties();
    ...
    public TimePeriodEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TimePeriodEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimePeriodEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimePeriodEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
