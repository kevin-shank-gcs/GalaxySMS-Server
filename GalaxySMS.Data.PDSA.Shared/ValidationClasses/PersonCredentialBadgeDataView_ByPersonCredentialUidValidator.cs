...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonCredentialBadgeDataView_ByPersonCredentialUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonCredentialBadgeDataView_ByPersonCredentialUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonCredentialBadgeDataView_ByPersonCredentialUidPDSA</param>
    public PersonCredentialBadgeDataView_ByPersonCredentialUidPDSAValidator(PersonCredentialBadgeDataView_ByPersonCredentialUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonCredentialBadgeDataView_ByPersonCredentialUidPDSAValidator";

      // Create Properties for each field in the PersonCredentialBadgeDataView_ByPersonCredentialUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonCredentialBadgeDataView_ByPersonCredentialUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonCredentialBadgeDataView_ByPersonCredentialUidPDSAValidator.ColumnNames.DateColumnNameHere);
