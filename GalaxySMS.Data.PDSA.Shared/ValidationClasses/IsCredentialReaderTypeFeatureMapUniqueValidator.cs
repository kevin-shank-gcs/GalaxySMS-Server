...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialReaderTypeFeatureMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialReaderTypeFeatureMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialReaderTypeFeatureMapUniquePDSA</param>
    public IsCredentialReaderTypeFeatureMapUniquePDSAValidator(IsCredentialReaderTypeFeatureMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialReaderTypeFeatureMapUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialReaderTypeFeatureMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialReaderTypeFeatureMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialReaderTypeFeatureMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
