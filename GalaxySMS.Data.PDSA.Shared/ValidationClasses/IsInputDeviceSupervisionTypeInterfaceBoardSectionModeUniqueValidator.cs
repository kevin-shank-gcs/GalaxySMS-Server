...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSA</param>
    public IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSAValidator(IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceSupervisionTypeInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
