...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsDayTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsDayTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsDayTypeUniquePDSA</param>
    public IsDayTypeUniquePDSAValidator(IsDayTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsDayTypeUniquePDSAValidator";

      // Create Properties for each field in the IsDayTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsDayTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsDayTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
