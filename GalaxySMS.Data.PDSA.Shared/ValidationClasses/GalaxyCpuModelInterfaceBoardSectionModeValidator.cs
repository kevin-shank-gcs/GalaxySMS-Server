...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyCpuModelInterfaceBoardSectionModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyCpuModelInterfaceBoardSectionModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuModelInterfaceBoardSectionModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuModelInterfaceBoardSectionModePDSA</param>
    public GalaxyCpuModelInterfaceBoardSectionModePDSAValidator(GalaxyCpuModelInterfaceBoardSectionModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuModelInterfaceBoardSectionModePDSAValidator";

      // Create Properties for each field in the GalaxyCpuModelInterfaceBoardSectionModePDSA entity class
      InitProperties();
    ...
    public GalaxyCpuModelInterfaceBoardSectionModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyCpuModelInterfaceBoardSectionModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuModelInterfaceBoardSectionModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuModelInterfaceBoardSectionModePDSAValidator.ColumnNames.DateColumnNameHere);
