...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSA</param>
    public IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSAValidator(IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelAlarmEventAcknowledgmentUniquePDSAValidator.ColumnNames.DateColumnNameHere);
