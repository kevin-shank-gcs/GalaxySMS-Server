...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPropertySensitivityLevelPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPropertySensitivityLevelPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPropertySensitivityLevelPermissionUniquePDSA</param>
    public IsPropertySensitivityLevelPermissionUniquePDSAValidator(IsPropertySensitivityLevelPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPropertySensitivityLevelPermissionUniquePDSAValidator";

      // Create Properties for each field in the IsPropertySensitivityLevelPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPropertySensitivityLevelPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPropertySensitivityLevelPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
