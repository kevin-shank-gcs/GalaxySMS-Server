...
{
  /// <summary>
  /// Used to validate business rules on the AccessGroupAccessPortalPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessGroupAccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortalPDSA</param>
    public AccessGroupAccessPortalPDSAValidator(AccessGroupAccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortalPDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortalPDSA entity class
      InitProperties();
    ...
    public AccessGroupAccessPortalPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessGroupAccessPortalPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
