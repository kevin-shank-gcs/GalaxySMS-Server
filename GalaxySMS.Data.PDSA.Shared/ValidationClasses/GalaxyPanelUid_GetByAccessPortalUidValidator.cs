...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanelUid_GetByAccessPortalUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelUid_GetByAccessPortalUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelUid_GetByAccessPortalUidPDSA</param>
    public GalaxyPanelUid_GetByAccessPortalUidPDSAValidator(GalaxyPanelUid_GetByAccessPortalUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelUid_GetByAccessPortalUidPDSAValidator";

      // Create Properties for each field in the GalaxyPanelUid_GetByAccessPortalUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelUid_GetByAccessPortalUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelUid_GetByAccessPortalUidPDSAValidator.ColumnNames.DateColumnNameHere);
