...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsDateTypeDefaultBehaviorUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsDateTypeDefaultBehaviorUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsDateTypeDefaultBehaviorUniquePDSA</param>
    public IsDateTypeDefaultBehaviorUniquePDSAValidator(IsDateTypeDefaultBehaviorUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsDateTypeDefaultBehaviorUniquePDSAValidator";

      // Create Properties for each field in the IsDateTypeDefaultBehaviorUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsDateTypeDefaultBehaviorUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsDateTypeDefaultBehaviorUniquePDSAValidator.ColumnNames.DateColumnNameHere);
