...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_UserEntityApplicationRolesForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_UserEntityApplicationRolesForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_UserEntityApplicationRolesForUserIdPDSA</param>
    public gcs_UserEntityApplicationRolesForUserIdPDSAValidator(gcs_UserEntityApplicationRolesForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_UserEntityApplicationRolesForUserIdPDSAValidator";

      // Create Properties for each field in the gcs_UserEntityApplicationRolesForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_UserEntityApplicationRolesForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_UserEntityApplicationRolesForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
