...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsResourceStringUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsResourceStringUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsResourceStringUniquePDSA</param>
    public gcs_IsResourceStringUniquePDSAValidator(gcs_IsResourceStringUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsResourceStringUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsResourceStringUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsResourceStringUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsResourceStringUniquePDSAValidator.ColumnNames.DateColumnNameHere);
