...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedPropertyEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedPropertyEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedPropertyEntityMapUniquePDSA</param>
    public IsUserDefinedPropertyEntityMapUniquePDSAValidator(IsUserDefinedPropertyEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedPropertyEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedPropertyEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedPropertyEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedPropertyEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
