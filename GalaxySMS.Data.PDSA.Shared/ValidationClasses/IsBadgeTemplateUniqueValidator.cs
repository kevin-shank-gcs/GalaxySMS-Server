...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsBadgeTemplateUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsBadgeTemplateUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsBadgeTemplateUniquePDSA</param>
    public IsBadgeTemplateUniquePDSAValidator(IsBadgeTemplateUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsBadgeTemplateUniquePDSAValidator";

      // Create Properties for each field in the IsBadgeTemplateUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsBadgeTemplateUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsBadgeTemplateUniquePDSAValidator.ColumnNames.DateColumnNameHere);
