...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsDayTypeEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsDayTypeEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsDayTypeEntityMapUniquePDSA</param>
    public IsDayTypeEntityMapUniquePDSAValidator(IsDayTypeEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsDayTypeEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsDayTypeEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsDayTypeEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsDayTypeEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
