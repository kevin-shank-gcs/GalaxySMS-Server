...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInputDeviceTimeScheduleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInputDeviceTimeScheduleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInputDeviceTimeScheduleUniquePDSA</param>
    public IsGalaxyInputDeviceTimeScheduleUniquePDSAValidator(IsGalaxyInputDeviceTimeScheduleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInputDeviceTimeScheduleUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInputDeviceTimeScheduleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInputDeviceTimeScheduleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInputDeviceTimeScheduleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
