...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailableInputOutputGroupNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailableInputOutputGroupNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailableInputOutputGroupNumberPDSA</param>
    public ChooseAvailableInputOutputGroupNumberPDSAValidator(ChooseAvailableInputOutputGroupNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailableInputOutputGroupNumberPDSAValidator";

      // Create Properties for each field in the ChooseAvailableInputOutputGroupNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailableInputOutputGroupNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailableInputOutputGroupNumberPDSAValidator.ColumnNames.DateColumnNameHere);
