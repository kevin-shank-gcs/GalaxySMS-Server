...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceActivityEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceActivityEventPDSA</param>
    public InputDeviceActivityEventPDSAValidator(InputDeviceActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceActivityEventPDSAValidator";

      // Create Properties for each field in the InputDeviceActivityEventPDSA entity class
      InitProperties();
    ...
    public InputDeviceActivityEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceActivityEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
