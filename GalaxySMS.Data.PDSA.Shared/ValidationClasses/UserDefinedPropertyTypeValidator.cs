...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedPropertyTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedPropertyTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedPropertyTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedPropertyTypePDSA</param>
    public UserDefinedPropertyTypePDSAValidator(UserDefinedPropertyTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedPropertyTypePDSAValidator";

      // Create Properties for each field in the UserDefinedPropertyTypePDSA entity class
      InitProperties();
    ...
    public UserDefinedPropertyTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedPropertyTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedPropertyTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedPropertyTypePDSAValidator.ColumnNames.DateColumnNameHere);
