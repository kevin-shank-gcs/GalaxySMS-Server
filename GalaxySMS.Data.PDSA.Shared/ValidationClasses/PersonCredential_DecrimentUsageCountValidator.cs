...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonCredential_DecrimentUsageCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonCredential_DecrimentUsageCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonCredential_DecrimentUsageCountPDSA</param>
    public PersonCredential_DecrimentUsageCountPDSAValidator(PersonCredential_DecrimentUsageCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonCredential_DecrimentUsageCountPDSAValidator";

      // Create Properties for each field in the PersonCredential_DecrimentUsageCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonCredential_DecrimentUsageCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonCredential_DecrimentUsageCountPDSAValidator.ColumnNames.DateColumnNameHere);
