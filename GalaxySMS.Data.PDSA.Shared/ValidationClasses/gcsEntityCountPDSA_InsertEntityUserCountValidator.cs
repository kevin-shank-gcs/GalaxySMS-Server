...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertEntityUserCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertEntityUserCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertEntityUserCountPDSA</param>
    public gcsEntityCountPDSA_InsertEntityUserCountPDSAValidator(gcsEntityCountPDSA_InsertEntityUserCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertEntityUserCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertEntityUserCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertEntityUserCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertEntityUserCountPDSAValidator.ColumnNames.DateColumnNameHere);
