...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsResourceStringLanguageUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsResourceStringLanguageUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsResourceStringLanguageUniquePDSA</param>
    public gcs_IsResourceStringLanguageUniquePDSAValidator(gcs_IsResourceStringLanguageUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsResourceStringLanguageUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsResourceStringLanguageUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsResourceStringLanguageUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsResourceStringLanguageUniquePDSAValidator.ColumnNames.DateColumnNameHere);
