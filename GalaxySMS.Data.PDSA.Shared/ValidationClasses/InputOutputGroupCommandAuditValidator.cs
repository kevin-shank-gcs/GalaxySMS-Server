...
{
  /// <summary>
  /// Used to validate business rules on the InputOutputGroupCommandAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputOutputGroupCommandAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupCommandAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupCommandAuditPDSA</param>
    public InputOutputGroupCommandAuditPDSAValidator(InputOutputGroupCommandAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupCommandAuditPDSAValidator";

      // Create Properties for each field in the InputOutputGroupCommandAuditPDSA entity class
      InitProperties();
    ...
    public InputOutputGroupCommandAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputOutputGroupCommandAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupCommandAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupCommandAuditPDSAValidator.ColumnNames.DateColumnNameHere);
