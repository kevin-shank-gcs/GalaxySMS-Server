...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Credential_GetPanelLoadDataByCredentialUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_GetPanelLoadDataByCredentialUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_GetPanelLoadDataByCredentialUidPDSA</param>
    public Credential_GetPanelLoadDataByCredentialUidPDSAValidator(Credential_GetPanelLoadDataByCredentialUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_GetPanelLoadDataByCredentialUidPDSAValidator";

      // Create Properties for each field in the Credential_GetPanelLoadDataByCredentialUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_GetPanelLoadDataByCredentialUidPDSAValidator.ColumnNames.DateColumnNameHere);
