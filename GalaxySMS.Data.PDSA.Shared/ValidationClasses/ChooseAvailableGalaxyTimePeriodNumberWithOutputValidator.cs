...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSA</param>
    public ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSAValidator(ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSAValidator";

      // Create Properties for each field in the ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailableGalaxyTimePeriodNumberWithOutputPDSAValidator.ColumnNames.DateColumnNameHere);
