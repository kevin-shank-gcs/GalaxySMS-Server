...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInputDeviceTimeSchedulePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInputDeviceTimeSchedulePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInputDeviceTimeSchedulePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInputDeviceTimeSchedulePDSA</param>
    public GalaxyInputDeviceTimeSchedulePDSAValidator(GalaxyInputDeviceTimeSchedulePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInputDeviceTimeSchedulePDSAValidator";

      // Create Properties for each field in the GalaxyInputDeviceTimeSchedulePDSA entity class
      InitProperties();
    ...
    public GalaxyInputDeviceTimeSchedulePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInputDeviceTimeSchedulePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInputDeviceTimeSchedulePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInputDeviceTimeSchedulePDSAValidator.ColumnNames.DateColumnNameHere);
