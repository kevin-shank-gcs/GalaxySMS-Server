...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonBooleanPropertyUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonBooleanPropertyUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonBooleanPropertyUniquePDSA</param>
    public IsPersonBooleanPropertyUniquePDSAValidator(IsPersonBooleanPropertyUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonBooleanPropertyUniquePDSAValidator";

      // Create Properties for each field in the IsPersonBooleanPropertyUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonBooleanPropertyUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonBooleanPropertyUniquePDSAValidator.ColumnNames.DateColumnNameHere);
