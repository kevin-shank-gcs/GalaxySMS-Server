...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelModelGalaxyPanelCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelModelGalaxyPanelCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelModelGalaxyPanelCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelModelGalaxyPanelCommandPDSA</param>
    public GalaxyPanelModelGalaxyPanelCommandPDSAValidator(GalaxyPanelModelGalaxyPanelCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelModelGalaxyPanelCommandPDSAValidator";

      // Create Properties for each field in the GalaxyPanelModelGalaxyPanelCommandPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelModelGalaxyPanelCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelModelGalaxyPanelCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelModelGalaxyPanelCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelModelGalaxyPanelCommandPDSAValidator.ColumnNames.DateColumnNameHere);
