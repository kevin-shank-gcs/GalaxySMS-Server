...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyCpuPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuPDSA</param>
    public GalaxyCpuPDSAValidator(GalaxyCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuPDSAValidator";

      // Create Properties for each field in the GalaxyCpuPDSA entity class
      InitProperties();
    ...
    public GalaxyCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuPDSAValidator.ColumnNames.DateColumnNameHere);
