...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceAlarmEventAcknowledgmentPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceAlarmEventAcknowledgmentPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceAlarmEventAcknowledgmentPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceAlarmEventAcknowledgmentPDSA</param>
    public InputDeviceAlarmEventAcknowledgmentPDSAValidator(InputDeviceAlarmEventAcknowledgmentPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceAlarmEventAcknowledgmentPDSAValidator";

      // Create Properties for each field in the InputDeviceAlarmEventAcknowledgmentPDSA entity class
      InitProperties();
    ...
    public InputDeviceAlarmEventAcknowledgmentPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceAlarmEventAcknowledgmentPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceAlarmEventAcknowledgmentPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceAlarmEventAcknowledgmentPDSAValidator.ColumnNames.DateColumnNameHere);
