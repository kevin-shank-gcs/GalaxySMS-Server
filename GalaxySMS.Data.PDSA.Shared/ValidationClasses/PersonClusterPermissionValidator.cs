...
{
  /// <summary>
  /// Used to validate business rules on the PersonClusterPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonClusterPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonClusterPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonClusterPermissionPDSA</param>
    public PersonClusterPermissionPDSAValidator(PersonClusterPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonClusterPermissionPDSAValidator";

      // Create Properties for each field in the PersonClusterPermissionPDSA entity class
      InitProperties();
    ...
    public PersonClusterPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonClusterPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonClusterPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonClusterPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
