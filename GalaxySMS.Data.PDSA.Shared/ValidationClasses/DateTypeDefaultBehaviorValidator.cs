...
{
  /// <summary>
  /// Used to validate business rules on the DateTypeDefaultBehaviorPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class DateTypeDefaultBehaviorPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateTypeDefaultBehaviorPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateTypeDefaultBehaviorPDSA</param>
    public DateTypeDefaultBehaviorPDSAValidator(DateTypeDefaultBehaviorPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateTypeDefaultBehaviorPDSAValidator";

      // Create Properties for each field in the DateTypeDefaultBehaviorPDSA entity class
      InitProperties();
    ...
    public DateTypeDefaultBehaviorPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DateTypeDefaultBehaviorPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateColumnNameHere);
