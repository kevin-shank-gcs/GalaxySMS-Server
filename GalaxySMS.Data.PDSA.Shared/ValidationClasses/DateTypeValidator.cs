...
{
  /// <summary>
  /// Used to validate business rules on the DateTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class DateTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateTypePDSA</param>
    public DateTypePDSAValidator(DateTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateTypePDSAValidator";

      // Create Properties for each field in the DateTypePDSA entity class
      InitProperties();
    ...
    public DateTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DateTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateTypePDSAValidator.ColumnNames.DateColumnNameHere);
