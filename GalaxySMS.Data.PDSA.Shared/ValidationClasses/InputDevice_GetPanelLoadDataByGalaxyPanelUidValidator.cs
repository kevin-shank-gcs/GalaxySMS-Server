...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA</param>
    public InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.DateColumnNameHere);
