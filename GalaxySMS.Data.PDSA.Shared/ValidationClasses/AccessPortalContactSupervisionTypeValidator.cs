...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalContactSupervisionTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalContactSupervisionTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalContactSupervisionTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalContactSupervisionTypePDSA</param>
    public AccessPortalContactSupervisionTypePDSAValidator(AccessPortalContactSupervisionTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalContactSupervisionTypePDSAValidator";

      // Create Properties for each field in the AccessPortalContactSupervisionTypePDSA entity class
      InitProperties();
    ...
    public AccessPortalContactSupervisionTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalContactSupervisionTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalContactSupervisionTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalContactSupervisionTypePDSAValidator.ColumnNames.DateColumnNameHere);
