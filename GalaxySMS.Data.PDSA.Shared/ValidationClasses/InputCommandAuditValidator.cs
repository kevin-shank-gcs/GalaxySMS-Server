...
{
  /// <summary>
  /// Used to validate business rules on the InputCommandAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputCommandAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputCommandAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputCommandAuditPDSA</param>
    public InputCommandAuditPDSAValidator(InputCommandAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputCommandAuditPDSAValidator";

      // Create Properties for each field in the InputCommandAuditPDSA entity class
      InitProperties();
    ...
    public InputCommandAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputCommandAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputCommandAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputCommandAuditPDSAValidator.ColumnNames.DateColumnNameHere);
