...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsBadgeSystemTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsBadgeSystemTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsBadgeSystemTypeUniquePDSA</param>
    public IsBadgeSystemTypeUniquePDSAValidator(IsBadgeSystemTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsBadgeSystemTypeUniquePDSAValidator";

      // Create Properties for each field in the IsBadgeSystemTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsBadgeSystemTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsBadgeSystemTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
