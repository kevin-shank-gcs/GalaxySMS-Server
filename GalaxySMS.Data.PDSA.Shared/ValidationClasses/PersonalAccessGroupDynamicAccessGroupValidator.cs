...
{
  /// <summary>
  /// Used to validate business rules on the PersonalAccessGroupDynamicAccessGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonalAccessGroupDynamicAccessGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroupDynamicAccessGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroupDynamicAccessGroupPDSA</param>
    public PersonalAccessGroupDynamicAccessGroupPDSAValidator(PersonalAccessGroupDynamicAccessGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroupDynamicAccessGroupPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroupDynamicAccessGroupPDSA entity class
      InitProperties();
    ...
    public PersonalAccessGroupDynamicAccessGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonalAccessGroupDynamicAccessGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroupDynamicAccessGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroupDynamicAccessGroupPDSAValidator.ColumnNames.DateColumnNameHere);
