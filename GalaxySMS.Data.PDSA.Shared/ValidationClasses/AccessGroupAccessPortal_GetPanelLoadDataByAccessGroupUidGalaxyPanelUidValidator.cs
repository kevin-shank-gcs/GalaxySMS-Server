...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSA</param>
    public AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSAValidator(AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortal_GetPanelLoadDataByAccessGroupUidGalaxyPanelUidPDSAValidator.ColumnNames.DateColumnNameHere);
