...
{
  /// <summary>
  /// Used to validate business rules on the PersonOtisElevatorPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonOtisElevatorPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonOtisElevatorPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonOtisElevatorPDSA</param>
    public PersonOtisElevatorPDSAValidator(PersonOtisElevatorPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonOtisElevatorPDSAValidator";

      // Create Properties for each field in the PersonOtisElevatorPDSA entity class
      InitProperties();
    ...
    public PersonOtisElevatorPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonOtisElevatorPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonOtisElevatorPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonOtisElevatorPDSAValidator.ColumnNames.DateColumnNameHere);
