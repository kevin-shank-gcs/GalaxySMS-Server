...
{
  /// <summary>
  /// Used to validate business rules on the PersonListPropertyItemPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonListPropertyItemPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonListPropertyItemPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonListPropertyItemPDSA</param>
    public PersonListPropertyItemPDSAValidator(PersonListPropertyItemPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonListPropertyItemPDSAValidator";

      // Create Properties for each field in the PersonListPropertyItemPDSA entity class
      InitProperties();
    ...
    public PersonListPropertyItemPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonListPropertyItemPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonListPropertyItemPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonListPropertyItemPDSAValidator.ColumnNames.DateColumnNameHere);
