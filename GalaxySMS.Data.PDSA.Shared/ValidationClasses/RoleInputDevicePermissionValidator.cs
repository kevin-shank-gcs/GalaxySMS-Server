...
{
  /// <summary>
  /// Used to validate business rules on the RoleInputDevicePermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleInputDevicePermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleInputDevicePermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleInputDevicePermissionPDSA</param>
    public RoleInputDevicePermissionPDSAValidator(RoleInputDevicePermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleInputDevicePermissionPDSAValidator";

      // Create Properties for each field in the RoleInputDevicePermissionPDSA entity class
      InitProperties();
    ...
    public RoleInputDevicePermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleInputDevicePermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleInputDevicePermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleInputDevicePermissionPDSAValidator.ColumnNames.DateColumnNameHere);
