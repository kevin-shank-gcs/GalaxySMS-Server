...
{
  /// <summary>
  /// Used to validate business rules on the CredentialToDeleteFromCpuPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialToDeleteFromCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToDeleteFromCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToDeleteFromCpuPDSA</param>
    public CredentialToDeleteFromCpuPDSAValidator(CredentialToDeleteFromCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToDeleteFromCpuPDSAValidator";

      // Create Properties for each field in the CredentialToDeleteFromCpuPDSA entity class
      InitProperties();
    ...
    public CredentialToDeleteFromCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialToDeleteFromCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToDeleteFromCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToDeleteFromCpuPDSAValidator.ColumnNames.DateColumnNameHere);
