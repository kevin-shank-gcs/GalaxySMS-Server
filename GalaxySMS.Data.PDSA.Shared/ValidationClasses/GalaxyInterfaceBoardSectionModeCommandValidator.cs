...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInterfaceBoardSectionModeCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInterfaceBoardSectionModeCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSectionModeCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSectionModeCommandPDSA</param>
    public GalaxyInterfaceBoardSectionModeCommandPDSAValidator(GalaxyInterfaceBoardSectionModeCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSectionModeCommandPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSectionModeCommandPDSA entity class
      InitProperties();
    ...
    public GalaxyInterfaceBoardSectionModeCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInterfaceBoardSectionModeCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionModeCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionModeCommandPDSAValidator.ColumnNames.DateColumnNameHere);
