...
{
  /// <summary>
  /// Used to validate business rules on the CredentialReaderTypeFeatureMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialReaderTypeFeatureMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialReaderTypeFeatureMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialReaderTypeFeatureMapPDSA</param>
    public CredentialReaderTypeFeatureMapPDSAValidator(CredentialReaderTypeFeatureMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialReaderTypeFeatureMapPDSAValidator";

      // Create Properties for each field in the CredentialReaderTypeFeatureMapPDSA entity class
      InitProperties();
    ...
    public CredentialReaderTypeFeatureMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialReaderTypeFeatureMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialReaderTypeFeatureMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialReaderTypeFeatureMapPDSAValidator.ColumnNames.DateColumnNameHere);
