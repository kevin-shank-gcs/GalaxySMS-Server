...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsRoleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsRoleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsRoleUniquePDSA</param>
    public gcs_IsRoleUniquePDSAValidator(gcs_IsRoleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsRoleUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsRoleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsRoleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsRoleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
