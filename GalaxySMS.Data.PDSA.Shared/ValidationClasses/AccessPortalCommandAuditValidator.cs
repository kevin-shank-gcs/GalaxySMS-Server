...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalCommandAuditPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalCommandAuditPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalCommandAuditPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalCommandAuditPDSA</param>
    public AccessPortalCommandAuditPDSAValidator(AccessPortalCommandAuditPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalCommandAuditPDSAValidator";

      // Create Properties for each field in the AccessPortalCommandAuditPDSA entity class
      InitProperties();
    ...
    public AccessPortalCommandAuditPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalCommandAuditPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalCommandAuditPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalCommandAuditPDSAValidator.ColumnNames.DateColumnNameHere);
