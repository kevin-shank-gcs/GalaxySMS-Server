...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelActivityAlarmEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelActivityAlarmEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelActivityAlarmEventUniquePDSA</param>
    public IsGalaxyPanelActivityAlarmEventUniquePDSAValidator(IsGalaxyPanelActivityAlarmEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelActivityAlarmEventUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelActivityAlarmEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelActivityAlarmEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelActivityAlarmEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
