...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroup_GetPanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroup_GetPanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroup_GetPanelLoadDataByClusterUidPDSA</param>
    public InputOutputGroup_GetPanelLoadDataByClusterUidPDSAValidator(InputOutputGroup_GetPanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroup_GetPanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the InputOutputGroup_GetPanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroup_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroup_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
