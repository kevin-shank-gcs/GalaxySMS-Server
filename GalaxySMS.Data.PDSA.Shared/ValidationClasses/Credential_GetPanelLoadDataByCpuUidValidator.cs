...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Credential_GetPanelLoadDataByCpuUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_GetPanelLoadDataByCpuUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_GetPanelLoadDataByCpuUidPDSA</param>
    public Credential_GetPanelLoadDataByCpuUidPDSAValidator(Credential_GetPanelLoadDataByCpuUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_GetPanelLoadDataByCpuUidPDSAValidator";

      // Create Properties for each field in the Credential_GetPanelLoadDataByCpuUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ColumnNames.DateColumnNameHere);
