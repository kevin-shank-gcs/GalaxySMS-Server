...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessProfileEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessProfileEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessProfileEntityMapUniquePDSA</param>
    public IsAccessProfileEntityMapUniquePDSAValidator(IsAccessProfileEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessProfileEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsAccessProfileEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessProfileEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessProfileEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
