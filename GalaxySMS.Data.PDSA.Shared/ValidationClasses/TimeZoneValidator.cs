...
{
  /// <summary>
  /// Used to validate business rules on the TimeZonePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class TimeZonePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeZonePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeZonePDSA</param>
    public TimeZonePDSAValidator(TimeZonePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeZonePDSAValidator";

      // Create Properties for each field in the TimeZonePDSA entity class
      InitProperties();
    ...
    public TimeZonePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your TimeZonePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeZonePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeZonePDSAValidator.ColumnNames.DateColumnNameHere);
