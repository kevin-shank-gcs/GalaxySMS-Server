...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsApplicationSettingUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsApplicationSettingUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsApplicationSettingUniquePDSA</param>
    public gcs_IsApplicationSettingUniquePDSAValidator(gcs_IsApplicationSettingUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsApplicationSettingUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsApplicationSettingUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsApplicationSettingUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsApplicationSettingUniquePDSAValidator.ColumnNames.DateColumnNameHere);
