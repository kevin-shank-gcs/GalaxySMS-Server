...
{
  /// <summary>
  /// Used to validate business rules on the StateProvincePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class StateProvincePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the StateProvincePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a StateProvincePDSA</param>
    public StateProvincePDSAValidator(StateProvincePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "StateProvincePDSAValidator";

      // Create Properties for each field in the StateProvincePDSA entity class
      InitProperties();
    ...
    public StateProvincePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your StateProvincePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(StateProvincePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(StateProvincePDSAValidator.ColumnNames.DateColumnNameHere);
