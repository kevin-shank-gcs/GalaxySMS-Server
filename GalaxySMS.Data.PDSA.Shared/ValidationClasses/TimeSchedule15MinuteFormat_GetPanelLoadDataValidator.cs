...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class TimeSchedule15MinuteFormat_GetPanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the TimeSchedule15MinuteFormat_GetPanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a TimeSchedule15MinuteFormat_GetPanelLoadDataPDSA</param>
    public TimeSchedule15MinuteFormat_GetPanelLoadDataPDSAValidator(TimeSchedule15MinuteFormat_GetPanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "TimeSchedule15MinuteFormat_GetPanelLoadDataPDSAValidator";

      // Create Properties for each field in the TimeSchedule15MinuteFormat_GetPanelLoadDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(TimeSchedule15MinuteFormat_GetPanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(TimeSchedule15MinuteFormat_GetPanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
