...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_SelectionListForEntityAndClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_SelectionListForEntityAndClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_SelectionListForEntityAndClusterPDSA</param>
    public AccessPortal_SelectionListForEntityAndClusterPDSAValidator(AccessPortal_SelectionListForEntityAndClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_SelectionListForEntityAndClusterPDSAValidator";

      // Create Properties for each field in the AccessPortal_SelectionListForEntityAndClusterPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_SelectionListForEntityAndClusterPDSAValidator.ColumnNames.DateColumnNameHere);
