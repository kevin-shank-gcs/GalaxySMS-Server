...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonInputOutputGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonInputOutputGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonInputOutputGroupUniquePDSA</param>
    public IsPersonInputOutputGroupUniquePDSAValidator(IsPersonInputOutputGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonInputOutputGroupUniquePDSAValidator";

      // Create Properties for each field in the IsPersonInputOutputGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonInputOutputGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonInputOutputGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
