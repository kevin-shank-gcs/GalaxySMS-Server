...
{
  /// <summary>
  /// Used to validate business rules on the LiquidCrystalDisplayGalaxyHardwareAddressPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class LiquidCrystalDisplayGalaxyHardwareAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the LiquidCrystalDisplayGalaxyHardwareAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a LiquidCrystalDisplayGalaxyHardwareAddressPDSA</param>
    public LiquidCrystalDisplayGalaxyHardwareAddressPDSAValidator(LiquidCrystalDisplayGalaxyHardwareAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "LiquidCrystalDisplayGalaxyHardwareAddressPDSAValidator";

      // Create Properties for each field in the LiquidCrystalDisplayGalaxyHardwareAddressPDSA entity class
      InitProperties();
    ...
    public LiquidCrystalDisplayGalaxyHardwareAddressPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your LiquidCrystalDisplayGalaxyHardwareAddressPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(LiquidCrystalDisplayGalaxyHardwareAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(LiquidCrystalDisplayGalaxyHardwareAddressPDSAValidator.ColumnNames.DateColumnNameHere);
