...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputInputSourceRelationshipPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputInputSourceRelationshipPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputInputSourceRelationshipPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputInputSourceRelationshipPDSA</param>
    public GalaxyOutputInputSourceRelationshipPDSAValidator(GalaxyOutputInputSourceRelationshipPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputInputSourceRelationshipPDSAValidator";

      // Create Properties for each field in the GalaxyOutputInputSourceRelationshipPDSA entity class
      InitProperties();
    ...
    public GalaxyOutputInputSourceRelationshipPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputInputSourceRelationshipPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputInputSourceRelationshipPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputInputSourceRelationshipPDSAValidator.ColumnNames.DateColumnNameHere);
