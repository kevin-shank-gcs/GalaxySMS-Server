...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSA</param>
    public IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSAValidator(IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSAValidator";

      // Create Properties for each field in the IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsLiquidCrystalDisplayGalaxyHardwareAddressUniquePDSAValidator.ColumnNames.DateColumnNameHere);
