...
{
  /// <summary>
  /// Used to validate business rules on the gcsRolePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsRolePDSA</param>
    public gcsRolePDSAValidator(gcsRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsRolePDSAValidator";

      // Create Properties for each field in the gcsRolePDSA entity class
      InitProperties();
    ...
    public gcsRolePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsRolePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsRolePDSAValidator.ColumnNames.DateColumnNameHere);
