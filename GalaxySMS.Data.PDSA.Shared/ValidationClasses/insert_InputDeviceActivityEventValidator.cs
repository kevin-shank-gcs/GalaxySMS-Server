...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class insert_InputDeviceActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the insert_InputDeviceActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a insert_InputDeviceActivityEventPDSA</param>
    public insert_InputDeviceActivityEventPDSAValidator(insert_InputDeviceActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "insert_InputDeviceActivityEventPDSAValidator";

      // Create Properties for each field in the insert_InputDeviceActivityEventPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(insert_InputDeviceActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(insert_InputDeviceActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
