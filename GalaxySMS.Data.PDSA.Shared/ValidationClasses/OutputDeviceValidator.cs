...
{
  /// <summary>
  /// Used to validate business rules on the OutputDevicePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class OutputDevicePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevicePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevicePDSA</param>
    public OutputDevicePDSAValidator(OutputDevicePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevicePDSAValidator";

      // Create Properties for each field in the OutputDevicePDSA entity class
      InitProperties();
    ...
    public OutputDevicePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputDevicePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevicePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevicePDSAValidator.ColumnNames.DateColumnNameHere);
