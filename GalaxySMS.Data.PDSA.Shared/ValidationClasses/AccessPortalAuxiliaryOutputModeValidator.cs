...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAuxiliaryOutputModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAuxiliaryOutputModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAuxiliaryOutputModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAuxiliaryOutputModePDSA</param>
    public AccessPortalAuxiliaryOutputModePDSAValidator(AccessPortalAuxiliaryOutputModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAuxiliaryOutputModePDSAValidator";

      // Create Properties for each field in the AccessPortalAuxiliaryOutputModePDSA entity class
      InitProperties();
    ...
    public AccessPortalAuxiliaryOutputModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAuxiliaryOutputModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAuxiliaryOutputModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAuxiliaryOutputModePDSAValidator.ColumnNames.DateColumnNameHere);
