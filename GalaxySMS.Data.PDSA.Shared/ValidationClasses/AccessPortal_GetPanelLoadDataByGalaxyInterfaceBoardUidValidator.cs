...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA</param>
    public AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardUidPDSAValidator.ColumnNames.DateColumnNameHere);
