...
{
  /// <summary>
  /// Used to validate business rules on the PanelDataPacketLogPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PanelDataPacketLogPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PanelDataPacketLogPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PanelDataPacketLogPDSA</param>
    public PanelDataPacketLogPDSAValidator(PanelDataPacketLogPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PanelDataPacketLogPDSAValidator";

      // Create Properties for each field in the PanelDataPacketLogPDSA entity class
      InitProperties();
    ...
    public PanelDataPacketLogPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PanelDataPacketLogPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PanelDataPacketLogPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PanelDataPacketLogPDSAValidator.ColumnNames.DateColumnNameHere);
