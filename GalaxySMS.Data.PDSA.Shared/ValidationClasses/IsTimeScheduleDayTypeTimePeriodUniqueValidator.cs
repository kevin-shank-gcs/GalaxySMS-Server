...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimeScheduleDayTypeTimePeriodUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimeScheduleDayTypeTimePeriodUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimeScheduleDayTypeTimePeriodUniquePDSA</param>
    public IsTimeScheduleDayTypeTimePeriodUniquePDSAValidator(IsTimeScheduleDayTypeTimePeriodUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimeScheduleDayTypeTimePeriodUniquePDSAValidator";

      // Create Properties for each field in the IsTimeScheduleDayTypeTimePeriodUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimeScheduleDayTypeTimePeriodUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimeScheduleDayTypeTimePeriodUniquePDSAValidator.ColumnNames.DateColumnNameHere);
