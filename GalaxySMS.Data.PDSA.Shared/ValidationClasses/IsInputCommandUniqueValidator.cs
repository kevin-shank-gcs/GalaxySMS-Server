...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputCommandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputCommandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputCommandUniquePDSA</param>
    public IsInputCommandUniquePDSAValidator(IsInputCommandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputCommandUniquePDSAValidator";

      // Create Properties for each field in the IsInputCommandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputCommandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputCommandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
