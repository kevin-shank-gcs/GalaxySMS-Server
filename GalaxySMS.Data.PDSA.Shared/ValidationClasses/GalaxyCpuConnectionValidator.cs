...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyCpuConnectionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyCpuConnectionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpuConnectionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpuConnectionPDSA</param>
    public GalaxyCpuConnectionPDSAValidator(GalaxyCpuConnectionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpuConnectionPDSAValidator";

      // Create Properties for each field in the GalaxyCpuConnectionPDSA entity class
      InitProperties();
    ...
    public GalaxyCpuConnectionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyCpuConnectionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpuConnectionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpuConnectionPDSAValidator.ColumnNames.DateColumnNameHere);
