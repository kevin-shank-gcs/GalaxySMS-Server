...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsBadgeTemplateEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsBadgeTemplateEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsBadgeTemplateEntityMapUniquePDSA</param>
    public IsBadgeTemplateEntityMapUniquePDSAValidator(IsBadgeTemplateEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsBadgeTemplateEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsBadgeTemplateEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsBadgeTemplateEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsBadgeTemplateEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
