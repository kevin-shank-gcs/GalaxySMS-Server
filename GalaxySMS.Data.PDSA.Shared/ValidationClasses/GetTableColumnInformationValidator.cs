...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GetTableColumnInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GetTableColumnInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GetTableColumnInformationPDSA</param>
    public GetTableColumnInformationPDSAValidator(GetTableColumnInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GetTableColumnInformationPDSAValidator";

      // Create Properties for each field in the GetTableColumnInformationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GetTableColumnInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GetTableColumnInformationPDSAValidator.ColumnNames.DateColumnNameHere);
