...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSA</param>
    public IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSAValidator(IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyOutputDeviceInputSourceInputOutputGroupUniquePDSAValidator.ColumnNames.DateColumnNameHere);
