...
{
  /// <summary>
  /// Used to validate business rules on the AcknowledgedAlarmsPDSA class.
  ...
  /// </summary>
  public partial class AcknowledgedAlarmsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarmsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarmsPDSA</param>
    public AcknowledgedAlarmsPDSAValidator(AcknowledgedAlarmsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarmsPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarmsPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AcknowledgedAlarmsPDSA object</returns>
    public AcknowledgedAlarmsPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AcknowledgedAlarmsPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarmsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarmsPDSAValidator.ColumnNames.DateColumnNameHere);
