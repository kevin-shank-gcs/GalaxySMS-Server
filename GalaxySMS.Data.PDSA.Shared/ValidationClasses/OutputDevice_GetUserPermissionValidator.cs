...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetUserPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetUserPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetUserPermissionPDSA</param>
    public OutputDevice_GetUserPermissionPDSAValidator(OutputDevice_GetUserPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetUserPermissionPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetUserPermissionPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetUserPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetUserPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
