...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceAlertEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceAlertEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceAlertEventUniquePDSA</param>
    public IsInputDeviceAlertEventUniquePDSAValidator(IsInputDeviceAlertEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceAlertEventUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceAlertEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceAlertEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceAlertEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
