...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelModelPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelModelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelModelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelModelPDSA</param>
    public GalaxyPanelModelPDSAValidator(GalaxyPanelModelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelModelPDSAValidator";

      // Create Properties for each field in the GalaxyPanelModelPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelModelPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelModelPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelModelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelModelPDSAValidator.ColumnNames.DateColumnNameHere);
