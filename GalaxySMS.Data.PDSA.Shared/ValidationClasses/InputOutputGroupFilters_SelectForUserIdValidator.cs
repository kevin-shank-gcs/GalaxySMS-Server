...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupFilters_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupFilters_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupFilters_SelectForUserIdPDSA</param>
    public InputOutputGroupFilters_SelectForUserIdPDSAValidator(InputOutputGroupFilters_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupFilters_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the InputOutputGroupFilters_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupFilters_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupFilters_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
