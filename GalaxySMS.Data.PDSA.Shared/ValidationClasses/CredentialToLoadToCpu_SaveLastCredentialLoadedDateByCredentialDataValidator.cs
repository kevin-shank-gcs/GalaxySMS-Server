...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSA</param>
    public CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSAValidator(CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSAValidator";

      // Create Properties for each field in the CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialToLoadToCpu_SaveLastCredentialLoadedDateByCredentialDataPDSAValidator.ColumnNames.DateColumnNameHere);
