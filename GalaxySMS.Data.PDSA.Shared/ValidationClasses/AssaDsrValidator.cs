...
{
  /// <summary>
  /// Used to validate business rules on the AssaDsrPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaDsrPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaDsrPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaDsrPDSA</param>
    public AssaDsrPDSAValidator(AssaDsrPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaDsrPDSAValidator";

      // Create Properties for each field in the AssaDsrPDSA entity class
      InitProperties();
    ...
    public AssaDsrPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaDsrPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaDsrPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaDsrPDSAValidator.ColumnNames.DateColumnNameHere);
