...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialFormatEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialFormatEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialFormatEntityMapUniquePDSA</param>
    public IsCredentialFormatEntityMapUniquePDSAValidator(IsCredentialFormatEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialFormatEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialFormatEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialFormatEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialFormatEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
