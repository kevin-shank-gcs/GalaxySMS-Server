...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataChangesByCpuUidPDSA</param>
    public InputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator(InputDevice_GetPanelLoadDataChangesByCpuUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataChangesByCpuUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.DateColumnNameHere);
