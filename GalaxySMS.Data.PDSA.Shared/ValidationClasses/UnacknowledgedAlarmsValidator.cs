...
{
  /// <summary>
  /// Used to validate business rules on the UnacknowledgedAlarmsPDSA class.
  ...
  /// </summary>
  public partial class UnacknowledgedAlarmsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UnacknowledgedAlarmsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UnacknowledgedAlarmsPDSA</param>
    public UnacknowledgedAlarmsPDSAValidator(UnacknowledgedAlarmsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UnacknowledgedAlarmsPDSAValidator";

      // Create Properties for each field in the UnacknowledgedAlarmsPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A UnacknowledgedAlarmsPDSA object</returns>
    public UnacknowledgedAlarmsPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UnacknowledgedAlarmsPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UnacknowledgedAlarmsPDSAValidator.ColumnNames.DateColumnNameHere);
