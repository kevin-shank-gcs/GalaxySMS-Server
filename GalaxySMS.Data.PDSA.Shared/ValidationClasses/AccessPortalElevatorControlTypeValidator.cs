...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalElevatorControlTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalElevatorControlTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalElevatorControlTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalElevatorControlTypePDSA</param>
    public AccessPortalElevatorControlTypePDSAValidator(AccessPortalElevatorControlTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalElevatorControlTypePDSAValidator";

      // Create Properties for each field in the AccessPortalElevatorControlTypePDSA entity class
      InitProperties();
    ...
    public AccessPortalElevatorControlTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalElevatorControlTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalElevatorControlTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalElevatorControlTypePDSAValidator.ColumnNames.DateColumnNameHere);
