...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyClusterDayTypeMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyClusterDayTypeMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyClusterDayTypeMapUniquePDSA</param>
    public IsGalaxyClusterDayTypeMapUniquePDSAValidator(IsGalaxyClusterDayTypeMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyClusterDayTypeMapUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyClusterDayTypeMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyClusterDayTypeMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyClusterDayTypeMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
