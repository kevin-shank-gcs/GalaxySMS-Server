...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterUniquePDSA</param>
    public IsClusterUniquePDSAValidator(IsClusterUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterUniquePDSAValidator";

      // Create Properties for each field in the IsClusterUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterUniquePDSAValidator.ColumnNames.DateColumnNameHere);
