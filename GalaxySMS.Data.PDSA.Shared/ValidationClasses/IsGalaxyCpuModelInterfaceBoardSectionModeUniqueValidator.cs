...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSA</param>
    public IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSAValidator(IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyCpuModelInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
