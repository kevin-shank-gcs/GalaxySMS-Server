...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class DateType_GetClustersThatUseDateTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DateType_GetClustersThatUseDateTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DateType_GetClustersThatUseDateTypePDSA</param>
    public DateType_GetClustersThatUseDateTypePDSAValidator(DateType_GetClustersThatUseDateTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DateType_GetClustersThatUseDateTypePDSAValidator";

      // Create Properties for each field in the DateType_GetClustersThatUseDateTypePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DateType_GetClustersThatUseDateTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DateType_GetClustersThatUseDateTypePDSAValidator.ColumnNames.DateColumnNameHere);
