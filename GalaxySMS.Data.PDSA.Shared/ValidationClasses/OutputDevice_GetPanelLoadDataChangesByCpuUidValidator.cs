...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA</param>
    public OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetPanelLoadDataChangesByCpuUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataChangesByCpuUidPDSAValidator.ColumnNames.DateColumnNameHere);
