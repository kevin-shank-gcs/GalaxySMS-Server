...
{
  /// <summary>
  /// Used to validate business rules on the RoleAccessPortalPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleAccessPortalPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleAccessPortalPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleAccessPortalPDSA</param>
    public RoleAccessPortalPDSAValidator(RoleAccessPortalPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleAccessPortalPDSAValidator";

      // Create Properties for each field in the RoleAccessPortalPDSA entity class
      InitProperties();
    ...
    public RoleAccessPortalPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleAccessPortalPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleAccessPortalPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleAccessPortalPDSAValidator.ColumnNames.DateColumnNameHere);
