...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsLiquidCrystalDisplayEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsLiquidCrystalDisplayEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsLiquidCrystalDisplayEntityMapUniquePDSA</param>
    public IsLiquidCrystalDisplayEntityMapUniquePDSAValidator(IsLiquidCrystalDisplayEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsLiquidCrystalDisplayEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsLiquidCrystalDisplayEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsLiquidCrystalDisplayEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsLiquidCrystalDisplayEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
