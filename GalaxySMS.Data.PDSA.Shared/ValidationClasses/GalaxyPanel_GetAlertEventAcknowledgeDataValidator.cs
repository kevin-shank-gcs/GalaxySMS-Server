...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyPanel_GetAlertEventAcknowledgeDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanel_GetAlertEventAcknowledgeDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanel_GetAlertEventAcknowledgeDataPDSA</param>
    public GalaxyPanel_GetAlertEventAcknowledgeDataPDSAValidator(GalaxyPanel_GetAlertEventAcknowledgeDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanel_GetAlertEventAcknowledgeDataPDSAValidator";

      // Create Properties for each field in the GalaxyPanel_GetAlertEventAcknowledgeDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanel_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanel_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.DateColumnNameHere);
