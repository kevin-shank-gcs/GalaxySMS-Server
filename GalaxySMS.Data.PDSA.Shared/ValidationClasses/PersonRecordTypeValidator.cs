...
{
  /// <summary>
  /// Used to validate business rules on the PersonRecordTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonRecordTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonRecordTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonRecordTypePDSA</param>
    public PersonRecordTypePDSAValidator(PersonRecordTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonRecordTypePDSAValidator";

      // Create Properties for each field in the PersonRecordTypePDSA entity class
      InitProperties();
    ...
    public PersonRecordTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonRecordTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonRecordTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonRecordTypePDSAValidator.ColumnNames.DateColumnNameHere);
