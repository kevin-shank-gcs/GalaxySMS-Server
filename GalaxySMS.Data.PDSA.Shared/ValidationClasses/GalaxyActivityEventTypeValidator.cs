...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyActivityEventTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyActivityEventTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyActivityEventTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyActivityEventTypePDSA</param>
    public GalaxyActivityEventTypePDSAValidator(GalaxyActivityEventTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyActivityEventTypePDSAValidator";

      // Create Properties for each field in the GalaxyActivityEventTypePDSA entity class
      InitProperties();
    ...
    public GalaxyActivityEventTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyActivityEventTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyActivityEventTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyActivityEventTypePDSAValidator.ColumnNames.DateColumnNameHere);
