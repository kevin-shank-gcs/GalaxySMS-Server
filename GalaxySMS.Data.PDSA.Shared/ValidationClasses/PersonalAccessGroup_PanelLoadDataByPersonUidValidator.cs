...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonalAccessGroup_PanelLoadDataByPersonUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroup_PanelLoadDataByPersonUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroup_PanelLoadDataByPersonUidPDSA</param>
    public PersonalAccessGroup_PanelLoadDataByPersonUidPDSAValidator(PersonalAccessGroup_PanelLoadDataByPersonUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroup_PanelLoadDataByPersonUidPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroup_PanelLoadDataByPersonUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroup_PanelLoadDataByPersonUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroup_PanelLoadDataByPersonUidPDSAValidator.ColumnNames.DateColumnNameHere);
