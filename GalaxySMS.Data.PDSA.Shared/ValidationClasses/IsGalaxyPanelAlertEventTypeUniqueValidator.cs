...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelAlertEventTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelAlertEventTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelAlertEventTypeUniquePDSA</param>
    public IsGalaxyPanelAlertEventTypeUniquePDSAValidator(IsGalaxyPanelAlertEventTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelAlertEventTypeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelAlertEventTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelAlertEventTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelAlertEventTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
