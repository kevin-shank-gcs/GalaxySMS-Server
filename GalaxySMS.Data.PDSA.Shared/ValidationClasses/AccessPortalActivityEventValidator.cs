...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalActivityEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalActivityEventPDSA</param>
    public AccessPortalActivityEventPDSAValidator(AccessPortalActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalActivityEventPDSAValidator";

      // Create Properties for each field in the AccessPortalActivityEventPDSA entity class
      InitProperties();
    ...
    public AccessPortalActivityEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalActivityEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
