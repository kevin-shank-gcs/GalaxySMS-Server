...
{
  /// <summary>
  /// Used to validate business rules on the EntityMapPermissionLevelPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class EntityMapPermissionLevelPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the EntityMapPermissionLevelPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a EntityMapPermissionLevelPDSA</param>
    public EntityMapPermissionLevelPDSAValidator(EntityMapPermissionLevelPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "EntityMapPermissionLevelPDSAValidator";

      // Create Properties for each field in the EntityMapPermissionLevelPDSA entity class
      InitProperties();
    ...
    public EntityMapPermissionLevelPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your EntityMapPermissionLevelPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(EntityMapPermissionLevelPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(EntityMapPermissionLevelPDSAValidator.ColumnNames.DateColumnNameHere);
