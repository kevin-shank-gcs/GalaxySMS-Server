...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInterfaceBoardPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInterfaceBoardPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardPDSA</param>
    public GalaxyInterfaceBoardPDSAValidator(GalaxyInterfaceBoardPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardPDSA entity class
      InitProperties();
    ...
    public GalaxyInterfaceBoardPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInterfaceBoardPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardPDSAValidator.ColumnNames.DateColumnNameHere);
