...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAuxiliaryOutputPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAuxiliaryOutputPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAuxiliaryOutputPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAuxiliaryOutputPDSA</param>
    public AccessPortalAuxiliaryOutputPDSAValidator(AccessPortalAuxiliaryOutputPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAuxiliaryOutputPDSAValidator";

      // Create Properties for each field in the AccessPortalAuxiliaryOutputPDSA entity class
      InitProperties();
    ...
    public AccessPortalAuxiliaryOutputPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAuxiliaryOutputPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAuxiliaryOutputPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAuxiliaryOutputPDSAValidator.ColumnNames.DateColumnNameHere);
