...
{
  /// <summary>
  /// Used to validate business rules on the DayTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class DayTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DayTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DayTypePDSA</param>
    public DayTypePDSAValidator(DayTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DayTypePDSAValidator";

      // Create Properties for each field in the DayTypePDSA entity class
      InitProperties();
    ...
    public DayTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DayTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DayTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DayTypePDSAValidator.ColumnNames.DateColumnNameHere);
