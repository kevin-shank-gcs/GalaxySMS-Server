...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyClusterTimeScheduleMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyClusterTimeScheduleMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyClusterTimeScheduleMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyClusterTimeScheduleMapPDSA</param>
    public GalaxyClusterTimeScheduleMapPDSAValidator(GalaxyClusterTimeScheduleMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyClusterTimeScheduleMapPDSAValidator";

      // Create Properties for each field in the GalaxyClusterTimeScheduleMapPDSA entity class
      InitProperties();
    ...
    public GalaxyClusterTimeScheduleMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyClusterTimeScheduleMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyClusterTimeScheduleMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyClusterTimeScheduleMapPDSAValidator.ColumnNames.DateColumnNameHere);
