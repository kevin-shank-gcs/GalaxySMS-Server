...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyTimePeriodPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyTimePeriodPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyTimePeriodPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyTimePeriodPDSA</param>
    public GalaxyTimePeriodPDSAValidator(GalaxyTimePeriodPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyTimePeriodPDSAValidator";

      // Create Properties for each field in the GalaxyTimePeriodPDSA entity class
      InitProperties();
    ...
    public GalaxyTimePeriodPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyTimePeriodPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyTimePeriodPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyTimePeriodPDSAValidator.ColumnNames.DateColumnNameHere);
