...
{
  /// <summary>
  /// Used to validate business rules on the gcsMenuItemPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsMenuItemPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsMenuItemPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsMenuItemPDSA</param>
    public gcsMenuItemPDSAValidator(gcsMenuItemPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsMenuItemPDSAValidator";

      // Create Properties for each field in the gcsMenuItemPDSA entity class
      InitProperties();
    ...
    public gcsMenuItemPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsMenuItemPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsMenuItemPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsMenuItemPDSAValidator.ColumnNames.DateColumnNameHere);
