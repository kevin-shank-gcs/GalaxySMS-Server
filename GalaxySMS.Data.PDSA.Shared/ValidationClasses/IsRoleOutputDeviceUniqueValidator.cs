...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleOutputDeviceUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleOutputDeviceUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleOutputDeviceUniquePDSA</param>
    public IsRoleOutputDeviceUniquePDSAValidator(IsRoleOutputDeviceUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleOutputDeviceUniquePDSAValidator";

      // Create Properties for each field in the IsRoleOutputDeviceUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleOutputDeviceUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleOutputDeviceUniquePDSAValidator.ColumnNames.DateColumnNameHere);
