...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialXceedId40BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialXceedId40BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialXceedId40BitUniquePDSA</param>
    public IsCredentialXceedId40BitUniquePDSAValidator(IsCredentialXceedId40BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialXceedId40BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialXceedId40BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialXceedId40BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialXceedId40BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
