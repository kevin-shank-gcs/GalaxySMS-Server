...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPropertySensitivityLevelUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPropertySensitivityLevelUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPropertySensitivityLevelUniquePDSA</param>
    public IsPropertySensitivityLevelUniquePDSAValidator(IsPropertySensitivityLevelUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPropertySensitivityLevelUniquePDSAValidator";

      // Create Properties for each field in the IsPropertySensitivityLevelUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPropertySensitivityLevelUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPropertySensitivityLevelUniquePDSAValidator.ColumnNames.DateColumnNameHere);
