...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_DoesRowExistBigIntPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_DoesRowExistBigIntPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_DoesRowExistBigIntPDSA</param>
    public gcs_DoesRowExistBigIntPDSAValidator(gcs_DoesRowExistBigIntPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_DoesRowExistBigIntPDSAValidator";

      // Create Properties for each field in the gcs_DoesRowExistBigIntPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_DoesRowExistBigIntPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_DoesRowExistBigIntPDSAValidator.ColumnNames.DateColumnNameHere);
