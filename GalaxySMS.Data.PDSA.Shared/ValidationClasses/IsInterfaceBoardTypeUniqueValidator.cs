...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInterfaceBoardTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInterfaceBoardTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInterfaceBoardTypeUniquePDSA</param>
    public IsInterfaceBoardTypeUniquePDSAValidator(IsInterfaceBoardTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInterfaceBoardTypeUniquePDSAValidator";

      // Create Properties for each field in the IsInterfaceBoardTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInterfaceBoardTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInterfaceBoardTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
