...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyOutputInputSourceRelationshipUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyOutputInputSourceRelationshipUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyOutputInputSourceRelationshipUniquePDSA</param>
    public IsGalaxyOutputInputSourceRelationshipUniquePDSAValidator(IsGalaxyOutputInputSourceRelationshipUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyOutputInputSourceRelationshipUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyOutputInputSourceRelationshipUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyOutputInputSourceRelationshipUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyOutputInputSourceRelationshipUniquePDSAValidator.ColumnNames.DateColumnNameHere);
