...
{
  /// <summary>
  /// Used to validate business rules on the AssaDsrEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaDsrEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaDsrEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaDsrEntityMapPDSA</param>
    public AssaDsrEntityMapPDSAValidator(AssaDsrEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaDsrEntityMapPDSAValidator";

      // Create Properties for each field in the AssaDsrEntityMapPDSA entity class
      InitProperties();
    ...
    public AssaDsrEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaDsrEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaDsrEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaDsrEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
