...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyClusterTimePeriodMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyClusterTimePeriodMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyClusterTimePeriodMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyClusterTimePeriodMapPDSA</param>
    public GalaxyClusterTimePeriodMapPDSAValidator(GalaxyClusterTimePeriodMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyClusterTimePeriodMapPDSAValidator";

      // Create Properties for each field in the GalaxyClusterTimePeriodMapPDSA entity class
      InitProperties();
    ...
    public GalaxyClusterTimePeriodMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyClusterTimePeriodMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyClusterTimePeriodMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyClusterTimePeriodMapPDSAValidator.ColumnNames.DateColumnNameHere);
