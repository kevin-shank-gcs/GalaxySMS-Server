...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsNoteUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsNoteUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsNoteUniquePDSA</param>
    public IsNoteUniquePDSAValidator(IsNoteUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsNoteUniquePDSAValidator";

      // Create Properties for each field in the IsNoteUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsNoteUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsNoteUniquePDSAValidator.ColumnNames.DateColumnNameHere);
