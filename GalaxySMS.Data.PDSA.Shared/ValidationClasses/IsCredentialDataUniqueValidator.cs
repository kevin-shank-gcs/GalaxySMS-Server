...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialDataUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialDataUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialDataUniquePDSA</param>
    public IsCredentialDataUniquePDSAValidator(IsCredentialDataUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialDataUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialDataUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialDataUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialDataUniquePDSAValidator.ColumnNames.DateColumnNameHere);
