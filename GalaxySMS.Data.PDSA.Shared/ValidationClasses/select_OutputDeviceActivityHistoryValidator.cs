...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class select_OutputDeviceActivityHistoryPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the select_OutputDeviceActivityHistoryPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a select_OutputDeviceActivityHistoryPDSA</param>
    public select_OutputDeviceActivityHistoryPDSAValidator(select_OutputDeviceActivityHistoryPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "select_OutputDeviceActivityHistoryPDSAValidator";

      // Create Properties for each field in the select_OutputDeviceActivityHistoryPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(select_OutputDeviceActivityHistoryPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(select_OutputDeviceActivityHistoryPDSAValidator.ColumnNames.DateColumnNameHere);
