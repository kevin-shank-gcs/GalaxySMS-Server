...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsOutputDeviceActivityEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsOutputDeviceActivityEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsOutputDeviceActivityEventUniquePDSA</param>
    public IsOutputDeviceActivityEventUniquePDSAValidator(IsOutputDeviceActivityEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsOutputDeviceActivityEventUniquePDSAValidator";

      // Create Properties for each field in the IsOutputDeviceActivityEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsOutputDeviceActivityEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsOutputDeviceActivityEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
