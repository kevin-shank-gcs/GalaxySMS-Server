...
{
  /// <summary>
  /// Used to validate business rules on the PersonDatePropertyPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonDatePropertyPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonDatePropertyPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonDatePropertyPDSA</param>
    public PersonDatePropertyPDSAValidator(PersonDatePropertyPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonDatePropertyPDSAValidator";

      // Create Properties for each field in the PersonDatePropertyPDSA entity class
      InitProperties();
    ...
    public PersonDatePropertyPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonDatePropertyPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonDatePropertyPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonDatePropertyPDSAValidator.ColumnNames.DateColumnNameHere);
