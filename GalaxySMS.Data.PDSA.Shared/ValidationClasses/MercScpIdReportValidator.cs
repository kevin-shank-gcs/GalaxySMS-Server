...
{
  /// <summary>
  /// Used to validate business rules on the MercScpIdReportPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class MercScpIdReportPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercScpIdReportPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercScpIdReportPDSA</param>
    public MercScpIdReportPDSAValidator(MercScpIdReportPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercScpIdReportPDSAValidator";

      // Create Properties for each field in the MercScpIdReportPDSA entity class
      InitProperties();
    ...
    public MercScpIdReportPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your MercScpIdReportPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercScpIdReportPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercScpIdReportPDSAValidator.ColumnNames.DateColumnNameHere);
