...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyOutputModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyOutputModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyOutputModeUniquePDSA</param>
    public IsGalaxyOutputModeUniquePDSAValidator(IsGalaxyOutputModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyOutputModeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyOutputModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyOutputModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyOutputModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
