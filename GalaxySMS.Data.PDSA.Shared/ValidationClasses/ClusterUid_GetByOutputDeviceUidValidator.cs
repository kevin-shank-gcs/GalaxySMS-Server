...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterUid_GetByOutputDeviceUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterUid_GetByOutputDeviceUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterUid_GetByOutputDeviceUidPDSA</param>
    public ClusterUid_GetByOutputDeviceUidPDSAValidator(ClusterUid_GetByOutputDeviceUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterUid_GetByOutputDeviceUidPDSAValidator";

      // Create Properties for each field in the ClusterUid_GetByOutputDeviceUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterUid_GetByOutputDeviceUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterUid_GetByOutputDeviceUidPDSAValidator.ColumnNames.DateColumnNameHere);
