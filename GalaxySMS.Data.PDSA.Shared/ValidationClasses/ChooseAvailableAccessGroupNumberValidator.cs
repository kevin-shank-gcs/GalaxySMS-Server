...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailableAccessGroupNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailableAccessGroupNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailableAccessGroupNumberPDSA</param>
    public ChooseAvailableAccessGroupNumberPDSAValidator(ChooseAvailableAccessGroupNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailableAccessGroupNumberPDSAValidator";

      // Create Properties for each field in the ChooseAvailableAccessGroupNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailableAccessGroupNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailableAccessGroupNumberPDSAValidator.ColumnNames.DateColumnNameHere);
