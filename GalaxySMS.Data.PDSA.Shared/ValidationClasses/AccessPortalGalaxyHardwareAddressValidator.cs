...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalGalaxyHardwareAddressPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalGalaxyHardwareAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalGalaxyHardwareAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalGalaxyHardwareAddressPDSA</param>
    public AccessPortalGalaxyHardwareAddressPDSAValidator(AccessPortalGalaxyHardwareAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalGalaxyHardwareAddressPDSAValidator";

      // Create Properties for each field in the AccessPortalGalaxyHardwareAddressPDSA entity class
      InitProperties();
    ...
    public AccessPortalGalaxyHardwareAddressPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalGalaxyHardwareAddressPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalGalaxyHardwareAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalGalaxyHardwareAddressPDSAValidator.ColumnNames.DateColumnNameHere);
