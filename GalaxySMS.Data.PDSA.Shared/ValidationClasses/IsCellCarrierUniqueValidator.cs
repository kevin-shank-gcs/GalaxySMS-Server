...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCellCarrierUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCellCarrierUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCellCarrierUniquePDSA</param>
    public IsCellCarrierUniquePDSAValidator(IsCellCarrierUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCellCarrierUniquePDSAValidator";

      // Create Properties for each field in the IsCellCarrierUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCellCarrierUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCellCarrierUniquePDSAValidator.ColumnNames.DateColumnNameHere);
