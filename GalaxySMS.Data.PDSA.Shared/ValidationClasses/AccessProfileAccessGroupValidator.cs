...
{
  /// <summary>
  /// Used to validate business rules on the AccessProfileAccessGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessProfileAccessGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessProfileAccessGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessProfileAccessGroupPDSA</param>
    public AccessProfileAccessGroupPDSAValidator(AccessProfileAccessGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessProfileAccessGroupPDSAValidator";

      // Create Properties for each field in the AccessProfileAccessGroupPDSA entity class
      InitProperties();
    ...
    public AccessProfileAccessGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessProfileAccessGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessProfileAccessGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessProfileAccessGroupPDSAValidator.ColumnNames.DateColumnNameHere);
