...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_CanRowBeDeletedNVarCharPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_CanRowBeDeletedNVarCharPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_CanRowBeDeletedNVarCharPDSA</param>
    public gcs_CanRowBeDeletedNVarCharPDSAValidator(gcs_CanRowBeDeletedNVarCharPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_CanRowBeDeletedNVarCharPDSAValidator";

      // Create Properties for each field in the gcs_CanRowBeDeletedNVarCharPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_CanRowBeDeletedNVarCharPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_CanRowBeDeletedNVarCharPDSAValidator.ColumnNames.DateColumnNameHere);
