...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class UnacknowledgedAlarms_ByDeviceEntityIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UnacknowledgedAlarms_ByDeviceEntityIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UnacknowledgedAlarms_ByDeviceEntityIdPDSA</param>
    public UnacknowledgedAlarms_ByDeviceEntityIdPDSAValidator(UnacknowledgedAlarms_ByDeviceEntityIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UnacknowledgedAlarms_ByDeviceEntityIdPDSAValidator";

      // Create Properties for each field in the UnacknowledgedAlarms_ByDeviceEntityIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UnacknowledgedAlarms_ByDeviceEntityIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UnacknowledgedAlarms_ByDeviceEntityIdPDSAValidator.ColumnNames.DateColumnNameHere);
