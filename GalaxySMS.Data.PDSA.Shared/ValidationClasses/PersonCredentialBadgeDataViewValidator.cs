...
{
  /// <summary>
  /// Used to validate business rules on the PersonCredentialBadgeDataViewPDSA class.
  ...
  /// </summary>
  public partial class PersonCredentialBadgeDataViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonCredentialBadgeDataViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonCredentialBadgeDataViewPDSA</param>
    public PersonCredentialBadgeDataViewPDSAValidator(PersonCredentialBadgeDataViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonCredentialBadgeDataViewPDSAValidator";

      // Create Properties for each field in the PersonCredentialBadgeDataViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A PersonCredentialBadgeDataViewPDSA object</returns>
    public PersonCredentialBadgeDataViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonCredentialBadgeDataViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.DateColumnNameHere);
