...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleOutputDevicePermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleOutputDevicePermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleOutputDevicePermissionUniquePDSA</param>
    public IsRoleOutputDevicePermissionUniquePDSAValidator(IsRoleOutputDevicePermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleOutputDevicePermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleOutputDevicePermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleOutputDevicePermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleOutputDevicePermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
