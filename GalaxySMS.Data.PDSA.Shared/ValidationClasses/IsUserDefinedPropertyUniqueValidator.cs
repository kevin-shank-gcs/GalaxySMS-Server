...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedPropertyUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedPropertyUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedPropertyUniquePDSA</param>
    public IsUserDefinedPropertyUniquePDSAValidator(IsUserDefinedPropertyUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedPropertyUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedPropertyUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedPropertyUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedPropertyUniquePDSAValidator.ColumnNames.DateColumnNameHere);
