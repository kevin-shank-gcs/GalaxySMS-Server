...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSA</param>
    public GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSAValidator(GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSection_GetPanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
