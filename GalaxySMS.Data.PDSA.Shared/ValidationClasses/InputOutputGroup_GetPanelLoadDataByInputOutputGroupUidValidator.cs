...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSA</param>
    public InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSAValidator(InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSAValidator";

      // Create Properties for each field in the InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroup_GetPanelLoadDataByInputOutputGroupUidPDSAValidator.ColumnNames.DateColumnNameHere);
