...
{
  /// <summary>
  /// Used to validate business rules on the CredentialDataLengthPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialDataLengthPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialDataLengthPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialDataLengthPDSA</param>
    public CredentialDataLengthPDSAValidator(CredentialDataLengthPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialDataLengthPDSAValidator";

      // Create Properties for each field in the CredentialDataLengthPDSA entity class
      InitProperties();
    ...
    public CredentialDataLengthPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialDataLengthPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialDataLengthPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialDataLengthPDSAValidator.ColumnNames.DateColumnNameHere);
