...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSA</param>
    public InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSAValidator(InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSAValidator";

      // Create Properties for each field in the InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupUid_GetByGalaxyPanelUidAndIOGroupNumberPDSAValidator.ColumnNames.DateColumnNameHere);
