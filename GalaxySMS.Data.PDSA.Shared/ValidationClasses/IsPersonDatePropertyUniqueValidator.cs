...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonDatePropertyUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonDatePropertyUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonDatePropertyUniquePDSA</param>
    public IsPersonDatePropertyUniquePDSAValidator(IsPersonDatePropertyUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonDatePropertyUniquePDSAValidator";

      // Create Properties for each field in the IsPersonDatePropertyUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonDatePropertyUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonDatePropertyUniquePDSAValidator.ColumnNames.DateColumnNameHere);
