...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonNumberPropertyUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonNumberPropertyUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonNumberPropertyUniquePDSA</param>
    public IsPersonNumberPropertyUniquePDSAValidator(IsPersonNumberPropertyUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonNumberPropertyUniquePDSAValidator";

      // Create Properties for each field in the IsPersonNumberPropertyUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonNumberPropertyUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonNumberPropertyUniquePDSAValidator.ColumnNames.DateColumnNameHere);
