...
{
  /// <summary>
  /// Used to validate business rules on the DayTypeEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class DayTypeEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the DayTypeEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a DayTypeEntityMapPDSA</param>
    public DayTypeEntityMapPDSAValidator(DayTypeEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "DayTypeEntityMapPDSAValidator";

      // Create Properties for each field in the DayTypeEntityMapPDSA entity class
      InitProperties();
    ...
    public DayTypeEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your DayTypeEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(DayTypeEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(DayTypeEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
