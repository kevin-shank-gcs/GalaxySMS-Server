...
{
  /// <summary>
  /// Used to validate business rules on the gcsEntityApplicationPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsEntityApplicationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityApplicationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityApplicationPDSA</param>
    public gcsEntityApplicationPDSAValidator(gcsEntityApplicationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityApplicationPDSAValidator";

      // Create Properties for each field in the gcsEntityApplicationPDSA entity class
      InitProperties();
    ...
    public gcsEntityApplicationPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsEntityApplicationPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityApplicationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityApplicationPDSAValidator.ColumnNames.DateColumnNameHere);
