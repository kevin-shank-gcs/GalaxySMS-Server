...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDeviceUids_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDeviceUids_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDeviceUids_SelectForUserIdPDSA</param>
    public OutputDeviceUids_SelectForUserIdPDSAValidator(OutputDeviceUids_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDeviceUids_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the OutputDeviceUids_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDeviceUids_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDeviceUids_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
