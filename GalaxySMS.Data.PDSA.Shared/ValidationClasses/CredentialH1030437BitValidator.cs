...
{
  /// <summary>
  /// Used to validate business rules on the CredentialH1030437BitPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialH1030437BitPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialH1030437BitPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialH1030437BitPDSA</param>
    public CredentialH1030437BitPDSAValidator(CredentialH1030437BitPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialH1030437BitPDSAValidator";

      // Create Properties for each field in the CredentialH1030437BitPDSA entity class
      InitProperties();
    ...
    public CredentialH1030437BitPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialH1030437BitPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialH1030437BitPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialH1030437BitPDSAValidator.ColumnNames.DateColumnNameHere);
