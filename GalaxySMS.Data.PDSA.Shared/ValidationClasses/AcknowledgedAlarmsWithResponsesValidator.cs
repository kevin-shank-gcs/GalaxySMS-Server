...
{
  /// <summary>
  /// Used to validate business rules on the AcknowledgedAlarmsWithResponsesPDSA class.
  ...
  /// </summary>
  public partial class AcknowledgedAlarmsWithResponsesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarmsWithResponsesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarmsWithResponsesPDSA</param>
    public AcknowledgedAlarmsWithResponsesPDSAValidator(AcknowledgedAlarmsWithResponsesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarmsWithResponsesPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarmsWithResponsesPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AcknowledgedAlarmsWithResponsesPDSA object</returns>
    public AcknowledgedAlarmsWithResponsesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AcknowledgedAlarmsWithResponsesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.DateColumnNameHere);
