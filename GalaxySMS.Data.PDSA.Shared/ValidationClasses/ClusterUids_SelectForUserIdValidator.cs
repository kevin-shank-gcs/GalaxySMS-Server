...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterUids_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterUids_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterUids_SelectForUserIdPDSA</param>
    public ClusterUids_SelectForUserIdPDSAValidator(ClusterUids_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterUids_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the ClusterUids_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterUids_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterUids_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
