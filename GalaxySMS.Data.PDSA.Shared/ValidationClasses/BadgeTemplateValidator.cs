...
{
  /// <summary>
  /// Used to validate business rules on the BadgeTemplatePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class BadgeTemplatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the BadgeTemplatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a BadgeTemplatePDSA</param>
    public BadgeTemplatePDSAValidator(BadgeTemplatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "BadgeTemplatePDSAValidator";

      // Create Properties for each field in the BadgeTemplatePDSA entity class
      InitProperties();
    ...
    public BadgeTemplatePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your BadgeTemplatePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(BadgeTemplatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(BadgeTemplatePDSAValidator.ColumnNames.DateColumnNameHere);
