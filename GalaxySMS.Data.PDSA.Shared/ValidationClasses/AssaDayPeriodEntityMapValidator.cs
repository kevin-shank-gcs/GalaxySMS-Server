...
{
  /// <summary>
  /// Used to validate business rules on the AssaDayPeriodEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AssaDayPeriodEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AssaDayPeriodEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AssaDayPeriodEntityMapPDSA</param>
    public AssaDayPeriodEntityMapPDSAValidator(AssaDayPeriodEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AssaDayPeriodEntityMapPDSAValidator";

      // Create Properties for each field in the AssaDayPeriodEntityMapPDSA entity class
      InitProperties();
    ...
    public AssaDayPeriodEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AssaDayPeriodEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AssaDayPeriodEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AssaDayPeriodEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
