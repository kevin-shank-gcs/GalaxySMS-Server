...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Credential_GetPanelLoadDataChangesByAddressPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_GetPanelLoadDataChangesByAddressPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_GetPanelLoadDataChangesByAddressPDSA</param>
    public Credential_GetPanelLoadDataChangesByAddressPDSAValidator(Credential_GetPanelLoadDataChangesByAddressPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_GetPanelLoadDataChangesByAddressPDSAValidator";

      // Create Properties for each field in the Credential_GetPanelLoadDataChangesByAddressPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_GetPanelLoadDataChangesByAddressPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_GetPanelLoadDataChangesByAddressPDSAValidator.ColumnNames.DateColumnNameHere);
