...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceAlertEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceAlertEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceAlertEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceAlertEventPDSA</param>
    public InputDeviceAlertEventPDSAValidator(InputDeviceAlertEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceAlertEventPDSAValidator";

      // Create Properties for each field in the InputDeviceAlertEventPDSA entity class
      InitProperties();
    ...
    public InputDeviceAlertEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceAlertEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceAlertEventPDSAValidator.ColumnNames.DateColumnNameHere);
