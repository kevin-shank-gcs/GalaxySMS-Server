...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyPanelModelUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyPanelModelUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyPanelModelUniquePDSA</param>
    public IsGalaxyPanelModelUniquePDSAValidator(IsGalaxyPanelModelUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyPanelModelUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyPanelModelUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyPanelModelUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyPanelModelUniquePDSAValidator.ColumnNames.DateColumnNameHere);
