...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class Credential_GetActivityEventDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential_GetActivityEventDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential_GetActivityEventDataPDSA</param>
    public Credential_GetActivityEventDataPDSAValidator(Credential_GetActivityEventDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential_GetActivityEventDataPDSAValidator";

      // Create Properties for each field in the Credential_GetActivityEventDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential_GetActivityEventDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential_GetActivityEventDataPDSAValidator.ColumnNames.DateColumnNameHere);
