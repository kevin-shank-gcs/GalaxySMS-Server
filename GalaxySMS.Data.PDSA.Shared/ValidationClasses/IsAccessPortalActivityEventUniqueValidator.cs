...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalActivityEventUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalActivityEventUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalActivityEventUniquePDSA</param>
    public IsAccessPortalActivityEventUniquePDSAValidator(IsAccessPortalActivityEventUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalActivityEventUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalActivityEventUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalActivityEventUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalActivityEventUniquePDSAValidator.ColumnNames.DateColumnNameHere);
