...
{
  /// <summary>
  /// Used to validate business rules on the InputOutputGroupAssignmentPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputOutputGroupAssignmentPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupAssignmentPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupAssignmentPDSA</param>
    public InputOutputGroupAssignmentPDSAValidator(InputOutputGroupAssignmentPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupAssignmentPDSAValidator";

      // Create Properties for each field in the InputOutputGroupAssignmentPDSA entity class
      InitProperties();
    ...
    public InputOutputGroupAssignmentPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputOutputGroupAssignmentPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupAssignmentPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupAssignmentPDSAValidator.ColumnNames.DateColumnNameHere);
