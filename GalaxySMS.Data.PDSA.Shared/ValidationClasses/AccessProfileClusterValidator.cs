...
{
  /// <summary>
  /// Used to validate business rules on the AccessProfileClusterPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessProfileClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessProfileClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessProfileClusterPDSA</param>
    public AccessProfileClusterPDSAValidator(AccessProfileClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessProfileClusterPDSAValidator";

      // Create Properties for each field in the AccessProfileClusterPDSA entity class
      InitProperties();
    ...
    public AccessProfileClusterPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessProfileClusterPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessProfileClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessProfileClusterPDSAValidator.ColumnNames.DateColumnNameHere);
