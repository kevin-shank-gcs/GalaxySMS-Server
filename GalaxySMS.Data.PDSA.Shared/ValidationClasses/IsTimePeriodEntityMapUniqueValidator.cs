...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsTimePeriodEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsTimePeriodEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsTimePeriodEntityMapUniquePDSA</param>
    public IsTimePeriodEntityMapUniquePDSAValidator(IsTimePeriodEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsTimePeriodEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsTimePeriodEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsTimePeriodEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsTimePeriodEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
