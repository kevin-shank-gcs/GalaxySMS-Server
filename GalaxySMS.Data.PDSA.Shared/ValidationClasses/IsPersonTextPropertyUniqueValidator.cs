...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonTextPropertyUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonTextPropertyUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonTextPropertyUniquePDSA</param>
    public IsPersonTextPropertyUniquePDSAValidator(IsPersonTextPropertyUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonTextPropertyUniquePDSAValidator";

      // Create Properties for each field in the IsPersonTextPropertyUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonTextPropertyUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonTextPropertyUniquePDSAValidator.ColumnNames.DateColumnNameHere);
