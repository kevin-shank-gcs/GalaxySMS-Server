...
{
  /// <summary>
  /// Used to validate business rules on the gcsApplicationSettingPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsApplicationSettingPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsApplicationSettingPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsApplicationSettingPDSA</param>
    public gcsApplicationSettingPDSAValidator(gcsApplicationSettingPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsApplicationSettingPDSAValidator";

      // Create Properties for each field in the gcsApplicationSettingPDSA entity class
      InitProperties();
    ...
    public gcsApplicationSettingPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsApplicationSettingPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsApplicationSettingPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsApplicationSettingPDSAValidator.ColumnNames.DateColumnNameHere);
