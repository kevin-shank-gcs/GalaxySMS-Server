...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalScheduleTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalScheduleTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalScheduleTypeUniquePDSA</param>
    public IsAccessPortalScheduleTypeUniquePDSAValidator(IsAccessPortalScheduleTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalScheduleTypeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalScheduleTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalScheduleTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalScheduleTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
