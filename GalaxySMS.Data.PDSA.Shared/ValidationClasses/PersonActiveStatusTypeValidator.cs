...
{
  /// <summary>
  /// Used to validate business rules on the PersonActiveStatusTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonActiveStatusTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonActiveStatusTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonActiveStatusTypePDSA</param>
    public PersonActiveStatusTypePDSAValidator(PersonActiveStatusTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonActiveStatusTypePDSAValidator";

      // Create Properties for each field in the PersonActiveStatusTypePDSA entity class
      InitProperties();
    ...
    public PersonActiveStatusTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonActiveStatusTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonActiveStatusTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonActiveStatusTypePDSAValidator.ColumnNames.DateColumnNameHere);
