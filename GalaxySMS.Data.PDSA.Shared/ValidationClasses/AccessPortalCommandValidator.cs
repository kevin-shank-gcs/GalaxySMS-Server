...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalCommandPDSA</param>
    public AccessPortalCommandPDSAValidator(AccessPortalCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalCommandPDSAValidator";

      // Create Properties for each field in the AccessPortalCommandPDSA entity class
      InitProperties();
    ...
    public AccessPortalCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalCommandPDSAValidator.ColumnNames.DateColumnNameHere);
