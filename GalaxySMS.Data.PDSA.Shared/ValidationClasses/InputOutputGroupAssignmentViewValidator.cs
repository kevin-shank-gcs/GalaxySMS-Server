...
{
  /// <summary>
  /// Used to validate business rules on the InputOutputGroupAssignmentViewPDSA class.
  ...
  /// </summary>
  public partial class InputOutputGroupAssignmentViewPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupAssignmentViewPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupAssignmentViewPDSA</param>
    public InputOutputGroupAssignmentViewPDSAValidator(InputOutputGroupAssignmentViewPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupAssignmentViewPDSAValidator";

      // Create Properties for each field in the InputOutputGroupAssignmentViewPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A InputOutputGroupAssignmentViewPDSA object</returns>
    public InputOutputGroupAssignmentViewPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputOutputGroupAssignmentViewPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupAssignmentViewPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupAssignmentViewPDSAValidator.ColumnNames.DateColumnNameHere);
