...
{
  /// <summary>
  /// Used to validate business rules on the AcknowledgedAlarmBasicDataPDSA class.
  ...
  /// </summary>
  public partial class AcknowledgedAlarmBasicDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AcknowledgedAlarmBasicDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AcknowledgedAlarmBasicDataPDSA</param>
    public AcknowledgedAlarmBasicDataPDSAValidator(AcknowledgedAlarmBasicDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AcknowledgedAlarmBasicDataPDSAValidator";

      // Create Properties for each field in the AcknowledgedAlarmBasicDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A AcknowledgedAlarmBasicDataPDSA object</returns>
    public AcknowledgedAlarmBasicDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AcknowledgedAlarmBasicDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AcknowledgedAlarmBasicDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AcknowledgedAlarmBasicDataPDSAValidator.ColumnNames.DateColumnNameHere);
