...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserSecurityQuestionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserSecurityQuestionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserSecurityQuestionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserSecurityQuestionPDSA</param>
    public gcsUserSecurityQuestionPDSAValidator(gcsUserSecurityQuestionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserSecurityQuestionPDSAValidator";

      // Create Properties for each field in the gcsUserSecurityQuestionPDSA entity class
      InitProperties();
    ...
    public gcsUserSecurityQuestionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserSecurityQuestionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserSecurityQuestionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserSecurityQuestionPDSAValidator.ColumnNames.DateColumnNameHere);
