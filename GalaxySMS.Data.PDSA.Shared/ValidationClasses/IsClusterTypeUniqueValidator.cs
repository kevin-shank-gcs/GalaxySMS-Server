...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterTypeUniquePDSA</param>
    public IsClusterTypeUniquePDSAValidator(IsClusterTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterTypeUniquePDSAValidator";

      // Create Properties for each field in the IsClusterTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
