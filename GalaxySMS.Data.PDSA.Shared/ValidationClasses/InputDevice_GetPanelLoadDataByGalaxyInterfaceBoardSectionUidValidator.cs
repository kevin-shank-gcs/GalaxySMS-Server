...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA</param>
    public InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator";

      // Create Properties for each field in the InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ColumnNames.DateColumnNameHere);
