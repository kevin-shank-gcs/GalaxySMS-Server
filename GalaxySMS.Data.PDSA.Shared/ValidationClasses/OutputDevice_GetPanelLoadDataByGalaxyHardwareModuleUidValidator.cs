...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA</param>
    public OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyHardwareModuleUidPDSAValidator.ColumnNames.DateColumnNameHere);
