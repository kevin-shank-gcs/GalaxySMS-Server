...
{
  /// <summary>
  /// Used to validate all parameters of the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA
    /// </summary>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA
    /// </summary>
    /// <param name="entityToClone">The AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity to clone</param>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA CloneEntity(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entityToClone)
    {
      AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA newEntity = new AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_GalaxyInterfaceBoardSectionUid_Header", "Galaxy Interface Board Section Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_GalaxyInterfaceBoardSectionUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid).Value = Entity.GalaxyInterfaceBoardSectionUid;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid).IsNull == false)
        Entity.GalaxyInterfaceBoardSectionUid = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid).GetAsGuid();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
