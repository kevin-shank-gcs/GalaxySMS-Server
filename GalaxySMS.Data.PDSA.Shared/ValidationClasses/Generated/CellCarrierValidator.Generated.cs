...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class CellCarrierPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(CellCarrierPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_CellCarrierPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_CellCarrierPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(CellCarrierPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_CellCarrierPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_CellCarrierPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
