...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcs_IsEntityUniquePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcs_IsEntityUniquePDSAValidator.ParameterNames.EntityId, GetResourceMessage("GCS_gcs_IsEntityUniquePDSA_EntityId_Header", "Entity Id"), true, typeof(Guid), 0, GetResourceMessage("GCS_gcs_IsEntityUniquePDSA_EntityId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcs_IsEntityUniquePDSAValidator.ParameterNames.EntityName, GetResourceMessage("GCS_gcs_IsEntityUniquePDSA_EntityName_Header", "Entity Name"), true, typeof(string), 8000, GetResourceMessage("GCS_gcs_IsEntityUniquePDSA_EntityName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(gcs_IsEntityUniquePDSAValidator.ParameterNames.Result, GetResourceMessage("GCS_gcs_IsEntityUniquePDSA_Result_Header", "Result"), true, typeof(int), 0, GetResourceMessage("GCS_gcs_IsEntityUniquePDSA_Result_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
