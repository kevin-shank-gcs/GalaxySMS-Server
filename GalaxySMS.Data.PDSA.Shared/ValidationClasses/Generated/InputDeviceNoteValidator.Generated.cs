...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class InputDeviceNotePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputDeviceNotePDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_InputDeviceNotePDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_InputDeviceNotePDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(InputDeviceNotePDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_InputDeviceNotePDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_InputDeviceNotePDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
