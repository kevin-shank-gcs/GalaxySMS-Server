...
{
  /// <summary>
  /// Used to validate all parameters of the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA
    /// </summary>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA
    /// </summary>
    /// <param name="entityToClone">The AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entity to clone</param>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA CloneEntity(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA entityToClone)
    {
      AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA newEntity = new AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_GalaxyInterfaceBoardSectionNodeUid_Header", "Galaxy Interface Board Section Node Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_GalaxyInterfaceBoardSectionNodeUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid).Value = Entity.GalaxyInterfaceBoardSectionNodeUid;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid).IsNull == false)
        Entity.GalaxyInterfaceBoardSectionNodeUid = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionNodeUid).GetAsGuid();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionNodeUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
