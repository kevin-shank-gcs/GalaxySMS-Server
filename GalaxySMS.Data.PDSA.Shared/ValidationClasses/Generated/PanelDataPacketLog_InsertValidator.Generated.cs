...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class PanelDataPacketLog_InsertPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(PanelDataPacketLog_InsertPDSAValidator.ParameterNames.InsertDate, GetResourceMessage("GCS_PanelDataPacketLog_InsertPDSA_InsertDate_Header", "Insert Date"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_PanelDataPacketLog_InsertPDSA_InsertDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
      props.Add(PDSAProperty.Create(PanelDataPacketLog_InsertPDSAValidator.ParameterNames.UpdateDate, GetResourceMessage("GCS_PanelDataPacketLog_InsertPDSA_UpdateDate_Header", "Update Date"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_PanelDataPacketLog_InsertPDSA_UpdateDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
