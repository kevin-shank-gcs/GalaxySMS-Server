...
{
  /// <summary>
  /// Used to validate all parameters of the AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA
    /// </summary>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA
    /// </summary>
    /// <param name="entityToClone">The AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA entity to clone</param>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA CloneEntity(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA entityToClone)
    {
      AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA newEntity = new AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_CpuUid_Header", "Cpu Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_CpuUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_ServerAddress_Header", "Server Address"), false, typeof(string), 8000, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_ServerAddress_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_IsConnected_Header", "Is Connected"), false, typeof(bool), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_IsConnected_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, false, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataChangesByCpuUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).Value = Entity.CpuUid;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).Value = Entity.ServerAddress;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).Value = Entity.IsConnected;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).IsNull == false)
        Entity.CpuUid = this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.CpuUid).GetAsGuid();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).IsNull == false)
        Entity.ServerAddress = this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.ServerAddress).GetAsString();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).IsNull == false)
        Entity.IsConnected = this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.IsConnected).GetAsBool();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(AccessPortal_GetPanelLoadDataChangesByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
