...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsUserPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.UserId, GetResourceMessage("GCS_gcsUserPDSA_UserId_Header", "User Id"), true, typeof(Guid), -1, GetResourceMessage("GCS_gcsUserPDSA_UserId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.NewGuid(), @"", ""));
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.LanguageId, GetResourceMessage("GCS_gcsUserPDSA_LanguageId_Header", "Language Id"), false, typeof(Guid), -1, GetResourceMessage("GCS_gcsUserPDSA_LanguageId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.NewGuid(), @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.LastLoginDate, GetResourceMessage("GCS_gcsUserPDSA_LastLoginDate_Header", "Last Login Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_gcsUserPDSA_LastLoginDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.LastPasswordResetDate, GetResourceMessage("GCS_gcsUserPDSA_LastPasswordResetDate_Header", "Last Password Reset Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_gcsUserPDSA_LastPasswordResetDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.UserActivationDate, GetResourceMessage("GCS_gcsUserPDSA_UserActivationDate_Header", "User Activation Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_gcsUserPDSA_UserActivationDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.UserExpirationDate, GetResourceMessage("GCS_gcsUserPDSA_UserExpirationDate_Header", "User Expiration Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_gcsUserPDSA_UserExpirationDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsUserPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_gcsUserPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_gcsUserPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_gcsUserPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.PrimaryEntityId, GetResourceMessage("GCS_gcsUserPDSA_PrimaryEntityId_Header", "Primary Entity Id"), true, typeof(Guid), -1, GetResourceMessage("GCS_gcsUserPDSA_PrimaryEntityId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.NewGuid(), @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsUserPDSAValidator.ColumnNames.LockoutEnd, GetResourceMessage("GCS_gcsUserPDSA_LockoutEnd_Header", "Lockout End"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_gcsUserPDSA_LockoutEnd_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, DateTimeOffset.MaxValue, @"", ""));
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.IsLockedOut).IsNull == false)
        Entity.IsLockedOut = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.IsLockedOut).GetValueAsBoolean();
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.IsActive).IsNull == false)
        Entity.IsActive = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.IsActive).GetValueAsBoolean();
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.ResetPasswordFlag).IsNull == false)
        Entity.ResetPasswordFlag = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.ResetPasswordFlag).GetValueAsBoolean();
      ...
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.UserActivationDate).IsNull == false)
        Entity.UserActivationDate = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.UserActivationDate).GetAsDateTimeOffset();
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.UserExpirationDate).IsNull == false)
        Entity.UserExpirationDate = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.UserExpirationDate).GetAsDateTimeOffset();
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.ImportedFromActiveDirectory).IsNull == false)
        Entity.ImportedFromActiveDirectory = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.ImportedFromActiveDirectory).GetValueAsBoolean();
      ...
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.EmailConfirmed).IsNull == false)
        Entity.EmailConfirmed = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.EmailConfirmed).GetValueAsBoolean();
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.LockoutEnabled).IsNull == false)
        Entity.LockoutEnabled = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.LockoutEnabled).GetValueAsBoolean();
      ...
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.PhoneNumberConfirmed).IsNull == false)
        Entity.PhoneNumberConfirmed = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.PhoneNumberConfirmed).GetValueAsBoolean();
      ...
      if(Properties.GetByName(gcsUserPDSAValidator.ColumnNames.TwoFactorEnabled).IsNull == false)
        Entity.TwoFactorEnabled = Properties.GetByName(gcsUserPDSAValidator.ColumnNames.TwoFactorEnabled).GetValueAsBoolean();
