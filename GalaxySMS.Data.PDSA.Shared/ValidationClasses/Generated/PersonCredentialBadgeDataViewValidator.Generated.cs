...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class PersonCredentialBadgeDataViewPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.DateOfBirth, GetResourceMessage("GCS_PersonCredentialBadgeDataViewPDSA_DateOfBirth_Header", "Date Of Birth"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_PersonCredentialBadgeDataViewPDSA_DateOfBirth_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
      ...
      props.Add(PDSAProperty.Create(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.EmploymentDate, GetResourceMessage("GCS_PersonCredentialBadgeDataViewPDSA_EmploymentDate_Header", "Employment Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_PersonCredentialBadgeDataViewPDSA_EmploymentDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
      ...
      props.Add(PDSAProperty.Create(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.TerminationDate, GetResourceMessage("GCS_PersonCredentialBadgeDataViewPDSA_TerminationDate_Header", "Termination Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_PersonCredentialBadgeDataViewPDSA_TerminationDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.DateOfBirth).IsNull == false)
        Entity.DateOfBirth = Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.DateOfBirth).GetAsDateTimeOffset();
      ...
      if(Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.EmploymentDate).IsNull == false)
        Entity.EmploymentDate = Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.EmploymentDate).GetAsDateTimeOffset();
      ...
      if(Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.TerminationDate).IsNull == false)
        Entity.TerminationDate = Properties.GetByName(PersonCredentialBadgeDataViewPDSAValidator.ColumnNames.TerminationDate).GetAsDateTimeOffset();
