...
{
  /// <summary>
  /// Used to validate all parameters of the OutputDevice_GetHardwareInformationPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class OutputDevice_GetHardwareInformationPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private OutputDevice_GetHardwareInformationPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new OutputDevice_GetHardwareInformationPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current OutputDevice_GetHardwareInformationPDSA
    /// </summary>
    /// <returns>A cloned OutputDevice_GetHardwareInformationPDSA object</returns>
    public OutputDevice_GetHardwareInformationPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in OutputDevice_GetHardwareInformationPDSA
    /// </summary>
    /// <param name="entityToClone">The OutputDevice_GetHardwareInformationPDSA entity to clone</param>
    /// <returns>A cloned OutputDevice_GetHardwareInformationPDSA object</returns>
    public OutputDevice_GetHardwareInformationPDSA CloneEntity(OutputDevice_GetHardwareInformationPDSA entityToClone)
    {
      OutputDevice_GetHardwareInformationPDSA newEntity = new OutputDevice_GetHardwareInformationPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.OutputDeviceUid, GetResourceMessage("GCS_OutputDevice_GetHardwareInformationPDSA_OutputDeviceUid_Header", "Output Device Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_OutputDevice_GetHardwareInformationPDSA_OutputDeviceUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_OutputDevice_GetHardwareInformationPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_OutputDevice_GetHardwareInformationPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.OutputDeviceUid).Value = Entity.OutputDeviceUid;
      this.Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.OutputDeviceUid).IsNull == false)
        Entity.OutputDeviceUid = this.Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.OutputDeviceUid).GetAsGuid();
      if(this.Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(OutputDevice_GetHardwareInformationPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
