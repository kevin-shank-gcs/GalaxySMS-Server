...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class AccessGroup_PanelLoadDataChangesForCpuPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ActivationDate, GetResourceMessage("GCS_AccessGroup_PanelLoadDataChangesForCpuPDSA_ActivationDate_Header", "Activation Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_AccessGroup_PanelLoadDataChangesForCpuPDSA_ActivationDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
      props.Add(PDSAProperty.Create(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ExpirationDate, GetResourceMessage("GCS_AccessGroup_PanelLoadDataChangesForCpuPDSA_ExpirationDate_Header", "Expiration Date"), false, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_AccessGroup_PanelLoadDataChangesForCpuPDSA_ExpirationDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ActivationDate).IsNull == false)
        Entity.ActivationDate = Properties.GetByName(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ActivationDate).GetAsDateTimeOffset();
      if(Properties.GetByName(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ExpirationDate).IsNull == false)
        Entity.ExpirationDate = Properties.GetByName(AccessGroup_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ExpirationDate).GetAsDateTimeOffset();
