...
{
  /// <summary>
  /// Used to validate all parameters of the OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA
    /// </summary>
    /// <returns>A cloned OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA object</returns>
    public OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA
    /// </summary>
    /// <param name="entityToClone">The OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity to clone</param>
    /// <returns>A cloned OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA object</returns>
    public OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA CloneEntity(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entityToClone)
    {
      OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA newEntity = new OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_GalaxyInterfaceBoardSectionUid_Header", "Galaxy Interface Board Section Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_GalaxyInterfaceBoardSectionUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid).Value = Entity.GalaxyInterfaceBoardSectionUid;
      this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid).IsNull == false)
        Entity.GalaxyInterfaceBoardSectionUid = this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.GalaxyInterfaceBoardSectionUid).GetAsGuid();
      if(this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
