...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsAuditPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsAuditPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsAuditPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_gcsAuditPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
