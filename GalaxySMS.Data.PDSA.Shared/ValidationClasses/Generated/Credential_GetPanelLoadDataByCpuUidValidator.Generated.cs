...
{
  /// <summary>
  /// Used to validate all parameters of the Credential_GetPanelLoadDataByCpuUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class Credential_GetPanelLoadDataByCpuUidPDSAValidator : PDSAValidatorBase
  {
    ...
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new Credential_GetPanelLoadDataByCpuUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current Credential_GetPanelLoadDataByCpuUidPDSA
    /// </summary>
    /// <returns>A cloned Credential_GetPanelLoadDataByCpuUidPDSA object</returns>
    public Credential_GetPanelLoadDataByCpuUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in Credential_GetPanelLoadDataByCpuUidPDSA
    /// </summary>
    /// <param name="entityToClone">The Credential_GetPanelLoadDataByCpuUidPDSA entity to clone</param>
    /// <returns>A cloned Credential_GetPanelLoadDataByCpuUidPDSA object</returns>
    public Credential_GetPanelLoadDataByCpuUidPDSA CloneEntity(Credential_GetPanelLoadDataByCpuUidPDSA entityToClone)
    {
      Credential_GetPanelLoadDataByCpuUidPDSA newEntity = new Credential_GetPanelLoadDataByCpuUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.CpuUid, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCpuUidPDSA_CpuUid_Header", "Cpu Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCpuUidPDSA_CpuUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCpuUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_Credential_GetPanelLoadDataByCpuUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.CpuUid).Value = Entity.CpuUid;
      this.Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.CpuUid).IsNull == false)
        Entity.CpuUid = this.Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.CpuUid).GetAsGuid();
      if(this.Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(Credential_GetPanelLoadDataByCpuUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
