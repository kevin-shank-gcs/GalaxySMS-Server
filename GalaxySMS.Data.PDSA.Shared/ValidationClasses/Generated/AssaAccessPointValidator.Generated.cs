...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class AssaAccessPointPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AssaAccessPointPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_AssaAccessPointPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_AssaAccessPointPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(AssaAccessPointPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_AssaAccessPointPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_AssaAccessPointPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
