...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcs_IsUserUniquePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcs_IsUserUniquePDSAValidator.ParameterNames.UserId, GetResourceMessage("GCS_gcs_IsUserUniquePDSA_UserId_Header", "User Id"), true, typeof(Guid), 0, GetResourceMessage("GCS_gcs_IsUserUniquePDSA_UserId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
