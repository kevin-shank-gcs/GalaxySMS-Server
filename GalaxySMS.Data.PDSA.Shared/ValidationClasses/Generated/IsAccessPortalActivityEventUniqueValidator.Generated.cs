...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class IsAccessPortalActivityEventUniquePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(IsAccessPortalActivityEventUniquePDSAValidator.ParameterNames.ActivityDateTime, GetResourceMessage("GCS_IsAccessPortalActivityEventUniquePDSA_ActivityDateTime_Header", "Activity Date Time"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_IsAccessPortalActivityEventUniquePDSA_ActivityDateTime_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
