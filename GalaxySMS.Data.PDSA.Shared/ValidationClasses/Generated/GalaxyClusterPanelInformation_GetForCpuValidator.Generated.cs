...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class GalaxyClusterPanelInformation_GetForCpuPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(GalaxyClusterPanelInformation_GetForCpuPDSAValidator.ParameterNames.ClusterGroupId, GetResourceMessage("GCS_GalaxyClusterPanelInformation_GetForCpuPDSA_AccountCode_Header", "Account Code"), false, typeof(string), 8000, GetResourceMessage("GCS_GalaxyClusterPanelInformation_GetForCpuPDSA_AccountCode_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
