...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class AreaPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AreaPDSAValidator.ColumnNames.AreaUid, GetResourceMessage("GCS_AreaPDSA_AreaUid_Header", "Area Uid"), true, typeof(Guid), -1, GetResourceMessage("GCS_AreaPDSA_AreaUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.NewGuid(), @"", ""));
      props.Add(PDSAProperty.Create(AreaPDSAValidator.ColumnNames.ClusterUid, GetResourceMessage("GCS_AreaPDSA_ClusterUid_Header", "Cluster Uid"), true, typeof(Guid), -1, GetResourceMessage("GCS_AreaPDSA_ClusterUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.NewGuid(), @"", ""));
      props.Add(PDSAProperty.Create(AreaPDSAValidator.ColumnNames.DisplayResourceKey, GetResourceMessage("GCS_AreaPDSA_DisplayResourceKey_Header", "Display Resource Key"), false, typeof(Guid), -1, GetResourceMessage("GCS_AreaPDSA_DisplayResourceKey_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.NewGuid(), @"", ""));
      ...
      props.Add(PDSAProperty.Create(AreaPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_AreaPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_AreaPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(AreaPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_AreaPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_AreaPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(AreaPDSAValidator.ColumnNames.EntityId, GetResourceMessage("GCS_AreaPDSA_EntityId_Header", "Entity Id"), false, typeof(Guid), -1, GetResourceMessage("GCS_AreaPDSA_EntityId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.NewGuid(), @"", ""));
