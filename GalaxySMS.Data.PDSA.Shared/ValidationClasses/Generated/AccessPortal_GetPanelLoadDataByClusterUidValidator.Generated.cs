...
{
  /// <summary>
  /// Used to validate all parameters of the AccessPortal_GetPanelLoadDataByClusterUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator : PDSAValidatorBase
  {
    ...
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new AccessPortal_GetPanelLoadDataByClusterUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current AccessPortal_GetPanelLoadDataByClusterUidPDSA
    /// </summary>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByClusterUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByClusterUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in AccessPortal_GetPanelLoadDataByClusterUidPDSA
    /// </summary>
    /// <param name="entityToClone">The AccessPortal_GetPanelLoadDataByClusterUidPDSA entity to clone</param>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByClusterUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByClusterUidPDSA CloneEntity(AccessPortal_GetPanelLoadDataByClusterUidPDSA entityToClone)
    {
      AccessPortal_GetPanelLoadDataByClusterUidPDSA newEntity = new AccessPortal_GetPanelLoadDataByClusterUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByClusterUidPDSA_ClusterUid_Header", "Cluster Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByClusterUidPDSA_ClusterUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByClusterUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByClusterUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid).Value = Entity.ClusterUid;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid).IsNull == false)
        Entity.ClusterUid = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.ClusterUid).GetAsGuid();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByClusterUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
        
    #region ColumnNames Class
    /// <summary>
    /// Contains static string properties that represent the name of each property in the AccessPortal_GetPanelLoadDataByClusterUidPDSA class.
