  ...
  public partial class IsTimePeriodUniquePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(IsTimePeriodUniquePDSAValidator.ParameterNames.Name, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_Name_Header", "Name"), false, typeof(string), 8000, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_Name_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
            //props.Add(PDSAProperty.Create(IsTimePeriodUniquePDSAValidator.ParameterNames.StartTime, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_StartTime_Header", "Start Time"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_StartTime_Req", PDSAValidationMessages.MustBeFilledIn), PDSAProperty.ConvertToTimeSpan("1753-01-01 00:00:00"), PDSAProperty.ConvertToTimeSpan("9999-12-31 23:59:59"), 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
            //props.Add(PDSAProperty.Create(IsTimePeriodUniquePDSAValidator.ParameterNames.EndTime, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_EndTime_Header", "End Time"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_EndTime_Req", PDSAValidationMessages.MustBeFilledIn), PDSAProperty.ConvertToTimeSpan("1753-01-01 00:00:00"), PDSAProperty.ConvertToTimeSpan("9999-12-31 23:59:59"), 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
            props.Add(PDSAProperty.Create(IsTimePeriodUniquePDSAValidator.ParameterNames.StartTime, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_StartTime_Header", "Start Time"), false, typeof(TimeSpan), 0, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_StartTime_Req", PDSAValidationMessages.MustBeFilledIn), PDSAProperty.ConvertToTimeSpan("1753-01-01 00:00:00"), PDSAProperty.ConvertToTimeSpan("9999-12-31 23:59:59"), 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
            props.Add(PDSAProperty.Create(IsTimePeriodUniquePDSAValidator.ParameterNames.EndTime, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_EndTime_Header", "End Time"), false, typeof(TimeSpan), 0, GetResourceMessage("GCS_IsTimePeriodUniquePDSA_EndTime_Req", PDSAValidationMessages.MustBeFilledIn), PDSAProperty.ConvertToTimeSpan("1753-01-01 00:00:00"), PDSAProperty.ConvertToTimeSpan("9999-12-31 23:59:59"), 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
