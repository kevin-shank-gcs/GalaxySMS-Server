...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class DateTypeDefaultBehaviorPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid, GetResourceMessage("GCS_DateTypeDefaultBehaviorPDSA_DateTypeDefaultBehaviorUid_Header", "Date Type Default Behavior Uid"), true, typeof(Guid), -1, GetResourceMessage("GCS_DateTypeDefaultBehaviorPDSA_DateTypeDefaultBehaviorUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      if(!Properties.GetByName(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).SetAsNull)
        Properties.GetByName(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).Value = Entity.DateTypeDefaultBehaviorUid;
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(Properties.GetByName(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).IsNull == false)
        Entity.DateTypeDefaultBehaviorUid = Properties.GetByName(DateTypeDefaultBehaviorPDSAValidator.ColumnNames.DateTypeDefaultBehaviorUid).GetAsGuid();
