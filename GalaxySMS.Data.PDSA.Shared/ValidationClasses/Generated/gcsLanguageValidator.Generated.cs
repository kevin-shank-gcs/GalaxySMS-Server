...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsLanguagePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsLanguagePDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsLanguagePDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_gcsLanguagePDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsLanguagePDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_gcsLanguagePDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_gcsLanguagePDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
