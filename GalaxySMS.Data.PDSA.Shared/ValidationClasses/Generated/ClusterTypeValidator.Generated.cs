...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class ClusterTypePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(ClusterTypePDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_ClusterTypePDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_ClusterTypePDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(ClusterTypePDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_ClusterTypePDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_ClusterTypePDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
