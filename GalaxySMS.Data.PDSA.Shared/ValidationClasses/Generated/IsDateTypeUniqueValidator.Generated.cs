...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class IsDateTypeUniquePDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(IsDateTypeUniquePDSAValidator.ParameterNames.Date, GetResourceMessage("GCS_IsDateTypeUniquePDSA_Date_Header", "Date"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_IsDateTypeUniquePDSA_Date_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
