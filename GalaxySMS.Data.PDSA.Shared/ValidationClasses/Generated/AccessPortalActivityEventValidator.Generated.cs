...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class AccessPortalActivityEventPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortalActivityEventPDSAValidator.ColumnNames.ActivityDateTime, GetResourceMessage("GCS_AccessPortalActivityEventPDSA_ActivityDateTime_Header", "Activity Date Time"), true, typeof(DateTimeOffset), -1, GetResourceMessage("GCS_AccessPortalActivityEventPDSA_ActivityDateTime_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, DateTimeOffset.Now, @"", ""));
