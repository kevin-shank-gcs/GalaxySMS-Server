...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class InputOutputGroupPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(InputOutputGroupPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_InputOutputGroupPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_InputOutputGroupPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(InputOutputGroupPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_InputOutputGroupPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_InputOutputGroupPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(InputOutputGroupPDSAValidator.ColumnNames.EntityId, GetResourceMessage("GCS_InputOutputGroupPDSA_EntityId_Header", "Entity Id"), false, typeof(Guid), 2147483647, GetResourceMessage("GCS_InputOutputGroupPDSA_EntityId_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(InputOutputGroupPDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_InputOutputGroupPDSA_AccountCode_Header", "Account Code"), false, typeof(string), 2147483647, GetResourceMessage("GCS_InputOutputGroupPDSA_AccountCode_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      props.Add(PDSAProperty.Create(InputOutputGroupPDSAValidator.ColumnNames.ClusterNumber, GetResourceMessage("GCS_InputOutputGroupPDSA_ClusterNumber_Header", "Cluster Number"), false, typeof(int), 2147483647, GetResourceMessage("GCS_InputOutputGroupPDSA_ClusterNumber_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
