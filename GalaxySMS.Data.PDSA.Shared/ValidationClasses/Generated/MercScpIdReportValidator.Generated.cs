...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class MercScpIdReportPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(MercScpIdReportPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_MercScpIdReportPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_MercScpIdReportPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(MercScpIdReportPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_MercScpIdReportPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_MercScpIdReportPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
