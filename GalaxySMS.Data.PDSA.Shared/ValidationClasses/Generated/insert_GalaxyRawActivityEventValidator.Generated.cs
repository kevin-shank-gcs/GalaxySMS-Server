...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class insert_GalaxyRawActivityEventPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(insert_GalaxyRawActivityEventPDSAValidator.ParameterNames.InsertDate, GetResourceMessage("GCS_insert_GalaxyRawActivityEventPDSA_InsertDate_Header", "Insert Date"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_insert_GalaxyRawActivityEventPDSA_InsertDate_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
      props.Add(PDSAProperty.Create(insert_GalaxyRawActivityEventPDSAValidator.ParameterNames.ClusterGroupId, GetResourceMessage("GCS_insert_GalaxyRawActivityEventPDSA_AccountCode_Header", "Account Code"), false, typeof(string), 8000, GetResourceMessage("GCS_insert_GalaxyRawActivityEventPDSA_AccountCode_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(insert_GalaxyRawActivityEventPDSAValidator.ParameterNames.EventDateTime, GetResourceMessage("GCS_insert_GalaxyRawActivityEventPDSA_EventDateTime_Header", "Event Date Time"), false, typeof(DateTimeOffset), 0, GetResourceMessage("GCS_insert_GalaxyRawActivityEventPDSA_EventDateTime_Req", PDSAValidationMessages.MustBeFilledIn), DateTimeOffset.MinValue, DateTimeOffset.MaxValue, 0, Convert.ToDateTime("1753-1-1", System.Threading.Thread.CurrentThread.CurrentUICulture.DateTimeFormat), @"", ""));
