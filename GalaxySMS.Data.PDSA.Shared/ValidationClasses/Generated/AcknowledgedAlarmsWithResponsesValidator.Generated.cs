...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class AcknowledgedAlarmsWithResponsesPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AcknowledgedAlarmsWithResponsesPDSAValidator.ColumnNames.ClusterGroupId, GetResourceMessage("GCS_AcknowledgedAlarmsWithResponsesPDSA_AccountCode_Header", "Account Code"), false, typeof(string), 16, GetResourceMessage("GCS_AcknowledgedAlarmsWithResponsesPDSA_AccountCode_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
