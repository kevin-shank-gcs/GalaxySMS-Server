...
namespace GalaxySMS.ValidationLayer
{
  ...
  public partial class gcsApplicationPDSAValidator : PDSAValidatorBase
  {
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(gcsApplicationPDSAValidator.ColumnNames.InsertName, GetResourceMessage("GCS_gcsApplicationPDSA_InsertName_Header", "Insert Name"), true, typeof(string), 50, GetResourceMessage("GCS_gcsApplicationPDSA_InsertName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
      ...
      props.Add(PDSAProperty.Create(gcsApplicationPDSAValidator.ColumnNames.UpdateName, GetResourceMessage("GCS_gcsApplicationPDSA_UpdateName_Header", "Update Name"), true, typeof(string), 50, GetResourceMessage("GCS_gcsApplicationPDSA_UpdateName_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, string.Empty, @"", ""));
