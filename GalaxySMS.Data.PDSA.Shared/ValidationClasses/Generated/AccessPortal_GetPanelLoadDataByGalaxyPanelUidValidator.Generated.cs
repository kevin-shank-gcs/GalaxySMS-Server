...
{
  /// <summary>
  /// Used to validate all parameters of the AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA class.
  /// This class is generated using the Haystack Code Generator for .NET.
  /// You should NOT modify this class as it is intended to be re-generated.
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator : PDSAValidatorBase
  {
    #region Public Entity Property
    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    private AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA _Entity = null;

    /// <summary>
    /// Get/Set the Entity class with the properties to validate
    /// </summary>
    public new AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA Entity
    {
      get { return _Entity; }
      set
      {
    ...
    /// <summary>
    /// Clones the current AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA
    /// </summary>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA CloneEntity()
    {
      return CloneEntity(this.Entity);
    }
    
    /// <summary>
    /// Clones the passed in AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA
    /// </summary>
    /// <param name="entityToClone">The AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA entity to clone</param>
    /// <returns>A cloned AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA object</returns>
    public AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA CloneEntity(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA entityToClone)
    {
      AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA newEntity = new AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA();
    ...
    public override PDSAProperties CreateProperties()
    {
      ...
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA_GalaxyPanelUid_Header", "Galaxy Panel Uid"), false, typeof(Guid), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA_GalaxyPanelUid_Req", PDSAValidationMessages.MustBeFilledIn), null, null, 0, Guid.Empty, @"", ""));
      props.Add(PDSAProperty.Create(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA_RETURNVALUE_Header", "return value"), false, typeof(int), 0, GetResourceMessage("GCS_AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSA_RETURNVALUE_Req", PDSAValidationMessages.MustBeFilledIn), Convert.ToInt32("-2147483648"), Convert.ToInt32("2147483647"), 0, 0, @"", ""));
    ...
    protected override void EntityDataToProperties()
    {
      ...
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid).Value = Entity.GalaxyPanelUid;
      this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE).Value = Entity.RETURNVALUE;
    }
    ...
    protected override void PropertiesToEntityData()
    {
      ...
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid).IsNull == false)
        Entity.GalaxyPanelUid = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.GalaxyPanelUid).GetAsGuid();
      if(this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE).IsNull == false)
        Entity.RETURNVALUE = this.Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ParameterNames.RETURNVALUE).GetAsInteger();
    }
    #endregion
