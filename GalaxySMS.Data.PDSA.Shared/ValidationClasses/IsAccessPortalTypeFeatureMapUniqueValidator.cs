...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalTypeFeatureMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalTypeFeatureMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalTypeFeatureMapUniquePDSA</param>
    public IsAccessPortalTypeFeatureMapUniquePDSAValidator(IsAccessPortalTypeFeatureMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalTypeFeatureMapUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalTypeFeatureMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalTypeFeatureMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalTypeFeatureMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
