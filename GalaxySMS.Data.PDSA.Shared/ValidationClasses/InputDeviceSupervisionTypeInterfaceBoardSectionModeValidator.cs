...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceSupervisionTypeInterfaceBoardSectionModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceSupervisionTypeInterfaceBoardSectionModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceSupervisionTypeInterfaceBoardSectionModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceSupervisionTypeInterfaceBoardSectionModePDSA</param>
    public InputDeviceSupervisionTypeInterfaceBoardSectionModePDSAValidator(InputDeviceSupervisionTypeInterfaceBoardSectionModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceSupervisionTypeInterfaceBoardSectionModePDSAValidator";

      // Create Properties for each field in the InputDeviceSupervisionTypeInterfaceBoardSectionModePDSA entity class
      InitProperties();
    ...
    public InputDeviceSupervisionTypeInterfaceBoardSectionModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceSupervisionTypeInterfaceBoardSectionModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceSupervisionTypeInterfaceBoardSectionModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceSupervisionTypeInterfaceBoardSectionModePDSAValidator.ColumnNames.DateColumnNameHere);
