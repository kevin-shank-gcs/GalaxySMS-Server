...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalAreaPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalAreaPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalAreaPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalAreaPDSA</param>
    public AccessPortalAreaPDSAValidator(AccessPortalAreaPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalAreaPDSAValidator";

      // Create Properties for each field in the AccessPortalAreaPDSA entity class
      InitProperties();
    ...
    public AccessPortalAreaPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalAreaPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalAreaPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalAreaPDSAValidator.ColumnNames.DateColumnNameHere);
