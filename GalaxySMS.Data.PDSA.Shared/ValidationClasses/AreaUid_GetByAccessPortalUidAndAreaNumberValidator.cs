...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AreaUid_GetByAccessPortalUidAndAreaNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AreaUid_GetByAccessPortalUidAndAreaNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AreaUid_GetByAccessPortalUidAndAreaNumberPDSA</param>
    public AreaUid_GetByAccessPortalUidAndAreaNumberPDSAValidator(AreaUid_GetByAccessPortalUidAndAreaNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AreaUid_GetByAccessPortalUidAndAreaNumberPDSAValidator";

      // Create Properties for each field in the AreaUid_GetByAccessPortalUidAndAreaNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AreaUid_GetByAccessPortalUidAndAreaNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AreaUid_GetByAccessPortalUidAndAreaNumberPDSAValidator.ColumnNames.DateColumnNameHere);
