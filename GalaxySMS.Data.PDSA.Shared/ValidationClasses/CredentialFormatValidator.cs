...
{
  /// <summary>
  /// Used to validate business rules on the CredentialFormatPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class CredentialFormatPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the CredentialFormatPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a CredentialFormatPDSA</param>
    public CredentialFormatPDSAValidator(CredentialFormatPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "CredentialFormatPDSAValidator";

      // Create Properties for each field in the CredentialFormatPDSA entity class
      InitProperties();
    ...
    public CredentialFormatPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your CredentialFormatPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(CredentialFormatPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(CredentialFormatPDSAValidator.ColumnNames.DateColumnNameHere);
