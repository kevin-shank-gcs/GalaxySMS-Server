...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyActivityEventTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyActivityEventTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyActivityEventTypeUniquePDSA</param>
    public IsGalaxyActivityEventTypeUniquePDSAValidator(IsGalaxyActivityEventTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyActivityEventTypeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyActivityEventTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyActivityEventTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyActivityEventTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
