...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyTimePeriodUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyTimePeriodUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyTimePeriodUniquePDSA</param>
    public IsGalaxyTimePeriodUniquePDSAValidator(IsGalaxyTimePeriodUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyTimePeriodUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyTimePeriodUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyTimePeriodUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyTimePeriodUniquePDSAValidator.ColumnNames.DateColumnNameHere);
