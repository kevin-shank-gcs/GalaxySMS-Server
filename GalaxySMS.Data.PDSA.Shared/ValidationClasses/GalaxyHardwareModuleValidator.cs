...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyHardwareModulePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyHardwareModulePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyHardwareModulePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyHardwareModulePDSA</param>
    public GalaxyHardwareModulePDSAValidator(GalaxyHardwareModulePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyHardwareModulePDSAValidator";

      // Create Properties for each field in the GalaxyHardwareModulePDSA entity class
      InitProperties();
    ...
    public GalaxyHardwareModulePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyHardwareModulePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyHardwareModulePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyHardwareModulePDSAValidator.ColumnNames.DateColumnNameHere);
