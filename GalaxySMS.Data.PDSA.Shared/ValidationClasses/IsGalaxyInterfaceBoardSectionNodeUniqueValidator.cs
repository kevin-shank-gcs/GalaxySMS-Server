...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInterfaceBoardSectionNodeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInterfaceBoardSectionNodeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInterfaceBoardSectionNodeUniquePDSA</param>
    public IsGalaxyInterfaceBoardSectionNodeUniquePDSAValidator(IsGalaxyInterfaceBoardSectionNodeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInterfaceBoardSectionNodeUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInterfaceBoardSectionNodeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionNodeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInterfaceBoardSectionNodeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
