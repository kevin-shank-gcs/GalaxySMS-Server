...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsBrandUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsBrandUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsBrandUniquePDSA</param>
    public IsBrandUniquePDSAValidator(IsBrandUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsBrandUniquePDSAValidator";

      // Create Properties for each field in the IsBrandUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsBrandUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsBrandUniquePDSAValidator.ColumnNames.DateColumnNameHere);
