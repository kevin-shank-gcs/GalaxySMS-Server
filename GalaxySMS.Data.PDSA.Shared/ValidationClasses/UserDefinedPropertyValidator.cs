...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedPropertyPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedPropertyPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedPropertyPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedPropertyPDSA</param>
    public UserDefinedPropertyPDSAValidator(UserDefinedPropertyPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedPropertyPDSAValidator";

      // Create Properties for each field in the UserDefinedPropertyPDSA entity class
      InitProperties();
    ...
    public UserDefinedPropertyPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedPropertyPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedPropertyPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedPropertyPDSAValidator.ColumnNames.DateColumnNameHere);
