...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelActivityEventPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelActivityEventPDSA</param>
    public GalaxyPanelActivityEventPDSAValidator(GalaxyPanelActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelActivityEventPDSAValidator";

      // Create Properties for each field in the GalaxyPanelActivityEventPDSA entity class
      InitProperties();
    ...
    public GalaxyPanelActivityEventPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelActivityEventPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
