...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelModelInterfaceBoardTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelModelInterfaceBoardTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelModelInterfaceBoardTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelModelInterfaceBoardTypePDSA</param>
    public GalaxyPanelModelInterfaceBoardTypePDSAValidator(GalaxyPanelModelInterfaceBoardTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelModelInterfaceBoardTypePDSAValidator";

      // Create Properties for each field in the GalaxyPanelModelInterfaceBoardTypePDSA entity class
      InitProperties();
    ...
    public GalaxyPanelModelInterfaceBoardTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelModelInterfaceBoardTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelModelInterfaceBoardTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelModelInterfaceBoardTypePDSAValidator.ColumnNames.DateColumnNameHere);
