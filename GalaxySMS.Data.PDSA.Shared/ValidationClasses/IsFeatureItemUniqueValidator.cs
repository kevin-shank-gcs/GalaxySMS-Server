...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsFeatureItemUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsFeatureItemUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsFeatureItemUniquePDSA</param>
    public IsFeatureItemUniquePDSAValidator(IsFeatureItemUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsFeatureItemUniquePDSAValidator";

      // Create Properties for each field in the IsFeatureItemUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsFeatureItemUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsFeatureItemUniquePDSAValidator.ColumnNames.DateColumnNameHere);
