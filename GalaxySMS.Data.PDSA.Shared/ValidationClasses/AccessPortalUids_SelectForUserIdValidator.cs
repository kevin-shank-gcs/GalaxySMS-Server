...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortalUids_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalUids_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalUids_SelectForUserIdPDSA</param>
    public AccessPortalUids_SelectForUserIdPDSAValidator(AccessPortalUids_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalUids_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the AccessPortalUids_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalUids_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalUids_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
