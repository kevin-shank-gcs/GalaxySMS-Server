...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSA</param>
    public gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSAValidator(gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSAValidator";

      // Create Properties for each field in the gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_SelectEntityApplicationRoleId_ByEntityApplicationAndRoleIdsPDSAValidator.ColumnNames.DateColumnNameHere);
