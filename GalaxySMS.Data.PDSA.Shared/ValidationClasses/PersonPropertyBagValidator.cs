...
{
  /// <summary>
  /// Used to validate business rules on the PersonPropertyBagPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonPropertyBagPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonPropertyBagPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonPropertyBagPDSA</param>
    public PersonPropertyBagPDSAValidator(PersonPropertyBagPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonPropertyBagPDSAValidator";

      // Create Properties for each field in the PersonPropertyBagPDSA entity class
      InitProperties();
    ...
    public PersonPropertyBagPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonPropertyBagPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonPropertyBagPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonPropertyBagPDSAValidator.ColumnNames.DateColumnNameHere);
