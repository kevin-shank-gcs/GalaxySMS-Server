...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyPanelModelInterfaceBoardSectionModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyPanelModelInterfaceBoardSectionModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyPanelModelInterfaceBoardSectionModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyPanelModelInterfaceBoardSectionModePDSA</param>
    public GalaxyPanelModelInterfaceBoardSectionModePDSAValidator(GalaxyPanelModelInterfaceBoardSectionModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyPanelModelInterfaceBoardSectionModePDSAValidator";

      // Create Properties for each field in the GalaxyPanelModelInterfaceBoardSectionModePDSA entity class
      InitProperties();
    ...
    public GalaxyPanelModelInterfaceBoardSectionModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyPanelModelInterfaceBoardSectionModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyPanelModelInterfaceBoardSectionModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyPanelModelInterfaceBoardSectionModePDSAValidator.ColumnNames.DateColumnNameHere);
