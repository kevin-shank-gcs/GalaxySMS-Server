...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertAccessPortalCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertAccessPortalCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertAccessPortalCountPDSA</param>
    public gcsEntityCountPDSA_InsertAccessPortalCountPDSAValidator(gcsEntityCountPDSA_InsertAccessPortalCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertAccessPortalCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertAccessPortalCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessPortalCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertAccessPortalCountPDSAValidator.ColumnNames.DateColumnNameHere);
