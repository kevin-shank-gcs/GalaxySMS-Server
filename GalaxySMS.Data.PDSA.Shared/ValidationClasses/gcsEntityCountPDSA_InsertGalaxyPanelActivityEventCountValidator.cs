...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSA</param>
    public gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSAValidator(gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertGalaxyPanelActivityEventCountPDSAValidator.ColumnNames.DateColumnNameHere);
