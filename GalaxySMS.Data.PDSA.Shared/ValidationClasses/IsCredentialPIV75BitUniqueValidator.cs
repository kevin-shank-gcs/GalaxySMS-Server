...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialPIV75BitUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialPIV75BitUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialPIV75BitUniquePDSA</param>
    public IsCredentialPIV75BitUniquePDSAValidator(IsCredentialPIV75BitUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialPIV75BitUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialPIV75BitUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialPIV75BitUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialPIV75BitUniquePDSAValidator.ColumnNames.DateColumnNameHere);
