...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputDeviceEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputDeviceEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputDeviceEntityMapUniquePDSA</param>
    public IsInputDeviceEntityMapUniquePDSAValidator(IsInputDeviceEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputDeviceEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsInputDeviceEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputDeviceEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputDeviceEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
