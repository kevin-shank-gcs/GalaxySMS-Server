...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaDsrEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaDsrEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaDsrEntityMapUniquePDSA</param>
    public IsAssaDsrEntityMapUniquePDSAValidator(IsAssaDsrEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaDsrEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsAssaDsrEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaDsrEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaDsrEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
