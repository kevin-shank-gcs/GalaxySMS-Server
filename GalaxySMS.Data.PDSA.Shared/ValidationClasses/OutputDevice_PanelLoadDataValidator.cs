...
{
  /// <summary>
  /// Used to validate business rules on the OutputDevice_PanelLoadDataPDSA class.
  ...
  /// </summary>
  public partial class OutputDevice_PanelLoadDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_PanelLoadDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_PanelLoadDataPDSA</param>
    public OutputDevice_PanelLoadDataPDSAValidator(OutputDevice_PanelLoadDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_PanelLoadDataPDSAValidator";

      // Create Properties for each field in the OutputDevice_PanelLoadDataPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A OutputDevice_PanelLoadDataPDSA object</returns>
    public OutputDevice_PanelLoadDataPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputDevice_PanelLoadDataPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_PanelLoadDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_PanelLoadDataPDSAValidator.ColumnNames.DateColumnNameHere);
