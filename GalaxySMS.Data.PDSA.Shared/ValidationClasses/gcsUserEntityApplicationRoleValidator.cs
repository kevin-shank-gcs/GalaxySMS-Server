...
{
  /// <summary>
  /// Used to validate business rules on the gcsUserEntityApplicationRolePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class gcsUserEntityApplicationRolePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsUserEntityApplicationRolePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsUserEntityApplicationRolePDSA</param>
    public gcsUserEntityApplicationRolePDSAValidator(gcsUserEntityApplicationRolePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsUserEntityApplicationRolePDSAValidator";

      // Create Properties for each field in the gcsUserEntityApplicationRolePDSA entity class
      InitProperties();
    ...
    public gcsUserEntityApplicationRolePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your gcsUserEntityApplicationRolePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsUserEntityApplicationRolePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsUserEntityApplicationRolePDSAValidator.ColumnNames.DateColumnNameHere);
