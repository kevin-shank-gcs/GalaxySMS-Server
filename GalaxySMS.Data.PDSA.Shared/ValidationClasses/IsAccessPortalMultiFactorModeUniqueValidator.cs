...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessPortalMultiFactorModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessPortalMultiFactorModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessPortalMultiFactorModeUniquePDSA</param>
    public IsAccessPortalMultiFactorModeUniquePDSAValidator(IsAccessPortalMultiFactorModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessPortalMultiFactorModeUniquePDSAValidator";

      // Create Properties for each field in the IsAccessPortalMultiFactorModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessPortalMultiFactorModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessPortalMultiFactorModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
