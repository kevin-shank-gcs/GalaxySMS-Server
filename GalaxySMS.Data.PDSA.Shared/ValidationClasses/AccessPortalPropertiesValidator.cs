...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalPropertiesPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalPropertiesPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalPropertiesPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalPropertiesPDSA</param>
    public AccessPortalPropertiesPDSAValidator(AccessPortalPropertiesPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalPropertiesPDSAValidator";

      // Create Properties for each field in the AccessPortalPropertiesPDSA entity class
      InitProperties();
    ...
    public AccessPortalPropertiesPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalPropertiesPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalPropertiesPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalPropertiesPDSAValidator.ColumnNames.DateColumnNameHere);
