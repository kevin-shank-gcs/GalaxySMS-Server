...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA</param>
    public OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator(OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator";

      // Create Properties for each field in the OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_GetPanelLoadDataByGalaxyPanelUidPDSAValidator.ColumnNames.DateColumnNameHere);
