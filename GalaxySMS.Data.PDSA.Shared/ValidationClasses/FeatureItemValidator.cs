...
{
  /// <summary>
  /// Used to validate business rules on the FeatureItemPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class FeatureItemPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the FeatureItemPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a FeatureItemPDSA</param>
    public FeatureItemPDSAValidator(FeatureItemPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "FeatureItemPDSAValidator";

      // Create Properties for each field in the FeatureItemPDSA entity class
      InitProperties();
    ...
    public FeatureItemPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your FeatureItemPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(FeatureItemPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(FeatureItemPDSAValidator.ColumnNames.DateColumnNameHere);
