...
{
  /// <summary>
  /// Used to validate business rules on the RoleClusterPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleClusterPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleClusterPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleClusterPDSA</param>
    public RoleClusterPDSAValidator(RoleClusterPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleClusterPDSAValidator";

      // Create Properties for each field in the RoleClusterPDSA entity class
      InitProperties();
    ...
    public RoleClusterPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleClusterPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleClusterPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleClusterPDSAValidator.ColumnNames.DateColumnNameHere);
