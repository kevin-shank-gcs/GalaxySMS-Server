...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_GetLatestCountsPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_GetLatestCountsPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_GetLatestCountsPDSA</param>
    public gcsEntityCountPDSA_GetLatestCountsPDSAValidator(gcsEntityCountPDSA_GetLatestCountsPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_GetLatestCountsPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_GetLatestCountsPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_GetLatestCountsPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_GetLatestCountsPDSAValidator.ColumnNames.DateColumnNameHere);
