...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedListPropertyItemUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedListPropertyItemUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedListPropertyItemUniquePDSA</param>
    public IsUserDefinedListPropertyItemUniquePDSAValidator(IsUserDefinedListPropertyItemUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedListPropertyItemUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedListPropertyItemUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedListPropertyItemUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedListPropertyItemUniquePDSAValidator.ColumnNames.DateColumnNameHere);
