...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAccessGroupEntityMapUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAccessGroupEntityMapUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAccessGroupEntityMapUniquePDSA</param>
    public IsAccessGroupEntityMapUniquePDSAValidator(IsAccessGroupEntityMapUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAccessGroupEntityMapUniquePDSAValidator";

      // Create Properties for each field in the IsAccessGroupEntityMapUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAccessGroupEntityMapUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAccessGroupEntityMapUniquePDSAValidator.ColumnNames.DateColumnNameHere);
