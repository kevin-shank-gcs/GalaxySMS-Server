...
{
  /// <summary>
  /// Used to validate business rules on the AreaPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AreaPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AreaPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AreaPDSA</param>
    public AreaPDSAValidator(AreaPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AreaPDSAValidator";

      // Create Properties for each field in the AreaPDSA entity class
      InitProperties();
    ...
    public AreaPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AreaPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AreaPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AreaPDSAValidator.ColumnNames.DateColumnNameHere);
