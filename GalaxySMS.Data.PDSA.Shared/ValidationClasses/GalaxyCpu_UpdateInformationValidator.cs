...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class GalaxyCpu_UpdateInformationPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyCpu_UpdateInformationPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyCpu_UpdateInformationPDSA</param>
    public GalaxyCpu_UpdateInformationPDSAValidator(GalaxyCpu_UpdateInformationPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyCpu_UpdateInformationPDSAValidator";

      // Create Properties for each field in the GalaxyCpu_UpdateInformationPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyCpu_UpdateInformationPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyCpu_UpdateInformationPDSAValidator.ColumnNames.DateColumnNameHere);
