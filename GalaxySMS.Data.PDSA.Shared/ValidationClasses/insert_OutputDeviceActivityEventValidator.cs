...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class insert_OutputDeviceActivityEventPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the insert_OutputDeviceActivityEventPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a insert_OutputDeviceActivityEventPDSA</param>
    public insert_OutputDeviceActivityEventPDSAValidator(insert_OutputDeviceActivityEventPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "insert_OutputDeviceActivityEventPDSAValidator";

      // Create Properties for each field in the insert_OutputDeviceActivityEventPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(insert_OutputDeviceActivityEventPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(insert_OutputDeviceActivityEventPDSAValidator.ColumnNames.DateColumnNameHere);
