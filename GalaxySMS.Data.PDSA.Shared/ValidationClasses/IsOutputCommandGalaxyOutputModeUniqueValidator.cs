...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsOutputCommandGalaxyOutputModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsOutputCommandGalaxyOutputModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsOutputCommandGalaxyOutputModeUniquePDSA</param>
    public IsOutputCommandGalaxyOutputModeUniquePDSAValidator(IsOutputCommandGalaxyOutputModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsOutputCommandGalaxyOutputModeUniquePDSAValidator";

      // Create Properties for each field in the IsOutputCommandGalaxyOutputModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsOutputCommandGalaxyOutputModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsOutputCommandGalaxyOutputModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
