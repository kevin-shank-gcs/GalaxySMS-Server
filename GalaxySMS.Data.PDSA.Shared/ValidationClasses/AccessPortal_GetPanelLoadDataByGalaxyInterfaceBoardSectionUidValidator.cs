...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA</param>
    public AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator";

      // Create Properties for each field in the AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortal_GetPanelLoadDataByGalaxyInterfaceBoardSectionUidPDSAValidator.ColumnNames.DateColumnNameHere);
