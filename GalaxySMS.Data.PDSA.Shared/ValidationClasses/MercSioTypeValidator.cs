...
{
  /// <summary>
  /// Used to validate business rules on the MercSioTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class MercSioTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the MercSioTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a MercSioTypePDSA</param>
    public MercSioTypePDSAValidator(MercSioTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "MercSioTypePDSAValidator";

      // Create Properties for each field in the MercSioTypePDSA entity class
      InitProperties();
    ...
    public MercSioTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your MercSioTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(MercSioTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(MercSioTypePDSAValidator.ColumnNames.DateColumnNameHere);
