...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsClusterLedBehaviorModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsClusterLedBehaviorModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsClusterLedBehaviorModeUniquePDSA</param>
    public IsClusterLedBehaviorModeUniquePDSAValidator(IsClusterLedBehaviorModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsClusterLedBehaviorModeUniquePDSAValidator";

      // Create Properties for each field in the IsClusterLedBehaviorModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsClusterLedBehaviorModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsClusterLedBehaviorModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
