...
{
  /// <summary>
  /// Used to validate business rules on the InputDeviceSupervisionTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InputDeviceSupervisionTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceSupervisionTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceSupervisionTypePDSA</param>
    public InputDeviceSupervisionTypePDSAValidator(InputDeviceSupervisionTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceSupervisionTypePDSAValidator";

      // Create Properties for each field in the InputDeviceSupervisionTypePDSA entity class
      InitProperties();
    ...
    public InputDeviceSupervisionTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDeviceSupervisionTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceSupervisionTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceSupervisionTypePDSAValidator.ColumnNames.DateColumnNameHere);
