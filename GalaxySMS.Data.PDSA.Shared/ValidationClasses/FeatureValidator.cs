...
{
  /// <summary>
  /// Used to validate business rules on the FeaturePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class FeaturePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the FeaturePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a FeaturePDSA</param>
    public FeaturePDSAValidator(FeaturePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "FeaturePDSAValidator";

      // Create Properties for each field in the FeaturePDSA entity class
      InitProperties();
    ...
    public FeaturePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your FeaturePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(FeaturePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(FeaturePDSAValidator.ColumnNames.DateColumnNameHere);
