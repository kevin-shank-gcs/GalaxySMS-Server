...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyHardwareModuleUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyHardwareModuleUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyHardwareModuleUniquePDSA</param>
    public IsGalaxyHardwareModuleUniquePDSAValidator(IsGalaxyHardwareModuleUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyHardwareModuleUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyHardwareModuleUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyHardwareModuleUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyHardwareModuleUniquePDSAValidator.ColumnNames.DateColumnNameHere);
