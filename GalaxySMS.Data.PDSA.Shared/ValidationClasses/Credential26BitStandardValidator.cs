...
{
  /// <summary>
  /// Used to validate business rules on the Credential26BitStandardPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class Credential26BitStandardPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the Credential26BitStandardPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a Credential26BitStandardPDSA</param>
    public Credential26BitStandardPDSAValidator(Credential26BitStandardPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "Credential26BitStandardPDSAValidator";

      // Create Properties for each field in the Credential26BitStandardPDSA entity class
      InitProperties();
    ...
    public Credential26BitStandardPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your Credential26BitStandardPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(Credential26BitStandardPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(Credential26BitStandardPDSAValidator.ColumnNames.DateColumnNameHere);
