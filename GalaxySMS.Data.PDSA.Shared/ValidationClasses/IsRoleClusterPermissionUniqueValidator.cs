...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleClusterPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleClusterPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleClusterPermissionUniquePDSA</param>
    public IsRoleClusterPermissionUniquePDSAValidator(IsRoleClusterPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleClusterPermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleClusterPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleClusterPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleClusterPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
