...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyCpuLoggingControlUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyCpuLoggingControlUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyCpuLoggingControlUniquePDSA</param>
    public IsGalaxyCpuLoggingControlUniquePDSAValidator(IsGalaxyCpuLoggingControlUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyCpuLoggingControlUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyCpuLoggingControlUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyCpuLoggingControlUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyCpuLoggingControlUniquePDSAValidator.ColumnNames.DateColumnNameHere);
