...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInputCommandGalaxyPanelModelUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInputCommandGalaxyPanelModelUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInputCommandGalaxyPanelModelUniquePDSA</param>
    public IsInputCommandGalaxyPanelModelUniquePDSAValidator(IsInputCommandGalaxyPanelModelUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInputCommandGalaxyPanelModelUniquePDSAValidator";

      // Create Properties for each field in the IsInputCommandGalaxyPanelModelUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInputCommandGalaxyPanelModelUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInputCommandGalaxyPanelModelUniquePDSAValidator.ColumnNames.DateColumnNameHere);
