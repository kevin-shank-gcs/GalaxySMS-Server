...
{
  /// <summary>
  /// Used to validate business rules on the OutputDeviceEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class OutputDeviceEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDeviceEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDeviceEntityMapPDSA</param>
    public OutputDeviceEntityMapPDSAValidator(OutputDeviceEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDeviceEntityMapPDSAValidator";

      // Create Properties for each field in the OutputDeviceEntityMapPDSA entity class
      InitProperties();
    ...
    public OutputDeviceEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputDeviceEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDeviceEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDeviceEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
