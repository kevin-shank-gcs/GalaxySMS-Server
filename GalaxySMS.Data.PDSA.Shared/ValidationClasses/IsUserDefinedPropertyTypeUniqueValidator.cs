...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsUserDefinedPropertyTypeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsUserDefinedPropertyTypeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsUserDefinedPropertyTypeUniquePDSA</param>
    public IsUserDefinedPropertyTypeUniquePDSAValidator(IsUserDefinedPropertyTypeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsUserDefinedPropertyTypeUniquePDSAValidator";

      // Create Properties for each field in the IsUserDefinedPropertyTypeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsUserDefinedPropertyTypeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsUserDefinedPropertyTypeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
