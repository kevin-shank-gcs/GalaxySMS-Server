...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsCredentialFormatUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsCredentialFormatUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsCredentialFormatUniquePDSA</param>
    public IsCredentialFormatUniquePDSAValidator(IsCredentialFormatUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsCredentialFormatUniquePDSAValidator";

      // Create Properties for each field in the IsCredentialFormatUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsCredentialFormatUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsCredentialFormatUniquePDSAValidator.ColumnNames.DateColumnNameHere);
