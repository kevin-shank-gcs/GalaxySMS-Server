...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyOutputDeviceInputSourcePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyOutputDeviceInputSourcePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyOutputDeviceInputSourcePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyOutputDeviceInputSourcePDSA</param>
    public GalaxyOutputDeviceInputSourcePDSAValidator(GalaxyOutputDeviceInputSourcePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyOutputDeviceInputSourcePDSAValidator";

      // Create Properties for each field in the GalaxyOutputDeviceInputSourcePDSA entity class
      InitProperties();
    ...
    public GalaxyOutputDeviceInputSourcePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyOutputDeviceInputSourcePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyOutputDeviceInputSourcePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyOutputDeviceInputSourcePDSAValidator.ColumnNames.DateColumnNameHere);
