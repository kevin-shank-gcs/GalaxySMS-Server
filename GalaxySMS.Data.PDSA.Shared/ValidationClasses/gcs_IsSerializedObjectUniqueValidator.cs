...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcs_IsSerializedObjectUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcs_IsSerializedObjectUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcs_IsSerializedObjectUniquePDSA</param>
    public gcs_IsSerializedObjectUniquePDSAValidator(gcs_IsSerializedObjectUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcs_IsSerializedObjectUniquePDSAValidator";

      // Create Properties for each field in the gcs_IsSerializedObjectUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcs_IsSerializedObjectUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcs_IsSerializedObjectUniquePDSAValidator.ColumnNames.DateColumnNameHere);
