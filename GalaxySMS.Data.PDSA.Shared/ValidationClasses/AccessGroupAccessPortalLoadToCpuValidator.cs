...
{
  /// <summary>
  /// Used to validate business rules on the AccessGroupAccessPortalLoadToCpuPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessGroupAccessPortalLoadToCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessGroupAccessPortalLoadToCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessGroupAccessPortalLoadToCpuPDSA</param>
    public AccessGroupAccessPortalLoadToCpuPDSAValidator(AccessGroupAccessPortalLoadToCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessGroupAccessPortalLoadToCpuPDSAValidator";

      // Create Properties for each field in the AccessGroupAccessPortalLoadToCpuPDSA entity class
      InitProperties();
    ...
    public AccessGroupAccessPortalLoadToCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessGroupAccessPortalLoadToCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessGroupAccessPortalLoadToCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessGroupAccessPortalLoadToCpuPDSAValidator.ColumnNames.DateColumnNameHere);
