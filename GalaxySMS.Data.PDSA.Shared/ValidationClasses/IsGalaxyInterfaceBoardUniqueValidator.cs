...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsGalaxyInterfaceBoardUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsGalaxyInterfaceBoardUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsGalaxyInterfaceBoardUniquePDSA</param>
    public IsGalaxyInterfaceBoardUniquePDSAValidator(IsGalaxyInterfaceBoardUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsGalaxyInterfaceBoardUniquePDSAValidator";

      // Create Properties for each field in the IsGalaxyInterfaceBoardUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsGalaxyInterfaceBoardUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsGalaxyInterfaceBoardUniquePDSAValidator.ColumnNames.DateColumnNameHere);
