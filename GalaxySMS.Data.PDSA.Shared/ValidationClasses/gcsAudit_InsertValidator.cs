...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsAudit_InsertPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsAudit_InsertPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsAudit_InsertPDSA</param>
    public gcsAudit_InsertPDSAValidator(gcsAudit_InsertPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsAudit_InsertPDSAValidator";

      // Create Properties for each field in the gcsAudit_InsertPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsAudit_InsertPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsAudit_InsertPDSAValidator.ColumnNames.DateColumnNameHere);
