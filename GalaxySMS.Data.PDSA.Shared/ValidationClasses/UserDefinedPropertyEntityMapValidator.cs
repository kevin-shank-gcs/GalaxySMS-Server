...
{
  /// <summary>
  /// Used to validate business rules on the UserDefinedPropertyEntityMapPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class UserDefinedPropertyEntityMapPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the UserDefinedPropertyEntityMapPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a UserDefinedPropertyEntityMapPDSA</param>
    public UserDefinedPropertyEntityMapPDSAValidator(UserDefinedPropertyEntityMapPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "UserDefinedPropertyEntityMapPDSAValidator";

      // Create Properties for each field in the UserDefinedPropertyEntityMapPDSA entity class
      InitProperties();
    ...
    public UserDefinedPropertyEntityMapPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your UserDefinedPropertyEntityMapPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(UserDefinedPropertyEntityMapPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(UserDefinedPropertyEntityMapPDSAValidator.ColumnNames.DateColumnNameHere);
