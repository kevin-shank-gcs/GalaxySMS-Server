...
{
  /// <summary>
  /// Used to validate business rules on the OutputDevice_PanelLoadDataChangesForCpuPDSA class.
  ...
  /// </summary>
  public partial class OutputDevice_PanelLoadDataChangesForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDevice_PanelLoadDataChangesForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDevice_PanelLoadDataChangesForCpuPDSA</param>
    public OutputDevice_PanelLoadDataChangesForCpuPDSAValidator(OutputDevice_PanelLoadDataChangesForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDevice_PanelLoadDataChangesForCpuPDSAValidator";

      // Create Properties for each field in the OutputDevice_PanelLoadDataChangesForCpuPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A OutputDevice_PanelLoadDataChangesForCpuPDSA object</returns>
    public OutputDevice_PanelLoadDataChangesForCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your OutputDevice_PanelLoadDataChangesForCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
