...
{
  /// <summary>
  /// Used to validate business rules on the InterfaceBoardTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class InterfaceBoardTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InterfaceBoardTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InterfaceBoardTypePDSA</param>
    public InterfaceBoardTypePDSAValidator(InterfaceBoardTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InterfaceBoardTypePDSAValidator";

      // Create Properties for each field in the InterfaceBoardTypePDSA entity class
      InitProperties();
    ...
    public InterfaceBoardTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InterfaceBoardTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InterfaceBoardTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InterfaceBoardTypePDSAValidator.ColumnNames.DateColumnNameHere);
