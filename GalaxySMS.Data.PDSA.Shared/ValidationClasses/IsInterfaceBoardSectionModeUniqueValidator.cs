...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsInterfaceBoardSectionModeUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsInterfaceBoardSectionModeUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsInterfaceBoardSectionModeUniquePDSA</param>
    public IsInterfaceBoardSectionModeUniquePDSAValidator(IsInterfaceBoardSectionModeUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsInterfaceBoardSectionModeUniquePDSAValidator";

      // Create Properties for each field in the IsInterfaceBoardSectionModeUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsInterfaceBoardSectionModeUniquePDSAValidator.ColumnNames.DateColumnNameHere);
