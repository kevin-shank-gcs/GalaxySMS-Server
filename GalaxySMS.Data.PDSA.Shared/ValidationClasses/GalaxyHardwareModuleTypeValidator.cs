...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyHardwareModuleTypePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyHardwareModuleTypePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyHardwareModuleTypePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyHardwareModuleTypePDSA</param>
    public GalaxyHardwareModuleTypePDSAValidator(GalaxyHardwareModuleTypePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyHardwareModuleTypePDSAValidator";

      // Create Properties for each field in the GalaxyHardwareModuleTypePDSA entity class
      InitProperties();
    ...
    public GalaxyHardwareModuleTypePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyHardwareModuleTypePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyHardwareModuleTypePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyHardwareModuleTypePDSAValidator.ColumnNames.DateColumnNameHere);
