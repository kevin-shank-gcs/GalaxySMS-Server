...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonalAccessGroup_PanelLoadDataByClusterUidPDSA</param>
    public PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator(PersonalAccessGroup_PanelLoadDataByClusterUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator";

      // Create Properties for each field in the PersonalAccessGroup_PanelLoadDataByClusterUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonalAccessGroup_PanelLoadDataByClusterUidPDSAValidator.ColumnNames.DateColumnNameHere);
