...
{
  /// <summary>
  /// Used to validate business rules on the RoleInputOutputGroupPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleInputOutputGroupPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleInputOutputGroupPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleInputOutputGroupPDSA</param>
    public RoleInputOutputGroupPDSAValidator(RoleInputOutputGroupPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleInputOutputGroupPDSAValidator";

      // Create Properties for each field in the RoleInputOutputGroupPDSA entity class
      InitProperties();
    ...
    public RoleInputOutputGroupPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleInputOutputGroupPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleInputOutputGroupPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleInputOutputGroupPDSAValidator.ColumnNames.DateColumnNameHere);
