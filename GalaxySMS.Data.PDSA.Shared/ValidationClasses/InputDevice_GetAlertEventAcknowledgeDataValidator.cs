...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDevice_GetAlertEventAcknowledgeDataPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_GetAlertEventAcknowledgeDataPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_GetAlertEventAcknowledgeDataPDSA</param>
    public InputDevice_GetAlertEventAcknowledgeDataPDSAValidator(InputDevice_GetAlertEventAcknowledgeDataPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_GetAlertEventAcknowledgeDataPDSAValidator";

      // Create Properties for each field in the InputDevice_GetAlertEventAcknowledgeDataPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_GetAlertEventAcknowledgeDataPDSAValidator.ColumnNames.DateColumnNameHere);
