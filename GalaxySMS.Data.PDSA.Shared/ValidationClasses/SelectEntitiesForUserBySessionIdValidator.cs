...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class SelectEntitiesForUserBySessionIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the SelectEntitiesForUserBySessionIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a SelectEntitiesForUserBySessionIdPDSA</param>
    public SelectEntitiesForUserBySessionIdPDSAValidator(SelectEntitiesForUserBySessionIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "SelectEntitiesForUserBySessionIdPDSAValidator";

      // Create Properties for each field in the SelectEntitiesForUserBySessionIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(SelectEntitiesForUserBySessionIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(SelectEntitiesForUserBySessionIdPDSAValidator.ColumnNames.DateColumnNameHere);
