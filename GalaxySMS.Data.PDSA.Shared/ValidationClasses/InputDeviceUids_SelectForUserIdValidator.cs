...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputDeviceUids_SelectForUserIdPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDeviceUids_SelectForUserIdPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDeviceUids_SelectForUserIdPDSA</param>
    public InputDeviceUids_SelectForUserIdPDSAValidator(InputDeviceUids_SelectForUserIdPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDeviceUids_SelectForUserIdPDSAValidator";

      // Create Properties for each field in the InputDeviceUids_SelectForUserIdPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDeviceUids_SelectForUserIdPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDeviceUids_SelectForUserIdPDSAValidator.ColumnNames.DateColumnNameHere);
