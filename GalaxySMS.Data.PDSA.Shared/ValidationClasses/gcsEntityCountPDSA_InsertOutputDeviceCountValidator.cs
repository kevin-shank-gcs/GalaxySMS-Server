...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertOutputDeviceCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertOutputDeviceCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertOutputDeviceCountPDSA</param>
    public gcsEntityCountPDSA_InsertOutputDeviceCountPDSAValidator(gcsEntityCountPDSA_InsertOutputDeviceCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertOutputDeviceCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertOutputDeviceCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertOutputDeviceCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertOutputDeviceCountPDSAValidator.ColumnNames.DateColumnNameHere);
