...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class gcsEntityCountPDSA_InsertInterfaceBoardCountPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the gcsEntityCountPDSA_InsertInterfaceBoardCountPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a gcsEntityCountPDSA_InsertInterfaceBoardCountPDSA</param>
    public gcsEntityCountPDSA_InsertInterfaceBoardCountPDSAValidator(gcsEntityCountPDSA_InsertInterfaceBoardCountPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "gcsEntityCountPDSA_InsertInterfaceBoardCountPDSAValidator";

      // Create Properties for each field in the gcsEntityCountPDSA_InsertInterfaceBoardCountPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInterfaceBoardCountPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(gcsEntityCountPDSA_InsertInterfaceBoardCountPDSAValidator.ColumnNames.DateColumnNameHere);
