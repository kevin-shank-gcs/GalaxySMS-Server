...
{
  /// <summary>
  /// Used to validate business rules on the AccessPortalMultiFactorModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class AccessPortalMultiFactorModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the AccessPortalMultiFactorModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a AccessPortalMultiFactorModePDSA</param>
    public AccessPortalMultiFactorModePDSAValidator(AccessPortalMultiFactorModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "AccessPortalMultiFactorModePDSAValidator";

      // Create Properties for each field in the AccessPortalMultiFactorModePDSA entity class
      InitProperties();
    ...
    public AccessPortalMultiFactorModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your AccessPortalMultiFactorModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(AccessPortalMultiFactorModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(AccessPortalMultiFactorModePDSAValidator.ColumnNames.DateColumnNameHere);
