...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ClusterUid_GetByAccessPortalUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ClusterUid_GetByAccessPortalUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ClusterUid_GetByAccessPortalUidPDSA</param>
    public ClusterUid_GetByAccessPortalUidPDSAValidator(ClusterUid_GetByAccessPortalUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ClusterUid_GetByAccessPortalUidPDSAValidator";

      // Create Properties for each field in the ClusterUid_GetByAccessPortalUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ClusterUid_GetByAccessPortalUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ClusterUid_GetByAccessPortalUidPDSAValidator.ColumnNames.DateColumnNameHere);
