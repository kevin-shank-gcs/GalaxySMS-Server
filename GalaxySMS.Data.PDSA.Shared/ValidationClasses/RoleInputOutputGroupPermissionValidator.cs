...
{
  /// <summary>
  /// Used to validate business rules on the RoleInputOutputGroupPermissionPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class RoleInputOutputGroupPermissionPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the RoleInputOutputGroupPermissionPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a RoleInputOutputGroupPermissionPDSA</param>
    public RoleInputOutputGroupPermissionPDSAValidator(RoleInputOutputGroupPermissionPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "RoleInputOutputGroupPermissionPDSAValidator";

      // Create Properties for each field in the RoleInputOutputGroupPermissionPDSA entity class
      InitProperties();
    ...
    public RoleInputOutputGroupPermissionPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your RoleInputOutputGroupPermissionPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(RoleInputOutputGroupPermissionPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(RoleInputOutputGroupPermissionPDSAValidator.ColumnNames.DateColumnNameHere);
