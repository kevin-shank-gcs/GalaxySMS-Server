...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsAssaTimeScheduleDayPeriodUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsAssaTimeScheduleDayPeriodUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsAssaTimeScheduleDayPeriodUniquePDSA</param>
    public IsAssaTimeScheduleDayPeriodUniquePDSAValidator(IsAssaTimeScheduleDayPeriodUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsAssaTimeScheduleDayPeriodUniquePDSAValidator";

      // Create Properties for each field in the IsAssaTimeScheduleDayPeriodUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsAssaTimeScheduleDayPeriodUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsAssaTimeScheduleDayPeriodUniquePDSAValidator.ColumnNames.DateColumnNameHere);
