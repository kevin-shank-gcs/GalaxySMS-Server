...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsRoleInputOutputGroupPermissionUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsRoleInputOutputGroupPermissionUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsRoleInputOutputGroupPermissionUniquePDSA</param>
    public IsRoleInputOutputGroupPermissionUniquePDSAValidator(IsRoleInputOutputGroupPermissionUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsRoleInputOutputGroupPermissionUniquePDSAValidator";

      // Create Properties for each field in the IsRoleInputOutputGroupPermissionUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsRoleInputOutputGroupPermissionUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsRoleInputOutputGroupPermissionUniquePDSAValidator.ColumnNames.DateColumnNameHere);
