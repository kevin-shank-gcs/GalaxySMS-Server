...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSA</param>
    public InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSAValidator(InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSAValidator";

      // Create Properties for each field in the InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputOutputGroupAssignmentSources_ByInputOuputGroupUidPDSAValidator.ColumnNames.DateColumnNameHere);
