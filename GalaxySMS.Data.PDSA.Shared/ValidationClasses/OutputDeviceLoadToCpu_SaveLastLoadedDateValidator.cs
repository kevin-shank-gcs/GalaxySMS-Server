...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class OutputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the OutputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a OutputDeviceLoadToCpu_SaveLastLoadedDatePDSA</param>
    public OutputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator(OutputDeviceLoadToCpu_SaveLastLoadedDatePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "OutputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator";

      // Create Properties for each field in the OutputDeviceLoadToCpu_SaveLastLoadedDatePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(OutputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(OutputDeviceLoadToCpu_SaveLastLoadedDatePDSAValidator.ColumnNames.DateColumnNameHere);
