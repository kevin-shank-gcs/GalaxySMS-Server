...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class ChooseAvailableAreaNumberPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the ChooseAvailableAreaNumberPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a ChooseAvailableAreaNumberPDSA</param>
    public ChooseAvailableAreaNumberPDSAValidator(ChooseAvailableAreaNumberPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "ChooseAvailableAreaNumberPDSAValidator";

      // Create Properties for each field in the ChooseAvailableAreaNumberPDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(ChooseAvailableAreaNumberPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(ChooseAvailableAreaNumberPDSAValidator.ColumnNames.DateColumnNameHere);
