...
{
  /// <summary>
  /// Used to validate business rules on the PersonLcdMessageDisplayModePDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class PersonLcdMessageDisplayModePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the PersonLcdMessageDisplayModePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a PersonLcdMessageDisplayModePDSA</param>
    public PersonLcdMessageDisplayModePDSAValidator(PersonLcdMessageDisplayModePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "PersonLcdMessageDisplayModePDSAValidator";

      // Create Properties for each field in the PersonLcdMessageDisplayModePDSA entity class
      InitProperties();
    ...
    public PersonLcdMessageDisplayModePDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your PersonLcdMessageDisplayModePDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(PersonLcdMessageDisplayModePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(PersonLcdMessageDisplayModePDSAValidator.ColumnNames.DateColumnNameHere);
