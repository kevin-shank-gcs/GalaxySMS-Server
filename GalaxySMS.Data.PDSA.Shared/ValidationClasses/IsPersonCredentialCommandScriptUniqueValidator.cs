...
namespace GalaxySMS.ValidationLayer
{
  ...
  /// </summary>
  public partial class IsPersonCredentialCommandScriptUniquePDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the IsPersonCredentialCommandScriptUniquePDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a IsPersonCredentialCommandScriptUniquePDSA</param>
    public IsPersonCredentialCommandScriptUniquePDSAValidator(IsPersonCredentialCommandScriptUniquePDSA entity) : base()
    {
      Entity = entity;
      ClassName = "IsPersonCredentialCommandScriptUniquePDSAValidator";

      // Create Properties for each field in the IsPersonCredentialCommandScriptUniquePDSA entity class
      InitProperties();
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(IsPersonCredentialCommandScriptUniquePDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(IsPersonCredentialCommandScriptUniquePDSAValidator.ColumnNames.DateColumnNameHere);
