...
{
  /// <summary>
  /// Used to validate business rules on the InputDevice_PanelLoadDataChangesForCpuPDSA class.
  ...
  /// </summary>
  public partial class InputDevice_PanelLoadDataChangesForCpuPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the InputDevice_PanelLoadDataChangesForCpuPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a InputDevice_PanelLoadDataChangesForCpuPDSA</param>
    public InputDevice_PanelLoadDataChangesForCpuPDSAValidator(InputDevice_PanelLoadDataChangesForCpuPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "InputDevice_PanelLoadDataChangesForCpuPDSAValidator";

      // Create Properties for each field in the InputDevice_PanelLoadDataChangesForCpuPDSA entity class
      InitProperties();
    ...
    /// </summary>
    /// <returns>A InputDevice_PanelLoadDataChangesForCpuPDSA object</returns>
    public InputDevice_PanelLoadDataChangesForCpuPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your InputDevice_PanelLoadDataChangesForCpuPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(InputDevice_PanelLoadDataChangesForCpuPDSAValidator.ColumnNames.DateColumnNameHere);
