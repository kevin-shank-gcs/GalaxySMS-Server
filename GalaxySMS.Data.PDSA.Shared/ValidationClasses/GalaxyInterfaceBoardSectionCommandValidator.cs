...
{
  /// <summary>
  /// Used to validate business rules on the GalaxyInterfaceBoardSectionCommandPDSA class.
  /// This class is generated by the Haystack Code Generator for .NET.
  /// You may add business rules to the ValidateCore method in this class.
  /// </summary>
  public partial class GalaxyInterfaceBoardSectionCommandPDSAValidator
  {
    #region Constructor
    /// <summary>
    /// Constructor for the GalaxyInterfaceBoardSectionCommandPDSAValidator class
    /// </summary>
    /// <param name="entity">An instance of a GalaxyInterfaceBoardSectionCommandPDSA</param>
    public GalaxyInterfaceBoardSectionCommandPDSAValidator(GalaxyInterfaceBoardSectionCommandPDSA entity) : base()
    {
      Entity = entity;
      ClassName = "GalaxyInterfaceBoardSectionCommandPDSAValidator";

      // Create Properties for each field in the GalaxyInterfaceBoardSectionCommandPDSA entity class
      InitProperties();
    ...
    public GalaxyInterfaceBoardSectionCommandPDSA CreateNewEntity()
    {
    ...
    /// <summary>
    /// Used to validate any custom business rules on your GalaxyInterfaceBoardSectionCommandPDSA class.
    ...
    protected override void AddBusinessRulesToProperties()
    {
      ...
      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionCommandPDSAValidator.ColumnNames.ColumnNameHere);
      //prop.MinLength = 6;

      //prop = Properties.GetByName(GalaxyInterfaceBoardSectionCommandPDSAValidator.ColumnNames.DateColumnNameHere);
