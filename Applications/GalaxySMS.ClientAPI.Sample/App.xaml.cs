...
namespace GalaxySMS.ClientAPI.Sample
{
    ...
    public partial class App : Application
    {
        ...
        static App()
        {
            ...
            //System.Diagnostics.Trace.WriteLine($"In {System.Reflection.MethodBase.GetCurrentMethod()?.DeclaringType?.FullName}");
        }

        protected override void OnStartup(StartupEventArgs e)
        {
            //System.Diagnostics.Trace.WriteLine($"In {System.Reflection.MethodBase.GetCurrentMethod()?.DeclaringType?.FullName}=>{System.Reflection.MethodBase.GetCurrentMethod()?.Name}");
