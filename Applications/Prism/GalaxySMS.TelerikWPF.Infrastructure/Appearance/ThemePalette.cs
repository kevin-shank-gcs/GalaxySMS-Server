...
namespace GalaxySMS.TelerikWPF.Infrastructure.Appearance
{
    public sealed class ThemePalette : Freezable
    {
        ...
        private static readonly Color defaultAccentBrushColor = Color.FromArgb(0xFF, 0x85, 0x8d, 0x93);
        ...
        public static readonly DependencyProperty AccentBrushProperty =
         DependencyProperty.Register("AccentBrush", typeof(Color), typeof(ThemePalette), new PropertyMetadata());

        public static readonly DependencyProperty ForegroundProperty =
          DependencyProperty.Register("Foreground", typeof(Color), typeof(ThemePalette), new PropertyMetadata());

        public static readonly DependencyProperty FontFamilyProperty =
          DependencyProperty.Register("FontFamily", typeof(FontFamily), typeof(ThemePalette), new PropertyMetadata());

        public static readonly DependencyProperty BackgroundProperty =
            DependencyProperty.Register("Background", typeof(Color), typeof(ThemePalette), new PropertyMetadata());

        public static readonly DependencyProperty AlternativeBackgroundProperty =
            DependencyProperty.Register("AlternativeBackground", typeof(Color), typeof(ThemePalette), new PropertyMetadata());
        ...
        internal static bool TryGetResource(Resources key, out string resource)
        {
            ...
            switch (key)
            {
                ...
                case Resources.Background:
                    ...
                    containsResource = true;
					break;
				case Resources.AlternativeBackground:
