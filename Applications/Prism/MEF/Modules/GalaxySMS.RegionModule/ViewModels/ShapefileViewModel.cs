...
{
    public class ShapefileViewModel : GCS.Core.Common.UI.Core.ViewModelBase
    {
#if SILVERLIGHT
        ...
        {
            get { return this._shapefileSourceUri; }
            set
            {
        ...
        {
            get { return this._shapefileDataSourceUri; }
            set
            {
        ...
        private void ShapefileViewModelPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            {
                this.ShapefileSourceUri = new Uri(string.Format(ShapeRelativeUriFormat, this.Region, ShapeExtension),
                    UriKind.Relative);
                this.ShapefileDataSourceUri = new Uri(string.Format(ShapeRelativeUriFormat, this.Region, DbfExtension),
                    UriKind.Relative);
            }
        }
    }
