...
namespace GalaxySMS.GalaxyHardware.ViewModels
{
    ...
    public class DayTypeViewModel : ViewModelBase, IPartImportsSatisfiedNotification, INavigationAware
    {
        #region Private fields
        private readonly IEventAggregator _eventAggregator;
        private readonly IClientServices _clientServices;
        //EditDayTypeViewModel _currentDayTypeViewModel;
        ...
        public DayTypeViewModel(IEventAggregator eventAggregator, IClientServices clientServices, Entities.Cluster cluster)
        {
            _eventAggregator = eventAggregator;
            ViewTitle = CommonResources.Resources.EditClusterView_DayTypeMappingView_ViewTitle;
            ViewToolTip = CommonResources.Resources.EditClusterView_DayTypeMappingView_ViewToolTip;
            ...
            DayTypeMapChecked = new DelegateCommand<object>(OnDayTypeMapChecked);
        ...
        private void OnDayTypeMapChecked(object obj)
        {
            _cluster.MakeDirty();
        }
        ...
        public DelegateCommand<object> DayTypeMapChecked { get; set; }
        #endregion
