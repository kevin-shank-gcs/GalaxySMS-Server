...
{
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>   Operations relating to Regions. </summary>
    ///<remarks>  </remarks>
    ...
    public class RegionController : ControllerBaseEx
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ///  <summary> Get a collection of Region objects. </summary>
        ...
        /// 
        ///  <returns>   A Task&lt;ActionResult&lt;ApiEntities.Region[]&gt;&gt; </returns>
        /// =================================================================================================
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [HttpGet]
        ...
        //[MapToApiVersion("1.0")]
        public async Task<ActionResult<ApiEntities.ArrayResponse<ApiEntities.Region>>> Get(Guid entityId, bool includePhoto = true, int photoPixelWidth = 200, bool includeChildren = false)
        {
            try
            {
                ...
                var mgr = Helpers.GetManager<RegionManager>(ServerWcfServerAddress, ServerWcfBindingType, ServerUserName, ServerPassword, ClientUserSessionData);
                var results = await mgr.GetRegionsForEntityAsync(new WcfEntities.GetParametersWithPhoto()
                {
                    UniqueId = entityId,
                ...
                var resp = new ApiEntities.ArrayResponse<ApiEntities.Region>();
                resp.Items = Mapper.Map<ApiEntities.Region[]>(results);
                return Ok(resp);
            }
            catch (Exception ex)
            {
        ...
        // If no MapToApiVersion attribute is specified, then this endpoint will work for all versions
        //[MapToApiVersion("1.0")]
        public async Task<ActionResult<ApiEntities.ArrayResponse<ApiEntities.ListItemBase>>> GetList(Guid entityId, bool includePhoto = true, int photoPixelWidth = 200)
        {
            try
            {
                var sessionId = this.GetClaimGuid(GalaxySMSClaimTypes.SessionId.ToString());
                ...
                var mgr = Helpers.GetManager<RegionManager>(ServerWcfServerAddress, ServerWcfBindingType, ServerUserName, ServerPassword, ClientUserSessionData);
                var results = await mgr.GetRegionsListItemsForEntityAsync(new WcfEntities.GetParametersWithPhoto()
                {
                    UniqueId = entityId,
                    IncludePhoto = includePhoto,
                    PhotoPixelWidth = photoPixelWidth,
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary> Get a single Region based on regionUid (unique id (Guid or uuid) value). </summary>
        ///
        ...
        // If no MapToApiVersion attribute is specified, then this endpoint will work for all versions
        //[MapToApiVersion("1.0")]
        public async Task<ActionResult<ApiEntities.Region>> Get(Guid regionUid, bool includePhoto = true)
        {
            try
            {
                var sessionId = this.GetClaimGuid(GalaxySMSClaimTypes.SessionId.ToString());
                ...
                var mgr = Helpers.GetManager<RegionManager>(ServerWcfServerAddress, ServerWcfBindingType, ServerUserName, ServerPassword, ClientUserSessionData);
                var result = await mgr.GetRegionAsync(new WcfEntities.GetParametersWithPhoto()
                {
                    UniqueId = regionUid,
                    IncludePhoto = includePhoto,
                    IncludeMemberCollections = includeChildren
                ...
                if (getForPut)
                {
                    ...
                    return Ok(Mapper.Map<RequestModels.RegionPutReq>(result));
                }
                var model = Mapper.Map<ApiEntities.Region>(result);
                return Ok(model);
            }
        ...
        public async Task<ActionResult<RegionPutReq>> Post(RequestModels.SaveParams<RequestModels.RegionReq> parameters)
        {
            try
            {
                var sessionId = this.GetClaimGuid(GalaxySMSClaimTypes.SessionId.ToString());
                ...
                var wcfEntity = Mapper.Map<WcfEntities.Region>(parameters.Data);
                ...
                var wcfParams = new WcfEntities.SaveParameters<WcfEntities.Region>(wcfEntity, wcfSaveParameters);

                var results = await mgr.SaveRegionAsync(wcfParams);
                ...
                if (results != null)
                {
                    var savedItem = Mapper.Map<RegionPutReq>(results);
                    var url = LinkGenerator.GetPathByAction("Get",
                        "Region",
                        new { regionUid = savedItem.RegionUid });
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Update an existing Region item. Can also create a new Region.
        /// </summary>
        ///
        /// <param name="parameters">   Options for controlling the operation. </param>
        ///
        ...
        public async Task<ActionResult<RegionPutReq>> Put(RequestModels.SaveParams<RequestModels.RegionPutReq> parameters)
        {
            try
            {
                var sessionId = this.GetClaimGuid(GalaxySMSClaimTypes.SessionId.ToString());
                ...
                if (parameters.Data.RegionUid == Guid.Empty)
                    return this.StatusCode(StatusCodes.Status403Forbidden, $"Cannot update region with RegionUid value of {parameters.Data.RegionUid}");
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Delete a specific Region by regionUid.
        /// </summary>
        ///
        ...
        public async Task<IActionResult> Delete(Guid regionUid)
        {
            try
            {
                ...
                var x = await mgr.DeleteRegionByUniqueIdAsync(new WcfEntities.DeleteParameters() { UniqueId = regionUid });
