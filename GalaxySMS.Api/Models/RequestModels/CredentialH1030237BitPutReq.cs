...
{
    public partial class CredentialH1030237BitPutReq : PutRequestBase
    {
...
////    	public Credential Credential { get; set; }
        ...
        public string CredentialFormatCodeAndPartsString
        {
            get
            {
                return $"{GalaxySMS.Common.Enums.CredentialFormatCodes.HIDH1030237Bit}:{CredentialPartsString}";
            }
            set
            {
                ;
