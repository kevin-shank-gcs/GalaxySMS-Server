...
{
    [Export(typeof(IRoleClusterRepository))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class RoleClusterRepository : DataRepositoryBase<RoleCluster>, IRoleClusterRepository, IPartImportsSatisfiedNotification
    {
        [Import] private IDataRepositoryFactory _dataRepositoryFactory;
        [Import] private ICacheManager _cacheManager;

        protected override RoleCluster AddEntity(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams)
        {
            try
            {
                //_binaryResourceRepository.SaveBinaryResource(entity, sessionData, saveParams);

                var mgr = new RoleClusterPDSAManager();
                mgr.InitEntityObject(entity);
                int rowCount = mgr.DataObject.Insert();
                if (rowCount > 0)
                {
                    //SaveEntityMappings(sessionData, entity.RoleClusterUid, entity);
                    var result = GetEntityByGuidId(entity.RoleClusterUid, sessionData, new GetParametersWithPhoto() { IncludeMemberCollections = false });
                    if (result != null)
                    {
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::AddEntity", ex);
                throw;
            }
        }

        protected override RoleCluster UpdateEntity(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams)
        {
            try
            {
                ...
                var originalEntity = GetEntityByGuidId(entity.RoleClusterUid, sessionData, null);
                var mgr = new RoleClusterPDSAManager();

                // PDSA Audit Tracking setup phase
                if (mgr.DataObject.LoadByPK(entity.RoleClusterUid) >
                    0) // must read the original record from the database so the PDSA object can detect changes
                {
                    ...
                    if (rowsUpdated > 0)
                    {
                        ...
                        var updatedEntity = GetEntityByGuidId(entity.RoleClusterUid, sessionData, new GetParametersWithPhoto()
                        {
                            RefreshCache = true,
                ...
                throw new Exception($"{entity.GetType().Name} {entity.RoleClusterUid} not found");
            }
            catch (PDSAValidationException ex)
            {
                DataValidationException dve = Converters.ConvertToDataValidationException(ex);
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::UpdateEntity", ex);
                throw;
            }
        }

        private void EnsureChildRecordsExist(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams)
        {
        ...
        private void SaveAccessPortalFilters(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams)
        {
            ...
            var accessPortalUids = accessPortalRepository.GetAllPrimaryKeyUidsFromRoleIdAndClusterUid(entity.RoleId, entity.ClusterUid);

            var existingAccessPortals = roleAccessPortalRepository.GetAllForRoleIdAndClusterUid(sessionData, new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, IncludeMemberCollections = true }).ToList();
        ...
        private void SaveInputDeviceFilters(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams)
        {
            ...
            var inputDeviceUids = inputDeviceRepository.GetAllPrimaryKeyUidsFromRoleIdAndClusterUid(entity.RoleId, entity.ClusterUid);

            var existingInputDevices = roleInputDeviceRepository.GetAllForRoleIdAndClusterUid(sessionData, new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, IncludeMemberCollections = true }).ToList();
        ...
        private void SaveOutputDeviceFilters(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams)
        {
            ...
            var outputDeviceUids = outputDeviceRepository.GetAllPrimaryKeyUidsFromRoleIdAndClusterUid(entity.RoleId, entity.ClusterUid);

            var existingOutputDevices = roleOutputDeviceRepository.GetAllForRoleIdAndClusterUid(sessionData, new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, IncludeMemberCollections = true }).ToList();
        ...
        private void SaveInputOutputGroupFilters(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, ISaveParameters saveParams)
        {
            ...
            var inputOutputGroupUids = inputOutputGroupRepository.GetAllPrimaryKeyUidsFromRoleIdAndClusterUid(entity.RoleId, entity.ClusterUid);

            var existingInputOutputGroups = roleInputOutputGroupRepository.GetAllForRoleIdAndClusterUid(sessionData, new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, IncludeMemberCollections = true }).ToList();
        ...
        protected override int DeleteEntity(RoleCluster entity, IApplicationUserSessionDataHeader sessionData)
        {
            try
            {
                var mgr = new RoleClusterPDSAManager();
                mgr.InitEntityObject(entity);
                int rowsDeleted = mgr.DataObject.DeleteByPK(entity.RoleClusterUid);
                if (rowsDeleted > 0)
                {
                    DataStoreTableName = mgr.DataObject.DBObjectName;
                    ...
                    {
                        var cacheKey = GetItemCacheKey(entity.RoleClusterUid);
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::DeleteEntity", ex);
                throw;
            }
        }
        ...
        public override int Remove(Guid id, IApplicationUserSessionDataHeader sessionData)
        {
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::Remove", ex);
                throw;
            }
        }

        //private IEnumerable<RoleCluster> GetIEnumerable(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters, RoleClusterPDSAManager mgr)
        //{
        ...
        private IEnumerable<RoleCluster> GetIEnumerable(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters, RoleClusterPDSAManager mgr)
        {
            IEnumerable<RoleCluster> entities = null;
            var cacheKey = string.Empty;
            switch (mgr.DataObject.SelectFilter)
            {
                case RoleClusterPDSAData.SelectFilters.All:
                    cacheKey = GetItemsCacheKey(Guid.Empty, $"{System.Reflection.MethodBase.GetCurrentMethod()?.Name}.{mgr.DataObject.SelectFilter}");
                    break;
                case RoleClusterPDSAData.SelectFilters.ByClusterUid:
                    cacheKey = GetItemsCacheKey(mgr.Entity.ClusterUid, $"{System.Reflection.MethodBase.GetCurrentMethod()?.Name}.{mgr.DataObject.SelectFilter}");
                    break;
                case RoleClusterPDSAData.SelectFilters.ByRoleId:
                    ...
                    break;
                case RoleClusterPDSAData.SelectFilters.ByRoleIdAndSiteUid:
                    ...
                    break;
                case RoleClusterPDSAData.SelectFilters.ByClusterAddress:
                    break;
                //case RoleClusterPDSAData.SelectFilters.ListBox:
                    //    break;
                    //case RoleClusterPDSAData.SelectFilters.PrimaryKey:
                    //    break;
                    //case RoleClusterPDSAData.SelectFilters.Search:
                    //    break;
                    //case RoleClusterPDSAData.SelectFilters.Custom:
                    //    break;
                    //default:
            ...
            {
                entities = _cacheManager.GetCachedItem<List<RoleCluster>>(cacheKey);
        ...
        // GetAllRoleClusters for an Entity
        protected override IEnumerable<RoleCluster> GetEntities(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            return GetAllEntities(sessionData, getParameters);
            //try
            //{
            //    var mgr = new RoleClusterPDSAManager();
            //    mgr.DataObject.SelectFilter = RoleClusterPDSAData.SelectFilters.All;
            ...
            //catch (Exception ex)
            //{
            //    this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::GetEntities", ex);
            //    throw;
            //}
        }

        protected override IEnumerable<RoleCluster> GetAllEntities(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            try
            {
                var mgr = new RoleClusterPDSAManager();
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::GetAllEntities", ex);
                throw;
            }
        }

        public IEnumerable<RoleCluster> GetAllForRoleId(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            try
            {
                var mgr = new RoleClusterPDSAManager();
                mgr.DataObject.SelectFilter = RoleClusterPDSAData.SelectFilters.ByRoleId;
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::GetAllForRoleId", ex);
                throw;
            }
        }
        public IEnumerable<RoleCluster> GetAllForRoleIdAndSiteUid(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            try
            {
                var mgr = new RoleClusterPDSAManager();
                mgr.DataObject.SelectFilter = RoleClusterPDSAData.SelectFilters.ByRoleIdAndSiteUid;
                mgr.Entity.RoleId = getParameters.UniqueId;
        ...
        public IEnumerable<RoleCluster> GetAllForClusterUid(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            try
            {
                var mgr = new RoleClusterPDSAManager();
                mgr.DataObject.SelectFilter = RoleClusterPDSAData.SelectFilters.ByClusterUid;
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::GetAllForClusterUid", ex);
                throw;
            }
        }

        public IEnumerable<RoleCluster> GetAllForClusterAddress(IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            try
            {
                var mgr = new RoleClusterPDSAManager();
                mgr.DataObject.SelectFilter = RoleClusterPDSAData.SelectFilters.ByClusterAddress;
        ...
        protected override RoleCluster GetEntityByIntId(int id, IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            return null;
        }

        protected override RoleCluster GetEntityByGuidId(Guid guid, IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            try
            {
                var mgr = new RoleClusterPDSAManager();
                ...
                if (count == 1)
                {
                    RoleCluster result = new RoleCluster();
            ...
            {
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::GetEntityByGuidId", ex);
                throw;
            }
        }
        ...
        {
            return CacheHelpers.GetCacheKey(typeof(RoleCluster), uid, false);
        }

        private string GetItemsCacheKey(Guid uid, string prefix)
        {
            return CacheHelpers.GetCacheKey(typeof(RoleCluster), uid, true, prefix);
        }

        private string GetItemsCacheKey(Guid uid, Guid uid2, string prefix)
        {
            return CacheHelpers.GetCacheKey(typeof(RoleCluster), uid, uid2, true, prefix);
        }

        protected override void SaveAuditData(OperationType operationType, IApplicationUserSessionDataHeader sessionData, RoleCluster originalEntity, RoleCluster newEntity, string auditXml)
        {
            try
            {
                ...
                switch (operationType)
                {
                    case OperationType.Update:
                        ...
                        mgr.Entity.PrimaryKeyColumn = "RoleClusterUid";
                        mgr.Entity.PrimaryKeyValue = newEntity.RoleClusterUid;
                        mgr.Entity.RecordTag = newEntity.RoleClusterUid.ToString();
                    ...
                    case OperationType.Insert:
                        ...
                        mgr.Entity.PrimaryKeyColumn = "RoleClusterUid";
                        mgr.Entity.PrimaryKeyValue = newEntity.RoleClusterUid;
                        mgr.Entity.RecordTag = newEntity.RoleClusterUid.ToString(); mgr.Entity.AuditXml = auditXml;
                        mgr.Entity.InsertName = sessionData.UserName;
                        mgr.Entity.InsertDate = DateTimeOffset.Now;
                        mgr.Entity.UserId = sessionData.UserId;
                        mgr.Execute();
                    ...
                    case OperationType.Delete:
                        ...
                        mgr.Entity.OperationType = operationType.ToString();
                        mgr.Entity.PrimaryKeyColumn = "RoleClusterUid";
                        mgr.Entity.PrimaryKeyValue = originalEntity.RoleClusterUid;
                        mgr.Entity.RecordTag = originalEntity.RoleClusterUid.ToString(); mgr.Entity.AuditXml = auditXml;
                        mgr.Entity.InsertName = sessionData.UserName;
                        mgr.Entity.InsertDate = DateTimeOffset.Now;
                        mgr.Entity.UserId = sessionData.UserId;
                        mgr.Execute();
            ...
            {   // log the exception and swallow the exception. Do not re-throw
                this.Log().Error($"{System.Reflection.MethodBase.GetCurrentMethod()?.Name} exception: {ex.ToString()}");//RoleClusterRepository::SaveAuditData", ex);
                //throw;
            }
        }

        protected override void FillMemberCollections(RoleCluster entity, IApplicationUserSessionDataHeader sessionData, IGetParametersWithPhoto getParameters)
        {
            ...
            if (!getParameters.IsExcluded(nameof(entity.AccessPortals)))
            {
                ...
                entity.AccessPortals = roleAccessPortalRepository.GetAllForRoleIdAndClusterUid(sessionData,
                    new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, RefreshCache = getParameters.RefreshCache}).ToCollection();
            }
            ...
            if (!getParameters.IsExcluded(nameof(entity.InputDevices)))
            {
                ...
                entity.InputDevices = roleInputDeviceRepository.GetAllForRoleIdAndClusterUid(sessionData,
                    new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, RefreshCache = getParameters.RefreshCache }).ToCollection();
            }
            ...
            if (!getParameters.IsExcluded(nameof(entity.OutputDevices)))
            {
                ...
                entity.OutputDevices = roleOutputDeviceRepository.GetAllForRoleIdAndClusterUid(sessionData,
                    new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, RefreshCache = getParameters.RefreshCache }).ToCollection();
            }
            ...
            if (!getParameters.IsExcluded(nameof(entity.InputOutputGroups)))
            {
                ...
                entity.InputOutputGroups = roleInputOutputGroupRepository.GetAllForRoleIdAndClusterUid(sessionData,
                    new GetParametersWithPhoto() { UniqueId = entity.RoleId, ClusterUid = entity.ClusterUid, RefreshCache = getParameters.RefreshCache }).ToCollection();
            }
        ...
        {
            var count = GalaxySMSDatabaseManager.GetRowCountFromTableByColumnValue("RoleCluster", "RoleClusterUid", id);

            if (count != 0)
                return true;

            count = GalaxySMSDatabaseManager.GetGuidForeignKeyReferenceCount("RoleCluster", "RoleClusterUid", id);
            if (count == 0)
                return false;
            return true;
        }
        ...
        protected override bool IsEntityUnique(RoleCluster entity)
        {
            var mgr = new IsRoleClusterUniquePDSAManager();
            mgr.Entity.RoleClusterUid = entity.RoleClusterUid;
        ...
        {
            int count = GalaxySMSDatabaseManager.DoesRowExist("RoleCluster", "RoleClusterUid", id);
            if (count == 0)
                return false;
            return true;
        }
        ...
        {
            int count = GalaxySMSDatabaseManager.CanRowBeDeleted("RoleCluster", "RoleClusterUid", id);
            if (count == 0)
                return true;
            return false;
        }
