...
namespace GCS.Framework.Security
{
    ...
    public static class Crypto
    {
        ...
        public static string Encrypt(string encryptThis, string passPhrase = "", EncodingType encodingType = EncodingType.Unicode, string prefix = "!=!enc!=!")
        {
            ...
            if (string.IsNullOrEmpty(passPhrase))
            {
                for (int x = 0; x < 26; x++)
                {
                    passPhrase += (char)(x + 0x40);
                }
            }

            var encryptedString = GCS.Framework.Security.Crypto.EncryptString(encryptThis, passPhrase, encodingType);
            return $"{prefix}{encryptedString}";
        }

        public static string Decrypt(string decryptThis, string passPhrase = "", EncodingType encodingType = EncodingType.Unicode, string prefix = "!=!enc!=!")
        {
            ...
            {
                if (!decryptThis.StartsWith(prefix))
                    return decryptThis;
                ...
                return GCS.Framework.Security.Crypto.DecryptString(decryptThis.Substring(prefix.Length), passPhrase, encodingType);
            }
            return decryptThis;
        }

        public static bool IsEncrypted(string value, string prefix = "!=!enc!=!")
        {
