...
namespace GalaxySMS.Client.Contracts
{
    ...
    public interface ISystemManagementService : IServiceContract
    {
        ...
        [TransactionFlow(TransactionFlowOption.Allowed)]
        [FaultContract(typeof(ExceptionDetailEx))]
        GalaxyClusterTimeScheduleMap SetTimeScheduleToClusterMapping(Guid timeScheduleUid, Guid clusterUid,
        ...
        [OperationContract]
        Task<GalaxyClusterTimeScheduleMap> SetTimeScheduleToClusterMappingAsync(Guid timeScheduleUid, Guid clusterUid,
            bool isMapped, bool fifteenMinuteFormatUsesHolidays);
        ...
        //[OperationContract]
        //PersonEditingData GetPersonEditingDataWpf(GetParametersWithPhoto parameters);
        ...
        //[OperationContract]
        //AccessAndAlarmControlPermissionsEditingData GetAccessAndAlarmControlPermissionsEditingDataWpf(GetParametersWithPhoto parameters);
        ...
        //[OperationContract]
        //Task<PersonEditingData> GetPersonEditingDataWpfAsync(GetParametersWithPhoto parameters);
        ...
        //[OperationContract]
        //Task<AccessAndAlarmControlPermissionsEditingData> GetAccessAndAlarmControlPermissionsEditingDataWpfAsync(GetParametersWithPhoto parameters);
