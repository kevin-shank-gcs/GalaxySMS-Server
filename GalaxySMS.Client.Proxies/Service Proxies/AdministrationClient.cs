...
namespace GalaxySMS.Client.Proxies
{
    ...
    public class AdministrationClient : UserClientBase<IAdministrationService>, IAdministrationService
    {
        ...
        public BackgroundJobInfo SaveBackgroundJobStateChange(Guid backgroundJobId, BackgroundJobState state,
            string info)
        {
            base.InsertUserDataToOutgoingHeader();
        ...
        public Task<BackgroundJobInfo[]> GetBackgroundJobsAsync(GetParametersWithPhoto parameters,
