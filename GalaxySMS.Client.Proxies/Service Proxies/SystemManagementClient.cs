...
namespace GalaxySMS.Client.Proxies
{
    ...
    public class SystemManagementClient : UserClientBase<ISystemManagementService>, ISystemManagementService
    {
        ...
        public GalaxyClusterTimeScheduleMap SetTimeScheduleToClusterMapping(Guid timeScheduleUid, Guid clusterUid, bool isMapped,
        ...
        public Task<GalaxyClusterTimeScheduleMap> SetTimeScheduleToClusterMappingAsync(Guid timeScheduleUid, Guid clusterUid, bool isMapped, bool fifteenMinuteFormatUsesHolidays)
        {
            base.InsertUserDataToOutgoingHeader();
        ...
        public Task<CommandResponse<GalaxyCpuCommandAction>> ExecuteClusterCommandAsync(
            CommandParameters<GalaxyCpuCommandAction> parameters)
        {
            base.InsertUserDataToOutgoingHeader();
