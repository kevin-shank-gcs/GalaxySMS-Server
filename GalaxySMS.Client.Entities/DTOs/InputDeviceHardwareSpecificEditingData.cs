...
{
    [DataContract]
    public class InputDeviceHardwareSpecificEditingData : DtoObjectBase
    {
        private ICollection<InputDeviceSupervisionType> _contactSupervisionTypes;
        private ICollection<TimeSchedule> _timeSchedules;
        private ICollection<InputOutputGroup> _inputOutputGroups;

        public InputDeviceHardwareSpecificEditingData()
        {
            ContactSupervisionTypes = new HashSet<InputDeviceSupervisionType>();
            TimeSchedules = new HashSet<TimeSchedule>();
            InputOutputGroups = new HashSet<InputOutputGroup>();
        }

        [DataMember]
        public ICollection<InputDeviceSupervisionType> ContactSupervisionTypes
        {
