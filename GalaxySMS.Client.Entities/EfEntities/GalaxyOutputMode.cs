...
namespace GalaxySMS.Client.Entities
{
	...
	[DataContract]
	public partial class GalaxyOutputMode : DbObjectBase, ITableEntityBase, IHasBinaryResource, IHasDisplayResourceKey, IHasDescriptionResourceKey
    {
    	...
    	private ICollection<Guid> _outputCommandUids;
    
    	[DataMember]
    	public virtual ICollection<Guid> OutputCommandUids
    	{ 
    		get { return _outputCommandUids; }
    		set
    		{
    			if (_outputCommandUids != value )
    			{
    				_outputCommandUids = value;
    				OnPropertyChanged(() => OutputCommandUids);
    			}
    		}
    	}
