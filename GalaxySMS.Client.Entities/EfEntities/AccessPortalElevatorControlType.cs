...
namespace GalaxySMS.Client.Entities
{
	...
	[DataContract]
	public partial class AccessPortalElevatorControlType : DbObjectBase, ITableEntityBase, IHasBinaryResource, IHasDisplayResourceKey, IHasDescriptionResourceKey
    {
    ...
    */
        ...
        private ICollection<Guid> _galaxyPanelModelUids;
        ...
        [DataMember]
        public ICollection<Guid> GalaxyPanelModelUids
        {
            ...
            set
            {
                if (_galaxyPanelModelUids != value)
                {
                    ...
                    OnPropertyChanged(() => GalaxyPanelModelUids);
                }
            }
        }
