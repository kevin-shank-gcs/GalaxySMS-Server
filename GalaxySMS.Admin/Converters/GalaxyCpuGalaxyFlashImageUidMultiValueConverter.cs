...
{
    public class GalaxyCpuGalaxyFlashImageUidMultiValueConverter: IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {   // Value 1 = Cpu value 
            // Value 2 = GalaxyFlashImageUid
            ...
            {
                result.Add(new KeyValuePair<string, Guid>("galaxyFlashImageUid", g));
            }
            return result;
        }
