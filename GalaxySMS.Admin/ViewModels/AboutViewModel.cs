...
namespace GalaxySMS.Admin.ViewModels
{
    ...
    public class AboutViewModel : ViewModelBase
    {
        ...
        public AboutViewModel()
        {
            ...
            UpdateLicenseCommand = new DelegateCommand<object>(ExecuteUpdateLicenseCommand, CanExecuteUpdateLicenseCommand);
        }
        ...
        public override string ViewTitle
        {
            get
            {
                return string.Format(Properties.Resources.AboutView_Title, Attributes.Title);
            }
        }

        public DelegateCommand<object> ViewLicenseDetailsCommand { get; private set; }
        public DelegateCommand<object> UpdateLicenseCommand { get; private set; }
        ...
        {
            return Globals.MyLicense.IsLicenseValid;
        }
        ...
        private bool CanExecuteUpdateLicenseCommand(object obj)
        {
            return true;
        ...
        private void ExecuteUpdateLicenseCommand(object obj)
        {
            SetBackgroundSubdued();
            TelerikHelpers.ShowUpdateLicenseDialog(OnUpdateLicenseClosed);
        }


        private void OnUpdateLicenseClosed(object sender, WindowClosedEventArgs e)
        {
            ClearBackgroundSubdued();
        }
        #endregion
