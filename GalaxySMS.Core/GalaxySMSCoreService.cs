...
{
    public partial class GalaxySMSCoreService : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            _logger = LogManager.GetLogger<GalaxySMSCoreService>();
        ...
        private async Task<bool> EnsureSystemIsInitialized()
        {
            ...
            //defaultEntity.AllRoles.Add(role);
            ...
            //{
            //    RoleId = role.RoleId,
            //    PermissionId = permissionCanExecAdminMgr.PermissionId
            //});
