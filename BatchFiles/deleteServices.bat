...
REM netsh http delete urlacl url=https://+:SIGNALR_HTTPS_PORT/ >> %temp%\GalaxySMS_deleteServices.txt
netsh http delete urlacl url=http://+:38002/ >> %temp%\GalaxySMS_deleteServices.txt
REM netsh http delete urlacl url=https://+:API_HTTPS_PORT/ >> %temp%\GalaxySMS_deleteServices.txt
netsh http delete urlacl url=http://+:38004/ >> %temp%\GalaxySMS_deleteServices.txt
REM netsh http delete urlacl url=https://+:CDN_HTTPS_PORT/ >> %temp%\GalaxySMS_deleteServices.txt
